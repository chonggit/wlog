# 坏账准备计提单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应收款管理 > 坏账准备计提单
...
client.Delete("AR_BADDEBT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AR_BADDEBT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FLASTDATE":"1900-01-01","FISINIT":"false","FSETTLEORGID":{"FNumber":""},"FISAUTOGENERATE":"false","FEXCHANGETYPE":{"FNUMBER":""},"FMAINBOOKSTDCURRID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FBADDEBTMETHOD":"","FENDAMOUNTFOR":0,"FLASTAMOUNTFOR":0,"FCURSUMAMOUNTFOR":0,"FCURADDAOUNTFOR":0,"FBDRECOVERAMOUNTFOR":0,"FBDRECOVERADDAMOUNTFOR":0,"FADJAMOUNTFOR":0,"FCURBADAMOUNTFOR":0,"FPRESETBASE1":{"FNUMBER":""},"FPRESETBASE2":{"FNUMBER":""},"FEXCHANGERATE":0,"FENDAMOUNT":0,"FLASTAMOUNT":0,"FCURSUMAMOUNT":0,"FCURADDAOUNT":0,"FBDRECOVERAMOUNT":0,"FBDRECOVERADDAMOUNT":0,"FADJAMOUNT":0,"FCURBADAMOUNT":0}],"FBADDEBTCURENTRY":[{"FEntryID":0,"FCONTACTUNITTYPEC":"","FCONTACTUNITC":{"FNumber":""},"FCURRENCYIDC":{"FNUMBER":""},"FNORECAMOUNTFORC":0,"FCURPRESETBASE1":{"FNUMBER":""},"FCURPRESETBASE2":{"FNUMBER":""},"FBADDEBTCURDETAIL":[{"FDetailID":0,"FNAMEC":"","FAMOUNTFOR":0,"FBADRATE":0,"FBADAMOUNTFOR":0}]}],"FBADDEBTLASTENTRY":[{"FEntryID":0,"FCONTACTUNITTYPEL":"","FCONTACTUNITL":{"FNumber":""},"FCURRENCYIDL":{"FNUMBER":""},"FNORECAMOUNTFORL":0,"FLASTPRESETBASE1":{"FNUMBER":""},"FLASTPRESETBASE2":{"FNUMBER":""},"FBADDEBTLASTDETAIL":[{"FDetailID":0,"FNAMEL":"","FAMOUNTFORL":0,"FBADRATEL":0,"FBADAMOUNTFORL":0}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FBillNo": "",
        "FDate": "1900-01-01",
        "FLASTDATE": "1900-01-01",
        "FISINIT": "false",
        "FSETTLEORGID": {
            "FNumber": ""
        },
        "FISAUTOGENERATE": "false",
        "FEXCHANGETYPE": {
            "FNUMBER": ""
        },
        "FMAINBOOKSTDCURRID": {
        ...
        "FEntity": [
            {
                ...
                "FCURSUMAMOUNTFOR": 0,
                "FCURADDAOUNTFOR": 0,
                "FBDRECOVERAMOUNTFOR": 0,
                "FBDRECOVERADDAMOUNTFOR": 0,
                "FADJAMOUNTFOR": 0,
                "FCURBADAMOUNTFOR": 0,
                "FPRESETBASE1": {
                    "FNUMBER": ""
...
单据头：FBillHead 
	 ...
	 审核人：FAPPROVERID 
	 审核日期：FAPPROVEDATE 
	 是否后台自动生成：FISAUTOGENERATE 
	 汇率类型：FEXCHANGETYPE 
	 本位币：FMAINBOOKSTDCURRID  (必填项)
计提信息：FEntity 
	 实体主键：FEntryID 
	 往来单位类型：FCONTACTUNITTYPE  (必填项)
	 往来单位编码：FCONTACTUNIT  (必填项)
	 币别：FCURRENCYID  (必填项)
	 往来单位名称：FCONTACTUNITNAME 
	 本期末坏账准备金额：FENDAMOUNTFOR 
	 上期末坏账准备金额：FLASTAMOUNTFOR 
	 坏账确认金额&前期累计金额：FCURSUMAMOUNTFOR 
	 坏账确认金额&本期新增金额：FCURADDAOUNTFOR 
	 本期应计提金额：FCURBADAMOUNTFOR 
	 计提方法：FBADDEBTMETHOD 
	 预设基础资料1：FPRESETBASE1 
	 预设基础资料2：FPRESETBASE2 
	 汇率：FEXCHANGERATE 
	 本期末坏账准备金额本位币：FENDAMOUNT 
	 上期末坏账准备金额本位币：FLASTAMOUNT 
	 坏账确认金额本位币&前期累计金额本位币：FCURSUMAMOUNT 
	 坏账确认金额本位币&本期新增金额本位币：FCURADDAOUNT 
	 本期应计提金额本位币：FCURBADAMOUNT 
	 坏账收回金额&前期累计金额：FBDRECOVERAMOUNTFOR 
	 坏账收回金额&本期新增金额：FBDRECOVERADDAMOUNTFOR 
	 坏账收回金额本位币&前期累计金额本位币：FBDRECOVERAMOUNT 
	 坏账收回金额本位币&本期新增金额本位币：FBDRECOVERADDAMOUNT 
	 审计调整金额：FADJAMOUNTFOR 
	 审计调整金额本位币：FADJAMOUNT 
账龄信息（本期）：FBADDEBTCURENTRY 
	 实体主键：FEntryID 
	 往来单位类型：FCONTACTUNITTYPEC 
	 往来单位编码：FCONTACTUNITC 
	 往来单位名称：FFCONTACTUNITCPERTY 
	 币别：FCURRENCYIDC 
	 尚未收款金额：FNORECAMOUNTFORC 
	 预设基础资料1：FCURPRESETBASE1 
	 预设基础资料2：FCURPRESETBASE2 
账龄分组信息（本期）：FBADDEBTCURDETAIL 
	 实体主键：FDetailID 
	 分组设置：FNAMEC 
	 应收金额：FAMOUNTFOR 
	 计提比例%：FBADRATE 
	 计提金额：FBADAMOUNTFOR 
账龄信息（上期）：FBADDEBTLASTENTRY 
	 实体主键：FEntryID 
	 往来单位类型：FCONTACTUNITTYPEL 
	 往来单位编码：FCONTACTUNITL 
	 往来单位名称：FCONTACTUNITLperty 
	 币别：FCURRENCYIDL 
	 尚未收款金额：FNORECAMOUNTFORL 
	 预设基础资料1：FLASTPRESETBASE1 
	 预设基础资料2：FLASTPRESETBASE2 
账龄分组信息（上期）：FBADDEBTLASTDETAIL 
	 实体主键：FDetailID 
	 分组设置：FNAMEL 
	 应收金额：FAMOUNTFORL 
	 计提比例%：FBADRATEL 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AR_BADDEBT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FLASTDATE":"1900-01-01","FISINIT":"false","FSETTLEORGID":{"FNumber":""},"FISAUTOGENERATE":"false","FEXCHANGETYPE":{"FNUMBER":""},"FMAINBOOKSTDCURRID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FBADDEBTMETHOD":"","FENDAMOUNTFOR":0,"FLASTAMOUNTFOR":0,"FCURSUMAMOUNTFOR":0,"FCURADDAOUNTFOR":0,"FBDRECOVERAMOUNTFOR":0,"FBDRECOVERADDAMOUNTFOR":0,"FADJAMOUNTFOR":0,"FCURBADAMOUNTFOR":0,"FPRESETBASE1":{"FNUMBER":""},"FPRESETBASE2":{"FNUMBER":""},"FEXCHANGERATE":0,"FENDAMOUNT":0,"FLASTAMOUNT":0,"FCURSUMAMOUNT":0,"FCURADDAOUNT":0,"FBDRECOVERAMOUNT":0,"FBDRECOVERADDAMOUNT":0,"FADJAMOUNT":0,"FCURBADAMOUNT":0}],"FBADDEBTCURENTRY":[{"FEntryID":0,"FCONTACTUNITTYPEC":"","FCONTACTUNITC":{"FNumber":""},"FCURRENCYIDC":{"FNUMBER":""},"FNORECAMOUNTFORC":0,"FCURPRESETBASE1":{"FNUMBER":""},"FCURPRESETBASE2":{"FNUMBER":""},"FBADDEBTCURDETAIL":[{"FDetailID":0,"FNAMEC":"","FAMOUNTFOR":0,"FBADRATE":0,"FBADAMOUNTFOR":0}]}],"FBADDEBTLASTENTRY":[{"FEntryID":0,"FCONTACTUNITTYPEL":"","FCONTACTUNITL":{"FNumber":""},"FCURRENCYIDL":{"FNUMBER":""},"FNORECAMOUNTFORL":0,"FLASTPRESETBASE1":{"FNUMBER":""},"FLASTPRESETBASE2":{"FNUMBER":""},"FBADDEBTLASTDETAIL":[{"FDetailID":0,"FNAMEL":"","FAMOUNTFORL":0,"FBADRATEL":0,"FBADAMOUNTFORL":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AR_BADDEBT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AR_BADDEBT","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AR_BADDEBT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AR_BADDEBT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AR_BADDEBT","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AR_BADDEBT","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AR_BADDEBT"}");

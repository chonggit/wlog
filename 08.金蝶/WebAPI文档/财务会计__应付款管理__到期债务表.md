# 到期债务表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应付款管理 > 到期债务表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3581 |
...
client.GetSysReportData("AP_MaturedDebt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAffiliation":{"FNAME":""},"FCONTACTUNITTYPE":"","FContactUnitFrom":{"FNumber":""},"FContactUnitTo":{"FNumber":""},"FSettleOrgLst":"","FIsFromFilter":"false","FDays":0,"FUNAUDIT":"false","FUNEND":"false","FCurrencyFrom":{"FNumber":""},"FByDate":"1900-01-01","FIncludePayEvaluate_New":"false","FOnlyShowPayEvaluate_New":"false","FShowLocal":"false","FReSetAllocateExc":"false","FExChangeRateType":{"FNUMBER":""}}}");
...
参数FieldKeys显示列：
	 ...
	 到期日：FENDDATE 
	 应付金额(原币)：FBALANCEFOR 
	 币别(本位币)：FMAINCURRENCY 
	 应付金额(本位币)：FBALANCE 
	 过期天数：FMATUREDDAYS 
	 未过期天数：FUNMATUREDDAYS 
	 备注：FREMARK 

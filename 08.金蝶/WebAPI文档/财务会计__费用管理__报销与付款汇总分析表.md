# 报销与付款汇总分析表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 费用管理 > 报销与付款汇总分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3007 |
...
client.GetSysReportData("ER_ReimbAndPayAnalysis","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAffiliation":{"FNUMBER":""},"FCurrency":{"FNUMBER":""},"FCONTACTUNITTYPE":"","FCONTACTUNITTo":{"FNumber":""},"FCONTACTUNITFrom":{"FNumber":""},"FEXPIDFrom":{"FNUMBER":""},"FEXPIDTo":{"FNUMBER":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FEXPENSEORGID":""}}");
...
参数FieldKeys显示列：
	 ...
	 币别：FCURRENCYID 
	 费用项目：FEXPENSEITEMID 
	 历史借款：FPayAmtForHisBorrow 
	 申请单借款：FPayAmtForRequest 
	 报销付款：FPayAmtForReimb 
	 尾差核销（付款单）：FPayAmtForOffset 
	 已退款金额：FRefundAmount 
	 付款小计：FPayAmtForTotal 
	 报销金额：FReimburseAmount 
	 尾差核销（报销单）：FReimbForOffset 
	 报销小计：FReimbAmtForTotal 
	 负数报销退款金额：FRefundAmountforPart 
	 余额（付款小计-报销小计）：FTurnOverAmount 

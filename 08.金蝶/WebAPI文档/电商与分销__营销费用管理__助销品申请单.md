# 助销品申请单 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 营销费用管理 > 助销品申请单
...
client.Delete("MEM_FEEREUESTGOODS","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("MEM_FEEREUESTGOODS","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FFeeTypeId":{"FFEETYPECODE":""},"FDate":"1900-01-01","FSrcBillNo":"","FCustId":{"FNUMBER":""},"FApplyChannelId":{"FNUMBER":""},"FApplyOrgId":{"FNUMBER":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FOutStatus":"","FReceiveCustId":{"FNUMBER":""},"FAddress":"","FReason":"","FCustORGId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FChannelId":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FApplyQty":0,"FQty":0,"FAuditQty":0,"FOutQty":0,"FSaleUnitId":{"FNumber":""},"FBaseUnitId":{"FNumber":""},"FEntryOutStatus":"","FEntryStartDate":"1900-01-01","FEntryEndDate":"1900-01-01","FRemark":"","FApplyBaseQty":0,"FBaseQty":0,"FOutBaseQty":0,"FSrcBillTypeId":"","FSrcEntryId":0,"FSRCSubEntryId":0,"FAuditBaseQty":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FEntryOutStatus": "",
                "FEntryStartDate": "1900-01-01",
                "FEntryEndDate": "1900-01-01",
                "FRemark": "",
                "FApplyBaseQty": 0,
                "FBaseQty": 0,
                "FOutBaseQty": 0,
...
明细信息：FEntity 
	 ...
	 计量单位：FSaleUnitId 
	 基本计量单位：FBaseUnitId 
	 物料出库状态：FEntryOutStatus 
	 开始时间：FEntryStartDate 
	 结束时间：FEntryEndDate 
	 备注：FRemark 
	 申请基本数量：FApplyBaseQty 
	 批准基本数量：FBaseQty 
	 出库基本数量：FOutBaseQty 
	 源单单据类型：FSrcBillTypeId 
	 源单分录ID：FSrcEntryId 
	 规格型号：FBaseProperty 
	 源单子单据体ID：FSRCSubEntryId 
	 物料编码：F_KDD_BaseProperty 
	 已出库数量：FAuditQty 
	 已出库基本单位数量：FAuditBaseQty 
关联关系表：FEntity_Link 
	 实体主键：FLinkId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("MEM_FEEREUESTGOODS","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FFeeTypeId":{"FFEETYPECODE":""},"FDate":"1900-01-01","FSrcBillNo":"","FCustId":{"FNUMBER":""},"FApplyChannelId":{"FNUMBER":""},"FApplyOrgId":{"FNUMBER":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FOutStatus":"","FReceiveCustId":{"FNUMBER":""},"FAddress":"","FReason":"","FCustORGId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FChannelId":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FApplyQty":0,"FQty":0,"FAuditQty":0,"FOutQty":0,"FSaleUnitId":{"FNumber":""},"FBaseUnitId":{"FNumber":""},"FEntryOutStatus":"","FEntryStartDate":"1900-01-01","FEntryEndDate":"1900-01-01","FRemark":"","FApplyBaseQty":0,"FBaseQty":0,"FOutBaseQty":0,"FSrcBillTypeId":"","FSrcEntryId":0,"FSRCSubEntryId":0,"FAuditBaseQty":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("MEM_FEEREUESTGOODS","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("MEM_FEEREUESTGOODS","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("MEM_FEEREUESTGOODS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("MEM_FEEREUESTGOODS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("MEM_FEEREUESTGOODS","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("MEM_FEEREUESTGOODS","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("MEM_FEEREUESTGOODS","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"MEM_FEEREUESTGOODS"}");

# 业务单据组织变更 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 业务变更 > 业务单据组织变更
...
client.Delete("ORG_BillOrgChange","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ORG_BillOrgChange","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgFieldName":"","FOrgFieldKey":"","FBillNo":"","FReason":"","FChangingPlan":{"FNUMBER":""},"FBChangeCOrgId":{"FNumber":""},"FBill":{"FID":""},"FExecutorId":{"FUserID":""},"FExecutorDate":"1900-01-01","FBillChangeEntity":[{"FEntryID":0,"FAfterChangeOrgId":{"FNumber":""},"FBillNumber":"","FBillId":"","FBillType":{"FNUMBER":""},"FExcuteStaus":"","FExcuteInfo":"","FBillChangeSubEntity":[{"FDetailID":0,"FBillEntryId":""}]}],"FBillCtrlFieldEntity":[{"FEntryID":0,"FFieldName":"","FControlTypeId":"","FDefaultValue":"","FFieldKey":""}]}}");
...
业务单据组织变更：FBillHead 
	 ...
	 编号：FBillNo  (必填项)
	 变更理由：FReason 
	 组织变更方案：FChangingPlan 
	 变更前组织：FBChangeCOrgId  (必填项)
	 业务单据：FBill  (必填项)
	 单据上组织：FOrgFieldName  (必填项)
	 组织标识：FOrgFieldKey 
	 变更人：FExecutorId 
	 变更日期：FExecutorDate 
变更数据：FBillChangeEntity 
	 实体主键：FEntryID 
	 变更后组织：FAfterChangeOrgId  (必填项)
	 业务单据编号：FBillNumber  (必填项)
	 业务单据内码：FBillId 
	 执行结果：FExcuteStaus 
	 执行信息：FExcuteInfo 
	 单据类型：FBillType 
受控字段：FBillCtrlFieldEntity 
	 实体主键：FEntryID 
	 字段名：FFieldName  (必填项)
	 控制方式：FControlTypeId  (必填项)
	 默认值：FDefaultValue 
	 字段标识：FFieldKey  (必填项)
子单据体：FBillChangeSubEntity 
	 实体主键：FDetailID 
	 实体的内码：FBillEntryId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ORG_BillOrgChange","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgFieldName":"","FOrgFieldKey":"","FBillNo":"","FReason":"","FChangingPlan":{"FNUMBER":""},"FBChangeCOrgId":{"FNumber":""},"FBill":{"FID":""},"FExecutorId":{"FUserID":""},"FExecutorDate":"1900-01-01","FBillChangeEntity":[{"FEntryID":0,"FAfterChangeOrgId":{"FNumber":""},"FBillNumber":"","FBillId":"","FBillType":{"FNUMBER":""},"FExcuteStaus":"","FExcuteInfo":"","FBillChangeSubEntity":[{"FDetailID":0,"FBillEntryId":""}]}],"FBillCtrlFieldEntity":[{"FEntryID":0,"FFieldName":"","FControlTypeId":"","FDefaultValue":"","FFieldKey":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ORG_BillOrgChange","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ORG_BillOrgChange","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ORG_BillOrgChange"}");

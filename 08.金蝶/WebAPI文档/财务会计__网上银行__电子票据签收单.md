# 电子票据签收单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 网上银行 > 电子票据签收单
...
client.Delete("WB_SigningElectronicBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("WB_SigningElectronicBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCollectBillOrgId":{"FNumber":""},"FReplyDate":"1900-01-01","FReplyerBankCnaps":"","FReplyerBankName":"","FReplyerAcName":"","FReplyerAcNo":"","FApplicantAcNo":"","FApplicantBankCnaps":"","FApplicantAcName":"","FApplicantBankName":"","FReplyType":"","FApplicationDate":"1900-01-01","FTransferFlag":"false","FApplicantDesc":"","FReplyOpinion":"","FRejectionReasons":"","FNoteStatus":"","FDraftType":"","FNoteNo":"","FIssueDate":"1900-01-01","FIsSplitTicket":"false","FDueDate":"1900-01-01","FPaymentTerm":0,"FCurrencyId":{"FNUMBER":""},"FAmount":0,"FDrawerAccNo":"","FPayeeBankName":"","FPayeeCnapsCode":"","FPayeeAccNo":"","FDrawerAccName":"","FDrawerBankName":"","FPayeeAccName":"","FDrawerCnapsCode":"","FAcceptorAccNo":"","FAcceptorAccName":"","FAcceptorCnapsCode":"","FAcceptorBankName":"","FSponsorAccNo":"","FSponsorAdress":"","FSponsorCnapsCode":"","FSponsorAccName":"","FEnsureDate":"1900-01-01","FAcceptanceEDate":"1900-01-01","FInvoiceNumer":"","FRemark":"","FBankMsg":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FIsCreateBillReceivable":"false","FRelateBillReceivable":"","FBankRefKey":"","FSubmitUser":{"FUSERACCOUNT":""},"FSubmitBankTime":"1900-01-01","FBatchSeqID":"","FModifyReason":"","FModifyStatusUser":{"FUserID":""},"FModifyStatusDatetime":"1900-01-01","FCollectPayType":"","FStartNo":0,"FEndNo":0,"FTicketNo":"","FTicketFrom":"","FCirStatus":"","FNewNoteStatus":"","FReserveds":"","FIsNoLimitPay":"false","FNOTESIDESDETAIL":[{"FEntryID":0,"FBusinessCode":"","FInitiatorName":"","FOpponentName":"","FDetailTransferFlag":"","FSignDate":"1900-01-01","FDetailNoteNo":"","FDetailSeq":"","FDetailRemark":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIsCreateBillReceivable": "false",
        "FRelateBillReceivable": "",
        "FBankRefKey": "",
        "FSubmitUser": {
            "FUSERACCOUNT": ""
        },
...
单据头：FBillHead 
	 ...
	 收票组织：FCollectBillOrgId 
	 回复日期：FReplyDate 
	 申请人全称：FApplicantAcName 
	 申请人开户行行号：FApplicantBankCnaps 
	 申请人账号：FApplicantAcNo 
	 申请人开户银行：FApplicantBankName 
	 回复人全称：FReplyerAcName 
	 回复人账号：FReplyerAcNo 
	 回复人开户银行：FReplyerBankName 
	 回复人开户行行号：FReplyerBankCnaps 
	 回复类型：FReplyType 
	 申请日期：FApplicationDate 
	 能否转让：FTransferFlag 
	 申请人备注：FApplicantDesc 
	 回复意见：FReplyOpinion 
	 拒收理由：FRejectionReasons 
	 票据类型：FDraftType 
	 电票状态：FNoteStatus 
	 票据（包）号：FNoteNo 
	 出票日：FIssueDate 
	 ...
	 出票人全称：FDrawerAccName 
	 出票人账号：FDrawerAccNo 
	 付款银行：FDrawerBankName 
	 出票人开户行行号：FDrawerCnapsCode 
	 收款人账号：FPayeeAccNo 
	 收款人开户行行号：FPayeeCnapsCode 
	 收款银行：FPayeeBankName 
	 收款人全称：FPayeeAccName 
	 ...
	 承兑人全称：FAcceptorAccName 
	 承兑日期：FAcceptanceEDate 
	 承兑人账号：FAcceptorAccNo 
	 承兑人开户行行号：FAcceptorCnapsCode 
	 发票号码：FInvoiceNumer 
	 备注：FRemark 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 是否生成应收票据：FIsCreateBillReceivable 
	 关联应收票据：FRelateBillReceivable 
	 银行参考号：FBankRefKey 
	 提交人：FSubmitUser 
	 ...
	 银企Reserveds：FReserveds 
	 承兑人承诺到期无条件付款：FIsNoLimitPay 
票据背面信息：FNOTESIDESDETAIL 
	 实体主键：FEntryID 
	 业务类型：FBusinessCode 
	 背书人名称/出票人名称：FInitiatorName 
	 被背书人名称/收款人名称/承兑人名称：FOpponentName 
	 能否转让标识：FDetailTransferFlag 
	 日期：FSignDate 
	 票据号：FDetailNoteNo 
	 明细号：FDetailSeq 
	 备注：FDetailRemark 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("WB_SigningElectronicBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCollectBillOrgId":{"FNumber":""},"FReplyDate":"1900-01-01","FReplyerBankCnaps":"","FReplyerBankName":"","FReplyerAcName":"","FReplyerAcNo":"","FApplicantAcNo":"","FApplicantBankCnaps":"","FApplicantAcName":"","FApplicantBankName":"","FReplyType":"","FApplicationDate":"1900-01-01","FTransferFlag":"false","FApplicantDesc":"","FReplyOpinion":"","FRejectionReasons":"","FNoteStatus":"","FDraftType":"","FNoteNo":"","FIssueDate":"1900-01-01","FIsSplitTicket":"false","FDueDate":"1900-01-01","FPaymentTerm":0,"FCurrencyId":{"FNUMBER":""},"FAmount":0,"FDrawerAccNo":"","FPayeeBankName":"","FPayeeCnapsCode":"","FPayeeAccNo":"","FDrawerAccName":"","FDrawerBankName":"","FPayeeAccName":"","FDrawerCnapsCode":"","FAcceptorAccNo":"","FAcceptorAccName":"","FAcceptorCnapsCode":"","FAcceptorBankName":"","FSponsorAccNo":"","FSponsorAdress":"","FSponsorCnapsCode":"","FSponsorAccName":"","FEnsureDate":"1900-01-01","FAcceptanceEDate":"1900-01-01","FInvoiceNumer":"","FRemark":"","FBankMsg":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FIsCreateBillReceivable":"false","FRelateBillReceivable":"","FBankRefKey":"","FSubmitUser":{"FUSERACCOUNT":""},"FSubmitBankTime":"1900-01-01","FBatchSeqID":"","FModifyReason":"","FModifyStatusUser":{"FUserID":""},"FModifyStatusDatetime":"1900-01-01","FCollectPayType":"","FStartNo":0,"FEndNo":0,"FTicketNo":"","FTicketFrom":"","FCirStatus":"","FNewNoteStatus":"","FReserveds":"","FIsNoLimitPay":"false","FNOTESIDESDETAIL":[{"FEntryID":0,"FBusinessCode":"","FInitiatorName":"","FOpponentName":"","FDetailTransferFlag":"","FSignDate":"1900-01-01","FDetailNoteNo":"","FDetailSeq":"","FDetailRemark":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("WB_SigningElectronicBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("WB_SigningElectronicBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("WB_SigningElectronicBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("WB_SigningElectronicBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("WB_SigningElectronicBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("WB_SigningElectronicBill","SynBankStatus","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBillNo":"","FCollectBillOrgId":{"FNumber":""},"FReplyDate":"1900-01-01","FReplyerBankCnaps":"","FReplyerBankName":"","FReplyerAcName":"","FReplyerAcNo":"","FApplicantAcNo":"","FApplicantBankCnaps":"","FApplicantAcName":"","FApplicantBankName":"","FReplyType":"","FApplicationDate":"1900-01-01","FTransferFlag":"false","FApplicantDesc":"","FReplyOpinion":"","FRejectionReasons":"","FNoteStatus":"","FDraftType":"","FNoteNo":"","FIssueDate":"1900-01-01","FIsSplitTicket":"false","FDueDate":"1900-01-01","FPaymentTerm":0,"FCurrencyId":{"FNUMBER":""},"FAmount":0,"FDrawerAccNo":"","FPayeeBankName":"","FPayeeCnapsCode":"","FPayeeAccNo":"","FDrawerAccName":"","FDrawerBankName":"","FPayeeAccName":"","FDrawerCnapsCode":"","FAcceptorAccNo":"","FAcceptorAccName":"","FAcceptorCnapsCode":"","FAcceptorBankName":"","FSponsorAccNo":"","FSponsorAdress":"","FSponsorCnapsCode":"","FSponsorAccName":"","FEnsureDate":"1900-01-01","FAcceptanceEDate":"1900-01-01","FInvoiceNumer":"","FRemark":"","FBankMsg":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FIsCreateBillReceivable":"false","FRelateBillReceivable":"","FBankRefKey":"","FSubmitUser":{"FUSERACCOUNT":""},"FSubmitBankTime":"1900-01-01","FBatchSeqID":"","FModifyReason":"","FModifyStatusUser":{"FUserID":""},"FModifyStatusDatetime":"1900-01-01","FCollectPayType":"","FStartNo":0,"FEndNo":0,"FTicketNo":"","FTicketFrom":"","FCirStatus":"","FNewNoteStatus":"","FReserveds":"","FIsNoLimitPay":"false","FNOTESIDESDETAIL":[{"FEntryID":0,"FBusinessCode":"","FInitiatorName":"","FOpponentName":"","FDetailTransferFlag":"","FSignDate":"1900-01-01","FDetailNoteNo":"","FDetailSeq":"","FDetailRemark":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("WB_SigningElectronicBill","SignFor","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBillNo":"","FCollectBillOrgId":{"FNumber":""},"FReplyDate":"1900-01-01","FReplyerBankCnaps":"","FReplyerBankName":"","FReplyerAcName":"","FReplyerAcNo":"","FApplicantAcNo":"","FApplicantBankCnaps":"","FApplicantAcName":"","FApplicantBankName":"","FReplyType":"","FApplicationDate":"1900-01-01","FTransferFlag":"false","FApplicantDesc":"","FReplyOpinion":"","FRejectionReasons":"","FNoteStatus":"","FDraftType":"","FNoteNo":"","FIssueDate":"1900-01-01","FIsSplitTicket":"false","FDueDate":"1900-01-01","FPaymentTerm":0,"FCurrencyId":{"FNUMBER":""},"FAmount":0,"FDrawerAccNo":"","FPayeeBankName":"","FPayeeCnapsCode":"","FPayeeAccNo":"","FDrawerAccName":"","FDrawerBankName":"","FPayeeAccName":"","FDrawerCnapsCode":"","FAcceptorAccNo":"","FAcceptorAccName":"","FAcceptorCnapsCode":"","FAcceptorBankName":"","FSponsorAccNo":"","FSponsorAdress":"","FSponsorCnapsCode":"","FSponsorAccName":"","FEnsureDate":"1900-01-01","FAcceptanceEDate":"1900-01-01","FInvoiceNumer":"","FRemark":"","FBankMsg":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FIsCreateBillReceivable":"false","FRelateBillReceivable":"","FBankRefKey":"","FSubmitUser":{"FUSERACCOUNT":""},"FSubmitBankTime":"1900-01-01","FBatchSeqID":"","FModifyReason":"","FModifyStatusUser":{"FUserID":""},"FModifyStatusDatetime":"1900-01-01","FCollectPayType":"","FStartNo":0,"FEndNo":0,"FTicketNo":"","FTicketFrom":"","FCirStatus":"","FNewNoteStatus":"","FReserveds":"","FIsNoLimitPay":"false","FNOTESIDESDETAIL":[{"FEntryID":0,"FBusinessCode":"","FInitiatorName":"","FOpponentName":"","FDetailTransferFlag":"","FSignDate":"1900-01-01","FDetailNoteNo":"","FDetailSeq":"","FDetailRemark":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("WB_SigningElectronicBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"WB_SigningElectronicBill"}");

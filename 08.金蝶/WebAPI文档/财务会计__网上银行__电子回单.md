...
client.Delete("WB_ReceiptBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("WB_ReceiptBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDATE":"1900-01-01","FBillNo":"","FCURRENCYID":{"FNUMBER":""},"FBANKID":{"FNUMBER":""},"FPAYORGID":{"FNumber":""},"FSRCBILLTYPEID":{"FNUMBER":""},"FACCOUNTID":{"FNUMBER":""},"FSRCBILLNO":"","FBUSIREFENO":"","FDEBITAMOUNT":0,"FCREDITAMOUNT":0,"FAmount":0,"FEXPLANATION":"","FOPPOSITEBANKNAME":"","FOPPOSITEBANKACNTNO":"","FOPPOSITECCOUNTNAME":"","FPRINTCOUNT":0,"FFIRSTPRINTDATE":"1900-01-01","FMATCHED":"false","FReceiptNo":"","FFlowNo":"","FDetailNo":"","FVerificationCode":"","FSRCFormId":"","FSRCBILLID":0,"FKDRETFLAG":"","FReceiptInfo":"","FRemark":"","FUSECN":""}}");
...
单据头：FBillHead 
	 ...
	 账户名称：FACCOUNTNAME 
	 币别：FCURRENCYID  (必填项)
	 借方(付款)金额：FDEBITAMOUNT 
	 贷方(收款)金额：FCREDITAMOUNT 
	 大写金额：FAmountDisplay 
	 金额：FAmount 
	 摘要：FEXPLANATION 
	 对方开户银行：FOPPOSITEBANKNAME 
	 对方银行账号：FOPPOSITEBANKACNTNO 
	 对方账号名称：FOPPOSITECCOUNTNAME 
	 打印次数：FPRINTCOUNT 
	 首次打印时间：FFIRSTPRINTDATE 
	 首次打印人：FFIRSTPRINTERID 
	 匹配交易明细：FMATCHED 
	 电子回单编号：FReceiptNo 
	 交易流水号：FFlowNo 
	 银行类型：FBANKTYPE 
	 关联标记：FDetailNo 
	 验证码：FVerificationCode 
	 创建日期：FCreateDate 
	 业务单据FormId：FSRCFormId 
	 业务单据ID：FSRCBILLID 
	 KD标志：FKDRETFLAG 
	 附言：FReceiptInfo 
	 备注：FRemark 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("WB_ReceiptBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDATE":"1900-01-01","FBillNo":"","FCURRENCYID":{"FNUMBER":""},"FBANKID":{"FNUMBER":""},"FPAYORGID":{"FNumber":""},"FSRCBILLTYPEID":{"FNUMBER":""},"FACCOUNTID":{"FNUMBER":""},"FSRCBILLNO":"","FBUSIREFENO":"","FDEBITAMOUNT":0,"FCREDITAMOUNT":0,"FAmount":0,"FEXPLANATION":"","FOPPOSITEBANKNAME":"","FOPPOSITEBANKACNTNO":"","FOPPOSITECCOUNTNAME":"","FPRINTCOUNT":0,"FFIRSTPRINTDATE":"1900-01-01","FMATCHED":"false","FReceiptNo":"","FFlowNo":"","FDetailNo":"","FVerificationCode":"","FSRCFormId":"","FSRCBILLID":0,"FKDRETFLAG":"","FReceiptInfo":"","FRemark":"","FUSECN":""}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("WB_ReceiptBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("WB_ReceiptBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("WB_ReceiptBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("WB_ReceiptBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("WB_ReceiptBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("WB_ReceiptBill","MatchBill","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FDATE":"1900-01-01","FBillNo":"","FCURRENCYID":{"FNUMBER":""},"FBANKID":{"FNUMBER":""},"FPAYORGID":{"FNumber":""},"FSRCBILLTYPEID":{"FNUMBER":""},"FACCOUNTID":{"FNUMBER":""},"FSRCBILLNO":"","FBUSIREFENO":"","FDEBITAMOUNT":0,"FCREDITAMOUNT":0,"FAmount":0,"FEXPLANATION":"","FOPPOSITEBANKNAME":"","FOPPOSITEBANKACNTNO":"","FOPPOSITECCOUNTNAME":"","FPRINTCOUNT":0,"FFIRSTPRINTDATE":"1900-01-01","FMATCHED":"false","FReceiptNo":"","FFlowNo":"","FDetailNo":"","FVerificationCode":"","FSRCFormId":"","FSRCBILLID":0,"FKDRETFLAG":"","FReceiptInfo":"","FRemark":"","FUSECN":""}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("WB_ReceiptBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"WB_ReceiptBill"}");

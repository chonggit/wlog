# 检验反写单 Web API 操作原始内容

> 来源页面：全部 > 质量管理 > 质量管理 > 检验反写单
...
client.Delete("QM_QCWriteBack","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QM_QCWriteBack","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FEntryId":0,"FBillNo":"","FSrcBillType":"","FSrcBillNo":"","FQCBusinessType":"","FMaterialId":{"FNUMBER":""},"FInspectResult":"","FSampleDamageBearer":"","FBaseUnitId":{"FNumber":""},"FBaseInspectQty":0,"FBaseSampleDamageQty":0,"FBaseWBInspectQty":0,"FPrdLineLocation":{"FLOCATIONCODE":""},"FBaseUnQuaSalQty":0,"FSrcInterId":0,"FSrcEntryId":0,"FSrcEntrySeq":0,"FNewExpiryDate":"1900-01-01"}}");
...
单据头：FBillHead 
	 ...
	 报废数量：FBaseScrapQty 
	 返修数量：FBaseRepairQty 
	 检验数量：FBaseInspectQty 
	 检验物料：FMaterialId 
	 检验结果：FInspectResult 
	 业务类型：FQCBusinessType 
	 挑选数量：FBasePickQty 
	 料废数量：FBaseMtrlScrapQty 
	 工废数量：FBaseProcScrapQty 
	 让步接收数量：FBaseReAcceptQty 
	 基本单位反写检验数量：FBaseWBInspectQty 
	 工位/工序：FPrdLineLocation 
	 不合格可销售数量：FBaseUnQuaSalQty 
	 源单内码：FSrcInterId 
	 源单分录内码：FSrcEntryId 
	 源单分录行号：FSrcEntrySeq 
	 返工数量：FBaseReMadeQty 
	 新有效期至：FNewExpiryDate 
	 来料不良数量：FBaseIncDefectQty 
	 作业不良数量：FBaseProDefectQty 
关联关系表：FBillHead_Link 
	 ...
	 原始携带量：FBillHead_Link_FBaseInspectQtyOld 
	 修改携带量：FBillHead_Link_FBaseInspectQty 
	 原始携带量：FBillHead_Link_FBaseSampleDamageQtyOld 
	 修改携带量：FBillHead_Link_FBaseSampleDamageQty 
	 原始携带量：FBillHead_Link_FBaseAcceptQtyOld 
	 修改携带量：FBillHead_Link_FBaseAcceptQty 
	 原始携带量：FBillHead_Link_FBaseReAcceptQtyOld 
	 修改携带量：FBillHead_Link_FBaseReAcceptQty 
	 原始携带量：FBillHead_Link_FBaseRejectQtyOld 
	 修改携带量：FBillHead_Link_FBaseRejectQty 
	 原始携带量：FBillHead_Link_FBaseDefectQtyOld 
	 修改携带量：FBillHead_Link_FBaseDefectQty 
	 原始携带量：FBillHead_Link_FBaseScrapQtyOld 
	 修改携带量：FBillHead_Link_FBaseScrapQty 
	 原始携带量：FBillHead_Link_FBaseReMadeQtyOld 
	 修改携带量：FBillHead_Link_FBaseReMadeQty 
	 原始携带量：FBillHead_Link_FBaseRepairQtyOld 
	 修改携带量：FBillHead_Link_FBaseRepairQty 
	 原始携带量：FBillHead_Link_FBasePickQtyOld 
	 修改携带量：FBillHead_Link_FBasePickQty 
	 原始携带量：FBillHead_Link_FBaseMtrlScrapQtyOld 
	 修改携带量：FBillHead_Link_FBaseMtrlScrapQty 
	 原始携带量：FBillHead_Link_FBaseProcScrapQtyOld 
	 修改携带量：FBillHead_Link_FBaseProcScrapQty 
	 原始携带量：FBillHead_Link_FBaseWBInspectQtyOld 
	 修改携带量：FBillHead_Link_FBaseWBInspectQty 
	 原始携带量：FBillHead_Link_FBaseUnQuaSalQtyOld 
	 修改携带量：FBillHead_Link_FBaseUnQuaSalQty 
	 原始携带量：FBillHead_Link_FBaseIncDefectQtyOld 
	 修改携带量：FBillHead_Link_FBaseIncDefectQty 
	 原始携带量：FBillHead_Link_FBaseProDefectQtyOld 
	 修改携带量：FBillHead_Link_FBaseProDefectQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QM_QCWriteBack","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FEntryId":0,"FBillNo":"","FSrcBillType":"","FSrcBillNo":"","FQCBusinessType":"","FMaterialId":{"FNUMBER":""},"FInspectResult":"","FSampleDamageBearer":"","FBaseUnitId":{"FNumber":""},"FBaseInspectQty":0,"FBaseSampleDamageQty":0,"FBaseWBInspectQty":0,"FPrdLineLocation":{"FLOCATIONCODE":""},"FBaseUnQuaSalQty":0,"FSrcInterId":0,"FSrcEntryId":0,"FSrcEntrySeq":0,"FNewExpiryDate":"1900-01-01"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QM_QCWriteBack","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QM_QCWriteBack","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QM_QCWriteBack","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QM_QCWriteBack","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QM_QCWriteBack","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("QM_QCWriteBack","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QM_QCWriteBack"}");

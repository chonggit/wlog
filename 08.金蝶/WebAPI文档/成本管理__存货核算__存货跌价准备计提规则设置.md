# 存货跌价准备计提规则设置 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 存货跌价准备计提规则设置
...
client.Delete("HS_ProvisionRuleSettings","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("HS_ProvisionRuleSettings","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("HS_ProvisionRuleSettings","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FProvisionDime":"","FProvisionMode":"","FInventoryAgeDivide":"","FNETREALIZABLESOURCE":"","FDAYDIVIDE":"","FDAYSTAGNANTPERIOD":"","FEntity":[{"FEntryID":0,"FMATERIALID":{"FNUMBER":""},"FSTOCKID":{"FNUMBER":""},"FEXPIRE":0,"FMATERIALTYPEID":{"FNUMBER":""},"FAge1":0,"FAge2":0,"FAge3":0,"FAge4":0,"FAge5":0,"FAge6":0,"FAge7":0,"FAge8":0,"FAge9":0,"FAge10":0,"FPROVISIONRATE":0,"FRATE":0,"FUNITNETREALIZABLE":0}]}}");
...
单据头：FBillHead 
	 ...
	 计提维度：FProvisionDime  (必填项)
	 库龄划分：FInventoryAgeDivide 
	 计提方式：FProvisionMode  (必填项)
	 审核人：FAuditorID 
	 审核日期：FAuditDate 
	 已生成库龄维度：FISGenerateAgeDime 
	 可变现净值来源：FNETREALIZABLESOURCE 
	 币别：FCurrencyID 
	 到期天数划分：FDAYDIVIDE 
	 呆滞期天数划分：FDAYSTAGNANTPERIOD 
比率设置：FEntity 
	 实体主键：FEntryID 
	 物料编码：FMATERIALID 
	 物料名称：FMATERIALNAME 
	 ...
	 库龄9：FAge9 
	 库龄10：FAge10 
	 仓库使用组织：FSTOCKUSEORGID 
	 计算比率：FPROVISIONRATE 
	 费率：FRATE 
	 规格型号：FMATERIALMODEL 
	 单位可变现净值：FUNITNETREALIZABLE 
	 已过期：FEXPIRE 
	 存货类别编码：FMATERIALTYPEID 
	 存货类别名称：FMATERIALTYPENAME 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("HS_ProvisionRuleSettings","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FProvisionDime":"","FProvisionMode":"","FInventoryAgeDivide":"","FNETREALIZABLESOURCE":"","FDAYDIVIDE":"","FDAYSTAGNANTPERIOD":"","FEntity":[{"FEntryID":0,"FMATERIALID":{"FNUMBER":""},"FSTOCKID":{"FNUMBER":""},"FEXPIRE":0,"FMATERIALTYPEID":{"FNUMBER":""},"FAge1":0,"FAge2":0,"FAge3":0,"FAge4":0,"FAge5":0,"FAge6":0,"FAge7":0,"FAge8":0,"FAge9":0,"FAge10":0,"FPROVISIONRATE":0,"FRATE":0,"FUNITNETREALIZABLE":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("HS_ProvisionRuleSettings","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("HS_ProvisionRuleSettings","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("HS_ProvisionRuleSettings","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("HS_ProvisionRuleSettings","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"HS_ProvisionRuleSettings"}");

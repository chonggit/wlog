# 组织间结算价目表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 组织间结算 > 组织间结算价目表
...
| 业务失效 | EntryUnEffective | 1699 |
| 取消业务失效 | EntryEffective | 1697 |
| 行审核 | RowAudit | 1691 |
| 行反审核 | RowUnAudit | 1693 |
| 整单提交 | WholeSubmit | 1616 |
| 整单审核 | WholeAudit | 1888 |
| 整单反审核 | WholeUnAudit | 1773 |
| 整单部分审核 | PartUnAudit | 1773 |
| 批量保存 | BatchSave | 3052 |
...
client.Delete("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IOS_PriceList","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IOS_PriceList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FAuditStatus":"","FNumber":"","FIsIncludedTax":"false","FName":"","FDescription":"","FPRICETYPE":"","FCURRENCYID":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FEffectiveDATE":"1900-01-01","FEXPIRYDATE":"1900-01-01","F_xhfz_JQBL":0,"F_xhfz_BDBL":0,"FEntity":[{"FEntryID":0,"FMATERIALID":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FAuxpropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FTRADETYPE":"","FLot":{"FNumber":""},"FBomId":{"FNUMBER":""},"FMTONO":"","FPRICEUNITID":{"FNumber":""},"FPRICEBASE":0,"FPrice":0,"FTaxPrice":0,"FTaxRate":0,"FIsFreeGift":"false","F_ora_Decimal":0,"FEntryEffectiveDate":"1900-01-01","FEntryExpriyDate":"1900-01-01","FRowAuditStatus":"","FBaseUnitID":{"FNumber":""},"FBaseUnitPrice":0}],"FEntityAcctSys":[{"FEntryID":0,"FIsEnable":"false","FACCTSysId":{"FNumber":""}}]}}");
...
基本信息：FBillHead 
	 ...
	 编码：FNumber 
	 备注：FDescription 
	 核算组织：FCreateOrgId  (必填项)
	 使用组织：FUseOrgId  (必填项)
	 创建人：FCreatorId 
	 最后修改人：FModifierId 
	 创建日期：FCreateDate 
	 最后修改日期：FModifyDate 
	 价目表对象：FPRICETYPE  (必填项)
	 币别：FCURRENCYID  (必填项)
	 生效日：FEffectiveDATE 
	 失效日：FEXPIRYDATE 
	 审核日期：FApproveDate 
...
明细信息：FEntity 
	 ...
	 交易类型：FTRADETYPE  (必填项)
	 业务类型：FBUSINESSTYPE 
	 定价单位：FPRICEUNITID  (必填项)
	 价格系数：FPRICEBASE 
	 价格：FPrice 
	 生效日期：FEntryEffectiveDate 
	 失效日期：FEntryExpriyDate 
	 业务失效：FForbidStatusEn 
	 业务失效人：FForbidderIdEn 
	 业务失效日期：FForbidDateEn 
	 存货类别：FMaterialTypeId 
	 行审核状态：FRowAuditStatus  (必填项)
	 含税单价：FTaxPrice 
	 税率%：FTaxRate 
	 免费：FIsFreeGift 
	 BOM版本：FBomId 
	 批号：FLot 
	 基本计量单位：FBaseUnitID 
	 基本单位不含税单价：FBaseUnitPrice 
	 计划跟踪号：FMTONO 
	 物料分组编码：FMaterialGroupId 
	 物料分组名称：FMaterialGroupName 
	 USD/KG：F_ora_Decimal 
适用会计核算体系：FEntityAcctSys 
	 实体主键：FEntryID 
	 启用：FIsEnable 
	 编码：FACCTSysId 
	 名称：FACCTSysName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IOS_PriceList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FAuditStatus":"","FNumber":"","FIsIncludedTax":"false","FName":"","FDescription":"","FPRICETYPE":"","FCURRENCYID":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FEffectiveDATE":"1900-01-01","FEXPIRYDATE":"1900-01-01","F_xhfz_JQBL":0,"F_xhfz_BDBL":0,"FEntity":[{"FEntryID":0,"FMATERIALID":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FAuxpropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FTRADETYPE":"","FLot":{"FNumber":""},"FBomId":{"FNUMBER":""},"FMTONO":"","FPRICEUNITID":{"FNumber":""},"FPRICEBASE":0,"FPrice":0,"FTaxPrice":0,"FTaxRate":0,"FIsFreeGift":"false","F_ora_Decimal":0,"FEntryEffectiveDate":"1900-01-01","FEntryExpriyDate":"1900-01-01","FRowAuditStatus":"","FBaseUnitID":{"FNumber":""},"FBaseUnitPrice":0}],"FEntityAcctSys":[{"FEntryID":0,"FIsEnable":"false","FACCTSysId":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","UnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","Effective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","EntryUnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","EntryEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","RowAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","RowUnAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IOS_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("IOS_PriceList","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IOS_PriceList"}");

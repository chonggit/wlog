# 预算汇总表样式方案 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 预算汇总表样式方案
...
client.Delete("BM_BudgetSumScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_BudgetSumScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_BudgetSumScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FRPTSCHEMEID":{"FNUMBER":""},"FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FBWBCurrencyID":{"FNumber":""},"FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FSPLITSHOWNAME":"false","FSHOWNAMEPOSITION":"false","FCURRENCYID":"","FBUDGETORGID":"","FISMULORG":"false","FSumSchemeType":"","FSUMREPORTREMARK":"false","FColDimensionEntry":[{"FEntryID":0,"FColDimensionID":{"FNumber":""},"FColFilterName":"","FColFilterKey":"","FColFilterNameDesc":"","FColIsDimensionSum":"false","FColDimensionFormId":"","FColDimEffectKey":"","FColDimEffectName":"","FColDimEffectNameDesc":"","FColDimPropNames":"","FColDimPropFields":""}],"FRowDimensionEntry":[{"FEntryID":0,"FRowDimensionID":{"FNumber":""},"FRowFilterName":"","FRowFilterKey":"","FRowFilterNameDesc":"","FRowIsDimensionSum":"false","FRowDimensionFormId":"","FRowDimEffectKey":"","FRowDimEffectName":"","FRowDimEffectNameDesc":"","FRowDimPropNames":"","FRowDimPropFields":""}],"FDimensionEntry":[{"FEntryID":0,"FDimensionID":{"FNumber":""},"FFilterName":"","FFilterKey":"","FFilterNameDesc":"","FIsDimensionSum":"false","FDimensionFormId":"","FDimEffectKey":"","FDimEffectName":"","FDimEffectNameDesc":"","FDimensionPosition":"","FDimPropNames":"","FDimPropFields":""}],"FDataTypeEntry":[{"FEntryID":0,"FItemDataType":{"FNUMBER":""},"FBusinessType":{"FNUMBER":""}}],"FActualDataTypeEntry":[{"FEntryID":0,"FItemDataTypeActual":{"FNUMBER":""},"FBusinessTypeActual":{"FNUMBER":""},"FDataTypeActual":"","FActualFillType":""}]}}");
        ...
        "FColDimensionEntry": [
            {
                ...
                "FColFilterKey": "",
                "FColFilterNameDesc": "",
                "FColIsDimensionSum": "false",
                "FColDimensionFormId": "",
                "FColDimEffectKey": "",
                "FColDimEffectName": "",
                "FColDimEffectNameDesc": "",
                "FColDimPropNames": "",
                "FColDimPropFields": ""
            }
        ],
        "FRowDimensionEntry": [
            {
                ...
                "FRowFilterKey": "",
                "FRowFilterNameDesc": "",
                "FRowIsDimensionSum": "false",
                "FRowDimensionFormId": "",
                "FRowDimEffectKey": "",
                "FRowDimEffectName": "",
                "FRowDimEffectNameDesc": "",
                "FRowDimPropNames": "",
                "FRowDimPropFields": ""
            }
        ],
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 描述：FDescription 
	 预算币别：FCURRENCYID  (必填项)
	 组织架构版本：FBUDGETORGID  (必填项)
	 多组织预算表：FISMULORG 
	 模板样式方案：FRPTSCHEMEID  (必填项)
	 审核日期：FAuditDate 
	 禁用人：FForbidderId 
	 审核人：FAuditorID 
	 禁用日期：FForbidDate 
	 样式方案类型：FSumSchemeType 
	 本位币别：FBWBCurrencyID 
	 显示备注信息：FSUMREPORTREMARK 
	 显示属性和维度分开显示：FSPLITSHOWNAME 
	 显示属性在维度前：FSHOWNAMEPOSITION 
列维度：FColDimensionEntry 
	 实体主键：FEntryID 
	 维度：FColDimensionID 
	 维度范围：FColFilterName 
	 维度范围条件：FColFilterKey 
	 汇总：FColIsDimensionSum 
	 维度范围多语言描述：FColFilterNameDesc 
	 维度业务对象ID：FColDimensionFormId 
	 维度过滤条件：FColDimEffectKey 
	 维度过滤：FColDimEffectName 
	 维度过滤名称多语言：FColDimEffectNameDesc 
	 显示属性：FColDimPropNames 
	 属性对应字段：FColDimPropFields 
行维度：FRowDimensionEntry 
	 实体主键：FEntryID 
	 维度：FRowDimensionID 
	 维度范围：FRowFilterName 
	 维度范围条件：FRowFilterKey 
	 汇总：FRowIsDimensionSum 
	 维度范围多语言描述：FRowFilterNameDesc 
	 维度业务对象ID：FRowDimensionFormId 
	 维度过滤条件：FRowDimEffectKey 
	 维度过滤：FRowDimEffectName 
	 维度过滤名称多语言：FRowDimEffectNameDesc 
	 显示属性：FRowDimPropNames 
	 属性对应字段：FRowDimPropFields 
行列维度：FDimensionEntry 
	 实体主键：FEntryID 
	 维度：FDimensionID 
	 维度范围：FFilterName 
	 维度范围条件：FFilterKey 
	 汇总：FIsDimensionSum 
	 维度范围多语言描述：FFilterNameDesc 
	 维度业务对象ID：FDimensionFormId 
	 维度过滤条件：FDimEffectKey 
	 维度过滤条件：FDimEffectName 
	 维度过滤名称多语言：FDimEffectNameDesc 
	 维度类型：FDimensionPosition 
	 显示属性：FDimPropNames 
	 属性对应字段：FDimPropFields 
项目数据类型：FDataTypeEntry 
	 实体主键：FEntryID 
	 项目数据类型：FItemDataType 
	 预算业务类型：FBusinessType 
辅助编制区域项目数据类型：FActualDataTypeEntry 
	 实体主键：FEntryID 
	 项目数据类型：FItemDataTypeActual 
	 预算业务类型：FBusinessTypeActual 
	 数据种类：FDataTypeActual 
	 显示在预算数：FActualFillType 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_BudgetSumScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FRPTSCHEMEID":{"FNUMBER":""},"FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FBWBCurrencyID":{"FNumber":""},"FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FSPLITSHOWNAME":"false","FSHOWNAMEPOSITION":"false","FCURRENCYID":"","FBUDGETORGID":"","FISMULORG":"false","FSumSchemeType":"","FSUMREPORTREMARK":"false","FColDimensionEntry":[{"FEntryID":0,"FColDimensionID":{"FNumber":""},"FColFilterName":"","FColFilterKey":"","FColFilterNameDesc":"","FColIsDimensionSum":"false","FColDimensionFormId":"","FColDimEffectKey":"","FColDimEffectName":"","FColDimEffectNameDesc":"","FColDimPropNames":"","FColDimPropFields":""}],"FRowDimensionEntry":[{"FEntryID":0,"FRowDimensionID":{"FNumber":""},"FRowFilterName":"","FRowFilterKey":"","FRowFilterNameDesc":"","FRowIsDimensionSum":"false","FRowDimensionFormId":"","FRowDimEffectKey":"","FRowDimEffectName":"","FRowDimEffectNameDesc":"","FRowDimPropNames":"","FRowDimPropFields":""}],"FDimensionEntry":[{"FEntryID":0,"FDimensionID":{"FNumber":""},"FFilterName":"","FFilterKey":"","FFilterNameDesc":"","FIsDimensionSum":"false","FDimensionFormId":"","FDimEffectKey":"","FDimEffectName":"","FDimEffectNameDesc":"","FDimensionPosition":"","FDimPropNames":"","FDimPropFields":""}],"FDataTypeEntry":[{"FEntryID":0,"FItemDataType":{"FNUMBER":""},"FBusinessType":{"FNUMBER":""}}],"FActualDataTypeEntry":[{"FEntryID":0,"FItemDataTypeActual":{"FNUMBER":""},"FBusinessTypeActual":{"FNUMBER":""},"FDataTypeActual":"","FActualFillType":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BudgetSumScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BudgetSumScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_BudgetSumScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_BudgetSumScheme"}");

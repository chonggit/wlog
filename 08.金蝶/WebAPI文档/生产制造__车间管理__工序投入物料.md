# 工序投入物料 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 工序投入物料
...
client.Delete("SFC_InputMaterial","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_InputMaterial","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgId":{"FNumber":""},"FScanCode":"","FBillNo":"","FMoNumber":"","FMoRowNumber":"","FProductId":{"FNUMBER":""},"FOptPlanNo":"","FSeqNumber":"","FOperDescription":"","FOperNumber":0,"FProcessId":0,"FPrdTrackNo":"","FOptRptEntryId":0,"FIsReworkRpt":"false","FSNNumberHead":{"FNUMBER":""},"FLotHead":{"FNumber":""},"FParMaterialType":"","FIsProductScrap":"false","FPrdOrgId":{"FNumber":""},"FTreeEntity":[{"FEntryID":0,"FMaterialType":"","FRowId":"","FParentRowId":"","FRowExpandType":0,"FMaterialId":{"FNUMBER":""},"FAuxProperty":{"FAUXPROPERTY__FF100001":{"FNumber":""},"FAUXPROPERTY__FF100002":{"FNumber":""},"FAUXPROPERTY__FF100003":{"FNumber":""},"FAUXPROPERTY__FF100005":{"FNumber":""},"FAUXPROPERTY__FF100010":{"FNumber":""},"FAUXPROPERTY__FF100007":{"FNumber":""},"FAUXPROPERTY__FF100008":{"FNumber":""}},"FQty":0,"FUnitID":{"FNumber":""},"FLot":{"FNumber":""},"FSNNumber":{"FNUMBER":""},"FSNUnit":{"FNumber":""},"FBaseQty":0,"FBaseUnitID":{"FNumber":""},"FStockOrgId":{"FNumber":""},"FIsSubstituted":"false","FUnusualMtrl":"","FReworkHandleType":"","FMaterialState":"","FDefectType":{"FNUMBER":""},"FInputProcessId":{"FNUMBER":""},"FPreLoadTrackNo":"","FKeyMaterialBadRptBillNo":"","FKeyMaterialBadRptSeq":0,"FScrapOptRptEntryId":0,"FEmpName":"","FInputTime":"1900-01-01","FPreLoadProcessJson":"","FOriginalRowId":""}]}}");
        ...
        "FTreeEntity": [
            {
                ...
                "FPreLoadTrackNo": "",
                "FKeyMaterialBadRptBillNo": "",
                "FKeyMaterialBadRptSeq": 0,
                "FScrapOptRptEntryId": 0,
                "FEmpName": "",
                "FInputTime": "1900-01-01",
                "FPreLoadProcessJson": "",
                "FOriginalRowId": ""
            }
        ]
...
单据头：FBillHead 
	 ...
	 产品编码：FProductId 
	 产品名称：FPrdName 
	 规格型号：FPrdSpecification 
	 工序计划：FOptPlanNo 
	 序列：FSeqNumber 
	 产品跟踪号：FPrdTrackNo 
	 工序：FOperNumber 
	 工序汇报分录内码：FOptRptEntryId 
	 作业：FProcessId 
	 加工组织：FOrgId 
	 ...
	 序列号：FSNNumberHead 
	 批号：FLotHead 
	 父项物料类型：FParMaterialType 
	 产品报废：FIsProductScrap 
	 关键件扫描：FScanCode 
	 生产组织：FPrdOrgId 
树形单据体：FTreeEntity 
	 实体主键：FEntryID 
	 ...
	 序列号：FSNNumber 
	 发料组织：FStockOrgId 
	 被替换标志：FIsSubstituted 
	 异常投料：FUnusualMtrl 
	 关键件不良单据分录内码：FScrapOptRptEntryId 
	 物料状态：FMaterialState 
	 返修处理类型：FReworkHandleType 
	 缺陷类型：FDefectType 
	 操作工：FEmpName 
	 投料时间：FInputTime 
	 投料作业：FInputProcessId 
	 预装跟踪号：FPreLoadTrackNo 
	 关键件不良单据编号：FKeyMaterialBadRptBillNo 
	 关键件不良单据行号：FKeyMaterialBadRptSeq 
	 原行标识：FOriginalRowId 
	 完整投料作业清单：FPreLoadProcessJson 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_InputMaterial","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgId":{"FNumber":""},"FScanCode":"","FBillNo":"","FMoNumber":"","FMoRowNumber":"","FProductId":{"FNUMBER":""},"FOptPlanNo":"","FSeqNumber":"","FOperDescription":"","FOperNumber":0,"FProcessId":0,"FPrdTrackNo":"","FOptRptEntryId":0,"FIsReworkRpt":"false","FSNNumberHead":{"FNUMBER":""},"FLotHead":{"FNumber":""},"FParMaterialType":"","FIsProductScrap":"false","FPrdOrgId":{"FNumber":""},"FTreeEntity":[{"FEntryID":0,"FMaterialType":"","FRowId":"","FParentRowId":"","FRowExpandType":0,"FMaterialId":{"FNUMBER":""},"FAuxProperty":{"FAUXPROPERTY__FF100001":{"FNumber":""},"FAUXPROPERTY__FF100002":{"FNumber":""},"FAUXPROPERTY__FF100003":{"FNumber":""},"FAUXPROPERTY__FF100005":{"FNumber":""},"FAUXPROPERTY__FF100010":{"FNumber":""},"FAUXPROPERTY__FF100007":{"FNumber":""},"FAUXPROPERTY__FF100008":{"FNumber":""}},"FQty":0,"FUnitID":{"FNumber":""},"FLot":{"FNumber":""},"FSNNumber":{"FNUMBER":""},"FSNUnit":{"FNumber":""},"FBaseQty":0,"FBaseUnitID":{"FNumber":""},"FStockOrgId":{"FNumber":""},"FIsSubstituted":"false","FUnusualMtrl":"","FReworkHandleType":"","FMaterialState":"","FDefectType":{"FNUMBER":""},"FInputProcessId":{"FNUMBER":""},"FPreLoadTrackNo":"","FKeyMaterialBadRptBillNo":"","FKeyMaterialBadRptSeq":0,"FScrapOptRptEntryId":0,"FEmpName":"","FInputTime":"1900-01-01","FPreLoadProcessJson":"","FOriginalRowId":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_InputMaterial","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_InputMaterial"}");

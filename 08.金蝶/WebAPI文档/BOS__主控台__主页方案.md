...
client.Delete("BOS_H5CardLayoutSolution","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BOS_H5CardLayoutSolution","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FLayoutName":"","FIsAllowEdit":"","FBillNo":"","FWorkName":"","FIsDefaultLayout":"","FIsOnlySelf":"","FIsStdConsole":"false","FSTDODEID":"","FSTDCONSOLEFORMID":"","FPERMISSIONID":"","FIsAutoCardAlign":"false","FIsStdConsoleToGUI":"false","FPowerObject":{"FID":""},"FCardDetail":[{"FEntryID":0,"FCARDID":{"FNUMBER":""},"FParameters":"","FCardColumnLayout":[{"FColumnLayoutID":0,"FColumnLayoutCols":0,"FColumnLayoutName":"","FColumnIndex":0,"FColumnOrder":0,"FColumnColsSum":0,"FCardColsSum":0}]}],"FEntityUser":[{"FENTRYID":0,"FUserIdList":{"FUSERACCOUNT":""}}],"FEntryRole":[{"FENTRYID":0,"FUserRoleId":{"FNUMBER":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FSTDCONSOLEFORMID": "",
        "FPERMISSIONID": "",
        "FIsAutoCardAlign": "false",
        "FIsStdConsoleToGUI": "false",
        "FPowerObject": {
            "FID": ""
        },
        "FCardDetail": [
...
单据头：FBillHead 
	 实体主键：FID 
	 方案编码：FBillNo 
	 方案状态：FDocumentStatus 
	 允许编辑：FIsAllowEdit 
	 工作台名称：FWorkName 
	 方案名称：FLayoutName  (必填项)
	 默认主页：FIsDefaultLayout 
	 是否另存个人方案：FIsOnlySelf 
	 禁用日期：FFORBIDDENDate 
	 禁用人：FForbiddenUserId 
	 修改日期：FModifyDate 
	 创建人：FCreateUserId 
	 修改人：FModifierUserId 
	 创建日期：FCreateDate 
	 ...
	 工作台主页：FIsStdConsole 
	 领域ID：FSTDODEID 
	 领域主控表单ID：FSTDCONSOLEFORMID 
	 权限项ID：FPERMISSIONID 
	 卡片自动对齐：FIsAutoCardAlign 
	 客户端显示方案类型：FIsStdConsoleToGUI 
	 业务对象：FPowerObject 
卡片明细：FCardDetail 
	 实体主键：FEntryID 
	 卡片名称：FCARDID 
	 ...
	 缩略图：FCardThumbnail 
	 参数：FParameters 
	 卡片禁用状态：FCardForbidStatus 
卡片列布局：FCardColumnLayout 
	 实体主键：FColumnLayoutID 
	 布局列数：FColumnLayoutCols 
	 列布局名称：FColumnLayoutName 
	 显示所在列：FColumnIndex 
	 显示顺序：FColumnOrder 
	 布局列占位列数量：FColumnColsSum 
	 卡片占位列数量：FCardColsSum 
用户：FEntityUser 
	 实体主键：FENTRYID 
	 用户：FUserIdList 
	 分配用户日期：FModifyDateUser 
角色：FEntryRole 
	 实体主键：FENTRYID 
	 角色：FUserRoleId 
	 分配角色日期：FModifyDateRole 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BOS_H5CardLayoutSolution","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FLayoutName":"","FIsAllowEdit":"","FBillNo":"","FWorkName":"","FIsDefaultLayout":"","FIsOnlySelf":"","FIsStdConsole":"false","FSTDODEID":"","FSTDCONSOLEFORMID":"","FPERMISSIONID":"","FIsAutoCardAlign":"false","FIsStdConsoleToGUI":"false","FPowerObject":{"FID":""},"FCardDetail":[{"FEntryID":0,"FCARDID":{"FNUMBER":""},"FParameters":"","FCardColumnLayout":[{"FColumnLayoutID":0,"FColumnLayoutCols":0,"FColumnLayoutName":"","FColumnIndex":0,"FColumnOrder":0,"FColumnColsSum":0,"FCardColsSum":0}]}],"FEntityUser":[{"FENTRYID":0,"FUserIdList":{"FUSERACCOUNT":""}}],"FEntryRole":[{"FENTRYID":0,"FUserRoleId":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BOS_H5CardLayoutSolution","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BOS_H5CardLayoutSolution","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BOS_H5CardLayoutSolution","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BOS_H5CardLayoutSolution","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BOS_H5CardLayoutSolution","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BOS_H5CardLayoutSolution","Forbit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BOS_H5CardLayoutSolution","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BOS_H5CardLayoutSolution","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BOS_H5CardLayoutSolution"}");

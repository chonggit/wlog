# 凭证汇总表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 总账 > 凭证汇总表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2918 |
...
client.GetSysReportData("GL_Rpt_VoucherSummary","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAccountBook":{"FNumber":""},"FCurrency":"","FStartDate":"1900-01-01","FStartAcctLevel":"","FVoucherRange":"","FEndDate":"1900-01-01","FEndAcctLevel":"","FSHOWFULLNAME":"false","FEXCLUDEADJUSTVCH":"false","FVchGroupEntity":[{"FCheck":"false","FVoucherGroup":{"FNumber":""},"FMinNo":0,"FMaxNo":0}]}}");
...
五、字段说明：
	 ...
	 开始日期：FStartDate  (必填项)
	 至：FEndDate  (必填项)
	 科目级别：FStartAcctLevel 
	 至：FEndAcctLevel 
	 凭证范围：FVoucherRange  (必填项)

# 物料编码申请表 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 基础资料 > 物料编码申请表
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1468 |
| 分组信息查询 | QueryGroupInfo | 1181 |
| 分组删除 | GroupDelete | 1081 |
...
client.Delete("QRDO_MaterialApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QRDO_MaterialApply","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FApplyType":"","FDepartID":{"FNUMBER":""},"FApplyID":{"FStaffNumber":""},"FDate":"1900-01-01","FNote":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","F_ora_Combo":"","FShowNote":"","F_ora_Assistant":{"FNumber":""},"FSyncScope":[{"FNumber":""}],"FCheckUpdateNumber":"false","FHTBillNO":"","FSyncScopeText":"","FEntity":[{"FEntryID":0,"FMaterialNumber":"","FMaterialName":"","FMaterialModel":"","FBrand":"","FUnitID":{"FNUMBER":""},"FCategoryID":{"FNUMBER":""},"FAuxUnitID":{"FNUMBER":""},"FMaterialGroup":{"FNumber":""},"FLongPurDay":0,"FFixLeadTime":0,"FDefectRate":0,"FMaterialTexture":{"FNumber":""},"FNetWeight":0,"FGrossWeight":0,"FSecondaryClass":"","FIsSale":"false","FPrimaryClass":{"FNumber":""},"FCustMaterialNumber":{"FNUMBER":""},"FProductSecondaryClass":"","FProductThreeClass":"","FProductName":"","FProductTexture":"","FProductVer":"","FIsDeclare":"false","FContractMaterialNumber":"","FTextureModel":"","FCustomsMaterialNumber":"","FCustomsMaterialName":"","FCustomsProductName":"","FCustomsMaterialSource":{"FNumber":""},"FInvoiceName":"","FMainCustName":"","F_ora_Keyicode":"","FEntryNote":"","FSpecialNeed":{"FNumber":""},"FSpecialNeedtxt":"","FSFZY":"","FGLZY":{"FNUMBER":""},"FTU7Machine":"","FAssemblyPart":"","FMaterialProcess":"","FSampleMake":{"FNumber":""},"F_ora_PMC":{"FSTAFFNUMBER":""},"FSemiFinish":"","F_ora_CheckOnTime":"false"}]}}");
        ...
        "FEntity": [
            {
                ...
                "FProductSecondaryClass": "",
                "FProductThreeClass": "",
                "FProductName": "",
                "FProductTexture": "",
                "FProductVer": "",
                "FIsDeclare": "false",
                "FContractMaterialNumber": "",
                "FTextureModel": "",
                "FCustomsMaterialNumber": "",
                "FCustomsMaterialName": "",
                "FCustomsProductName": "",
                "FCustomsMaterialSource": {
                    "FNumber": ""
                },
                "FInvoiceName": "",
                "FMainCustName": "",
...
单据头：FBillHead 
	 ...
	 审核日期：FApproveDate 
	 申请类型：FApplyType  (必填项)
	 新增类型：F_ora_Combo  (必填项)
	 提示：FShowNote 
	 所属部门：F_ora_Assistant 
	 同步范围（禁用）：F_Synchro 
	 同步范围：FSyncScope  (必填项)
	 审核时更新物料编码：FCheckUpdateNumber 
	 汇通物料编码表编号：FHTBillNO 
	 同步范围显示：FSyncScopeText 
单据体：FEntity 
	 实体主键：FEntryID 
	 存货编码：FMaterialNumber 
	 存货名称：FMaterialName  (必填项)
	 规格型号：FMaterialModel 
	 最长采购周期（天）：FLongPurDay 
	 固定提前期（生产周期：FFixLeadTime 
	 不良率（%）：FDefectRate 
	 净重：FNetWeight 
	 毛重：FGrossWeight 
	 二级分类(商品名称)：FSecondaryClass 
	 成品二级分类：FProductSecondaryClass 
	 成品三级分类：FProductThreeClass 
	 成品名称：FProductName 
	 版本/REV：FProductVer 
	 合同料号：FContractMaterialNumber 
	 材质型号：FTextureModel 
	 海关编码：FCustomsMaterialNumber 
	 报关货物名称：FCustomsMaterialName 
	 报关商品编码：FCustomsProductName 
	 开票名称：FInvoiceName 
	 备注：FEntryNote 
	 是否销售：FIsSale 
	 可否报关：FIsDeclare 
	 ...
	 单位：FUnitID  (必填项)
	 材质：FMaterialTexture 
	 一级分类(大类名称)：FPrimaryClass 
	 报关材料来源：FCustomsMaterialSource 
	 客户编码：FCustMaterialNumber 
	 客户：FCustName 
	 品牌：FBrand 
	 科益自制编码：F_ora_Keyicode 
	 产品主要客户：FMainCustName 
	 材料名称：FProductTexture 
	 链接特殊需求：FSpecialNeed 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QRDO_MaterialApply","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FApplyType":"","FDepartID":{"FNUMBER":""},"FApplyID":{"FStaffNumber":""},"FDate":"1900-01-01","FNote":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","F_ora_Combo":"","FShowNote":"","F_ora_Assistant":{"FNumber":""},"FSyncScope":[{"FNumber":""}],"FCheckUpdateNumber":"false","FHTBillNO":"","FSyncScopeText":"","FEntity":[{"FEntryID":0,"FMaterialNumber":"","FMaterialName":"","FMaterialModel":"","FBrand":"","FUnitID":{"FNUMBER":""},"FCategoryID":{"FNUMBER":""},"FAuxUnitID":{"FNUMBER":""},"FMaterialGroup":{"FNumber":""},"FLongPurDay":0,"FFixLeadTime":0,"FDefectRate":0,"FMaterialTexture":{"FNumber":""},"FNetWeight":0,"FGrossWeight":0,"FSecondaryClass":"","FIsSale":"false","FPrimaryClass":{"FNumber":""},"FCustMaterialNumber":{"FNUMBER":""},"FProductSecondaryClass":"","FProductThreeClass":"","FProductName":"","FProductTexture":"","FProductVer":"","FIsDeclare":"false","FContractMaterialNumber":"","FTextureModel":"","FCustomsMaterialNumber":"","FCustomsMaterialName":"","FCustomsProductName":"","FCustomsMaterialSource":{"FNumber":""},"FInvoiceName":"","FMainCustName":"","F_ora_Keyicode":"","FEntryNote":"","FSpecialNeed":{"FNumber":""},"FSpecialNeedtxt":"","FSFZY":"","FGLZY":{"FNUMBER":""},"FTU7Machine":"","FAssemblyPart":"","FMaterialProcess":"","FSampleMake":{"FNumber":""},"F_ora_PMC":{"FSTAFFNUMBER":""},"FSemiFinish":"","F_ora_CheckOnTime":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QRDO_MaterialApply","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QRDO_MaterialApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QRDO_MaterialApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QRDO_MaterialApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QRDO_MaterialApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("QRDO_MaterialApply","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QRDO_MaterialApply"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("QRDO_MaterialApply","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("QRDO_MaterialApply","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("QRDO_MaterialApply","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

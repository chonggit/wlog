# 生产SMT上料表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 生产SMT上料表
...
client.Delete("SFC_PPBOMSMT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_PPBOMSMT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDescription":"","FPrdOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FMONumber":"","FMOEntrySeq":0,"FProductId":{"FNumber":""},"FMOQty":0,"FMOUnitId":{"FNumber":""},"FProcessId":{"FNUMBER":""},"FMoEntryMirror":{},"FMOId":0,"FMOEntryId":0,"FMOBaseUnitID":{"FNumber":""},"FMOBaseQty":0,"FEntity":[{"FEntryID":0,"FBOMSMTId":{"FNumber":""},"FCheckStatusEntry":"","FSubEntity":[{"FDetailID":0,"FROWID":"","FPARENTROWID":"","FROWEXPANDTYPE":"","FReplaceGroup":0,"FTable":"","FMaterialType":"","FTrack":"","FIsEnabled":"false","FMaterialID":{"FNUMBER":""},"FNumerator":0,"FDenominator":0,"FFeederSetEntryId":{"FNUMBER":""},"FNozzleModel":"","FLocation":"","FPartDirection":"","FUploadStatus":"","FCheckStatus":"","FCheckInfo":"","FPPBomId":0,"FPPBomEntryId":0,"FRemarks":"","FChildUnitID":{"FNumber":""},"FChildBaseUnitID":{"FNumber":""},"FBaseNumerator":0,"FBaseDenominator":0}]}]}}");
...
单据头：FBillHead 
	 ...
	 备注：FDescription 
	 生产组织：FPrdOrgId  (必填项)
	 产线：FProductLineId  (必填项)
	 生产订单编号：FMONumber  (必填项)
	 生产订单行号：FMOEntrySeq 
	 产品编码：FProductId 
	 产品名称：FProductName 
	 规格型号：FProductModel 
	 ...
	 生产单位：FMOUnitId 
	 作业：FProcessId 
	 生产订单镜像模型：FMoEntryMirror 
	 生产订单状态：FMoEntryStatus 
	 生产订单Id：FMOId 
	 生产订单分录Id：FMOEntryId 
	 基本计量单位：FMOBaseUnitID 
	 基本单位数量：FMOBaseQty 
上料表信息：FEntity 
	 实体主键：FEntryID 
	 站位表版本：FBOMSMTId  (必填项)
	 贴片机位置：FChipMounterLocation 
	 贴片机型号：FChipMounterModel 
	 程序名称：FProgramName 
	 数据检查：FCheckStatusEntry 
上料表明细：FSubEntity 
	 实体主键：FDetailID 
	 主键：FROWID 
	 父级内码：FPARENTROWID 
	 ...
	 数据检查信息：FCheckInfo 
	 用料清单Id：FPPBomId 
	 用料清单分录Id：FPPBomEntryId 
	 备注：FRemarks 
	 子项单位：FChildUnitID 
	 子项基本计量单位：FChildBaseUnitID 
	 基本单位用量分子：FBaseNumerator 
	 基本单位用量分母：FBaseDenominator 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_PPBOMSMT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDescription":"","FPrdOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FMONumber":"","FMOEntrySeq":0,"FProductId":{"FNumber":""},"FMOQty":0,"FMOUnitId":{"FNumber":""},"FProcessId":{"FNUMBER":""},"FMoEntryMirror":{},"FMOId":0,"FMOEntryId":0,"FMOBaseUnitID":{"FNumber":""},"FMOBaseQty":0,"FEntity":[{"FEntryID":0,"FBOMSMTId":{"FNumber":""},"FCheckStatusEntry":"","FSubEntity":[{"FDetailID":0,"FROWID":"","FPARENTROWID":"","FROWEXPANDTYPE":"","FReplaceGroup":0,"FTable":"","FMaterialType":"","FTrack":"","FIsEnabled":"false","FMaterialID":{"FNUMBER":""},"FNumerator":0,"FDenominator":0,"FFeederSetEntryId":{"FNUMBER":""},"FNozzleModel":"","FLocation":"","FPartDirection":"","FUploadStatus":"","FCheckStatus":"","FCheckInfo":"","FPPBomId":0,"FPPBomEntryId":0,"FRemarks":"","FChildUnitID":{"FNumber":""},"FChildBaseUnitID":{"FNumber":""},"FBaseNumerator":0,"FBaseDenominator":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_PPBOMSMT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SFC_PPBOMSMT","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SFC_PPBOMSMT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SFC_PPBOMSMT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SFC_PPBOMSMT","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("SFC_PPBOMSMT","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_PPBOMSMT","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_PPBOMSMT","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_PPBOMSMT","DoCheckData","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FDescription":"","FPrdOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FMONumber":"","FMOEntrySeq":0,"FProductId":{"FNumber":""},"FMOQty":0,"FMOUnitId":{"FNumber":""},"FProcessId":{"FNUMBER":""},"FMoEntryMirror":{},"FMOId":0,"FMOEntryId":0,"FMOBaseUnitID":{"FNumber":""},"FMOBaseQty":0,"FEntity":[{"FEntryID":0,"FBOMSMTId":{"FNumber":""},"FCheckStatusEntry":"","FSubEntity":[{"FDetailID":0,"FROWID":"","FPARENTROWID":"","FROWEXPANDTYPE":"","FReplaceGroup":0,"FTable":"","FMaterialType":"","FTrack":"","FIsEnabled":"false","FMaterialID":{"FNUMBER":""},"FNumerator":0,"FDenominator":0,"FFeederSetEntryId":{"FNUMBER":""},"FNozzleModel":"","FLocation":"","FPartDirection":"","FUploadStatus":"","FCheckStatus":"","FCheckInfo":"","FPPBomId":0,"FPPBomEntryId":0,"FRemarks":"","FChildUnitID":{"FNumber":""},"FChildBaseUnitID":{"FNumber":""},"FBaseNumerator":0,"FBaseDenominator":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SFC_PPBOMSMT","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_PPBOMSMT"}");

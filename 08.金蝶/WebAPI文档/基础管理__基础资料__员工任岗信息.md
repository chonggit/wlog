# 员工任岗信息 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 基础资料 > 员工任岗信息
...
client.Delete("BD_NEWSTAFF","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_NEWSTAFF","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_NEWSTAFF","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FSTAFFID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FPerson":{"FNumber":""},"FStaffNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FDept":{"FNumber":""},"FPosition":{"FNumber":""},"FStartDate":"1900-01-01","FEmpInfoId":{"FNumber":""},"FDescription":"","FOperatorType":"","FORGDEPTGROUP":{"FNUMBER":""},"FPOSTBILLEntity":{"FENTRYID":0,"FIsFirstPost":"false"},"FOtherEntity":{"FENTRYID":0},"FSHRMapEntity":{"FMAPID":0},"FStaffRole":[{"FSTAFFROLEID":0,"FRoleStaffID":0,"FIsStaffRole":""}],"FPostEntity":[{"FOperaType":""}]}}");
...
员工信息：FBillHead 
	 ...
	 员工任岗编码：FStaffNumber 
	 出生日期：FPDateBirth 
	 婚姻状况：FPMaritalStatus 
	 参加工作日期：FFStartWorkDate 
	 HR业务组织：FHrBoId 
	 员工：FEmpInfoId  (必填项)
	 任岗结束日期：FEndDate 
	 年龄：FAge 
	 员工临时表Id：FTempStaffId 
	 来源于s-HR：FIsSHR 
	 业务员类型：FOperatorType 
	 组织部门：FORGDEPTGROUP 
	 负责人岗位：FLeadPost 
角色信息：FStaffRole 
	 ...
	 角色名称：FStaffRoleName 
	 是否有效：FRoleEnable 
	 是否岗位默认角色：FIsDefaultRole 
	 对应岗位：FStaffPositionName 
	 员工内码：FRoleStaffID 
岗位信息单据体：FPostEntity 
	 实体主键： 
	 序号：FPostSeq 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_NEWSTAFF","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FSTAFFID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FPerson":{"FNumber":""},"FStaffNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FDept":{"FNumber":""},"FPosition":{"FNumber":""},"FStartDate":"1900-01-01","FEmpInfoId":{"FNumber":""},"FDescription":"","FOperatorType":"","FORGDEPTGROUP":{"FNUMBER":""},"FPOSTBILLEntity":{"FENTRYID":0,"FIsFirstPost":"false"},"FOtherEntity":{"FENTRYID":0},"FSHRMapEntity":{"FMAPID":0},"FStaffRole":[{"FSTAFFROLEID":0,"FRoleStaffID":0,"FIsStaffRole":""}],"FPostEntity":[{"FOperaType":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_NEWSTAFF","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_NEWSTAFF","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_NEWSTAFF","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_NEWSTAFF","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_NEWSTAFF","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_NEWSTAFF","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_NEWSTAFF","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_NEWSTAFF"}");

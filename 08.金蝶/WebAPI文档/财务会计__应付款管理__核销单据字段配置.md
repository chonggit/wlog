# 核销单据字段配置 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应付款管理 > 核销单据字段配置
...
client.Delete("AP_MatchConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AP_MatchConfig","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AP_MatchConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FUpdateField":"","FFiterField":"","FMatchFieldName":"","FEntryKey":"","FName":"","FBillFromId":{"FNumber":""},"FMatchType":"","FIsGenBill":"false","FBillDirection":"","FDefultSelect":"false","FAmountDir":"","FIsExpenseBill":"false","FIsAmtOpposite":"false","FMatchConfigEntry":[{"FEntryID":0,"FFieldId":{"FNumber":""},"FFieldKey":"","FDefluteValue":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDefultSelect": "false",
        "FAmountDir": "",
        "FIsExpenseBill": "false",
        "FIsAmtOpposite": "false",
        "FMatchConfigEntry": [
            {
                "FEntryID": 0,
                "FFieldId": {
...
单据头：FBillHead 
	 ...
	 编码：FNumber  (必填项)
	 更新字段：FUpdateField 
	 业务对象：FBillFromId  (必填项)
	 核销类型：FMatchType  (必填项)
	 过滤字段：FFiterField 
	 是否为核销产生单据：FIsGenBill 
	 单据方向：FBillDirection 
	 是否默认选择：FDefultSelect 
	 金额方向：FAmountDir  (必填项)
	 核销字段：FMatchFieldName 
	 是否为费用单据：FIsExpenseBill 
	 反写到核销记录的单体据标识：FEntryKey 
	 金额是否反向：FIsAmtOpposite 
	 参与核销上限：FMATCHMAXCOUNT 
单据体：FMatchConfigEntry 
	 实体主键：FEntryID 
	 核销字段：FFieldId 
	 单据字段key：FFieldKey 
	 默认值：FDefluteValue 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AP_MatchConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FUpdateField":"","FFiterField":"","FMatchFieldName":"","FEntryKey":"","FName":"","FBillFromId":{"FNumber":""},"FMatchType":"","FIsGenBill":"false","FBillDirection":"","FDefultSelect":"false","FAmountDir":"","FIsExpenseBill":"false","FIsAmtOpposite":"false","FMatchConfigEntry":[{"FEntryID":0,"FFieldId":{"FNumber":""},"FFieldKey":"","FDefluteValue":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AP_MatchConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AP_MatchConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AP_MatchConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AP_MatchConfig","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AP_MatchConfig","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AP_MatchConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AP_MatchConfig"}");

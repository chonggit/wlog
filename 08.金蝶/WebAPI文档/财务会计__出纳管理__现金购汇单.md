# 现金购汇单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 现金购汇单
...
client.Delete("CN_CASHFEXCHANGBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_CASHFEXCHANGBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FCOMMENT":"","FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FApproveDate":"1900-01-01","FCANCELLERID":{"FUserID":""},"FCANCELDATE":"1900-01-01","FPAYORGID":{"FNumber":""},"FBillTypeID":{"FNUMBER":""},"FCASHFEXCHANGBILLENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FOUTCASHACCTID":{"FNUMBER":""},"FINCASHACCTID":{"FNUMBER":""},"FINCURRENCYID":{"FNUMBER":""},"FINAMOUNT":0,"FOUTCURRENCYID":{"FNUMBER":""},"FOUTAMOUNT":0,"FINEXCHANGETYPE":0,"FOUTEXCHANGETYPE":0,"FCOMMENT_P":"","FINAMOUNTLOC":0,"FOUTAMOUNTLOC":0,"FSETTLENO":""}]}}");
...
现金购汇明细：FCASHFEXCHANGBILLENTRY 
	 实体主键：FEntryID 
	 结算方式：FSETTLETYPEID  (必填项)
	 转出现金账号：FOUTCASHACCTID 
	 转入现金账号：FINCASHACCTID 
	 转入币别：FINCURRENCYID  (必填项)
	 转入金额：FINAMOUNT 
	 转出币别：FOUTCURRENCYID  (必填项)
	 转出金额：FOUTAMOUNT 
	 转入汇率：FINEXCHANGETYPE 
	 转出汇率：FOUTEXCHANGETYPE 
	 摘要：FCOMMENT_P 
	 转入本位币金额：FINAMOUNTLOC 
	 转出本位币金额：FOUTAMOUNTLOC 
	 结算号：FSETTLENO 
	 是否登账：FISPOST 
	 登账日期：FPOSTDATE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_CASHFEXCHANGBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FCOMMENT":"","FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FApproveDate":"1900-01-01","FCANCELLERID":{"FUserID":""},"FCANCELDATE":"1900-01-01","FPAYORGID":{"FNumber":""},"FBillTypeID":{"FNUMBER":""},"FCASHFEXCHANGBILLENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FOUTCASHACCTID":{"FNUMBER":""},"FINCASHACCTID":{"FNUMBER":""},"FINCURRENCYID":{"FNUMBER":""},"FINAMOUNT":0,"FOUTCURRENCYID":{"FNUMBER":""},"FOUTAMOUNT":0,"FINEXCHANGETYPE":0,"FOUTEXCHANGETYPE":0,"FCOMMENT_P":"","FINAMOUNTLOC":0,"FOUTAMOUNTLOC":0,"FSETTLENO":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_CASHFEXCHANGBILL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_CASHFEXCHANGBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_CASHFEXCHANGBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_CASHFEXCHANGBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_CASHFEXCHANGBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_CASHFEXCHANGBILL","Cancle","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_CASHFEXCHANGBILL"}");

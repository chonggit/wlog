# 在产品分配标准设置 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 在产品分配标准设置

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3886 |
...
参数FieldKeys显示列：
	 成本中心编码：FCOSTCENTERID_FNumber 
	 成本中心名称：FCOSTCENTERID_FName 
	 综合分配标准：FAlloStd 

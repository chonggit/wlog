# 维修报价单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 维修报价单
...
client.Save("ora_PurchaseQuotation","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FOfferDate":"1900-01-01","F_Remarks":"","F_RepairReqNo":"","F_Department":"","F_Applicant":"","F_Purchaser":"","F_Vendor":{"FNUMBER":""},"F_NewSupplier":"","FPurchaseOrgId":{"FNumber":""},"F_ZZOrganization":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"F_Currency":{"FNUMBER":""},"F_ora_Entity":[{"FEntryID":0,"F_ItemCode":{"FNUMBER":""},"F_MaterialName":"","F_MaterialModel":"","F_ora_UnitID":{"FNumber":""},"F_Quantity":0,"F_Price":0,"F_Amount":0,"F_DetailsRemarks":"","F_RMBPrice":0,"F_RepairReqIRowNo":"","F_RMBAmount":0}]}}");
...
单据头：FBillHead 
	 ...
	 关闭状态：FCloseStatus 
	 备注：F_Remarks 
	 维修申请单单号：F_RepairReqNo  (必填项)
	 申请部门：F_Department 
	 申请人：F_Applicant 
	 采购员：F_Purchaser 
	 供应商：F_Vendor 
	 新供应商名称：F_NewSupplier 
	 采购组织：FPurchaseOrgId  (必填项)
	 需求组织：F_ZZOrganization 
	 单据类型：FBillTypeID  (必填项)
	 结算币别：F_Currency 
单据体：F_ora_Entity 
	 实体主键：FEntryID 
	 新物料名称：F_MaterialName 
	 新规格型号：F_MaterialModel 
	 维修申请单表体标志：F_RepairReqIRowNo  (必填项)
	 数量：F_Quantity 
	 含税单价：F_Price 
	 金额：F_Amount 
	 备注：F_DetailsRemarks 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("ora_PurchaseQuotation","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ora_PurchaseQuotation","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ora_PurchaseQuotation","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ora_PurchaseQuotation","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("ora_PurchaseQuotation","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ora_PurchaseQuotation","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FOfferDate":"1900-01-01","F_Remarks":"","F_RepairReqNo":"","F_Department":"","F_Applicant":"","F_Purchaser":"","F_Vendor":{"FNUMBER":""},"F_NewSupplier":"","FPurchaseOrgId":{"FNumber":""},"F_ZZOrganization":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"F_Currency":{"FNUMBER":""},"F_ora_Entity":[{"FEntryID":0,"F_ItemCode":{"FNUMBER":""},"F_MaterialName":"","F_MaterialModel":"","F_ora_UnitID":{"FNumber":""},"F_Quantity":0,"F_Price":0,"F_Amount":0,"F_DetailsRemarks":"","F_RMBPrice":0,"F_RepairReqIRowNo":"","F_RMBAmount":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ora_PurchaseQuotation","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ora_PurchaseQuotation","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ora_PurchaseQuotation","BillClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ora_PurchaseQuotation","BillUnClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ora_PurchaseQuotation","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ora_PurchaseQuotation"}");

# 库龄计算方案 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 库龄计算方案
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1466 |
| 分组信息查询 | QueryGroupInfo | 1179 |
| 分组删除 | GroupDelete | 1079 |
...
client.Delete("STK_InvAgeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("STK_InvAgeScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("STK_InvAgeScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FDescription":"","FModifyDate":"1900-01-01","FTimeRange":0,"FTimeUnit":"","FBeginTimeRule":"","FSalReturnRule":"","FMisDelReturnRule":"","FTrackLevel":0,"FOutDateBillType":"","FPrdReProcInstockRule":"","FRecToResultBill":"false","FClearResultBill":"false","FIncludeSubMatGroup":"false","FNonSpecInstock":"","FPlugIn":"","FMaxTCount":0,"FEntityIn":[{"FEntryID":0,"FInBillFormID":{"FID":""},"FInSequence":0}],"FEntityOrg":[{"FEntryID":0,"FStockOrgId":{"FNUMBER":""}}],"FEntityMatRange":[{"FEntryID":0,"FRgMaterialId":{"FNUMBER":""}}],"FEntityMatGroupRange":[{"FEntryID":0,"FRgMaterialGroupId":{"FNumber":""},"FRgSMaterialGroupId":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FTrackLevel": 0,
        "FOutDateBillType": "",
        "FPrdReProcInstockRule": "",
        "FRecToResultBill": "false",
        "FClearResultBill": "false",
...
单据头：FBillHead 
	 ...
	 统计期限：FTimeRange 
	 期限单位：FTimeUnit  (必填项)
	 库龄查询日期规则：FBeginTimeRule  (必填项)
	 销售退货账龄规则：FSalReturnRule  (必填项)
	 其他出库（退货）账龄规则：FMisDelReturnRule  (必填项)
	 最大计算次数：FTrackLevel 
	 最新出库日期统计单据范围：FOutDateBillType  (必填项)
	 返工生产入库账龄规则：FPrdReProcInstockRule  (必填项)
	 库龄计算成功时将计算结果同步至固定物理表：FRecToResultBill 
	 库龄计算时自动清除固定物理表库龄方案的相关记录：FClearResultBill 
	 包含下级物料分组：FIncludeSubMatGroup 
	 追溯至以下单据停止追溯：FNonSpecInstock 
	 计算插件：FPlugIn 
	 最大计算线程数：FMaxTCount 
入库流水顺序：FEntityIn 
	 实体主键：FEntryID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("STK_InvAgeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("STK_InvAgeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("STK_InvAgeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_InvAgeScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_InvAgeScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("STK_InvAgeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("STK_InvAgeScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"STK_InvAgeScheme"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("STK_InvAgeScheme","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("STK_InvAgeScheme","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("STK_InvAgeScheme","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

...
client.Delete("BD_OPERATORGROUPBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_OPERATORGROUPBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FOperatorGroupId":0,"FBillNo":"","FOperatorGroupType":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryId":0,"FBizOrgId":{"FNumber":""},"FNumber":"","FName":"","FOperatorGroupType_EYR":"","FIsUse":"false","Fdescription_ETY":"","FSubEntity":[{"FStaffId":{}}]}]}}");
...
五、字段说明：
基本信息：FBillHead 
	 实体主键：FOperatorGroupId 
	 单据编号：FBillNo 
	 业务组类型：FOperatorGroupType  (必填项)
	 描述：FDescription 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_OPERATORGROUPBILL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_OPERATORGROUPBILL","Delete(DoNothing)","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FOperatorGroupId":0,"FBillNo":"","FOperatorGroupType":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryId":0,"FBizOrgId":{"FNumber":""},"FNumber":"","FName":"","FOperatorGroupType_EYR":"","FIsUse":"false","Fdescription_ETY":"","FSubEntity":[{"FStaffId":{}}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_OPERATORGROUPBILL"}");

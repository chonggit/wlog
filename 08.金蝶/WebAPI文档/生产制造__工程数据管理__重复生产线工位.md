# 重复生产线工位 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 工程数据管理 > 重复生产线工位
...
client.Delete("ENG_RptPrdLineLocation","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ENG_RptPrdLineLocation","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ENG_RptPrdLineLocation","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FWIPWarehouse":{"FNUMBER":""},"FNumber":"","FName":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FFeedOrgId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FLocationCode":"","FLocationName":"","FTaktNumber":0,"FWIPBinLocation":{"FWIPBINLOCATION__FF100003":{"FNumber":""},"FWIPBINLOCATION__FF100005":{"FNumber":""},"FWIPBINLOCATION__FF100006":{"FNumber":""},"FWIPBINLOCATION__FF100007":{"FNumber":""},"FWIPBINLOCATION__FF100008":{"FNumber":""},"FWIPBINLOCATION__FF100009":{"FNumber":""},"FWIPBINLOCATION__FF100011":{"FNumber":""},"FWIPBINLOCATION__FF100014":{"FNumber":""}},"FPickingLocation":"false","FDefaultPickingLocation":"false","FOnLineLocation":"false","FCommonLocation":"false","FOffLineLocation":"false","FBackflushLocation":"false","FQualifiedSLocation":"false","FInspectLocation":"false","FQCSchemeId":{"FNUMBER":""},"FReportScrap":"false","FParentWIPWarehouse":{"FNUMBER":""},"FSubpackageLocation":"false","FMotherLocation":"","FVirtualStartLocation":"false","FOffsetTakt":0,"FLocationDescription":"","FTotalOffSetTakt":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FTaktNumber": 0,
                "FWIPBinLocation": {
                    "FWIPBINLOCATION__FF100003": {
                        "FNumber": ""
                    },
                    "FWIPBINLOCATION__FF100005": {
                        "FNumber": ""
                    },
                    "FWIPBINLOCATION__FF100006": {
                        "FNumber": ""
                    },
                    "FWIPBINLOCATION__FF100007": {
                        "FNumber": ""
                    },
                    "FWIPBINLOCATION__FF100008": {
                        "FNumber": ""
                    },
                    "FWIPBINLOCATION__FF100009": {
                        "FNumber": ""
                    },
                    "FWIPBINLOCATION__FF100011": {
                        "FNumber": ""
                    },
                    "FWIPBINLOCATION__FF100014": {
                        "FNumber": ""
                    }
                },
                "FPickingLocation": "false",
                "FDefaultPickingLocation": "false",
                "FOnLineLocation": "false",
                "FCommonLocation": "false",
                "FOffLineLocation": "false",
                "FBackflushLocation": "false",
                "FQualifiedSLocation": "false",
                "FInspectLocation": "false",
                "FQCSchemeId": {
                    "FNUMBER": ""
                },
                "FReportScrap": "false",
                ...
                "FSubpackageLocation": "false",
                "FMotherLocation": "",
                "FVirtualStartLocation": "false",
                "FOffsetTakt": 0,
...
单据头：FBillHead 
	 ...
	 禁用日期：FForbidDate 
	 审核日期：FApproveDate 
	 生产线编码：FProductLineId  (必填项)
	 工位物料在制仓库：FWIPWarehouse  (必填项)
	 发料组织：FFeedOrgId 
	 生产线名称：FProductLineName 
工位列表：FEntity 
	 实体主键：FEntryID 
	 工位编码：FLocationCode  (必填项)
	 工位名称：FLocationName  (必填项)
	 备注：FLocationDescription 
	 普通工位：FCommonLocation 
	 上线工位：FOnLineLocation 
	 下线工位：FOffLineLocation 
	 终检工位：FQualifiedSLocation 
	 倒冲在制工位：FBackflushLocation 
	 允许汇报废品：FReportScrap 
	 送料工位：FPickingLocation 
	 默认送料工位：FDefaultPickingLocation 
	 工位物料在制仓位：FWIPBinLocation 
	 100新豪仓位值集：FF100003
	 ...
	 300德上仓位值集：FF100014
	 表头工位物料在制仓库：FParentWIPWarehouse 
	 检验工位：FInspectLocation 
	 质检方案：FQCSchemeId 
	 加工节拍数：FTaktNumber 
	 分装工位：FSubpackageLocation 
	 对应母线工位编码：FMotherLocation 
	 虚拟起点工位：FVirtualStartLocation 
	 送料偏移节拍数：FOffsetTakt 
	 累计偏移节拍数：FTotalOffSetTakt 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ENG_RptPrdLineLocation","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FWIPWarehouse":{"FNUMBER":""},"FNumber":"","FName":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FFeedOrgId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FLocationCode":"","FLocationName":"","FTaktNumber":0,"FWIPBinLocation":{"FWIPBINLOCATION__FF100003":{"FNumber":""},"FWIPBINLOCATION__FF100005":{"FNumber":""},"FWIPBINLOCATION__FF100006":{"FNumber":""},"FWIPBINLOCATION__FF100007":{"FNumber":""},"FWIPBINLOCATION__FF100008":{"FNumber":""},"FWIPBINLOCATION__FF100009":{"FNumber":""},"FWIPBINLOCATION__FF100011":{"FNumber":""},"FWIPBINLOCATION__FF100014":{"FNumber":""}},"FPickingLocation":"false","FDefaultPickingLocation":"false","FOnLineLocation":"false","FCommonLocation":"false","FOffLineLocation":"false","FBackflushLocation":"false","FQualifiedSLocation":"false","FInspectLocation":"false","FQCSchemeId":{"FNUMBER":""},"FReportScrap":"false","FParentWIPWarehouse":{"FNUMBER":""},"FSubpackageLocation":"false","FMotherLocation":"","FVirtualStartLocation":"false","FOffsetTakt":0,"FLocationDescription":"","FTotalOffSetTakt":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ENG_RptPrdLineLocation","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ENG_RptPrdLineLocation","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ENG_RptPrdLineLocation","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_RptPrdLineLocation","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_RptPrdLineLocation","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ENG_RptPrdLineLocation","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Allocate("ENG_RptPrdLineLocation","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAllocate("ENG_RptPrdLineLocation","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ENG_RptPrdLineLocation","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ENG_RptPrdLineLocation"}");

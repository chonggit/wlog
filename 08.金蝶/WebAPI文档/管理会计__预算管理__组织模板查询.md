# 组织模板查询 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 组织模板查询
...
client.Submit("BM_OrgReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_OrgReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_OrgReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("BM_OrgReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_OrgReport","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FROWINDEX":0,"FSampleID":{"FNUMBER":""},"FCycleID":"","FOrgID":{"FNUMBER":""},"FTypeClass":"","FOrgType":"","FDOCUMENTSTATUS":"","FSchemeID":{"FNumber":""},"FRateTypeId":{"FNumber":""},"FORBIDSTATUS":"","FDeptOrgIDTem":{"FNUMBER":""},"FMultiDeptOrgID":{"FNumber":""},"FStyleType":"","FEntryOrgId":{"FNUMBER":""},"FSAMPLENUMBER":"","FIsJsonReport":"false"}}");
...
单据头：FBillHead 
	 ...
	 周期：FCycleID  (必填项)
	 组织类型：FOrgType 
	 组织部门名称(暂时隐藏)：FDeptOrgIDTem 
	 状态：FDOCUMENTSTATUS  (必填项)
	 汇率类型：FRateTypeId 
	 所属组织：FOrgID 
	 禁用状态：FORBIDSTATUS 
	 预算组织：FMultiDeptOrgID 
	 组织类别：FTypeClass 
	 报表样式：FStyleType 
	 预算组织：FEntryOrgId 
	 编码：FSAMPLENUMBER 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_OrgReport"}");

# 资金调拨还款统计表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 资金调拨还款统计表
...
client.GetSysReportData("CN_FundsTransferRepayRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FCurrencyIds":"","FMyCurrency":"false","FPayOrgID":[{"FNumber":""}],"FNotAudit":"false","FReceiveOrgId":[{"FNumber":""}],"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FSettleTypeId":[{"FNumber":""}],"FSumPayOrg":"false","FSumReceiveOrg":"false"}}");
...
五、字段说明：
	 ...
	 包含未审核单据：FNotAudit 
	 显示本位币：FMyCurrency 
	 显示借出组织本位币合计：FSumPayOrg 
	 显示借入组织本位币合计：FSumReceiveOrg 

参数FieldKeys显示列：
	 借出组织：FPayOrgName 
	 借入组织：FReceiveOrgName 
	 业务描述：FDescriptions 
	 业务日期：FDateDisplay 
	 单据编号：FBillNo 
	 摘要：FRemarks 
	 ...
	 调拨金额：FLocalTransferAmount 
	 利息金额：FLocalInterestAmount 
	 还款金额：FLocalRepayAmount 
	 还利息金额：FLocalRepayInterest 
	 待还本金：FLocalUnRepayAmount 
	 待还利息：FLocalUnRepayInterest 
	 待还款金额：FLocalUnRepayTotalAmount 
	 制单人：FCreatorName 
	 审核人：FApproverName 

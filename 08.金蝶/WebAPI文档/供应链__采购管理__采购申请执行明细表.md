# 采购申请执行明细表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 采购申请执行明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 4781 |
...
client.GetSysReportData("PUR_PurReqExecuteRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FReqOrgIdList":"","FOrderStartDate":"1900-01-01","FOrderEndDate":"1900-01-01","FBeginSupplierId":{"FNumber":""},"FEndSupplierId":{"FNumber":""},"FBeginBillNumber":"","FEndBillNumber":"","FBeginMaterialId":{"FNumber":""},"FBeginMaterialGroup":{"FNUMBER":""},"FEndMaterialId":{"FNumber":""},"FEndMaterialGroup":{"FNUMBER":""},"FBeginPurchaser":{"FSTAFFNUMBER":""},"FEndPurchaser":{"FSTAFFNUMBER":""},"FDocumentStatus":"","FLineStatus":""}}");
...
五、字段说明：
	 申请日期：FOrderStartDate  (必填项)
	 至：FOrderEndDate  (必填项)
	 单据状态：FDocumentStatus  (必填项)
	 行状态：FLineStatus  (必填项)
	 申请组织：FReqOrgIdList  (必填项)
	 至：FEndPurchaser 
	 至：FEndBillNumber 
	 至：FEndSupplierId 
	 建议供应商编码：FBeginSupplierId 
	 至：FEndMaterialId 
	 申请人编码：FBeginPurchaser 
	 申请编号：FBeginBillNumber 

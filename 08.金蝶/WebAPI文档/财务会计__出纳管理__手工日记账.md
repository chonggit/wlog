# 手工日记账 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 手工日记账
...
client.Delete("CN_JOURNAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_JOURNAL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FDATE":"1900-01-01","FAcctBookId":{"FNumber":""},"FACCOUNTID":{"FNumber":""},"FBillNo":"","FDocumentStatus":"","FCURRENCYID":{"FNumber":""},"FEXCHANGERATE":0,"FCancelStatus":"","FPAYORGID":{"FNumber":""},"FSTARTPERIOD":"","FVOUCHERID":"","FVOUENTRYID":"","FDEBITSUMAMOUNT":0,"FCREDITSUMAMOUNT":0,"FJOURNALENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNumber":""},"FDEBITAMOUNT":0,"FCREDITAMOUNT":0,"FVOUCHERGROUPID":{"FNUMBER":""},"FSETTLENO":"","FVOUCHERGROUPNO":"","FBANKACCOUNTID":{"FNumber":""},"FCASHACCOUNTID":{"FNUMBER":""},"FOPPOSITEACCOUNTID":{"FNUMBER":""},"FOPPOSITEDETAILID":{"FOPPOSITEDETAILID__FFLEX9":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX10":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX11":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX12":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX13":{"FNumber":""},"FOPPOSITEDETAILID__FF100002":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX4":{"FNumber":""},"FOPPOSITEDETAILID__FF100003":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX5":{"FNumber":""},"FOPPOSITEDETAILID__FF100004":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX6":{"FNumber":""},"FOPPOSITEDETAILID__FF100005":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX7":{"FNumber":""},"FOPPOSITEDETAILID__FF100006":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX8":{"FNumber":""},"FOPPOSITEDETAILID__FF100007":{"FNumber":""},"FOPPOSITEDETAILID__FF100008":{"FNumber":""},"FOPPOSITEDETAILID__FF100009":{"FNumber":""}},"FOPPOSITEBANKACCOUNT":"","FOPPOSITECCOUNTNAME":"","FOPPOSITEBANKNAME":"","FCOMMENT":"","FCOMMENTID":{"FNUMBER":""}}]}}");
        ...
        "FJOURNALENTRY": [
            {
                ...
                "FOPPOSITEDETAILID": {
                    "FOPPOSITEDETAILID__FFLEX9": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX10": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX11": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX12": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX13": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100002": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX4": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100003": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX5": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100004": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX6": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100005": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX7": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100006": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FFLEX8": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100007": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100008": {
                        "FNumber": ""
                    },
                    "FOPPOSITEDETAILID__FF100009": {
                        "FNumber": ""
                    }
                },
...
单据头：FBillHead 
	 ...
	 来源类型：FSOURCETYPE 
	 业务类型：FBUSINESSTYPE 
	 会计期间：FSTARTPERIOD  (必填项)
	 凭证内码：FVOUCHERID 
	 凭证分录内码：FVOUENTRYID 
	 借方金额：FDEBITSUMAMOUNT 
	 贷方金额：FCREDITSUMAMOUNT 
	 借方金额本位币：FDEBITSUMAMOUNTLOC 
	 贷方金额本位币：FCREDITSUMAMOUNTLOC 
日记账明细：FJOURNALENTRY 
	 实体主键：FEntryID 
	 ...
	 凭证号：FVOUCHERGROUPNO 
	 借方金额本位币：FDEBITAMOUNTLOC 
	 贷方金额本位币：FCREDITAMOUNTLOC 
	 勾对：FBLEND 
	 对方科目：FOPPOSITEACCOUNTID 
	 现金账号：FCASHACCOUNTID 
	 现金账号名称：FCASHACCOUNTNAME 
	 核算维度：FOPPOSITEDETAILID 
	 费用项目：FFLEX9
	 资产类别：FFlex10
	 组织机构：FFLEX11
	 物料分组：FFLEX12
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_JOURNAL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FDATE":"1900-01-01","FAcctBookId":{"FNumber":""},"FACCOUNTID":{"FNumber":""},"FBillNo":"","FDocumentStatus":"","FCURRENCYID":{"FNumber":""},"FEXCHANGERATE":0,"FCancelStatus":"","FPAYORGID":{"FNumber":""},"FSTARTPERIOD":"","FVOUCHERID":"","FVOUENTRYID":"","FDEBITSUMAMOUNT":0,"FCREDITSUMAMOUNT":0,"FJOURNALENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNumber":""},"FDEBITAMOUNT":0,"FCREDITAMOUNT":0,"FVOUCHERGROUPID":{"FNUMBER":""},"FSETTLENO":"","FVOUCHERGROUPNO":"","FBANKACCOUNTID":{"FNumber":""},"FCASHACCOUNTID":{"FNUMBER":""},"FOPPOSITEACCOUNTID":{"FNUMBER":""},"FOPPOSITEDETAILID":{"FOPPOSITEDETAILID__FFLEX9":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX10":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX11":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX12":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX13":{"FNumber":""},"FOPPOSITEDETAILID__FF100002":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX4":{"FNumber":""},"FOPPOSITEDETAILID__FF100003":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX5":{"FNumber":""},"FOPPOSITEDETAILID__FF100004":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX6":{"FNumber":""},"FOPPOSITEDETAILID__FF100005":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX7":{"FNumber":""},"FOPPOSITEDETAILID__FF100006":{"FNumber":""},"FOPPOSITEDETAILID__FFLEX8":{"FNumber":""},"FOPPOSITEDETAILID__FF100007":{"FNumber":""},"FOPPOSITEDETAILID__FF100008":{"FNumber":""},"FOPPOSITEDETAILID__FF100009":{"FNumber":""}},"FOPPOSITEBANKACCOUNT":"","FOPPOSITECCOUNTNAME":"","FOPPOSITEBANKNAME":"","FCOMMENT":"","FCOMMENTID":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_JOURNAL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_JOURNAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_JOURNAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_JOURNAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_JOURNAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_JOURNAL","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_JOURNAL","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_JOURNAL"}");

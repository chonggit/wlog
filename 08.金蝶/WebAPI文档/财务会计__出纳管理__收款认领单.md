# 收款认领单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 收款认领单
...
client.Delete("CN_RECCLAIMBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_RECCLAIMBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FPAYUNITTYPE":"","FEXCHANGERATE":0,"FPAYUNIT":{"FNumber":""},"FEXCHANGETYPE":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FDate":"1900-01-01","FRECORGID":{"FNumber":""},"FCLAIMUSERID":{"FUserID":""},"FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FBNKSEQNO":"","FACCOUNTID":{"FNUMBER":""},"FTRANSDATE":"1900-01-01","FAmount":0,"FOPPOSITEBANKACCOUNT":"","FOPPOSITEBANKNAME":"","FOPPOSITECCOUNTNAME":"","FEXPLANATION":"","FSOURCETYPE":"","FCHECKCODE":"","FAMOUNTFOR":0}],"FRECCMENTRYDETAIL":[{"FEntryID":0,"FSourceBillType":"","FRELATIONBILL":{"FNUMBER":""},"FCONVERTRULEID":{},"FSourceBillNo":"","FSETTLEORGID":{"FNumber":""},"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FRECBILLTYPEID":{"FNUMBER":""},"FCMSETTLETYPEID":{"FNUMBER":""},"FPURPOSEID":{"FNUMBER":""},"FSETTLECUR":{"FNUMBER":""},"FSETTLERATE":0,"FSETTLEMAINBOOKID":{"FNUMBER":""},"FSETTLEEXCHANGETYPE":{"FNUMBER":""},"FCMRECAMT":0,"FPLANRECAMOUNT":0,"FRELATEAMOUNT":0,"FCMRECAMOUNT":0,"FSETTLEDISTAMOUNT":0,"FHANDLINGCHARGE":0,"FOVERUNDERAMOUNT":0,"FCMSETTLEAMOUNT":0,"FCOMMENT":"","FSALEORDERNO":"","FMATERIALID":{"FNUMBER":""},"FMATERIALSEQ":0,"FPRICEUNITID":{"FNumber":""},"FORDERENTRYID":0,"FPrice":0,"FQty":0,"FCMUSERID":{"FUserID":""},"FCMDATETIME":"1900-01-01","FCMRECAMOUNTFOR":0,"FSETTLEDISTAMOUNTFOR":0,"FHANDLINGCHARGEFOR":0,"FOVERUNDERAMOUNTFOR":0,"FCMSETTLEAMOUNTFOR":0,"FCMRECAMTFOR":0,"FCOSTID":{"FNUMBER":""},"FCOSTDEPARTMENTID":{"FNUMBER":""},"FSALEORGID":{"FNumber":""},"FSALEDEPTID":{"FNUMBER":""},"FSALEGROUPID":{"FNUMBER":""},"FSALEERID":{"FNUMBER":""},"FCROSSORG":"false"}],"FRECCLAIMREFUNDENTRY":[{"FEntryID":0}]}}");
...
单据头：FBillHead 
	 ...
	 流水总金额：FRECAMOUNT 
	 已认领金额：FCLAIMAMOUNT 
	 未认领金额：FUNCLAIMAMOUNT 
	 认领状态：FBillStatus 
	 审核人：FAPPROVERID 
	 审核日期：FApproveDate 
	 认领确认人：FCLAIMUSERID 
	 认领确认日期：FCLAIMDATE 
	 取消确认认领人：FUNCLAIMUSERID 
	 取消确认认领日期：FUNCLAIMDATE 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 ...
	 生成方式：FCREATETYPE 
	 可认领人：FRECCLAIMUSER 
	 源认领单ID：FSOURCECLAIMID 
	 上一级认领单ID：FPARENTCLAIMID 
收款流水信息：FEntity 
	 实体主键：FEntryID 
	 结算方式：FSETTLETYPEID 
	 关联银行交易明细：FCHECKCODE 
	 ...
	 流水金额本位币：FAMOUNTFOR 
	 交易流水号：FBNKSEQNO 
收款认领详情：FRECCMENTRYDETAIL 
	 实体主键：FEntryID 
	 源单类型：FSourceBillType 
	 关联业务单据编号：FSourceBillNo 
	 源单内码：FSRCBILLID 
	 源单行内码：FSRCROWID 
	 结算组织：FSETTLEORGID  (必填项)
	 往来单位类型：FCONTACTUNITTYPE  (必填项)
	 往来单位：FCONTACTUNIT  (必填项)
	 认领结算金额：FCMSETTLEAMOUNT 
	 应收币别：FSETTLECUR  (必填项)
	 应收本位币：FSETTLEMAINBOOKID  (必填项)
	 结算汇率类型：FSETTLEEXCHANGETYPE  (必填项)
	 应收币别汇率：FSETTLERATE 
	 计划收款金额：FPLANRECAMOUNT 
	 收款金额：FCMRECAMOUNT 
	 现金折扣：FSETTLEDISTAMOUNT 
	 销售订单号：FSALEORDERNO 
	 物料编码：FMATERIALID 
	 物料名称：FMATERIALNAME 
	 订单行号：FMATERIALSEQ 
	 ...
	 关联金额：FRELATEAMOUNT 
	 手续费：FHANDLINGCHARGE 
	 长短款：FOVERUNDERAMOUNT 
	 收款金额本位币：FCMRECAMOUNTFOR 
	 现金折扣本位币：FSETTLEDISTAMOUNTFOR 
	 手续费本位币：FHANDLINGCHARGEFOR 
	 长短款本位币：FOVERUNDERAMOUNTFOR 
	 结算方式：FCMSETTLETYPEID  (必填项)
	 收款用途：FPURPOSEID  (必填项)
	 认领结算金额本位币：FCMSETTLEAMOUNTFOR 
	 本次应收金额本位币：FCMRECAMTFOR 
	 费用项目：FCOSTID 
	 费用承担部门：FCOSTDEPARTMENTID 
	 收款单据类型：FRECBILLTYPEID  (必填项)
	 销售组织：FSALEORGID 
	 销售部门：FSALEDEPTID 
	 销售组：FSALEGROUPID 
	 销售员：FSALEERID 
	 单据转换：FCONVERTRULEID 
	 关联业务单据：FRELATIONBILL 
	 跨组织结算：FCROSSORG 
	 退款金额：FREFUNDAMOUNT 
来源退款单详情：FRECCLAIMREFUNDENTRY 
	 实体主键：FEntryID 
	 来源退款单ID：FSRCREFUNDBILLID 
关联关系表：FRECCMENTRYDETAIL_Link 
	 实体主键：FLinkId 
	 业务流程图：FRECCMENTRYDETAIL_Link_FFlowId 
	 推进路线：FRECCMENTRYDETAIL_Link_FFlowLineId 
	 转换规则：FRECCMENTRYDETAIL_Link_FRuleId 
	 源单表内码：FRECCMENTRYDETAIL_Link_FSTableId 
	 源单表：FRECCMENTRYDETAIL_Link_FSTableName 
	 源单内码：FRECCMENTRYDETAIL_Link_FSBillId 
	 源单分录内码：FRECCMENTRYDETAIL_Link_FSId 
	 原始携带量：FRECCMENTRYDETAIL_Link_FCMRECAMTOld 
	 修改携带量：FRECCMENTRYDETAIL_Link_FCMRECAMT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_RECCLAIMBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FPAYUNITTYPE":"","FEXCHANGERATE":0,"FPAYUNIT":{"FNumber":""},"FEXCHANGETYPE":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FDate":"1900-01-01","FRECORGID":{"FNumber":""},"FCLAIMUSERID":{"FUserID":""},"FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FBNKSEQNO":"","FACCOUNTID":{"FNUMBER":""},"FTRANSDATE":"1900-01-01","FAmount":0,"FOPPOSITEBANKACCOUNT":"","FOPPOSITEBANKNAME":"","FOPPOSITECCOUNTNAME":"","FEXPLANATION":"","FSOURCETYPE":"","FCHECKCODE":"","FAMOUNTFOR":0}],"FRECCMENTRYDETAIL":[{"FEntryID":0,"FSourceBillType":"","FRELATIONBILL":{"FNUMBER":""},"FCONVERTRULEID":{},"FSourceBillNo":"","FSETTLEORGID":{"FNumber":""},"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FRECBILLTYPEID":{"FNUMBER":""},"FCMSETTLETYPEID":{"FNUMBER":""},"FPURPOSEID":{"FNUMBER":""},"FSETTLECUR":{"FNUMBER":""},"FSETTLERATE":0,"FSETTLEMAINBOOKID":{"FNUMBER":""},"FSETTLEEXCHANGETYPE":{"FNUMBER":""},"FCMRECAMT":0,"FPLANRECAMOUNT":0,"FRELATEAMOUNT":0,"FCMRECAMOUNT":0,"FSETTLEDISTAMOUNT":0,"FHANDLINGCHARGE":0,"FOVERUNDERAMOUNT":0,"FCMSETTLEAMOUNT":0,"FCOMMENT":"","FSALEORDERNO":"","FMATERIALID":{"FNUMBER":""},"FMATERIALSEQ":0,"FPRICEUNITID":{"FNumber":""},"FORDERENTRYID":0,"FPrice":0,"FQty":0,"FCMUSERID":{"FUserID":""},"FCMDATETIME":"1900-01-01","FCMRECAMOUNTFOR":0,"FSETTLEDISTAMOUNTFOR":0,"FHANDLINGCHARGEFOR":0,"FOVERUNDERAMOUNTFOR":0,"FCMSETTLEAMOUNTFOR":0,"FCMRECAMTFOR":0,"FCOSTID":{"FNUMBER":""},"FCOSTDEPARTMENTID":{"FNUMBER":""},"FSALEORGID":{"FNumber":""},"FSALEDEPTID":{"FNUMBER":""},"FSALEGROUPID":{"FNUMBER":""},"FSALEERID":{"FNUMBER":""},"FCROSSORG":"false"}],"FRECCLAIMREFUNDENTRY":[{"FEntryID":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_RECCLAIMBILL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_RECCLAIMBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_RECCLAIMBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_RECCLAIMBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_RECCLAIMBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_RECCLAIMBILL","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CN_RECCLAIMBILL","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_RECCLAIMBILL","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_RECCLAIMBILL"}");

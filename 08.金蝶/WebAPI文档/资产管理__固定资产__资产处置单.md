# 资产处置单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 资产处置单
...
client.Delete("FA_DISPOSAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_DISPOSAL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPeriodEnddate":"1900-01-01","FAssetOrgId":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FDisPoseMethod":{"FNumber":""},"FDisposeReason":"","FScanPoint":{"FNUMBER":""},"FDISPOSALENTRY":[{"FEntryID":0,"FAlterId":{"FNumber":""},"FUnitId":{"FNumber":""},"FDisposeQty":0,"FDisposalCurrency":{"FNumber":""},"FCleanCost":0,"FResidualIncome":0,"FINVOICETYPE":"","FTAXRATE":0,"FTAXAMOUNTFOR":0,"FISPUSH":"false","FDisposalFinance":[{"FDetailID":0}],"FSubEntity":[{"FDetailID":0,"FEntityId":{"FASSETNO":""},"FQty":0}],"FDisposalVchEntry":[{"FID":0,"FVchDealCurrency":{"FNUMBER":""},"FVCHALTERID":{"FNUMBER":""},"FVchCleanCost":0,"FVchResidualIncome":0,"FVCHINVOICETYPE":"","FVCHTAXRATE":0,"FVCHTAXAMOUNTFOR":0,"FVchAcctPolicyId":{"FNUMBER":""},"FVchCurrency":{"FNUMBER":""},"FVchOriginalAmount":0,"FVchAccumDepr":0,"FVchResidualvalue":0,"FVchAccumDevalue":0,"FVchManualDepr":0,"FVchAssetNo":"","FVchQty":0,"FVchUnit":{"FNUMBER":""},"FVchDepAllocation":{"FNUMBER":""},"FVchAllocation":0}]}]}}");
...
资产：FDISPOSALENTRY 
	 ...
	 资产名称：FAssetName 
	 处置数量：FDisposeQty 
	 基础资料属性：FBaseProperty2 
	 变动后ID：FNewAlterId 
	 单位：FUnitId 
	 数量：FQuantity 
	 处置币别：FDisposalCurrency 
	 清理费用：FCleanCost 
	 残值收入(含税)：FResidualIncome 
	 业务流程：FBFLowId 
	 已下推应收单：FISPUSH 
	 发票类型：FINVOICETYPE 
	 税率(%)：FTAXRATE 
	 税额：FTAXAMOUNTFOR 
	 资产编码：F_ora_BaseProperty_qtr 
财务：FDisposalFinance 
	 实体主键：FDetailID 
	 处置原值：FOriginalAmount 
	 处置累计折旧：FAccumDepr 
	 处置残值：FResidualvalue 
	 处置减值准备：FAccumDevalue 
	 财务信息：FFinanceId 
	 会计政策：FPolicyId 
	 年度：FYear 
	 期间：FPeriod 
	 处置本期累计折旧：FDisposeDepr 
	 手工调整折旧额：FManualDepr 
	 处置折旧率：FDisDeprRate 
	 折旧政策清理：FClearDeprPolicy 
	 本年折旧额：FCurYearDepr 
	 币别：FCurrencyId 
	 写入余额表折旧调减字段：FBanAccumDepr 
	 本年累计折旧调减：FCurYearDeprDEC 
	 处置净值：FNETVALUE 
实物：FSubEntity 
	 实体主键：FDetailID 
	 实物编码：FEntityId 
	 ...
	 数量：FQty 
	 资产编码：FAssetNo 
凭证资料：FDisposalVchEntry 
	 实体主键：FID 
	 处置币别：FVchDealCurrency 
	 清理费用：FVchCleanCost 
	 残值收入(含税)：FVchResidualIncome 
	 会计政策：FVchAcctPolicyId 
	 币别：FVchCurrency 
	 处置原值：FVchOriginalAmount 
	 处置累计折旧：FVchAccumDepr 
	 处置残值：FVchResidualvalue 
	 处置减值准备：FVchAccumDevalue 
	 手工调整折旧额：FVchManualDepr 
	 数量：FVchQty 
	 分配部门：FVchDepAllocation 
	 分配比例（%）：FVchAllocation 
	 单位：FVchUnit 
	 资产编码：FVchAssetNo 
	 卡片编码：FVCHALTERID 
	 资产名称：FNAME 
	 发票类型：FVCHINVOICETYPE 
	 税率：FVCHTAXRATE 
	 税额：FVCHTAXAMOUNTFOR 
关联关系表：FDISPOSALENTRY_Link 
	 实体主键：FLinkId 
	 业务流程图：FDISPOSALENTRY_Link_FFlowId 
	 推进路线：FDISPOSALENTRY_Link_FFlowLineId 
	 转换规则：FDISPOSALENTRY_Link_FRuleId 
	 源单表内码：FDISPOSALENTRY_Link_FSTableId 
	 源单表：FDISPOSALENTRY_Link_FSTableName 
	 源单内码：FDISPOSALENTRY_Link_FSBillId 
	 源单分录内码：FDISPOSALENTRY_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_DISPOSAL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPeriodEnddate":"1900-01-01","FAssetOrgId":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FDisPoseMethod":{"FNumber":""},"FDisposeReason":"","FScanPoint":{"FNUMBER":""},"FDISPOSALENTRY":[{"FEntryID":0,"FAlterId":{"FNumber":""},"FUnitId":{"FNumber":""},"FDisposeQty":0,"FDisposalCurrency":{"FNumber":""},"FCleanCost":0,"FResidualIncome":0,"FINVOICETYPE":"","FTAXRATE":0,"FTAXAMOUNTFOR":0,"FISPUSH":"false","FDisposalFinance":[{"FDetailID":0}],"FSubEntity":[{"FDetailID":0,"FEntityId":{"FASSETNO":""},"FQty":0}],"FDisposalVchEntry":[{"FID":0,"FVchDealCurrency":{"FNUMBER":""},"FVCHALTERID":{"FNUMBER":""},"FVchCleanCost":0,"FVchResidualIncome":0,"FVCHINVOICETYPE":"","FVCHTAXRATE":0,"FVCHTAXAMOUNTFOR":0,"FVchAcctPolicyId":{"FNUMBER":""},"FVchCurrency":{"FNUMBER":""},"FVchOriginalAmount":0,"FVchAccumDepr":0,"FVchResidualvalue":0,"FVchAccumDevalue":0,"FVchManualDepr":0,"FVchAssetNo":"","FVchQty":0,"FVchUnit":{"FNUMBER":""},"FVchDepAllocation":{"FNUMBER":""},"FVchAllocation":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_DISPOSAL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_DISPOSAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_DISPOSAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_DISPOSAL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_DISPOSAL","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_DISPOSAL"}");

# 动态罗列项目数据查询 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 合并报表 > 动态罗列项目数据查询

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3489 |
...
client.GetSysReportData("CR_DItemDataList","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FYearFrom":0,"FYearTo":0,"FRptCycleId":"","FPeriodFrom":0,"FPeriodTo":0,"FScopeTypeId":{"FNUMBER":""},"FScopeId":{"FNUMBER":""},"FCompanyId":{"FNUMBER":""},"FCurrencyId":{"FNUMBER":""},"FCurrUnitId":{"FNUMBER":""},"FRptItemFromId":{"FNUMBER":""},"FRptItemToId":{"FNUMBER":""},"FItemDataTypeId":{"FNUMBER":""},"FFlexItemEntity":[{"FRptDemsion":{"FNUMBER":""},"FDemsionFrom":"","FDemsionTo":""}]}}");

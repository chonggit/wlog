...
client.Delete("SC_InterestObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SC_InterestObject","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SC_InterestObject","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDate":"1900-01-01","FNumber":"","FName":"","FObjectFrom":"","FObjectID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FLastEndDate":"1900-01-01","FStartPoint":0,"FRateScheme":{"FNUMBER":""},"FFreeAmout":0,"FInitFactor":0,"FPayOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FAPPROVERID":{"FUserID":""},"FAPPROVEDATE":"1900-01-01","FUseOrgId":{"FNumber":""},"FDescription":"","FFORBIDDERID":{"FUserID":""},"FFORBIDDATE":"1900-01-01","FRateForType":"","FInterestStandard":"","FRateTable":{"FNUMBER":""},"FDepositRate":0,"FRateForTypeOver":"","FInterestStdOver":"","FRateTableOver":{"FNUMBER":""},"FOverRate":0,"FCountRate":"false","FCountOverRate":"false"}}");
...
单据头：FBillHead 
	 ...
	 启用日期：FDate  (必填项)
	 结息方案：FRateScheme 
	 计息对象来源：FObjectFrom  (必填项)
	 计息对象：FObjectID  (必填项)
	 币别：FCURRENCYID  (必填项)
	 上次结息日：FLastEndDate  (必填项)
	 利率适用类型：FRateForType  (必填项)
	 对应组织：FPayOrgId 
	 计息标准：FInterestStandard  (必填项)
	 存款利率(BP)：FDepositRate 
	 利率表：FRateTable 
	 初始积数：FInitFactor 
	 免息额：FFreeAmout 
	 计息起点：FStartPoint 
	 计算存款利息：FCountRate 
	 利率适用类型：FRateForTypeOver  (必填项)
	 计息标准：FInterestStdOver  (必填项)
	 透支利率(BP)：FOverRate 
	 利率表：FRateTableOver 
	 计算透支利息：FCountOverRate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SC_InterestObject","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDate":"1900-01-01","FNumber":"","FName":"","FObjectFrom":"","FObjectID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FLastEndDate":"1900-01-01","FStartPoint":0,"FRateScheme":{"FNUMBER":""},"FFreeAmout":0,"FInitFactor":0,"FPayOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FAPPROVERID":{"FUserID":""},"FAPPROVEDATE":"1900-01-01","FUseOrgId":{"FNumber":""},"FDescription":"","FFORBIDDERID":{"FUserID":""},"FFORBIDDATE":"1900-01-01","FRateForType":"","FInterestStandard":"","FRateTable":{"FNUMBER":""},"FDepositRate":0,"FRateForTypeOver":"","FInterestStdOver":"","FRateTableOver":{"FNUMBER":""},"FOverRate":0,"FCountRate":"false","FCountOverRate":"false"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SC_InterestObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SC_InterestObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SC_InterestObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SC_InterestObject","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SC_InterestObject","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SC_InterestObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SC_InterestObject","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SC_InterestObject"}");

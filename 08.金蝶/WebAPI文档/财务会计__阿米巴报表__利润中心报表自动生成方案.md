# 利润中心报表自动生成方案 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 阿米巴报表 > 利润中心报表自动生成方案
...
client.Delete("KDS_AutoCreateProfitRptScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("KDS_AutoCreateProfitRptScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("KDS_AutoCreateProfitRptScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FEnableUserId":{"FUserID":""},"FFrequency":"","FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FEnableStatus":"","FCreatorId":{"FUserID":""},"FUseOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FModifierId":{"FUserID":""},"FDay":0,"FHour":0,"FMinute":0,"FSecond":0,"FAutoPriorPeriodRpt":"false","FReplace":"false","FEnableDate":"1900-01-01","FAutoAudit":"false","FContainUnAudit":"false","FRptType":"","FContainUnpostVch":"false","FAutoScopeEntity":[{"FENTRYID":0,"FSampleId":{"FNUMBER":""},"FAcctSysId":{"FNumber":""},"FAcctOrgId":{"FNumber":""},"FAcctPolicyId":{"FNUMBER":""},"FCurrencyId":{"FNumber":""},"FIsCFCurrency":"false","FREFRESHFLEX":"false","FADDITIONALREFRESH":"false","FSETFLEX":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FMinute": 0,
        "FSecond": 0,
        "FAutoPriorPeriodRpt": "false",
        "FReplace": "false",
        "FEnableDate": "1900-01-01",
        "FAutoAudit": "false",
        "FContainUnAudit": "false",
        "FRptType": "",
        "FContainUnpostVch": "false",
        "FAutoScopeEntity": [
            {
                "FENTRYID": 0,
                "FSampleId": {
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 天：FDay 
	 存在相同属性报表，覆盖现有报表：FReplace 
	 分：FMinute 
	 根据重算时间，生成上期报表：FAutoPriorPeriodRpt 
	 时：FHour 
	 秒：FSecond 
	 执行频率：FFrequency  (必填项)
	 自动提交审核：FAutoAudit 
	 ...
	 包含未审核单据：FContainUnAudit 
	 报表类别：FRptType 
	 包含未过账凭证(函数：ACCT、ACCTCASH)：FContainUnpostVch 
生成报表范围：FAutoScopeEntity 
	 实体主键：FENTRYID 
	 报表模板：FSampleId  (必填项)
	 核算体系：FAcctSysId  (必填项)
	 核算组织：FAcctOrgId  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("KDS_AutoCreateProfitRptScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FEnableUserId":{"FUserID":""},"FFrequency":"","FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FEnableStatus":"","FCreatorId":{"FUserID":""},"FUseOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FModifierId":{"FUserID":""},"FDay":0,"FHour":0,"FMinute":0,"FSecond":0,"FAutoPriorPeriodRpt":"false","FReplace":"false","FEnableDate":"1900-01-01","FAutoAudit":"false","FContainUnAudit":"false","FRptType":"","FContainUnpostVch":"false","FAutoScopeEntity":[{"FENTRYID":0,"FSampleId":{"FNUMBER":""},"FAcctSysId":{"FNumber":""},"FAcctOrgId":{"FNumber":""},"FAcctPolicyId":{"FNUMBER":""},"FCurrencyId":{"FNumber":""},"FIsCFCurrency":"false","FREFRESHFLEX":"false","FADDITIONALREFRESH":"false","FSETFLEX":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("KDS_AutoCreateProfitRptScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("KDS_AutoCreateProfitRptScheme","Activate","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("KDS_AutoCreateProfitRptScheme","NotActivate","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("KDS_AutoCreateProfitRptScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"KDS_AutoCreateProfitRptScheme"}");

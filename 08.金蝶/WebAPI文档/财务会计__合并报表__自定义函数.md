# 自定义函数 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 合并报表 > 自定义函数
...
client.Delete("CR_CustomFunction","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CR_CustomFunction","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CR_CustomFunction","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FUseType":"","FDataSource":{"FID":""},"FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FSrcTableName":"","FSrcPkField":"","FSourceType":"","FForbidStatusField":"","FDocStatusField":"","FDATASERVICECLASS":"","FCustomSql":"","FFUNCTIONCLASS":"","FSQLSELECT":"","FSQLFROM":"","FSQLWHERE":"","FGroupID":{"FNUMBER":""},"FIsSysPreset":"false","FPreCondition":"","FPreConditionVal":"","FPreConditionXML":"","FFUNCTIONINFO":"","FParameterEntry":[{"FEntryID":0,"FParamKey":"","FParameterId":{"FNAME":""},"FCompareOperator":"","FSelectType":"","FFieldDescription":"","FIsMatchFieldType":"false","FDefValueRule":"","FParamFieldKey":"","FParamFieldName":"","FRule":"","FIsParamMust":"false","FIsParamPreset":"false","FAppreanceClass":"","FParamDesc":"","FDefValue":""}],"FSettingEntry":[{"FEntryID":0,"FItemDataType":{"FNUMBER":""},"FSettingFieldDesc":"","FSettingFieldKey":"","FSettingFieldName":"","FFieldInfo":"","FFetchType":""}]}}");
        ...
        "FParameterEntry": [
            {
                ...
                "FSelectType": "",
                "FFieldDescription": "",
                "FIsMatchFieldType": "false",
                "FDefValueRule": "",
                "FParamFieldKey": "",
                "FParamFieldName": "",
                "FRule": "",
                "FIsParamMust": "false",
                "FIsParamPreset": "false",
                "FAppreanceClass": "",
                "FParamDesc": "",
                "FDefValue": ""
            }
...
单据头：FBillHead 
	 ...
	 禁用人：FForbidderId 
	 禁用日期：FForbidDate 
	 取数来源：FDataSource  (必填项)
	 适用报表类型：FUseType  (必填项)
	 来源表名：FSrcTableName 
	 源表主键：FSrcPkField 
	 取数来源类型：FSourceType  (必填项)
	 禁用状态字段名：FForbidStatusField 
	 审核状态字段名：FDocStatusField 
	 取数实现类：FDATASERVICECLASS 
	 SQL：FCustomSql 
	 函数指定实现类：FFUNCTIONCLASS 
	 SELECT：FSQLSELECT 
	 FROM：FSQLFROM 
	 WHERE：FSQLWHERE 
	 函数分组：FGroupID 
	 系统预置：FIsSysPreset 
	 前置条件：FPreCondition 
	 前置条件值：FPreConditionVal 
	 前置条件XML值：FPreConditionXML 
	 函数信息(客户端注册)：FFUNCTIONINFO 
取数参数：FParameterEntry 
	 实体主键：FEntryID 
	 参数：FParameterId  (必填项)
	 报表属性与参数间传递关系：FDefValueRuleDesc 
	 间接转换规则：FRule 
	 自动传参规则：FDefValueRule 
	 来源字段：FFieldDescription 
	 是否预置参数：FIsParamPreset 
	 参数与对应字段匹配：FIsMatchFieldType 
	 SQL参数：FParamKey 
	 来源字段KEY：FParamFieldKey 
	 来源字段SQL字段名：FParamFieldName 
	 比较符：FCompareOperator 
	 参数必录：FIsParamMust 
	 参数界面设置：FAppreanceClass 
	 参数说明：FParamDesc 
	 默认值：FDefValue 
	 参数类型：FSelectType 
取数设置：FSettingEntry 
	 ...
	 对应来源字段标识：FSettingFieldKey 
	 对应来源字段名：FSettingFieldName 
	 对应来源字段：FSettingFieldDesc 
	 字段相关信息：FFieldInfo 
	 汇总类型：FFetchType 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CR_CustomFunction","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FUseType":"","FDataSource":{"FID":""},"FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FSrcTableName":"","FSrcPkField":"","FSourceType":"","FForbidStatusField":"","FDocStatusField":"","FDATASERVICECLASS":"","FCustomSql":"","FFUNCTIONCLASS":"","FSQLSELECT":"","FSQLFROM":"","FSQLWHERE":"","FGroupID":{"FNUMBER":""},"FIsSysPreset":"false","FPreCondition":"","FPreConditionVal":"","FPreConditionXML":"","FFUNCTIONINFO":"","FParameterEntry":[{"FEntryID":0,"FParamKey":"","FParameterId":{"FNAME":""},"FCompareOperator":"","FSelectType":"","FFieldDescription":"","FIsMatchFieldType":"false","FDefValueRule":"","FParamFieldKey":"","FParamFieldName":"","FRule":"","FIsParamMust":"false","FIsParamPreset":"false","FAppreanceClass":"","FParamDesc":"","FDefValue":""}],"FSettingEntry":[{"FEntryID":0,"FItemDataType":{"FNUMBER":""},"FSettingFieldDesc":"","FSettingFieldKey":"","FSettingFieldName":"","FFieldInfo":"","FFetchType":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CR_CustomFunction","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CR_CustomFunction","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CR_CustomFunction","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_CustomFunction","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_CustomFunction","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CR_CustomFunction","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CR_CustomFunction","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CR_CustomFunction"}");

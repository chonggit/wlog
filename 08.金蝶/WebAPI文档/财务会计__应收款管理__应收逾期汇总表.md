# 应收逾期汇总表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应收款管理 > 应收逾期汇总表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2213 |
...
client.GetSysReportData("RESP_YSYQHZB","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"F_RESP_Date":"1900-01-01","F_RESP_KHBM":[{"FNumber":""}],"F_RESP_ZZ":[{"FNumber":""}],"FEntAgingGrpSetting":[{"FSection":"","FDays":0}]}}");

# 引出方案设置 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 引出方案设置
...
client.Delete("BD_SALESIEMPIMP","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_SALESIEMPIMP","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_SALESIEMPIMP","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FBill":{"FNumber":""},"FLinkType":{"FNumber":""},"FSeparateChar":"","FCompartType":"","FCompartChar":"","FCreateOrgId":{"FNumber":""},"FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FUseOrgId":{"FNumber":""},"FFiledMapEntity":[{"FEntryID":0,"FTargetName":"","FTargetKey":"","FIsFormula":"false","FSourceName":"","FSourceKey":"","FFormulaDesc":"","FFormula":"","FDefaultValue":"","FIsFilter":"false"}],"FBaseDataMapEntity":[{"FEntryID":0,"FBaseDataFieldKey":"","FBaseDataField":"","FBDSystemName":"","FFileDataName":""}],"FFileFieldEntity":[{"FEntryID":0,"FEntityName":"","FEntityKey":"","FFileFieldName":"","FFileFieldKey":"","FDataType":0,"FDataTypeName":"","FPropertyName":"","FBodyNumber":"false"}]}}");
...
单据头：FBillHead 
	 ...
	 禁用日期：FForbidDate 
	 系统预置：FIsSysPreset 
	 分隔符类型：FCompartType  (必填项)
	 关联类型：FLinkType  (必填项)
	 单据类型：FBill  (必填项)
	 字段标识符：FSeparateChar 
	 分隔符：FCompartChar 
字段映射关系：FFiledMapEntity 
	 实体主键：FEntryID 
	 目标单字段名称：FTargetName 
	 目标单字段：FTargetKey 
	 公式：FIsFormula 
	 ...
	 公式：FFormula 
	 过滤：FIsFilter 
基础资料对应关系：FBaseDataMapEntity 
	 实体主键：FEntryID 
	 基础资料字段：FBaseDataField 
	 金蝶K/3系统名称：FBDSystemName 
	 文本文件名称：FFileDataName 
	 基础资料字段标识：FBaseDataFieldKey 
文本文件字段：FFileFieldEntity 
	 实体主键：FEntryID 
	 位置：FEntityName 
	 实体标识：FEntityKey 
	 字段名称：FFileFieldName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_SALESIEMPIMP","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FBill":{"FNumber":""},"FLinkType":{"FNumber":""},"FSeparateChar":"","FCompartType":"","FCompartChar":"","FCreateOrgId":{"FNumber":""},"FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FUseOrgId":{"FNumber":""},"FFiledMapEntity":[{"FEntryID":0,"FTargetName":"","FTargetKey":"","FIsFormula":"false","FSourceName":"","FSourceKey":"","FFormulaDesc":"","FFormula":"","FDefaultValue":"","FIsFilter":"false"}],"FBaseDataMapEntity":[{"FEntryID":0,"FBaseDataFieldKey":"","FBaseDataField":"","FBDSystemName":"","FFileDataName":""}],"FFileFieldEntity":[{"FEntryID":0,"FEntityName":"","FEntityKey":"","FFileFieldName":"","FFileFieldKey":"","FDataType":0,"FDataTypeName":"","FPropertyName":"","FBodyNumber":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_SALESIEMPIMP","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_SALESIEMPIMP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_SALESIEMPIMP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SALESIEMPIMP","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SALESIEMPIMP","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_SALESIEMPIMP","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_SALESIEMPIMP","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_SALESIEMPIMP"}");

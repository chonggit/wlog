# 收款结算单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 资金管理 > 收款结算单
...
client.Delete("SC_RECEIVESETTLEBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SC_RECEIVESETTLEBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPAYUNITTYPE":"","FPAYUNIT":{"FNumber":""},"FBillNo":"","FFundsOrgID":{"FNumber":""},"FDate":"1900-01-01","FCURRENCYID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGERATE":0,"FEXCHANGETYPE":{"FNUMBER":""},"FHADSETTLEAMOUNT":0,"FUNSETTLEAMOUNT":0,"FBillTypeID":{"FNUMBER":""},"FWBSETTLENO":"","FRECEIVESETTLEBILLENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FRECAMOUNTFOR_E":0,"FRECAMOUNT_E":0,"FHANDLINGCHARGEFOR":0,"FHANDLINGCHARGE":0,"FREALRECAMOUNTFOR_E":0,"FREALRECAMOUNT_E":0,"FACCOUNTID":{"FNUMBER":""},"FCASHACCOUNTID":{"FNUMBER":""},"FSETTLENO":"","FREMARKS":"","FBILLID":{"FNUMBER":""},"FBPBILLPARAMOUNTFOR":0,"FPARLEFTAMOUNTFOR":0,"FOPPOSITEBANKACCOUNT":"","FOPPOSITEBANKNAME":"","FOPPOSITECCOUNTNAME":"","FPOSTDATE":"1900-01-01"}],"FRECESETTLEENTRY":[{"FEntryID":0,"FSOURCETYPE":"","FSRCBILLNO":"","FSETTLEORGID":{"FNumber":""},"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FSETTLETYPEID_S":{"FNUMBER":""},"FPURPOSEID":{"FNUMBER":""},"FSETTLECUR":{"FNUMBER":""},"FSETTLERATE":0,"FSETTLEMAINBOOKID":{"FNUMBER":""},"FSETTLEEXCHANGETYPE":{"FNUMBER":""},"FSETTLEAMOUNTFOR":0,"FRECAMOUNTFOR_H":0,"FPLANRECAMOUNTFOR":0,"FORDERBILLNO":"","FMATERIALID":{"FNUMBER":""},"FMATERIALSEQ":0,"FORDERENTRYID":0,"FCOMMENT_S":""}]}}");
...
单据头：FBillHead 
	 ...
	 汇率：FEXCHANGERATE 
	 收款金额：FRECAMOUNTFOR 
	 实收金额：FREALRECAMOUNTFOR 
	 实收金额本位币：FREALRECAMOUNT 
	 已结算金额：FHADSETTLEAMOUNT 
	 未结算金额：FUNSETTLEAMOUNT 
	 作废日期：FCancelDate 
	 作废人：FCancellerID 
	 作废状态：FCancelStatus 
	 ...
	 收款金额本位币：FRECAMOUNT 
	 网银流水号：FWBSETTLENO 
明细：FRECEIVESETTLEBILLENTRY 
	 实体主键：FEntryID 
	 结算方式：FSETTLETYPEID  (必填项)
	 收款金额：FRECAMOUNTFOR_E 
	 手续费：FHANDLINGCHARGEFOR 
	 实收金额：FREALRECAMOUNTFOR_E 
	 我方银行账号：FACCOUNTID 
	 现金账号：FCASHACCOUNTID 
	 结算号：FSETTLENO 
	 摘要：FREMARKS 
	 票面金额：FBPBILLPARAMOUNTFOR 
	 收款金额本位币：FRECAMOUNT_E 
	 手续费本位币：FHANDLINGCHARGE 
	 实收金额本位币：FREALRECAMOUNT_E 
	 票据流水号：FBILLID 
	 可用票面金额：FPARLEFTAMOUNTFOR 
	 ...
	 我方开户行：FRECBANKID 
	 票据号码：FFRCBILLNUMBERTY 
结算明细：FRECESETTLEENTRY 
	 实体主键：FEntryID 
	 结算组织：FSETTLEORGID  (必填项)
	 往来单位类型：FCONTACTUNITTYPE  (必填项)
	 往来单位：FCONTACTUNIT  (必填项)
	 结算方式：FSETTLETYPEID_S  (必填项)
	 结算金额：FSETTLEAMOUNTFOR 
	 备注：FCOMMENT_S 
	 关联金额：FRELATEAMOUNTFOR 
	 源单类型：FSOURCETYPE 
	 源单编号：FSRCBILLNO 
	 应收币别：FSETTLECUR  (必填项)
	 应收币别汇率：FSETTLERATE 
	 本次应收金额：FRECAMOUNTFOR_H 
	 已确认收款：FCONFIRMEDREC 
	 收款用途：FPURPOSEID 
	 销售订单号：FORDERBILLNO 
	 物料编码：FMATERIALID 
	 物料名称：FMATERIALIDNAME 
	 物料行号：FMATERIALSEQ 
	 销售订单行内码：FORDERENTRYID 
	 应收本位币：FSETTLEMAINBOOKID 
	 结算汇率类型：FSETTLEEXCHANGETYPE 
	 本次应收金额本位币：FRECAMOUNT_H 
	 结算金额本位币：FSETTLEAMOUNT 
	 源单内码：FSRCBILLID 
	 源单行内码：FSRCROWID 
	 计划收款金额：FPLANRECAMOUNTFOR 
关联关系表：FRECESETTLEENTRY_Link 
	 实体主键：FLinkId 
	 业务流程图：FRECESETTLEENTRY_Link_FFlowId 
	 推进路线：FRECESETTLEENTRY_Link_FFlowLineId 
	 转换规则：FRECESETTLEENTRY_Link_FRuleId 
	 源单表内码：FRECESETTLEENTRY_Link_FSTableId 
	 源单表：FRECESETTLEENTRY_Link_FSTableName 
	 源单内码：FRECESETTLEENTRY_Link_FSBillId 
	 源单分录内码：FRECESETTLEENTRY_Link_FSId 
	 原始携带量：FRECESETTLEENTRY_Link_FRECAMOUNTFOR_HOld 
	 修改携带量：FRECESETTLEENTRY_Link_FRECAMOUNTFOR_H 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SC_RECEIVESETTLEBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPAYUNITTYPE":"","FPAYUNIT":{"FNumber":""},"FBillNo":"","FFundsOrgID":{"FNumber":""},"FDate":"1900-01-01","FCURRENCYID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGERATE":0,"FEXCHANGETYPE":{"FNUMBER":""},"FHADSETTLEAMOUNT":0,"FUNSETTLEAMOUNT":0,"FBillTypeID":{"FNUMBER":""},"FWBSETTLENO":"","FRECEIVESETTLEBILLENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FRECAMOUNTFOR_E":0,"FRECAMOUNT_E":0,"FHANDLINGCHARGEFOR":0,"FHANDLINGCHARGE":0,"FREALRECAMOUNTFOR_E":0,"FREALRECAMOUNT_E":0,"FACCOUNTID":{"FNUMBER":""},"FCASHACCOUNTID":{"FNUMBER":""},"FSETTLENO":"","FREMARKS":"","FBILLID":{"FNUMBER":""},"FBPBILLPARAMOUNTFOR":0,"FPARLEFTAMOUNTFOR":0,"FOPPOSITEBANKACCOUNT":"","FOPPOSITEBANKNAME":"","FOPPOSITECCOUNTNAME":"","FPOSTDATE":"1900-01-01"}],"FRECESETTLEENTRY":[{"FEntryID":0,"FSOURCETYPE":"","FSRCBILLNO":"","FSETTLEORGID":{"FNumber":""},"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FSETTLETYPEID_S":{"FNUMBER":""},"FPURPOSEID":{"FNUMBER":""},"FSETTLECUR":{"FNUMBER":""},"FSETTLERATE":0,"FSETTLEMAINBOOKID":{"FNUMBER":""},"FSETTLEEXCHANGETYPE":{"FNUMBER":""},"FSETTLEAMOUNTFOR":0,"FRECAMOUNTFOR_H":0,"FPLANRECAMOUNTFOR":0,"FORDERBILLNO":"","FMATERIALID":{"FNUMBER":""},"FMATERIALSEQ":0,"FORDERENTRYID":0,"FCOMMENT_S":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SC_RECEIVESETTLEBILL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SC_RECEIVESETTLEBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SC_RECEIVESETTLEBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SC_RECEIVESETTLEBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SC_RECEIVESETTLEBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SC_RECEIVESETTLEBILL","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("SC_RECEIVESETTLEBILL","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SC_RECEIVESETTLEBILL","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SC_RECEIVESETTLEBILL"}");

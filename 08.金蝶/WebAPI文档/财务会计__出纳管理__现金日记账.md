# 现金日记账 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 现金日记账

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3737 |
...
client.GetSysReportData("CN_CashJournal","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSumYear":"false","FSumMonth":"false","FCurrencyIds":"","FOrgID":[{"FNumber":""}],"FNotGenVch":"false","FMyCurrency":"false","FNotAudit":"false","FEndDate":"1900-01-01","FStartDate":"1900-01-01","FAffiliation":{"FNUMBER":""},"FSumDay":"false","FAcctBookId":[{"FNumber":""}],"FGROUPBILLNO":"false","FAllAcct":"false","FCASHACCTID":[{"FNumber":""}],"FSortRadioGroup":"","FSortByDate":"","FSortByVcho":""}}");

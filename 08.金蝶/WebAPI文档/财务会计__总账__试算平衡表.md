# 试算平衡表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 总账 > 试算平衡表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2594 |
...
client.GetSysReportData("GL_RPT_TrialBalance","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTBOOK":{"FNumber":""},"FYear":"","FPeriod":"","FAcctLevel":"","FCurrency":"","FShowForbid":"false","FShowDetailOnly":"false","FIncludeUnPost":"false","FSHOWFULLNAME":"false","FSHOWDETAIL":"false","FEXCLUDEADJUSTVCH":"false"}}");

...
client.Delete("PLN_RESERVE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PLN_RESERVE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDEMANDORGID":{"FNumber":""},"FMATERIALID":{"FNumber":""},"FDemandDate":"1900-01-01","FReserveEndDate":"1900-01-01","FEarlyDay":0,"FUseObjTypeId":"","FUseObjId":{"FNumber":""},"FSOURCEFORMID":{"FID":""},"FSOURCEINTERID":"","FSOURCEENTRYID":"","FEntity":[{"FEntryID":0,"FSUPPLYORGID":{"FNumber":""},"FSUPPLYFORMID":{"FID":""},"FSUPPLYINTERID":"","FSUPPLYBILLNO":"","FSUPPLYENTRYID":"","FSUPPLYSEQNO":0,"FSUPPLYMATERIALID":{"FNumber":""},"FSUPPLYDATE":"1900-01-01","FSUPPLYUNITID":{"FNumber":""},"FSupplyQty":0,"FRESERVEQTY":0,"FRESERVESTATUS":"","FSUPPLYSTOCKID":{"FNumber":""},"FSUPPLYSTOCKLOCID":{"FSUPPLYSTOCKLOCID__FF100003":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100005":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100006":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100007":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100008":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100009":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100011":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100014":{"FNumber":""}},"FSUPPLYBOMID":{"FNumber":""},"FSUPPLYLOT":{"FNumber":""},"FSUPPLYMTONO":"","FBASESUPPLYUNITID":{"FNumber":""},"FBaseSupplyQty":0,"FBASERESERVEQTY":0,"FSUPPLYAUXPROPID":{"FSUPPLYAUXPROPID__FF100001":{"FNumber":""},"FSUPPLYAUXPROPID__FF100002":{"FNumber":""},"FSUPPLYAUXPROPID__FF100003":{"FNumber":""},"FSUPPLYAUXPROPID__FF100005":{"FNumber":""},"FSUPPLYAUXPROPID__FF100010":{"FNumber":""},"FSUPPLYAUXPROPID__FF100007":{"FNumber":""},"FSUPPLYAUXPROPID__FF100008":{"FNumber":""}},"FMemo":"","FStockFormId":"","FStockInterId":"","FStockEntryId":"","FSupplyEntityKey":""}]}}");
        ...
        "FEntity": [
            {
                ...
                "FSUPPLYSTOCKLOCID": {
                    "FSUPPLYSTOCKLOCID__FF100003": {
                        "FNumber": ""
                    },
                    "FSUPPLYSTOCKLOCID__FF100005": {
                        "FNumber": ""
                    },
                    "FSUPPLYSTOCKLOCID__FF100006": {
                        "FNumber": ""
                    },
                    "FSUPPLYSTOCKLOCID__FF100007": {
                        "FNumber": ""
                    },
                    "FSUPPLYSTOCKLOCID__FF100008": {
                        "FNumber": ""
                    },
                    "FSUPPLYSTOCKLOCID__FF100009": {
                        "FNumber": ""
                    },
                    "FSUPPLYSTOCKLOCID__FF100011": {
                        "FNumber": ""
                    },
                    "FSUPPLYSTOCKLOCID__FF100014": {
                        "FNumber": ""
                    }
                },
                "FSUPPLYBOMID": {
                ...
                "FBASERESERVEQTY": 0,
                "FSUPPLYAUXPROPID": {
                    "FSUPPLYAUXPROPID__FF100001": {
                        "FNumber": ""
                    },
                    "FSUPPLYAUXPROPID__FF100002": {
                        "FNumber": ""
                    },
                    "FSUPPLYAUXPROPID__FF100003": {
                        "FNumber": ""
                    },
                    "FSUPPLYAUXPROPID__FF100005": {
                        "FNumber": ""
                    },
                    "FSUPPLYAUXPROPID__FF100010": {
                        "FNumber": ""
                    },
                    "FSUPPLYAUXPROPID__FF100007": {
                        "FNumber": ""
                    },
                    "FSUPPLYAUXPROPID__FF100008": {
                        "FNumber": ""
                    }
                },
                "FMemo": "",
...
单据头：FBillHead 
	 ...
	 预留至：FReserveEndDate  (必填项)
	 提前天数：FEarlyDay 
	 使用对象类型：FUseObjTypeId 
	 使用对象：FUseObjId 
	 来源单据内码：FSOURCEINTERID 
	 来源单据分录内码：FSOURCEENTRYID 
	 来源单据类型：FSOURCEFORMID 
	 作废人：FCanceler 
	 作废日期：FCancelDate 
	 作废状态：FCancelStatus 
	 物料名称：FMaterialName 
预留明细：FEntity 
	 实体主键：FEntryID 
	 供应组织：FSUPPLYORGID 
	 供应单据类型：FSUPPLYFORMID 
	 供应单据号：FSUPPLYBILLNO 
	 供应单据分录内码：FSUPPLYENTRYID 
	 供应单据行号：FSUPPLYSEQNO 
	 物料编码：FSUPPLYMATERIALID 
	 规格型号：FSUPPLYMATERIALMODE 
	 单位：FSUPPLYUNITID 
	 预留数量：FRESERVEQTY 
	 预留状态：FRESERVESTATUS 
	 BOM版本：FSUPPLYBOMID 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 基本计量单位：FBASESUPPLYUNITID 
	 基本单位预留数量：FBASERESERVEQTY 
	 仓位：FSUPPLYSTOCKLOCID 
	 100新豪仓位值集：FF100003
	 ...
	 300德上仓位值集：FF100014
	 供应单据内码：FSUPPLYINTERID 
	 备注：FMemo 
	 可供应数量：FSupplyQty 
	 基本单位可供应数量：FBaseSupplyQty 
	 供给日期：FSUPPLYDATE 
	 库存单据类型：FStockFormId 
	 库存单据内码：FStockInterId 
	 库存单据分录内码：FStockEntryId 
	 供应单表体标识：FSupplyEntityKey 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PLN_RESERVE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDEMANDORGID":{"FNumber":""},"FMATERIALID":{"FNumber":""},"FDemandDate":"1900-01-01","FReserveEndDate":"1900-01-01","FEarlyDay":0,"FUseObjTypeId":"","FUseObjId":{"FNumber":""},"FSOURCEFORMID":{"FID":""},"FSOURCEINTERID":"","FSOURCEENTRYID":"","FEntity":[{"FEntryID":0,"FSUPPLYORGID":{"FNumber":""},"FSUPPLYFORMID":{"FID":""},"FSUPPLYINTERID":"","FSUPPLYBILLNO":"","FSUPPLYENTRYID":"","FSUPPLYSEQNO":0,"FSUPPLYMATERIALID":{"FNumber":""},"FSUPPLYDATE":"1900-01-01","FSUPPLYUNITID":{"FNumber":""},"FSupplyQty":0,"FRESERVEQTY":0,"FRESERVESTATUS":"","FSUPPLYSTOCKID":{"FNumber":""},"FSUPPLYSTOCKLOCID":{"FSUPPLYSTOCKLOCID__FF100003":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100005":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100006":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100007":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100008":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100009":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100011":{"FNumber":""},"FSUPPLYSTOCKLOCID__FF100014":{"FNumber":""}},"FSUPPLYBOMID":{"FNumber":""},"FSUPPLYLOT":{"FNumber":""},"FSUPPLYMTONO":"","FBASESUPPLYUNITID":{"FNumber":""},"FBaseSupplyQty":0,"FBASERESERVEQTY":0,"FSUPPLYAUXPROPID":{"FSUPPLYAUXPROPID__FF100001":{"FNumber":""},"FSUPPLYAUXPROPID__FF100002":{"FNumber":""},"FSUPPLYAUXPROPID__FF100003":{"FNumber":""},"FSUPPLYAUXPROPID__FF100005":{"FNumber":""},"FSUPPLYAUXPROPID__FF100010":{"FNumber":""},"FSUPPLYAUXPROPID__FF100007":{"FNumber":""},"FSUPPLYAUXPROPID__FF100008":{"FNumber":""}},"FMemo":"","FStockFormId":"","FStockInterId":"","FStockEntryId":"","FSupplyEntityKey":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLN_RESERVE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PLN_RESERVE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PLN_RESERVE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PLN_RESERVE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PLN_RESERVE","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PLN_RESERVE","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PLN_RESERVE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PLN_RESERVE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLN_RESERVE"}");

# 经营费用分配结果单 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 经营费用分配结果单
...
client.Delete("AM_COSTALLOCATRESULTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_COSTALLOCATRESULTS","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FACCTBOOKID":{"FNUMBER":""},"FSTARTPERIOD":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FCURRENTYEAR":0,"FCURRENTPERIOD":0,"FAMSTDID":{"FNUMBER":""},"FAMOEBAID":{"FNUMBER":""},"FSRCDTAILID":0,"FCURRENCYID":{"FNUMBER":""},"FCOSTINPUTTYPE":"","FORGSTRUCTUREID":{"FNUMBER":""},"FCOSTOBJECTIN":"","FCOSTOBJECTID":0,"FCOSTOBJECTDESC":"","FCOSTOBJECTTYPE":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FENTRYDATE":"1900-01-01","FEXPENSEID":{"FNUMBER":""},"FACCOUNTID":{"FNUMBER":""},"FFLEXDETAILID":{"FFLEXDETAILID__FFLEX9":{"FNumber":""},"FFLEXDETAILID__FFLEX10":{"FNumber":""},"FFLEXDETAILID__FFLEX11":{"FNumber":""},"FFLEXDETAILID__FFLEX12":{"FNumber":""},"FFLEXDETAILID__FFLEX13":{"FNumber":""},"FFLEXDETAILID__FF100002":{"FNumber":""},"FFLEXDETAILID__FFLEX4":{"FNumber":""},"FFLEXDETAILID__FF100003":{"FNumber":""},"FFLEXDETAILID__FFLEX5":{"FNumber":""},"FFLEXDETAILID__FF100004":{"FNumber":""},"FFLEXDETAILID__FFLEX6":{"FNumber":""},"FFLEXDETAILID__FF100005":{"FNumber":""},"FFLEXDETAILID__FFLEX7":{"FNumber":""},"FFLEXDETAILID__FF100006":{"FNumber":""},"FFLEXDETAILID__FFLEX8":{"FNumber":""},"FFLEXDETAILID__FF100007":{"FNumber":""},"FFLEXDETAILID__FF100008":{"FNumber":""},"FFLEXDETAILID__FF100009":{"FNumber":""}},"FAMOUNT":0,"FWEIGHT":0,"FALLWEIGHT":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FFLEXDETAILID": {
                    "FFLEXDETAILID__FFLEX9": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX10": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX11": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX12": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX13": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100002": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX4": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100003": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX5": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100004": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX6": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100005": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX7": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100006": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FFLEX8": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100007": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100008": {
                        "FNumber": ""
                    },
                    "FFLEXDETAILID__FF100009": {
                        "FNumber": ""
                    }
                },
                "FAMOUNT": 0,
...
单据头：FBillHead 
	 ...
	 经营单元：FAMOEBAID  (必填项)
	 维度内码：FSRCDTAILID 
	 引入总账科目方案分录内码：FVCHPLANENTRYID 
	 业务期间：FSTARTPERIOD  (必填项)
	 币别：FCURRENCYID 
	 费用录入方式：FCOSTINPUTTYPE  (必填项)
	 组织架构：FORGSTRUCTUREID  (必填项)
	 利润中心：FPROFITCENTERID 
	 费用分摊方案行号：FEXPSHARESEQ 
	 费用分摊分录内码：FEXPSHAREENTRYID 
	 来源单据行号：FFROMBILLSEQ 
	 来源单据：FFROMBILLFORMID 
	 费用分摊方案编号：FEXPSHAREID 
	 费用承担对象：FCOSTOBJECTIN 
	 对象内码：FCOSTOBJECTID 
	 费用承担对象多语言：FCOSTOBJECTDESC 
	 费用承担类型：FCOSTOBJECTTYPE 
单据体：FEntity 
	 实体主键：FEntryID 
	 费用项目：FEXPENSEID 
	 金额：FAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_COSTALLOCATRESULTS","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FACCTBOOKID":{"FNUMBER":""},"FSTARTPERIOD":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FCURRENTYEAR":0,"FCURRENTPERIOD":0,"FAMSTDID":{"FNUMBER":""},"FAMOEBAID":{"FNUMBER":""},"FSRCDTAILID":0,"FCURRENCYID":{"FNUMBER":""},"FCOSTINPUTTYPE":"","FORGSTRUCTUREID":{"FNUMBER":""},"FCOSTOBJECTIN":"","FCOSTOBJECTID":0,"FCOSTOBJECTDESC":"","FCOSTOBJECTTYPE":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FENTRYDATE":"1900-01-01","FEXPENSEID":{"FNUMBER":""},"FACCOUNTID":{"FNUMBER":""},"FFLEXDETAILID":{"FFLEXDETAILID__FFLEX9":{"FNumber":""},"FFLEXDETAILID__FFLEX10":{"FNumber":""},"FFLEXDETAILID__FFLEX11":{"FNumber":""},"FFLEXDETAILID__FFLEX12":{"FNumber":""},"FFLEXDETAILID__FFLEX13":{"FNumber":""},"FFLEXDETAILID__FF100002":{"FNumber":""},"FFLEXDETAILID__FFLEX4":{"FNumber":""},"FFLEXDETAILID__FF100003":{"FNumber":""},"FFLEXDETAILID__FFLEX5":{"FNumber":""},"FFLEXDETAILID__FF100004":{"FNumber":""},"FFLEXDETAILID__FFLEX6":{"FNumber":""},"FFLEXDETAILID__FF100005":{"FNumber":""},"FFLEXDETAILID__FFLEX7":{"FNumber":""},"FFLEXDETAILID__FF100006":{"FNumber":""},"FFLEXDETAILID__FFLEX8":{"FNumber":""},"FFLEXDETAILID__FF100007":{"FNumber":""},"FFLEXDETAILID__FF100008":{"FNumber":""},"FFLEXDETAILID__FF100009":{"FNumber":""}},"FAMOUNT":0,"FWEIGHT":0,"FALLWEIGHT":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_COSTALLOCATRESULTS","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_COSTALLOCATRESULTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_COSTALLOCATRESULTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AM_COSTALLOCATRESULTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_COSTALLOCATRESULTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AM_COSTALLOCATRESULTS","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AM_COSTALLOCATRESULTS"}");

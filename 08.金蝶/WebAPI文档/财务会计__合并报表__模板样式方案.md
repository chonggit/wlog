# 模板样式方案 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 合并报表 > 模板样式方案
...
client.Delete("CR_WizardScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CR_WizardScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CR_WizardScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRptType":"","FStypeType":"","FFillDirection":"","FIsAutoIndent":"false","FIsRptItem":"false","FIsItemDataType":"false","FIsItemFormula":"false","FIsAccessFormula":"false","FIsElimination":"false","FIsConsolidate":"false","FIsAdjust":"false","FIsSummary":"false","FElimTypeID":{"FNumber":""},"FDefRowCol":0,"FIncludeSum":"false","FCanInputDim":"false","FAdjustOption":"","FIsSingle":"false","FTransactionTypeId":{"FNUMBER":""},"FFillBy":"","FAccessFormula":"","FAcctBookId":{"FNumber":""},"FCurrencyId":"","FAcctOrgId":{"FNumber":""},"FCycle":"","FCurrencyUnitId":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FDescription":"","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FIsAccFlaIsItemFla":"false","FIsTransBalance":"false","FFormulaParam4Product":"","FFormulaParam4Material":"","FIncludeDeliver":"false","FAccessFormulaParams":"","FISFIRSTCOLUMN":"false","FDATADIRECTION":"","FSumPosition":"","FItemEntity":[{"FEntryID":0,"FDynItemDataTypeID":{"FNUMBER":""},"FItemId":{"FNumber":""},"FItemIndent":0,"FNewLine":"false","FItemFormula":"","FIsInnerItem":"false","FInnerItemFormula":"","FItemYear":0,"FItemPeriod":0}],"FItemDataTypeEntity":[{"FEntryID":0,"FItemDataTypeId":{"FNumber":""},"FYear":0,"FPeriod":0}],"FFormulaEntity":[{"FEntryID":0,"FAccessDataTypeId":{"FNumber":""},"FAccessType":"","FAccessYear":0,"FAccessStarPeriod":0,"FAccessEndPeriod":0}],"FDimensionEntity":[{"FEntryID":0,"FDimensionID":{"FNumber":""},"FDataGroupLevel":0,"FDDIMENSIONPROPERTYENTRY":[{"FDetailID":0,"FFIELDTITLE":"","FFieldKey":"","FIsShowInRpt":"false"}]}],"FDataColEntity":[{"FAddColEryID":0,"FAddItemDataTypeId":{"FNUMBER":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIsAutoIndent": "false",
        "FIsRptItem": "false",
        "FIsItemDataType": "false",
        "FIsItemFormula": "false",
        "FIsAccessFormula": "false",
        "FIsElimination": "false",
        "FIsConsolidate": "false",
        "FIsAdjust": "false",
        "FIsSummary": "false",
        "FElimTypeID": {
            "FNumber": ""
        ...
        "FIsAccFlaIsItemFla": "false",
        "FIsTransBalance": "false",
        "FFormulaParam4Product": "",
        "FFormulaParam4Material": "",
        "FIncludeDeliver": "false",
        "FAccessFormulaParams": "",
        "FISFIRSTCOLUMN": "false",
        "FDATADIRECTION": "",
        "FSumPosition": "",
        "FItemEntity": [
            {
...
单据头：FBillHead 
	 ...
	 报表类型：FRptType  (必填项)
	 样式类型：FStypeType  (必填项)
	 报表项目填充方向：FFillDirection  (必填项)
	 报表项目填充自动缩进：FIsAutoIndent 
	 报表项目：FIsRptItem 
	 数据类型：FIsItemDataType 
	 项目公式：FIsItemFormula 
	 取数公式：FIsAccessFormula 
	 取数公式：FAccessFormula  (必填项)
	 取数账簿：FAcctBookId 
	 核算组织：FAcctOrgId 
	 周期：FCycle 
	 金额单位：FCurrencyUnitId 
	 币别：FCurrencyId  (必填项)
	 填充分组依据：FFillBy  (必填项)
	 抵消类型：FElimTypeID 
	 维度值允许手工录入：FCanInputDim 
	 包含合计项：FIncludeSum 
	 默认插入行列数：FDefRowCol 
	 个别数：FIsSingle 
	 汇总数：FIsSummary 
	 ...
	 抵消数：FIsElimination 
	 调整：FAdjustOption 
	 交易种类：FTransactionTypeId 
	 取数公式来源项目取数公式：FIsAccFlaIsItemFla 
	 交易结存明细表：FIsTransBalance 
	 产品：FFormulaParam4Product 
	 原料：FFormulaParam4Material 
	 是否统计核算组织内的调拨单据：FIncludeDeliver 
	 取数公式参数：FAccessFormulaParams 
	 合并数/汇总数置于数据列首：FISFIRSTCOLUMN 
	 取数方：FDATADIRECTION  (必填项)
	 合计项位置：FSumPosition  (必填项)
报表项目：FItemEntity 
	 实体主键：FEntryID 
	 报表项目：FItemId  (必填项)
	 另起一列(行)填充：FNewLine 
	 数据类型：FDynItemDataTypeID 
	 年度：FItemYear 
	 期间：FItemPeriod 
	 项目名称：FItemName 
	 项目取数公式：FItemFormula 
	 缩进字符数：FItemIndent 
	 表内计算项：FIsInnerItem 
	 表内计算项公式：FInnerItemFormula 
项目数据类型：FItemDataTypeEntity 
	 实体主键：FEntryID 
	 数据类型：FItemDataTypeId  (必填项)
	 数据属性：FDataProperty 
	 年度：FYear 
	 期间：FPeriod 
	 自动取数：FAutoFetch 
	 数据类型描述：FAutoFetchDes 
取数公式：FFormulaEntity 
	 实体主键：FEntryID 
	 项目数据类型：FAccessDataTypeId  (必填项)
	 取数类型：FAccessType  (必填项)
	 年度：FAccessYear 
	 起始期间：FAccessStarPeriod 
	 结束期间：FAccessEndPeriod 
	 项目数据类型名称：FItemDataTypeName 
报表维度：FDimensionEntity 
	 实体主键：FEntryID 
	 报告维度：FDimensionID 
	 维度类型：FDimesionCategory 
	 分组级次：FDataGroupLevel 
数据列：FDataColEntity 
	 实体主键：FAddColEryID 
	 数据列名：FAddItemDataTypeId 
报表维度类型属性：FDDIMENSIONPROPERTYENTRY 
	 实体主键：FDetailID 
	 字段描述：FFIELDTITLE 
	 字段标识：FFieldKey 
	 显示到报表：FIsShowInRpt 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CR_WizardScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRptType":"","FStypeType":"","FFillDirection":"","FIsAutoIndent":"false","FIsRptItem":"false","FIsItemDataType":"false","FIsItemFormula":"false","FIsAccessFormula":"false","FIsElimination":"false","FIsConsolidate":"false","FIsAdjust":"false","FIsSummary":"false","FElimTypeID":{"FNumber":""},"FDefRowCol":0,"FIncludeSum":"false","FCanInputDim":"false","FAdjustOption":"","FIsSingle":"false","FTransactionTypeId":{"FNUMBER":""},"FFillBy":"","FAccessFormula":"","FAcctBookId":{"FNumber":""},"FCurrencyId":"","FAcctOrgId":{"FNumber":""},"FCycle":"","FCurrencyUnitId":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FDescription":"","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FIsAccFlaIsItemFla":"false","FIsTransBalance":"false","FFormulaParam4Product":"","FFormulaParam4Material":"","FIncludeDeliver":"false","FAccessFormulaParams":"","FISFIRSTCOLUMN":"false","FDATADIRECTION":"","FSumPosition":"","FItemEntity":[{"FEntryID":0,"FDynItemDataTypeID":{"FNUMBER":""},"FItemId":{"FNumber":""},"FItemIndent":0,"FNewLine":"false","FItemFormula":"","FIsInnerItem":"false","FInnerItemFormula":"","FItemYear":0,"FItemPeriod":0}],"FItemDataTypeEntity":[{"FEntryID":0,"FItemDataTypeId":{"FNumber":""},"FYear":0,"FPeriod":0}],"FFormulaEntity":[{"FEntryID":0,"FAccessDataTypeId":{"FNumber":""},"FAccessType":"","FAccessYear":0,"FAccessStarPeriod":0,"FAccessEndPeriod":0}],"FDimensionEntity":[{"FEntryID":0,"FDimensionID":{"FNumber":""},"FDataGroupLevel":0,"FDDIMENSIONPROPERTYENTRY":[{"FDetailID":0,"FFIELDTITLE":"","FFieldKey":"","FIsShowInRpt":"false"}]}],"FDataColEntity":[{"FAddColEryID":0,"FAddItemDataTypeId":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CR_WizardScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CR_WizardScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CR_WizardScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_WizardScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_WizardScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CR_WizardScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CR_WizardScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CR_WizardScheme"}");

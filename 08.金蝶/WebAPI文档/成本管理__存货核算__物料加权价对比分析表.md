# 物料加权价对比分析表 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 物料加权价对比分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2895 |
...
client.GetSysReportData("HS_MatWeightAvgPriceContrastReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTGORGID":{"FNUMBER":""},"FACCTPOLICYID":{"FNUMBER":""},"FACCTGSYSTEMID":{"FNUMBER":""},"FTARGETCOSTTYPE":"","FYEAR":"","FPERIOD":""}}");
...
参数FieldKeys显示列：
	 ...
	 仓库：FSTOCKID 
	 仓位：FSTOCKLOCNAME 
	 本期加权平均价&本期加权平均价：FNOWWEIGHTAVGPRICE 
	 本期加权平均价&目标成本：FNOWWEIGHTAVGTARGETCOST 
	 本期加权平均价&差额：FNOWWEIGHTDIFFAMOUNT 
	 本期加权平均价&差异率：FNOWWEIGHTDIFF 
	 期末加权平均价&期末加权平均价：FENDWEIGHTAVGPRICE 
	 期末加权平均价&目标成本：FENDWEIGHTAVGTARGETCOST 
	 期末加权平均价&差额：FENDWEIGHTAVGDIFFAMOUNT 
	 期末加权平均价&差异率：FENDWEIGHTAVGDIFF 
	 描述：FF100001 
	 公差：FF100002 
	 品牌：FF100003 
	 TU归属：FF100005 

# 采购价目表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 采购价目表
...
| 取消禁用 | Effective | 1696 |
| 禁用 | UnEffective | 1698 |
| 分录禁用 | SubUnEffective | 1701 |
| 取消分录禁用 | SubEffective | 1699 |
| 下推 | Push | 2326 |
| 行审核 | RowAudit | 1695 |
| 行反审核 | RowUnAudit | 1697 |
| 批量保存 | BatchSave | 3056 |
...
client.Delete("PUR_PriceCategory","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_PriceCategory","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_PriceCategory","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FPriceObject":"","FPriceType":"","FCurrencyID":{"FNumber":""},"FSupplierID":{"FNumber":""},"FPricer":{},"FIsIncludedTax":"false","FDefPriceListId":"false","FDescription":"","FIsPriceExcludeTax":"false","FPriceListEntry":[{"FEntryID":0,"FMaterialId":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FMaterialTypeId":{"FNumber":""},"FUnitID":{"FNumber":""},"FFROMQTY":0,"FToQty":0,"FPrice":0,"FTaxPrice":0,"FPublicWastePrice":0,"FPublicWasteTaxPrice":0,"FWastePrice":0,"FWasteTaxPrice":0,"FTaxRate":0,"FPriceCoefficient":0,"FDownPrice":0,"FUpPrice":0,"FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FDisablerId":{"FUserID":""},"FDisableDate":"1900-01-01","FProcessOrgId":{"FNumber":""},"FPROCESSID":{"FNUMBER":""},"FDefBaseDataO":{"FNUMBER":""},"FDefBaseDataT":{"FNUMBER":""},"FDefAssistantO":{"FNumber":""},"FDefAssistantT":{"FNumber":""},"FDefTextO":"","FDefTextT":"","FDefaultPriceO":0,"FDefaultPriceT":0,"FNote":"","FPRICEFROM":"","FFROMBILLNO":"","FRECENTDATE":"1900-01-01"}]}}");
...
基本信息：FBillHead 
	 ...
	 供应商：FSupplierID 
	 价格类型：FPriceType  (必填项)
	 生效日（2.0废除）：FEffectiveDate 
	 失效日（2.0废除）：FExpiryDate 
	 含税：FIsIncludedTax 
	 币别：FCurrencyID  (必填项)
	 定价员：FPricer 
	 禁用日期：FForbidDate 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 供货方(2.0废除)：FSupplierLocId 
	 价目表对象：FPriceObject  (必填项)
	 默认价目表：FDefPriceListId 
	 供应商Masterid：FSupplierMasterId 
	 价外税：FIsPriceExcludeTax 
价目表明细：FPriceListEntry 
	 实体主键：FEntryID 
	 物料编码：FMaterialId 
	 生效日期：FEntryEffectiveDate  (必填项)
	 失效日期：FEntryExpiryDate  (必填项)
	 物料名称：FMaterialName 
	 至：FToQty 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 调价唯一性标示：FPATIdentity 
	 采购目录编码：FCatalogNo 
	 采购目录分录ID：FCatalogEntryId 
	 含税单价：FTaxPrice  (必填项)
	 税率%：FTaxRate 
	 作业：FPROCESSID 
	 工废单价：FPublicWastePrice 
	 料废单价：FWastePrice 
	 工废含税单价：FPublicWasteTaxPrice 
	 料废含税单价：FWasteTaxPrice 
	 需求组织：FProcessOrgId 
	 物料masterid：FMMasterid 
	 ...
	 最近调价日期：FRECENTDATE 
关联关系表：FPriceListEntry_Link 
	 实体主键：FLinkId 
	 业务流程图：FPriceListEntry_Link_FFlowId 
	 推进路线：FPriceListEntry_Link_FFlowLineId 
	 转换规则：FPriceListEntry_Link_FRuleId 
	 源单表内码：FPriceListEntry_Link_FSTableId 
	 源单表：FPriceListEntry_Link_FSTableName 
	 源单内码：FPriceListEntry_Link_FSBillId 
	 源单分录内码：FPriceListEntry_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PUR_PriceCategory","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FPriceObject":"","FPriceType":"","FCurrencyID":{"FNumber":""},"FSupplierID":{"FNumber":""},"FPricer":{},"FIsIncludedTax":"false","FDefPriceListId":"false","FDescription":"","FIsPriceExcludeTax":"false","FPriceListEntry":[{"FEntryID":0,"FMaterialId":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FMaterialTypeId":{"FNumber":""},"FUnitID":{"FNumber":""},"FFROMQTY":0,"FToQty":0,"FPrice":0,"FTaxPrice":0,"FPublicWastePrice":0,"FPublicWasteTaxPrice":0,"FWastePrice":0,"FWasteTaxPrice":0,"FTaxRate":0,"FPriceCoefficient":0,"FDownPrice":0,"FUpPrice":0,"FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FDisablerId":{"FUserID":""},"FDisableDate":"1900-01-01","FProcessOrgId":{"FNumber":""},"FPROCESSID":{"FNUMBER":""},"FDefBaseDataO":{"FNUMBER":""},"FDefBaseDataT":{"FNUMBER":""},"FDefAssistantO":{"FNumber":""},"FDefAssistantT":{"FNumber":""},"FDefTextO":"","FDefTextT":"","FDefaultPriceO":0,"FDefaultPriceT":0,"FNote":"","FPRICEFROM":"","FFROMBILLNO":"","FRECENTDATE":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_PriceCategory","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_PriceCategory","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_PriceCategory","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_PriceCategory","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PriceCategory","Effective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PriceCategory","UnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PriceCategory","SubUnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PriceCategory","SubEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("PUR_PriceCategory","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PriceCategory","RowAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PriceCategory","RowUnAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PUR_PriceCategory","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_PriceCategory"}");

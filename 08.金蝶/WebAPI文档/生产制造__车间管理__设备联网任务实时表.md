# 设备联网任务实时表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 设备联网任务实时表
...
client.Delete("SFC_DITaskBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_DITaskBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FOrgId":{"FNumber":""},"FPrdLineId":{"FNUMBER":""},"FEqmId":{"FNUMBER":""},"FTaskType":"","FPrdMtrlId":{"FNUMBER":""},"FMoQty":0,"FMoNo":"","FMoType":"","FProId":{"FNUMBER":""},"FIsBatchRpt":"false","FTraceNo":"","FUserId":{"FUserID":""},"FOPSEQID":0,"FDispatchDetailEntryId":"","FResource":{"FNUMBER":""},"FShiftslice":{"FNUMBER":""},"FShiftGroup":{"FNUMBER":""},"FEmpId":"","FOperID":"","FNumber":"","FCreateDate":"1900-01-01","FSeqNumber":"","FDITaskHistoryDataId":0,"FDITaskHisDataNumber":""}}");
...
单据头：FBillHead 
	 ...
	 任务类型：FTaskType 
	 创建日期：FCreateDate 
	 历史任务表ID：FDITaskHistoryDataId 
	 历史任务表编码：FDITaskHisDataNumber 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_DITaskBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SFC_DITaskBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_DITaskBill"}");

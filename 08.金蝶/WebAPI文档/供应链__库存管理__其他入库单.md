# 其他入库单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 其他入库单
...
client.Delete("STK_MISCELLANEOUS","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("STK_MISCELLANEOUS","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FStockOrgId":{"FNumber":""},"FStockDirect":"","FDate":"1900-01-01","FSUPPLIERID":{"FNumber":""},"FDEPTID":{"FNumber":""},"FACCEPTANCE":{"FStaffNumber":""},"FSTOCKERID":{"FNumber":""},"FSTOCKERGROUPID":{"FNumber":""},"FOwnerTypeIdHead":"","FOwnerIdHead":{"FNumber":""},"FNOTE":"","FScanBox":"","F_PAEZ_Assistant":{"FNumber":""},"F_xhfz_Invoice":"false","FInputOrgName":"","FCheckCreateBill":"false","F_TransferNo":"","F_XCKF_AccountPeriod":"1900-01-01","FEntity":[{"FEntryID":0,"FInStockType":"","FMATERIALID":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FSTOCKSTATUSID":{"FNumber":""},"FSTOCKID":{"FNumber":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FLOT":{"FNumber":""},"F_PAEZ_Text":"","F_PAEZ_Text2":"","F_PAEZ_Text1":"","FQty":0,"FOWNERTYPEID":"","FOWNERID":{"FNumber":""},"FEntryNote":"","FSRCBILLNO":"","FBOMID":{"FNumber":""},"FSRCBILLTYPEID":"","FPRODUCEDATE":"1900-01-01","FMTONO":"","FProjectNo":"","FExtAuxUnitId":{"FNumber":""},"FExtAuxUnitQty":0,"FKEEPERTYPEID":"","F_PAEZ_Text3":"","F_TY_Decimal":0,"FKEEPERID":{"FNumber":""},"F_InventoryFG":{"FNUMBER":""},"FInstockDate":"1900-01-01","F_ordernumber":"","F_boxesNO":"","F_mannerofpacking":"","F_workordernumber":"","F_Processnumber":0,"F_linenumbers":0,"F_ora_boxes":0,"F_ora_Customssign":"","FInputStockName":"","FInputLocName":"","FInputStockNumber":"","FInputLocNumber":"","F_WXSQNO":"","F_WXQSDROWNO":"","FApplySeq":0,"FSplitSeq":0,"FProjectapproval":{"FNUMBER":""},"FSerialSubEntity":[{"FDetailID":0,"FSerialNo":"","FSerialNote":""}]}]}}");
...
基本信息：FBillHead 
	 ...
	 审核日期：FAPPROVEDATE 
	 序列号上传：FScanBox 
	 入库类型：F_PAEZ_Assistant  (必填项)
	 已开票：F_xhfz_Invoice 
	 附件数：F_ora_AttachmentCount 
	 传入组织：FInputOrgName 
	 审核自动生成直接调拔单：FCheckCreateBill 
	 直接调拨单单号：F_TransferNo 
	 结账日期：F_XCKF_AccountPeriod 
明细信息：FEntity 
	 实体主键：FEntryID 
	 ...
	 即时库存：FInvQty 
	 参考实收数量：FREFQTY 
	 参考实收数量(基本单位)：FREFBASEQTY 
	 参考实收数量(辅单位)：FREFEXTAUXUNITQTY 
	 参考实收数量(库存辅单位)：FREFSECQTY 
	 参考总成本：FREFAMOUNT 
	 源单录入序列号标识：FQMSERIALFLAG 
	 入库日期：FInstockDate 
	 合同号/支数：F_PAEZ_Text 
	 清关单号：F_PAEZ_Text1 
	 商品编码：F_PAEZ_Text2 
	 ...
	 成品指定对象：F_InventoryFG 
	 成品指定对象名称：F_ItemNameFG 
	 生产订单号：F_ordernumber 
	 箱数（旧）：F_boxesNO 
	 包装方式：F_mannerofpacking 
	 随工单号：F_workordernumber 
	 工序号：F_Processnumber 
	 生产订单行号：F_linenumbers 
	 箱数：F_ora_boxes 
	 海关标识：F_ora_Customssign 
	 传入仓库：FInputStockName 
	 传入仓位：FInputLocName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("STK_MISCELLANEOUS","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FStockOrgId":{"FNumber":""},"FStockDirect":"","FDate":"1900-01-01","FSUPPLIERID":{"FNumber":""},"FDEPTID":{"FNumber":""},"FACCEPTANCE":{"FStaffNumber":""},"FSTOCKERID":{"FNumber":""},"FSTOCKERGROUPID":{"FNumber":""},"FOwnerTypeIdHead":"","FOwnerIdHead":{"FNumber":""},"FNOTE":"","FScanBox":"","F_PAEZ_Assistant":{"FNumber":""},"F_xhfz_Invoice":"false","FInputOrgName":"","FCheckCreateBill":"false","F_TransferNo":"","F_XCKF_AccountPeriod":"1900-01-01","FEntity":[{"FEntryID":0,"FInStockType":"","FMATERIALID":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FSTOCKSTATUSID":{"FNumber":""},"FSTOCKID":{"FNumber":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FLOT":{"FNumber":""},"F_PAEZ_Text":"","F_PAEZ_Text2":"","F_PAEZ_Text1":"","FQty":0,"FOWNERTYPEID":"","FOWNERID":{"FNumber":""},"FEntryNote":"","FSRCBILLNO":"","FBOMID":{"FNumber":""},"FSRCBILLTYPEID":"","FPRODUCEDATE":"1900-01-01","FMTONO":"","FProjectNo":"","FExtAuxUnitId":{"FNumber":""},"FExtAuxUnitQty":0,"FKEEPERTYPEID":"","F_PAEZ_Text3":"","F_TY_Decimal":0,"FKEEPERID":{"FNumber":""},"F_InventoryFG":{"FNUMBER":""},"FInstockDate":"1900-01-01","F_ordernumber":"","F_boxesNO":"","F_mannerofpacking":"","F_workordernumber":"","F_Processnumber":0,"F_linenumbers":0,"F_ora_boxes":0,"F_ora_Customssign":"","FInputStockName":"","FInputLocName":"","FInputStockNumber":"","FInputLocNumber":"","F_WXSQNO":"","F_WXQSDROWNO":"","FApplySeq":0,"FSplitSeq":0,"FProjectapproval":{"FNUMBER":""},"FSerialSubEntity":[{"FDetailID":0,"FSerialNo":"","FSerialNote":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("STK_MISCELLANEOUS","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("STK_MISCELLANEOUS","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("STK_MISCELLANEOUS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("STK_MISCELLANEOUS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("STK_MISCELLANEOUS","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("STK_MISCELLANEOUS","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_MISCELLANEOUS","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_MISCELLANEOUS","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("STK_MISCELLANEOUS","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"STK_MISCELLANEOUS"}");

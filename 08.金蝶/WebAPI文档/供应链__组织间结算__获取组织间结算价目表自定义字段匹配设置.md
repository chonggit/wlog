# 获取组织间结算价目表自定义字段匹配设置 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 组织间结算 > 获取组织间结算价目表自定义字段匹配设置
...
client.Delete("IOS_GetIOSPriceCustSet","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IOS_GetIOSPriceCustSet","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IOS_GetIOSPriceCustSet","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FFORMID":{"FID":""},"FPPTYPE":"","FPRICEKEY":"","FEXTBILLFIELDKEY":"","FPriceKeyName":"","FBillKeyName":""}}");
...
单据头：FBillHead 
	 ...
	 业务对象：FFORMID 
	 基础资料字段匹配模式：FPPTYPE 
	 组织间价目表的字段标识：FPRICEKEY 
	 结算清单上的字段标识：FEXTBILLFIELDKEY 
	 价目表字段名称：FPriceKeyName 
	 结算清单字段名称：FBillKeyName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IOS_GetIOSPriceCustSet","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FFORMID":{"FID":""},"FPPTYPE":"","FPRICEKEY":"","FEXTBILLFIELDKEY":"","FPriceKeyName":"","FBillKeyName":""}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IOS_GetIOSPriceCustSet"}");

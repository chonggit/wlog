...
| 分配 | Allocate | 1186 |
| 取消分配 | CancelAllocate | 1192 |
| 反注册 | UnRegistered | 1702 |
| 注册 | Registered | 1700 |
| POS解锁 | PosUnlLock | 4050 |
| 批量保存 | BatchSave | 3059 |
...
client.Delete("CMK_LS_POSManagement","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CMK_LS_POSManagement","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CMK_LS_POSManagement","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FCreateOrgId":{"FNumber":""},"FPOS":{"FNUMBER":""},"FLocalCurrId":{"FNUMBER":""},"FRegisterStatus":"","FIPAddress":"","FIndex":"","FGuid":"","FBranchID":{"FNUMBER":""},"FPosType":{"FNUMBER":""},"FPaymentChannels":"","FTIMEZONESID":{"FNUMBER":""},"FPrintConfigID":{"FNUMBER":""},"FBillsTID":"","FWISEASYTERMINALNO":"","FWISEASYDEVICENO":"","FWISEASYACCEPTCASHIER":"","FYLSWMchID":"","FLockDate":"1900-01-01","FSCANAUTOSETTLEID":{"FNUMBER":""},"FIP":"","FEntity":[{"FEntryID":0,"FStockId":{"FNUMBER":""},"FIsSelected":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FWISEASYTERMINALNO": "",
        "FWISEASYDEVICENO": "",
        "FWISEASYACCEPTCASHIER": "",
        "FYLSWMchID": "",
        "FLockDate": "1900-01-01",
        "FSCANAUTOSETTLEID": {
            "FNUMBER": ""
        },
        "FIP": "",
...
单据头：FBillHead 
	 ...
	 识别码：FGuid 
	 POS终端：FPOS 
	 注册状态：FRegisterStatus  (必填项)
	 币别：FLocalCurrId  (必填项)
	 所属门店：FBranchID  (必填项)
	 POS类型：FPosType  (必填项)
	 支付通道：FPaymentChannels  (必填项)
	 时区：FTIMEZONESID 
	 打印机-钱箱：FPrintConfigID 
	 银商POS终端号：FBillsTID 
	 银商POS商户号：FYLSWMchID 
	 微智金服终端号：FWISEASYTERMINALNO 
	 微智金服序列号：FWISEASYDEVICENO 
	 微智金服收银方式：FWISEASYACCEPTCASHIER 
	 锁定状态：FLockStatus 
	 锁定时间：FLockDate 
	 扫码自动结算设置：FISSCANAUTOSETTLE 
	 插件扫码收款方式：FSCANAUTOSETTLEID 
	 POS机IP地址：FIP 
单据体：FEntity 
	 实体主键：FEntryID 
	 仓库：FStockId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CMK_LS_POSManagement","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FCreateOrgId":{"FNumber":""},"FPOS":{"FNUMBER":""},"FLocalCurrId":{"FNUMBER":""},"FRegisterStatus":"","FIPAddress":"","FIndex":"","FGuid":"","FBranchID":{"FNUMBER":""},"FPosType":{"FNUMBER":""},"FPaymentChannels":"","FTIMEZONESID":{"FNUMBER":""},"FPrintConfigID":{"FNUMBER":""},"FBillsTID":"","FWISEASYTERMINALNO":"","FWISEASYDEVICENO":"","FWISEASYACCEPTCASHIER":"","FYLSWMchID":"","FLockDate":"1900-01-01","FSCANAUTOSETTLEID":{"FNUMBER":""},"FIP":"","FEntity":[{"FEntryID":0,"FStockId":{"FNUMBER":""},"FIsSelected":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CMK_LS_POSManagement","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CMK_LS_POSManagement","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CMK_LS_POSManagement","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CMK_LS_POSManagement","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CMK_LS_POSManagement","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CMK_LS_POSManagement","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Allocate("CMK_LS_POSManagement","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAllocate("CMK_LS_POSManagement","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CMK_LS_POSManagement","UnRegistered","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CMK_LS_POSManagement","Registered","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CMK_LS_POSManagement","PosUnlLock","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FCreateOrgId":{"FNumber":""},"FPOS":{"FNUMBER":""},"FLocalCurrId":{"FNUMBER":""},"FRegisterStatus":"","FIPAddress":"","FIndex":"","FGuid":"","FBranchID":{"FNUMBER":""},"FPosType":{"FNUMBER":""},"FPaymentChannels":"","FTIMEZONESID":{"FNUMBER":""},"FPrintConfigID":{"FNUMBER":""},"FBillsTID":"","FWISEASYTERMINALNO":"","FWISEASYDEVICENO":"","FWISEASYACCEPTCASHIER":"","FYLSWMchID":"","FLockDate":"1900-01-01","FSCANAUTOSETTLEID":{"FNUMBER":""},"FIP":"","FEntity":[{"FEntryID":0,"FStockId":{"FNUMBER":""},"FIsSelected":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CMK_LS_POSManagement","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CMK_LS_POSManagement"}");

# 银行存款日报表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 银行存款日报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 4049 |
...
client.GetSysReportData("CN_BankDailyReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FOrgID":[{"FNumber":""}],"FSETTLEORGID":[{"FNumber":""}],"FBankId":[{"FNumber":""}],"FBankAccountID":[{"FNumber":""}],"FINNERACCTID":[{"FNumber":""}],"FCurrencyIds":"","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FNotAudit":"false","FMyCurrency":"false","FCurrencySubTotal":"false","FMyPayOrg":"false","FAffiliation":{"FNUMBER":""},"FSettleOrgBox":"false","FPAYORGIDBOX":"false","FInnerPayOrgBox":"false","FMyCurrencySum":"false","FInnerPayOrgId":[{"FNumber":""}],"FPAYORGINNERACCTID":[{"FNumber":""}]}}");

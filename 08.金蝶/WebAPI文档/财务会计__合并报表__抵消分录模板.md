# 抵消分录模板 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 合并报表 > 抵消分录模板
...
client.Delete("CR_ElimTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CR_ElimTemplate","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CR_ElimTemplate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FTempTypeID":{"FNumber":""},"FElimTypeID":{"FNumber":""},"FDescription":"","FDealPeriod":"","FTransTypeID":{"FNUMBER":""},"FDeffMode":"","FDiffAllocate":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FRptItem":{"FNUMBER":""},"FIsSetScope":"false","FEntity":[{"FEntryID":0,"FExplanation":"","FRptItemID":{"FNumber":""},"FRptItemDataTypeID":{"FNumber":""},"FDC":"","FDataDirect":"","FDataSource":"","FDataFormula":"","FIsMulEsp":"false","FElimDirect":"","FCalByDetailDimension":"false","FFormulaEntity":[{"FFormulaID":0,"FFormulaRemark":"","FFormulaLeftSign":"","FFormulaItemID":{"FNUMBER":""},"FFormulaItemDataTypeID":{"FNUMBER":""},"FFormulaDataSource":"","FFormulaDataDirect":"","FFormulaRightSign":"","FFormulaOperator":""}]}],"FScopeEntity":[{"FEntryID":0,"FCompanyFromId":{"FNUMBER":""},"FCompanyToId":{"FNUMBER":""},"FIsMutual":"false"}]}}");
...
单据头：FBillHead 
	 ...
	 禁用人：FForbidderID 
	 禁用日期：FForbidDate 
	 抵消类型：FElimTypeID  (必填项)
	 交易期间：FDealPeriod 
	 差异处理：FDeffMode  (必填项)
	 编码：FNumber 
	 差异分配：FDiffAllocate  (必填项)
	 交易类型：FTransTypeID 
	 报表项目：FRptItem 
	 指定以下交易方适用此模板(未勾选此项适用于所有交易方)：FIsSetScope 
分录明细：FEntity 
	 实体主键：FEntryID 
	 项目编码：FRptItemID  (必填项)
	 项目名称：FRptItemName 
	 数据类型：FRptItemDataTypeID  (必填项)
	 借贷方向：FDC  (必填项)
	 取数来源：FDataSource 
	 抵消数：FDataFormula 
	 取数方：FDataDirect 
	 ...
	 摘要：FExplanation 
	 股权分段计算：FIsMulEsp 
	 按报表项目关联公司维度值汇总后再进行计算：FCalByDetailDimension 
公式明细：FFormulaEntity 
	 实体主键：FFormulaID 
	 说明：FFormulaRemark 
	 报表项目：FFormulaItemID 
	 数据类型：FFormulaItemDataTypeID 
	 左括号：FFormulaLeftSign 
	 数据来源：FFormulaDataSource 
	 取数方：FFormulaDataDirect 
	 右括号：FFormulaRightSign 
	 操作符：FFormulaOperator 
使用范围：FScopeEntity 
	 实体主键：FEntryID 
	 销售方：FCompanyFromId 
	 购买方：FCompanyToId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CR_ElimTemplate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FTempTypeID":{"FNumber":""},"FElimTypeID":{"FNumber":""},"FDescription":"","FDealPeriod":"","FTransTypeID":{"FNUMBER":""},"FDeffMode":"","FDiffAllocate":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FRptItem":{"FNUMBER":""},"FIsSetScope":"false","FEntity":[{"FEntryID":0,"FExplanation":"","FRptItemID":{"FNumber":""},"FRptItemDataTypeID":{"FNumber":""},"FDC":"","FDataDirect":"","FDataSource":"","FDataFormula":"","FIsMulEsp":"false","FElimDirect":"","FCalByDetailDimension":"false","FFormulaEntity":[{"FFormulaID":0,"FFormulaRemark":"","FFormulaLeftSign":"","FFormulaItemID":{"FNUMBER":""},"FFormulaItemDataTypeID":{"FNUMBER":""},"FFormulaDataSource":"","FFormulaDataDirect":"","FFormulaRightSign":"","FFormulaOperator":""}]}],"FScopeEntity":[{"FEntryID":0,"FCompanyFromId":{"FNUMBER":""},"FCompanyToId":{"FNUMBER":""},"FIsMutual":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CR_ElimTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CR_ElimTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CR_ElimTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ElimTemplate","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ElimTemplate","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CR_ElimTemplate","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CR_ElimTemplate"}");

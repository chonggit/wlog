# 生产线工位在制库存表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产线生产 > 生产线工位在制库存表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2284 |
...
client.GetSysReportData("REM_PrdLineLocationTranferRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FProOrgId":{"FNumber":""},"FProcessOrg":[{"FNumber":""}],"FPrdLine":[{"FNumber":""}]}}");

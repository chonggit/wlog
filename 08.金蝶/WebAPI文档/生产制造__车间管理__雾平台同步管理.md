# 雾平台同步管理 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 雾平台同步管理
...
client.Delete("SFC_OfflineSyncManage","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_OfflineSyncManage","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOfflineId":"","FOfflineSN":0,"FOfflineName":"","FRegisterTime":"1900-01-01","FCloudUrl":"","FCloudAcctCombo":"","FCloudAcctId":"","FIsCloud":"false","FOfflineUrl":"","FPassportCombo":"","FCloudAppId":"","FCloudAppSecret":"","FCloudUserName":"","FIsPassportCustom":"false","FBillNo":"","FFingerprintId":"","FIsValid":"false","FIsNeedUpdate":"false","FIsCompatible":"false","FPkAllocateStep":0,"FPkReserveStep":0,"FPkAllocateThreshold":0,"FPkMin":0,"FPkMax":0,"FIsPkNeedReallocate":"false","FLogLevel":"","FSyncDim":"","FTimeDiffLimit":0,"FIsAlreadyInit":"false","FIsOfflineInspect":"false","FSyncTimeOffset":0,"FJobEntity":[{"FEntryID":0,"FSyncDirection":"","FSyncStatus":"","FBeginTime":"1900-01-01","FEndTime":"1900-01-01","FJobId":"","FPkgSize":"","FPkgFileId":"","FMessage":"","FLastSyncTime":"1900-01-01"}],"FTableEntity":[{"FEntryID":0,"FTableName":"","FObjectTypeId":{"FID":""},"FIsPkNeedAllocate":"false","FIsPkAllocated":"false","FPkAllocateStatus":"","FOfflinePkFrom":0,"FOfflinePkTo":0,"FCloudPkFrom":0}],"FUserEntity":[{"FEntryID":0,"FUserId":{"FUSERACCOUNT":""},"FIsAdminUser":"false"}],"FEqmEntity":[{"FEntryID":0,"FEqmId":{"FNUMBER":""}}],"FDimEntity":[{"FEntryID":0,"FDimOrgId":{"FNUMBER":""},"FDimDeptId":{"FNUMBER":""},"FDimPrdLineId":{"FNUMBER":""},"FIsDimDisabled":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FPkAllocateStep": 0,
        "FPkReserveStep": 0,
        "FPkAllocateThreshold": 0,
        "FPkMin": 0,
        "FPkMax": 0,
        "FIsPkNeedReallocate": "false",
        "FLogLevel": "",
        "FSyncDim": "",
        "FTimeDiffLimit": 0,
        "FIsAlreadyInit": "false",
        "FIsOfflineInspect": "false",
        "FSyncTimeOffset": 0,
        "FJobEntity": [
            {
                "FEntryID": 0,
        ...
        "FTableEntity": [
            {
                ...
                "FIsPkNeedAllocate": "false",
                "FIsPkAllocated": "false",
                "FPkAllocateStatus": "",
                "FOfflinePkFrom": 0,
                "FOfflinePkTo": 0,
                "FCloudPkFrom": 0
...
单据头：FBillHead 
	 ...
	 主键分配最大值(废弃)：FPkMax 
	 云服务地址：FCloudUrl  (必填项)
	 云服务账套：FCloudAcctCombo 
	 云服务账套标识：FCloudAcctId  (必填项)
	 登录授权：FPassportCombo 
	 云服务登录授权ID：FCloudAppId 
	 云服务登录授权密钥：FCloudAppSecret 
	 云服务登录授权用户：FCloudUserName 
	 云服务登录授权自定义：FIsPassportCustom 
	 注册时间：FRegisterTime 
	 主键需重新分配(废弃)：FIsPkNeedReallocate 
	 雾服务序号：FOfflineSN 
	 是否需升级：FIsNeedUpdate 
	 是否有效：FIsValid 
	 是否云服务：FIsCloud 
	 雾服务账套指纹：FFingerprintId 
	 雾服务地址：FOfflineUrl  (必填项)
	 主键分配步长：FPkAllocateStep 
	 主键预留步长：FPkReserveStep 
	 主键分配触发阈值：FPkAllocateThreshold 
	 是否兼容处理：FIsCompatible 
	 日志级别：FLogLevel  (必填项)
	 响应时差上限：FTimeDiffLimit 
	 同步维度：FSyncDim  (必填项)
	 初始化：FIsAlreadyInit 
	 雾服务名称：FOfflineName 
	 雾端质检：FIsOfflineInspect 
	 同步时间偏移量：FSyncTimeOffset 
同步任务：FJobEntity 
	 实体主键：FEntryID 
	 同步任务号：FJobId 
	 同步状态：FSyncStatus 
	 ...
	 数据包标识：FPkgFileId 
	 同步信息：FMessage 
	 最新同步时间：FLastSyncTime 
同步数据表：FTableEntity 
	 实体主键：FEntryID 
	 数据表名：FTableName 
	 主键已分配(废弃)：FIsPkAllocated 
	 主键需分配：FIsPkNeedAllocate 
	 业务对象：FObjectTypeId 
	 雾主键分配从：FOfflinePkFrom 
	 雾主键分配至：FOfflinePkTo 
	 云主键分配从：FCloudPkFrom 
	 主键分配状态：FPkAllocateStatus 
雾用户：FUserEntity 
	 实体主键：FEntryID 
	 用户：FUserId  (必填项)
	 雾管理员：FIsAdminUser 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_OfflineSyncManage","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOfflineId":"","FOfflineSN":0,"FOfflineName":"","FRegisterTime":"1900-01-01","FCloudUrl":"","FCloudAcctCombo":"","FCloudAcctId":"","FIsCloud":"false","FOfflineUrl":"","FPassportCombo":"","FCloudAppId":"","FCloudAppSecret":"","FCloudUserName":"","FIsPassportCustom":"false","FBillNo":"","FFingerprintId":"","FIsValid":"false","FIsNeedUpdate":"false","FIsCompatible":"false","FPkAllocateStep":0,"FPkReserveStep":0,"FPkAllocateThreshold":0,"FPkMin":0,"FPkMax":0,"FIsPkNeedReallocate":"false","FLogLevel":"","FSyncDim":"","FTimeDiffLimit":0,"FIsAlreadyInit":"false","FIsOfflineInspect":"false","FSyncTimeOffset":0,"FJobEntity":[{"FEntryID":0,"FSyncDirection":"","FSyncStatus":"","FBeginTime":"1900-01-01","FEndTime":"1900-01-01","FJobId":"","FPkgSize":"","FPkgFileId":"","FMessage":"","FLastSyncTime":"1900-01-01"}],"FTableEntity":[{"FEntryID":0,"FTableName":"","FObjectTypeId":{"FID":""},"FIsPkNeedAllocate":"false","FIsPkAllocated":"false","FPkAllocateStatus":"","FOfflinePkFrom":0,"FOfflinePkTo":0,"FCloudPkFrom":0}],"FUserEntity":[{"FEntryID":0,"FUserId":{"FUSERACCOUNT":""},"FIsAdminUser":"false"}],"FEqmEntity":[{"FEntryID":0,"FEqmId":{"FNUMBER":""}}],"FDimEntity":[{"FEntryID":0,"FDimOrgId":{"FNUMBER":""},"FDimDeptId":{"FNUMBER":""},"FDimPrdLineId":{"FNUMBER":""},"FIsDimDisabled":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_OfflineSyncManage","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_OfflineSyncManage"}");

...
client.Delete("RPA_Task","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("RPA_Task","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FRobot":{"FName":""},"FTerminalName":"","FRpaRobotName":"","FRpaTaskCreator":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FExecuteTime":"1900-01-01","FExecuteStartTime":"1900-01-01","FExecuteEndTime":"1900-01-01","FRpaTaskId":0,"FTerminalId":0,"FRpaRobotId":0,"FRunMethod":"","FRunningStateDes":"","FResult":"","FRunningDurationDesc":"","FRunningDuration":0,"FReport":"","FParamEntity":[{"FEntryID":0,"FParamName":"","FParamType":"","FParamValue":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FExecuteTime": "1900-01-01",
        "FExecuteStartTime": "1900-01-01",
        "FExecuteEndTime": "1900-01-01",
        "FRpaTaskId": 0,
        "FTerminalId": 0,
        "FRpaRobotId": 0,
        "FRunMethod": "",
...
单据头：FBillHead 
	 ...
	 单据编号：FBillNo  (必填项)
	 机器人名：FRpaRobotName 
	 小K任务创建人名：FRpaTaskCreator 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 计划开始时间：FExecuteTime 
	 实际开始时间：FExecuteStartTime 
	 结束时间：FExecuteEndTime 
	 小K任务Id：FRpaTaskId 
	 运行终端Id：FTerminalId 
	 小K机器人Id：FRpaRobotId 
	 运行方式：FRunMethod  (必填项)
	 机器人名：FRobot  (必填项)
	 运行终端：FTerminalName  (必填项)
	 运行状态：FRunningStateDes 
	 运行结果：FResult 
	 运行时长：FRunningDurationDesc 
	 运行时长：FRunningDuration 
	 报告：FReport 
参数单据体：FParamEntity 
	 实体主键：FEntryID 
	 参数名：FParamName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("RPA_Task","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FRobot":{"FName":""},"FTerminalName":"","FRpaRobotName":"","FRpaTaskCreator":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FExecuteTime":"1900-01-01","FExecuteStartTime":"1900-01-01","FExecuteEndTime":"1900-01-01","FRpaTaskId":0,"FTerminalId":0,"FRpaRobotId":0,"FRunMethod":"","FRunningStateDes":"","FResult":"","FRunningDurationDesc":"","FRunningDuration":0,"FReport":"","FParamEntity":[{"FEntryID":0,"FParamName":"","FParamType":"","FParamValue":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("RPA_Task","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("RPA_Task","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RPA_Task"}");

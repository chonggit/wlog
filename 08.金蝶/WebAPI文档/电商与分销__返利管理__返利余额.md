...
| 保存 | Save | 4273 |
| 查看 | View | 1099 |
| 初始化 | InitAccountBalance | 2728 |
| 提交 | Submit | 1612 |
| 反审核 | UnAudit | 1770 |
| 撤销 | CancelAssign | 1394 |
| 审核 | Audit | 1883 |
| 反初始化 | ReInitAccountBalance | 2730 |
| 批量保存 | BatchSave | 3057 |
...
client.Delete("RPM_AccountBalance","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("RPM_AccountBalance","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgId":{"FNumber":""},"FCustomerID":{"FNUMBER":""},"FAccountID":{"FNUMBER":""},"FBalanceAmount":0,"FCurrencyID":{"FNUMBER":""},"FUpdateTime":"1900-01-01","FCustMasterID":0,"FBillNo":"","FOrderCustomerId":{"FNUMBER":""},"FOrderCustMasterId":0,"FIsGroupRebate":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FUpdateTime": "1900-01-01",
        "FCustMasterID": 0,
        "FBillNo": "",
        "FOrderCustomerId": {
            "FNUMBER": ""
        },
        "FOrderCustMasterId": 0,
...
基本信息：FBillHead 
	 ...
	 审核人：FApproverID 
	 审核日期：FApproveDate 
	 返利客户：FOrderCustomerId  (必填项)
	 订货客户分配内码：FOrderCustMasterId 
	 结算客户编码：FCustomerNumber 
	 返利客户编码：FOrderCustomerNum 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("RPM_AccountBalance","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgId":{"FNumber":""},"FCustomerID":{"FNUMBER":""},"FAccountID":{"FNUMBER":""},"FBalanceAmount":0,"FCurrencyID":{"FNUMBER":""},"FUpdateTime":"1900-01-01","FCustMasterID":0,"FBillNo":"","FOrderCustomerId":{"FNUMBER":""},"FOrderCustMasterId":0,"FIsGroupRebate":"false"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("RPM_AccountBalance","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("RPM_AccountBalance","InitAccountBalance","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FOrgId":{"FNumber":""},"FCustomerID":{"FNUMBER":""},"FAccountID":{"FNUMBER":""},"FBalanceAmount":0,"FCurrencyID":{"FNUMBER":""},"FUpdateTime":"1900-01-01","FCustMasterID":0,"FBillNo":"","FOrderCustomerId":{"FNUMBER":""},"FOrderCustMasterId":0,"FIsGroupRebate":"false"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("RPM_AccountBalance","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("RPM_AccountBalance","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("RPM_AccountBalance","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("RPM_AccountBalance","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("RPM_AccountBalance","ReInitAccountBalance","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FOrgId":{"FNumber":""},"FCustomerID":{"FNUMBER":""},"FAccountID":{"FNUMBER":""},"FBalanceAmount":0,"FCurrencyID":{"FNUMBER":""},"FUpdateTime":"1900-01-01","FCustMasterID":0,"FBillNo":"","FOrderCustomerId":{"FNUMBER":""},"FOrderCustMasterId":0,"FIsGroupRebate":"false"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("RPM_AccountBalance","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RPM_AccountBalance"}");

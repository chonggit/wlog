# 返利依据来源单据 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 返利管理 > 返利依据来源单据
...
client.Delete("RPM_RpBasiseBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("RPM_RpBasiseBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("RPM_RpBasiseBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FBillFormId":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FApproverID":{"FUserID":""},"FApproveDate":"1900-01-01","FBillTableName":"","FBillTableIdColumn":"","FBillTableAlias":"","FSelectFields":"","FLinkTable":"","FCalcType":"","FGroupNum":0,"FCondition":"","FConditionSql":"","FInnerTable":"","FSelectEntities":"","FEntity":[{"FEntryID":0,"FColumnKey":"","FBillColumnType":"","FBillColumnKey":"","FBillColumnName":"","FBillColumnOrmKey":"","FBillEntityKey":"","FBillColumnEntityKey":"","FBillColumnTable":"","FBillColTableAlias":"","FBillColumnTableSuffix":"","FBillColumnTableFid":""}]}}");
        ...
        "FEntity": [
            {
                ...
                "FBillColumnOrmKey": "",
                "FBillEntityKey": "",
                "FBillColumnEntityKey": "",
                "FBillColumnTable": "",
                "FBillColTableAlias": "",
                "FBillColumnTableSuffix": "",
                "FBillColumnTableFid": ""
            }
        ]
    }
...
单据头：FBillHead 
	 ...
	 是否系统预置：FIsSystemSet 
	 单据主表：FBillTableName 
	 单据主键：FBillTableIdColumn 
	 主表别名：FBillTableAlias 
	 选择字段：FSelectFields 
	 关联表：FLinkTable 
	 计算方式：FCalcType  (必填项)
	 组号：FGroupNum 
	 过滤条件JSON：FCondition 
	 过滤条件SQL：FConditionSql 
	 条件关联表：FInnerTable 
	 过滤实体范围：FSelectEntities  (必填项)
单据体：FEntity 
	 实体主键：FEntryID 
	 单据字段：FBillColumnKey 
	 字段所在实体名：FBillEntityKey 
	 单据字段名：FBillColumnName 
	 字段所属表名：FBillColumnTable 
	 字段类型：FBillColumnType 
	 主键字段：FBillColumnTableFid 
	 字段名：FColumnKey  (必填项)
	 字段所属表别名：FBillColTableAlias 
	 字段实体属性名：FBillColumnOrmKey 
	 字段标识：FBillColumnEntityKey 
	 扩展表后缀名：FBillColumnTableSuffix 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("RPM_RpBasiseBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FBillFormId":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FApproverID":{"FUserID":""},"FApproveDate":"1900-01-01","FBillTableName":"","FBillTableIdColumn":"","FBillTableAlias":"","FSelectFields":"","FLinkTable":"","FCalcType":"","FGroupNum":0,"FCondition":"","FConditionSql":"","FInnerTable":"","FSelectEntities":"","FEntity":[{"FEntryID":0,"FColumnKey":"","FBillColumnType":"","FBillColumnKey":"","FBillColumnName":"","FBillColumnOrmKey":"","FBillEntityKey":"","FBillColumnEntityKey":"","FBillColumnTable":"","FBillColTableAlias":"","FBillColumnTableSuffix":"","FBillColumnTableFid":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("RPM_RpBasiseBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("RPM_RpBasiseBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("RPM_RpBasiseBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("RPM_RpBasiseBill","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("RPM_RpBasiseBill","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("RPM_RpBasiseBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RPM_RpBasiseBill"}");

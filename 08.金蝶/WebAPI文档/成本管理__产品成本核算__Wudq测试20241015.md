# Wudq测试20241015 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > Wudq测试20241015
...
client.Delete("k5a2da3f0cd954b658482cb97f02a8cd2","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("k5a2da3f0cd954b658482cb97f02a8cd2","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_PTDD__ora_CreatorId_apv_qtr":{"FUserID":""},"F_PTDD__ora_ModifyDate_uky_83g":"1900-01-01","F_XCKF_Org":{"FNumber":""},"F_ora__PTDD_UserId_qtr_apv":{"FUserID":""},"F_XCKF_Period":"1900-01-01","F_PTDD__ora_ModifierId_ca9_ca9":{"FUserID":""},"F_ora__PTDD_Date_83g_uky":"1900-01-01","F_PTDD__ora_CreateDate_tzk_dvn":"1900-01-01","F_XCKF_HeadDepartment":{"FNUMBER":""},"F_XCKF_Org142":{"FNumber":""},"FEntity":[{"FEntryID":0,"F_XCKF_ProOrderNo":"","F_XCKF_ProOrderSeq":0,"F_XCKF_SubMaterial":{"FNUMBER":""},"F_XCKF_Stock":{"FNUMBER":""},"F_XCKF_Lot":{"FNUMBER":""},"F_XCKF_BalanceQty":0,"F_XCKF_Remark":"","F_XCKF_Status":""}],"F_XCKF_InTheProductInvSum":[{"FEntryID":0,"F_XCKF_Sum_ProOrderNo":"","F_XCKF_Sum_ProOrderSeq":0,"F_XCKF_Sum_SubMaterial":{"FNUMBER":""},"F_XCKF_Sum_BalanceQty":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        "FID": 0,
        "FBillNo": "",
        "F_PTDD__ora_CreatorId_apv_qtr": {
            "FUserID": ""
        },
        "F_PTDD__ora_ModifyDate_uky_83g": "1900-01-01",
        "F_XCKF_Org": {
            "FNumber": ""
        },
        "F_ora__PTDD_UserId_qtr_apv": {
            "FUserID": ""
        },
        "F_XCKF_Period": "1900-01-01",
        "F_PTDD__ora_ModifierId_ca9_ca9": {
            "FUserID": ""
        },
        "F_ora__PTDD_Date_83g_uky": "1900-01-01",
        "F_PTDD__ora_CreateDate_tzk_dvn": "1900-01-01",
        ...
        "F_XCKF_InTheProductInvSum": [
            {
                "FEntryID": 0,
                "F_XCKF_Sum_ProOrderNo": "",
                "F_XCKF_Sum_ProOrderSeq": 0,
                "F_XCKF_Sum_SubMaterial": {
                    "FNUMBER": ""
                },
                "F_XCKF_Sum_BalanceQty": 0
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 创建人：F_PTDD__ora_CreatorId_apv_qtr 
	 修改日期：F_PTDD__ora_ModifyDate_uky_83g 
	 组织：F_XCKF_Org 
	 审核人：F_ora__PTDD_UserId_qtr_apv 
	 期间：F_XCKF_Period 
	 修改人：F_PTDD__ora_ModifierId_ca9_ca9 
	 审核日期：F_ora__PTDD_Date_83g_uky 
	 创建日期：F_PTDD__ora_CreateDate_tzk_dvn 
	 生产车间：F_XCKF_HeadDepartment 
	 WIP组织：F_XCKF_Org142 
库存账龄表数据：FEntity 
	 实体主键：FEntryID 
	 生产订单号：F_XCKF_ProOrderNo 
	 生产订单行号：F_XCKF_ProOrderSeq 
	 零件编码：F_XCKF_SubMaterial 
	 零件名称：F_PTDD_BaseProperty_tzk 
	 仓库：F_XCKF_Stock 
	 批号：F_XCKF_Lot 
	 结存数：F_XCKF_BalanceQty 
	 备注：F_XCKF_Remark 
	 异常单据：F_XCKF_Status 
正常单据汇总：F_XCKF_InTheProductInvSum 
	 实体主键：FEntryID 
	 生产订单号：F_XCKF_Sum_ProOrderNo 
	 生产订单行号：F_XCKF_Sum_ProOrderSeq 
	 零件编码：F_XCKF_Sum_SubMaterial 
	 零件名称：F_PTDD_BaseProperty_uky 
	 结存总数：F_XCKF_Sum_BalanceQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("k5a2da3f0cd954b658482cb97f02a8cd2","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_PTDD__ora_CreatorId_apv_qtr":{"FUserID":""},"F_PTDD__ora_ModifyDate_uky_83g":"1900-01-01","F_XCKF_Org":{"FNumber":""},"F_ora__PTDD_UserId_qtr_apv":{"FUserID":""},"F_XCKF_Period":"1900-01-01","F_PTDD__ora_ModifierId_ca9_ca9":{"FUserID":""},"F_ora__PTDD_Date_83g_uky":"1900-01-01","F_PTDD__ora_CreateDate_tzk_dvn":"1900-01-01","F_XCKF_HeadDepartment":{"FNUMBER":""},"F_XCKF_Org142":{"FNumber":""},"FEntity":[{"FEntryID":0,"F_XCKF_ProOrderNo":"","F_XCKF_ProOrderSeq":0,"F_XCKF_SubMaterial":{"FNUMBER":""},"F_XCKF_Stock":{"FNUMBER":""},"F_XCKF_Lot":{"FNUMBER":""},"F_XCKF_BalanceQty":0,"F_XCKF_Remark":"","F_XCKF_Status":""}],"F_XCKF_InTheProductInvSum":[{"FEntryID":0,"F_XCKF_Sum_ProOrderNo":"","F_XCKF_Sum_ProOrderSeq":0,"F_XCKF_Sum_SubMaterial":{"FNUMBER":""},"F_XCKF_Sum_BalanceQty":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("k5a2da3f0cd954b658482cb97f02a8cd2","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("k5a2da3f0cd954b658482cb97f02a8cd2","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("k5a2da3f0cd954b658482cb97f02a8cd2","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("k5a2da3f0cd954b658482cb97f02a8cd2","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("k5a2da3f0cd954b658482cb97f02a8cd2","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("k5a2da3f0cd954b658482cb97f02a8cd2","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"k5a2da3f0cd954b658482cb97f02a8cd2"}");

# 生产线日计划完工产量表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产线生产 > 生产线日计划完工产量表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2514 |
...
client.GetSysReportData("REM_PrdLineSCPRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgId":{"FNumber":""},"FRadioBeforeWeek":"","FRadioCurrWork":"","FBeginCountDate":"1900-01-01","FEndCountDate":"1900-01-01","FWorkShopIDS":"","FProductLine":[{"FNumber":""}],"FCountDateGroup":"","FShiftSliceId":{"FNUMBER":""}}}");
...
五、字段说明：
	 ...
	 本周：FRadioCurrWork 
	 生产组织：FPrdOrgId  (必填项)
	 生产部门：FWorkShopIDS  (必填项)
	 生产线：FProductLine 
	 FSHIFTSLICEID：FShiftSliceId 

# CRM数据授权 Web API 操作原始内容

> 来源页面：全部 > 客户关系管理 > 客户管理 > CRM数据授权
...
client.Delete("CRM_DataRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRM_DataRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDataRuleType":"","FRoleId":{"FNUMBER":""},"FUserID":{"FName":""},"FEntity":[{"FEntryID":0,"FAllObjectID":{"FID":""},"FUnderEmp":"false","FAllUnderEmp":"false","FMyDept":"false","FUnderDept":"false","FAllUnderDept":"false"}]}}");
...
单据体：FEntity 
	 实体主键：FEntryID 
	 业务对象：FAllObjectID  (必填项)
	 子系统：FAllSubSystemID 
	 直接下属：FUnderEmp 
	 所有下属：FAllUnderEmp 
	 直属部门：FUnderDept 
	 所有下级部门：FAllUnderDept 
	 其它员工：FOtherEmp 
	 其它部门：FOtherDept 
	 本部门：FMyDept 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRM_DataRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDataRuleType":"","FRoleId":{"FNUMBER":""},"FUserID":{"FName":""},"FEntity":[{"FEntryID":0,"FAllObjectID":{"FID":""},"FUnderEmp":"false","FAllUnderEmp":"false","FMyDept":"false","FUnderDept":"false","FAllUnderDept":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRM_DataRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRM_DataRule"}");

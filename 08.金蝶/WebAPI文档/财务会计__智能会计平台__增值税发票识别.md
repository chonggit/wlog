# 增值税发票识别 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 智能会计平台 > 增值税发票识别
...
client.Delete("GL_AddedTaxOcrResult","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("GL_AddedTaxOcrResult","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FBuyerAddressTel":"","FSalesAddressTel":"","FSalesBankAndCode":"","FBuyerBankAndCode":"","FBillCode":"","FBillNumber":"","FBillDate":"","FPageNumber":"","FReviewer":"","FDrawer":"","FPayee":"","FBillType":"","FTemplateId":{"FNUMBER":""},"FIsCreatedBill":"false","FRemark":"","FOcrResult":"","FBuyerName":"","FSalesName":"","FBuyerTaxRegisterCode":"","FSalesTaxRegisterCode":"","FOcrBillId":0,"FEntity":[{"FEntryID":0,"FTaxItem":"","FModels":"","FUnit":"","FQuantity":"","FPrice":"","FAmount":"","FTaxRate":"","FTaxAmount":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIsCreatedBill": "false",
        "FRemark": "",
        "FOcrResult": "",
        "FBuyerName": "",
        "FSalesName": "",
        "FBuyerTaxRegisterCode": "",
        "FSalesTaxRegisterCode": "",
        "FOcrBillId": 0,
        "FEntity": [
            {
                "FEntryID": 0,
...
单据头：FBillHead 
	 ...
	 开票日期：FBillDate  (必填项)
	 销售方开户行及账号：FSalesBankAndCode 
	 收款人：FPayee 
	 复核：FReviewer 
	 发票代码：FBillCode 
	 开票人：FDrawer 
	 购买方开户行及账号：FBuyerBankAndCode 
	 发票号码：FBillNumber 
	 购买方地址及电话：FBuyerAddressTel 
	 销售方地址及电话：FSalesAddressTel 
	 联数：FPageNumber 
	 创建日期：FCreateDate 
	 扫描图片：FBillImage 
	 修改日期：FModifyDate 
	 ...
	 票据类型：FBillType  (必填项)
	 识别模板：FTemplateId 
	 已生成单据：FIsCreatedBill 
	 备注：FRemark 
	 识别结果：FOcrResult 
	 购方企业名称：FBuyerName 
	 销方企业名称：FSalesName 
	 购方纳税号：FBuyerTaxRegisterCode 
	 销方纳税号：FSalesTaxRegisterCode 
	 生成的单据ID(用于联查)：FOcrBillId 
项目明细：FEntity 
	 实体主键：FEntryID 
	 货物或应税劳务、服务名称：FTaxItem  (必填项)
	 规格型号：FModels 
	 单位：FUnit 
	 数量：FQuantity 
	 单价：FPrice 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("GL_AddedTaxOcrResult","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FBuyerAddressTel":"","FSalesAddressTel":"","FSalesBankAndCode":"","FBuyerBankAndCode":"","FBillCode":"","FBillNumber":"","FBillDate":"","FPageNumber":"","FReviewer":"","FDrawer":"","FPayee":"","FBillType":"","FTemplateId":{"FNUMBER":""},"FIsCreatedBill":"false","FRemark":"","FOcrResult":"","FBuyerName":"","FSalesName":"","FBuyerTaxRegisterCode":"","FSalesTaxRegisterCode":"","FOcrBillId":0,"FEntity":[{"FEntryID":0,"FTaxItem":"","FModels":"","FUnit":"","FQuantity":"","FPrice":"","FAmount":"","FTaxRate":"","FTaxAmount":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("GL_AddedTaxOcrResult","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("GL_AddedTaxOcrResult","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("GL_AddedTaxOcrResult","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("GL_AddedTaxOcrResult","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("GL_AddedTaxOcrResult","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("GL_AddedTaxOcrResult","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"GL_AddedTaxOcrResult"}");

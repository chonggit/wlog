# 用户权限报表 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 安全管理 > 用户权限报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2031 |
...
client.GetSysReportData("SEC_UserPermissionDataRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FUSER":{"FUSERACCOUNT":""},"FROLE":{"FNUMBER":""},"FOBJECTTYPE":{"FID":""},"FITEM":{"FNUMBER":""}}}");

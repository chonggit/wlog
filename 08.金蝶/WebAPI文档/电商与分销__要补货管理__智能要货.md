...
client.Draft("DRP_OrderCenter","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FBillNo":"","FSourceType":"","FSourceSupplierId":{"FNUMBER":""},"FChannelId":{"FNumber":""},"FSupplyOrgId":{"FNumber":""},"FReqOrgId":{"FNumber":""},"FSupplyStockOrgId":{"FNumber":""},"FReqStockOrgId":{"FNumber":""},"FUserId":{"FUserID":""},"FMaterialId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FBaseUnitID":{"FNumber":""},"FUnitID":{"FNumber":""},"FSafeQty":0,"FInTransQty":0,"FReqQty":0,"FStockQty":0,"FNetReqQty":0,"FBaseBatchQty":0,"FBatchQty":0,"FSuggestQty":0,"FBaseSafeQty":0,"FBaseMinOrderQty":0,"FMinOrderQty":0,"FBaseActualQty":0,"FActualQty":0}}");
...
单据头：FBillHead 
	 ...
	 要货组织：FReqOrgId 
	 基本计量单位：FBaseUnitID 
	 基本单位最小要货量：FBaseMinOrderQty 
	 基本单位安全库存：FBaseSafeQty 
	 基本单位要货批量：FBaseBatchQty 
	 最小订货量：FMinOrderQty 
	 辅助属性：FAuxPropId 
	 描述：FF100001
	 公差：FF100002
	 ...
	 实际要货量：FActualQty 
	 规格型号：FMaterialMode 
	 基本单位实际要货量：FBaseActualQty 
	 供货库存组织：FSupplyStockOrgId 
	 要货库存组织：FReqStockOrgId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("DRP_OrderCenter","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FBillNo":"","FSourceType":"","FSourceSupplierId":{"FNUMBER":""},"FChannelId":{"FNumber":""},"FSupplyOrgId":{"FNumber":""},"FReqOrgId":{"FNumber":""},"FSupplyStockOrgId":{"FNumber":""},"FReqStockOrgId":{"FNumber":""},"FUserId":{"FUserID":""},"FMaterialId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FBaseUnitID":{"FNumber":""},"FUnitID":{"FNumber":""},"FSafeQty":0,"FInTransQty":0,"FReqQty":0,"FStockQty":0,"FNetReqQty":0,"FBaseBatchQty":0,"FBatchQty":0,"FSuggestQty":0,"FBaseSafeQty":0,"FBaseMinOrderQty":0,"FMinOrderQty":0,"FBaseActualQty":0,"FActualQty":0}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("DRP_OrderCenter","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("DRP_OrderCenter","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("DRP_OrderCenter","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"DRP_OrderCenter"}");

# 内部账户调整单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 内部账户调整单
...
| 下推 | Push | 2330 |
| 同步银行状态 | Synchronism | 4996 |
| 作废 | StatusConvert | 1702 |
| 批量保存 | BatchSave | 3060 |
...
client.Delete("CN_InnerAccountAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_InnerAccountAdjust","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FINNERACCOUNTID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FEXCHANGERATE":0,"FDescription":"","FCreateOrgId":{"FNumber":""},"FMappingOrgId":{"FNumber":""},"FBillTypeID":{"FNUMBER":""},"FAdjustAmount":0,"FAdjustAmountLoc":0,"FINNERACCTADJUSTENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FBANKACCTID":{"FNUMBER":""},"FCASHACCTID":{"FNUMBER":""},"FAmount":0,"FAMOUNTLOC":0,"FFEE":0,"FFEELOC":0,"FSETTLENUMBER":"","FCOMMENT":"","FOPPBANKACCTID":{"FNUMBER":""},"FOPPCASHACCTID":{"FNUMBER":""},"FCREATEPOSTDATE":"1900-01-01","FMAPPINGPOSTDATE":"1900-01-01","FOppBankID":{"FNUMBER":""},"FBankID":{"FNumber":""},"FSignature":""}]}}");
        ...
        "FINNERACCTADJUSTENTRY": [
            {
                ...
                "FCREATEPOSTDATE": "1900-01-01",
                "FMAPPINGPOSTDATE": "1900-01-01",
                "FOppBankID": {
                    "FNUMBER": ""
                },
                "FBankID": {
...
单据头：FBillHead 
	 ...
	 作废状态：FCancelStatus 
	 业务日期：FDate  (必填项)
	 开设组织：FCreateOrgId  (必填项)
	 内部账户：FINNERACCOUNTID  (必填项)
	 对应组织：FMappingOrgId  (必填项)
	 币别：FCURRENCYID  (必填项)
	 汇率：FEXCHANGERATE 
	 ...
	 调整金额：FAdjustAmount 
	 调整金额本位币：FAdjustAmountLoc 
	 业务类型：FBUSINESSTYPE 
单据体：FINNERACCTADJUSTENTRY 
	 实体主键：FEntryID 
	 ...
	 结算号：FSETTLENUMBER 
	 摘要：FCOMMENT 
	 对方银行账号：FOPPBANKACCTID 
	 对方现金账号：FOPPCASHACCTID 
	 开设组织是否登账：FISCREATEPOST 
	 开设组织登账日期：FCREATEPOSTDATE  (必填项)
	 对应组织是否登账：FISMAPPINGPOST 
	 对应组织登账日期：FMAPPINGPOSTDATE  (必填项)
	 银行提交状态：FSubmitStatus 
	 银行处理状态：FBankStatus 
	 对方开户行：FOppBankID 
	 勾对开设组织：FBLENDCREATEORG 
	 我方开户行：FBankID 
	 勾对对应组织：FBLENDMAPPINGORG 
	 银行状态码：FBankCode 
	 流水号/对账码：FCHECKCODE 
	 签名：FSignature 
	 手续费本位币：FFEELOC 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_InnerAccountAdjust","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FINNERACCOUNTID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FEXCHANGERATE":0,"FDescription":"","FCreateOrgId":{"FNumber":""},"FMappingOrgId":{"FNumber":""},"FBillTypeID":{"FNUMBER":""},"FAdjustAmount":0,"FAdjustAmountLoc":0,"FINNERACCTADJUSTENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FBANKACCTID":{"FNUMBER":""},"FCASHACCTID":{"FNUMBER":""},"FAmount":0,"FAMOUNTLOC":0,"FFEE":0,"FFEELOC":0,"FSETTLENUMBER":"","FCOMMENT":"","FOPPBANKACCTID":{"FNUMBER":""},"FOPPCASHACCTID":{"FNUMBER":""},"FCREATEPOSTDATE":"1900-01-01","FMAPPINGPOSTDATE":"1900-01-01","FOppBankID":{"FNUMBER":""},"FBankID":{"FNumber":""},"FSignature":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_InnerAccountAdjust","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_InnerAccountAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_InnerAccountAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_InnerAccountAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_InnerAccountAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CN_InnerAccountAdjust","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_InnerAccountAdjust","Synchronism","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FINNERACCOUNTID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FEXCHANGERATE":0,"FDescription":"","FCreateOrgId":{"FNumber":""},"FMappingOrgId":{"FNumber":""},"FBillTypeID":{"FNUMBER":""},"FAdjustAmount":0,"FAdjustAmountLoc":0,"FINNERACCTADJUSTENTRY":[{"FEntryID":0,"FSETTLETYPEID":{"FNUMBER":""},"FBANKACCTID":{"FNUMBER":""},"FCASHACCTID":{"FNUMBER":""},"FAmount":0,"FAMOUNTLOC":0,"FFEE":0,"FFEELOC":0,"FSETTLENUMBER":"","FCOMMENT":"","FOPPBANKACCTID":{"FNUMBER":""},"FOPPCASHACCTID":{"FNUMBER":""},"FCREATEPOSTDATE":"1900-01-01","FMAPPINGPOSTDATE":"1900-01-01","FOppBankID":{"FNUMBER":""},"FBankID":{"FNumber":""},"FSignature":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.StatusConvert("CN_InnerAccountAdjust","StatusConvert","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_InnerAccountAdjust"}");

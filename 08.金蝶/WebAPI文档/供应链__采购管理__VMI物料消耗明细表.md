# VMI物料消耗明细表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > VMI物料消耗明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3037 |
...
client.GetSysReportData("PUR_VMIConsumeDetail","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FConsumeOrgIdList":"","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FStartSupplierNumber":"","FEndSupplierNumber":"","FStartMaterialNumber":"","FEndMaterialNumber":"","FStartStockNumber":"","FEndStockNumber":"","FStartLot":"","FEndLot":"","FDocumentStatus":"","FPurchaseOrgIdList":"","FConsumeBillTypeId":""}}");
...
五、字段说明：
	 ...
	 供应商至：FEndSupplierNumber 
	 物料：FStartMaterialNumber 
	 物料至：FEndMaterialNumber 
	 ...
	 消耗单据类型：FConsumeBillTypeId 

参数FieldKeys显示列：
	 消耗单据类型：FComsumeBillTypeId 
	 消耗单据编码：FConsumeBillNo 
	 行号：FSeq 
	 消耗组织：FConsumeOrgId 
	 日期：FDate 
	 供应商：FSupplierId 

# 预算组织架构 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 预算组织架构
...
client.Delete("BM_BudgetOrg","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_BudgetOrg","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_BudgetOrg","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FRootOrgID":{"FNumber":""},"FDescription":"","FIsDefault":"false","FIsDefaultVersion":"false","FAutoSetDeptType":"","FVERSION":"","FEffectDate":"1900-01-01","FVersionRemark":"","FConfirmMessage":"","FSearchNodeText":"","FBudgetOrgEntry":[{"FEntryID":0,"FORGNumber":"","FParentOrgId":0,"FOrgId":0,"FOrgName":"","FOrgType":"","FOWNERORGID":0,"FBUDGETNUMBER":"","FBudgetOrgUnitId":{"FNUMBER":""},"FPARENTENTRYID":0}],"FBackupOrgEntity":[{"FBackUpOrgId":{"FNUMBER":""},"FBackupOrg":""}]}}");
...
预算组织架构：FBillHead 
	 ...
	 审核人：FAUDITORID 
	 名称：FName  (必填项)
	 部门范围：FAutoSetDeptType  (必填项)
	 版本组：FVersionGroupID 
	 是否默认版本：FIsDefaultVersion 
	 版本：FVERSION 
	 生效日期：FEffectDate 
	 版本备注：FVersionRemark 
	 要删除的部门：FConfirmMessage 
	 查找名称：FSearchNodeText 
预算组织实体：FBudgetOrgEntry 
	 实体主键：FEntryID 
	 上级组织ID：FParentOrgId 
	 组织ID：FOrgId 
	 组织名称：FOrgName 
	 ...
	 编码：FORGNumber 
	 所属组织：FOWNERORGID 
	 预算组织编码：FBUDGETNUMBER 
	 预算组织：FBudgetOrgUnitId 
	 上级分录id：FPARENTENTRYID 
可选组织：FBackupOrgEntity 
	 实体主键： 
	 可选组织：FBackupOrg 
	 可选组织：FBackUpOrgId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_BudgetOrg","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FRootOrgID":{"FNumber":""},"FDescription":"","FIsDefault":"false","FIsDefaultVersion":"false","FAutoSetDeptType":"","FVERSION":"","FEffectDate":"1900-01-01","FVersionRemark":"","FConfirmMessage":"","FSearchNodeText":"","FBudgetOrgEntry":[{"FEntryID":0,"FORGNumber":"","FParentOrgId":0,"FOrgId":0,"FOrgName":"","FOrgType":"","FOWNERORGID":0,"FBUDGETNUMBER":"","FBudgetOrgUnitId":{"FNUMBER":""},"FPARENTENTRYID":0}],"FBackupOrgEntity":[{"FBackUpOrgId":{"FNUMBER":""},"FBackupOrg":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BM_BudgetOrg","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_BudgetOrg","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_BudgetOrg","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BudgetOrg","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BudgetOrg","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BM_BudgetOrg","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_BudgetOrg","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_BudgetOrg"}");

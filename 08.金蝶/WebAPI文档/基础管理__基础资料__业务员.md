...
client.Delete("BD_OPERATOR","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_OPERATOR","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FOperatorId":0,"FOperatorType":"","FEntity":[{"FEntryId":0,"FOperatorType_ETY":"","FBizOrgId":{"FNumber":""},"FStaffId":{"FStaffNumber":""},"FNumber":"","FName":"","FForbiddenStatus":"","FBD_OPERATORDETAILS":[{"FSubEntryId":0,"FOperatorGroupId":{"FNumber":""}}]}]}}");
...
业务员分录：FEntity 
	 ...
	 员工编码：FEmpNumber 
业务员子表：FBD_OPERATORDETAILS 
	 实体主键：FSubEntryId 
	 业务组编码：FOperatorGroupId 
	 业务组名称：FOperatorGroupName 
	 描述：Fdescription_SETY 
	 默认：FIsDefault 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_OPERATOR","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_OPERATOR","Delete(DoNothing)","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FOperatorId":0,"FOperatorType":"","FEntity":[{"FEntryId":0,"FOperatorType_ETY":"","FBizOrgId":{"FNumber":""},"FStaffId":{"FStaffNumber":""},"FNumber":"","FName":"","FForbiddenStatus":"","FBD_OPERATORDETAILS":[{"FSubEntryId":0,"FOperatorGroupId":{"FNumber":""}}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_OPERATOR","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_OPERATOR"}");

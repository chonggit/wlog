# 销售出库退货自动冲销方案 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 销售出库退货自动冲销方案
...
client.Delete("SAL_OutRetAutoWriteOffProj","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SAL_OutRetAutoWriteOffProj","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SAL_OutRetAutoWriteOffProj","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FExecuteDay":0,"FExecuteIntervalUnit":"","FExecuteNextTime":"1900-01-01","FExecutorId":{"FUSERACCOUNT":""},"FExecuteTime":"1900-01-01","FNumber":"","FName":"","FDescription":"","FNoWriteOffWhenPriceDiff":"false","FEntity":[{"FENTRYID":0,"FSaleOrgList":"","FOutStockRange":{"FSchemeName":""},"FOutBillTypeList":"","FWriteOffProject":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FName": "",
        "FDescription": "",
        "FNoWriteOffWhenPriceDiff": "false",
        "FEntity": [
            {
                "FENTRYID": 0,
                "FSaleOrgList": "",
...
单据头：FBillHead 
	 实体主键：FID 
	 执行间隔：FExecuteDay 
	 执行周期：FExecuteIntervalUnit  (必填项)
	 下次执行时间：FExecuteNextTime  (必填项)
	 定时执行人：FExecutorId 
	 执行时间：FExecuteTime 
	 方案编码：FNumber 
	 方案名称：FName  (必填项)
	 ...
	 创建人：FCreatorId 
	 修改人：FModifierId 
	 出库退货单价不一致时不自动冲销：FNoWriteOffWhenPriceDiff 
单据体：FEntity 
	 实体主键：FENTRYID 
	 销售组织：FSaleOrgList  (必填项)
	 出库单范围：FOutStockRange  (必填项)
	 出库单单据类型：FOutBillTypeList  (必填项)
	 冲销匹配方案：FWriteOffProject  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SAL_OutRetAutoWriteOffProj","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FExecuteDay":0,"FExecuteIntervalUnit":"","FExecuteNextTime":"1900-01-01","FExecutorId":{"FUSERACCOUNT":""},"FExecuteTime":"1900-01-01","FNumber":"","FName":"","FDescription":"","FNoWriteOffWhenPriceDiff":"false","FEntity":[{"FENTRYID":0,"FSaleOrgList":"","FOutStockRange":{"FSchemeName":""},"FOutBillTypeList":"","FWriteOffProject":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SAL_OutRetAutoWriteOffProj","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SAL_OutRetAutoWriteOffProj","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SAL_OutRetAutoWriteOffProj","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SAL_OutRetAutoWriteOffProj","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SAL_OutRetAutoWriteOffProj","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SAL_OutRetAutoWriteOffProj","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SAL_OutRetAutoWriteOffProj","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SAL_OutRetAutoWriteOffProj"}");

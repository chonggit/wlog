# 基础资料控制策略 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 组织管理 > 基础资料控制策略
...
client.Draft("ORG_BaseDataControlPolicy","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FPolicyID":"","FBaseDataTypeId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FCheckFields":"","FTargetOrgEntrys":[{"FTargetOrgEntryID":"","FTargetOrgId":{"FNumber":""},"FPropertyLoaded":"false","FIsForbidden":"false","FDontSyncAllocate":"false","FPropertyEntry":[{"FPropEntryId":"","FKey":"","FPropertyGroup":"","FPropertyName":"","FControlTypeId":"","FLocked":"false","FDefaultValue":""}]}]}}");
...
单据头：FBillHead 
	 ...
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 基础资料：FBaseDataTypeId  (必填项)
	 创建组织：FCreateOrgId  (必填项)
	 分配关联检查：FCheckFields 
目的组织：FTargetOrgEntrys 
	 实体主键：FTargetOrgEntryID 
	 分配目标组织：FTargetOrgId 
	 属性加载标志：FPropertyLoaded 
	 同步禁用：FIsForbidden 
	 不做同步：FDontSyncAllocate 
控制属性：FPropertyEntry 
	 实体主键：FPropEntryId 
	 属性对应Key：FKey 
	 属性名称：FPropertyName 
	 属性分组：FPropertyGroup 
	 控制方式：FControlTypeId  (必填项)
	 默认值：FDefaultValue 
	 不可修改：FLocked 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ORG_BaseDataControlPolicy","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FPolicyID":"","FBaseDataTypeId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FCheckFields":"","FTargetOrgEntrys":[{"FTargetOrgEntryID":"","FTargetOrgId":{"FNumber":""},"FPropertyLoaded":"false","FIsForbidden":"false","FDontSyncAllocate":"false","FPropertyEntry":[{"FPropEntryId":"","FKey":"","FPropertyGroup":"","FPropertyName":"","FControlTypeId":"","FLocked":"false","FDefaultValue":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ORG_BaseDataControlPolicy","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("ORG_BaseDataControlPolicy","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ORG_BaseDataControlPolicy"}");

...
client.Delete("SC_Credit","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SC_Credit","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FBankID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FLoanAmount":0,"FStartDate":"1900-01-01","FDueDate":"1900-01-01","FAssureType":"","FAssureOrgId":"","FFundsOrgID":{"FNumber":""},"FScanPoint":{"FNUMBER":""},"FComment":"","FRATETYPE":"","FCONVERTDAY":0,"FRATEFORTYPE":"","FRateShow":"","FRateTable":{"FNUMBER":""},"FINTERESTSTANDARD":"","FTICKPOINT":0,"FFreeAmout":0,"FLastEndDate":"1900-01-01","FRate":0,"FCreditGrantEntry":[{"FEntryID":0,"FPlanGrantDate":"1900-01-01","FPlanGrantAmount":0,"FRealGrantAmount":0}],"FCreditRepayEntry":[{"FEntryID":0,"FPlanRepayDate":"1900-01-01","FPlanPclAmount":0,"FRealPclAmount":0,"FRealInstAmount":0,"FRelateAmount":0}],"FCreditInterestEntry":[{"FEntryID":0,"FINTERESTNO":""}]}}");
...
单据头：FBillHead 
	 ...
	 利率表示：FRateShow  (必填项)
	 利率表：FRateTable 
	 计息标准：FINTERESTSTANDARD  (必填项)
	 浮动点：FTICKPOINT 
	 免息额：FFreeAmout 
	 上次结息日：FLastEndDate  (必填项)
	 利率（%）：FRate 
	 扫描点：FScanPoint 
发放信息：FCreditGrantEntry 
	 实体主键：FEntryID 
	 计划发放日期：FPlanGrantDate  (必填项)
	 计划发放金额：FPlanGrantAmount 
	 实际发放金额：FRealGrantAmount 
	 发放状态：FEntryGrantStatus 
还款信息：FCreditRepayEntry 
	 实体主键：FEntryID 
	 计划还款日期：FPlanRepayDate  (必填项)
	 计划还本金额：FPlanPclAmount 
	 实际还本金额：FRealPclAmount 
	 实际还利息金额：FRealInstAmount 
	 付款申请关联金额：FRelateAmount 
	 还款状态：FEntryRepayStatus 
预提利息信息：FCreditInterestEntry 
	 实体主键：FEntryID 
	 利息单编号：FINTERESTNO  (必填项)
	 开始时间：FBEGINDATE 
	 结束时间：FENDDATE 
	 应付利息：FPAYAMOUNT 
	 实付利息：FREALPAYAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SC_Credit","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FBankID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FLoanAmount":0,"FStartDate":"1900-01-01","FDueDate":"1900-01-01","FAssureType":"","FAssureOrgId":"","FFundsOrgID":{"FNumber":""},"FScanPoint":{"FNUMBER":""},"FComment":"","FRATETYPE":"","FCONVERTDAY":0,"FRATEFORTYPE":"","FRateShow":"","FRateTable":{"FNUMBER":""},"FINTERESTSTANDARD":"","FTICKPOINT":0,"FFreeAmout":0,"FLastEndDate":"1900-01-01","FRate":0,"FCreditGrantEntry":[{"FEntryID":0,"FPlanGrantDate":"1900-01-01","FPlanGrantAmount":0,"FRealGrantAmount":0}],"FCreditRepayEntry":[{"FEntryID":0,"FPlanRepayDate":"1900-01-01","FPlanPclAmount":0,"FRealPclAmount":0,"FRealInstAmount":0,"FRelateAmount":0}],"FCreditInterestEntry":[{"FEntryID":0,"FINTERESTNO":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SC_Credit","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SC_Credit","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SC_Credit","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SC_Credit","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SC_Credit","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("SC_Credit","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SC_Credit","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SC_Credit","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SC_Credit"}");

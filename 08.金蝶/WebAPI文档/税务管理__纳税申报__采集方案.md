...
client.Delete("IV_TAXITGSOLUTION","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IV_TAXITGSOLUTION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FTargetFormId":"","FSourceFormId":"","FSolutionType":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FStatus":"false","FIsBatchPush":"false","FParallelism":0,"FByTaxData":"","FRptTemplateNo":"","FRPTUSAGE":"","FZCCJLX":"","FFieldMapEntity":[{"FEntryID":0,"FElementName":"","FTargetFieldKey":"","FTargetFieldType":"","FSourceFieldKey":"","FSourceFieldKeyAs":"","FSourceTableName":"","FSourceConvertRule":"","FFieldAggregation":"","FSourceFieldIsSum":"false","FIsRelationKey":"false","FRelationHeaderKey":"","FDescription":""}],"FFilterMapEntity":[{"FEntryID":0,"FLeftBracket":"","FFilterField":"","FFilterFieldDesc":"","FFieldType":"","FComparisonMode":"","FComparisonValue":"","FRightBracket":"","FJointMark":""}],"FSortMapEntity":[{"FEntryID":0,"FSortField":"","FSortFieldDesc":"","FSortMode":""}],"FTableMapEntity":[{"FEntryID":0,"FTableName":"","FTableNameAs":"","FIsMainTable":"false","FJoinType":"","FJoinFilter":""}],"FItemMapEntity":[{"FEntryID":0,"FItemSeq":0,"FSWYNumber":"","FSWYNAME":"","FXKNUMBER":"","FXKITEMNAME":""}]}}");
        ...
        "FFieldMapEntity": [
            {
                ...
                "FSourceConvertRule": "",
                "FFieldAggregation": "",
                "FSourceFieldIsSum": "false",
                "FIsRelationKey": "false",
                "FRelationHeaderKey": "",
                "FDescription": ""
            }
        ],
...
方案信息：FBillHead 
	 实体主键：FID 
	 方案编号：FBillNo 
	 目标单据标识：FTargetFormId  (必填项)
	 源单据标识：FSourceFormId  (必填项)
	 方案类型：FSolutionType  (必填项)
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 ...
	 每批次大小：FParallelism 
	 涉税数据：FByTaxData 
	 税务云报表模板编码：FRptTemplateNo 
	 涉税报表用途：FRPTUSAGE 
	 资产采集类型：FZCCJLX 
字段映射：FFieldMapEntity 
	 实体主键：FEntryID 
	 元素名称：FElementName 
	 目标字段标识：FTargetFieldKey 
	 源字段名称：FSourceFieldKey 
	 源字段别名：FSourceFieldKeyAs 
	 源字段聚合运算：FFieldAggregation 
	 来源表名称：FSourceTableName 
	 值转换规则：FSourceConvertRule 
	 描述信息：FDescription 
	 源字段是否汇总：FSourceFieldIsSum 
	 是否关联表头字段：FIsRelationKey 
	 关联的表头字段名：FRelationHeaderKey 
	 目标字段类型：FTargetFieldType 
过滤条件：FFilterMapEntity 
	 实体主键：FEntryID 
	 左括号：FLeftBracket 
	 条件字段：FFilterField  (必填项)
	 比较方式：FComparisonMode  (必填项)
	 比较值：FComparisonValue  (必填项)
	 右括号：FRightBracket 
	 逻辑连接符：FJointMark 
	 字段描述：FFilterFieldDesc 
	 字段类型：FFieldType 
排序设置：FSortMapEntity 
	 实体主键：FEntryID 
	 源表排序字段：FSortField 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IV_TAXITGSOLUTION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FTargetFormId":"","FSourceFormId":"","FSolutionType":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FStatus":"false","FIsBatchPush":"false","FParallelism":0,"FByTaxData":"","FRptTemplateNo":"","FRPTUSAGE":"","FZCCJLX":"","FFieldMapEntity":[{"FEntryID":0,"FElementName":"","FTargetFieldKey":"","FTargetFieldType":"","FSourceFieldKey":"","FSourceFieldKeyAs":"","FSourceTableName":"","FSourceConvertRule":"","FFieldAggregation":"","FSourceFieldIsSum":"false","FIsRelationKey":"false","FRelationHeaderKey":"","FDescription":""}],"FFilterMapEntity":[{"FEntryID":0,"FLeftBracket":"","FFilterField":"","FFilterFieldDesc":"","FFieldType":"","FComparisonMode":"","FComparisonValue":"","FRightBracket":"","FJointMark":""}],"FSortMapEntity":[{"FEntryID":0,"FSortField":"","FSortFieldDesc":"","FSortMode":""}],"FTableMapEntity":[{"FEntryID":0,"FTableName":"","FTableNameAs":"","FIsMainTable":"false","FJoinType":"","FJoinFilter":""}],"FItemMapEntity":[{"FEntryID":0,"FItemSeq":0,"FSWYNumber":"","FSWYNAME":"","FXKNUMBER":"","FXKITEMNAME":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IV_TAXITGSOLUTION","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("IV_TAXITGSOLUTION","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IV_TAXITGSOLUTION"}");

# 全面数字化的电子专用发票 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 电子凭证池 > 全面数字化的电子专用发票
...
client.Delete("EVCH_EINV_SPCL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("EVCH_EINV_SPCL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FInvoiceID":"","FBillNo":"","FeVchType":"","FAccountBook":{"FNUMBER":""},"FYear":0,"FPeriod":0,"FCollectionDate":"1900-01-01","FSourceBill":{"FNUMBER":""},"FSourceBillNo":"","FXbrlFileName":"","FXbrlUrl":"","FSallerName":"","FSallerTaxID":"","FNoTaxAmount":0,"FTaxAmount":0,"FPriceTaxAmount":0,"FInvoiceDate":"1900-01-01","FContractNo":"","FStatus":"","FDepreciationMethods":"","FIsSecuritization":"false","FIsRed":"false","FIsCheckReal":"false","FIsRecord":"false","FIsConfirmedUse":"false","FConfirmedUse":"","FConfirmedUsePeriod":"","FIsPay":"false","FBankBillNo":"","FIsVATOut":"false","FVATOutAmount":0,"FCreditCode":"","FAccountName":"","FBeginPeriod":"","FIsPreTaxDeduction":"false","FEndPeriod":"","FTaxBeginYear":0,"FTaxEndYear":0,"FAcctOrgId":{"FNumber":""},"FLocalCurrency":{"FNUMBER":""},"FSourceBillID":"","FEntity":[{"FEntryID":0,"FVoucherID":0,"FVoucherNo":"","FDate":"1900-01-01","FYearPeriod":"","FExplanation":"","FSubEntity":[{"FDetailID":0,"FDC":"","FGLAccount":"","FDetailAccount":"","FAmount":0}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FContractNo": "",
        "FStatus": "",
        "FDepreciationMethods": "",
        "FIsSecuritization": "false",
        "FIsRed": "false",
        "FIsCheckReal": "false",
        "FIsRecord": "false",
        "FIsConfirmedUse": "false",
        "FConfirmedUse": "",
        "FConfirmedUsePeriod": "",
        "FIsPay": "false",
        "FBankBillNo": "",
...
单据头：FBillHead 
	 ...
	 创建人：FCreatorId 
	 修改人：FModifierId 
	 电子凭证类型：FeVchType  (必填项)
	 会计年度：FYear 
	 会计期间：FPeriod 
	 账簿名称：FAccountBook 
	 账簿编码：FBookNumber 
	 采集日期：FCollectionDate 
	 来源单据：FSourceBill 
	 来源单据号：FSourceBillNo  (必填项)
	 电子凭证XBRL文件名称：FXbrlFileName  (必填项)
	 电子凭证XBRL文件地址：FXbrlUrl  (必填项)
	 发票唯一标识：FInvoiceID  (必填项)
	 销售方名称：FSallerName  (必填项)
	 销售方纳税人识别号：FSallerTaxID  (必填项)
	 合计(不含税金额)：FNoTaxAmount 
	 合计(税额)：FTaxAmount 
	 价税合计(小写)：FPriceTaxAmount 
	 开票日期：FInvoiceDate  (必填项)
	 合同编号：FContractNo 
	 业务单据与电子发票的匹配状态：FStatus 
	 固定资产、无形资产折旧摊销方法：FDepreciationMethods 
	 是否已做保理、出售或资产证券化：FIsSecuritization 
	 是否红字发票：FIsRed 
	 是否已验真：FIsCheckReal 
	 是否已入账：FIsRecord 
	 是否已用途确认：FIsConfirmedUse 
	 确认用途：FConfirmedUse  (必填项)
	 确认用途所属期：FConfirmedUsePeriod  (必填项)
	 是否已付款：FIsPay 
	 银行回单编号：FBankBillNo 
	 是否进项税额转出：FIsVATOut 
	 进项税额转出金额：FVATOutAmount 
	 统一社会信用代码：FCreditCode  (必填项)
	 会计主体名称：FAccountName  (必填项)
	 权责发生制下支出所属期起：FBeginPeriod 
	 是否已所得税税前扣除：FIsPreTaxDeduction 
	 权责发生制下支出所属期止：FEndPeriod 
	 所得税税前扣除年度起：FTaxBeginYear 
	 所得税税前扣除年度止：FTaxEndYear 
	 核算组织：FAcctOrgId  (必填项)
	 本位币：FLocalCurrency 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("EVCH_EINV_SPCL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FInvoiceID":"","FBillNo":"","FeVchType":"","FAccountBook":{"FNUMBER":""},"FYear":0,"FPeriod":0,"FCollectionDate":"1900-01-01","FSourceBill":{"FNUMBER":""},"FSourceBillNo":"","FXbrlFileName":"","FXbrlUrl":"","FSallerName":"","FSallerTaxID":"","FNoTaxAmount":0,"FTaxAmount":0,"FPriceTaxAmount":0,"FInvoiceDate":"1900-01-01","FContractNo":"","FStatus":"","FDepreciationMethods":"","FIsSecuritization":"false","FIsRed":"false","FIsCheckReal":"false","FIsRecord":"false","FIsConfirmedUse":"false","FConfirmedUse":"","FConfirmedUsePeriod":"","FIsPay":"false","FBankBillNo":"","FIsVATOut":"false","FVATOutAmount":0,"FCreditCode":"","FAccountName":"","FBeginPeriod":"","FIsPreTaxDeduction":"false","FEndPeriod":"","FTaxBeginYear":0,"FTaxEndYear":0,"FAcctOrgId":{"FNumber":""},"FLocalCurrency":{"FNUMBER":""},"FSourceBillID":"","FEntity":[{"FEntryID":0,"FVoucherID":0,"FVoucherNo":"","FDate":"1900-01-01","FYearPeriod":"","FExplanation":"","FSubEntity":[{"FDetailID":0,"FDC":"","FGLAccount":"","FDetailAccount":"","FAmount":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("EVCH_EINV_SPCL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("EVCH_EINV_SPCL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("EVCH_EINV_SPCL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("EVCH_EINV_SPCL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("EVCH_EINV_SPCL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("EVCH_EINV_SPCL","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"EVCH_EINV_SPCL"}");

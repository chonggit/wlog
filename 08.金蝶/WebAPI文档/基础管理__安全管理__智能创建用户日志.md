# 智能创建用户日志 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 安全管理 > 智能创建用户日志
...
client.Delete("BAS_POSTROLEPLOG","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BAS_POSTROLEPLOG"}");

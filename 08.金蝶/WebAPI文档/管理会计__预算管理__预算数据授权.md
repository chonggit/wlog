# 预算数据授权 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 预算数据授权
...
client.Delete("BM_DataAuthorization","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_DataAuthorization","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_DataAuthorization","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FNumber":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FIsFromCrewInfo":"false","FGroup":{"FNumber":""},"FIsIncludeChild":"false","FCurrentUserDimension":"false","FBudgetOrg":[{"FEntryID":0,"FEntryOrgId":{"FNUMBER":""}}],"FAuthorizatedUser":[{"FEntryID":0,"FUserId":{"FName":""}}],"FRole":[{"FEntryID":0,"FRoleId":{"FNumber":""}}],"FDataRuleDimLs":[{"FEntryID":0,"FDimension":{"FNumber":""},"FFilterName":"","FFilterKey":"","FFilterKeyDesc":"","FDimensionFormId":"","FDimEffectKey":"","FDimEffectName":"","FDimEffectKeyDesc":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDescription": "",
        "FIsFromCrewInfo": "false",
        "FGroup": {
            "FNumber": ""
        },
        "FIsIncludeChild": "false",
        "FCurrentUserDimension": "false",
        "FBudgetOrg": [
            {
                "FEntryID": 0,
                "FEntryOrgId": {
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 描述：FDescription 
	 用户关联员工所属部门：FIsFromCrewInfo 
	 分组：FGroup 
	 预算方案：FSchemeId 
	 预算模板：FSample 
	 默认包含所有下级：FIsIncludeChild 
	 当前登录用户创建的维度值：FCurrentUserDimension 
部门级预算组织：FBudgetOrg 
	 实体主键：FEntryID 
	 预算组织：FEntryOrgId 
	 所属组织：FOwnerORGId 
授权用户：FAuthorizatedUser 
	 实体主键：FEntryID 
	 用户名称：FUserId 
	 用户账号：FUserName 
角色：FRole 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_DataAuthorization","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FNumber":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FIsFromCrewInfo":"false","FGroup":{"FNumber":""},"FIsIncludeChild":"false","FCurrentUserDimension":"false","FBudgetOrg":[{"FEntryID":0,"FEntryOrgId":{"FNUMBER":""}}],"FAuthorizatedUser":[{"FEntryID":0,"FUserId":{"FName":""}}],"FRole":[{"FEntryID":0,"FRoleId":{"FNumber":""}}],"FDataRuleDimLs":[{"FEntryID":0,"FDimension":{"FNumber":""},"FFilterName":"","FFilterKey":"","FFilterKeyDesc":"","FDimensionFormId":"","FDimEffectKey":"","FDimEffectName":"","FDimEffectKeyDesc":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_DataAuthorization","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_DataAuthorization","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_DataAuthorization","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_DataAuthorization"}");

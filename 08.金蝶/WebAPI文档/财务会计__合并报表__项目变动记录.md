# 项目变动记录 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 合并报表 > 项目变动记录
...
client.Delete("CR_HisCurrency","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CR_HisCurrency","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCompanyId":{"FNumber":""},"FBillNo":"","FScopeId":{"FNUMBER":""},"FScopeOrg":"","FSelectType":"","FEntity":[{"FEntryID":0,"FItemId":{"FNumber":""},"FItemDataTypeText":"","FCurrencyId":{"FNumber":""},"FAmount":0,"FDate":"1900-01-01"}],"FElimEntity":[{"FEntryID":0,"FElimCompanyToId":{"FNUMBER":""},"FElimItemId":{"FNumber":""},"FElimCurrencyId":{"FNumber":""},"FElimAmount":0,"FElimItemDataTypeText":"","FElimDate":"1900-01-01"}]}}");
...
固定报表项目变动记录：FEntity 
	 ...
	 项目数据类型：FItemDataTypeText 
抵消表项目变动记录：FElimEntity 
	 实体主键：FEntryID 
	 变动项目：FElimItemId  (必填项)
	 项目名称：FElimItemName 
	 币别：FElimCurrencyId  (必填项)
	 变动额：FElimAmount 
	 变动日期：FElimDate  (必填项)
	 项目数据类型：FElimItemDataTypeId 
	 关联方：FElimCompanyToId  (必填项)
	 项目数据类型：FElimItemDataTypeText 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CR_HisCurrency","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCompanyId":{"FNumber":""},"FBillNo":"","FScopeId":{"FNUMBER":""},"FScopeOrg":"","FSelectType":"","FEntity":[{"FEntryID":0,"FItemId":{"FNumber":""},"FItemDataTypeText":"","FCurrencyId":{"FNumber":""},"FAmount":0,"FDate":"1900-01-01"}],"FElimEntity":[{"FEntryID":0,"FElimCompanyToId":{"FNUMBER":""},"FElimItemId":{"FNumber":""},"FElimCurrencyId":{"FNumber":""},"FElimAmount":0,"FElimItemDataTypeText":"","FElimDate":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CR_HisCurrency","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CR_HisCurrency","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CR_HisCurrency","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CR_HisCurrency","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CR_HisCurrency","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_HisCurrency","Disable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_HisCurrency","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CR_HisCurrency"}");

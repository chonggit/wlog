...
client.Delete("SVM_InquiryBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SVM_InquiryBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FBusinessType":"","FInquiryDate":"1900-01-01","FPurchaseOrgId":{"FNumber":""},"FPurchaseDeptId":{"FNUMBER":""},"FPurchaserGroupId":{"FNUMBER":""},"FPurchaserId":{"FNUMBER":""},"FExpiryDate":"1900-01-01","FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FtoAllSuppliers":"false","FISSENDPHONEMSG":"false","FPHONEMSGTMP":"","FComMode":"","FAccessMutilSup":"false","FInquiryBus":{"FEntryId":0,"FSettleCurrId":{"FNUMBER":""},"FLocalCurrId":{"FNUMBER":""},"FExchangeTypeId":{"FNUMBER":""},"FPayConditionId":{"FNUMBER":""},"FSettleModeId":{"FNUMBER":""},"FPriceType":"","FIsIncludedTax":"false","FInquiryBillName":"","FBillNote":"","FExchangeRate":0},"FInquiryEntry":[{"FEntryID":0,"FMaterialId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FBaseUnitID":{"FNumber":""},"FQty":0,"FBaseQty":0,"FArrivalDatetime":"1900-01-01","FRequireOrgId":{"FNumber":""},"FRequireDeptId":{"FNUMBER":""},"FDeliveryType":{"FNumber":""},"FDeliveryLocation":"","FREFERCURRID":{"FNUMBER":""},"FREFERPRICE":0,"FEntryNote":"","FSourceBillType":"","FSourceBillNo":"","FInquiryQuote":[{"FDetailID":0}]}],"FInquirySup":[{"FEntryID":0,"FSupplierId":{"FNUMBER":""},"FContact":"","FPhone":"","FMail":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FEndDate": "1900-01-01",
        "FtoAllSuppliers": "false",
        "FISSENDPHONEMSG": "false",
        "FPHONEMSGTMP": "",
        "FComMode": "",
        "FAccessMutilSup": "false",
        "FInquiryBus": {
            "FEntryId": 0,
            "FSettleCurrId": {
                "FNUMBER": ""
...
基本信息：FBillHead 
	 ...
	 作废状态：FCancelStatus 
	 关闭状态：FCloseStatus 
	 SCP单据类型(隐藏)：FShowBillType 
	 适用所有供应商：FtoAllSuppliers 
	 第三方消息模板：FPHONEMSGTMP 
	 发送第三方消息通知：FISSENDPHONEMSG 
	 比价模式：FComMode 
...
明细信息：FInquiryEntry 
	 ...
	 确认供应商：FConfirmSupplierId 
	 交货方式：FDeliveryType 
	 交货地址：FDeliveryLocation 
	 源单类型：FSourceBillType 
	 源单编号：FSourceBillNo 
	 订单关联数量(基本单位)：FOrderJoinBaseQty 
	 订单关联数量：FOrderJoinQty 
	 比价关联数量(基本单位)：FCOMPAREJOINBASEQTY 
	 比价关联数量：FCOMPAREJOINQTY 
	 参考币别：FREFERCURRID 
	 参考价：FREFERPRICE 
商务信息：FInquiryBus 
	 实体主键：FEntryId 
...
适用供应商：FInquirySup 
	 ...
	 邮箱：FMail 
	 报价状态：FQuoteStatus 
报价采纳信息：FInquiryQuote 
	 实体主键：FDetailID 
	 供应商：FQuoteSup 
	 报价单位：FQuoteUnitID 
	 报价采纳数量：FQuoteQty 
	 报价单价：FQuotePrice 
	 报价含税单价：FQuoteTaxPrice 
	 货源比例(%)：FAccessRate 
	 税率：FQuoteTaxRate 
	 报价采纳金额：FQuoteAmount 
	 报价采纳价税合计：FQuoteTaxAmount 
	 基本单位报价采纳数量：FBaseQuoteQty 
	 基本单位关联订单数量2：FJoinOrderBaseQty2 
关联关系表：FInquiryEntry_Link 
	 实体主键：FLinkId 
	 业务流程图：FInquiryEntry_Link_FFlowId 
	 推进路线：FInquiryEntry_Link_FFlowLineId 
	 转换规则：FInquiryEntry_Link_FRuleId 
	 源单表内码：FInquiryEntry_Link_FSTableId 
	 源单表：FInquiryEntry_Link_FSTableName 
	 源单内码：FInquiryEntry_Link_FSBillId 
	 源单分录内码：FInquiryEntry_Link_FSId 
	 原始携带量：FInquiryEntry_Link_FBaseQtyOld 
	 修改携带量：FInquiryEntry_Link_FBaseQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SVM_InquiryBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FBusinessType":"","FInquiryDate":"1900-01-01","FPurchaseOrgId":{"FNumber":""},"FPurchaseDeptId":{"FNUMBER":""},"FPurchaserGroupId":{"FNUMBER":""},"FPurchaserId":{"FNUMBER":""},"FExpiryDate":"1900-01-01","FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FtoAllSuppliers":"false","FISSENDPHONEMSG":"false","FPHONEMSGTMP":"","FComMode":"","FAccessMutilSup":"false","FInquiryBus":{"FEntryId":0,"FSettleCurrId":{"FNUMBER":""},"FLocalCurrId":{"FNUMBER":""},"FExchangeTypeId":{"FNUMBER":""},"FPayConditionId":{"FNUMBER":""},"FSettleModeId":{"FNUMBER":""},"FPriceType":"","FIsIncludedTax":"false","FInquiryBillName":"","FBillNote":"","FExchangeRate":0},"FInquiryEntry":[{"FEntryID":0,"FMaterialId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FBaseUnitID":{"FNumber":""},"FQty":0,"FBaseQty":0,"FArrivalDatetime":"1900-01-01","FRequireOrgId":{"FNumber":""},"FRequireDeptId":{"FNUMBER":""},"FDeliveryType":{"FNumber":""},"FDeliveryLocation":"","FREFERCURRID":{"FNUMBER":""},"FREFERPRICE":0,"FEntryNote":"","FSourceBillType":"","FSourceBillNo":"","FInquiryQuote":[{"FDetailID":0}]}],"FInquirySup":[{"FEntryID":0,"FSupplierId":{"FNUMBER":""},"FContact":"","FPhone":"","FMail":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SVM_InquiryBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SVM_InquiryBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SVM_InquiryBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SVM_InquiryBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SVM_InquiryBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SVM_InquiryBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SVM_InquiryBill"}");

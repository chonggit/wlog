...
client.Delete("ENG_Substitution","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ENG_Substitution","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ENG_Substitution","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FUseOrgId":{"FNumber":""},"FNumber":"","FName":"","FDescription":"","FCreateOrgId":{"FNumber":""},"FReplacePolicy":"","FReplaceType":"","FBillType":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FReplaceSource":"","FRepType":"","FEntity":[{"FEntryID":0,"FPriority":0,"FSubMaterialID":{"FNumber":""},"FSubAuxPropID":{"FSUBAUXPROPID__FF100001":{"FNumber":""},"FSUBAUXPROPID__FF100002":{"FNumber":""},"FSUBAUXPROPID__FF100003":{"FNumber":""},"FSUBAUXPROPID__FF100005":{"FNumber":""},"FSUBAUXPROPID__FF100010":{"FNumber":""},"FSUBAUXPROPID__FF100007":{"FNumber":""},"FSUBAUXPROPID__FF100008":{"FNumber":""}},"FSubSupplyOrgId":{"FNumber":""},"FSubBomId":{"FNumber":""},"FSubIsKeyItem":"false","FSubUnitID":{"FNumber":""},"FSubNumerator":0,"FSubDenominator":0,"FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FMemo":"","FSubBomEntryId":0,"FSUBTemMtrlId":{"FNUMBER":""},"FSUBNETDEMANDRATE":0}],"FEntityMainItems":[{"FEntryID":0,"FMainPriority":0,"FMaterialID":{"FNumber":""},"FAuxPropID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FMainSupplyOrgId":{"FNumber":""},"FBomId":{"FNumber":""},"FIsKeyItem":"false","FUnitID":{"FNumber":""},"FNumerator":0,"FDenominator":0,"FBomEntryId":0,"FTemplateMtrlId":{"FNUMBER":""},"FNETDEMANDRATE":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FSubAuxPropID": {
                    "FSUBAUXPROPID__FF100001": {
                        "FNumber": ""
                    },
                    "FSUBAUXPROPID__FF100002": {
                        "FNumber": ""
                    },
                    "FSUBAUXPROPID__FF100003": {
                        "FNumber": ""
                    },
                    "FSUBAUXPROPID__FF100005": {
                        "FNumber": ""
                    },
                    "FSUBAUXPROPID__FF100010": {
                        "FNumber": ""
                    },
                    "FSUBAUXPROPID__FF100007": {
                        "FNumber": ""
                    },
                    "FSUBAUXPROPID__FF100008": {
                        "FNumber": ""
                    }
                },
                "FSubSupplyOrgId": {
...
单据头：FBillHead 
	 ...
	 禁用日期：FForbidDate 
	 审核日期：FApproveDate 
	 替代策略：FReplacePolicy  (必填项)
	 替代方式：FReplaceType  (必填项)
	 替代编码：FReplaceNO 
	 单据类型：FBillType  (必填项)
	 替代方案来源：FReplaceSource  (必填项)
	 替代类型：FRepType  (必填项)
替代物料：FEntity 
	 实体主键：FEntryID 
	 替代物料编码：FSubMaterialID  (必填项)
	 ...
	 备注：FMemo 
	 规格型号：FSubMaterialModel 
	 物料属性：FSubMaterialErpClsID 
	 辅助属性：FSubAuxPropID 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 ...
	 单位：FSubUnitID  (必填项)
	 基本单位：FSubBaseUnitID 
	 替代料BOM行标识：FSubBOMRowId 
	 分子：FSubNumerator 
	 分母：FSubDenominator 
	 替代料基本单位分子：FSubBaseNumerator 
	 替代料基本单位分母：FSubBaseDenominator 
	 供应组织：FSubSupplyOrgId 
	 替代料BOM分录内码：FSubBomEntryId 
	 替代模板物料：FSUBTemMtrlId 
	 净需求比例(%)：FSUBNETDEMANDRATE 
主物料：FEntityMainItems 
	 实体主键：FEntryID 
	 物料编码：FMaterialID  (必填项)
	 物料名称：FMaterialName 
	 规格型号：FMaterialModel 
	 物料属性：FMaterialProperty 
	 辅助属性：FAuxPropID 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 ...
	 分子：FNumerator 
	 分母：FDenominator 
	 主物料基本单位分子：FBaseNumerator 
	 主物料基本单位分母：FBaseDenominator 
	 供应组织：FMainSupplyOrgId 
	 BOM分录内码：FBomEntryId 
	 模板物料：FTemplateMtrlId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ENG_Substitution","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FUseOrgId":{"FNumber":""},"FNumber":"","FName":"","FDescription":"","FCreateOrgId":{"FNumber":""},"FReplacePolicy":"","FReplaceType":"","FBillType":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FReplaceSource":"","FRepType":"","FEntity":[{"FEntryID":0,"FPriority":0,"FSubMaterialID":{"FNumber":""},"FSubAuxPropID":{"FSUBAUXPROPID__FF100001":{"FNumber":""},"FSUBAUXPROPID__FF100002":{"FNumber":""},"FSUBAUXPROPID__FF100003":{"FNumber":""},"FSUBAUXPROPID__FF100005":{"FNumber":""},"FSUBAUXPROPID__FF100010":{"FNumber":""},"FSUBAUXPROPID__FF100007":{"FNumber":""},"FSUBAUXPROPID__FF100008":{"FNumber":""}},"FSubSupplyOrgId":{"FNumber":""},"FSubBomId":{"FNumber":""},"FSubIsKeyItem":"false","FSubUnitID":{"FNumber":""},"FSubNumerator":0,"FSubDenominator":0,"FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FMemo":"","FSubBomEntryId":0,"FSUBTemMtrlId":{"FNUMBER":""},"FSUBNETDEMANDRATE":0}],"FEntityMainItems":[{"FEntryID":0,"FMainPriority":0,"FMaterialID":{"FNumber":""},"FAuxPropID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FMainSupplyOrgId":{"FNumber":""},"FBomId":{"FNumber":""},"FIsKeyItem":"false","FUnitID":{"FNumber":""},"FNumerator":0,"FDenominator":0,"FBomEntryId":0,"FTemplateMtrlId":{"FNUMBER":""},"FNETDEMANDRATE":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ENG_Substitution","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ENG_Substitution","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ENG_Substitution","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_Substitution","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_Substitution","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ENG_Substitution","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Allocate("ENG_Substitution","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAllocate("ENG_Substitution","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ENG_Substitution"}");

# PC装箱设置 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > PC装箱设置
...
client.Delete("UN_PCPackSet","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_PCPackSet","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FSNBarcodeRule":{"FNUMBER":""},"FRemark":"","FIsRepeatPack":"false","FIsCheckMaterial":"false","FIsDelBarcode":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FPackCodeRule":{"FNUMBER":""},"FIsConvertToPack":"false","FIsUseBomMinPackQty":"false","FEntity":[{"FEntryID":0,"FBarcodeItem":{"FNUMBER":""},"FItemIndex":0,"FIsShow":"false","FItemRemark":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIsConvertToPack": "false",
        "FIsUseBomMinPackQty": "false",
        "FEntity": [
            {
                "FEntryID": 0,
                "FBarcodeItem": {
...
单据头：FBillHead 
	 ...
	 编码：FBillNo 
	 名称：FName 
	 SN条码规则：FSNBarcodeRule  (必填项)
	 备注：FRemark 
	 允许同一SN重复装箱扫描：FIsRepeatPack 
	 每箱首件SN需校验物料是否与外箱一致：FIsCheckMaterial 
	 扫描删除（清箱）时自动删除条码主档：FIsDelBarcode 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 包装条码规则：FPackCodeRule 
	 支持明细条码装箱并自动转换为包装条码：FIsConvertToPack 
	 按BOM取最小包装数：FIsUseBomMinPackQty 
单据体：FEntity 
	 实体主键：FEntryID 
	 条码属性：FBarcodeItem  (必填项)
	 允许显示：FIsShow 
	 备注：FItemRemark 
	 顺序号：FItemIndex 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_PCPackSet","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FSNBarcodeRule":{"FNUMBER":""},"FRemark":"","FIsRepeatPack":"false","FIsCheckMaterial":"false","FIsDelBarcode":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FPackCodeRule":{"FNUMBER":""},"FIsConvertToPack":"false","FIsUseBomMinPackQty":"false","FEntity":[{"FEntryID":0,"FBarcodeItem":{"FNUMBER":""},"FItemIndex":0,"FIsShow":"false","FItemRemark":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UN_PCPackSet","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("UN_PCPackSet","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_PCPackSet"}");

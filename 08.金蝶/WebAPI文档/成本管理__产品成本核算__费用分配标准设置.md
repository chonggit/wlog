# 费用分配标准设置 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 费用分配标准设置
...
client.Delete("CB_STANDARDSET","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_STANDARDSET","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_STANDARDSET","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FSTANDARDSETID":0,"FNumber":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FALLOCTYPE":"","FEXPENSETYPE":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FALLSET":"false","FALLSETSTANDARDID":{"FNUMBER":""},"FBillTypeName":"","FEntity":[{"FEntryID":0,"FCOSTCENTERID":{"FNumber":""},"FSTANDARDID":{"FNUMBER":""},"FSubEntity":[{"FDetailID":0,"FSUBCOSTCENTERID":{"FNumber":""},"FPRODUCTID":{"FNumber":""},"FWORKACTIVEID":{"FNumber":""},"FQTY":0}]}]}}");
...
单据头：FBillHead 
	 ...
	 费用类型：FEXPENSETYPE  (必填项)
	 统一设置分配标准：FALLSET 
	 分配标准：FALLSETSTANDARDID 
	 分配类型：FALLOCTYPE  (必填项)
	 核算体系编码：FACCTGSYSTEMNAME 
	 核算组织编码：FACCTGORGNAME 
	 核算组织：FACCTGORGID  (必填项)
	 会计政策：FACCTPOLICYID  (必填项)
	 会计政策编码：FAcctPolicyName 
	 费用项目：FEXPENSEITEMID 
	 单据类型：FBillTypeId 
	 费用项目名称：FEXPNAME 
...
发送方：FEntity 
	 ...
	 分配标准编码：FSTANDARDID  (必填项)
	 分配标准名称：FStandardName 
限定接收方：FSubEntity 
	 实体主键：FDetailID 
	 成本中心编码：FSUBCOSTCENTERID 
	 成本中心名称：FSUBCOSTCENTERNAME 
	 产品编码：FPRODUCTID 
	 作业活动编码：FWORKACTIVEID 
	 固定比例：FQTY 
	 产品名称：FPRODUCTNAME 
	 规格型号：FPRODUCTMODEL 
	 作业活动名称：FWORKACTIVEName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_STANDARDSET","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FSTANDARDSETID":0,"FNumber":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FALLOCTYPE":"","FEXPENSETYPE":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FALLSET":"false","FALLSETSTANDARDID":{"FNUMBER":""},"FBillTypeName":"","FEntity":[{"FEntryID":0,"FCOSTCENTERID":{"FNumber":""},"FSTANDARDID":{"FNUMBER":""},"FSubEntity":[{"FDetailID":0,"FSUBCOSTCENTERID":{"FNumber":""},"FPRODUCTID":{"FNumber":""},"FWORKACTIVEID":{"FNumber":""},"FQTY":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_STANDARDSET"}");

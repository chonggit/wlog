# 采购外发周期统计报表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 采购外发周期统计报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2395 |
...
client.GetSysReportData("QRDO_PurchaseOut","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FStockOrgId1":"","FStockOrgId":"","FStockNumber":"","FCheckNoData":"false"}}");
...
五、字段说明：
	 ...
	 库存组织：FStockOrgId1 
	 库存组织：FStockOrgId 
	 限定仓库开头编码：FStockNumber 
	 结存为零时不显示：FCheckNoData 

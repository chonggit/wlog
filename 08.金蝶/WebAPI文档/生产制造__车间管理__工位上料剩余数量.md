# 工位上料剩余数量 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 工位上料剩余数量
...
client.Delete("SFC_SiteWIPBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_SiteWIPBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FPrdLineId":{"FNUMBER":""},"FEquipmentId":{"FNUMBER":""},"FTrack":"","FFeederId":{"FNUMBER":""},"FChipMounterLocation":"","FMOBillNo":"","FMOSeq":0,"FProcessId":{"FNUMBER":""},"FSeqNumber":"","FOperNo":0,"FMaterialId":{"FNUMBER":""},"FMtrlLot":{"FNumber":""},"FUnitID":{"FNumber":""},"FPickQty":0,"FConsumeQty":0,"FOfflineCountQty":0,"FAutoReturnQty":0,"FAutoFeedQty":0,"FReturnQty":0,"FWIPQty":0,"FIssueType":"","FNumerator":0,"FDenominator":0,"FPicktime":"1900-01-01","FPickerId":{"FUserID":""},"FLastUpdateTime":"1900-01-01","FMOEntryId":0,"FOPSeqId":0,"FPPBOMEntryId":0,"FPPBOMSMTDetailId":0,"FCacheId":"","FBaseUnitID":{"FNumber":""},"FBasePickQty":0,"FBaseConsumeQty":0,"FBaseOfflineCountQty":0,"FBaseAutoReturnQty":0,"FBaseAutoFeedQty":0,"FBaseReturnQty":0,"FBaseWIPQty":0,"FBaseNumerator":0,"FBaseDenominator":0,"FLoadLot":""}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FNumerator": 0,
        "FDenominator": 0,
        "FPicktime": "1900-01-01",
        "FPickerId": {
            "FUserID": ""
        },
        "FLastUpdateTime": "1900-01-01",
        "FMOEntryId": 0,
        "FOPSeqId": 0,
        "FPPBOMEntryId": 0,
        "FPPBOMSMTDetailId": 0,
        ...
        "FBasePickQty": 0,
        "FBaseConsumeQty": 0,
        "FBaseOfflineCountQty": 0,
        "FBaseAutoReturnQty": 0,
        "FBaseAutoFeedQty": 0,
        "FBaseReturnQty": 0,
        "FBaseWIPQty": 0,
        "FBaseNumerator": 0,
...
单据头：FBillHead 
	 ...
	 序列内码：FOPSeqId 
	 基本计量单位：FBaseUnitID 
	 基本单位上料数量：FBasePickQty 
	 基本单位消耗数量：FBaseConsumeQty 
	 最近更新时间：FLastUpdateTime 
	 作业：FProcessId 
	 剩余数量：FWIPQty 
	 已上料退料数量：FReturnQty 
	 基本单位已上料退料数量：FBaseReturnQty 
	 计量单位：FUnitID 
	 基本单位剩余数量：FBaseWIPQty 
	 缓存标识：FCacheId 
	 轨道号：FTrack 
	 飞达编码：FFeederId 
	 工序号：FOperNo 
	 下线盘点数量：FOfflineCountQty 
	 基本单位下线盘点数量：FBaseOfflineCountQty 
	 自动退料数量：FAutoReturnQty 
	 基本单位自动退料数量：FBaseAutoReturnQty 
	 自动补料数量：FAutoFeedQty 
	 基本单位自动补料数量：FBaseAutoFeedQty 
	 发料方式：FIssueType 
	 用量:分子：FNumerator 
	 用量:分母：FDenominator 
	 生产用料清单分录内码：FPPBOMEntryId 
	 生产SMT上料表明细内码：FPPBOMSMTDetailId 
	 基本单位用量:分子：FBaseNumerator 
	 基本单位用量:分母：FBaseDenominator 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_SiteWIPBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FPrdLineId":{"FNUMBER":""},"FEquipmentId":{"FNUMBER":""},"FTrack":"","FFeederId":{"FNUMBER":""},"FChipMounterLocation":"","FMOBillNo":"","FMOSeq":0,"FProcessId":{"FNUMBER":""},"FSeqNumber":"","FOperNo":0,"FMaterialId":{"FNUMBER":""},"FMtrlLot":{"FNumber":""},"FUnitID":{"FNumber":""},"FPickQty":0,"FConsumeQty":0,"FOfflineCountQty":0,"FAutoReturnQty":0,"FAutoFeedQty":0,"FReturnQty":0,"FWIPQty":0,"FIssueType":"","FNumerator":0,"FDenominator":0,"FPicktime":"1900-01-01","FPickerId":{"FUserID":""},"FLastUpdateTime":"1900-01-01","FMOEntryId":0,"FOPSeqId":0,"FPPBOMEntryId":0,"FPPBOMSMTDetailId":0,"FCacheId":"","FBaseUnitID":{"FNumber":""},"FBasePickQty":0,"FBaseConsumeQty":0,"FBaseOfflineCountQty":0,"FBaseAutoReturnQty":0,"FBaseAutoFeedQty":0,"FBaseReturnQty":0,"FBaseWIPQty":0,"FBaseNumerator":0,"FBaseDenominator":0,"FLoadLot":""}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_SiteWIPBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_SiteWIPBill","Freeze","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_SiteWIPBill","Unfreeze","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SFC_SiteWIPBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_SiteWIPBill"}");

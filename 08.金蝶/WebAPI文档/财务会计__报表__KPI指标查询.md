# KPI指标查询 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 报表 > KPI指标查询

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2228 |
...
client.GetSysReportData("KDS_KPIListQuery","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAcctSysID":{"FNUMBER":""},"FYear":0,"FPeriod":0,"FORGEntity":[{"FOrgID":{"FNUMBER":""}}],"FKPIEntity":[{"FKPIID":{"FNUMBER":""}}]}}");

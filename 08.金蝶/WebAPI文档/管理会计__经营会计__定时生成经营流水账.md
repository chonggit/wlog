# 定时生成经营流水账 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 定时生成经营流水账
...
client.Delete("AM_VCHSETTIMERUN","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_VCHSETTIMERUN","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FExecuteTime":"1900-01-01","FEndDate":"1900-01-01","FBeginDate":"1900-01-01","FExecuteIntervalUnit":"","FExecuteInterval":0,"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FTaskRemarks":"","FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FACCOUNTBOOKID":{"FNUMBER":""},"FRUNTYPE":"","FSCHEDULEID":"","FCREATEORG":{"FNumber":""},"FEntity":[{"FENTRYID":0,"FVOUCHERPLANID":{"FNUMBER":""},"FPeriodFuture":""}],"FEEntity":[{"FEntryID":0,"FFROMVCHPLANID":{"FNUMBER":""},"FPeriodFutureGL":""}]}}");
...
单据头：FBillHead 
	 ...
	 任务描述：FTaskRemarks 
	 执行间隔：FExecuteInterval  (必填项)
	 计划开始时间：FBeginDate  (必填项)
	 修改人：FModifierId 
	 审核日期：FAuditDate 
...
引入业务单据方案单据体：FEntity 
	 实体主键：FENTRYID 
	 经营流水账引入方案：FVOUCHERPLANID 
	 经营流水账引入方案名称：FVOUCHERPLANNAME 
	 经营单元范围：FAMOEABLISTID 
	 未来期间数：FPeriodFuture  (必填项)
引入总账科目方案单据体：FEEntity 
	 实体主键：FEntryID 
	 引入总账科目方案：FFROMVCHPLANID 
	 引入总账科目方案名称：FFROMVCHPLANNAME 
	 未来期间数：FPeriodFutureGL  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_VCHSETTIMERUN","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FExecuteTime":"1900-01-01","FEndDate":"1900-01-01","FBeginDate":"1900-01-01","FExecuteIntervalUnit":"","FExecuteInterval":0,"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FTaskRemarks":"","FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FACCOUNTBOOKID":{"FNUMBER":""},"FRUNTYPE":"","FSCHEDULEID":"","FCREATEORG":{"FNumber":""},"FEntity":[{"FENTRYID":0,"FVOUCHERPLANID":{"FNUMBER":""},"FPeriodFuture":""}],"FEEntity":[{"FEntryID":0,"FFROMVCHPLANID":{"FNUMBER":""},"FPeriodFutureGL":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_VCHSETTIMERUN","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_VCHSETTIMERUN","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_VCHSETTIMERUN","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_VCHSETTIMERUN","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AM_VCHSETTIMERUN","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_VCHSETTIMERUN","UnForbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");

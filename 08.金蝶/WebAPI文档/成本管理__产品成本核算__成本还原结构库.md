# 成本还原结构库 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 成本还原结构库
...
client.Delete("CB_PRDRESTOREMATDETAIL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_PRDRESTOREMATDETAIL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FBillNo":"","FYEAR":0,"FPERIOD":0,"FCOSTCENTERID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FQTY":0,"FAMOUNT":0,"FDATAFROM":"","FCOMPLETEHOUR":0,"FVERSIONID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FEXPCALTYPE":"","FCOSTITEMID":{"FNUMBER":""},"FMATERIALID":{"FNUMBER":""},"FEXPENSEITEMID":{"FNUMBER":""},"FMATQTY":0,"FMATAMOUNT":0}]}}");
...
单据头：FBillHead 
	 ...
	 币别：FCURRENCYID 
	 产品名称：FPRODUCTNAME 
	 产品基本单位：FBASICUNITFIELD_FNAME 
	 规格型号：FSPECIFICATION 
	 标准成本版本：FVERSIONID 
单据体：FEntity 
	 实体主键：FEntryID 
	 费用类型：FEXPCALTYPE  (必填项)
	 成本项目：FCOSTITEMID  (必填项)
	 子项物料编码：FMATERIALID 
	 子项物料名称：FMATERIALIDNAME 
	 子项基本单位：FMATBASICUNITFIELD_FNAME 
	 数量：FMATQTY 
	 金额：FMATAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_PRDRESTOREMATDETAIL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FBillNo":"","FYEAR":0,"FPERIOD":0,"FCOSTCENTERID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FQTY":0,"FAMOUNT":0,"FDATAFROM":"","FCOMPLETEHOUR":0,"FVERSIONID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FEXPCALTYPE":"","FCOSTITEMID":{"FNUMBER":""},"FMATERIALID":{"FNUMBER":""},"FEXPENSEITEMID":{"FNUMBER":""},"FMATQTY":0,"FMATAMOUNT":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_PRDRESTOREMATDETAIL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CB_PRDRESTOREMATDETAIL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CB_PRDRESTOREMATDETAIL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CB_PRDRESTOREMATDETAIL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CB_PRDRESTOREMATDETAIL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_PRDRESTOREMATDETAIL"}");

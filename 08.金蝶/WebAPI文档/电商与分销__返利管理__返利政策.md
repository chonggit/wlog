...
client.Delete("RPM_RPPolicy","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("RPM_RPPolicy","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCurrencyID":{"FNUMBER":""},"FCompanyOrgUnitID":{"FNumber":""},"FRPModeID":{"FNUMBER":""},"FCumulatationType":"","FName":"","FRPCycleType":"","FContent":"","FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FJudgementModel":"","FIsSettleByCust":"false","FRPPolicyItemEntity":[{"FEntryID":0,"FRPCycleID":{"FNUMBER":""},"FGroupNumber":0,"FMaterialGroupID":{"FNumber":""},"FMaterialID":{"FNUMBER":""},"FUnitID":{"FNumber":""},"FPurchaseQty":0,"FAssistPropertyID":{"FASSISTPROPERTYID__FF100001":{"FNumber":""},"FASSISTPROPERTYID__FF100002":{"FNumber":""},"FASSISTPROPERTYID__FF100003":{"FNumber":""},"FASSISTPROPERTYID__FF100005":{"FNumber":""},"FASSISTPROPERTYID__FF100010":{"FNumber":""},"FASSISTPROPERTYID__FF100007":{"FNumber":""},"FASSISTPROPERTYID__FF100008":{"FNumber":""}},"FPurchaseAmount":0,"FTargetQty":0,"FTargetAmount":0,"FTargetRate":0,"FRPType":"","FPresentType":"","FEntryPresentQty":0,"FPresentCycleNum":0,"FRPRate":0,"FRPAmount":0,"FRPFixAmount":0,"FRemark":"","FBasePurchaseQty":0,"FBasePresentQty":0,"FBaseUnitID":{"FNumber":""},"FBaseTargetQty":0}],"FRPPolicySaleOrg":[{"FEntryID":0,"FSaleOrgID":{"FNumber":""}}],"FRPPolicyCustomer":[{"FEntryID":0,"FCustomerID":{"FNUMBER":""},"FCustomerTypeId":{"FNumber":""},"FCustAuditorId":{"FUserID":""},"FCustAuditTime":"1900-01-01"}],"FExEntity":[{"FEntryID":0,"FExMaterialGroupId":{"FNumber":""},"FExMaterialId":{"FNUMBER":""},"FExBaseUnitID":{"FNumber":""},"FExUnitID":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FExMatMasterId":0,"FExceptionType":""}],"FEntity":[{"FEntryID":0,"FExMaterialGroupDetailId":0,"FMGExceptionType":""}]}}");
...
基本信息：FBillHead 
	 ...
	 失效日期：FForbidDate 
	 失效状态：FForbidStatus 
	 返利周期类型：FRPCycleType  (必填项)
	 返利累进方式：FCumulatationType  (必填项)
	 多组号执行策略：FJudgementModel  (必填项)
	 按客户分开生成返利结算单：FIsSettleByCust 
物料范围：FRPPolicyItemEntity 
	 实体主键：FEntryID 
	 组号：FGroupNumber 
	 物料编码：FMaterialID 
	 物料名称：FMaterialName 
	 ...
	 返利周期：FRPCycleID  (必填项)
	 指标数量>=：FTargetQty 
	 指标基本单位数量：FBaseTargetQty 
	 指标金额>=：FTargetAmount 
	 赠送基数：FPresentCycleNum 
	 固定返利金额：FRPFixAmount 
参与销售组织：FRPPolicySaleOrg 
	 实体主键：FEntryID 
	 销售组织编码：FSaleOrgID  (必填项)
	 销售组织名称：FSaleOrgName 
参与客户：FRPPolicyCustomer 
	 实体主键：FEntryID 
	 客户编码：FCustomerID 
	 客户名称：FCustomerName 
...
例外明细：FExEntity 
	 实体主键：FEntryID 
	 物料分组：FExMaterialGroupId 
	 物料编码：FExMaterialId 
	 物料名称：FExMaterialName 
	 基本计量单位：FExBaseUnitID 
	 计量单位：FExUnitID 
	 辅助属性：FAuxPropId 
	 描述：FF100001
	 公差：FF100002
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 例外物料内码：FExMatMasterId 
	 例外控制：FExceptionType 
单据体：FEntity 
	 实体主键：FEntryID 
	 物料分组ID：FExMaterialGroupDetailId 
	 例外控制：FMGExceptionType 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("RPM_RPPolicy","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("RPM_RPPolicy","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RPM_RPPolicy"}");

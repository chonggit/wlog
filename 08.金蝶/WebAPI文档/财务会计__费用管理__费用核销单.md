# 费用核销单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 费用管理 > 费用核销单
...
client.View("ER_MatchBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("ER_MatchBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ER_MatchBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FCURRENCYID":{"FNumber":""},"FLOCALCURRID":{"FNumber":""},"FSETTLEORGID":{"FNumber":""},"FPAYORGID":{"FNumber":""},"FDOCUMENTSTATUS":"","FBillTypeID":{"FNUMBER":""},"Fmatcher":{"FUserID":""},"FEntity":[{"FEntryID":0,"FSOURCETYPE":{"FNumber":""},"FSRCBILLNO":"","FSRCSEQ":0,"FSRCDATE":"1900-01-01","FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FMatchAMOUNTFOR":0,"FOTHERCONTACTUNIT":"","FCurrencyId_D":{"FNUMBER":""},"FExpenseOrgID":{"FNumber":""},"FExpenseDeptID":{"FNUMBER":""},"FExpenseItemID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNumber":""},"FEXCHANGERATE":0,"FMATCHAMOUNT":0,"FPURPOSEID":{"FNumber":""},"FBUSINESSORGID":{"FNumber":""},"FBUSINESSDEPTID":{"FNumber":""},"FBUSINESSGROUPID":{"FNumber":""},"FBUSINESSERID":{"FNumber":""},"FMatchType":"","FACCTSYSTEMID":{"FNumber":""},"FSRCBILLID":0,"FSRCROWID":0,"FMatchFag":"","FSETTLETYPEID":{"FNumber":""}}]}}");
...
明细：FEntity 
	 实体主键：FEntryID 
	 单据类型：FSOURCETYPE 
	 单据：FBillTypeProperty 
	 单据编号：FSRCBILLNO 
	 单据行号：FSRCSEQ 
	 日期：FSRCDATE 
	 汇率类型：FEXCHANGETYPE 
	 汇率：FEXCHANGERATE 
	 核销金额：FMatchAMOUNTFOR 
	 核销本位币金额：FMATCHAMOUNT 
	 业务组织：FBUSINESSORGID 
	 业务部门：FBUSINESSDEPTID 
	 业务组：FBUSINESSGROUPID 
	 业务员：FBUSINESSERID 
	 核销种类：FMatchType 
	 往来单位类型：FCONTACTUNITTYPE 
	 往来单位：FCONTACTUNIT 
	 核算体系：FACCTSYSTEMID 
	 往来单位：FOTHERCONTACTUNIT 
	 源单内码：FSRCBILLID 
	 源单行内码：FSRCROWID 
	 结算方式：FSETTLETYPEID 
	 付款用途：FPURPOSEID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ER_MatchBill"}");

# 批次条码库存报表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 批次条码库存报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2098 |
...
client.GetSysReportData("BarcodeInventoryRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FBarcode":"","FMATERIALID":{"FNUMBER":""},"FLOT":{"FNUMBER":""},"FSTOCKID":{"FNUMBER":""},"FSTOCKLOCID":{"FNUMBER":""}}}");

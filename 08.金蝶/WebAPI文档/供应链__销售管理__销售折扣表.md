# 销售折扣表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 销售折扣表
...
| 业务失效 | SubUnEffective | 1703 |
| 取消业务失效 | SubEffective | 1701 |
| 失效 | UnEffective | 1700 |
| 取消失效 | Effective | 1698 |
| 行审核 | RowAudit | 1697 |
...
client.Delete("BD_SAL_DiscountList","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_SAL_DiscountList","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_SAL_DiscountList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FCurrencyId":{"FNumber":""},"FDescription":"","FDiscountFor":"","FDiscountObject":"","FEffectiveDate":"1900-01-01","FExpiryDate":"1900-01-01","FLimitCustomer":"","FLimitSalesMan":"","FSALDISCOUNTLISTENTRY":[{"FENTRYID":0,"FMaterialId":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FBomId":{"FNUMBER":""},"FLot":{"FNumber":""},"FDiscountType":"","FUnitID":{"FNumber":""},"FDiscountAccording":"","FFromQty":0,"FToQty":0,"FComputeMode":"","FDiscountRate":0,"FDiscount":0,"FPriceDiscount":0,"FEffectiveDateEntry":"1900-01-01","FExpiryDateEntry":"1900-01-01","FAutoApplicationDiscount":"false","FDiscDescription":""}],"FEntity1":[{"FENTRYID":0,"FCustID":{"FNumber":""},"FCustTypeID":{"FNumber":""},"FCustGroup":{"FNumber":""},"FIsDefList":"false"}],"FEntity2":[{"FENTRYID":0,"FSalerId":{"FNumber":""},"FDeptId":{"FNumber":""},"FSaleGroupId":{"FNumber":""}}],"FEntity":[{"FEntryID":0,"FPriceListId":{"FNumber":""}}]}}");
        ...
        "FSALDISCOUNTLISTENTRY": [
            {
                ...
                "FDiscount": 0,
                "FPriceDiscount": 0,
                "FEffectiveDateEntry": "1900-01-01",
                "FExpiryDateEntry": "1900-01-01",
                "FAutoApplicationDiscount": "false",
                "FDiscDescription": ""
            }
        ],
        "FEntity1": [
...
基本信息：FBillHead 
	 ...
	 失效人：FForbiderId 
	 失效日期：FForbidDate 
	 折扣应用层：FDiscountFor  (必填项)
	 币别：FCurrencyId  (必填项)
	 折扣对象：FDiscountObject  (必填项)
	 限定销售员：FLimitSalesMan 
	 限定客户：FLimitCustomer 
	 业务审核状态：FAuditStatus 
折扣明细：FSALDISCOUNTLISTENTRY 
	 实体主键：FENTRYID 
	 折扣类型：FDiscountType  (必填项)
	 从：FFromQty 
	 至：FToQty 
	 ...
	 物料携带计价单位：FPriceUnitId 
	 物料编码：FMaterialId 
	 折扣率(%)：FDiscountRate 
	 折扣额：FDiscount 
	 生效日：FEffectiveDateEntry  (必填项)
	 失效日：FExpiryDateEntry  (必填项)
	 自动应用折扣：FAutoApplicationDiscount 
	 物料名称：FMeterialName 
	 规格型号：FMeterialModel 
	 计算方式：FComputeMode  (必填项)
	 折扣描述：FDiscDescription 
	 折扣依据：FDiscountAccording  (必填项)
	 计价单位：FUnitID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_SAL_DiscountList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FCurrencyId":{"FNumber":""},"FDescription":"","FDiscountFor":"","FDiscountObject":"","FEffectiveDate":"1900-01-01","FExpiryDate":"1900-01-01","FLimitCustomer":"","FLimitSalesMan":"","FSALDISCOUNTLISTENTRY":[{"FENTRYID":0,"FMaterialId":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FBomId":{"FNUMBER":""},"FLot":{"FNumber":""},"FDiscountType":"","FUnitID":{"FNumber":""},"FDiscountAccording":"","FFromQty":0,"FToQty":0,"FComputeMode":"","FDiscountRate":0,"FDiscount":0,"FPriceDiscount":0,"FEffectiveDateEntry":"1900-01-01","FExpiryDateEntry":"1900-01-01","FAutoApplicationDiscount":"false","FDiscDescription":""}],"FEntity1":[{"FENTRYID":0,"FCustID":{"FNumber":""},"FCustTypeID":{"FNumber":""},"FCustGroup":{"FNumber":""},"FIsDefList":"false"}],"FEntity2":[{"FENTRYID":0,"FSalerId":{"FNumber":""},"FDeptId":{"FNumber":""},"FSaleGroupId":{"FNumber":""}}],"FEntity":[{"FEntryID":0,"FPriceListId":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_SAL_DiscountList","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_SAL_DiscountList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_SAL_DiscountList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_SAL_DiscountList","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_DiscountList","SubUnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_DiscountList","SubEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_DiscountList","UnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_DiscountList","Effective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_DiscountList","RowAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_DiscountList","RowUnAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_SAL_DiscountList","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_SAL_DiscountList"}");

# 实际工时归集 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 实际工时归集
...
client.View("CB_WORKHOURSCOLL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_WORKHOURSCOLL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FBillNo":"","FBIZORGID":{"FNumber":""},"FEntity":[{"FEntryID":0,"FDate":"1900-01-01","FCOSTCENTERID":{"FNumber":""},"FPROORDERENTRYID":0,"FPROORDERTYPE":"","FPROORDERNO":"","FPROORDERSEQ":0,"FPRODUCTID":{"FNumber":""},"FPRODUCTTYPE":"","FTIMENUITID":{"FNumber":""},"FHRPREPARETIME":0,"FHRWORKTIME":0,"FMACPREPARETIME":0,"FMACWORKTIME":0,"FTOTALTIME":0,"FMtoNo":"","FLOTID":{"FNUMBER":""},"FBOMID":{"FNumber":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FWORKCENTERID":{"FNUMBER":""},"FPROCOSTCENTERID":{"FNUMBER":""}}]}}");
...
明细：FEntity 
	 ...
	 机器实作工时：FMACWORKTIME 
	 实际总工时：FTOTALTIME 
	 来源单据分录内码：FSRCENTRYID 
	 来源单据内码：FSRCBILLID 
	 产品类型：FPRODUCTTYPE 
	 汇报数量：FRPTQTY 
	 订单数量：FORDERQTY 
	 工序说明：FOPERATIONDESCRIPTION 
	 单据类型：FBILLTYPEID 
	 计划跟踪号：FMtoNo 
	 批号：FLOTID 
	 BOM版本：FBOMID 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 生产/加工车间：FWORKCENTERID 
	 生产/加工成本中心：FPROCOSTCENTERID 
	 数据来源：FDATATYPE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("CB_WORKHOURSCOLL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_WORKHOURSCOLL","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_WORKHOURSCOLL"}");

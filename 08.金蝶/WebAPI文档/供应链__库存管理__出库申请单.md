# 出库申请单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 出库申请单
...
| 作废 | Cancel | 1693 |
| 反作废 | UnCancel | 1695 |
| 行反关闭 | RowUnClose | 1697 |
| 整单关闭 | BillClose | 1696 |
| 整单反关闭 | BillUnclose | 1698 |
| 业务终止 | BusinessEnd | 1698 |
| 业务反终止 | BusinessUnEnd | 1700 |
| 批量保存 | BatchSave | 3056 |
...
client.Delete("STK_OutStockApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("STK_OutStockApply","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FStockOrgId":{"FNumber":""},"FDate":"1900-01-01","FCustId":{"FNumber":""},"FDeptId":{"FNumber":""},"FBizType":"","FOwnerTypeIdHead":"","FNote":"","FApplyType":{"FNumber":""},"F_ora_Assistant":{"FNumber":""},"F_ora_week":"","F_ora_Combo":"","FPickerId":{"FSTAFFNUMBER":""},"F_UNW__PAEZ_Assistant_vym":{"FNumber":""},"FEntity":[{"FEntryID":0,"FMaterialId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FQty":0,"FBaseUnitId":{"FNumber":""},"FStockOrgIdEntry":{"FNumber":""},"FExtAuxUnitId":{"FNumber":""},"FExtAuxUnitQty":0,"FStockId":{"FNumber":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FLot":{"FNumber":""},"FOwnerTypeId":"","FOwnerId":{"FNumber":""},"FBomId":{"FNumber":""},"FProduceDate":"1900-01-01","FMtoNo":"","FStockStatusId":{"FNumber":""},"FEntryNote":"","FServiceContext":"","F_ProductId":{"FNUMBER":""},"F_OrderNo":"","F_PcsQty":0,"F_HTNo":"","F_CompletedDate":"1900-01-01","F_UseOfCollar":{"FNumber":""},"F_Custom":"","F_PlanQty":0,"F_ora_week1":"","F_ora_Base":{"FNUMBER":""},"F_piece_yardage":0,"F_person_in_charge":"","F_PAEZ_Text":"","F_CBZDDX_Text1":"","F_MBC_qtr":{"FNUMBER":""},"FDCC":{"FNUMBER":""},"FSCDDH":"","FSCDDHH":"","F_ZFXM1":{"FNumber":""},"F_CBZDDX":{"FNUMBER":""}}]}}");
...
基本信息：FBillHead 
	 ...
	 所属范围：F_ora_Assistant 
	 周数：F_ora_week 
	 申请类别：F_ora_Combo 
	 领料人：FPickerId 
	 出库类别：F_UNW__PAEZ_Assistant_vym 
明细信息：FEntity 
	 实体主键：FEntryID 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 普通出库关联数量（基本单位）：FNormalJoinBaseQty 
	 仓位：FStockLocId 
	 100新豪仓位值集：FF100003
	 ...
	 累计出库数量（基本单位）：FTotalBaseQty 
	 退货出库数量（基本单位）：FReturnBaseQty 
	 退货出库关联数量（基本单位）：FReturnJoinBaseQty 
	 普通出库数量（基本单位）：FNormalBaseQty 
	 普通出库关联数量（库存辅单位）：FNormalJoinQty 
	 普通出库数量（库存辅单位）：FNormalQty 
	 退货出库关联数量（库存辅单位）：FReturnJoinSecQty 
	 退货出库数量（库存辅单位）：FReturnSecQty 
	 累计出库数量（库存辅单位）：FTotalSecQty 
	 业务终止：FBusinessEnd 
	 终止人：FBusinessEnderId 
	 终止日期：FEndDate 
	 业务关闭：FBUSINESSCLOSED 
	 库存组织：FStockOrgIdEntry  (必填项)
	 即时库存：FInvQty 
	 生产对象：F_ProductId 
	 指令单号1：F_OrderNo 
	 计划量/支：F_PcsQty 
	 合同号/支数：F_HTNo 
	 完工日期：F_CompletedDate 
	 领用用途：F_UseOfCollar 
	 海关标识：F_Custom 
	 计划产量（PCS）：F_PlanQty 
	 周数（停用）：F_ora_week1 
	 客户：F_ora_Base 
	 单耗：F_piece_yardage 
	 生产对象名称：F_ora_BaseProperty 
	 负责人：F_person_in_charge 
	 指定对象1：F_PAEZ_Text 
	 成品指定对象：F_CBZDDX_Text1 
	 目标仓库：F_MBC_qtr 
	 生产订单号：FSCDDH 
	 生产订单行号：FSCDDHH 
	 调入仓库：FDCC 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("STK_OutStockApply","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FStockOrgId":{"FNumber":""},"FDate":"1900-01-01","FCustId":{"FNumber":""},"FDeptId":{"FNumber":""},"FBizType":"","FOwnerTypeIdHead":"","FNote":"","FApplyType":{"FNumber":""},"F_ora_Assistant":{"FNumber":""},"F_ora_week":"","F_ora_Combo":"","FPickerId":{"FSTAFFNUMBER":""},"F_UNW__PAEZ_Assistant_vym":{"FNumber":""},"FEntity":[{"FEntryID":0,"FMaterialId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FQty":0,"FBaseUnitId":{"FNumber":""},"FStockOrgIdEntry":{"FNumber":""},"FExtAuxUnitId":{"FNumber":""},"FExtAuxUnitQty":0,"FStockId":{"FNumber":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FLot":{"FNumber":""},"FOwnerTypeId":"","FOwnerId":{"FNumber":""},"FBomId":{"FNumber":""},"FProduceDate":"1900-01-01","FMtoNo":"","FStockStatusId":{"FNumber":""},"FEntryNote":"","FServiceContext":"","F_ProductId":{"FNUMBER":""},"F_OrderNo":"","F_PcsQty":0,"F_HTNo":"","F_CompletedDate":"1900-01-01","F_UseOfCollar":{"FNumber":""},"F_Custom":"","F_PlanQty":0,"F_ora_week1":"","F_ora_Base":{"FNUMBER":""},"F_piece_yardage":0,"F_person_in_charge":"","F_PAEZ_Text":"","F_CBZDDX_Text1":"","F_MBC_qtr":{"FNUMBER":""},"FDCC":{"FNUMBER":""},"FSCDDH":"","FSCDDHH":"","F_ZFXM1":{"FNumber":""},"F_CBZDDX":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("STK_OutStockApply","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("STK_OutStockApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("STK_OutStockApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("STK_OutStockApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("STK_OutStockApply","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("STK_OutStockApply","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_OutStockApply","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_OutStockApply","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_OutStockApply","RowUnClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_OutStockApply","BillClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_OutStockApply","BillUnclose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_OutStockApply","BusinessEnd","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_OutStockApply","BusinessUnEnd","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("STK_OutStockApply","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"STK_OutStockApply"}");

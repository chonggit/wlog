# 预算控制提示语 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 预算控制提示语
...
client.Delete("BM_CTRLMESSAGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_CTRLMESSAGE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_CTRLMESSAGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FNumber":"","FDescription":"","FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FModifyDate":"1900-01-01","FSuitAllRole":"false","FPresetData":"false","FModel":"","FModelTxt":"","FSuitRoleScope":[{"FEntryID":0,"FUserId":{"FNUMBER":""}}],"FCtrlMessageEntry":[{"FEntryID":0,"FMESSAGE":"","FShow":"false","FPreset":"","FSuitCondition":"","FMessageType":""}]}}");
...
单据头：FBillHead 
	 ...
	 创建人：FCreatorId 
	 修改日期：FModifyDate 
	 适用于所有角色：FSuitAllRole 
	 提示语范例：FModel  (必填项)
	 启用状态：FStartStatus 
	 是否系统预置：FPresetData 
	 提示语：FModelTxt 
适用角色范围：FSuitRoleScope 
	 实体主键：FEntryID 
	 角色编码：FUserId 
	 角色名称：FUserName 
自定义预算结果提示语：FCtrlMessageEntry 
	 实体主键：FEntryID 
	 提示语：FMESSAGE  (必填项)
	 显示：FShow 
	 适用条件：FSuitCondition  (必填项)
	 系统预置：FPreset  (必填项)
	 提示语类型：FMessageType 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_CTRLMESSAGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FNumber":"","FDescription":"","FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FModifyDate":"1900-01-01","FSuitAllRole":"false","FPresetData":"false","FModel":"","FModelTxt":"","FSuitRoleScope":[{"FEntryID":0,"FUserId":{"FNUMBER":""}}],"FCtrlMessageEntry":[{"FEntryID":0,"FMESSAGE":"","FShow":"false","FPreset":"","FSuitCondition":"","FMessageType":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_CTRLMESSAGE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_CTRLMESSAGE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_CTRLMESSAGE","Start","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_CTRLMESSAGE","UnStart","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_CTRLMESSAGE"}");

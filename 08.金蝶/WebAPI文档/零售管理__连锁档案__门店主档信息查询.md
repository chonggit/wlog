# 门店主档信息查询 Web API 操作原始内容

> 来源页面：全部 > 零售管理 > 连锁档案 > 门店主档信息查询

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 1924 |
...
client.GetSysReportData("CMK_BranchMainInfo_Query","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSaleOrgId":[{"FNumber":""}],"FBranchId":[{"FNumber":""}]}}");

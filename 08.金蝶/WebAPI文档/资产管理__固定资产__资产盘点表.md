# 资产盘点表 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 资产盘点表
...
client.Delete("FA_CountingReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_CountingReport","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FInventSchemeId":{"FBILLNO":""},"FInventUseDept":"false","FPositionFullName":"false","FInventPosition":"false","FInventUser":"false","FAssetOrgId":{"FNumber":""},"FDescription":"","FEntity":[{"FEntryID":0,"FOwnerOrgId":{"FNumber":""},"FAssetTypeId":{"FNumber":""},"FCardNumber":"","FAssetName":"","FAssetUnitId":{"FNumber":""},"FASSETSTATUSID":{"FNUMBER":""},"FAssetNumber":"","FSPECIFICATION":"","FBookQty":0,"FInitQty":0,"FVariance":0,"FBookPositionId":{"FNumber":""},"FBookUseDeptid":{"FNumber":""},"FBookUserId":{"FStaffNumber":""},"FInitPositionId":{"FNumber":""},"FInitUseDeptId":{"FNumber":""},"FInitUserId":{"FStaffNumber":""},"FInitCheckerId":{"FUserID":""},"FInitDate":"1900-01-01","FIsReinventory":"false","FReQty":0,"FRePositionId":{"FNumber":""},"FReUseDeptId":{"FNumber":""},"FReUserId":{"FStaffNumber":""},"FReCheckerId":{"FUserID":""},"FReDate":"1900-01-01","FIsDealPosition":"false","FIsDealDept":"false","FEntryDescription":"","FAlterId":{"FNumber":""},"FProfitStatus":"","FAssetId":0,"FKEEPERID":{"FSTAFFNUMBER":""},"FPSTATUS":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FInventUseDept": "false",
        "FPositionFullName": "false",
        "FInventPosition": "false",
        "FInventUser": "false",
        "FAssetOrgId": {
            "FNumber": ""
        },
        ...
        "FEntity": [
            {
                ...
                "FInitDate": "1900-01-01",
                "FIsReinventory": "false",
                "FReQty": 0,
                "FRePositionId": {
                    "FNumber": ""
                },
...
单据头：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 盘点方案：FInventSchemeId  (必填项)
	 描述：FDescription 
	 资产组织：FAssetOrgId  (必填项)
	 盘点使用部门：FInventUseDept 
	 资产位置显示全称：FPositionFullName 
	 盘点资产位置：FInventPosition 
	 盘点使用人：FInventUser 
明细：FEntity 
	 实体主键：FEntryID 
	 卡片变动内码：FAlterId 
	 ...
	 复盘人：FReCheckerId 
	 复盘日期：FReDate 
	 资产位置差异是否处理：FIsDealPosition 
	 资产类别：FAssetTypeId  (必填项)
	 资产编码：FAssetNumber 
	 资产名称：FAssetName 
	 单位：FAssetUnitId  (必填项)
	 使用部门差异是否处理：FIsDealDept 
	 备注：FEntryDescription 
	 账存资产位置：FBookPositionId 
	 初盘变动位置：FInitPositionId 
	 复盘资产位置：FRePositionId 
	 卡片编码：FCardNumber 
	 账存使用部门：FBookUseDeptid 
	 账存使用人：FBookUserId 
	 初盘变动使用部门：FInitUseDeptId 
	 初盘变动使用人：FInitUserId 
	 复盘使用部门：FReUseDeptId 
	 复盘使用人：FReUserId 
	 盘盈盘亏状态：FProfitStatus 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_CountingReport","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FInventSchemeId":{"FBILLNO":""},"FInventUseDept":"false","FPositionFullName":"false","FInventPosition":"false","FInventUser":"false","FAssetOrgId":{"FNumber":""},"FDescription":"","FEntity":[{"FEntryID":0,"FOwnerOrgId":{"FNumber":""},"FAssetTypeId":{"FNumber":""},"FCardNumber":"","FAssetName":"","FAssetUnitId":{"FNumber":""},"FASSETSTATUSID":{"FNUMBER":""},"FAssetNumber":"","FSPECIFICATION":"","FBookQty":0,"FInitQty":0,"FVariance":0,"FBookPositionId":{"FNumber":""},"FBookUseDeptid":{"FNumber":""},"FBookUserId":{"FStaffNumber":""},"FInitPositionId":{"FNumber":""},"FInitUseDeptId":{"FNumber":""},"FInitUserId":{"FStaffNumber":""},"FInitCheckerId":{"FUserID":""},"FInitDate":"1900-01-01","FIsReinventory":"false","FReQty":0,"FRePositionId":{"FNumber":""},"FReUseDeptId":{"FNumber":""},"FReUserId":{"FStaffNumber":""},"FReCheckerId":{"FUserID":""},"FReDate":"1900-01-01","FIsDealPosition":"false","FIsDealDept":"false","FEntryDescription":"","FAlterId":{"FNumber":""},"FProfitStatus":"","FAssetId":0,"FKEEPERID":{"FSTAFFNUMBER":""},"FPSTATUS":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_CountingReport","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_CountingReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_CountingReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_CountingReport","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("FA_CountingReport","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_CountingReport"}");

# 动态安全库存计算方案 Web API 操作原始内容

> 来源页面：全部 > 星空云服务 > 数据智能服务 > 动态安全库存计算方案
...
client.Delete("DI_CalculatePlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("DI_CalculatePlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAuditDate":"1900-01-01","FAuditorId":{"FUserID":""},"FName":"","FIssysPreset":"false","FDescription":"","FOrganization":"","FCalculateDimension":"","FCalculateGist":"","FCalculatePeriod":"","FCalculateModel":"","FLeadTime":"","FCostSource":"","FLeadTimeDefault":0,"FServiceLevelDefault":0,"FOrganizationId":"","FPurLeadTime":"","FPurLeadTimeId":"","FPrdLeadTime":"","FPrdLeadTimeId":"","FSalServiceLevel":"","FSalServiceLevelId":"","FPrdServiceLevel":"","FPrdServiceLevelId":"","FMaterialScopeType":"","FIndicatorModel":"","FStatisticalPeriod":0,"FStockStatusType":"","FStockStatusTypeId":"","FIndicatorModelId":"","FMaterialIndex":"","FMaterialIndexId":"","FEntity":[{"FEntryID":0,"FBillName":"","FBillTypeName":"","FBillTypeId":""}]}}");
...
计算方案：FBillHead 
	 ...
	 描述：FDescription 
	 适用组织：FOrganization 
	 计算依据：FCalculateGist  (必填项)
	 计算周期单位：FCalculatePeriod  (必填项)
	 默认计算模型：FCalculateModel  (必填项)
	 提前期：FLeadTime  (必填项)
	 物料成本来源：FCostSource  (必填项)
	 提前期缺省值（天）：FLeadTimeDefault 
	 服务水平缺省值（%）：FServiceLevelDefault 
	 适用组织ID：FOrganizationId 
	 采购提前期配置：FPurLeadTime  (必填项)
	 采购提前期配置ID：FPurLeadTimeId 
	 生产提前期配置：FPrdLeadTime  (必填项)
	 生产提前期配置ID：FPrdLeadTimeId 
	 实际服务水平（销售）：FSalServiceLevel  (必填项)
	 实际服务水平（销售）ID：FSalServiceLevelId 
	 实际服务水平（生产）：FPrdServiceLevel  (必填项)
	 实际服务水平（生产）ID：FPrdServiceLevelId 
	 计算维度：FCalculateDimension  (必填项)
	 物料范围类型：FMaterialScopeType  (必填项)
	 指标取值模型：FIndicatorModel  (必填项)
	 统计周期数：FStatisticalPeriod 
	 库存状态类型：FStockStatusType  (必填项)
	 库存状态类型Id：FStockStatusTypeId 
	 指标取值模型ID：FIndicatorModelId 
	 XML字段：FXMLField 
	 物料指标：FMaterialIndex 
	 物料指标ID：FMaterialIndexId 
来源选择：FEntity 
	 实体主键：FEntryID 
	 单据名称：FBillName  (必填项)
	 单据类型名称：FBillTypeName 
	 单据类型id：FBillTypeId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("DI_CalculatePlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("DI_CalculatePlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAuditDate":"1900-01-01","FAuditorId":{"FUserID":""},"FName":"","FIssysPreset":"false","FDescription":"","FOrganization":"","FCalculateDimension":"","FCalculateGist":"","FCalculatePeriod":"","FCalculateModel":"","FLeadTime":"","FCostSource":"","FLeadTimeDefault":0,"FServiceLevelDefault":0,"FOrganizationId":"","FPurLeadTime":"","FPurLeadTimeId":"","FPrdLeadTime":"","FPrdLeadTimeId":"","FSalServiceLevel":"","FSalServiceLevelId":"","FPrdServiceLevel":"","FPrdServiceLevelId":"","FMaterialScopeType":"","FIndicatorModel":"","FStatisticalPeriod":0,"FStockStatusType":"","FStockStatusTypeId":"","FIndicatorModelId":"","FMaterialIndex":"","FMaterialIndexId":"","FEntity":[{"FEntryID":0,"FBillName":"","FBillTypeName":"","FBillTypeId":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("DI_CalculatePlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("DI_CalculatePlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("DI_CalculatePlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("DI_CalculatePlan","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("DI_CalculatePlan","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"DI_CalculatePlan"}");

# MES-随工单 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产管理 > MES-随工单
...
client.Delete("ora_LYKF_MES_FlowTicket","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ora_LYKF_MES_FlowTicket","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_TU":"","F_cInvCode":{"FNumber":""},"F_DocDate":"1900-01-01","F_BatchQty":0,"F_ProFAuxPropId":{"F_PROFAUXPROPID__FF100001":{"FNumber":""},"F_PROFAUXPROPID__FF100002":{"FNumber":""},"F_PROFAUXPROPID__FF100003":{"FNumber":""},"F_PROFAUXPROPID__FF100005":{"FNumber":""},"F_PROFAUXPROPID__FF100010":{"FNumber":""},"F_PROFAUXPROPID__FF100007":{"FNumber":""},"F_PROFAUXPROPID__FF100008":{"FNumber":""}},"F_Material":{"FNUMBER":""},"F_MaterialFAuxPropId":{"F_MATERIALFAUXPROPID__FF100001":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100002":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100003":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100005":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100010":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100007":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100008":{"FNumber":""}},"F_MaterialsBatch":"","F_Id":0,"FUseOrgId":"","F_CreatorId":{"FUserID":""},"F_CreateDate":"1900-01-01","F_ModifierId":{"FUserID":""},"F_ModifyDate":"1900-01-01","F_ApproverId1":{"FUserID":""},"F_ApproveDate":"1900-01-01","F_OutNo":"","F_ProiRow":"","F_DispatchQtyDate":"1900-01-01","F_DISPATCHQTY":0,"F_MthEndRemainder":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_DocDate": "1900-01-01",
        "F_BatchQty": 0,
        "F_ProFAuxPropId": {
            "F_PROFAUXPROPID__FF100001": {
                "FNumber": ""
            },
            "F_PROFAUXPROPID__FF100002": {
                "FNumber": ""
            },
            "F_PROFAUXPROPID__FF100003": {
                "FNumber": ""
            },
            "F_PROFAUXPROPID__FF100005": {
                "FNumber": ""
            },
            "F_PROFAUXPROPID__FF100010": {
                "FNumber": ""
            },
            "F_PROFAUXPROPID__FF100007": {
                "FNumber": ""
            },
            "F_PROFAUXPROPID__FF100008": {
                "FNumber": ""
            }
        },
        "F_Material": {
        ...
        "F_MaterialFAuxPropId": {
            "F_MATERIALFAUXPROPID__FF100001": {
                "FNumber": ""
            },
            "F_MATERIALFAUXPROPID__FF100002": {
                "FNumber": ""
            },
            "F_MATERIALFAUXPROPID__FF100003": {
                "FNumber": ""
            },
            "F_MATERIALFAUXPROPID__FF100005": {
                "FNumber": ""
            },
            "F_MATERIALFAUXPROPID__FF100010": {
                "FNumber": ""
            },
            "F_MATERIALFAUXPROPID__FF100007": {
                "FNumber": ""
            },
            "F_MATERIALFAUXPROPID__FF100008": {
                "FNumber": ""
            }
        },
        "F_MaterialsBatch": "",
        ...
        "F_CreateDate": "1900-01-01",
        "F_ModifierId": {
            "FUserID": ""
        },
        "F_ModifyDate": "1900-01-01",
        "F_ApproverId1": {
            "FUserID": ""
        },
        "F_ApproveDate": "1900-01-01",
        "F_OutNo": "",
        "F_ProiRow": "",
        "F_DispatchQtyDate": "1900-01-01",
        "F_DISPATCHQTY": 0,
        "F_MthEndRemainder": "false"
    }
}
...
单据头：FBillHead 
	 ...
	 TU：F_TU 
	 零件编码：F_cInvCode 
	 零件名称：F_ProductionStd 
	 工单日期：F_DocDate 
	 批量：F_BatchQty 
	 零件辅助属性：F_ProFAuxPropId 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 TU归属：FF100005
	 ...
	 生产订单号：F_OutNo 
	 生产订单行号：F_ProiRow 
	 发单日期：F_DispatchQtyDate 
	 发单数量：F_DISPATCHQTY 
	 是否月末开单余量：F_MthEndRemainder 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ora_LYKF_MES_FlowTicket","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_TU":"","F_cInvCode":{"FNumber":""},"F_DocDate":"1900-01-01","F_BatchQty":0,"F_ProFAuxPropId":{"F_PROFAUXPROPID__FF100001":{"FNumber":""},"F_PROFAUXPROPID__FF100002":{"FNumber":""},"F_PROFAUXPROPID__FF100003":{"FNumber":""},"F_PROFAUXPROPID__FF100005":{"FNumber":""},"F_PROFAUXPROPID__FF100010":{"FNumber":""},"F_PROFAUXPROPID__FF100007":{"FNumber":""},"F_PROFAUXPROPID__FF100008":{"FNumber":""}},"F_Material":{"FNUMBER":""},"F_MaterialFAuxPropId":{"F_MATERIALFAUXPROPID__FF100001":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100002":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100003":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100005":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100010":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100007":{"FNumber":""},"F_MATERIALFAUXPROPID__FF100008":{"FNumber":""}},"F_MaterialsBatch":"","F_Id":0,"FUseOrgId":"","F_CreatorId":{"FUserID":""},"F_CreateDate":"1900-01-01","F_ModifierId":{"FUserID":""},"F_ModifyDate":"1900-01-01","F_ApproverId1":{"FUserID":""},"F_ApproveDate":"1900-01-01","F_OutNo":"","F_ProiRow":"","F_DispatchQtyDate":"1900-01-01","F_DISPATCHQTY":0,"F_MthEndRemainder":"false"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ora_LYKF_MES_FlowTicket","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ora_LYKF_MES_FlowTicket","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ora_LYKF_MES_FlowTicket","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ora_LYKF_MES_FlowTicket","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ora_LYKF_MES_FlowTicket","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ora_LYKF_MES_FlowTicket","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ora_LYKF_MES_FlowTicket"}");

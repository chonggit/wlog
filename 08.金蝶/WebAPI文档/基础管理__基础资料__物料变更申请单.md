# 物料变更申请单 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 基础资料 > 物料变更申请单
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1470 |
| 分组信息查询 | QueryGroupInfo | 1183 |
| 分组删除 | GroupDelete | 1083 |
...
client.Delete("QRDO_Meterial_Change","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QRDO_Meterial_Change","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FNote":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FChangeStatus":"","FHeadUseOrgId":{"FNumber":""},"F_ora_Assistant":{"FNumber":""},"F_ora_Combo":"","F_ora_Base":{"FNUMBER":""},"FHTBillNO":"","FSyncScope":[{"FNumber":""}],"FSyncScopeText":"","FEntity":[{"FEntryID":0,"FGroup":0,"FConvertType":"","FUseOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FMaterialID":{"FNUMBER":""},"FMaterialNumber":"","FMaterialName":"","FMaterialModel":"","FMaterialGroup":{"FNumber":""},"FproductMainCustomer":"","FSecondaryClass":"","FProductSecondaryClass":"","FProductThreeClass":"","FProductName":"","FCustomsMaterialNumber":"","FProductTexture":"","FCustGroupNumber":"","FPrimaryClass":{"FNumber":""},"FProductVer":"","FMaterialTexture":{"FNumber":""},"FContractMaterialNumber":"","FTextureModel":"","FCustomsMaterialSource":{"FNumber":""},"FCustomsMaterialName":"","FCustomsProductName":"","FIsDeclare":"false","FInvoiceName":"","FDefectRate":0,"FMaterialShape":"","FKYZZMaterialNumber":"","FLongProcurement":0,"FFixedLeadTime":0,"FDiameter":"","FDiameterUnit":"","FSpecialNeed":{"FNumber":""},"FSpecialNeedtxt":"","FSampleMake":{"FNumber":""},"F_ora_PMC":{"FSTAFFNUMBER":""},"F_ora_CheckOnTime":"false"}]}}");
...
单据头：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 变更状态：FChangeStatus  (必填项)
	 变更使用组织：FHeadUseOrgId 
	 所属部门：F_ora_Assistant 
	 变更类型：F_ora_Combo  (必填项)
	 部门：F_ora_Base  (必填项)
	 汇通物料变更表编号：FHTBillNO 
	 同步范围：FSyncScope  (必填项)
...
单据体：FEntity 
	 ...
	 分组：FGroup 
	 转换类型：FConvertType 
	 物料信息：FMaterialID  (必填项)
	 物料代码：FMaterialNumber 
	 物料名称：FMaterialName 
	 规格型号：FMaterialModel 
	 使用组织：FUseOrgId 
	 物料分组：FMaterialGroup 
	 ...
	 客户组编号：FCustGroupNumber 
	 产品一级大类：FPrimaryClass 
	 版本：FProductVer 
	 材质：FMaterialTexture 
	 ...
	 不良率（%）：FDefectRate 
	 材料形状：FMaterialShape 
	 最长采购周期（天）：FLongProcurement 
	 科益自制编码：FKYZZMaterialNumber 
	 直径：FDiameter 
	 直径单位：FDiameterUnit 
	 固定提前期：FFixedLeadTime 
	 创建组织：FCreateOrgId 
	 产品主要客户：FproductMainCustomer 
	 链接特殊需求：FSpecialNeed 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QRDO_Meterial_Change","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FNote":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FChangeStatus":"","FHeadUseOrgId":{"FNumber":""},"F_ora_Assistant":{"FNumber":""},"F_ora_Combo":"","F_ora_Base":{"FNUMBER":""},"FHTBillNO":"","FSyncScope":[{"FNumber":""}],"FSyncScopeText":"","FEntity":[{"FEntryID":0,"FGroup":0,"FConvertType":"","FUseOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FMaterialID":{"FNUMBER":""},"FMaterialNumber":"","FMaterialName":"","FMaterialModel":"","FMaterialGroup":{"FNumber":""},"FproductMainCustomer":"","FSecondaryClass":"","FProductSecondaryClass":"","FProductThreeClass":"","FProductName":"","FCustomsMaterialNumber":"","FProductTexture":"","FCustGroupNumber":"","FPrimaryClass":{"FNumber":""},"FProductVer":"","FMaterialTexture":{"FNumber":""},"FContractMaterialNumber":"","FTextureModel":"","FCustomsMaterialSource":{"FNumber":""},"FCustomsMaterialName":"","FCustomsProductName":"","FIsDeclare":"false","FInvoiceName":"","FDefectRate":0,"FMaterialShape":"","FKYZZMaterialNumber":"","FLongProcurement":0,"FFixedLeadTime":0,"FDiameter":"","FDiameterUnit":"","FSpecialNeed":{"FNumber":""},"FSpecialNeedtxt":"","FSampleMake":{"FNumber":""},"F_ora_PMC":{"FSTAFFNUMBER":""},"F_ora_CheckOnTime":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QRDO_Meterial_Change","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QRDO_Meterial_Change","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QRDO_Meterial_Change","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QRDO_Meterial_Change","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QRDO_Meterial_Change","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("QRDO_Meterial_Change","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QRDO_Meterial_Change"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("QRDO_Meterial_Change","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("QRDO_Meterial_Change","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("QRDO_Meterial_Change","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

# 移动签到报表 Web API 操作原始内容

> 来源页面：全部 > 客户关系管理 > 日程管理 > 移动签到报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2389 |
...
client.GetSysReportData("Sche_RPT_SignInInfo","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FFromSignTime":"1900-01-01","FToSignTime":"1900-01-01","FFromUser":{"FUSERACCOUNT":""},"FToUser":{"FUSERACCOUNT":""},"FBeginCustomerID":{"FNumber":""},"FEndCustomerID":{"FNumber":""}}}");
...
四、JSON格式数据：
{
    ...
    "FilterString": [],
    "Model": {
        "FFromSignTime": "1900-01-01",
        "FToSignTime": "1900-01-01",
        "FFromUser": {
            "FUSERACCOUNT": ""
        },
        "FToUser": {

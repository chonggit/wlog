...
client.Delete("PLM_CFG_CODERULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLM_CFG_CODERULE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PLM_CFG_CODERULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FRULEID":"","FBillFormID":{"FID":""},"FName":"","FDescription":"","FIsDefault":"false","FAllowAdjust":"false","FISRepairBILLNO":"false","FISAutoBILLNO":"false","FNewSimulation":"false","FForbidDate":"1900-01-01","FNumber":"","FIsSysPreSet":"false","FIsConstLen":"false","FCtrlType":"","FMatchType":"","FBillCodeRuleEntry":[{"FEntryID":"","FProjectType":"","FProjectID":"","FProjectIDText":"","FProjectProperty":"","FLength":0,"FFormat":"","FFormatText":"","FProjectValue":"","FSeed":0,"FIncrement":0,"FSeperator":"","FReChar":"","FAddChar":"","FCutStyle":"false","FAddStyle":"false","FCodeOnlyBy":"false","FCodeElement":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIsDefault": "false",
        "FAllowAdjust": "false",
        "FISRepairBILLNO": "false",
        "FISAutoBILLNO": "false",
        "FNewSimulation": "false",
...
单据头：FBillHead 
	 ...
	 编码：FNumber 
	 默认规则：FIsDefault 
	 新建时是否模拟生成：FNewSimulation 
	 允许修改：FAllowAdjust 
	 描述：FDescription 
	 手动补号：FISRepairBILLNO 
	 创建人：FCreatorId 
	 创建时间：FCreateDate 
	 系统预设：FIsSysPreSet 
	 审核人：FAuditorID 
	 ...
	 审核日期：FAuditDate 
	 最后修改人：FModifierId 
	 业务对象：FBillFormID  (必填项)
	 自动补号：FISAutoBILLNO 
	 禁止自动升位：FIsConstLen 
	 流水号计算方式：FVersion 
	 流水号按编码依据区分升位：FAddLenWithCodeBy 
	 是否已清空补号池：FIsClearRepairPool 
	 管控方式：FCtrlType 
	 初始流水号长度：FInitialFlowLen 
	 匹配方式：FMatchType 
单据体：FBillCodeRuleEntry 
	 实体主键：FEntryID 
	 类型：FProjectType  (必填项)
	 来源属性：FProjectProperty 
	 长度：FLength 
	 右侧截断：FCutStyle 
	 分隔符：FSeperator 
	 替代符：FReChar 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PLM_CFG_CODERULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PLM_CFG_CODERULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PLM_CFG_CODERULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PLM_CFG_CODERULE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PLM_CFG_CODERULE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_CFG_CODERULE"}");

# 应收票据拆分单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 应收票据拆分单
...
client.Draft("CN_SplitRecBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPE":"","FPAYORGID":{"FNumber":""},"FSETTLEORGID":{"FNumber":""},"FBILLNUMBER":"","FCURRENCYID":{"FNumber":""},"FISSUEDATE":"1900-01-01","FCONTACTUNITTYPE":"","FDUEDATE":"1900-01-01","FCONTACTUNIT":{"FNumber":""},"FPARAMOUNTFOR":0,"FPARRATE":0,"FDRAWER":"","FACCEPTOR":"","FACCEPTDEALNO":"","FACCEPTDATE":"1900-01-01","FCOMMENT":"","FBillNo":"","FDate":"1900-01-01","FTRADEAMOUNTFOR":0,"FSALEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FSALEGROUPID":{"FNumber":""},"FSALEERID":{"FNumber":""},"FRECBANKID":{"FNumber":""},"FRECBANKACNTID":{"FNumber":""},"FPAYBANKNAME":"","FPAYBANKACNTNO":"","FPAYACNTNAME":"","FPAYBANKADDRESS":"","FExchangeRate":0,"FScanPoint":{"FNUMBER":""},"FREVOCABLENEW":"false","FRECOURSENEW":"false","FISINIT":"false","FISELECTRONICBILL":"false","FSourceBillNo":"","FEquidiffBill":"false","FRCBILLNUMBER":"","FStandardAmt":0,"FSourceBillType":"","FBillTypeID":{"FNUMBER":""},"FSubbillStartNo":0,"FSUBBILLENDNO":0,"FTicketFrom":"","FNewNoteStatus":"","FCirStatus":"","FSplitRecBillEntity":[{"FEntryID":0,"FESUBBILLSTARTNO":0,"FESUBBILLENDNO":0,"FESUBBILLNUMBER":0}]}}");
...
单据体：FSplitRecBillEntity 
	 实体主键：FEntryID 
	 票据号码：FERCBILLNUMBER 
	 金额：FAmount 
	 子票据包区间：FESubbillRange 
	 子票据开始序号：FESUBBILLSTARTNO 
	 子票据终止序号：FESUBBILLENDNO 
	 子票据包数量：FESUBBILLNUMBER 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_SplitRecBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPE":"","FPAYORGID":{"FNumber":""},"FSETTLEORGID":{"FNumber":""},"FBILLNUMBER":"","FCURRENCYID":{"FNumber":""},"FISSUEDATE":"1900-01-01","FCONTACTUNITTYPE":"","FDUEDATE":"1900-01-01","FCONTACTUNIT":{"FNumber":""},"FPARAMOUNTFOR":0,"FPARRATE":0,"FDRAWER":"","FACCEPTOR":"","FACCEPTDEALNO":"","FACCEPTDATE":"1900-01-01","FCOMMENT":"","FBillNo":"","FDate":"1900-01-01","FTRADEAMOUNTFOR":0,"FSALEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FSALEGROUPID":{"FNumber":""},"FSALEERID":{"FNumber":""},"FRECBANKID":{"FNumber":""},"FRECBANKACNTID":{"FNumber":""},"FPAYBANKNAME":"","FPAYBANKACNTNO":"","FPAYACNTNAME":"","FPAYBANKADDRESS":"","FExchangeRate":0,"FScanPoint":{"FNUMBER":""},"FREVOCABLENEW":"false","FRECOURSENEW":"false","FISINIT":"false","FISELECTRONICBILL":"false","FSourceBillNo":"","FEquidiffBill":"false","FRCBILLNUMBER":"","FStandardAmt":0,"FSourceBillType":"","FBillTypeID":{"FNUMBER":""},"FSubbillStartNo":0,"FSUBBILLENDNO":0,"FTicketFrom":"","FNewNoteStatus":"","FCirStatus":"","FSplitRecBillEntity":[{"FEntryID":0,"FESUBBILLSTARTNO":0,"FESUBBILLENDNO":0,"FESUBBILLNUMBER":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_SplitRecBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_SplitRecBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_SplitRecBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_SplitRecBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("CN_SplitRecBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_SplitRecBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_SplitRecBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_SplitRecBill"}");

# 现场异常处理单 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 现场异常处理单
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1031 |
| 分组信息查询 | QueryGroupInfo | 1031 |
| 分组删除 | GroupDelete | 1031 |
...
client.Delete("SFC_AlertBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_AlertBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_AlertBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCancelId":{"FUserID":""},"FApproveDate":"1900-01-01","FApproverId":{"FUserID":""},"FCancelDate":"1900-01-01","FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifyDate":"1900-01-01","FProdOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FEquipmentId":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FExpStatus":"","FSubMaterialId":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FOPSeqNumber":"","FMoRowNumber":"","FLot":{"FNumber":""},"FMoNumber":"","FOPOperNumber":"","FAlertTime":"1900-01-01","FCancelAlertTime":"1900-01-01","FUnitID":{"FNumber":""},"FFinishQty":0,"FBadQty":0,"FBaseUnitID":{"FNumber":""},"FBaseFinishQty":0,"FBaseBadQty":0,"FDataSource":"","FDescribe":"","FExpEmergStatus":"","FCurExpLevel":"","FQty":0,"FBaseQty":0,"FBadRate":0,"FExpType":{"FName":""},"FAlertPerson":{"FUSERACCOUNT":""},"FConfirmPerson":{"FSTAFFNUMBER":""},"FProcessName":{"FName":""},"FMoBillType":"","FMsgSendTime":"1900-01-01","FReplaceGroup":0,"FMOId":0,"FMOEntryId":0,"FOpPlanId":0,"FOpSeqEntryId":0,"FOpEntryId":0,"FAlertDescribe":"","FConclusion":"","FShutDownStatus":"false","FShutDownPerson":{"FUSERACCOUNT":""},"FShutDownDate":"1900-01-01","FProcessStaff":{"FSTAFFNUMBER":""},"FSerialId":{"FNUMBER":""},"FOccDepartment":{"FNUMBER":""},"FAssignableCause":{"FNumber":""},"FDisposeTime":0,"FCallType":"","FCauseAnalysis":"","FCorreAct":"","FPrecaution":"","FSupplierId":{"FNUMBER":""},"FIssueQty":0,"FSupplyLot":"","FSeverity":{"FNumber":""},"FOptPlanNo":"","FMtrlUnitID":{"FNumber":""},"FProcessStage":{"FNumber":""},"FHMITerminal":"","FEntity":[{"FEntryID":0,"FSerialType":"","FSerialId2":{"FNUMBER":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FMoNumber": "",
        "FOPOperNumber": "",
        "FAlertTime": "1900-01-01",
        "FCancelAlertTime": "1900-01-01",
        "FUnitID": {
            "FNumber": ""
        },
        "FFinishQty": 0,
        ...
        "FAlertDescribe": "",
        "FConclusion": "",
        "FShutDownStatus": "false",
        "FShutDownPerson": {
            "FUSERACCOUNT": ""
        },
        "FShutDownDate": "1900-01-01",
        "FProcessStaff": {
            "FSTAFFNUMBER": ""
        },
        "FSerialId": {
...
单据头：FBillHead 
	 ...
	 计量单位：FUnitID 
	 基本计量单位：FBaseUnitID 
	 基本单位已完工数量：FBaseFinishQty 
	 基本单位不良数量：FBaseBadQty 
	 产品编码：FMaterialId 
	 异常发生时间：FAlertTime  (必填项)
	 订单行号：FMoRowNumber 
	 生产订单：FMoNumber 
	 子项批号：FLot 
	 异常紧急状态：FExpEmergStatus  (必填项)
	 工序数量：FQty 
	 基本单位数量：FBaseQty 
	 不良率：FBadRate 
	 工序序列：FOPSeqNumber 
	 ...
	 子项物料编码：FSubMaterialId 
	 物料名称：FSubMaterialName 
	 异常处理状态：FExpStatus 
	 当前异常等级：FCurExpLevel 
	 解除报警时间：FCancelAlertTime 
	 异常类型：FExpType  (必填项)
	 发起人：FAlertPerson 
	 确认人：FConfirmPerson 
	 作业名称：FProcessName 
	 ...
	 异常描述：FAlertDescribe 
	 处理结论：FConclusion 
	 状态变更日志项次：FReplaceGroup 
	 关闭状态：FShutDownStatus 
	 关闭人：FShutDownPerson 
	 关闭时间：FShutDownDate 
	 当前处理人：FProcessStaff 
	 产品序列号(废弃)：FSerialId 
	 发生部门：FOccDepartment  (必填项)
	 异常原因：FAssignableCause 
	 异常处理时长(分)：FDisposeTime 
	 呼叫类型：FCallType 
	 原因分析：FCauseAnalysis 
	 纠正措施：FCorreAct 
	 预防措施：FPrecaution 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_AlertBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCancelId":{"FUserID":""},"FApproveDate":"1900-01-01","FApproverId":{"FUserID":""},"FCancelDate":"1900-01-01","FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifyDate":"1900-01-01","FProdOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FEquipmentId":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FExpStatus":"","FSubMaterialId":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FOPSeqNumber":"","FMoRowNumber":"","FLot":{"FNumber":""},"FMoNumber":"","FOPOperNumber":"","FAlertTime":"1900-01-01","FCancelAlertTime":"1900-01-01","FUnitID":{"FNumber":""},"FFinishQty":0,"FBadQty":0,"FBaseUnitID":{"FNumber":""},"FBaseFinishQty":0,"FBaseBadQty":0,"FDataSource":"","FDescribe":"","FExpEmergStatus":"","FCurExpLevel":"","FQty":0,"FBaseQty":0,"FBadRate":0,"FExpType":{"FName":""},"FAlertPerson":{"FUSERACCOUNT":""},"FConfirmPerson":{"FSTAFFNUMBER":""},"FProcessName":{"FName":""},"FMoBillType":"","FMsgSendTime":"1900-01-01","FReplaceGroup":0,"FMOId":0,"FMOEntryId":0,"FOpPlanId":0,"FOpSeqEntryId":0,"FOpEntryId":0,"FAlertDescribe":"","FConclusion":"","FShutDownStatus":"false","FShutDownPerson":{"FUSERACCOUNT":""},"FShutDownDate":"1900-01-01","FProcessStaff":{"FSTAFFNUMBER":""},"FSerialId":{"FNUMBER":""},"FOccDepartment":{"FNUMBER":""},"FAssignableCause":{"FNumber":""},"FDisposeTime":0,"FCallType":"","FCauseAnalysis":"","FCorreAct":"","FPrecaution":"","FSupplierId":{"FNUMBER":""},"FIssueQty":0,"FSupplyLot":"","FSeverity":{"FNumber":""},"FOptPlanNo":"","FMtrlUnitID":{"FNumber":""},"FProcessStage":{"FNumber":""},"FHMITerminal":"","FEntity":[{"FEntryID":0,"FSerialType":"","FSerialId2":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SFC_AlertBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SFC_AlertBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SFC_AlertBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SFC_AlertBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SFC_AlertBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_AlertBill"}");

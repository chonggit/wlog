# 成本汇总表 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 成本汇总表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2495 |
...
client.GetSysReportData("ora_CostSummaryReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"F_XCKF_OrgId":{"FNumber":""},"F_XCKF_Period":"1900-01-01","F_XCKF_Product":[{"FNumber":""}],"F_XCKF_CostCenter":{"FNUMBER":""},"F_XCKF_ProPrderNo":"","F_XCKF_ProOrderSeq":0,"F_XCKF_StartPeriod":"1900-01-01","F_XCKF_EndPeriod":"1900-01-01"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_XCKF_StartPeriod": "1900-01-01",
        "F_XCKF_EndPeriod": "1900-01-01"
    }
}
...
五、字段说明：
	 ...
	 期间：F_XCKF_Period 
	 产品编码：F_XCKF_Product 
	 成本中心：F_XCKF_CostCenter 
	 生产订单号：F_XCKF_ProPrderNo 
	 生产订单行号：F_XCKF_ProOrderSeq 
	 起始期间：F_XCKF_StartPeriod 
	 截止期间：F_XCKF_EndPeriod 

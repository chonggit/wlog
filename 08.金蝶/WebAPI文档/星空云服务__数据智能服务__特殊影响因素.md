# 特殊影响因素 Web API 操作原始内容

> 来源页面：全部 > 星空云服务 > 数据智能服务 > 特殊影响因素
...
| 下推 | Push | 2336 |
| 整单关闭 | BillClose | 1706 |
| 作废 | StatusConvert | 1708 |
| 反关闭 | BillUnClose | 1708 |
| 批量保存 | BatchSave | 3066 |
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1477 |
| 分组信息查询 | QueryGroupInfo | 1190 |
| 分组删除 | GroupDelete | 1090 |
...
client.Delete("BDIP_SpecialInfluenceFactor","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BDIP_SpecialInfluenceFactor","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FFactorCategory":{"FNumber":""},"FCategory":{"FNumber":""},"FInfluenceFactorDesc":"","FSaleOrgId":{"FNumber":""},"FDeadDate":"1900-01-01","FRemark":"","FSpecialFactorEntry":[{"FENTRYID":0,"FOrgId":{"FNumber":""},"FSaleDeptId":{"FNUMBER":""},"FCustId":{"FNUMBER":""},"FCustomerGroup":{"FNumber":""},"FCustTypeId":{"FNumber":""},"FMaterialId":{"FNUMBER":""},"FMaterialGroupName":{"FNUMBER":""},"FInfluencingValue":0,"FAbsoluteFigure":0,"FEntryRemark":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FInfluenceFactorDesc": "",
        "FSaleOrgId": {
            "FNumber": ""
        },
        "FDeadDate": "1900-01-01",
        "FRemark": "",
        "FSpecialFactorEntry": [
            {
                "FENTRYID": 0,
...
基本信息：FBillHead 
	 ...
	 截止日期：FDeadDate  (必填项)
	 备注：FRemark 
	 影响因素描述：FInfluenceFactorDesc  (必填项)
	 因素类别：FFactorCategory  (必填项)
	 细分类别：FCategory 
影响范围：FSpecialFactorEntry 
	 实体主键：FENTRYID 
	 组织：FOrgId  (必填项)
	 销售部门：FSaleDeptId 
	 客户：FCustId 
	 ...
	 物料名称：FMATERIALNAME 
	 规格型号：FSPECIFICATION 
	 影响值%：FInfluencingValue 
	 绝对数值：FAbsoluteFigure 
	 备注：FEntryRemark 
	 客户类别：FCustTypeId 
	 客户分组：FCustomerGroup 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BDIP_SpecialInfluenceFactor","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FFactorCategory":{"FNumber":""},"FCategory":{"FNumber":""},"FInfluenceFactorDesc":"","FSaleOrgId":{"FNumber":""},"FDeadDate":"1900-01-01","FRemark":"","FSpecialFactorEntry":[{"FENTRYID":0,"FOrgId":{"FNumber":""},"FSaleDeptId":{"FNUMBER":""},"FCustId":{"FNUMBER":""},"FCustomerGroup":{"FNumber":""},"FCustTypeId":{"FNumber":""},"FMaterialId":{"FNUMBER":""},"FMaterialGroupName":{"FNUMBER":""},"FInfluencingValue":0,"FAbsoluteFigure":0,"FEntryRemark":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BDIP_SpecialInfluenceFactor","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BDIP_SpecialInfluenceFactor","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BDIP_SpecialInfluenceFactor","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BDIP_SpecialInfluenceFactor","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BDIP_SpecialInfluenceFactor","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("BDIP_SpecialInfluenceFactor","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BDIP_SpecialInfluenceFactor","BillClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.StatusConvert("BDIP_SpecialInfluenceFactor","StatusConvert","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BDIP_SpecialInfluenceFactor","BillUnClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BDIP_SpecialInfluenceFactor","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BDIP_SpecialInfluenceFactor"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("BDIP_SpecialInfluenceFactor","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("BDIP_SpecialInfluenceFactor","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("BDIP_SpecialInfluenceFactor","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

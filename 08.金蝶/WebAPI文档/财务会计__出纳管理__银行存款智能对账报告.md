# 银行存款智能对账报告 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 银行存款智能对账报告
...
client.Delete("CN_INTELLIGENTBLENDRPT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_INTELLIGENTBLENDRPT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_INTELLIGENTBLENDRPT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FExecuteDate":"1900-01-01","FOverview":"","FEntity":[{"FEntryID":0,"FBankAcntId":{"FNUMBER":""},"FCurrencyId":{"FNUMBER":""},"FRecordDebitAmount":0,"FRecordCreditAmount":0,"FTransDebitAmount":0,"FTransCreditAmount":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FRecordDebitAmount": 0,
                "FRecordCreditAmount": 0,
                "FTransDebitAmount": 0,
                "FTransCreditAmount": 0
            }
        ]
    }
}
...
单据体：FEntity 
	 ...
	 银行账号：FBankAcntId 
	 币别：FCurrencyId 
	 银行对账单借方金额：FRecordDebitAmount 
	 银行对账单贷方金额：FRecordCreditAmount 
	 银行存款流水账借方金额：FTransDebitAmount 
	 银行存款流水账贷方金额：FTransCreditAmount 
	 账号名称：FBankAcntName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_INTELLIGENTBLENDRPT","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_INTELLIGENTBLENDRPT"}");

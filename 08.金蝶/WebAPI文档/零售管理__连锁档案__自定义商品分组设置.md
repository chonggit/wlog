# 自定义商品分组设置 Web API 操作原始内容

> 来源页面：全部 > 零售管理 > 连锁档案 > 自定义商品分组设置
...
client.Delete("CMK_Cus_MaterialGroup","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CMK_Cus_MaterialGroup","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FOrgAffiliation":{"FNUMBER":""},"FIsApplyAllShop":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FEntity":[{"FEntryID":0,"FLevel":0,"FMATERIALGROUP":{"FNumber":""},"FShowSeq":0,"FGroupSubEntity":[{"FDetailID":0,"FMaterialId":{"FNUMBER":""},"FMaterialSeq":0}]}],"FBranchSetEntity":[{"FEntryID":0,"FChannelId":{"FNUMBER":""},"FBranchID":{"FNUMBER":""},"FIsSelected":"false","FParentId":"","FRowType":0,"FRowId":""}]}}");
...
物料分组单据体：FEntity 
	 实体主键：FEntryID 
	 分组：FMATERIALGROUP  (必填项)
	 显示序号：FShowSeq 
	 层级：FLevel 
商品信息子单据体：FGroupSubEntity 
	 实体主键：FDetailID 
	 物料显示序号：FMaterialSeq 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CMK_Cus_MaterialGroup","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FOrgAffiliation":{"FNUMBER":""},"FIsApplyAllShop":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FEntity":[{"FEntryID":0,"FLevel":0,"FMATERIALGROUP":{"FNumber":""},"FShowSeq":0,"FGroupSubEntity":[{"FDetailID":0,"FMaterialId":{"FNUMBER":""},"FMaterialSeq":0}]}],"FBranchSetEntity":[{"FEntryID":0,"FChannelId":{"FNUMBER":""},"FBranchID":{"FNUMBER":""},"FIsSelected":"false","FParentId":"","FRowType":0,"FRowId":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CMK_Cus_MaterialGroup","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CMK_Cus_MaterialGroup","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CMK_Cus_MaterialGroup","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CMK_Cus_MaterialGroup"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("CMK_Cus_MaterialGroup","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("CMK_Cus_MaterialGroup","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("CMK_Cus_MaterialGroup","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

# 盘点情况报表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 盘点情况报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2224 |
...
client.GetSysReportData("UNW_InventoryReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FBillNo":"","FStockCountNumber":"","FMaterialNumber":{"FNUMBER":""},"FOrgId":{"FNumber":""}}}");

...
client.Delete("BD_AccountBook","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_AccountBook","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_AccountBook","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FBOOKID":0,"FCreateOrgId":{"FNumber":""},"FCRTYEARPERIOD":"","FNumber":"","FAcctSystemID":{"FNumber":""},"FAccountOrgID":{"FNumber":""},"FSTARTPERIOD":"","FAcctPolicyID":{"FNumber":""},"FPeriodid":{"FNumber":""},"FName":"","FBOOKTYPE":"","FACCTTABLEID":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FRATETYPEID":{"FNumber":""},"FDefaultvoucherType":{"FVCHGROUPID":""},"FYEARANDPERIOD":"","FSTARTYEAR":"","FAPFinType":"","FARFinType":"","FCURRENTYEAR":0,"FCURRENTPERIOD":0,"F_XCKF_IsCostAccBook":"false","FEntity":[{"FADJUSTPERIODID":0,"FYEAR":"","FADJUSTNAME":""}]}}");
...
单据头：FBillHead 
	 ...
	 审核人：FAuditorID 
	 系统预置：FIsSysPreset 
	 默认凭证字：FDefaultvoucherType 
	 启用调整期：FUSEADJUSTPERIOD 
	 初始化状态：FINITIALSTATUS 
	 当前期间：FCURRENTPERIOD 
	 启用期间：FYEARANDPERIOD  (必填项)
	 当前年度：FCURRENTYEAR 
	 启用年度：FSTARTYEAR 
	 启用期间：FSTARTPERIOD 
	 当前期间：FCRTYEARPERIOD 
	 会计政策：FAcctPolicyID  (必填项)
	 核算组织：FAccountOrgID  (必填项)
	 财务应付确认方式：FAPFinType 
	 财务应收确认方式：FARFinType 
	 核算组织编码：FAccountOrgNumber 
	 成本模块默认账簿：F_XCKF_IsCostAccBook 
调整期间：FEntity 
	 实体主键：FADJUSTPERIODID 
	 会计年度：FYEAR  (必填项)
	 调整期间：FADJUSTPERIOD 
	 名称：FADJUSTNAME  (必填项)
	 说明：FCOMMENT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_AccountBook","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FBOOKID":0,"FCreateOrgId":{"FNumber":""},"FCRTYEARPERIOD":"","FNumber":"","FAcctSystemID":{"FNumber":""},"FAccountOrgID":{"FNumber":""},"FSTARTPERIOD":"","FAcctPolicyID":{"FNumber":""},"FPeriodid":{"FNumber":""},"FName":"","FBOOKTYPE":"","FACCTTABLEID":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FRATETYPEID":{"FNumber":""},"FDefaultvoucherType":{"FVCHGROUPID":""},"FYEARANDPERIOD":"","FSTARTYEAR":"","FAPFinType":"","FARFinType":"","FCURRENTYEAR":0,"FCURRENTPERIOD":0,"F_XCKF_IsCostAccBook":"false","FEntity":[{"FADJUSTPERIODID":0,"FYEAR":"","FADJUSTNAME":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_AccountBook","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_AccountBook","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_AccountBook","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_AccountBook","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_AccountBook","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_AccountBook","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_AccountBook"}");

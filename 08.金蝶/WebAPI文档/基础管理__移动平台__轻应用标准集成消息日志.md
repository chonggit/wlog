# 轻应用标准集成消息日志 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 移动平台 > 轻应用标准集成消息日志
...
client.Delete("MOB_StdIntMsgLog","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("MOB_StdIntMsgLog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FMsgType":"","FBizId":"","FIsSuccess":"","FMsgTime":"1900-01-01","FSendUserId":{"FUSERACCOUNT":""},"FMsgTitle":"","FSubTitle":"","FUrl":"","FPicUrl":"","FMsgContent":"","FTimestamp":"","FNonce":"","FOption":"","FMsgLogEntry":[{"FENTRYID":0,"FPlatformType":"","FEId":"","FMsgId":"","FEntryIsSuccess":"","FResultMsg":"","FResultCode":"","FInvalidUser":"","FSubEntry":[{"FDETAILID":0,"FReceiverUser":{"FUSERACCOUNT":""},"FOpenId":"","FReceiverIsSuccess":""}],"FStdIntMsgResendLog":[{"FDETAILID":0,"FResenddDate":"1900-01-01","FResendIsSuccess":"","FResendResultMsg":""}]}]}}");
...
明细信息：FMsgLogEntry 
	 ...
	 结果状态码：FResultCode 
	 无效用户：FInvalidUser 
	 是否发送成功：FEntryIsSuccess 
接收人：FSubEntry 
	 实体主键：FDETAILID 
	 用户：FReceiverUser 
	 集成平台用户ID：FOpenId 
	 是否发送成功：FReceiverIsSuccess 
重发记录：FStdIntMsgResendLog 
	 实体主键：FDETAILID 
	 重发时间：FResenddDate 
	 是否发送成功：FResendIsSuccess 
	 结果信息：FResendResultMsg 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("MOB_StdIntMsgLog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FMsgType":"","FBizId":"","FIsSuccess":"","FMsgTime":"1900-01-01","FSendUserId":{"FUSERACCOUNT":""},"FMsgTitle":"","FSubTitle":"","FUrl":"","FPicUrl":"","FMsgContent":"","FTimestamp":"","FNonce":"","FOption":"","FMsgLogEntry":[{"FENTRYID":0,"FPlatformType":"","FEId":"","FMsgId":"","FEntryIsSuccess":"","FResultMsg":"","FResultCode":"","FInvalidUser":"","FSubEntry":[{"FDETAILID":0,"FReceiverUser":{"FUSERACCOUNT":""},"FOpenId":"","FReceiverIsSuccess":""}],"FStdIntMsgResendLog":[{"FDETAILID":0,"FResenddDate":"1900-01-01","FResendIsSuccess":"","FResendResultMsg":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("MOB_StdIntMsgLog","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("MOB_StdIntMsgLog","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"MOB_StdIntMsgLog"}");

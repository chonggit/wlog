# 银行存款期初 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 银行存款期初
...
client.Delete("CN_BANKACNTBALINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_BANKACNTBALINIT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FPAYORGID":{"FNumber":""},"FDate":"1900-01-01","FISSAMEORG":"false","FSettleOrgId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FBankId":{"FNumber":""},"FBankAcntId":{"FNumber":""},"FINNERACCOUNTID":{"FNUMBER":""},"FCurrencyId":{"FNumber":""},"FYEARDEBITAMOUNT":0,"FYEARCREDITAMOUNT":0,"FEntAmount":0,"FBankAmount":0,"FISBALANCE":"","FEXCHANGERATE":0,"FYEARDEBITAMOUNTLOC":0,"FYEARCREDITAMOUNTLOC":0,"FEntAmountLoc":0,"FBankAmountLoc":0,"FNOREACHENTAMOUNTLOC":0,"FNOREACHBANKAMOUNTLOC":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FEntAmountLoc": 0,
                "FBankAmountLoc": 0,
                "FNOREACHENTAMOUNTLOC": 0,
                "FNOREACHBANKAMOUNTLOC": 0
            }
        ]
    }
}
...
银行存款期初明细：FEntity 
	 ...
	 银行方期初余额：FBankAmount 
	 余额方向：FDC 
	 企业未达金额合计：FNOREACHENTAMOUNT 
	 银行未达金额合计：FNOREACHBANKAMOUNT 
	 是否平衡：FISBALANCE  (必填项)
	 企业方本年收入累计：FYEARDEBITAMOUNT 
	 企业方本年支出累计：FYEARCREDITAMOUNT 
	 内部账号：FINNERACCOUNTID 
	 内部账户名称：FINNERACCOUNTNAME 
	 汇率：FEXCHANGERATE 
	 企业方本年收入累计本位币：FYEARDEBITAMOUNTLOC 
	 企业方本年支出累计本位币：FYEARCREDITAMOUNTLOC 
	 企业方期初余额本位币：FEntAmountLoc 
	 银行方期初余额本位币：FBankAmountLoc 
	 企业未达金额合计本位币：FNOREACHENTAMOUNTLOC 
	 银行未达金额合计本位币：FNOREACHBANKAMOUNTLOC 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_BANKACNTBALINIT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FPAYORGID":{"FNumber":""},"FDate":"1900-01-01","FISSAMEORG":"false","FSettleOrgId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FBankId":{"FNumber":""},"FBankAcntId":{"FNumber":""},"FINNERACCOUNTID":{"FNUMBER":""},"FCurrencyId":{"FNumber":""},"FYEARDEBITAMOUNT":0,"FYEARCREDITAMOUNT":0,"FEntAmount":0,"FBankAmount":0,"FISBALANCE":"","FEXCHANGERATE":0,"FYEARDEBITAMOUNTLOC":0,"FYEARCREDITAMOUNTLOC":0,"FEntAmountLoc":0,"FBankAmountLoc":0,"FNOREACHENTAMOUNTLOC":0,"FNOREACHBANKAMOUNTLOC":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_BANKACNTBALINIT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_BANKACNTBALINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_BANKACNTBALINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_BANKACNTBALINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_BANKACNTBALINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_BANKACNTBALINIT","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_BANKACNTBALINIT"}");

# 信用检查规则 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 信用管理 > 信用检查规则
...
client.Delete("CRE_CheckRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRE_CheckRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRE_CheckRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FDescription":"","FIsDefault":"false","FEntity":[{"FEntryID":0,"FBillFormId":"","FBillTypeId":{"FNumber":""},"FCheckPoint":"","FControlLevel":"","FUpdateAmount":"false","FCheckAmount":"false","FCreditRate":"false","FLimitAmount":"false","FOverDays":"false","FOverAmount":"false","FOverArrate":"false","FJudgeTerm":"","FAdjustFactor":0,"FPressussBatch":"false","FMonthlyBalance":"false"}]}}");
        ...
        "FEntity": [
            {
                ...
                "FJudgeTerm": "",
                "FAdjustFactor": 0,
                "FPressussBatch": "false",
                "FMonthlyBalance": "false"
            }
        ]
    }
}
...
基本信息：FBillHead 
	 ...
	 默认规则：FIsDefault 
	 是否预设：FIsSysyPreset 
	 是否列表不可见：FListDisable 
规则明细：FEntity 
	 实体主键：FEntryID 
	 单据名称：FBillFormId  (必填项)
	 单据类型：FBillTypeId  (必填项)
	 检查及更新时点：FCheckPoint  (必填项)
	 控制强度：FControlLevel  (必填项)
	 更新信用额度：FUpdateAmount 
	 检查信用额度：FCheckAmount 
	 检查信用比例：FCreditRate 
	 检查单笔限额：FLimitAmount 
	 检查逾期天数：FOverDays 
	 检查逾期额度：FOverAmount 
	 检查逾期比例：FOverArrate 
	 超标判断依据：FJudgeTerm  (必填项)
	 信用额度调节系数%：FAdjustFactor 
	 压批控制：FPressussBatch 
	 月结控制：FMonthlyBalance 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRE_CheckRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FDescription":"","FIsDefault":"false","FEntity":[{"FEntryID":0,"FBillFormId":"","FBillTypeId":{"FNumber":""},"FCheckPoint":"","FControlLevel":"","FUpdateAmount":"false","FCheckAmount":"false","FCreditRate":"false","FLimitAmount":"false","FOverDays":"false","FOverAmount":"false","FOverArrate":"false","FJudgeTerm":"","FAdjustFactor":0,"FPressussBatch":"false","FMonthlyBalance":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CRE_CheckRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CRE_CheckRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CRE_CheckRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CRE_CheckRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CRE_CheckRule","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRE_CheckRule"}");

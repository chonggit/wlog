# 受托加工材料清单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 受托加工材料清单
...
client.Save("SAL_OEMBOM","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FAuxPropIDHead":{"FAUXPROPIDHEAD__FF100001":{"FNumber":""},"FAUXPROPIDHEAD__FF100002":{"FNumber":""},"FAUXPROPIDHEAD__FF100003":{"FNumber":""},"FAUXPROPIDHEAD__FF100005":{"FNumber":""},"FAUXPROPIDHEAD__FF100010":{"FNumber":""},"FAUXPROPIDHEAD__FF100007":{"FNumber":""},"FAUXPROPIDHEAD__FF100008":{"FNumber":""}},"FStockOrgId":{"FNumber":""},"FDescription":"","FCustId":{"FNUMBER":""},"FMtoNo":"","FDeliveryDate":"1900-01-01","FSaleOrderId":0,"FSaleOrderEntryId":0,"FIsUseOEMBomPush":"false","FStockBaseQty":0,"FEntity":[{"FEntryID":0,"FMaterialID2":{"FNumber":""},"FErpClsID":"","FAuxPropID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FMaterialType":"","FNumerator":0,"FDenominator":0,"FUnitID2":{"FNumber":""},"FFixScrapQty":0,"FScrapRate":0,"FIssueType":"","FBaseUnitID1":{"FNumber":""},"FBaseQty":0,"FChildStockOrgId":{"FNumber":""},"FMEMO":"","FIsSkip":"false","FBomId2":{"FNumber":""},"FStockStatusId":{"FNUMBER":""},"FStockID":{"FNumber":""},"FStockLOCID":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FMtoNo2":"","FLot":{"FNumber":""},"FAuxUnitQty":0,"FExtAuxUnitQty":0,"FExtAuxUnitId":{"FNumber":""},"FUnReceiveQty":0,"FUnInStockQty":0,"FUnInStockBaseQty":0,"FUnReceiveBaseQty":0,"FInStockQty":0,"FBaseJoinQty":0,"FJoinQty":0,"FInStockBaseQty":0,"FReceiveBaseQty":0,"FReceiveQty":0,"FBaseFixScrapQTY":0,"FBaseNumerator":0,"FBASEDENOMINATOR":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FBillNo": "",
        "FAuxPropIDHead": {
            "FAUXPROPIDHEAD__FF100001": {
                "FNumber": ""
            },
            "FAUXPROPIDHEAD__FF100002": {
                "FNumber": ""
            },
            "FAUXPROPIDHEAD__FF100003": {
                "FNumber": ""
            },
            "FAUXPROPIDHEAD__FF100005": {
                "FNumber": ""
            },
            "FAUXPROPIDHEAD__FF100010": {
                "FNumber": ""
            },
            "FAUXPROPIDHEAD__FF100007": {
                "FNumber": ""
            },
            "FAUXPROPIDHEAD__FF100008": {
                "FNumber": ""
            }
        },
        "FStockOrgId": {
...
单据头：FBillHead 
	 ...
	 产品库存单位数量：FStockQty 
	 销售订单编号：FSaleOrderNO 
	 销售订单行号：FSaleOrderEntrySeq 
	 产品库存单位：FStockUnitID 
	 产品库存组织：FStockOrgId  (必填项)
	 辅助属性：FAuxPropIDHead 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
...
子项明细：FEntity 
	 ...
	 BOM分录内码：FBOMEntryID 
	 项次：FReplaceGroup 
	 子项物料编码：FMaterialID2  (必填项)
	 子项物料名称：FMaterialName1 
	 规格型号：FMaterialModel1 
	 ...
	 仓库：FStockID 
	 BOM版本：FBomId2 
	 标准用量(基本单位)：FBaseStdQty 
	 基本单位：FBaseUnitID1 
	 子项单位：FUnitID2  (必填项)
	 分子：FNumerator 
	 分母：FDenominator 
	 分子(基本单位)：FBaseNumerator 
	 辅助属性：FAuxPropID 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 ...
	 固定损耗：FFixScrapQty 
	 批号：FLot 
	 固定损耗数量(基本单位)：FBaseFixScrapQTY 
	 分母(基本单位)：FBASEDENOMINATOR 
	 库存状态：FStockStatusId 
	 跳层：FIsSkip 
	 物料属性：FErpClsID 
	 子项数量：FQty 
	 用量类型：FDosageType 
	 库存辅单位：FAuxUnitID 
	 子项数量(库存辅单位)：FAuxUnitQty 
	 辅单位：FExtAuxUnitId 
	 子项数量(辅单位)：FExtAuxUnitQty 
	 子项数量(基本单位)：FBaseQty 
	 计划跟踪号：FMtoNo2 
	 未收料数量：FUnReceiveQty 
	 未入库数量：FUnInStockQty 
	 未收料数量(基本单位)：FUnReceiveBaseQty 
	 未入库数量(基本单位)：FUnInStockBaseQty 
	 已入库数量：FInStockQty 
	 已入库数量(基本单位)：FInStockBaseQty 
	 已收料数量：FReceiveQty 
	 已收料数量(基本单位)：FReceiveBaseQty 
	 关联数量(基本单位)：FBaseJoinQty 
	 关联数量(库存辅单位)：FJoinQty 
	 发料方式：FIssueType 
	 BOM级次：FBOMLevel 
	 排序序号：FDetailSeq 
	 库存组织：FChildStockOrgId 
	 备注：FMEMO 
关联关系表：FEntity_Link 
	 实体主键：FLinkId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SAL_OEMBOM","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SAL_OEMBOM","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SAL_OEMBOM","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SAL_OEMBOM","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SAL_OEMBOM","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("SAL_OEMBOM","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("SAL_OEMBOM","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SAL_OEMBOM"}");

# 单据条码清单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 单据条码清单
...
client.Delete("UN_BillBarcodeList","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_BillBarcodeList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FBarCodeBillBarList":"","FBillEntryId":"","FBillId":"","FBillFromId":"","FSCANCONFIGID":"","FScanConfig":"","FEntity":[{"FEntryID":0,"FBarCodeEntity":"","FPackCode":"","FQty":0,"FMaterialId":{"FNUMBER":""},"FAuxrpopId":{"FAUXRPOPID__FF100001":{"FNumber":""},"FAUXRPOPID__FF100002":{"FNumber":""},"FAUXRPOPID__FF100003":{"FNumber":""},"FAUXRPOPID__FF100005":{"FNumber":""},"FAUXRPOPID__FF100010":{"FNumber":""},"FAUXRPOPID__FF100007":{"FNumber":""},"FAUXRPOPID__FF100008":{"FNumber":""}},"FProductionDate":"1900-01-01","FExpirationDate":"1900-01-01","FScanTime":"1900-01-01","FScanUserId":{"FUserID":""},"FIsSend":"false","FLot":{"FNumber":""}}]}}");
        ...
        "FEntity": [
            {
                ...
                "FAuxrpopId": {
                    "FAUXRPOPID__FF100001": {
                        "FNumber": ""
                    },
                    "FAUXRPOPID__FF100002": {
                        "FNumber": ""
                    },
                    "FAUXRPOPID__FF100003": {
                        "FNumber": ""
                    },
                    "FAUXRPOPID__FF100005": {
                        "FNumber": ""
                    },
                    "FAUXRPOPID__FF100010": {
                        "FNumber": ""
                    },
                    "FAUXRPOPID__FF100007": {
                        "FNumber": ""
                    },
                    "FAUXRPOPID__FF100008": {
                        "FNumber": ""
                    }
                },
                "FProductionDate": "1900-01-01",
                "FExpirationDate": "1900-01-01",
                "FScanTime": "1900-01-01",
                "FScanUserId": {
                    "FUserID": ""
                },
                "FIsSend": "false",
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_BillBarcodeList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FBarCodeBillBarList":"","FBillEntryId":"","FBillId":"","FBillFromId":"","FSCANCONFIGID":"","FScanConfig":"","FEntity":[{"FEntryID":0,"FBarCodeEntity":"","FPackCode":"","FQty":0,"FMaterialId":{"FNUMBER":""},"FAuxrpopId":{"FAUXRPOPID__FF100001":{"FNumber":""},"FAUXRPOPID__FF100002":{"FNumber":""},"FAUXRPOPID__FF100003":{"FNumber":""},"FAUXRPOPID__FF100005":{"FNumber":""},"FAUXRPOPID__FF100010":{"FNumber":""},"FAUXRPOPID__FF100007":{"FNumber":""},"FAUXRPOPID__FF100008":{"FNumber":""}},"FProductionDate":"1900-01-01","FExpirationDate":"1900-01-01","FScanTime":"1900-01-01","FScanUserId":{"FUserID":""},"FIsSend":"false","FLot":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UN_BillBarcodeList","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("UN_BillBarcodeList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("UN_BillBarcodeList","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("UN_BillBarcodeList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("UN_BillBarcodeList","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_BillBarcodeList"}");

# 营销费用申请单 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 营销费用管理 > 营销费用申请单
...
client.Delete("MEM_FeeRequest","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("MEM_FeeRequest","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FApplyDepId":{"FNUMBER":""},"FSettleCUSTId":{"FNUMBER":""},"FPayway":{"FNUMBER":""},"FExecStatus":"","FReimburseStatus":"","FFreezeStatus":"","FFreezeDate":"1900-01-01","FReason":"","FCurrencyId":{"FNUMBER":""},"FMinStartTime":"1900-01-01","FMaxEndTime":"1900-01-01","FApplyORGId":{"FNumber":""},"FCreateTime":"1900-01-01","FModifier":{"FUserID":""},"FModifyTime":"1900-01-01","FBillTypeID":{"FNUMBER":""},"FFeeTypeID":{"FFEETYPECODE":""},"FCreator":{"FUSERNAME":""},"FRepaymentDate":"1900-01-01","FIsBorrow":"false","FPayTypeId":{"FNUMBER":""},"FCNBankId":{"FNUMBER":""},"FERBillId":0,"FEntity":[{"FEntryID":0,"FExecChannelID":{"FNUMBER":""},"FChannelSquare":"","FMaterialId":{"FNUMBER":""},"FGoodsId":{"FGOODSNUMBER":""},"FDisplayType":"","FDisplayArea":"","FQty":0,"FBaseQty":0,"FPrice":0,"FApplyAmount":0,"FStartTime":"1900-01-01","FEndTime":"1900-01-01","FHasPromotion":"false","FPromotionPrice":0,"FTheme":"","FPromotionAddr":"","FContractRate":0,"FEstiSaleVol":0,"FRealSaleVol":0,"FReachRate":0,"FLosRate":0,"FRemark":"","FSize":"","FReimbursedAmount":0,"FApprovedAmount":0,"FUnApprovedAmount":0,"FHasGoods":"","FActualBorrowAmount":0,"FOffsetAmount":0,"FAutoMatchAmount":0,"FAppWriteoffAmount":0,"FBorrowRemainAmount":0,"FRefundAmount":0,"FSubEntity":[{"FDETAILID":0,"FSubGoodsId":{"FNUMBER":""},"FSubMaterialId":{"FNUMBER":""},"FSubQty":0,"FSubBaseQty":0,"FSubUnitId":{"FNumber":""},"FBaseUnitId":{"FNumber":""},"FSubRemark":"","FLinkedQty":0,"FLinkedBaseQty":0}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FMinStartTime": "1900-01-01",
        "FMaxEndTime": "1900-01-01",
        "FApplyORGId": {
            "FNumber": ""
        },
        ...
        "FEntity": [
            {
                ...
                "FUnApprovedAmount": 0,
                "FHasGoods": "",
                "FActualBorrowAmount": 0,
                "FOffsetAmount": 0,
                "FAutoMatchAmount": 0,
                "FAppWriteoffAmount": 0,
                "FBorrowRemainAmount": 0,
                "FRefundAmount": 0,
                "FSubEntity": [
                    {
                        "FDETAILID": 0,
...
单据头：FBillHead 
	 ...
	 付款组织：FPayOrg 
	 财务申请单ID：FERBillId 
	 一级审批处理意见：FAuditOpinions1 
	 二级审批处理意见：FAuditOpinions2 
	 三级审批处理意见：FAuditOpinions3 
明细信息：FEntity 
	 实体主键：FEntryID 
	 执行渠道：FExecChannelID 
	 商品：FGoodsId 
	 ...
	 陈列面积：FDisplayArea 
	 形象尺寸：FSize 
	 已报销金额：FReimbursedAmount 
	 已核准金额：FApprovedAmount 
	 未核准金额：FUnApprovedAmount 
	 规则型号：FSpecification 
	 渠道编码：FChannelCode 
	 渠道类型：FChannelType 
	 渠道地区：FChannelArea 
	 ...
	 已核销金额：FAppWriteoffAmount 
	 借款余额：FBorrowRemainAmount 
	 已退款金额：FRefundAmount 
子单据体：FSubEntity 
	 实体主键：FDETAILID 
	 商品名称：FSubGoodsId 
	 ...
	 申请基本数量：FSubBaseQty 
	 计量单位：FSubUnitId 
	 商品编码：F_KDD_BaseProperty 
	 物料编码：F_KDD_BaseProperty1 
	 已关联数量：FLinkedQty 
	 已关联基本单位数量：FLinkedBaseQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("MEM_FeeRequest","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FApplyDepId":{"FNUMBER":""},"FSettleCUSTId":{"FNUMBER":""},"FPayway":{"FNUMBER":""},"FExecStatus":"","FReimburseStatus":"","FFreezeStatus":"","FFreezeDate":"1900-01-01","FReason":"","FCurrencyId":{"FNUMBER":""},"FMinStartTime":"1900-01-01","FMaxEndTime":"1900-01-01","FApplyORGId":{"FNumber":""},"FCreateTime":"1900-01-01","FModifier":{"FUserID":""},"FModifyTime":"1900-01-01","FBillTypeID":{"FNUMBER":""},"FFeeTypeID":{"FFEETYPECODE":""},"FCreator":{"FUSERNAME":""},"FRepaymentDate":"1900-01-01","FIsBorrow":"false","FPayTypeId":{"FNUMBER":""},"FCNBankId":{"FNUMBER":""},"FERBillId":0,"FEntity":[{"FEntryID":0,"FExecChannelID":{"FNUMBER":""},"FChannelSquare":"","FMaterialId":{"FNUMBER":""},"FGoodsId":{"FGOODSNUMBER":""},"FDisplayType":"","FDisplayArea":"","FQty":0,"FBaseQty":0,"FPrice":0,"FApplyAmount":0,"FStartTime":"1900-01-01","FEndTime":"1900-01-01","FHasPromotion":"false","FPromotionPrice":0,"FTheme":"","FPromotionAddr":"","FContractRate":0,"FEstiSaleVol":0,"FRealSaleVol":0,"FReachRate":0,"FLosRate":0,"FRemark":"","FSize":"","FReimbursedAmount":0,"FApprovedAmount":0,"FUnApprovedAmount":0,"FHasGoods":"","FActualBorrowAmount":0,"FOffsetAmount":0,"FAutoMatchAmount":0,"FAppWriteoffAmount":0,"FBorrowRemainAmount":0,"FRefundAmount":0,"FSubEntity":[{"FDETAILID":0,"FSubGoodsId":{"FNUMBER":""},"FSubMaterialId":{"FNUMBER":""},"FSubQty":0,"FSubBaseQty":0,"FSubUnitId":{"FNumber":""},"FBaseUnitId":{"FNumber":""},"FSubRemark":"","FLinkedQty":0,"FLinkedBaseQty":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("MEM_FeeRequest","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("MEM_FeeRequest","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("MEM_FeeRequest","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("MEM_FeeRequest","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("MEM_FeeRequest","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("MEM_FeeRequest","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("MEM_FeeRequest","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"MEM_FeeRequest"}");

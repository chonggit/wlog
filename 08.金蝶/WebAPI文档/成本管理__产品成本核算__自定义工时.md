# 自定义工时 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 自定义工时
...
client.Delete("ora_CustomWorkHours","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ora_CustomWorkHours","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_XCKF_Org":{"FNumber":""},"F_XCKF_Period":"1900-01-01","F_ora_CreatorId_h1g":{"FUserID":""},"F_ora_CreateDate_zc5":"1900-01-01","F_ora_ModifierId_imu":{"FUserID":""},"F_ora_ModifyDate_1xj":"1900-01-01","F_XCKF_Department":{"FNUMBER":""},"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"F_XCKF_ProductionOrderNo":"","F_XCKF_ProductionOrderSeq":"","F_XCKF_Product":{"FNUMBER":""},"F_XCKF_SettlementQty":0,"F_XCKF_UnitWorkingHours":0,"F_XCKF_CostObject":{"FNUMBER":""},"F_XCKF_WorkingHoursTotal":0,"F_XCKF_WorkHoursWeight":0}],"F_XCKF_CustomWorkHoursSum":[{"FEntryID":0,"F_XCKF_Sum_CostObject":{"FNUMBER":""},"F_XCKF_Sum_ProductionNo":"","F_XCKF_Sum_ProductionSeq":"","F_XCKF_Sum_Product":{"FNUMBER":""},"F_XCKF_Sum_WorkHoursTotal":0,"F_XCKF_Sum_WorkHoursWeight":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_ora_CreateDate_zc5": "1900-01-01",
        "F_ora_ModifierId_imu": {
            "FUserID": ""
        },
        "F_ora_ModifyDate_1xj": "1900-01-01",
        "F_XCKF_Department": {
            "FNUMBER": ""
        },
        "FApproverId": {
        ...
        "FEntity": [
            {
                "FEntryID": 0,
                "F_XCKF_ProductionOrderNo": "",
                "F_XCKF_ProductionOrderSeq": "",
                "F_XCKF_Product": {
                    "FNUMBER": ""
                },
                "F_XCKF_SettlementQty": 0,
                "F_XCKF_UnitWorkingHours": 0,
                "F_XCKF_CostObject": {
                    "FNUMBER": ""
                },
                "F_XCKF_WorkingHoursTotal": 0,
                "F_XCKF_WorkHoursWeight": 0
            }
        ],
        "F_XCKF_CustomWorkHoursSum": [
            {
                "FEntryID": 0,
                "F_XCKF_Sum_CostObject": {
                    "FNUMBER": ""
                },
                "F_XCKF_Sum_ProductionNo": "",
                "F_XCKF_Sum_ProductionSeq": "",
                "F_XCKF_Sum_Product": {
                    "FNUMBER": ""
                },
                "F_XCKF_Sum_WorkHoursTotal": 0,
                "F_XCKF_Sum_WorkHoursWeight": 0
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 组织：F_XCKF_Org  (必填项)
	 期间：F_XCKF_Period  (必填项)
	 创建人：F_ora_CreatorId_h1g 
	 创建日期：F_ora_CreateDate_zc5 
	 修改人：F_ora_ModifierId_imu 
	 修改日期：F_ora_ModifyDate_1xj 
	 生产车间：F_XCKF_Department 
	 审核人：FApproverId 
	 审核日期：FApproveDate 
单据体明细：FEntity 
	 实体主键：FEntryID 
	 生产订单编号：F_XCKF_ProductionOrderNo  (必填项)
	 生产订单行号：F_XCKF_ProductionOrderSeq  (必填项)
	 产品编码：F_XCKF_Product  (必填项)
	 交收数量：F_XCKF_SettlementQty 
	 单位工时：F_XCKF_UnitWorkingHours 
	 成本对象：F_XCKF_CostObject  (必填项)
	 总工时：F_XCKF_WorkingHoursTotal 
	 产品名称：F_ora_BaseProperty_qtr 
	 工时权重：F_XCKF_WorkHoursWeight 
按工序汇总：F_XCKF_CustomWorkHoursSum 
	 实体主键：FEntryID 
	 费用分配标准（工序）：F_XCKF_Sum_CostObject 
	 工单编号：F_XCKF_Sum_ProductionNo 
	 工单行号：F_XCKF_Sum_ProductionSeq 
	 产品编码：F_XCKF_Sum_Product 
	 总工时：F_XCKF_Sum_WorkHoursTotal 
	 工时权重：F_XCKF_Sum_WorkHoursWeight 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ora_CustomWorkHours","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_XCKF_Org":{"FNumber":""},"F_XCKF_Period":"1900-01-01","F_ora_CreatorId_h1g":{"FUserID":""},"F_ora_CreateDate_zc5":"1900-01-01","F_ora_ModifierId_imu":{"FUserID":""},"F_ora_ModifyDate_1xj":"1900-01-01","F_XCKF_Department":{"FNUMBER":""},"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"F_XCKF_ProductionOrderNo":"","F_XCKF_ProductionOrderSeq":"","F_XCKF_Product":{"FNUMBER":""},"F_XCKF_SettlementQty":0,"F_XCKF_UnitWorkingHours":0,"F_XCKF_CostObject":{"FNUMBER":""},"F_XCKF_WorkingHoursTotal":0,"F_XCKF_WorkHoursWeight":0}],"F_XCKF_CustomWorkHoursSum":[{"FEntryID":0,"F_XCKF_Sum_CostObject":{"FNUMBER":""},"F_XCKF_Sum_ProductionNo":"","F_XCKF_Sum_ProductionSeq":"","F_XCKF_Sum_Product":{"FNUMBER":""},"F_XCKF_Sum_WorkHoursTotal":0,"F_XCKF_Sum_WorkHoursWeight":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ora_CustomWorkHours","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ora_CustomWorkHours","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ora_CustomWorkHours","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ora_CustomWorkHours","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ora_CustomWorkHours","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("ora_CustomWorkHours","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ora_CustomWorkHours","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ora_CustomWorkHours"}");

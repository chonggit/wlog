# 收付内部账户期初 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 收付内部账户期初
...
client.Delete("CN_INNERACTINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_INNERACTINIT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FFundsOrgID":{"FNumber":""},"FPAYORGID":{"FNumber":""},"FINNERACTINITENTITY":[{"FEntryID":0,"FINNERACCOUNTID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FYEARDEBITAMOUNT":0,"FYEARCREDITAMOUNT":0,"FINITAMOUNT":0,"FSOURCETYPE":"","FSRCBILLNO":"","FEXCHANGERATE":0,"FYEARDEBITAMOUNTLOC":0,"FYEARCREDITAMOUNTLOC":0,"FINITAMOUNTLOC":0}]}}");
        ...
        "FINNERACTINITENTITY": [
            {
                ...
                "FSRCBILLNO": "",
                "FEXCHANGERATE": 0,
                "FYEARDEBITAMOUNTLOC": 0,
                "FYEARCREDITAMOUNTLOC": 0,
                "FINITAMOUNTLOC": 0
            }
        ]
    }
...
单据头：FBillHead 
	 ...
	 本位币：FMAINBOOKID 
	 汇率类型：FEXCHANGETYPE 
单据体：FINNERACTINITENTITY 
	 实体主键：FEntryID 
	 内部账户：FINNERACCOUNTID  (必填项)
	 内部账户名称：FINNERACCOUNTNAME 
	 币别：FCURRENCYID  (必填项)
	 本年收入累计：FYEARDEBITAMOUNT 
	 本年支出累计：FYEARCREDITAMOUNT 
	 期初余额：FINITAMOUNT 
	 源单类型：FSOURCETYPE 
	 源单编号：FSRCBILLNO 
	 汇率：FEXCHANGERATE 
	 本年累计收入本位币：FYEARDEBITAMOUNTLOC 
	 本年支出累计本位币：FYEARCREDITAMOUNTLOC 
	 期初余额本位币：FINITAMOUNTLOC 
关联关系表：FINNERACTINITENTITY_Link 
	 实体主键：FLinkId 
	 业务流程图：FINNERACTINITENTITY_Link_FFlowId 
	 推进路线：FINNERACTINITENTITY_Link_FFlowLineId 
	 转换规则：FINNERACTINITENTITY_Link_FRuleId 
	 源单表内码：FINNERACTINITENTITY_Link_FSTableId 
	 源单表：FINNERACTINITENTITY_Link_FSTableName 
	 源单内码：FINNERACTINITENTITY_Link_FSBillId 
	 源单分录内码：FINNERACTINITENTITY_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_INNERACTINIT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FFundsOrgID":{"FNumber":""},"FPAYORGID":{"FNumber":""},"FINNERACTINITENTITY":[{"FEntryID":0,"FINNERACCOUNTID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FYEARDEBITAMOUNT":0,"FYEARCREDITAMOUNT":0,"FINITAMOUNT":0,"FSOURCETYPE":"","FSRCBILLNO":"","FEXCHANGERATE":0,"FYEARDEBITAMOUNTLOC":0,"FYEARCREDITAMOUNTLOC":0,"FINITAMOUNTLOC":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_INNERACTINIT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_INNERACTINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_INNERACTINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_INNERACTINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_INNERACTINIT","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_INNERACTINIT","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_INNERACTINIT"}");

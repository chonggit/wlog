# 销售发票账龄分析表 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 销售发票账龄分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3173 |
...
client.GetSysReportData("IV_SalesAgingAnalysis","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAffiliation":{"FNAME":""},"FCurrencyId":{"FNumber":""},"FDate":"1900-01-01","FSettleOrgIdList":"","FBusinessDate":"","FByBill":"false","FIncludeUnAudit":"false","FCalStandardRadioGroup":"","FInvoiceDate":"","FCustomerIdTo":{"FNUMBER":""},"FCustomerIdFrom":{"FNUMBER":""},"FAgingGroupSetting":[{"FSection":"","FDays":0}]}}");

# 净值重分类方案 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 报表 > 净值重分类方案
...
client.Delete("KDS_RecategorizeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("KDS_RecategorizeScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("KDS_RecategorizeScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FPositiveItem":{"FNUMBER":""},"FNegativeItem":{"FNUMBER":""},"FAcctTableId":{"FNumber":""},"FAcctFormula":"","FItemDataType":[{"FNumber":""}],"FAcctId":{"FNUMBER":""},"FMainDime":"","FDimensionEntity":[{"FENTRYID":0,"FDimeItem":{"FNUMBER":""},"FDimeValueFrom":"","FDimeValueTo":""}],"FDataTypeToFetchType":[{"FEntryID":0,"FEItemDataType":{"FNUMBER":""},"FFetchType":""}],"FDimensionMap":[{"FEntryID":0,"FDimeFrom":{"FNUMBER":""},"FDimeTo":{"FNUMBER":""},"FDimeToFieldName":"","FDimeToField":""}]}}");
...
基本：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 描述：FDescription 
	 净值正数：FPositiveItem  (必填项)
	 净值负数：FNegativeItem  (必填项)
	 科目表：FAcctTableId 
	 科目表达式：FAcctFormula  (必填项)
...
维度：FDimensionEntity 
	 实体主键：FENTRYID 
	 核算维度：FDimeItem 
	 维度编码(从)：FDimeValueFrom 
	 维度编码(至)：FDimeValueTo 
数据类型取数类型对应关系：FDataTypeToFetchType 
	 实体主键：FEntryID 
	 项目数据类型：FEItemDataType 
	 Acct取数类型：FFetchType 
维度映射：FDimensionMap 
	 实体主键：FEntryID 
	 主维度：FDimeFrom 
	 关联维度：FDimeTo 
	 关联维度对应字段：FDimeToFieldName 
	 关联维度ID：FDimeToField 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("KDS_RecategorizeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("KDS_RecategorizeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("KDS_RecategorizeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("KDS_RecategorizeScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("KDS_RecategorizeScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("KDS_RecategorizeScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"KDS_RecategorizeScheme"}");

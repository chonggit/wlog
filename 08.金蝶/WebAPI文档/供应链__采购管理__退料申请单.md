# 退料申请单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 退料申请单
...
client.Delete("PUR_MRAPP","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_MRAPP","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBusinessType":"","FBillNo":"","FDate":"1900-01-01","FAPPORGID":{"FNumber":""},"FAPPDEPTID":{"FNumber":""},"FRequireOrgId":{"FNumber":""},"FRMTYPE":"","FRMMODE":"","FRMLOC":"","FCorrespondOrgId":{"FNumber":""},"FRMREASON":{"FNumber":""},"FPURCHASEORGID":{"FNumber":""},"FSUPPLIERID":{"FNumber":""},"FRemarks":"","FConfirmerId":{"FUserID":""},"FConfirmDate":"1900-01-01","FApplicantId":{},"F_SubEntity_FIN":{"FENTRYID":0,"FSettleTypeId":{"FNumber":""},"FLOCALCURRID":{"FNumber":""},"FExchangeTypeId":{"FNUMBER":""},"FPriceListId":{"FNUMBER":""},"FISPRICEEXCLUDETAX":"false"},"FEntity":[{"FEntryID":0,"FMtoNo":"","FMATERIALID":{"FNumber":""},"FUNITID":{"FNumber":""},"FMRAPPQTY":0,"FPRICEUNITID_F":{"FNumber":""},"FREPLENISHQTY":0,"FKEAPAMTQTY":0,"FRMREASON_M":{"FNumber":""},"FGiveAway":"false","FNOTE_M":"","FSupMatId":"","FSupMatName":"","FBOMID":{"FNumber":""},"FLot":{"FNumber":""},"FPRICECOEFFICIENT_F":0,"FPRICE_F":0,"FEntryTaxRate":0,"FDISCOUNTRATE_F":0,"FTAXNETPRICE_F":0,"FSRCBILLTYPEID":"","FSRCBILLNO":"","FBFLowId":{"FName":""},"FPriceBaseQty":0,"FPURUNITID":{"FNumber":""},"FPurQty":0,"FPurBaseQty":0,"FENTRYPRICELISTID":{"FNUMBER":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FStockId":{"FNUMBER":""},"F_CGDDH":"","FPriceDiscount":0,"F_JHRQ":"","FSTOCKLOCID":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FSUBREQBILLNO":"","FSUBREQBILLSEQ":0,"FSUBREQENTRYID":0}]}}");
...
基本信息：FBillHead 
	 ...
	 确认状态：FConfirmStatus 
	 申请人：FApplicantId 
财务（表头财务）：F_SubEntity_FIN 
	 实体主键：FENTRYID 
	 金额：FBILLAMOUNT 
	 币别：FLOCALCURRID  (必填项)
	 结算组织：FSettleTypeId  (必填项)
...
明细信息：FEntity 
	 ...
	 计价数量：FPRICEQTY_F 
	 单价：FPRICE_F 
	 价格系数：FPRICECOEFFICIENT_F 
	 折扣率：FDISCOUNTRATE_F 
	 折扣额：FDISCOUNT_F 
	 净价：FTAXNETPRICE_F 
	 退料金额：FAMOUNT_F 
	 退料含税金额：FALLAMOUNT_F 
	 含税单价：FAPPROVEPRICE_F 
	 源单行号：FSRCSEQ 
	 合同单号：FCONTRACTNO 
	 订单单号：FORDERNO 
	 需求跟踪号：FREQTRACENO 
	 库存基本数量：FBASEUNITQTY 
	 退料申请基本单位：FBASEUNITID 
	 库存单位：FUNITID  (必填项)
	 计价单位：FPRICEUNITID_F  (必填项)
	 退料关联数量（库存基本）：FBASEMRJOINQTY 
	 退料数量(基本单位)：FBASEMRQTY 
	 辅助属性：FAUXPROPID 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 ...
	 税率%：FEntryTaxRate 
	 分录价目表：FENTRYPRICELISTID 
	 采购订单分录内码：FPOORDERENTRYID 
	 仓库：FStockId 
	 是否同步管易(GY)：FISSYNTOTHIRD 
	 产品类型：FRowType 
	 父项产品：FPARENTMATID 
	 单价折扣：FPriceDiscount 
	 仓位：FSTOCKLOCID 
...
关联关系表：FEntity_Link 
	 ...
	 原始携带量：FEntity_Link_FPurBaseQtyOld 
	 修改携带量：FEntity_Link_FPurBaseQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PUR_MRAPP","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBusinessType":"","FBillNo":"","FDate":"1900-01-01","FAPPORGID":{"FNumber":""},"FAPPDEPTID":{"FNumber":""},"FRequireOrgId":{"FNumber":""},"FRMTYPE":"","FRMMODE":"","FRMLOC":"","FCorrespondOrgId":{"FNumber":""},"FRMREASON":{"FNumber":""},"FPURCHASEORGID":{"FNumber":""},"FSUPPLIERID":{"FNumber":""},"FRemarks":"","FConfirmerId":{"FUserID":""},"FConfirmDate":"1900-01-01","FApplicantId":{},"F_SubEntity_FIN":{"FENTRYID":0,"FSettleTypeId":{"FNumber":""},"FLOCALCURRID":{"FNumber":""},"FExchangeTypeId":{"FNUMBER":""},"FPriceListId":{"FNUMBER":""},"FISPRICEEXCLUDETAX":"false"},"FEntity":[{"FEntryID":0,"FMtoNo":"","FMATERIALID":{"FNumber":""},"FUNITID":{"FNumber":""},"FMRAPPQTY":0,"FPRICEUNITID_F":{"FNumber":""},"FREPLENISHQTY":0,"FKEAPAMTQTY":0,"FRMREASON_M":{"FNumber":""},"FGiveAway":"false","FNOTE_M":"","FSupMatId":"","FSupMatName":"","FBOMID":{"FNumber":""},"FLot":{"FNumber":""},"FPRICECOEFFICIENT_F":0,"FPRICE_F":0,"FEntryTaxRate":0,"FDISCOUNTRATE_F":0,"FTAXNETPRICE_F":0,"FSRCBILLTYPEID":"","FSRCBILLNO":"","FBFLowId":{"FName":""},"FPriceBaseQty":0,"FPURUNITID":{"FNumber":""},"FPurQty":0,"FPurBaseQty":0,"FENTRYPRICELISTID":{"FNUMBER":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FStockId":{"FNUMBER":""},"F_CGDDH":"","FPriceDiscount":0,"F_JHRQ":"","FSTOCKLOCID":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FSUBREQBILLNO":"","FSUBREQBILLSEQ":0,"FSUBREQENTRYID":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_MRAPP","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_MRAPP","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_MRAPP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_MRAPP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_MRAPP","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("PUR_MRAPP","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_MRAPP","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_MRAPP","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PUR_MRAPP","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_MRAPP"}");

# 资金调拨单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 资金调拨单
...
client.Draft("SC_FundsTransf","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FDate":"1900-01-01","FFundsOrgID":{"FNumber":""},"FPayOrgID":{"FNumber":""},"FBankID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FCashActID":{"FNUMBER":""},"FINNERACCOUNTID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FSettleTypeID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FTotalAmount":0,"FEXCHANGETYPE":{"FNUMBER":""},"FCount":0,"FDescription":"","FEXCHANGERATE":0,"FBEGINDATE":"1900-01-01","FENDDATE":"1900-01-01","FRateTable":{"FNUMBER":""},"FRateType":"","FRateShow":"","FConvertDay":0,"FYearRate":0,"FLastEndDate":"1900-01-01","FFreeAmout":0,"FRepayAmount":0,"FOwedAmount":0,"FInterestAmount":0,"FRepaidInterest":0,"FOwedInterest":0,"FRepayCount":0,"FISINIT":"false","FFUNDSTRANSFENTRY":[{"FEntryID":0,"FReceiveOrgId":{"FNumber":""},"FEntryBankID":{"FNUMBER":""},"FENTRYBANKActID":{"FNUMBER":""},"FENTRYCASHActID":{"FNUMBER":""},"FOPPOSITEINNERACCTID":{"FNUMBER":""},"FAmount":0,"FAMOUNT_LC":0,"FRECEIVEHANDLINGCHARGE":0,"FHANDLINGCHARGE":0,"FSettleNumber":"","FMainHANDLINGCHARGE":0,"FRECBILLID":{"FBILLNUMBER":""},"FPAYBILLID":{"FBILLNUMBER":""},"FPARAMOUNTFOR":0,"FCOMMENT":"","FSignature":""}],"FFUNDSINTERESTFENTRY":[{"FEntryID":0,"FISINITINTEREST":"false","FINTERESTBILLNO":"","FCalcDate":"1900-01-01","FStartDate":"1900-01-01","FFinishDate":"1900-01-01","FDetailInterestAmt":0,"FMainDetailInterest":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FFUNDSTRANSFENTRY": [
            {
                ...
                "FOPPOSITEINNERACCTID": {
                    "FNUMBER": ""
                },
                "FAmount": 0,
                "FAMOUNT_LC": 0,
                "FRECEIVEHANDLINGCHARGE": 0,
                "FHANDLINGCHARGE": 0,
                "FSettleNumber": "",
                "FMainHANDLINGCHARGE": 0,
                "FRECBILLID": {
                    "FBILLNUMBER": ""
                },
                "FPAYBILLID": {
        ...
        "FFUNDSINTERESTFENTRY": [
            {
                "FEntryID": 0,
                "FISINITINTEREST": "false",
                "FINTERESTBILLNO": "",
                "FCalcDate": "1900-01-01",
                "FStartDate": "1900-01-01",
                "FFinishDate": "1900-01-01",
                "FDetailInterestAmt": 0,
                "FMainDetailInterest": 0
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 摘要：FDescription 
	 账户名称：FBankActName 
	 利息总金额：FInterestAmount 
	 已还利息金额：FRepaidInterest 
	 未还利息金额：FOwedInterest 
	 还款笔数：FRepayCount 
	 现金账号：FCashActID 
	 现金账户名称：FCashActName 
	 期初：FISINIT 
明细：FFUNDSTRANSFENTRY 
	 实体主键：FEntryID 
	 借入组织：FReceiveOrgId  (必填项)
	 银行账号：FENTRYBANKActID 
	 金额：FAmount 
	 结算号：FSettleNumber 
	 备注：FCOMMENT 
	 银行提交状态：FSubmitStatus 
	 银行处理状态：FBankStatus 
	 本位币金额：FAMOUNT_LC 
	 内部账户：FOPPOSITEINNERACCTID 
	 账户名称：FENTRYBANKActName 
	 借出方手续费：FHANDLINGCHARGE 
	 本位币借出方手续费：FMainHANDLINGCHARGE 
	 内部账户名称：FOPPOSITEINNERACCTNAME 
	 银行：FEntryBankID 
	 现金账号：FENTRYCASHActID 
	 现金账户名称：FENTRYCASHActName 
	 银行状态码：FBankCode 
	 应收票据票据（包）号：FRECBILLID 
	 应付票据票据（包）号：FPAYBILLID 
	 票面金额：FPARAMOUNTFOR 
	 银企处理详细信息：FEBMSG 
	 借入方手续费：FRECEIVEHANDLINGCHARGE 
	 应收票据流水号：FRecBillNO 
	 应付票据流水号：FPayBillNO 
	 流水号/对账码：FCHECKCODE 
	 签名：FSignature 
利息明细：FFUNDSINTERESTFENTRY 
	 实体主键：FEntryID 
	 计算日期：FCalcDate 
	 开始日期：FStartDate 
	 结束日期：FFinishDate 
	 利息金额：FDetailInterestAmt 
	 本位币利息金额：FMainDetailInterest 
	 资金调拨利息单编号：FINTERESTBILLNO 
	 期初：FISINITINTEREST 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SC_FundsTransf","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FDate":"1900-01-01","FFundsOrgID":{"FNumber":""},"FPayOrgID":{"FNumber":""},"FBankID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FCashActID":{"FNUMBER":""},"FINNERACCOUNTID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FSettleTypeID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FTotalAmount":0,"FEXCHANGETYPE":{"FNUMBER":""},"FCount":0,"FDescription":"","FEXCHANGERATE":0,"FBEGINDATE":"1900-01-01","FENDDATE":"1900-01-01","FRateTable":{"FNUMBER":""},"FRateType":"","FRateShow":"","FConvertDay":0,"FYearRate":0,"FLastEndDate":"1900-01-01","FFreeAmout":0,"FRepayAmount":0,"FOwedAmount":0,"FInterestAmount":0,"FRepaidInterest":0,"FOwedInterest":0,"FRepayCount":0,"FISINIT":"false","FFUNDSTRANSFENTRY":[{"FEntryID":0,"FReceiveOrgId":{"FNumber":""},"FEntryBankID":{"FNUMBER":""},"FENTRYBANKActID":{"FNUMBER":""},"FENTRYCASHActID":{"FNUMBER":""},"FOPPOSITEINNERACCTID":{"FNUMBER":""},"FAmount":0,"FAMOUNT_LC":0,"FRECEIVEHANDLINGCHARGE":0,"FHANDLINGCHARGE":0,"FSettleNumber":"","FMainHANDLINGCHARGE":0,"FRECBILLID":{"FBILLNUMBER":""},"FPAYBILLID":{"FBILLNUMBER":""},"FPARAMOUNTFOR":0,"FCOMMENT":"","FSignature":""}],"FFUNDSINTERESTFENTRY":[{"FEntryID":0,"FISINITINTEREST":"false","FINTERESTBILLNO":"","FCalcDate":"1900-01-01","FStartDate":"1900-01-01","FFinishDate":"1900-01-01","FDetailInterestAmt":0,"FMainDetailInterest":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SC_FundsTransf","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SC_FundsTransf","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SC_FundsTransf","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SC_FundsTransf","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SC_FundsTransf","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("SC_FundsTransf","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SC_FundsTransf","Synchronism","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FDate":"1900-01-01","FFundsOrgID":{"FNumber":""},"FPayOrgID":{"FNumber":""},"FBankID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FCashActID":{"FNUMBER":""},"FINNERACCOUNTID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FSettleTypeID":{"FNUMBER":""},"FMAINBOOKID":{"FNUMBER":""},"FTotalAmount":0,"FEXCHANGETYPE":{"FNUMBER":""},"FCount":0,"FDescription":"","FEXCHANGERATE":0,"FBEGINDATE":"1900-01-01","FENDDATE":"1900-01-01","FRateTable":{"FNUMBER":""},"FRateType":"","FRateShow":"","FConvertDay":0,"FYearRate":0,"FLastEndDate":"1900-01-01","FFreeAmout":0,"FRepayAmount":0,"FOwedAmount":0,"FInterestAmount":0,"FRepaidInterest":0,"FOwedInterest":0,"FRepayCount":0,"FISINIT":"false","FFUNDSTRANSFENTRY":[{"FEntryID":0,"FReceiveOrgId":{"FNumber":""},"FEntryBankID":{"FNUMBER":""},"FENTRYBANKActID":{"FNUMBER":""},"FENTRYCASHActID":{"FNUMBER":""},"FOPPOSITEINNERACCTID":{"FNUMBER":""},"FAmount":0,"FAMOUNT_LC":0,"FRECEIVEHANDLINGCHARGE":0,"FHANDLINGCHARGE":0,"FSettleNumber":"","FMainHANDLINGCHARGE":0,"FRECBILLID":{"FBILLNUMBER":""},"FPAYBILLID":{"FBILLNUMBER":""},"FPARAMOUNTFOR":0,"FCOMMENT":"","FSignature":""}],"FFUNDSINTERESTFENTRY":[{"FEntryID":0,"FISINITINTEREST":"false","FINTERESTBILLNO":"","FCalcDate":"1900-01-01","FStartDate":"1900-01-01","FFinishDate":"1900-01-01","FDetailInterestAmt":0,"FMainDetailInterest":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SC_FundsTransf","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SC_FundsTransf","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SC_FundsTransf"}");

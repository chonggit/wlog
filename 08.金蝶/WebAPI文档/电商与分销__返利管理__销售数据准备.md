# 销售数据准备 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 返利管理 > 销售数据准备
...
client.Save("RPM_RPSaleDataReady","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FSettleOrgId":{"FNumber":""},"FCurrencyID":{"FNUMBER":""},"FRPPolicyID":{"FNUMBER":""},"FRPCycleID":{"FNUMBER":""},"FCustTypeID":{"FNumber":""},"FCustomerID":{"FNUMBER":""},"FMaterialGroupID":{"FNumber":""},"FMaterialID":{"FNUMBER":""},"FUnitID":{"FNumber":""},"FBaseUnitID":{"FNumber":""},"FActualQty":0,"FBaseActualQty":0,"FActualAmount":0,"FGroupNumber":0,"FPurchaseQty":0,"FPurchaseAmount":0,"FTargetQty":0,"FTargetAmount":0,"FAssistPropertyID":{"FASSISTPROPERTYID__FF100001":{"FNumber":""},"FASSISTPROPERTYID__FF100002":{"FNumber":""},"FASSISTPROPERTYID__FF100003":{"FNumber":""},"FASSISTPROPERTYID__FF100005":{"FNumber":""},"FASSISTPROPERTYID__FF100010":{"FNumber":""},"FASSISTPROPERTYID__FF100007":{"FNumber":""},"FASSISTPROPERTYID__FF100008":{"FNumber":""}},"FBasePurchaseQty":0,"FBaseTargetQty":0,"FTargetRate":0,"FActualTargetRate":0,"FCalcRPBaseQty":0,"FCalcRPAmount":0,"FCalcRPQty":0,"FRPPolicyDate":"1900-01-01"}}");
...
单据头：FBillHead 
	 实体主键：FID 
	 编号：FBillNo 
	 返利计算组织：FSettleOrgId  (必填项)
	 币别：FCurrencyID  (必填项)
	 返利政策：FRPPolicyID  (必填项)
	 返利周期：FRPCycleID  (必填项)
	 开始日期：FStartDate 
	 结束日期：FEndDate 
	 客户类别：FCustTypeID 
	 返利对象：FCustomerID 
	 物料分类：FMaterialGroupID 
	 物料编码：FMaterialID 
	 物料名称：FMaterialName 
	 规格型号：FMaterialMode 
	 计量单位：FUnitID 
	 基本计量单位：FBaseUnitID 
	 实际销售数量：FActualQty 
	 实际销售基本数量：FBaseActualQty 
	 实际销售金额：FActualAmount 
	 组号：FGroupNumber 
	 购买数量：FPurchaseQty 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 购买基本数量：FBasePurchaseQty 
	 指标基本数量：FBaseTargetQty 
	 指标完成率%：FTargetRate 
	 实际指标完成率%：FActualTargetRate 
	 是否已结算：FSettleStatus 
	 参与返利基本数量：FCalcRPBaseQty 
	 参与返利销售金额：FCalcRPAmount 
	 参与返利销售数量：FCalcRPQty 
	 返利政策审核日期：FRPPolicyDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("RPM_RPSaleDataReady","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("RPM_RPSaleDataReady","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RPM_RPSaleDataReady"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("RPM_RPSaleDataReady","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("RPM_RPSaleDataReady","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("RPM_RPSaleDataReady","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

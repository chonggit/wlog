# 分步式调出未调入明细表 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 分步式调出未调入明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 4315 |
...
client.GetSysReportData("HS_TransOutNotInDetailReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FYear":"","FPeriod":"","FENDYEAR":"","FEndPeriod":"","FMATERIALID":{"FNumber":""},"FENDMATERIALID":{"FNumber":""},"FBILLNO":"","FCURRENCYID":{"FNumber":""},"FENDBILLNO":"","FOWNERIDS":[{"FNumber":""}],"FSTOCKORGIDS":[{"FNumber":""}],"FSTOCKID":{"FNUMBER":""},"FENDSTOCKID":{"FNUMBER":""},"FMATERTYPEIDS":[{"FNumber":""}],"FCHXEXPENSE":"false","FNoStatisAllIn":"false","FOnlyShowSubTotal":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FCHXEXPENSE": "false",
        "FNoStatisAllIn": "false",
        "FOnlyShowSubTotal": "false"
    }
}
...
五、字段说明：
	 ...
	 已全部调入不统计（金额）：FNoStatisAllIn 
	 仅显示小计：FOnlyShowSubTotal 
...
参数FieldKeys显示列：
	 ...
	 单价：FPrice 
	 金额：FAmount 
	 源调出单据编号：FSRCOUTBILLNO 
	 源调出单据行号：FSRCOUTBILLSEQ 

...
client.Delete("ENG_MODELRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ENG_MODELRULE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ENG_MODELRULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FMODELCODE":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FRuleDescription":"","FRuleType":"","FExeCute":"","FModelVariable":"","FCode":"","FOpVariable":"","FOpeCode":"","FRemark":"","FVariableControl":"","FVarType":"","FVariableID":0,"FIsCalVariable":"","FForMulaEntity":[{"FFORMULAEntryID":0,"FLeftBracket":"","FVariableType":"","FForMulaVBLeft":"","FRightBracket":"","FForMulaOperator":"","FForMulaVarType":"","FForMulaVarId":0,"FForMulaIsCalVar":""}],"FOperatioEntity":[{"FOperationEntryID":0,"FLogic":"","FOPLeftBracket":"","FOpVBLeftType":"","FOperationLeftVB":"","FOperator":"","FOPVBRightType":"","FOperationRightVB":"","FOpRightBracket":"","FOPLeftVARID":0,"FOPRightVARID":0,"FOPLeftVARTYPE":"","FOPLeftIsCalVar":"","FOPRightVARTYPE":"","FOPRightIsCalVar":""}],"FOPForMulaEntity":[{"FOPForMulaEntryID":0,"FOPForMulaLeftBracket":"","FOPForMulaType":"","FOPForMulaVariable":"","FOPForMulaRightBracket":"","FOpForMulaOperator":"","FOPForMulaVarType":"","FOPFORMULAVARID":0,"FOPForMulaIsCalVar":""}],"FCONEntity":[{"FCONENTRYID":0,"FConLogic":"","FConLeftBracket":"","FConLeftVar":"","FConOperator":"","FConVariableType":"","FConRightVar":"","FConRightBracket":"","FConLeftVarId":0,"FConLeftVarType":"","FConLeftIsCalVar":"","FConRightVarId":0,"FConRightVarType":"","FConRightIsCalVar":""}]}]}}");
        ...
        "FEntity": [
            {
                ...
                "FOPForMulaEntity": [
                    {
                        "FOPForMulaEntryID": 0,
                        "FOPForMulaLeftBracket": "",
                        "FOPForMulaType": "",
                        "FOPForMulaVariable": "",
                        "FOPForMulaRightBracket": "",
                        "FOpForMulaOperator": "",
                        "FOPForMulaVarType": "",
                        "FOPFORMULAVARID": 0,
                        "FOPForMulaIsCalVar": ""
...
明细：FEntity 
	 实体主键：FEntryID 
	 规则描述：FRuleDescription 
	 规则类型：FRuleType  (必填项)
	 控制：FVariableControl  (必填项)
	 操作代码：FOpeCode 
	 消息：FRemark 
	 公式代码：FCode 
	 执行：FExeCute  (必填项)
	 ...
	 变量内码：FVariableID 
	 参数表：FBaseDataTypeId 
	 是否计算变量：FIsCalVariable  (必填项)
公式：FForMulaEntity 
	 实体主键：FFORMULAEntryID 
	 左括号：FLeftBracket 
	 运算符：FForMulaOperator 
	 右括号：FRightBracket 
	 类型：FVariableType 
	 文本：FForMulaVBLeft 
	 变量类型：FForMulaVarType 
	 变量内码：FForMulaVarId 
	 是否计算变量：FForMulaIsCalVar  (必填项)
操作：FOperatioEntity 
	 实体主键：FOperationEntryID 
	 逻辑：FLogic 
	 左括号：FOPLeftBracket 
	 运算符：FOperator  (必填项)
	 右括号：FOpRightBracket 
	 类型：FOpVBLeftType  (必填项)
	 类型：FOPVBRightType  (必填项)
	 文本一：FOperationLeftVB 
	 文本二：FOperationRightVB 
	 变量一内码：FOPLeftVARID 
	 变量二内码：FOPRightVARID 
	 变量一类型：FOPLeftVARTYPE 
	 变量二类型：FOPRightVARTYPE 
	 左边是否计算变量：FOPLeftIsCalVar  (必填项)
	 右边是否计算变量：FOPRightIsCalVar  (必填项)
操作公式：FOPForMulaEntity 
	 实体主键：FOPForMulaEntryID 
	 左括号：FOPForMulaLeftBracket 
	 变量类型：FOPForMulaVarType 
	 运算符：FOpForMulaOperator 
	 右括号：FOPForMulaRightBracket 
	 类型：FOPForMulaType 
	 文本：FOPForMulaVariable 
	 变量内码：FOPFORMULAVARID 
	 是否计算变量：FOPForMulaIsCalVar  (必填项)
约束：FCONEntity 
	 实体主键：FCONENTRYID 
	 逻辑：FConLogic 
	 左括号：FConLeftBracket 
	 运算符：FConOperator  (必填项)
	 类型：FConVariableType  (必填项)
	 文本：FConRightVar 
	 右括号：FConRightBracket 
	 变量：FConLeftVar 
	 左边变量内码：FConLeftVarId 
	 左边变量类型：FConLeftVarType  (必填项)
	 右边变量内码：FConRightVarId 
	 右边变量类型：FConRightVarType  (必填项)
	 左边是否计算变量：FConLeftIsCalVar  (必填项)
	 右边是否计算变量：FConRightIsCalVar  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ENG_MODELRULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FMODELCODE":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FRuleDescription":"","FRuleType":"","FExeCute":"","FModelVariable":"","FCode":"","FOpVariable":"","FOpeCode":"","FRemark":"","FVariableControl":"","FVarType":"","FVariableID":0,"FIsCalVariable":"","FForMulaEntity":[{"FFORMULAEntryID":0,"FLeftBracket":"","FVariableType":"","FForMulaVBLeft":"","FRightBracket":"","FForMulaOperator":"","FForMulaVarType":"","FForMulaVarId":0,"FForMulaIsCalVar":""}],"FOperatioEntity":[{"FOperationEntryID":0,"FLogic":"","FOPLeftBracket":"","FOpVBLeftType":"","FOperationLeftVB":"","FOperator":"","FOPVBRightType":"","FOperationRightVB":"","FOpRightBracket":"","FOPLeftVARID":0,"FOPRightVARID":0,"FOPLeftVARTYPE":"","FOPLeftIsCalVar":"","FOPRightVARTYPE":"","FOPRightIsCalVar":""}],"FOPForMulaEntity":[{"FOPForMulaEntryID":0,"FOPForMulaLeftBracket":"","FOPForMulaType":"","FOPForMulaVariable":"","FOPForMulaRightBracket":"","FOpForMulaOperator":"","FOPForMulaVarType":"","FOPFORMULAVARID":0,"FOPForMulaIsCalVar":""}],"FCONEntity":[{"FCONENTRYID":0,"FConLogic":"","FConLeftBracket":"","FConLeftVar":"","FConOperator":"","FConVariableType":"","FConRightVar":"","FConRightBracket":"","FConLeftVarId":0,"FConLeftVarType":"","FConLeftIsCalVar":"","FConRightVarId":0,"FConRightVarType":"","FConRightIsCalVar":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ENG_MODELRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ENG_MODELRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ENG_MODELRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_MODELRULE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_MODELRULE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ENG_MODELRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ENG_MODELRULE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ENG_MODELRULE"}");

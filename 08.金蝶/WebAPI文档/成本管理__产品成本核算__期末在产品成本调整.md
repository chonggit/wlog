# 期末在产品成本调整 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 期末在产品成本调整
...
client.Save("CB_ENDPROCOSTADJ","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FYEAR":0,"FPERIOD":0,"FSHOWPERIOD":"","FCREATORID":{"FUserID":""},"FCREATEDATE":"1900-01-01","FMODIFIERID":{"FUserID":""},"FMODIFYDATE":"1900-01-01","FAPPROVERID":{"FUserID":""},"FAPPROVEDATE":"1900-01-01","FFORBIDDERID":{"FUserID":""},"FFORBIDDATE":"1900-01-01","FTreeEntity":[{"FENTRYID":0,"FROWID":"","FPROORDERTYPE":"","FPROORDERID":{"FNUMBER":""},"FPROORDERNO":"","FPROORDERSEQ":0,"FFORMID":"","FPRODUCTDIMEID":0,"FBUSINESSSTATUS":"","FDATATYPE":"","FCOSTCENTERID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FUNITID":{"FNumber":""},"FBOMID":{"FNumber":""},"FLOTID":{"FNUMBER":""},"FMTONO":"","FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FSUPPLIERID":{"FNUMBER":""},"FENDQTY":0,"FEXPTYPE":"","FENDAMOUNT":0,"FMaterialEntity":[{"FMATDETAILID":0,"FMATPARENTID":"","FMATEXPENSESITEMID":{"FNUMBER":""},"FExpItemEntity":[{"FEXPDETAILID":0,"FEXPPARENTID":""}]}]}]}}");
...
子项物料：FMaterialEntity 
	 ...
	 基本单位：FMATUNITID 
	 期末在产数量：FMATENDQTY 
	 期末调整数量：FMATENDADJQTY 
	 调整后数量：FMATAFTERADJQTY 
	 期末在产金额：FMATENDAMOUNT 
	 期末调整金额：FMATENDADJAMOUNT 
	 调整后金额：FMATAFTERADJAMOUNT 
	 批号：FMATLOTID 
	 规格型号：FMaterialModel 
	 BOM版本：FMATBOMID 
	 父级内码：FMATPARENTID 
	 费用项目：FMATEXPENSESITEMID 
子项费用项目：FExpItemEntity 
	 实体主键：FEXPDETAILID 
	 父级内码：FEXPPARENTID 
	 费用项目名称：FEXPITEMNAME 
	 费用项目编码：FEXPITEMID 
	 期末在产金额：FEXPENDAMOUNT 
	 期末调整金额：FEXPENDADJAMOUNT 
	 调整后金额：FEXPAFTERADJAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_ENDPROCOSTADJ","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CB_ENDPROCOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("CB_ENDPROCOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CB_ENDPROCOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CB_ENDPROCOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CB_ENDPROCOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_ENDPROCOSTADJ","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_ENDPROCOSTADJ"}");

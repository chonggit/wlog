# 其他检验质量统计表 Web API 操作原始内容

> 来源页面：全部 > 质量管理 > 质量管理 > 其他检验质量统计表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3769 |
...
client.GetSysReportData("QM_OthChkQuaStatictis","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FBillBeginDate":"1900-01-01","FBillEndDate":"1900-01-01","FSupplierId":[{"FNumber":""}],"FMaterialId":[{"FNumber":""}],"FInspectDeptId":[{"FNumber":""}],"FWorkShopId":[{"FNumber":""}],"FInspectorId":[{"FNumber":""}],"FInspectBillNo":"","FQCStatus":"","FBillStatus":"","FInspectGroupId":"","FStockId":[{"FNumber":""}],"FInOrgId":"","FInspectOrgId":""}}");
...
四、JSON格式数据：
{
    ...
    "FilterString": [],
    "Model": {
        "FBillBeginDate": "1900-01-01",
        "FBillEndDate": "1900-01-01",
        "FSupplierId": [
            {
                "FNumber": ""
            }
...
参数FieldKeys显示列：
	 ...
	 质检组织：FInspectOrgId 
	 检验单编号：FInspectBillNo 
	 检验单行号：FInspectBillSeq 
	 质检状态：FQCStatus 
	 质检完成日期：FInspectFinishDate 
	 检验部门：FInspectDeptId 
	 质检组：FInspectGroupId 
	 质检员：FInspectorId 
	 单据日期：FInspectBillDate 

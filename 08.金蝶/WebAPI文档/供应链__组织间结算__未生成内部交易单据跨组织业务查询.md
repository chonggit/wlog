# 未生成内部交易单据跨组织业务查询 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 组织间结算 > 未生成内部交易单据跨组织业务查询

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2512 |
...
client.GetSysReportData("IOS_NotCreateIOSInnerBillRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FBillStartDate":"1900-01-01","FBillEndDate":"1900-01-01","FObjStartOrignID":{"FNUMBER":""},"FACCTSysId":{"FNUMBER":""},"FBizOrgId":"","FACCTOrgId":{"FNUMBER":""},"FBizBillType":""}}");

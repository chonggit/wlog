# 客户平台资料维护 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > B2B电商中心 > 客户平台资料维护
...
client.Delete("CP_Maintenance","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CP_Maintenance","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FUserName":"","FBillNo":"","FCPCustomer":{"FNUMBER":""},"FCUSTOMERMASTERID":0,"FMAXUSERNUM":0,"FIsCreateAdmin":"false","FPhone":"","FCustOrgEntity":[{"FENTRYID":0,"FOrgId":{"FNumber":""},"FIsDefault":"false"}],"FCustUserEntity":[{"FENTRYID":0,"FCPUser":{"FNAME":""}}]}}");
...
单据头：FBillHead 
	 ...
	 客户：FCPCustomer  (必填项)
	 管理员用户名：FUserName 
	 客户MastId：FCUSTOMERMASTERID 
	 最大用户数：FMAXUSERNUM 
	 客户名称：FBasePropCustName 
	 客户简称：FBasePropCustJC 
	 已经创建？：FIsCreateAdmin 
	 客户编码：FBasePropCustomerNumber 
	 管理员移动电话：FPhone 
订货组织：FCustOrgEntity 
	 实体主键：FENTRYID 
	 订货组织：FOrgId  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CP_Maintenance","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FUserName":"","FBillNo":"","FCPCustomer":{"FNUMBER":""},"FCUSTOMERMASTERID":0,"FMAXUSERNUM":0,"FIsCreateAdmin":"false","FPhone":"","FCustOrgEntity":[{"FENTRYID":0,"FOrgId":{"FNumber":""},"FIsDefault":"false"}],"FCustUserEntity":[{"FENTRYID":0,"FCPUser":{"FNAME":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CP_Maintenance","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CP_Maintenance","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CP_Maintenance"}");

# 定时清理移动条码日志 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 定时清理移动条码日志
...
client.Delete("DSQLYDDRZ","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("DSQLYDDRZ","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_Status":"","FCreatorId":{"FUserID":""},"F_StartDatetime":"1900-01-01","F_EndDatetime":"1900-01-01","F_Executioninterval":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","F_DelDatetime":"1900-01-01","F_TimerName":""}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_StartDatetime": "1900-01-01",
        "F_EndDatetime": "1900-01-01",
        "F_Executioninterval": "",
        "FCreateDate": "1900-01-01",
        "FModifyDate": "1900-01-01",
        "F_DelDatetime": "1900-01-01",
        "F_TimerName": ""
    }
}
...
单据头：FBillHead 
	 ...
	 状态：F_Status  (必填项)
	 创建人：FCreatorId 
	 起始时间：F_StartDatetime  (必填项)
	 结束日期：F_EndDatetime  (必填项)
	 日志保留周期：F_Executioninterval 
	 创建日期：FCreateDate 
	 修改日期：FModifyDate 
	 上次执行时间：F_DelDatetime 
	 名称：F_TimerName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("DSQLYDDRZ","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_Status":"","FCreatorId":{"FUserID":""},"F_StartDatetime":"1900-01-01","F_EndDatetime":"1900-01-01","F_Executioninterval":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","F_DelDatetime":"1900-01-01","F_TimerName":""}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("DSQLYDDRZ","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("DSQLYDDRZ","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"DSQLYDDRZ"}");

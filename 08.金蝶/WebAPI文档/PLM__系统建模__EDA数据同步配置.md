# EDA数据同步配置 Web API 操作原始内容

> 来源页面：全部 > PLM > 系统建模 > EDA数据同步配置
...
client.Save("PLM_CFG_AD_SYNCDATA_CONFIG","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FADSynchrogazerDBUrl":"","FADSynchrogazerDBName":"","FADSynchrogazerDBPassword":"","FADSynchrogazerDBAccount":"","FADSYNCHRONIZATIONTIME":0,"FTempTime":"","Funit":"","FEntity":[{"FEntryID":0,"FCategoryId":{"FCODE":""},"FADVIEWNAME":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        "FID": 0,
        "FADSynchrogazerDBUrl": "",
        "FADSynchrogazerDBName": "",
        "FADSynchrogazerDBPassword": "",
        "FADSynchrogazerDBAccount": "",
        "FADSYNCHRONIZATIONTIME": 0,
        "FTempTime": "",
        "Funit": "",
        "FEntity": [
            {
...
单据头：FBillHead 
	 实体主键：FID 
	 文本：FADSynchrogazerDBUrl 
	 文本：FADSynchrogazerDBName 
	 文本：FADSynchrogazerDBPassword 
	 文本：FADSynchrogazerDBAccount 
	 整数：FADSYNCHRONIZATIONTIME 
	 文本：FTempTime 
	 下拉列表：Funit 
单据体：FEntity 
	 实体主键：FEntryID 
	 业务类型：FCategoryId 
	 视图名称：FADVIEWNAME  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("PLM_CFG_AD_SYNCDATA_CONFIG","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_CFG_AD_SYNCDATA_CONFIG"}");

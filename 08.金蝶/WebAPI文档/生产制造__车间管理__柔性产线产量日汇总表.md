# 柔性产线产量日汇总表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 柔性产线产量日汇总表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3879 |
...
client.GetSysReportData("SFC_FlexibleOutPutRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FProcessOrgId":[{"FNumber":""}],"FWorkCenterId":[{"FNumber":""}],"FMaterialId":[{"FNumber":""}],"FMONumber":"","FProcessId":[{"FNumber":""}],"FProWorkShopIDS":"","FShiftSlice":[{"FNumber":""}],"FShiftGroup":[{"FNumber":""}],"FEquipment":[{"FNumber":""}],"FEmp":[{"FStaffNumber":""}],"FStatistical":"","FEntity":[{"FLength":0,"FUnit":"","FNumber":0}]}}");

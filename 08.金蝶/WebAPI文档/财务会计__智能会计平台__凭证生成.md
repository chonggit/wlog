...
client.Save("Bas_MakeBizVchWizard","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FSystemID":"","FISDEFAULT":"false","FName":"","FCoverMakeGlVch":"false","FUseNewBuilder":"false","FLogType":"","FUserId":0,"FIsShare":0,"FEntity":[{"FEntryID":0,"FSelectBook":"false","FACCTBOOKID":{"FNumber":""},"FPeriod":"","FACTIONTYPE":"","FMergeBuildVchScheme":{"FNUMBER":""},"FSubEntity":[{"FDID":0,"FDIsSelected":"false","FSOURCEBILLKEY":{"FNumber":""},"FBillFilter":"","FGENERATETYPE":"","FMATCHNAME":"","FMATCHVALUE":""}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FISDEFAULT": "false",
        "FName": "",
        "FCoverMakeGlVch": "false",
        "FUseNewBuilder": "false",
        "FLogType": "",
        "FUserId": 0,
        "FIsShare": 0,
        "FEntity": [
...
单据头：FBillHead 
	 实体主键：FID 
	 下次以此方案自动进入：FISDEFAULT 
	 生成方案名称：FName 
	 已经生成总账凭证的单据重新生成总账凭证：FCoverMakeGlVch 
	 系统内码：FSystemID 
	 使用逐行生成：FUseNewBuilder 
	 日志详细度：FLogType  (必填项)
	 用户ID：FUserId 
	 共享给他人：FIsShare 
单据体：FEntity 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("Bas_MakeBizVchWizard","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("Bas_MakeBizVchWizard","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"Bas_MakeBizVchWizard"}");

# 合并报表项目勾稽关系分配 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 合并报表 > 合并报表项目勾稽关系分配
...
client.Delete("CR_ItemRelationAllocate","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CR_ItemRelationAllocate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FTemplateID":{"FRptID":""},"FTemplateTypeID":"","FCREATORID":{"FUserID":""},"FCREATEDATE":"1900-01-01","FMODIFIERID":{"FUserID":""},"FMODIFYDATE":"1900-01-01","FRelationEntity":[{"FEntryID":0,"FRelationId":{"FNumber":""},"FCONTROLNODE":"","FCONTROLSTRENGTH":""}]}}");
...
单据头：FBillHead 
	 实体主键：FID 
	 报表模板：FTemplateID 
	 模板类型：FTemplateTypeID 
	 报表周期：FTemplateCycleID 
	 模板名称：FName 
	 模板编码：FTemplateNumber 
	 创建组织：FTemplateCreateOrgId 
	 核算体系：FTemplateAcctSystemID 
	 所属组织：FTemplateOrgId 
	 ...
	 修改人：FMODIFIERID 
	 修改日期：FMODIFYDATE 
勾稽关系单据体：FRelationEntity 
	 实体主键：FEntryID 
	 勾稽关系编码：FRelationId 
	 勾稽关系名称：FRelationName 
	 左表达式：FLeftExpression 
	 等式关系符：FRelationOperator 
	 右表达式：FRightExpression 
	 控制节点：FCONTROLNODE 
	 控制强度：FCONTROLSTRENGTH 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CR_ItemRelationAllocate","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CR_ItemRelationAllocate","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CR_ItemRelationAllocate"}");

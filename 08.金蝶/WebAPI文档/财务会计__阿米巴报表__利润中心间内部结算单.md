# 利润中心间内部结算单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 阿米巴报表 > 利润中心间内部结算单
...
client.Delete("AMB_INNERSETTLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AMB_INNERSETTLE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPEID":{"FNUMBER":""},"FBUSINESSDATE":"1900-01-01","FRECEIVEPROFIT":{"FNUMBER":""},"FCURRENCY":{"FNUMBER":""},"FPROVIDEPROFIT":{"FNUMBER":""},"FSETTLETYPE":"","FCREATORID":{"FUserID":""},"FAPPROVERID":{"FUserID":""},"FSETTLEPURPOSE":{"FNUMBER":""},"FFEEITEM":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FEXPENSEITEM":{"FNUMBER":""},"FUNIT":{"FNUMBER":""},"FFQUANTITY":0,"FAMOUNT":0,"FMATERIALID":{"FNUMBER":""},"FSERVICEID":{"FNUMBER":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FREMARK":""}]}}");
...
单据头：FBillHead 
	 ...
	 接收利润中心：FRECEIVEPROFIT  (必填项)
	 币别：FCURRENCY  (必填项)
	 供货利润中心：FPROVIDEPROFIT  (必填项)
	 结算类型：FSETTLETYPE  (必填项)
	 创建人：FCREATORID 
	 审核人：FAPPROVERID 
	 结算用途：FSETTLEPURPOSE  (必填项)
	 费用项目：FFEEITEM 
单据体：FEntity 
	 实体主键：FEntryID 
	 费用项目：FEXPENSEITEM  (必填项)
	 单位：FUNIT  (必填项)
	 数量：FFQUANTITY 
	 金额：FAMOUNT 
	 物料编码：FMATERIALID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AMB_INNERSETTLE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPEID":{"FNUMBER":""},"FBUSINESSDATE":"1900-01-01","FRECEIVEPROFIT":{"FNUMBER":""},"FCURRENCY":{"FNUMBER":""},"FPROVIDEPROFIT":{"FNUMBER":""},"FSETTLETYPE":"","FCREATORID":{"FUserID":""},"FAPPROVERID":{"FUserID":""},"FSETTLEPURPOSE":{"FNUMBER":""},"FFEEITEM":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FEXPENSEITEM":{"FNUMBER":""},"FUNIT":{"FNUMBER":""},"FFQUANTITY":0,"FAMOUNT":0,"FMATERIALID":{"FNUMBER":""},"FSERVICEID":{"FNUMBER":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FREMARK":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AMB_INNERSETTLE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AMB_INNERSETTLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AMB_INNERSETTLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AMB_INNERSETTLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AMB_INNERSETTLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AMB_INNERSETTLE","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AMB_INNERSETTLE","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AMB_INNERSETTLE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AMB_INNERSETTLE"}");

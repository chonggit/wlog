# 财政电子票据 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 电子凭证池 > 财政电子票据
...
client.Delete("EVCH_EFI","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("EVCH_EFI","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FInvoiceID":"","FBillNo":"","FeVchType":"","FAccountBook":{"FNUMBER":""},"FYear":0,"FPeriod":0,"FCollectionDate":"1900-01-01","FSourceBill":{"FNUMBER":""},"FSourceBillNo":"","FXbrlFileName":"","FXbrlUrl":"","FFareAmount":0,"FInvoiceDate":"1900-01-01","FIsRed":"false","FIsRecord":"false","FCreditCode":"","FAccountName":"","FAcctOrgId":{"FNumber":""},"FIsCheckReal":"false","FLocalCurrency":{"FNUMBER":""},"FIssueCompany":"","FSourceBillID":"","FIssuerID":"","FEntity":[{"FEntryID":0,"FVoucherID":0,"FVoucherNo":"","FDate":"1900-01-01","FYearPeriod":"","FExplanation":"","FSubEntity":[{"FDetailID":0,"FDC":"","FGLAccount":"","FDetailAccount":"","FAmount":0}]}]}}");
...
单据头：FBillHead 
	 ...
	 核算组织：FAcctOrgId  (必填项)
	 是否已验真：FIsCheckReal 
	 开票单位名称：FIssueCompany  (必填项)
	 开票单位代码：FIssuerID  (必填项)
	 本位币：FLocalCurrency 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("EVCH_EFI","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FInvoiceID":"","FBillNo":"","FeVchType":"","FAccountBook":{"FNUMBER":""},"FYear":0,"FPeriod":0,"FCollectionDate":"1900-01-01","FSourceBill":{"FNUMBER":""},"FSourceBillNo":"","FXbrlFileName":"","FXbrlUrl":"","FFareAmount":0,"FInvoiceDate":"1900-01-01","FIsRed":"false","FIsRecord":"false","FCreditCode":"","FAccountName":"","FAcctOrgId":{"FNumber":""},"FIsCheckReal":"false","FLocalCurrency":{"FNUMBER":""},"FIssueCompany":"","FSourceBillID":"","FIssuerID":"","FEntity":[{"FEntryID":0,"FVoucherID":0,"FVoucherNo":"","FDate":"1900-01-01","FYearPeriod":"","FExplanation":"","FSubEntity":[{"FDetailID":0,"FDC":"","FGLAccount":"","FDetailAccount":"","FAmount":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("EVCH_EFI","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("EVCH_EFI","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("EVCH_EFI","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("EVCH_EFI","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("EVCH_EFI","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("EVCH_EFI","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"EVCH_EFI"}");

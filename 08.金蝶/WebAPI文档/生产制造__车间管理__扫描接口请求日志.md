# 扫描接口请求日志 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 扫描接口请求日志
...
client.Delete("SFC_WebApiReqLog","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_WebApiReqLog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAPIName":"","FUserId":{"FUserID":""},"FDatetime":"1900-01-01","FReqResult":"","FBillNo":"","FReturnResult":"","FParamInfo":"","FCallStartTime":"1900-01-01","FCallEndTime":"1900-01-01","FMessage":"","FRequestId":"","FEquClickTime":"1900-01-01","FEquResValTime":"1900-01-01","FEquRefTime":"1900-01-01","FOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FMOMessage":"","FProductNo":"","FSerialNo":"","FEquipmentId":{"FNUMBER":""},"FEqmNo":"","FProcessId":{"FNUMBER":""},"FTrackNumber":"","FGatherNo":"","FOpSeqId":"","FProcessType":"","FOpSeqType":"","FRunTime":0}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FReturnResult": "",
        "FParamInfo": "",
        "FCallStartTime": "1900-01-01",
        "FCallEndTime": "1900-01-01",
        "FMessage": "",
        "FRequestId": "",
        "FEquClickTime": "1900-01-01",
        "FEquResValTime": "1900-01-01",
        "FEquRefTime": "1900-01-01",
        "FOrgId": {
            "FNumber": ""
        },
        "FProductLineId": {
...
单据头：FBillHead 
	 ...
	 单据状态：FBillStatus 
	 返回结果：FReturnResult 
	 调用开始时间：FCallStartTime 
	 调用结束时间：FCallEndTime 
	 返回消息：FMessage 
	 参数信息：FParamInfo 
	 会话ID：FRequestId 
	 设备端点击时间：FEquClickTime 
	 设备端接收返回值时间：FEquResValTime 
	 设备端刷新完成时间：FEquRefTime 
	 组织：FOrgId 
	 产线：FProductLineId 
	 生产订单：FMOMessage 
	 序列号：FSerialNo 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_WebApiReqLog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAPIName":"","FUserId":{"FUserID":""},"FDatetime":"1900-01-01","FReqResult":"","FBillNo":"","FReturnResult":"","FParamInfo":"","FCallStartTime":"1900-01-01","FCallEndTime":"1900-01-01","FMessage":"","FRequestId":"","FEquClickTime":"1900-01-01","FEquResValTime":"1900-01-01","FEquRefTime":"1900-01-01","FOrgId":{"FNumber":""},"FProductLineId":{"FNUMBER":""},"FMOMessage":"","FProductNo":"","FSerialNo":"","FEquipmentId":{"FNUMBER":""},"FEqmNo":"","FProcessId":{"FNUMBER":""},"FTrackNumber":"","FGatherNo":"","FOpSeqId":"","FProcessType":"","FOpSeqType":"","FRunTime":0}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_WebApiReqLog","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SFC_WebApiReqLog","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_WebApiReqLog"}");

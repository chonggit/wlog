# 定时智能采购 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 定时智能采购
...
client.Delete("PUR_SCHEDULEPURCHASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_SCHEDULEPURCHASE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_SCHEDULEPURCHASE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FPlanBeginDate":"1900-01-01","FExecuteTime":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteInterval":0,"FExecuteIntervalUnit":"","FPlanScheme":{"FNUMBER":""},"FPurOrgId":{"FNumber":""},"FBeginDate":"1900-01-01","FReqOrgId":{"FNumber":""},"FMaterialTo":{"FNUMBER":""},"FEndDate":"1900-01-01","FMaterialFrom":{"FNUMBER":""},"FNeedDraftData":"false","FSafeStockAsDemand":"false","FAutoNextTime":"false","FByMonth":"false","FByWeek":"false","FByAfterDay":"false","FDiffDay":0,"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FNeedDraftData": "false",
        "FSafeStockAsDemand": "false",
        "FAutoNextTime": "false",
        "FByMonth": "false",
        "FByWeek": "false",
        "FByAfterDay": "false",
...
单据头：FBillHead 
	 ...
	 物料编码：FMaterialFrom 
	 仓库：FMStockId 
	 采购申请保存失败时暂存单据：FNeedDraftData 
	 物料分组：FMaterialGroup 
	 无需求单据安全库存作为独立需求：FSafeStockAsDemand 
	 指定日期自动滚动计算：FAutoNextTime 
	 按当前自然月计算：FByMonth 
	 按当前自然周计算：FByWeek 
	 按当前日期后多少天前：FByAfterDay 
	 指定天数：FDiffDay 
	 计划名称：FScheduledId 
	 审核人：FApproverId 
	 审核日期：FApproveDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PUR_SCHEDULEPURCHASE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FPlanBeginDate":"1900-01-01","FExecuteTime":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteInterval":0,"FExecuteIntervalUnit":"","FPlanScheme":{"FNUMBER":""},"FPurOrgId":{"FNumber":""},"FBeginDate":"1900-01-01","FReqOrgId":{"FNumber":""},"FMaterialTo":{"FNUMBER":""},"FEndDate":"1900-01-01","FMaterialFrom":{"FNUMBER":""},"FNeedDraftData":"false","FSafeStockAsDemand":"false","FAutoNextTime":"false","FByMonth":"false","FByWeek":"false","FByAfterDay":"false","FDiffDay":0,"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_SCHEDULEPURCHASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_SCHEDULEPURCHASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_SCHEDULEPURCHASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_SCHEDULEPURCHASE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_SCHEDULEPURCHASE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_SCHEDULEPURCHASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PUR_SCHEDULEPURCHASE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_SCHEDULEPURCHASE"}");

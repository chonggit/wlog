# 物料SN条码管理 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 物料SN条码管理
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1476 |
| 分组信息查询 | QueryGroupInfo | 1189 |
| 分组删除 | GroupDelete | 1089 |
...
client.Delete("UN_MaterialSNBarCodeManage","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_MaterialSNBarCodeManage","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FOrgId":{"FNumber":""},"FSNIsStartUse":"false","FEntity":[{"FEntryID":0,"FRemark":"","FMariteilGroup":{"FNUMBER":""}}],"F_BusinessObject":[{"FEntryID":0,"FBusinessObject":{"FID":""},"FBillType":{"FNUMBER":""},"FRemarkBusiness":""}]}}");
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 组织：FOrgId 
	 所有物料默认启用SN条码管理：FSNIsStartUse 
物料信息：FEntity 
	 实体主键：FEntryID 
	 备注：FRemark 
	 物料分组：FMariteilGroup 
单据体：F_BusinessObject 
	 实体主键：FEntryID 
	 业务对象：FBusinessObject  (必填项)
	 备注：FRemarkBusiness 
	 单据类型：FBillType 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_MaterialSNBarCodeManage","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FOrgId":{"FNumber":""},"FSNIsStartUse":"false","FEntity":[{"FEntryID":0,"FRemark":"","FMariteilGroup":{"FNUMBER":""}}],"F_BusinessObject":[{"FEntryID":0,"FBusinessObject":{"FID":""},"FBillType":{"FNUMBER":""},"FRemarkBusiness":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UN_MaterialSNBarCodeManage","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("UN_MaterialSNBarCodeManage","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_MaterialSNBarCodeManage"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("UN_MaterialSNBarCodeManage","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("UN_MaterialSNBarCodeManage","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("UN_MaterialSNBarCodeManage","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

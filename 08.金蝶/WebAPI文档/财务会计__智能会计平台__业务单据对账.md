# 业务单据对账 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 智能会计平台 > 业务单据对账

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2359 |
...
client.GetSysReportData("GL_RPT_CustomCheckAccount","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FCURRENCY":"","FACCTBOOKID":{"FNUMBER":""},"FYear":"","FIsContainCheckBox":"false","FPeriod":"","FShowNoBalanceResult":"false","FScheme":{"FNUMBER":""},"FIsContainAdjustPeriodBox":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FYear": "",
        "FIsContainCheckBox": "false",
        "FPeriod": "",
        "FShowNoBalanceResult": "false",
        "FScheme": {
            "FNUMBER": ""
        },
        "FIsContainAdjustPeriodBox": "false"
    }
}
...
五、字段说明：
	 ...
	 会计期间：FPeriod  (必填项)
	 账簿：FACCTBOOKID  (必填项)
	 仅显示不平衡的对账结果：FShowNoBalanceResult 
	 包含未过账凭证：FIsContainCheckBox 
	 对账方案：FScheme  (必填项)
	 币别：FCURRENCY  (必填项)
	 包含调整期凭证：FIsContainAdjustPeriodBox 

# 基础资料完整性展示 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 标准成本分析 > 基础资料完整性展示

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3685 |
...
client.GetSysReportData("CA_PRODUCTCOMPLETERPT","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FYear":"","FEndYear":"","FPeriod":"","FEndPeriod":"","FVERSIONID":{"FNUMBER":""},"FSTARTPRODUCTID":{"FNUMBER":""},"FENDPRODUCTID":{"FNUMBER":""},"FISSHOWMATERIA":"false","FISSHOWDETAIL":"false","FSHOWTYPE":"","FCURRENCYID":{"FNUMBER":""},"FBYFILTER":"","FBYMATERIALPROPERTIES":"","FBYBOMUSE":"","FMATERIALPROPERTIES":"","FBOMUSE":""}}");
...
五、字段说明：
	 ...
	 版本名称：FBaseProperty 
	 单选按钮组：FBYFILTER 
	 按物料属性查询：FBYMATERIALPROPERTIES 
	 按BOM用途查询：FBYBOMUSE 
	 物料属性：FMATERIALPROPERTIES 
	 BOM用途：FBOMUSE 

参数FieldKeys显示列：
	 产品编码：FProduct_Number 
	 产品名称：FPRODUCT_NAME 
	 规格型号：FMODEL 
	 物料属性：FMaterialProperties 
	 基础单位：FBASICUNITID 
	 ...
	 标准成本：FCostAmount 
	 成本BOM设置：FCABOMSET 
	 外购物料标准价目表：FPURSTDPRICE 
	 标准工时维护：FWorkHour 
	 标准费率维护：FRATESET 
	 产品委外加工价目表：FOUTSTDPRICE 
	 基础资料完整性：FComplete 

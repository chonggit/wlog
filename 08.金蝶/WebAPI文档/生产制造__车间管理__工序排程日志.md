# 工序排程日志 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 工序排程日志
...
client.Delete("SFC_SchedulingLog","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_SchedulingLog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FSchedulingModelId":{"FNUMBER":""},"FDescription":"","FSchedulingWay":"","FConsiderIterate":"false","FConsiderSplit":"false","FReSchConfirmed":"false","FReSchReleased":"false","FAutoForwardSch":"false","FConsiderQueueTime":"","FConsiderMoveTime":"","FConsiderWaitTime":"","FProOrgId":{"FNumber":""},"FSchedulingStatus":"","FCalcStartTime":"1900-01-01","FCalcFinishTime":"1900-01-01","FSchedulingModeSetting":"","FEntity":[{"FENTRYID":0,"FEntrySeq":0,"FOPNumber":"","FSeqNumber":"","FOperNumber":0,"FErrorType":"","FErrDescription":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDescription": "",
        "FSchedulingWay": "",
        "FConsiderIterate": "false",
        "FConsiderSplit": "false",
        "FReSchConfirmed": "false",
        "FReSchReleased": "false",
        "FAutoForwardSch": "false",
        "FConsiderQueueTime": "",
        "FConsiderMoveTime": "",
        "FConsiderWaitTime": "",
        "FProOrgId": {
        ...
        "FSchedulingStatus": "",
        "FCalcStartTime": "1900-01-01",
        "FCalcFinishTime": "1900-01-01",
        "FSchedulingModeSetting": "",
        "FEntity": [
            {
                "FENTRYID": 0,
                "FEntrySeq": 0,
...
单据头：FBillHead 
	 ...
	 作废状态：FCancelStatus 
	 备注：FDescription 
	 考虑等待时间：FConsiderWaitTime 
	 考虑排队时间：FConsiderQueueTime 
	 倒排时间在过去时自动按当前日期正排：FAutoForwardSch 
	 考虑转移时间：FConsiderMoveTime 
	 考虑工序重叠：FConsiderIterate 
	 排程方法：FSchedulingWay 
	 重排已确认计划：FReSchConfirmed 
	 考虑工序拆分：FConsiderSplit 
	 排程模型编码：FSchedulingModelId 
	 排程模型名称：FSchedulingModelName 
	 生产组织：FProOrgId 
	 排程状态：FSchedulingStatus 
	 计算开始时间：FCalcStartTime 
	 计算结束时间：FCalcFinishTime 
	 排程模型设置：FSchedulingModeSetting 
	 重排已下达计划：FReSchReleased 
日志信息：FEntity 
	 实体主键：FENTRYID 
	 行号：FEntrySeq 
	 工序计划编号：FOPNumber 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_SchedulingLog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FSchedulingModelId":{"FNUMBER":""},"FDescription":"","FSchedulingWay":"","FConsiderIterate":"false","FConsiderSplit":"false","FReSchConfirmed":"false","FReSchReleased":"false","FAutoForwardSch":"false","FConsiderQueueTime":"","FConsiderMoveTime":"","FConsiderWaitTime":"","FProOrgId":{"FNumber":""},"FSchedulingStatus":"","FCalcStartTime":"1900-01-01","FCalcFinishTime":"1900-01-01","FSchedulingModeSetting":"","FEntity":[{"FENTRYID":0,"FEntrySeq":0,"FOPNumber":"","FSeqNumber":"","FOperNumber":0,"FErrorType":"","FErrDescription":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_SchedulingLog","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SFC_SchedulingLog","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SFC_SchedulingLog","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SFC_SchedulingLog","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SFC_SchedulingLog","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("SFC_SchedulingLog","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_SchedulingLog","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_SchedulingLog","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SFC_SchedulingLog","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_SchedulingLog"}");

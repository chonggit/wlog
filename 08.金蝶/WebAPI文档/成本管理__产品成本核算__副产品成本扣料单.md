# 副产品成本扣料单 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 副产品成本扣料单
...
client.Delete("CB_BYPRODUCTMATDEDUCTION","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_BYPRODUCTMATDEDUCTION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FACCTGSYSTEMID":{"FNUMBER":""},"FACCTPOLICYID":{"FNUMBER":""},"FACCTGORGID":{"FNumber":""},"FPROORDERTYPE":"","FPROORDERNO":"","FPROORDERSEQ":"","FCOSTCENTERID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FYEAR":0,"FPERIOD":0,"FDATE":"1900-01-01","FSRCDATATYPE":"","FEntity":[{"FEntryID":0,"FMATERIALID":{"FNUMBER":""}}]}}");
...
单据头：FBillHead 
	 ...
	 审核日期：FAUDITTIME 
	 产品名称：FProductName 
	 规格型号：FProductSpecification 
	 产品基本单位：FPBASEUNITID 
	 单据维度内码：FPRODUCTDIMEID 
	 业务类型：FPROORDERTYPE 
	 订单编号：FPROORDERID 
	 生产编号：FPROORDERNO 
	 订单行号：FPROORDERSEQ 
...
单据体：FEntity 
	 实体主键：FEntryID 
	 子项物料编码：FMATERIALID  (必填项)
	 费用类型：FEXPTYPE 
	 成本项目：FCOSTITEMID 
	 子项物料名称：FMATERIALNAME 
	 费用项目：FEXPENSESITEMID 
	 累计投入数量：FSUMQTY 
	 累计投入金额：FSUMAMOUNT 
	 子项物料基本单位：FBASEUNITID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_BYPRODUCTMATDEDUCTION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FACCTGSYSTEMID":{"FNUMBER":""},"FACCTPOLICYID":{"FNUMBER":""},"FACCTGORGID":{"FNumber":""},"FPROORDERTYPE":"","FPROORDERNO":"","FPROORDERSEQ":"","FCOSTCENTERID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FYEAR":0,"FPERIOD":0,"FDATE":"1900-01-01","FSRCDATATYPE":"","FEntity":[{"FEntryID":0,"FMATERIALID":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_BYPRODUCTMATDEDUCTION","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_BYPRODUCTMATDEDUCTION","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_BYPRODUCTMATDEDUCTION"}");

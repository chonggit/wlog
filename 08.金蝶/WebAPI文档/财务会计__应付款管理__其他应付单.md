# 其他应付单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应付款管理 > 其他应付单
...
client.Delete("AP_OtherPayable","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AP_OtherPayable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FDATE":"1900-01-01","FENDDATE_H":"1900-01-01","FISINIT":"false","FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FTOTALAMOUNTFOR_H":0,"FNOTSETTLEAMOUNTFOR":0,"FSETTLEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FPAYORGID":{"FNumber":""},"FPURCHASEORGID":{"FNumber":""},"FPURCHASEDEPTID":{"FNumber":""},"FPURCHASERGROUPID":{"FNumber":""},"FPURCHASERID":{"FNumber":""},"FRemarks":"","FScanPoint":{"FNUMBER":""},"FSettleTypeID":{"FNumber":""},"FMAINBOOKSTDCURRID":{"FNumber":""},"FEXCHANGETYPE":{"FNumber":""},"FExchangeRate":0,"FNOTAXAMOUNT":0,"FTAXAMOUNT":0,"FACCNTTIMEJUDGETIME":"1900-01-01","FCancelStatus":"","FBUSINESSTYPE":"","FHisLoanBalanceFor":0,"FPRESETBASE1":{"FNUMBER":""},"FPRESETBASE2":{"FNUMBER":""},"FPRESETASSISTANT1":{"FNumber":""},"FPRESETASSISTANT2":{"FNumber":""},"FPRESETTEXT1":"","FPRESETTEXT2":"","F_ora_Text_qtr":"","F_ora_Text_83g":"","F_ora_Text_re5":"","F_ora_Text_apv":"","F_ora_GYS":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FCOSTID":{"FNumber":""},"FCOSTDEPARTMENTID":{"FNumber":""},"FINVOICETYPE":"","FEntryTaxRate":0,"FNOTAXAMOUNTFOR":0,"FTAXAMOUNTFOR":0,"FTOTALAMOUNTFOR":0,"FNOTSETTLEAMOUNTFOR_D":0,"FNOTAXAMOUNT_D":0,"FTAXAMOUNT_D":0,"FCOMMENT":"","FSOURCETYPE":"","FSourceBillNo":"","FCREATEINVOICE":"false","FIVAmountFor":0,"F_ora_Text_re51":"","F_ZFXM1":{"FNumber":""},"FPaySubEntity":[{"FDetailID":0}]}]}}");
...
单据头：FBillHead 
	 ...
	 修改人：FModifierId 
	 创建人：FCreatorId 
	 未借款金额：FNOTSETTLEAMOUNTFOR 
	 表头基本 - 付款核销状态：FWRITTENOFFSTATUS 
	 表头基本 - 付（退）款单的关联金额：FRelateHadPayAmount 
	 未借款金额本位币：FNOTSETTLEAMOUNT 
	 来源系统：FSOURCESYSTEM 
	 申请部门：FDEPARTMENTID 
	 总金额：FTOTALAMOUNTFOR_H 
	 总金额本位币：FTOTALAMOUNT_H 
	 已付款核销金额：FWRITTENOFFAMOUNTFOR 
	 是否期初单据：FISINIT 
	 ...
	 报销模式：F_ora_Text_apv 
	 供应商：F_ora_GYS 
	 供应商简称：F_ora_BaseProperty_83g 
单据体：FEntity 
	 实体主键：FEntryID 
	 费用项目编码：FCOSTID  (必填项)
	 总金额：FTOTALAMOUNTFOR 
	 已借款金额：FLOANAMOUNTFOR 
	 未借款金额：FNOTSETTLEAMOUNTFOR_D 
	 备注：FCOMMENT 
	 费用项目名称：FCOSTNAME 
	 总金额本位币：FTOTALAMOUNT 
	 未借款金额本位币：FNOTSETTLEAMOUNT_D 
	 已借款金额本位币：FLOANAMOUNT 
	 付款单号：FPayBillNO 
	 ...
	 表体-付（退）款单的关联金额：FRELATEHADPAYAMOUNT_D 
	 付款申请关联金额：FAPPLYAMOUNT 
	 源单类型：FSOURCETYPE 
	 源单编号：FSourceBillNo 
	 核销状态：FWRITTENOFFSTATUS_D 
	 已核销金额：FWRITTENOFFAMOUNTFOR_D 
	 发票类型：FINVOICETYPE  (必填项)
	 已生成发票：FCREATEINVOICE 
	 税率(%) ：FEntryTaxRate 
	 付（退）款单关联金额本位币：FWRITTENOFFAMOUNT 
	 已开票金额：FIVAmountFor 
	 已付款申请关联金额：FAMOUNTPAID 
	 未核销金额：FNOTWRITTENOFFAMOUNTFOR 
	 部门属性：F_AT_BaseProperty 
	 云之家摘要：F_ora_Text_re51 
	 政府项目：F_ZFXM1 
关联付款子单体：FPaySubEntity 
	 实体主键：FDetailID 
	 付款单FID：FPayFID 
	 单据编号：FPayNO 
	 明细EntryID：FPayEntryID 
	 可用金额：FPAYMAXAMOUNTFOR 
	 本次借款金额：FRELATEAMOUNTFOR 
关联关系表：FEntity_Link 
	 实体主键：FLinkId 
	 ...
	 原始携带量：FEntity_Link_FTOTALAMOUNTFOROld 
	 修改携带量：FEntity_Link_FTOTALAMOUNTFOR 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AP_OtherPayable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FDATE":"1900-01-01","FENDDATE_H":"1900-01-01","FISINIT":"false","FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FTOTALAMOUNTFOR_H":0,"FNOTSETTLEAMOUNTFOR":0,"FSETTLEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FPAYORGID":{"FNumber":""},"FPURCHASEORGID":{"FNumber":""},"FPURCHASEDEPTID":{"FNumber":""},"FPURCHASERGROUPID":{"FNumber":""},"FPURCHASERID":{"FNumber":""},"FRemarks":"","FScanPoint":{"FNUMBER":""},"FSettleTypeID":{"FNumber":""},"FMAINBOOKSTDCURRID":{"FNumber":""},"FEXCHANGETYPE":{"FNumber":""},"FExchangeRate":0,"FNOTAXAMOUNT":0,"FTAXAMOUNT":0,"FACCNTTIMEJUDGETIME":"1900-01-01","FCancelStatus":"","FBUSINESSTYPE":"","FHisLoanBalanceFor":0,"FPRESETBASE1":{"FNUMBER":""},"FPRESETBASE2":{"FNUMBER":""},"FPRESETASSISTANT1":{"FNumber":""},"FPRESETASSISTANT2":{"FNumber":""},"FPRESETTEXT1":"","FPRESETTEXT2":"","F_ora_Text_qtr":"","F_ora_Text_83g":"","F_ora_Text_re5":"","F_ora_Text_apv":"","F_ora_GYS":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FCOSTID":{"FNumber":""},"FCOSTDEPARTMENTID":{"FNumber":""},"FINVOICETYPE":"","FEntryTaxRate":0,"FNOTAXAMOUNTFOR":0,"FTAXAMOUNTFOR":0,"FTOTALAMOUNTFOR":0,"FNOTSETTLEAMOUNTFOR_D":0,"FNOTAXAMOUNT_D":0,"FTAXAMOUNT_D":0,"FCOMMENT":"","FSOURCETYPE":"","FSourceBillNo":"","FCREATEINVOICE":"false","FIVAmountFor":0,"F_ora_Text_re51":"","F_ZFXM1":{"FNumber":""},"FPaySubEntity":[{"FDetailID":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AP_OtherPayable","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AP_OtherPayable","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AP_OtherPayable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AP_OtherPayable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AP_OtherPayable","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("AP_OtherPayable","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AP_OtherPayable","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AP_OtherPayable"}");

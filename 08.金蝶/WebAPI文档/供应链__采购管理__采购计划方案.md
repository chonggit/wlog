# 采购计划方案 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 采购计划方案
...
client.Delete("PUR_PlanScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_PlanScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_PlanScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FIncludeInvQty":"false","FIncludeMinOrderQty":"false","FIncludeSafeStock":"false","FISSYSPRESET":"false","FForbiderId":{"FUserID":""},"FForbidDate":"1900-01-01","FIncludeMinusStockQty":"false","FIncludeOrderBatchQty":"false","FIncludePurLeadTime":"false","FIndependDemandSupply":"false","FIncludeMRPStock":"false","FSumByMaterial":"false","FSumByAuxProp":"false","FSumByDemandDate":"false","FIncludeLockStock":"false","FCALCTOTALDEMAND":"false","FNoAuxProp":"false","FPlanDemand":[{"FEntryID":0,"FDemandFormId":{"FNUMBER":""},"FInOutType":"","FNote":"","FUnitIdName":"","FDeFormulaDesp":"","FDeFormulaExp":"","FUnitIdKey":"","FDemandBillTypeId":"","FDemandBillTypeName":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIncludeInvQty": "false",
        "FIncludeMinOrderQty": "false",
        "FIncludeSafeStock": "false",
        "FISSYSPRESET": "false",
        "FForbiderId": {
            "FUserID": ""
        },
        "FForbidDate": "1900-01-01",
        "FIncludeMinusStockQty": "false",
        "FIncludeOrderBatchQty": "false",
        "FIncludePurLeadTime": "false",
        "FIndependDemandSupply": "false",
        "FIncludeMRPStock": "false",
        "FSumByMaterial": "false",
        "FSumByAuxProp": "false",
        "FSumByDemandDate": "false",
        "FIncludeLockStock": "false",
        "FCALCTOTALDEMAND": "false",
        "FNoAuxProp": "false",
        "FPlanDemand": [
            {
                "FEntryID": 0,
...
单据头：FBillHead 
	 ...
	 创建日期：FCreateDate 
	 修改日期：FModifyDate 
	 考虑现有库存：FIncludeInvQty 
	 考虑安全库存：FIncludeSafeStock 
	 考虑最小订货量：FIncludeMinOrderQty 
	 是否系统预置：FISSYSPRESET 
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 禁用日期：FForbidDate 
	 禁用人：FForbiderId 
	 负库存作为需求：FIncludeMinusStockQty 
	 考虑订货批量：FIncludeOrderBatchQty 
	 考虑采购提前期：FIncludePurLeadTime 
	 按需求独立生成供给：FIndependDemandSupply 
	 仓库运行MRP的控制：FIncludeMRPStock 
	 物料：FSumByMaterial 
	 辅助属性：FSumByAuxProp 
	 需求日期：FSumByDemandDate 
	 考虑锁库：FIncludeLockStock 
	 计算总需求：FCALCTOTALDEMAND 
	 不考虑物料辅助属性：FNoAuxProp 
	 库存状态：FStockStatusIds 
供需单据体：FPlanDemand 
	 实体主键：FEntryID 
	 单据名称：FDemandFormId  (必填项)
	 出入库类型：FInOutType  (必填项)
	 单据类型_作废：FDemandBillTypeId_old 
	 供货说明：FNote 
	 计算公式：FDeFormulaDesp 
	 计算公式公式：FDeFormulaExp 
	 生效状态：FBillStatus 
	 单位Key：FUnitIdKey 
	 单位：FUnitIdName 
	 单据类型：FDemandBillTypeId 
	 单据类型名称：FDemandBillTypeName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_PlanScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_PlanScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_PlanScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PlanScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_PlanScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_PlanScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_PlanScheme"}");

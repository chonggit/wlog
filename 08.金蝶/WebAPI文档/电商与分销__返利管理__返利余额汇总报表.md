# 返利余额汇总报表 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 返利管理 > 返利余额汇总报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2657 |
...
client.GetSysReportData("RPM_RptSumAccountBalance","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSaleOrgList":"","FDateFrom":"1900-01-01","FDateTo":"1900-01-01","FCustFrom":{"FNumber":""},"FCustTo":{"FNumber":""},"FAccountFrom":{"FNUMBER":""},"FAccountTo":{"FNUMBER":""},"FRadioGroupCust":"","FRadioCustomRange":"","FRadioCustom":"","FMulCustom":[{"FNumber":""}]}}");
...
五、字段说明：
	 ...
	 返利账户：FAccountFrom 
	 至：FAccountTo 
	 单选按钮组：FRadioGroupCust 
	 客户范围：FRadioCustomRange 
	 客户：FRadioCustom 
	 客户：FMulCustom 

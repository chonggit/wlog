# ABC分析 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > ABC分析

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2894 |
...
client.GetSysReportData("STK_ABCAnalyzation","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FStockOrgId":{"FNUMBER":""},"FCurrencyId":{"FNumber":""},"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FBeginMaterial":{"FNumber":""},"FEndMaterial":{"FNumber":""},"FGroupRule":"","FRuleMode":"","FABCEntityFilter":[{"FGroupNumber":"","FGroupName":"","FValue":0,"FRatio":0}]}}");
...
五、字段说明：
	 ...
	 至：FEndMaterial 
	 分组规则：FGroupRule  (必填项)
	 规则设置方式：FRuleMode  (必填项)
	 币别：FCurrencyId  (必填项)
	 分组编码：FGroupNumber  (必填项)
	 分组名称：FGroupName 
	 数值：FValue 
	 比例%：FRatio 

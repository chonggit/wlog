# 云巡检报表 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 云巡检报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 1809 |
...
client.GetSysReportData("HS_PatrolReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FStartDate":"1900-01-01","FEndDate":"1900-01-01"}}");

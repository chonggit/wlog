# 物料计价方法变更 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 物料计价方法变更
...
client.Delete("HS_VALUATIONMETHODCHANGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("HS_VALUATIONMETHODCHANGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FVALUATIONMETHODID":0,"FBillNo":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FACCTGRANGEID":{"FNumber":""},"FRANGEGroup":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FAuditDate":"1900-01-01","FDEFCHANGEDMETHOD":"","FEntity":[{"FEntryID":0,"FMaterialID":{"FNumber":""},"FMaterialType":{"FNumber":""},"FMaterialProperties":"","FOLDVALUATIONMETHOD":"","FNEWVALUATIONMETHOD":"","FOLDVALUATIONMETHODID":"","FOLDENTRYID":""}]}}");
...
五、字段说明：
单据头：FBillHead 
	 实体主键：FVALUATIONMETHODID 
	 单据编号：FBillNo 
	 数据状态：FDocumentStatus 
	 核算体系编码：FACCTGSYSTEMID 
	 核算体系名称：FACCTGSYSTEMNAME 
	 核算组织编码：FACCTGORGID 
	 核算组织名称：FACCTGORGNAME 
	 会计政策编码：FACCTPOLICYID 
	 会计政策名称：FAcctPolicyName 
	 核算范围编码：FACCTGRANGEID  (必填项)
	 核算范围名称：FACCTGRANGENAME 
	 批量变更方式：FRANGEGroup  (必填项)
	 存货类别：FMaterialTypeHead 
	 物料属性：FMaterialPropertiesHead 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 审核人：FAuditId 
	 审核日期：FAuditDate 
	 默认变更计价方法：FDEFCHANGEDMETHOD  (必填项)
单据体：FEntity 
	 实体主键：FEntryID 
	 存货类别：FMaterialType 
	 物料属性：FMaterialProperties 
	 物料编码：FMaterialID  (必填项)
	 物料名称：FMaterialName 
	 原计价方法：FOLDVALUATIONMETHOD 
	 更改后计价方法：FNEWVALUATIONMETHOD  (必填项)
	 原物料计价方法内码：FOLDVALUATIONMETHODID 
	 原分录行内码：FOLDENTRYID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("HS_VALUATIONMETHODCHANGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FVALUATIONMETHODID":0,"FBillNo":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FACCTGRANGEID":{"FNumber":""},"FRANGEGroup":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FAuditDate":"1900-01-01","FDEFCHANGEDMETHOD":"","FEntity":[{"FEntryID":0,"FMaterialID":{"FNumber":""},"FMaterialType":{"FNumber":""},"FMaterialProperties":"","FOLDVALUATIONMETHOD":"","FNEWVALUATIONMETHOD":"","FOLDVALUATIONMETHODID":"","FOLDENTRYID":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("HS_VALUATIONMETHODCHANGE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("HS_VALUATIONMETHODCHANGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("HS_VALUATIONMETHODCHANGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"HS_VALUATIONMETHODCHANGE"}");

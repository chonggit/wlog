# 未提货商品库龄分析表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 未提货商品库龄分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2180 |
...
client.GetSysReportData("RESP_WTHSPFXB","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"F_RESP_WL":{"FNUMBER":""},"F_RESP_PC":{"FNUMBER":""},"F_RESP_CQTS":0,"F_RESP_ZZ":[{"FNumber":""}],"F_RESP_CKLB":[{"FNumber":""}]}}");

...
client.Save("BAS_MsgSetting","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FMsgNumber":"","FName":"","FMsgType":"","FObjectId":{"FID":""},"FTriggerAction":"","FTriggerActName":"","FMsgLEVEL":"","FSendTime":"1900-01-01","FSendConditionId":{"FID":""},"FIsSendMobileMsg":"false","FIsSendMailMSG":"false","FIsSendLightAppMsg":"false","FISSENDCENTERMSG":"false","FIsSysPreset":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FMsgReceiverId":{"FID":""},"FMsgModelId":{"FNUMBER":""},"FIsSendAdMsg":"false","FIsOnLineSync":"false","FIsSendInfoMsg":"false","FEnablePer":{"FUserID":""},"FEnableTime":"1900-01-01","FSendAdMethor":"","FSendOnce":"false","FTriggerTime":"","FOpenMsgObject":"false","FOpenMsgCustom":"false","FOpenMsgPlugin":"","FOpenInDetailForm":"false","FOpenInPopForm":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FTriggerActName": "",
        "FMsgLEVEL": "",
        "FSendTime": "1900-01-01",
        "FSendConditionId": {
            "FID": ""
        },
        "FIsSendMobileMsg": "false",
        "FIsSendMailMSG": "false",
        "FIsSendLightAppMsg": "false",
        "FISSENDCENTERMSG": "false",
        "FIsSysPreset": "false",
        "FCreatorId": {
            "FUserID": ""
        },
        ...
        "FIsSendAdMsg": "false",
        "FIsOnLineSync": "false",
        "FIsSendInfoMsg": "false",
        "FEnablePer": {
            "FUserID": ""
        },
        "FEnableTime": "1900-01-01",
        "FSendAdMethor": "",
        "FSendOnce": "false",
        "FTriggerTime": "",
        "FOpenMsgObject": "false",
        "FOpenMsgCustom": "false",
        "FOpenMsgPlugin": "",
        "FOpenInDetailForm": "false",
        "FOpenInPopForm": "false"
    }
}
...
单据头：FBillHead 
	 ...
	 业务对象：FObjectId 
	 触发操作：FTriggerAction 
	 触发操作：FTriggerActName 
	 消息级别：FMsgLEVEL  (必填项)
	 发送时间：FSendTime 
	 消息发送条件ID：FSendConditionId 
	 第三方消息：FIsSendMobileMsg 
	 邮件：FIsSendMailMSG 
	 消息轻应用：FIsSendLightAppMsg 
	 消息通知：FISSENDCENTERMSG 
	 系统预置：FIsSysPreset 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 ...
	 禁用状态：FForbidStatus 
	 启用状态：FStatus 
	 消息接收人ID：FMsgReceiverId 
	 消息模板：FMsgModelId  (必填项)
	 公告消息是否发送（隐藏）：FIsSendAdMsg 
	 是否来源线上同步（隐藏）：FIsOnLineSync 
	 信息中心：FIsSendInfoMsg 
	 子系统：FSubSysid 
	 启用/停用人：FEnablePer 
	 启用/停用日期：FEnableTime 
	 发送方式：FSendAdMethor 
	 发送一次：FSendOnce 
	 触发时机：FTriggerTime  (必填项)
	 打开消息设置的业务对象单据：FOpenMsgObject 
	 自定义打开内容（可通过插件定义消息打开内容）：FOpenMsgCustom 
	 消息查看插件：FOpenMsgPlugin 
	 从消息详细信息窗口操作打开：FOpenInDetailForm 
	 从消息内容点击直接打开：FOpenInPopForm 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_MsgSetting","Start","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_MsgSetting","Stop","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_MsgSetting","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_MsgSetting","UnForbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("BAS_MsgSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BAS_MsgSetting","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BAS_MsgSetting","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BAS_MsgSetting"}");

# 第三方物流网点 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > B2C电商中心 > 第三方物流网点
...
client.View("ECC_CNLogisticsCom","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("ECC_CNLogisticsCom","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ECC_CNLogisticsCom","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCode":"","FShopType":"","FSHOPID":{"FNumber":""},"FCpType":"","FPTLogisticsComId":{"FCODE":""},"FSettlementCode":"","FCNBranchAccount":[{"FEntryID":0,"FBranchAccountId":{"FCode":""},"FBranchAccountAddress":[{"FDetailID":0,"FProvince":"","FCity":"","FDistrict":"","FTown":"","FDetail":""}]}]}}");
...
菜鸟物流公司：FBillHead 
	 ...
	 网店：FSHOPID 
	 物流服务商业务类型：FCpType 
	 平台物流公司：FPTLogisticsComId 
	 财务结算编码：FSettlementCode 
网点：FCNBranchAccount 
	 实体主键：FEntryID 
	 菜鸟网点：FBranchAccountId 
	 网点代码：FBranchAccountCode 
	 网点名称：FBranchAccountName 
	 已用面单数量：FAllocatedquantity 
	 网点状态：FStatus 
	 取消的面单总数：FCancelquantity 
	 已经打印的面单总数：FPrintquantity 
	 电子面单余额数量：FQuantitty 
网点地址：FBranchAccountAddress 
	 实体主键：FDetailID 
	 省名称（一级地址）：FProvince 
	 市名称（二级地址）：FCity 
	 区名称（三级地址）：FDistrict 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ECC_CNLogisticsCom"}");

# 旗舰发票云连接设置 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 旗舰发票云连接设置
...
client.Delete("IV_GTUltSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IV_GTUltSetting","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FGTULTSYSTEMURL":"","FULTAPPID":"","FULTAPPSECRET":"","FULTTENANTID":"","FULTDATACENTERID":"","FLANGUAGE":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FGWIDENTITYREMARK":"","FbusinessSystemCode":"","FAESKey":"","FencodeType":"","FGTULTGSETTINGENTRY":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FCOMPANYNAME":"","FTAXNUMBER":"","FMAILINFO":"","FMAILPHONEINFO":"","FBANKINFO":"","FBANKACCOUNTINFO":""}],"FGTULTACCOUNTENTRY":[{"FEntryID":0,"FULTCOMPANYNAME":"","FULTTAXNUMBER":"","FELECTRONICPLATFORMACCOUNT":"","FELECTRONICTAXADMIN":"","FISDEFAULTOPEN":"false","FISDEFAULTRECEIVE":"false"}]}}");
        ...
        "FGTULTACCOUNTENTRY": [
            {
                ...
                "FULTCOMPANYNAME": "",
                "FULTTAXNUMBER": "",
                "FELECTRONICPLATFORMACCOUNT": "",
                "FELECTRONICTAXADMIN": "",
                "FISDEFAULTOPEN": "false",
                "FISDEFAULTRECEIVE": "false"
            }
        ]
    }
}
...
单据头：FBillHead 
	 实体主键：FID 
	 单据编号：FBillNo 
	 旗舰发票云地址：FGTULTSYSTEMURL  (必填项)
	 第三方应用ID：FULTAPPID  (必填项)
	 第三方应用Secret：FULTAPPSECRET  (必填项)
	 租户ID：FULTTENANTID  (必填项)
	 租户数据中心ID：FULTDATACENTERID  (必填项)
	 语言：FLANGUAGE 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 旗舰版网关认证信息：FGWIDENTITYREMARK 
	 业务系统编码：FbusinessSystemCode 
	 AES秘钥：FAESKey 
	 数据加密策略：FencodeType 
组织信息：FGTULTGSETTINGENTRY 
	 实体主键：FEntryID 
	 ...
	 企业开户行：FBANKINFO 
	 默认：FISDEFAULT 
	 默认收票账号：FDEFAULTRECEIVEACCOUNT 
	 默认开票账号：FDEFAULTOPENACCOUNT 
	 企业电话：FMAILPHONEINFO 
	 企业开户行账号：FBANKACCOUNTINFO 
数电账号：FGTULTACCOUNTENTRY 
	 实体主键：FEntryID 
	 企业名称：FULTCOMPANYNAME 
	 企业纳税人识别号：FULTTAXNUMBER 
	 数电票服务平台账号：FELECTRONICPLATFORMACCOUNT 
	 电子税局权限：FELECTRONICTAXADMIN 
	 默认开票账号：FISDEFAULTOPEN 
	 默认收票账号：FISDEFAULTRECEIVE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IV_GTUltSetting","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FGTULTSYSTEMURL":"","FULTAPPID":"","FULTAPPSECRET":"","FULTTENANTID":"","FULTDATACENTERID":"","FLANGUAGE":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FGWIDENTITYREMARK":"","FbusinessSystemCode":"","FAESKey":"","FencodeType":"","FGTULTGSETTINGENTRY":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FCOMPANYNAME":"","FTAXNUMBER":"","FMAILINFO":"","FMAILPHONEINFO":"","FBANKINFO":"","FBANKACCOUNTINFO":""}],"FGTULTACCOUNTENTRY":[{"FEntryID":0,"FULTCOMPANYNAME":"","FULTTAXNUMBER":"","FELECTRONICPLATFORMACCOUNT":"","FELECTRONICTAXADMIN":"","FISDEFAULTOPEN":"false","FISDEFAULTRECEIVE":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IV_GTUltSetting","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("IV_GTUltSetting","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IV_GTUltSetting"}");

# 资金下拨单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 资金管理 > 资金下拨单
...
client.Delete("SC_FundsDown","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SC_FundsDown","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FBankID":{"FNUMBER":""},"FHSettleTypeID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FFundsOrgID":{"FNumber":""},"FTotalAmount":0,"FCount":0,"FDepositType":"","FBillTypeID":{"FNUMBER":""},"FScanPoint":{"FNUMBER":""},"FDescription":"","FMAINBOOKID":{"FNUMBER":""},"FEXCHANGERATE":0,"FEXCHANGETYPE":{"FNUMBER":""},"FPOSTDATE":"1900-01-01","FISFROMTRADEBANK":"false","FFundsDownEntry":[{"FEntryID":0,"FSettleTypeID":{"FNUMBER":""},"FOrgId":{"FNumber":""},"FEntryBankID":{"FNUMBER":""},"FOrgAccountID":{"FNUMBER":""},"FOrgInnerActID":{"FNUMBER":""},"FRECBILLID":{"FBILLNUMBER":""},"FPARAMOUNTFOR":0,"FAmount":0,"FSettleNo":"","FComment":"","FSourceBillType":"","FSourceBillNo":"","FLocAmount":0,"FSignature":""}]}}");
...
明细：FFundsDownEntry 
	 ...
	 流水号/对账码：FCHECKCODE 
	 签名：FSignature 
关联关系表：FFundsDownEntry_Link 
	 实体主键：FLinkId 
	 业务流程图：FFundsDownEntry_Link_FFlowId 
	 推进路线：FFundsDownEntry_Link_FFlowLineId 
	 转换规则：FFundsDownEntry_Link_FRuleId 
	 源单表内码：FFundsDownEntry_Link_FSTableId 
	 源单表：FFundsDownEntry_Link_FSTableName 
	 源单内码：FFundsDownEntry_Link_FSBillId 
	 源单分录内码：FFundsDownEntry_Link_FSId 
	 原始携带量：FFundsDownEntry_Link_FAmountOld 
	 修改携带量：FFundsDownEntry_Link_FAmount 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SC_FundsDown","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FBankID":{"FNUMBER":""},"FHSettleTypeID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FFundsOrgID":{"FNumber":""},"FTotalAmount":0,"FCount":0,"FDepositType":"","FBillTypeID":{"FNUMBER":""},"FScanPoint":{"FNUMBER":""},"FDescription":"","FMAINBOOKID":{"FNUMBER":""},"FEXCHANGERATE":0,"FEXCHANGETYPE":{"FNUMBER":""},"FPOSTDATE":"1900-01-01","FISFROMTRADEBANK":"false","FFundsDownEntry":[{"FEntryID":0,"FSettleTypeID":{"FNUMBER":""},"FOrgId":{"FNumber":""},"FEntryBankID":{"FNUMBER":""},"FOrgAccountID":{"FNUMBER":""},"FOrgInnerActID":{"FNUMBER":""},"FRECBILLID":{"FBILLNUMBER":""},"FPARAMOUNTFOR":0,"FAmount":0,"FSettleNo":"","FComment":"","FSourceBillType":"","FSourceBillNo":"","FLocAmount":0,"FSignature":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SC_FundsDown","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SC_FundsDown","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SC_FundsDown","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SC_FundsDown","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SC_FundsDown","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SC_FundsDown","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SC_FundsDown","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SC_FundsDown"}");

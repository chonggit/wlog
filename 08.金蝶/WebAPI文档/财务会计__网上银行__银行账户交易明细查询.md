# 银行账户交易明细查询 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 网上银行 > 银行账户交易明细查询

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2530 |
...
client.GetSysReportData("WB_Detail","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FStartDateF":"1900-01-01","FEndDateF":"1900-01-01","FCurrencyS":{"FNumber":""},"FSettleOrgIdF":{"FNumber":""},"FBankNoSF":{"FNumber":""}}}");
...
四、JSON格式数据：
{
    ...
    "FilterString": [],
    "Model": {
        "FStartDateF": "1900-01-01",
        "FEndDateF": "1900-01-01",
        "FCurrencyS": {
            "FNumber": ""
        },
        "FSettleOrgIdF": {

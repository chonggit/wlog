# 应收票据使用流水 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 应收票据使用流水

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2358 |
...
client.GetSysReportData("CN_BillRecReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FNotAudit":"false","FMyCurrency":"false","FOrgID":[{"FNumber":""}],"FCurrencyIds":"","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FCurrencyId":{"FNUMBER":""},"FPAYORGID":{"FNUMBER":""}}}");

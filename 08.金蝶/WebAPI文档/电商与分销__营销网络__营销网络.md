...
client.Delete("DRP_Channel","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("DRP_Channel","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("DRP_Channel","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FCHANNELID":0,"FChannelGroupID":{"FNumber":""},"FNumber":"","FDescription":"","FChannelOrgId":{"FNumber":""},"FName":"","FChannelClass":{"FNumber":""},"FChannelCustId":{"FNumber":""},"FShortName":"","FParentChannelId":{"FNumber":""},"FChannelTypeID":{"FNUMBER":""},"FOrgBranchID":{"FNUMBER":""},"FBaseAddress":"","FTel":"","FHead":"","FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FChannelSupplyId":{"FNUMBER":""},"FChannelBelong":{"FNumber":""},"FChannelDeptId":{"FNUMBER":""},"FLevelCode":"","FChannelType":"","FOrderChannelID":{"FNUMBER":""},"FReceiveChannelID":[{"FNumber":""}],"FSettleChannelID":{"FNUMBER":""},"FChannelNetRelation":"","FPersonEntity":[{"FEntryID":0,"FPersonID":{"FSTAFFNUMBER":""},"FMobile":"","FPersonTel":"","FPersonEmail":"","FAddress":""}],"FStockEntity":[{"FEntryID":0,"FStockOrgId":{"FNumber":""},"FStockId":{"FNUMBER":""},"FStockIsDRP":"false"}]}}");
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 备注：FDescription 
	 上级渠道：FParentChannelId 
	 对应组织：FChannelOrgId 
	 简称：FShortName 
	 渠道类别：FChannelClass 
	 渠道类型：FChannelType  (必填项)
	 对应客户：FChannelCustId 
	 禁用日期：FFORBIDDATE 
	 审核人：FAPPROVERID 
	 审核日期：FAPPROVEDATE 
	 禁用人：FFORBIDDERID 
	 对应供应商：FChannelSupplyId 
	 原上级渠道：FOriginalParentid 
	 对应部门：FChannelDeptId 
	 长编码：FLevelCode 
	 渠道细分：FChannelTypeID 
	 负责人：FHead 
	 ...
	 地址：FBaseAddress 
	 所属分支机构：FOrgBranchID 
	 订货渠道：FOrderChannelID 
	 收货渠道：FReceiveChannelID 
	 结算渠道：FSettleChannelID 
	 渠道分组：FChannelGroupID 
	 渠道大类：FChannelTypeGroup 
	 渠道归属：FChannelBelong  (必填项)
	 营销网络关联：FChannelNetRelation 
联系人：FPersonEntity 
	 实体主键：FEntryID 
	 固定电话：FPersonTel 
	 电子邮箱：FPersonEmail 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("DRP_Channel","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FCHANNELID":0,"FChannelGroupID":{"FNumber":""},"FNumber":"","FDescription":"","FChannelOrgId":{"FNumber":""},"FName":"","FChannelClass":{"FNumber":""},"FChannelCustId":{"FNumber":""},"FShortName":"","FParentChannelId":{"FNumber":""},"FChannelTypeID":{"FNUMBER":""},"FOrgBranchID":{"FNUMBER":""},"FBaseAddress":"","FTel":"","FHead":"","FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FChannelSupplyId":{"FNUMBER":""},"FChannelBelong":{"FNumber":""},"FChannelDeptId":{"FNUMBER":""},"FLevelCode":"","FChannelType":"","FOrderChannelID":{"FNUMBER":""},"FReceiveChannelID":[{"FNumber":""}],"FSettleChannelID":{"FNUMBER":""},"FChannelNetRelation":"","FPersonEntity":[{"FEntryID":0,"FPersonID":{"FSTAFFNUMBER":""},"FMobile":"","FPersonTel":"","FPersonEmail":"","FAddress":""}],"FStockEntity":[{"FEntryID":0,"FStockOrgId":{"FNumber":""},"FStockId":{"FNUMBER":""},"FStockIsDRP":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("DRP_Channel","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("DRP_Channel","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("DRP_Channel","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_Channel","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_Channel","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("DRP_Channel","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("DRP_Channel","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"DRP_Channel"}");

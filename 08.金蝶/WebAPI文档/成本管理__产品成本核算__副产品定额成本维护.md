# 副产品定额成本维护 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 副产品定额成本维护
...
client.Delete("CB_BYPRODUCTCOST","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_BYPRODUCTCOST","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNUMBER":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FBYPROCOSTENTRY":[{"FEntryID":0,"FProductId":{"FNumber":""},"FAUXPROPERTYID":{"FAUXPROPERTYID__FF100001":{"FNumber":""},"FAUXPROPERTYID__FF100002":{"FNumber":""},"FAUXPROPERTYID__FF100003":{"FNumber":""},"FAUXPROPERTYID__FF100005":{"FNumber":""},"FAUXPROPERTYID__FF100010":{"FNumber":""},"FAUXPROPERTYID__FF100007":{"FNumber":""},"FAUXPROPERTYID__FF100008":{"FNumber":""}},"FALLPLANAMOUNT":0,"FBYPROCOSTDETAIL":[{"FDetailID":0,"FEXPID":{"FNUMBER":""},"FPLANAMOUNT":0}]}]}}");
...
单据头：FBillHead 
	 ...
	 币别：FCURRENCYID 
综合设置：FBYPROCOSTENTRY 
	 实体主键：FEntryID 
	 产品编码：FProductId  (必填项)
	 产品名称：FProductName 
	 规格型号：FSPECIFICATION 
	 基本单位：FUNIT 
	 单位综合成本：FALLPLANAMOUNT 
	 辅助属性：FAUXPROPERTYID 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_BYPRODUCTCOST","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNUMBER":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FBYPROCOSTENTRY":[{"FEntryID":0,"FProductId":{"FNumber":""},"FAUXPROPERTYID":{"FAUXPROPERTYID__FF100001":{"FNumber":""},"FAUXPROPERTYID__FF100002":{"FNumber":""},"FAUXPROPERTYID__FF100003":{"FNumber":""},"FAUXPROPERTYID__FF100005":{"FNumber":""},"FAUXPROPERTYID__FF100010":{"FNumber":""},"FAUXPROPERTYID__FF100007":{"FNumber":""},"FAUXPROPERTYID__FF100008":{"FNumber":""}},"FALLPLANAMOUNT":0,"FBYPROCOSTDETAIL":[{"FDetailID":0,"FEXPID":{"FNUMBER":""},"FPLANAMOUNT":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_BYPRODUCTCOST","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_BYPRODUCTCOST","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_BYPRODUCTCOST"}");

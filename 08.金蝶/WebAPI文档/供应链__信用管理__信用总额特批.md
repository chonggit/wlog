# 信用总额特批 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 信用管理 > 信用总额特批
...
client.Delete("CRE_CreditSumPermit","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRE_CreditSumPermit","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRE_CreditSumPermit","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FSalt":"","FRange":"","FCreateOrgId":{"FNumber":""},"FUserId":{"FName":""},"FPassword":"","FConfirmPass":"","FCurrencyId":{"FNUMBER":""},"FNeedInputPass":"false","FNote":"","FCHECKNEWPASS":"false","FNEWPASSWORD":"","FEntity":[{"FEntryID":0,"FStartYear":0,"FStartPeriod":0,"FOverAmount":0,"FOverDays":0,"FOverDueAmount":0,"FMonthlyRoll":"false","FOverAmountCopy":0,"FOverDueAmountCopy":0}]}}");
...
基本信息：FBillHead 
	 ...
	 描述：FDescription 
	 授信范围：FRange  (必填项)
	 授信组织：FCreateOrgId  (必填项)
	 特批密码：FPassword  (必填项)
	 确认密码：FConfirmPass  (必填项)
	 币别：FCurrencyId  (必填项)
	 特批时需输入密码进行确认：FNeedInputPass 
	 备注：FNote 
	 特批人：FUserId  (必填项)
	 密码SALT：FSalt 
	 审核人：FApproverId 
	 ...
	 禁用人：FFORBIDDERID 
	 禁用日期：FFORBIDDATE 
	 是否检查加密密码：FCHECKNEWPASS 
	 加密密码：FNEWPASSWORD 
明细信息：FEntity 
	 实体主键：FEntryID 
	 允许特批金额：FOverAmount 
	 允许特批逾期天数：FOverDays 
	 允许特批逾期额度总额：FOverDueAmount 
	 按月自动授信：FMonthlyRoll 
	 授信年度：FStartYear 
	 授信期间：FStartPeriod 
	 允许特批金额copy：FOverAmountCopy 
	 允许特批逾期额度总额copy：FOverDueAmountCopy 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRE_CreditSumPermit","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FSalt":"","FRange":"","FCreateOrgId":{"FNumber":""},"FUserId":{"FName":""},"FPassword":"","FConfirmPass":"","FCurrencyId":{"FNUMBER":""},"FNeedInputPass":"false","FNote":"","FCHECKNEWPASS":"false","FNEWPASSWORD":"","FEntity":[{"FEntryID":0,"FStartYear":0,"FStartPeriod":0,"FOverAmount":0,"FOverDays":0,"FOverDueAmount":0,"FMonthlyRoll":"false","FOverAmountCopy":0,"FOverDueAmountCopy":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CRE_CreditSumPermit","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CRE_CreditSumPermit","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CRE_CreditSumPermit","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CRE_CreditSumPermit","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CRE_CreditSumPermit","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CRE_CreditSumPermit","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CRE_CreditSumPermit","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRE_CreditSumPermit"}");

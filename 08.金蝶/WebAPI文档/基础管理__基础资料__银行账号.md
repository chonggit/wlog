...
client.Delete("CN_BANKACNT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_BANKACNT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_BANKACNT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FBANKACNTID":0,"FCreateOrgId":{"FNumber":""},"FACCOUNTTYPE":"","FNumber":"","FBANKID":{"FNumber":""},"FName":"","FInOrOut":"","FACNTBRANCHNUMBER":"","FBankType":{"FNAME":""},"FProvince":{"FNAME":""},"FCity":{"FNAME":""},"FDistrict":{"FNAME":""},"FUseOrgId":{"FNumber":""},"FACNTAREACODE":"","FACNTAREANAME":"","FIsFundUp":"false","FIsCancel":"false","FIsSupBank":"false","FISDEFAULTBANK":"false","FINNERACCOUNTID":{"FNUMBER":""},"FDescription":"","FSRCBILLID":0,"FUpType":"","FUpAmount":0,"FBaseAmount":0,"FMinUpAmount":0,"FLICENSEKEY":"","FPUBLICACNT":{"FNUMBER":""},"FBankServiceLoginId":"","FBankServiceLoginDesc":"","FIsSupBBC":"false","FIsAutoBlend":"false","FNProvince":"","FNCity":"","FNDistrict":"","FCountry":"","FKDPAYNUMBER":{"FNUMBER":""},"FIsImpNegativeBal":"false","FLimOverControl":"","FOVERLIMITAMT":0,"FIsSupAutoDER":"false","FIsSupAutoDERT":"false","FDOWNLOADDESC":"false","FIsSupDZHD":"false","FChangeDirection":"false","FWBANKTYPE":"","F_ora_Base_qtr":{"FNUMBER":""}}}");
...
单据头：FBillHead 
	 ...
	 地区：FNDistrict 
	 国别：FCountry 
	 聚合收款商户号：FKDPAYNUMBER 
	 支持导入负余额对账单：FIsImpNegativeBal 
	 透支策略：FLimOverControl 
	 禁止透支：FBanOver 
	 额度内允许透支：FLimOver 
	 透支额度：FOVERLIMITAMT 
	 支持自动下载电子回单：FIsSupAutoDER 
	 支持自动下载当天电子回单：FIsSupAutoDERT 
	 倒序下载对账单：FDOWNLOADDESC 
	 支持电子回单：FIsSupDZHD 
	 交易明细发生额为负时，不转换方向和符号：FChangeDirection 
	 网上银行类型：FWBANKTYPE 
	 对接平台：FDockingPlat 
	 对接平台认证账号：FPlatSafeAuthUser 
	 余额查询开通状态：FBalance 
	 交易明细查询开通状态：FDetail 
	 电子回单开通状态：FReceiptBill 
	 签约银行分行号：FContractBankBranchNo 
	 签约银行：FConBank 
	 科目：F_ora_Base_qtr 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_BANKACNT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FBANKACNTID":0,"FCreateOrgId":{"FNumber":""},"FACCOUNTTYPE":"","FNumber":"","FBANKID":{"FNumber":""},"FName":"","FInOrOut":"","FACNTBRANCHNUMBER":"","FBankType":{"FNAME":""},"FProvince":{"FNAME":""},"FCity":{"FNAME":""},"FDistrict":{"FNAME":""},"FUseOrgId":{"FNumber":""},"FACNTAREACODE":"","FACNTAREANAME":"","FIsFundUp":"false","FIsCancel":"false","FIsSupBank":"false","FISDEFAULTBANK":"false","FINNERACCOUNTID":{"FNUMBER":""},"FDescription":"","FSRCBILLID":0,"FUpType":"","FUpAmount":0,"FBaseAmount":0,"FMinUpAmount":0,"FLICENSEKEY":"","FPUBLICACNT":{"FNUMBER":""},"FBankServiceLoginId":"","FBankServiceLoginDesc":"","FIsSupBBC":"false","FIsAutoBlend":"false","FNProvince":"","FNCity":"","FNDistrict":"","FCountry":"","FKDPAYNUMBER":{"FNUMBER":""},"FIsImpNegativeBal":"false","FLimOverControl":"","FOVERLIMITAMT":0,"FIsSupAutoDER":"false","FIsSupAutoDERT":"false","FDOWNLOADDESC":"false","FIsSupDZHD":"false","FChangeDirection":"false","FWBANKTYPE":"","F_ora_Base_qtr":{"FNUMBER":""}}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_BANKACNT","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_BANKACNT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_BANKACNT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BANKACNT","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BANKACNT","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_BANKACNT","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_BANKACNT","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_BANKACNT"}");

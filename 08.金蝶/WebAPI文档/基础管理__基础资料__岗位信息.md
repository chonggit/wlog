...
client.Delete("HR_ORG_HRPOST","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("HR_ORG_HRPOST","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("HR_ORG_HRPOST","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FPOSTID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FHelpCode":"","FDept":{"FNumber":""},"FEffectDate":"1900-01-01","FLapseDate":"1900-01-01","FDESCRIPTIONS":"","FHRPostSubHead":{"FHRPOSTID":0,"FLEADERPOST":"false"},"FSHRMapEntity":{"FMAPID":0},"FPostRoleEntitys":[{"FPOSTROLEID":0,"FIsRoleValid":"false","FPostRole":{"FNumber":""},"FIsDefault":"false","FRoleDiscription":"","FRoleStime":"1900-01-01","FRoleETime":"1900-01-01","FIsHrCreateRole":"false","FSourceShrApiDetl":""}],"FSubReportEntity":[{"FSubNumber":""}],"FReportEntitys":[{"FPOSTREPORTID":0,"FSupiorIsValid":"false","FSuperiorReportType":{"FNumber":""},"FSuperiorPost":{"FNumber":""},"FSuperiorDescaription":"","FSuperiorStime":"1900-01-01","FSuperiorEtime":"1900-01-01","FIsHrCreate":"false"}]}}");
        ...
        "FPostRoleEntitys": [
            {
                ...
                "FIsDefault": "false",
                "FRoleDiscription": "",
                "FRoleStime": "1900-01-01",
                "FRoleETime": "1900-01-01",
                "FIsHrCreateRole": "false",
                "FSourceShrApiDetl": ""
            }
        ],
        "FSubReportEntity": [
        ...
        "FReportEntitys": [
            {
                ...
                "FSuperiorDescaription": "",
                "FSuperiorStime": "1900-01-01",
                "FSuperiorEtime": "1900-01-01",
                "FIsHrCreate": "false"
            }
        ]
    }
...
岗位信息：FBillHead 
	 ...
	 描述：FDESCRIPTIONS 
	 HR岗位：FISHR 
	 部门名称：FDepartmentName 
	 部门全称：FFullName 
	 来源于s-HR：FIsSHR 
	 来源shr的Api数据：FSourceShrApi 
岗位对应角色：FPostRoleEntitys 
	 实体主键：FPOSTROLEID 
	 角色编码：FPostRole  (必填项)
	 角色类型：FRoleType 
	 所属业务组织：FRoleOrg 
	 ...
	 是否默认角色：FIsDefault 
	 是否有效：FIsRoleValid 
	 关系描述：FRoleDiscription 
	 创建人：FRoleCreatorId 
	 创建日期：FRoleCreateDate 
	 修改人：FRoleModifierId 
	 修改日期：FRoleModifyDate 
	 生效日期：FRoleStime 
	 失效日期：FRoleETime 
	 是否HR创建：FIsHrCreateRole 
	 来源于shr数据：FSourceShrApiDetl 
下级汇报关系：FSubReportEntity 
	 实体主键： 
	 序号：FSubNumber 
	 汇报类型：FSubReportType 
	 下级岗位：FSubPost 
	 ...
	 创建日期：FSubCreateDate 
	 修改日期：FSubModifyDate 
	 关系描述：FSubDiscription 
	 生效日期：FSubStime 
	 失效日期：FSubEtime 
	 岗位全称：FSubFullName 
上级汇报关系：FReportEntitys 
	 实体主键：FPOSTREPORTID 
	 汇报类型：FSuperiorReportType  (必填项)
	 岗位编码：FSuperiorPost  (必填项)
	 岗位名称：FSuperiorPostName 
	 所属业务组织：FSuperiorOrg 
	 所属部门：FSuperiorDept 
	 岗位全称：FSuperiorFullName 
	 是否有效：FSupiorIsValid 
	 关系描述：FSuperiorDescaription 
	 生效日期：FSuperiorStime 
	 失效日期：FSuperiorEtime 
	 创建组织：FSuperiorCreateOrg 
	 使用组织：FSuperiorUserOrg 
	 禁用状态：FSuperiorForBid 
	 创建人：FSuperiorCreatorId 
	 创建日期：FSuperiorCreateDate 
	 修改人：FSuperiorModifierId 
	 修改日期：FSuperiorModifyDate 
	 是否Hr创建：FIsHrCreate 
	 来源于s-HR（上级）：FIsSHREntry 
职位子单据头：FHRPostSubHead 
	 实体主键：FHRPOSTID 
	 负责人岗位：FLEADERPOST 
	 所属组织单元：FOrgUnit 
	 所属业务组织：FAffiliatedOrgID 
SHR映射实体：FSHRMapEntity 
	 实体主键：FMAPID 
	 编码：FSHRNumber 
	 SHR内码：FShrId 
	 名称：FSHRName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("HR_ORG_HRPOST","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FPOSTID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FHelpCode":"","FDept":{"FNumber":""},"FEffectDate":"1900-01-01","FLapseDate":"1900-01-01","FDESCRIPTIONS":"","FHRPostSubHead":{"FHRPOSTID":0,"FLEADERPOST":"false"},"FSHRMapEntity":{"FMAPID":0},"FPostRoleEntitys":[{"FPOSTROLEID":0,"FIsRoleValid":"false","FPostRole":{"FNumber":""},"FIsDefault":"false","FRoleDiscription":"","FRoleStime":"1900-01-01","FRoleETime":"1900-01-01","FIsHrCreateRole":"false","FSourceShrApiDetl":""}],"FSubReportEntity":[{"FSubNumber":""}],"FReportEntitys":[{"FPOSTREPORTID":0,"FSupiorIsValid":"false","FSuperiorReportType":{"FNumber":""},"FSuperiorPost":{"FNumber":""},"FSuperiorDescaription":"","FSuperiorStime":"1900-01-01","FSuperiorEtime":"1900-01-01","FIsHrCreate":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("HR_ORG_HRPOST","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("HR_ORG_HRPOST","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("HR_ORG_HRPOST","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("HR_ORG_HRPOST","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("HR_ORG_HRPOST","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("HR_ORG_HRPOST","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("HR_ORG_HRPOST","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"HR_ORG_HRPOST"}");

...
client.Save("PLM_CFG_FILETYPE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCode":"","FName":"","FIsGeneratePDF":"false","FFileType":"","FIsUpdateDoc":"false","FIsLeapLayer":"false","FMatchField":"","FMatchFieldFormat":"","FMatchCategoryFormat":"","FMatchCategoryInfo":"","FZWCADType":"","FFileVersionText":"","FIsValidateHiddenFile":"false","FMatchFieldDoc":"","FMatchCategoryInfoDoc":"","FMatchFieldFormatDoc":"","FMatchCategoryFormatDoc":"","FIsGetDrws":"false","FCaseSensitive":"false","FIsAbleChangeBom":"false","FIsNotMaIfExcludeBom":"false","FGetMultConfig":"false","FAPILICENSE":"","FIsLimitReadPath":"false","FIsNoCheckNetlistFile":"false","FIsGetDrwsByName":"false","FEnableDocPreview":"false","FEnableMatPreview":"false","FIsCheckLayer":"false","FCancelRegeneration":"false","FFileEntity":[{"FEntryID":0,"FFileIdentifier":"","FCBFiledType":"","FMulAlias":"","FDescribe":"","FMaterialFiled":{"FKEY":""},"FCBIndex":"false","FCBIsmust":"false","FCBFileIndex":"false","FCBFileName":"false","FBaseType":"","FCADFieldId":""}],"FExtendEntity":[{"FEntryID":0,"FExtendName":"","FExtendRemark":"","FISCONVERTPDF":"false","FISCONVERTHTML":"false","FISNOTSIGN":"false","FConvertStartTime":"1900-01-01","FConvertEndTime":"1900-01-01","FFreeConvertFileMinSize":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FCode": "",
        "FName": "",
        "FIsGeneratePDF": "false",
        "FFileType": "",
        "FIsUpdateDoc": "false",
        "FIsLeapLayer": "false",
        "FMatchField": "",
        "FMatchFieldFormat": "",
        "FMatchCategoryFormat": "",
        "FMatchCategoryInfo": "",
        "FZWCADType": "",
        "FFileVersionText": "",
        "FIsValidateHiddenFile": "false",
        "FMatchFieldDoc": "",
        "FMatchCategoryInfoDoc": "",
        "FMatchFieldFormatDoc": "",
        "FMatchCategoryFormatDoc": "",
        "FIsGetDrws": "false",
        "FCaseSensitive": "false",
        "FIsAbleChangeBom": "false",
        "FIsNotMaIfExcludeBom": "false",
        "FGetMultConfig": "false",
        "FAPILICENSE": "",
        "FIsLimitReadPath": "false",
        "FIsNoCheckNetlistFile": "false",
        "FIsGetDrwsByName": "false",
        "FEnableDocPreview": "false",
        "FEnableMatPreview": "false",
        "FIsCheckLayer": "false",
        "FCancelRegeneration": "false",
        "FFileEntity": [
            {
                "FEntryID": 0,
                "FFileIdentifier": "",
        ...
        "FExtendEntity": [
            {
                ...
                "FISNOTSIGN": "false",
                "FConvertStartTime": "1900-01-01",
                "FConvertEndTime": "1900-01-01",
                "FFreeConvertFileMinSize": 0
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 文件类型编码：FCode  (必填项)
	 文件类型名称：FName  (必填项)
	 生成PDF：FIsGeneratePDF 
	 文档类别：FFileType 
	 更新明细栏：FIsUpdateDoc 
	 中间层不生成物料,下层自动提层：FIsLeapLayer 
	 下拉列表：FMatchField 
	 位数设置：FMatchFieldFormat 
	 业务类型信息：FMatchCategoryInfo 
	 位数设置：FMatchCategoryFormat 
	 中望版本：FZWCADType 
	 图纸版本属性：FFileVersionText 
	 不生成物料/BOM的图纸导入和检入时，跳过【必填】校验：FIsValidateHiddenFile 
	 下拉列表：FMatchFieldDoc 
	 业务类型信息：FMatchCategoryInfoDoc 
	 位数设置：FMatchFieldFormatDoc 
	 位数设置：FMatchCategoryFormatDoc 
	 是否获取不同名多配置工程图：FIsGetDrws 
	 文件索引是否区分大小写（仅限于SQL数据库）：FCaseSensitive 
	 允许在系统中修改该文档生成的BOM：FIsAbleChangeBom 
	 部件状态为【封套】或【不包括在材料明细表中】时，下级所有零部件不生成物料/BOM：FIsNotMaIfExcludeBom 
	 集成接口秘钥：FAPILICENSE 
	 获取多配置：FGetMultConfig 
	 限制下层图纸读取文件夹：FIsLimitReadPath 
	 不校验网表文件：FIsNoCheckNetlistFile 
	 只获取包含3D图纸名的工程图：FIsGetDrwsByName 
	 文档详情页轻量化浏览：FEnableDocPreview 
	 物料详情页轻量化浏览：FEnableMatPreview 
	 同层物料不允许重复是否校验层：FIsCheckLayer 
	 是否取消默认重新生成功能：FCancelRegeneration 
文件标识单据：FFileEntity 
	 实体主键：FEntryID 
	 物理文件字段：FFileIdentifier  (必填项)
	 字段类型：FCBFiledType  (必填项)
	 描述：FDescribe 
	 系统属性字段：FMaterialFiled 
	 物料索引：FCBIndex 
	 必填项：FCBIsmust 
	 文件索引：FCBFileIndex 
	 虚文档名称：FCBFileName 
	 别名：FMulAlias 
	 基础资料类型：FBaseType 
	 物理文件属性标识：FCADFieldId 
扩展名称单据：FExtendEntity 
	 实体主键：FEntryID 
	 文件后缀名：FExtendName 
	 描述：FExtendRemark 
	 转换PDF：FISCONVERTPDF 
	 转换HTML：FISCONVERTHTML 
	 转换其它类型：FConvertOtherType 
	 闲时转换开始时间：FConvertStartTime 
	 闲时转换结束时间：FConvertEndTime 
	 闲时转换文件最小值(MB)：FFreeConvertFileMinSize 
	 不参与签字：FISNOTSIGN 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("PLM_CFG_FILETYPE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_CFG_FILETYPE"}");

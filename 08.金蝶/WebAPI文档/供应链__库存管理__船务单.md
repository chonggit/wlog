...
client.Delete("RESP_CWD","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("RESP_CWD","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_RESP_Date":"1900-01-01","F_RESP_YDH":"","F_RESP_YSDDRQ":"1900-01-01","F_RESP_Qty":0,"F_RESP_Amount":0,"F_RESP_Remarks":"","F_RESP_BTCWC":{"FNumber":""},"F_RESP_BTCWLB":{"FNumber":""},"F_RESP_ZXS":0,"F_RESP_DOFPH":"","F_ora_OrgId":{"FNumber":""},"F_RESP_CreatorId":{"FUserID":""},"F_RESP_CreateDate":"1900-01-01","F_ora_Text":"","F_ora_Text1":"","FEntity":[{"FEntryID":0,"F_RESP_CWFYMX":{"FNumber":""},"F_RESP_MXZL":0,"F_RESP_MXJE":0,"F_RESP_WLGYS":{"FNUMBER":""},"F_RESP_CGGYS":{"FNUMBER":""},"F_RESP_DDXX":"","F_RESP_MXBM":{"FNUMBER":""},"F_RESP_MXMYTK":{"FNumber":""},"F_RESP_MXBZ":"","F_RESP_KH":{"FNUMBER":""}}],"F_RESP_CWDSRCEntity":[{"FEntryID":0,"F_RESP_FPH":"","F_RESP_CKDate":"1900-01-01","F_RESP_KHBM":"","F_RESP_KHMC":"","F_RESP_KHDZ":"","F_RESP_MYTK":"","F_RESP_CPBM":"","F_RESP_CPMC":"","F_RESP_CPXH":"","F_RESP_SL":0,"F_RESP_ZL":0,"F_RESP_BM":{"FNUMBER":""},"F_RESP_BZ":"","F_RESP_BZ1":""}]}}");
...
单据头：FBillHead 
	 ...
	 总重量(费用)：F_RESP_Qty 
	 总金额(费用)：F_RESP_Amount 
	 备注(运单)：F_RESP_Remarks 
	 单据编号(携带)：F_RESP_DJBM 
	 船务仓：F_RESP_BTCWC 
	 船务费用类别：F_RESP_BTCWLB 
	 总毛重(含卡板)：F_RESP_Decimal 
	 直销未开票最晚预警日期：F_RESP_WKPRQ 
	 总箱数(DO)：F_RESP_ZXS 
	 发票号(DO)：F_RESP_DOFPH 
	 发票组织(DO)：F_ora_OrgId 
	 客户：F_RESP_DOKH 
	 创建人：F_RESP_CreatorId 
	 创建日期：F_RESP_CreateDate 
	 体积：F_ora_Text 
	 起运港：F_ora_Text1 
费用明细：FEntity 
	 实体主键：FEntryID 
	 船务费用明细：F_RESP_CWFYMX 
	 重量(费用)：F_RESP_MXZL 
	 金额(费用)：F_RESP_MXJE 
	 物流供应商：F_RESP_WLGYS 
	 采购供应商：F_RESP_CGGYS 
	 部门：F_RESP_MXBM 
	 备注(费用)：F_RESP_MXBZ 
	 贸易条款(费用)：F_RESP_MXMYTK 
	 供应商-地点信息：F_RESP_DDXX 
	 销售客户：F_RESP_KH 
DO源单明细：F_RESP_CWDSRCEntity 
	 实体主键：FEntryID 
	 发票号：F_RESP_FPH 
	 出库日期：F_RESP_CKDate 
	 客户编码：F_RESP_KHBM 
	 ...
	 箱数：F_RESP_XS 
	 源单内码：F_RESP_YDNM 
关联关系表：F_RESP_CWDSRCEntity_Link 
	 实体主键：FLinkId 
	 业务流程图：F_RESP_CWDSRCEntity_Link_FFlowId 
	 推进路线：F_RESP_CWDSRCEntity_Link_FFlowLineId 
	 转换规则：F_RESP_CWDSRCEntity_Link_FRuleId 
	 源单表内码：F_RESP_CWDSRCEntity_Link_FSTableId 
	 源单表：F_RESP_CWDSRCEntity_Link_FSTableName 
	 源单内码：F_RESP_CWDSRCEntity_Link_FSBillId 
	 源单分录内码：F_RESP_CWDSRCEntity_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("RESP_CWD","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_RESP_Date":"1900-01-01","F_RESP_YDH":"","F_RESP_YSDDRQ":"1900-01-01","F_RESP_Qty":0,"F_RESP_Amount":0,"F_RESP_Remarks":"","F_RESP_BTCWC":{"FNumber":""},"F_RESP_BTCWLB":{"FNumber":""},"F_RESP_ZXS":0,"F_RESP_DOFPH":"","F_ora_OrgId":{"FNumber":""},"F_RESP_CreatorId":{"FUserID":""},"F_RESP_CreateDate":"1900-01-01","F_ora_Text":"","F_ora_Text1":"","FEntity":[{"FEntryID":0,"F_RESP_CWFYMX":{"FNumber":""},"F_RESP_MXZL":0,"F_RESP_MXJE":0,"F_RESP_WLGYS":{"FNUMBER":""},"F_RESP_CGGYS":{"FNUMBER":""},"F_RESP_DDXX":"","F_RESP_MXBM":{"FNUMBER":""},"F_RESP_MXMYTK":{"FNumber":""},"F_RESP_MXBZ":"","F_RESP_KH":{"FNUMBER":""}}],"F_RESP_CWDSRCEntity":[{"FEntryID":0,"F_RESP_FPH":"","F_RESP_CKDate":"1900-01-01","F_RESP_KHBM":"","F_RESP_KHMC":"","F_RESP_KHDZ":"","F_RESP_MYTK":"","F_RESP_CPBM":"","F_RESP_CPMC":"","F_RESP_CPXH":"","F_RESP_SL":0,"F_RESP_ZL":0,"F_RESP_BM":{"FNUMBER":""},"F_RESP_BZ":"","F_RESP_BZ1":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("RESP_CWD","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("RESP_CWD","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("RESP_CWD","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("RESP_CWD","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("RESP_CWD","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RESP_CWD"}");

# 利润考核体系 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 阿米巴报表 > 利润考核体系
...
client.Delete("BD_ProfitSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_ProfitSystem","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_ProfitSystem","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FProfitSystemID":0,"FNumber":"","FName":"","FAcctSystemId":{"FNUMBER":""},"FOrgId":{"FNUMBER":""},"FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FProfitCenterEntity":[{"FProfitCenterID":0,"FProfitCenterName":"","FParentProfitCenterId":{"FNUMBER":""},"FParentProfitCenterNumber":"","FProfitCenterOrgId":{"FNUMBER":""},"FProfitCenterNumber":"","FSubCBCenterEntity":[{"FProfitDetailId":0,"FCostCenterId":"","FCostCenterNumber":"","FCostCenterName":"","FCostCenterType":""}]}]}}");
        ...
        "FProfitCenterEntity": [
            {
                "FProfitCenterID": 0,
                "FProfitCenterName": "",
                "FParentProfitCenterId": {
                    "FNUMBER": ""
                },
                "FParentProfitCenterNumber": "",
                "FProfitCenterOrgId": {
                    "FNUMBER": ""
                },
                "FProfitCenterNumber": "",
...
单据头：FBillHead 
	 ...
	 核算组织(作废)：FOrgId 
利润中心单据体：FProfitCenterEntity 
	 实体主键：FProfitCenterID 
	 利润中心编码：FProfitCenterNumber 
	 利润中心名称：FProfitCenterName 
	 上级利润中心：FParentProfitCenterId 
	 利润中心数据状态：FProfitCenterDocStatus 
	 上级利润中心编码：FParentProfitCenterNumber 
	 利润中心禁用状态：FProCenterForbidStatus 
	 核算组织：FProfitCenterOrgId 
子单据体：FSubCBCenterEntity 
	 实体主键：FProfitDetailId 
	 考核对象ID：FCostCenterId 
	 编码：FCostCenterNumber 
	 名称：FCostCenterName 
	 类型：FCostCenterType  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_ProfitSystem","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FProfitSystemID":0,"FNumber":"","FName":"","FAcctSystemId":{"FNUMBER":""},"FOrgId":{"FNUMBER":""},"FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FProfitCenterEntity":[{"FProfitCenterID":0,"FProfitCenterName":"","FParentProfitCenterId":{"FNUMBER":""},"FParentProfitCenterNumber":"","FProfitCenterOrgId":{"FNUMBER":""},"FProfitCenterNumber":"","FSubCBCenterEntity":[{"FProfitDetailId":0,"FCostCenterId":"","FCostCenterNumber":"","FCostCenterName":"","FCostCenterType":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_ProfitSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_ProfitSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_ProfitSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_ProfitSystem","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_ProfitSystem","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_ProfitSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_ProfitSystem","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_ProfitSystem"}");

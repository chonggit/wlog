...
client.Delete("BD_BarCodeRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_BarCodeRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_BarCodeRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRuleType":"","FBarCodeType":"","FCheckNum":0,"FBARCODELENGTH":0,"FLevel":0,"FDescription":"","FBarCodeEx":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAUDITORID":{"FUserID":""},"FAUDITDATE":"1900-01-01","FFORBIDDERID":{"FUserID":""},"FFORBIDDATE":"1900-01-01","FCreateOrgId":{"FNumber":""},"FIsRuleCode":"false","FIsDefaultPackRule":"false","FCreateSecurityCode":"false","FSubAnalytic":"false","FAutoExpansion":"false","FIsAutoFillFlot":"false","FBatchCreateBarcode":"false","FIsPCPackRule":"false","FExplainAnalysisBarCode":"false","FPackLevel":0,"FBarcodeReuseBindMaterial":"false","FIsAutoGenerateLot":"false","FWirteBackBarcodeSign":"false","FPrintSummaryEntry":"false","FCreateBarcodeCombin":"false","FIsHideTrailZero":"false","FBarCodeRuleEntity":[{"FEntryID":0,"FBarCodePropertyId":{"FNUMBER":""},"FLength":0,"FFormat":{"FNUMBER":""},"FProjectValue":"","FStartValue":0,"FAddChar":"","FAlignType":"","FSeperatorStr":"","FSeperator":"","FStartSplit":0,"FEndSplit":0,"FContainsPrefix":"false","FCodeItem":"false","FSumItem":"false","FIsPCMatch":"false","FChangePre":"false","FNote":""}],"FEntityBill":[{"FEntryID":0,"FBillId":{"FID":""},"FFIELD":"","FFIELDKEY":"","FFIELDNAME":"","FIsCheck":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIsRuleCode": "false",
        "FIsDefaultPackRule": "false",
        "FCreateSecurityCode": "false",
        "FSubAnalytic": "false",
        "FAutoExpansion": "false",
        "FIsAutoFillFlot": "false",
        "FBatchCreateBarcode": "false",
        "FIsPCPackRule": "false",
        "FExplainAnalysisBarCode": "false",
        "FPackLevel": 0,
        "FBarcodeReuseBindMaterial": "false",
        "FIsAutoGenerateLot": "false",
        "FWirteBackBarcodeSign": "false",
        "FPrintSummaryEntry": "false",
        "FCreateBarcodeCombin": "false",
        "FIsHideTrailZero": "false",
        "FBarCodeRuleEntity": [
            {
                "FEntryID": 0,
                "FBarCodePropertyId": {
...
基本信息：FBillHead 
	 ...
	 条码长度：FBARCODELENGTH 
	 条码解析优先级：FLevel 
	 默认包装条码规则：FIsDefaultPackRule 
	 自动生成防伪码：FCreateSecurityCode 
	 分段解析：FSubAnalytic 
	 流水号自动扩容：FAutoExpansion 
	 自动填充批号：FIsAutoFillFlot 
	 条码批量生成：FBatchCreateBarcode 
	 PC打包箱码规则：FIsPCPackRule 
	 动态解释条码扫描同时建档：FExplainAnalysisBarCode 
	 包装层级：FPackLevel 
	 条码重复利用绑定物料：FBarcodeReuseBindMaterial 
	 调用批号规则生成批号：FIsAutoGenerateLot 
	 回填条码生成标识：FWirteBackBarcodeSign 
	 单据分录汇总打印：FPrintSummaryEntry 
	 生成随机码流水号组合值：FCreateBarcodeCombin 
	 是否隐藏尾0：FIsHideTrailZero 
规则内容：FBarCodeRuleEntity 
	 实体主键：FEntryID 
	 ...
	 备注：FNote 
	 格式：FFormat 
	 属性名称：FBARCODEITEMNAME 
	 分隔符：FSeperator 
	 补位符：FAddChar 
	 PC匹配项：FIsPCMatch 
	 调整解析精度：FChangePre 
	 分隔符：FSeperatorStr 
	 解析包含前缀：FContainsPrefix 
	 起始值：FStartValue 
	 截取起始位：FStartSplit 
	 截取截止位：FEndSplit 
适用业务对象：FEntityBill 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_BarCodeRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRuleType":"","FBarCodeType":"","FCheckNum":0,"FBARCODELENGTH":0,"FLevel":0,"FDescription":"","FBarCodeEx":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAUDITORID":{"FUserID":""},"FAUDITDATE":"1900-01-01","FFORBIDDERID":{"FUserID":""},"FFORBIDDATE":"1900-01-01","FCreateOrgId":{"FNumber":""},"FIsRuleCode":"false","FIsDefaultPackRule":"false","FCreateSecurityCode":"false","FSubAnalytic":"false","FAutoExpansion":"false","FIsAutoFillFlot":"false","FBatchCreateBarcode":"false","FIsPCPackRule":"false","FExplainAnalysisBarCode":"false","FPackLevel":0,"FBarcodeReuseBindMaterial":"false","FIsAutoGenerateLot":"false","FWirteBackBarcodeSign":"false","FPrintSummaryEntry":"false","FCreateBarcodeCombin":"false","FIsHideTrailZero":"false","FBarCodeRuleEntity":[{"FEntryID":0,"FBarCodePropertyId":{"FNUMBER":""},"FLength":0,"FFormat":{"FNUMBER":""},"FProjectValue":"","FStartValue":0,"FAddChar":"","FAlignType":"","FSeperatorStr":"","FSeperator":"","FStartSplit":0,"FEndSplit":0,"FContainsPrefix":"false","FCodeItem":"false","FSumItem":"false","FIsPCMatch":"false","FChangePre":"false","FNote":""}],"FEntityBill":[{"FEntryID":0,"FBillId":{"FID":""},"FFIELD":"","FFIELDKEY":"","FFIELDNAME":"","FIsCheck":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_BarCodeRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_BarCodeRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_BarCodeRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_BarCodeRule","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_BarCodeRule","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_BarCodeRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_BarCodeRule","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_BarCodeRule"}");

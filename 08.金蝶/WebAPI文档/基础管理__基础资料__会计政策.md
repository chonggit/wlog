...
client.Delete("BD_ACCTPOLICY","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_ACCTPOLICY","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_ACCTPOLICY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FACCTPOLICYID":0,"FNumber":"","FName":"","FCurrencyID":{"FNumber":""},"FAcctCalendarID":{"FNumber":""},"FAcctGroupID":{"FNumber":""},"FRateTypeID":{"FNumber":""},"FDescription":"","FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FIsCalByExpItem":"false","FISTAXAMOUNT":"false","FISCOSTACCOUNT":"false","FAcctSystem":{"FNUMBER":""},"FAcctPolicyAssetEntity":[{"FEntryID":0,"FAssetTypeID":{"FNumber":""},"FEntDeprYears":0,"FLegalDeprYears":0,"FWorkLoadUnitID":{"FNumber":""},"FEntDeprWorkLoad":0,"FLegalDeprWorkLoad":0,"FResidualType":"","FEntResidualRate":0,"FLegalResidualRate":0,"FResidualAmount":0,"FDeprMethod":"","FDeprPolicyID":{"FNumber":""},"FONETIMEDEPR":0}],"FAcctPolicyOrgEntity":[{"FEntryID":0,"FIsDefault":"false","FAcctSystemId":{"FNumber":""},"FAcctOrgId":{"FNumber":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIsCalByExpItem": "false",
        "FISTAXAMOUNT": "false",
        "FISCOSTACCOUNT": "false",
        "FAcctSystem": {
            "FNUMBER": ""
        },
        "FAcctPolicyAssetEntity": [
            {
                "FEntryID": 0,
                "FAssetTypeID": {
                    "FNumber": ""
                ...
                "FEntDeprWorkLoad": 0,
                "FLegalDeprWorkLoad": 0,
                "FResidualType": "",
                "FEntResidualRate": 0,
                "FLegalResidualRate": 0,
                "FResidualAmount": 0,
                "FDeprMethod": "",
                "FDeprPolicyID": {
                    "FNumber": ""
...
单据头：FBillHead 
	 ...
	 系统预置：FIsSysPreset 
	 主币别：FCurrencyID  (必填项)
	 会计日历：FAcctCalendarID  (必填项)
	 默认汇率类型：FRateTypeID  (必填项)
	 存货核算按费用项目明细核算：FIsCalByExpItem 
	 会计要素表：FAcctGroupID  (必填项)
	 成本以含税金额进行核算：FISTAXAMOUNT 
	 即时成本：FISCOSTACCOUNT 
	 启用核算体系：FAcctSystem 
资产政策：FAcctPolicyAssetEntity 
	 实体主键：FEntryID 
	 资产类别：FAssetTypeID 
	 残值类型：FResidualType  (必填项)
	 法定折旧年限：FLegalDeprYears 
	 法定残值率(%)：FLegalResidualRate 
	 残值额：FResidualAmount 
	 一次性折旧原值：FONETIMEDEPR 
	 折旧方法：FDeprMethod  (必填项)
	 折旧政策：FDeprPolicyID  (必填项)
	 企业折旧年限：FEntDeprYears 
	 企业残值率(%)：FEntResidualRate 
	 企业折旧工作量：FEntDeprWorkLoad 
	 法定折旧工作量：FLegalDeprWorkLoad 
	 工作量单位：FWorkLoadUnitID 
适用核算组织：FAcctPolicyOrgEntity 
	 实体主键：FEntryID 
	 是否默认：FIsDefault 
	 适用核算组织：FAcctOrgId 
	 是否已审核：FIsAudit 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_ACCTPOLICY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FACCTPOLICYID":0,"FNumber":"","FName":"","FCurrencyID":{"FNumber":""},"FAcctCalendarID":{"FNumber":""},"FAcctGroupID":{"FNumber":""},"FRateTypeID":{"FNumber":""},"FDescription":"","FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FIsCalByExpItem":"false","FISTAXAMOUNT":"false","FISCOSTACCOUNT":"false","FAcctSystem":{"FNUMBER":""},"FAcctPolicyAssetEntity":[{"FEntryID":0,"FAssetTypeID":{"FNumber":""},"FEntDeprYears":0,"FLegalDeprYears":0,"FWorkLoadUnitID":{"FNumber":""},"FEntDeprWorkLoad":0,"FLegalDeprWorkLoad":0,"FResidualType":"","FEntResidualRate":0,"FLegalResidualRate":0,"FResidualAmount":0,"FDeprMethod":"","FDeprPolicyID":{"FNumber":""},"FONETIMEDEPR":0}],"FAcctPolicyOrgEntity":[{"FEntryID":0,"FIsDefault":"false","FAcctSystemId":{"FNumber":""},"FAcctOrgId":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_ACCTPOLICY","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_ACCTPOLICY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_ACCTPOLICY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_ACCTPOLICY","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_ACCTPOLICY","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_ACCTPOLICY","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_ACCTPOLICY","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_ACCTPOLICY"}");

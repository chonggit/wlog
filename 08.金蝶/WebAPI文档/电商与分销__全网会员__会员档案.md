...
client.Delete("ECC_Member","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ECC_Member","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ECC_Member","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FMobilePhone":"","FEmail":"","FCityID":{"FNUMBER":""},"FCountryId":{"FNUMBER":""},"FRegionId":{"FNUMBER":""},"FCountyID":{"FNUMBER":""},"FStreetId":{"FNUMBER":""},"FBruiseHistory":"","FPhone":"","FQQ":"","FSourceStoreId":{"FNumber":""},"FFullAddress":"","FShop":{"FNUMBER":""},"FSourceCustId":{"FNUMBER":""},"FMemberTypeId":{"FNUMBER":""},"FMemberLevelId":{"FNUMBER":""},"FCardType":{"FNumber":""},"FCardNo":"","FSex":{"FNumber":""},"FAgeId":{"FNumber":""},"FShoppingGoodId":{"FNumber":""},"FCurrentAddress":"","FBirthDate":"1900-01-01","FAlipayID":"","FFAlipayAccount":"","FGlobalId":{"FNumber":""},"FMemberSource":"","FInterestName":"","FInterestId":"","FRelativeCustomerId":{"FNUMBER":""},"FSourceChannelId":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FAddress":{"FFullAddress":""},"FAssociateTime":"1900-01-01"}],"FEntity1":[{"FEntryID":0,"FCardId":{"FNumber":""},"FAccountTypeId":{"FNUMBER":""},"FMainBalance":0,"FPresentBalance":0}],"FEntityMarketingVolume":[{"FMEMBERID":{"FNUMBER":""},"FMEMBERLEVELID2":{"FNumber":""},"FMEMBERTYPEID2":{"FNUMBER":""},"FMARKETINGID":{"FNUMBER":""},"FISSUETYPE":""}],"FInterestEntity":[{"FIsSelect":"false","FInterest":{"FNumber":""}}],"FMEMBERINVOICEINFO":[{"FEntryID":0,"FINVOICEINFO":{"FInvoiceTitle":""},"FAssociateInvoiceInfoDate":"1900-01-01"}]}}");
        ...
        "FMEMBERINVOICEINFO": [
            {
                ...
                "FAssociateInvoiceInfoDate": "1900-01-01"
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 来源门店：FSourceStoreId 
	 全网会员编码：FGlobalId 
	 全网会员名称：FGlobalMemberName 
	 会员来源：FMemberSource 
	 QQ：FQQ 
	 年龄段：FAgeId 
	 身形：FBodyShapesId 
	 锻炼频度：FExerciseFrequencyId 
	 购买产品型号：FShoppingGoodId 
	 受伤史：FBruiseHistory 
	 城市：FCityID 
	 国家：FCountryId 
	 街道/乡镇：FStreetId 
	 ...
	 会员喜好：FInterestName 
	 会员喜好ID：FInterestId 
	 对应客户：FRelativeCustomerId 
	 来源渠道：FSourceChannelId 
单据体：FEntity 
	 实体主键：FEntryID 
	 收货地址：FAddress 
	 收货人：FBaseProperty 
	 手机号码：FReceiverMobile 
	 关联地址时间：FAssociateTime 
	 地址来源：FAddressSource 
	 地址创建时间：FAddressCreateTime 
	 固定电话：FTelePhone 
账户信息：FEntity1 
	 实体主键：FEntryID 
	 会员卡：FCardId 
	 账户：FAccountTypeId 
	 主账户余额：FMainBalance 
	 赠送账户余额：FPresentBalance 
	 账户计量单位：FUnitId 
	 有效期管理：FValidPeriod 
单据体：FEntityMarketingVolume 
	 实体主键： 
	 会员名称：FMEMBERID 
	 会员等级：FMEMBERLEVELID2 
	 会员种类：FMEMBERTYPEID2 
	 营销券：FMARKETINGID 
	 发放类型：FISSUETYPE 
单据体：FInterestEntity 
...
开票信息：FMEMBERINVOICEINFO 
	 ...
	 创建时间：FInvoiceInfoCreateTime 
	 创建人：FInvoiceInfoCreatorId 
	 开票信息来源：FInvoiceInfoSource 
	 发票信息：FINVOICEINFO 
	 关联时间：FAssociateInvoiceInfoDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ECC_Member","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ECC_Member","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ECC_Member","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ECC_Member","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ECC_Member","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ECC_Member","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ECC_Member","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ECC_Member"}");

# 岗位体系数据规则 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 安全管理 > 岗位体系数据规则
...
client.Delete("Post_DataRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("Post_DataRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FPERMISSIONID":0,"FBillNo":"","FROLEID":{"FNUMBER":""},"FREPORTTYPE":{"FNumber":""},"FEntity":[{"FEntryID":0,"FOBJECTTYPEID":{"FID":""},"FDIRECTSUBOPERATOR":"false","FALLSUBOPERATOR":"false","FMYDEPT":"false","FDIRECTSUBDEPT":"false","FALLSUBDEPT":"false","FDATARULEID":{"FNUMBER":""}}]}}");
        ...
        "FEntity": [
            {
                ...
                "FDIRECTSUBOPERATOR": "false",
                "FALLSUBOPERATOR": "false",
                "FMYDEPT": "false",
                "FDIRECTSUBDEPT": "false",
                "FALLSUBDEPT": "false",
                "FDATARULEID": {
                    "FNUMBER": ""
                }
...
单据体：FEntity 
	 ...
	 直接下属：FDIRECTSUBOPERATOR 
	 所有下属：FALLSUBOPERATOR 
	 其它业务员：FOTHEROPERATOR 
	 本部部门：FMYDEPT 
	 直属部门：FDIRECTSUBDEPT 
	 所有下级部门：FALLSUBDEPT 
	 其它部门：FOTHERDEPT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("Post_DataRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FPERMISSIONID":0,"FBillNo":"","FROLEID":{"FNUMBER":""},"FREPORTTYPE":{"FNumber":""},"FEntity":[{"FEntryID":0,"FOBJECTTYPEID":{"FID":""},"FDIRECTSUBOPERATOR":"false","FALLSUBOPERATOR":"false","FMYDEPT":"false","FDIRECTSUBDEPT":"false","FALLSUBDEPT":"false","FDATARULEID":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("Post_DataRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("Post_DataRule","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"Post_DataRule"}");

# 资产租入单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 租赁资产 > 资产租入单
...
client.Delete("FA_ASSETLEASEIN","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_ASSETLEASEIN","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAssetOrgID":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FISDEDUCTIBLE":"false","FBUSDATE":"1900-01-01","FPAYFREQ":"","FINVOCIETYPE":"","FBILLSTATUS":"","FCONTACTUNITTYPE":"","FCONTRACTNO":"","FCONTACTUNIT":{"FNumber":""},"FRemarks":"","FASSETTYPE":{"FNUMBER":""},"FUNIT":{"FNUMBER":""},"FNAME":"","FPOSITIONID":{"FNUMBER":""},"FQTY":0,"FSTARTDATE":"1900-01-01","FENDDATE":"1900-01-01","FPERIODS":0,"FFREEPERIODS":0,"FFREESTARTDATE":"1900-01-01","FFREEENDDATE":"1900-01-01","FCURRENCY":{"FNUMBER":""},"FRENTINLCTAXFOR":0,"FRENTEXCLTAXFOR":0,"FTAXRATE":0,"FPAYPERIODS":0,"FADVRENTINCLTAXFOR":0,"FLEASEPAYMENTFOR":0,"FLEASEPAYMENT":0,"FINITCOST":0,"FINITCOSTFOR":0,"FLEASEINCENTFOR":0,"FLEASEINCENT":0,"FPRDRCCOSTFOR":0,"FPRDRSDVALFOR":0,"FPRDEXREXPFOR":0,"FPRDTRMCOSTFOR":0,"FRATETYPE":{"FNUMBER":""},"FRATE":0,"FYEARDSCRATE":0,"FDSCRATE":0,"FUSEASSETVALFOR":0,"FUSEASSETVAL":0,"FLEASEDEBTFOR":0,"FUNFINAMOUTFOR":0,"FUNFINAMOUT":0,"FINTERESTTOTALFOR":0,"FINTERESTTOTAL":0,"FBASECURRENCY":{"FNUMBER":""},"FFIRSTPAYDATE":"1900-01-01","FCONTRACKNAME":"","FUNPAYPERIODS":0,"FPAYCOUNT":0,"FFREERENTEXCTAXFOR":0,"FFREERENTFOR":0,"FFINALPRESENDVALFOR":0,"FFINALPRESENDVAL":0,"FTOTALDAYS":0,"FPREPAYVALFOR":0,"FDUEDATE":"1900-01-01","FINTERESTPREFOR":0,"FPAYPREFOR":0,"FISHISTORY":"false","FLEASEPAYPLAN":[{"FEntryID":0,"FPAYPERIOD":0,"FPAYDATE":"1900-01-01","FPAYAMOUTFOR":0,"FPAYTAXRATE":0,"FPAYTAX":0,"FPAYAMOUTEXCTAXFOR":0,"FPAYCURRENCYID":{"FNUMBER":""},"FISPUSH":"false","FPAIDAMOUTFOR":0,"FAMORTISEDENDFOR":0,"FPRINCIPLEPFOR":0,"FUNFINAMOUTPFOR":0,"FPRINCIPLEPERIODFOR":0,"FINTERESTPERIODFOR":0,"FUNFINAMOUTENDFOR":0,"FINTERESTFOR":0,"FUNINTERESTFOR":0,"FISPREINTERESTCNF":"false","FDSCDAYS":0,"FDSCFAC":0,"FPRESENTVALFOR":0}],"FLEASEALLOC":[{"FEntryID":0,"FUSEDEPTID":{"FNUMBER":""},"FUSERID":{"FSTAFFNUMBER":""},"FRATIO":0,"FCOSTITEMID":{"FNUMBER":""}}],"FLEASEVCH":[{"FEntryID":0,"FVCHUSEDEPTID":{"FNUMBER":""},"FVCHRATE":0,"FVCHCOSTITEMID":{"FNUMBER":""},"FVCHISDEDUCTIBLE":"false","FVCHUSEASSETVALFOR":0,"FVCHUNFINAMOUTFOR":0,"FVCHLEASEPAYMENTFOR":0,"FVCHUSEASSETVAL":0,"FVCHUNFINAMOUT":0,"FVCHLEASEPAYMENT":0,"FVCHINTERESTPREFOR":0,"FVCHPAYPREFOR":0,"FVCHINTERESTPRE":0,"FVCHPAYPRE":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FPERIODS": 0,
        "FFREEPERIODS": 0,
        "FFREESTARTDATE": "1900-01-01",
        "FFREEENDDATE": "1900-01-01",
        "FCURRENCY": {
            "FNUMBER": ""
        },
        "FRENTINLCTAXFOR": 0,
        ...
        "FFIRSTPAYDATE": "1900-01-01",
        "FCONTRACKNAME": "",
        "FUNPAYPERIODS": 0,
        "FPAYCOUNT": 0,
        "FFREERENTEXCTAXFOR": 0,
        "FFREERENTFOR": 0,
        "FFINALPRESENDVALFOR": 0,
        "FFINALPRESENDVAL": 0,
        "FTOTALDAYS": 0,
        "FPREPAYVALFOR": 0,
        "FDUEDATE": "1900-01-01",
        ...
        "FLEASEPAYPLAN": [
            {
                ...
                "FPRINCIPLEPFOR": 0,
                "FUNFINAMOUTPFOR": 0,
                "FPRINCIPLEPERIODFOR": 0,
                "FINTERESTPERIODFOR": 0,
                "FUNFINAMOUTENDFOR": 0,
                "FINTERESTFOR": 0,
                "FUNINTERESTFOR": 0,
                "FISPREINTERESTCNF": "false",
                "FDSCDAYS": 0,
                "FDSCFAC": 0,
                "FPRESENTVALFOR": 0
            }
        ...
        "FLEASEVCH": [
            {
                ...
                "FVCHISDEDUCTIBLE": "false",
                "FVCHUSEASSETVALFOR": 0,
                "FVCHUNFINAMOUTFOR": 0,
                "FVCHLEASEPAYMENTFOR": 0,
                "FVCHUSEASSETVAL": 0,
                "FVCHUNFINAMOUT": 0,
                "FVCHLEASEPAYMENT": 0,
                "FVCHINTERESTPREFOR": 0,
                "FVCHPAYPREFOR": 0,
                "FVCHINTERESTPRE": 0,
                "FVCHPAYPRE": 0
            }
...
单据头：FBillHead 
	 ...
	 审核日期：FApproveDate 
	 汇率类型：FRATETYPE  (必填项)
	 使用权资产：FUSEASSETVALFOR 
	 年折现率(%)：FYEARDSCRATE 
	 日折现率(%)：FDSCRATE 
	 汇率：FRATE 
	 备注：FRemarks 
	 免租期(月)：FFREEPERIODS 
	 存放位置：FPOSITIONID  (必填项)
	 合同号：FCONTRACTNO  (必填项)
	 ...
	 起租日期：FSTARTDATE  (必填项)
	 资产名称：FNAME  (必填项)
	 免租开始日期：FFREESTARTDATE 
	 资产类别：FASSETTYPE  (必填项)
	 业务日期：FBUSDATE  (必填项)
	 初始直接费用：FINITCOSTFOR 
	 租赁激励：FLEASEINCENTFOR 
	 预计复原成本：FPRDRCCOSTFOR 
	 预计担保余值：FPRDRSDVALFOR 
	 预计行权费用：FPRDEXREXPFOR 
	 预计终止费用：FPRDTRMCOSTFOR 
	 付款频率单位：FPAYFREQ  (必填项)
	 原币别：FCURRENCY 
	 租金总额(含税)：FRENTINLCTAXFOR 
	 租金总额(不含税)：FRENTEXCLTAXFOR 
	 税率(%)：FTAXRATE 
	 是否可抵扣：FISDEDUCTIBLE 
	 发票类型：FINVOCIETYPE  (必填项)
	 总付款期数：FPAYPERIODS 
	 确认日之前的租金（含税）：FADVRENTINCLTAXFOR 
	 租赁负债(租赁付款额)：FLEASEPAYMENTFOR 
	 租赁负债(租赁付款额)本位币：FLEASEPAYMENT 
	 使用权资产(本位币)：FUSEASSETVAL 
	 租赁负债：FLEASEDEBTFOR 
	 租赁负债（未确认融资费用）：FUNFINAMOUTFOR 
	 租赁负债(未确认融资费用)本位币：FUNFINAMOUT 
	 累计确认利息费用：FINTERESTTOTALFOR 
	 累计确认利息费用（本位币）：FINTERESTTOTAL 
	 已付款合计：FPAIDAMOUTTOTALFOR 
	 已付款合计（本位币）：FPAIDAMOUTTOTAL 
	 业务状态：FBILLSTATUS 
	 本位币：FBASECURRENCY  (必填项)
	 首次付款日期：FFIRSTPAYDATE  (必填项)
	 往来单位类型：FCONTACTUNITTYPE  (必填项)
	 出租方：FCONTACTUNIT  (必填项)
	 禁用状态：FForbidStatus 
	 合同名称：FCONTRACKNAME  (必填项)
	 关联卡片编码：FALTERID 
	 确认日后的付款期数：FUNPAYPERIODS 
	 未确认融资费用（余额）：FUNFINAMOUTFORBAL 
	 租赁负债（租赁付款额）余额：FLEASEDEBTFORBAL 
	 付款频率：FPAYCOUNT 
	 免租金额：FFREERENTEXCTAXFOR 
	 免租金额(含税)：FFREERENTFOR 
	 租赁结束费用现值：FFINALPRESENDVALFOR 
	 租赁天数：FTOTALDAYS 
	 预付租金(含税)：FPREPAYVALFOR 
	 免租结束日期：FFREEENDDATE 
	 租赁负债确认日期：FDUEDATE 
	 初始直接费用本位币：FINITCOST 
	 租赁激励本位币：FLEASEINCENT 
	 租赁结束费用现值本位币：FFINALPRESENDVAL 
	 入账前已确认利息：FINTERESTPREFOR 
	 入账前已支付租金（含税）：FPAYPREFOR 
	 历史租入：FISHISTORY 
	 创建来源：FSOURCE 
	 使用权资产调整：FUSEASSETVALFORDIFF 
	 租赁负债(租赁付款额)调整：FLEASEPAYMENTFORDIFF 
	 未确认融资费用调整：FUNFINAMOUTFORDIFF 
	 原始租入单编码：FINITLEASEINID 
	 变更前租入单：FPRELEASEINID 
	 变更次数：FCHANGECOUNT 
	 已下推资产变更单：FISPUSHCHANGE 
付款计划：FLEASEPAYPLAN 
	 实体主键：FEntryID 
	 付款期次：FPAYPERIOD 
	 计划付款日期：FPAYDATE 
	 付款金额(含税)：FPAYAMOUTFOR 
	 税率(%)：FPAYTAXRATE 
	 税额：FPAYTAX 
	 付款金额(不含税)：FPAYAMOUTEXCTAXFOR 
	 付款币别：FPAYCURRENCYID 
	 已生成报销单：FISPUSH 
	 已付款金额：FPAIDAMOUTFOR 
	 期末摊余成本：FAMORTISEDENDFOR 
	 期初本金：FPRINCIPLEPFOR 
	 期初未确认融资费：FUNFINAMOUTPFOR 
	 本期应归还本金：FPRINCIPLEPERIODFOR 
	 本付款期利息：FINTERESTPERIODFOR 
	 期末未确认融资费用：FUNFINAMOUTENDFOR 
	 已确认利息：FINTERESTFOR 
	 未确认利息：FUNINTERESTFOR 
	 上期利息已确认：FISPREINTERESTCNF 
	 折现天数：FDSCDAYS 
	 折现系数：FDSCFAC 
	 现值：FPRESENTVALFOR 
使用分配：FLEASEALLOC 
	 ...
	 使用人：FUSERID 
	 分配比例(%)：FRATIO 
	 费用项目：FCOSTITEMID  (必填项)
凭证信息：FLEASEVCH 
	 实体主键：FEntryID 
	 使用部门：FVCHUSEDEPTID 
	 分配比例：FVCHRATE 
	 费用项目：FVCHCOSTITEMID 
	 是否可抵扣：FVCHISDEDUCTIBLE 
	 使用权资产：FVCHUSEASSETVALFOR 
	 租赁负债(未确认融资费用)：FVCHUNFINAMOUTFOR 
	 租赁负债（租赁付款额）：FVCHLEASEPAYMENTFOR 
	 使用权资产（本位币）：FVCHUSEASSETVAL 
	 租赁负债（未确认融资费用）本位币：FVCHUNFINAMOUT 
	 租赁负债（租赁付款额）本位币：FVCHLEASEPAYMENT 
	 入账前已确认利息：FVCHINTERESTPREFOR 
	 入账前已支付租金（含税）：FVCHPAYPREFOR 
	 入账前已确认利息（本位币）：FVCHINTERESTPRE 
	 入账前已支付租金（含税）本位币：FVCHPAYPRE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_ASSETLEASEIN","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAssetOrgID":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FISDEDUCTIBLE":"false","FBUSDATE":"1900-01-01","FPAYFREQ":"","FINVOCIETYPE":"","FBILLSTATUS":"","FCONTACTUNITTYPE":"","FCONTRACTNO":"","FCONTACTUNIT":{"FNumber":""},"FRemarks":"","FASSETTYPE":{"FNUMBER":""},"FUNIT":{"FNUMBER":""},"FNAME":"","FPOSITIONID":{"FNUMBER":""},"FQTY":0,"FSTARTDATE":"1900-01-01","FENDDATE":"1900-01-01","FPERIODS":0,"FFREEPERIODS":0,"FFREESTARTDATE":"1900-01-01","FFREEENDDATE":"1900-01-01","FCURRENCY":{"FNUMBER":""},"FRENTINLCTAXFOR":0,"FRENTEXCLTAXFOR":0,"FTAXRATE":0,"FPAYPERIODS":0,"FADVRENTINCLTAXFOR":0,"FLEASEPAYMENTFOR":0,"FLEASEPAYMENT":0,"FINITCOST":0,"FINITCOSTFOR":0,"FLEASEINCENTFOR":0,"FLEASEINCENT":0,"FPRDRCCOSTFOR":0,"FPRDRSDVALFOR":0,"FPRDEXREXPFOR":0,"FPRDTRMCOSTFOR":0,"FRATETYPE":{"FNUMBER":""},"FRATE":0,"FYEARDSCRATE":0,"FDSCRATE":0,"FUSEASSETVALFOR":0,"FUSEASSETVAL":0,"FLEASEDEBTFOR":0,"FUNFINAMOUTFOR":0,"FUNFINAMOUT":0,"FINTERESTTOTALFOR":0,"FINTERESTTOTAL":0,"FBASECURRENCY":{"FNUMBER":""},"FFIRSTPAYDATE":"1900-01-01","FCONTRACKNAME":"","FUNPAYPERIODS":0,"FPAYCOUNT":0,"FFREERENTEXCTAXFOR":0,"FFREERENTFOR":0,"FFINALPRESENDVALFOR":0,"FFINALPRESENDVAL":0,"FTOTALDAYS":0,"FPREPAYVALFOR":0,"FDUEDATE":"1900-01-01","FINTERESTPREFOR":0,"FPAYPREFOR":0,"FISHISTORY":"false","FLEASEPAYPLAN":[{"FEntryID":0,"FPAYPERIOD":0,"FPAYDATE":"1900-01-01","FPAYAMOUTFOR":0,"FPAYTAXRATE":0,"FPAYTAX":0,"FPAYAMOUTEXCTAXFOR":0,"FPAYCURRENCYID":{"FNUMBER":""},"FISPUSH":"false","FPAIDAMOUTFOR":0,"FAMORTISEDENDFOR":0,"FPRINCIPLEPFOR":0,"FUNFINAMOUTPFOR":0,"FPRINCIPLEPERIODFOR":0,"FINTERESTPERIODFOR":0,"FUNFINAMOUTENDFOR":0,"FINTERESTFOR":0,"FUNINTERESTFOR":0,"FISPREINTERESTCNF":"false","FDSCDAYS":0,"FDSCFAC":0,"FPRESENTVALFOR":0}],"FLEASEALLOC":[{"FEntryID":0,"FUSEDEPTID":{"FNUMBER":""},"FUSERID":{"FSTAFFNUMBER":""},"FRATIO":0,"FCOSTITEMID":{"FNUMBER":""}}],"FLEASEVCH":[{"FEntryID":0,"FVCHUSEDEPTID":{"FNUMBER":""},"FVCHRATE":0,"FVCHCOSTITEMID":{"FNUMBER":""},"FVCHISDEDUCTIBLE":"false","FVCHUSEASSETVALFOR":0,"FVCHUNFINAMOUTFOR":0,"FVCHLEASEPAYMENTFOR":0,"FVCHUSEASSETVAL":0,"FVCHUNFINAMOUT":0,"FVCHLEASEPAYMENT":0,"FVCHINTERESTPREFOR":0,"FVCHPAYPREFOR":0,"FVCHINTERESTPRE":0,"FVCHPAYPRE":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_ASSETLEASEIN","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_ASSETLEASEIN","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_ASSETLEASEIN","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_ASSETLEASEIN","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("FA_ASSETLEASEIN","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_ASSETLEASEIN","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_ASSETLEASEIN"}");

# 归档条码拆装箱 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 归档条码拆装箱
...
client.Save("UN_ArchivePackaging","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"Fpackaging":"","FBarCodeScan":"","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FEntryCount":0,"FSumQty":0,"FBoxMaterialId":{"FNUMBER":""},"FIsMix":"false","FBoxCapacity":0,"FInstalledQty":0,"FExpressNo":"","FPackRemark":"","FSupplierId":{"FNUMBER":""},"FCreateOrgId":{"FNumber":""},"FBEGINBARCODE":"","FENDBARCODE":"","FSalDeliveryNoticeNo":"","FUnitOfInstall":{"FNumber":""},"FEntity":[{"FEntryID":0,"FEntryBarCode":"","FItemID":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FLot":{"FNumber":""},"FQty":0,"FDetailCount":0,"FDetailBillcode":"","FRemark":""}]}}");
...
单据头：FBillHead 
	 ...
	 供应商：FSupplierId 
	 创建组织：FCreateOrgId 
	 明细开始条码：FBEGINBARCODE 
	 明细结束条码：FENDBARCODE 
	 发货通知单单号：FSalDeliveryNoticeNo 
	 已装件数(计量单位)：FUnitOfInstall 
单据体：FEntity 
	 实体主键：FEntryID 
	 条形码：FEntryBarCode 
	 物料：FItemID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("UN_ArchivePackaging","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_ArchivePackaging"}");

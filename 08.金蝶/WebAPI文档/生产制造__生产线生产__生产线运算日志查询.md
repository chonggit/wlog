# 生产线运算日志查询 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产线生产 > 生产线运算日志查询
...
client.Delete("REM_RunProcedure","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("REM_RunProcedure","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("REM_RunProcedure","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FModelName":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModelBeginTime":"1900-01-01","FModelEndTime":"1900-01-01","FRunMinute":0,"FModelProgressValue":0,"FProgressMessage":"","FRunStatus":"","FBizType":"","FComputerId":"","FPrdOrgId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FProcedureName":"","FRunSecond":0,"FProgressValue":0,"FRunResult":"","FDetail":"","FParentRowId":"","FExpandType":"","FRowId":"","FDetailClass":"","FBeginTime":"1900-01-01","FEndTime":"1900-01-01"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FModelBeginTime": "1900-01-01",
        "FModelEndTime": "1900-01-01",
        "FRunMinute": 0,
        "FModelProgressValue": 0,
        "FProgressMessage": "",
        "FRunStatus": "",
        "FBizType": "",
        "FComputerId": "",
...
单据头：FBillHead 
	 ...
	 执行人：FCreatorId 
	 执行日期：FCreateDate 
	 开始时间：FModelBeginTime 
	 结束时间：FModelEndTime 
	 运行时间(分钟)：FRunMinute 
	 进度值：FModelProgressValue 
	 进度信息：FProgressMessage 
	 运行状态：FRunStatus 
	 业务类型：FBizType 
	 运算标识：FComputerId 
	 生产组织：FPrdOrgId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("REM_RunProcedure","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FModelName":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModelBeginTime":"1900-01-01","FModelEndTime":"1900-01-01","FRunMinute":0,"FModelProgressValue":0,"FProgressMessage":"","FRunStatus":"","FBizType":"","FComputerId":"","FPrdOrgId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FProcedureName":"","FRunSecond":0,"FProgressValue":0,"FRunResult":"","FDetail":"","FParentRowId":"","FExpandType":"","FRowId":"","FDetailClass":"","FBeginTime":"1900-01-01","FEndTime":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("REM_RunProcedure","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("REM_RunProcedure","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("REM_RunProcedure","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("REM_RunProcedure","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("REM_RunProcedure","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("REM_RunProcedure","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"REM_RunProcedure"}");

...
client.Delete("CN_BILLPAYABLE","Delete","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBILLTYPE":"","FCONTACTUNITTYPE":"","FBILLNUMBER":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FDate":"1900-01-01","FDUEDATE":"1900-01-01","FPARAMOUNTFOR":0,"FPARRATE":0,"FACCEPTOR":"","FCOMMENT":"","FREVOCABLE":"false","FRECOURSE":"false","FSETTLEORGID":{"FNumber":""},"FBillNo":"","FPURCHASEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FPURCHASERGROUPID":{"FNumber":""},"FPURCHASERID":{"FNumber":""},"FPAYBANKID":{"FNumber":""},"FPAYBANKACNTID":{"FNumber":""},"FRECBANKNAME":"","FRECBANKACNTNO":"","FRECACNTNAME":"","FRECBANKADDRESS":"","FExchangeRate":0,"FPAYORGID":{"FNumber":""},"FREVOCABLENEW":"false","FRECOURSENEW":"false","FScanPoint":{"FNUMBER":""},"FISINIT":"false","FNoteStatus":"","FBankInvoice":"false","FISELECTRONICBILL":"false","FUNPAYAMOUTFOR":0,"FUNPAYAMOUT":0,"FRCBILLNUMBER":"","FStandardAmt":0,"FEquidiffBill":"false","FPAYBILLTYPE":{"FNUMBER":""},"FSUBBILLSTARTNO":0,"FSUBBILLENDNO":0,"FBILLPAYOTHER":{"FEntryId":0},"FEntity":[{"FEntryID":0}],"FBILLPAYABLEENTRY":[{"FENTRYID":0,"FSRCBILLTYPEID":"","FSRCBILLNO":"","FSPLEDGEAMOUNT":0,"FPLANRECAMOUNT":0,"FREALRECAMOUNT":0,"FRECBILLBILLNO":"","FSRCBILLID":0,"FSRCROWID":0,"FRECBILLBILLID":0}]}}");
...
单据头：FBillHead 
	 ...
	 收款银行地址：FRECBANKADDRESS 
	 收款账户名称：FRECACNTNAME 
	 收款银行：FRECBANKNAME 
	 结算组织：FSETTLEORGID  (必填项)
	 签发日：FDate  (必填项)
	 承兑人：FACCEPTOR  (必填项)
	 收款银行账号：FRECBANKACNTNO 
	 票面利率(%)：FPARRATE 
	 备注：FCOMMENT 
	 本位币：FMainBookCurId 
	 票面金额(本位币)：FPARAMOUNT 
	 ...
	 到期金额：FDUEAMOUNTFOR 
	 票面金额：FPARAMOUNTFOR 
	 付款账户名称：FKDBPPAYBANKACNTNAME 
	 汇率：FExchangeRate 
	 结算状态：FSETTLESTATUS 
	 付款银行账号：FPAYBANKACNTID 
	 ...
	 付款银行地址：FKDBPPAYBANKACNTADDR 
	 付款组织：FPAYORGID  (必填项)
	 收款单位类型：FCONTACTUNITTYPE  (必填项)
	 收款单位：FCONTACTUNIT  (必填项)
	 可撤销：FREVOCABLENEW 
	 带追索权：FRECOURSENEW 
	 扫描点：FScanPoint 
	 期初：FISINIT 
	 ...
	 未付款票面金额：FUNPAYAMOUTFOR 
	 未付款票面金额(本位币)：FUNPAYAMOUT 
	 票据号码：FRCBILLNUMBER 
	 标准票据金额：FStandardAmt 
	 等分化票据：FEquidiffBill 
	 付款单据类型：FPAYBILLTYPE 
...
单据体：FEntity 
	 实体主键：FEntryID 
	 单据类型：FKDBPPAYBILLTYPE 
	 单据编码：FPAYBILLID 
	 业务日期：FKDBPBILLDATE 
	 占用票据金额：FKDBPCURRUSEDAMOUNT 
	 付款组织：FKDBPPAYORGID 
	 结算组织：FKDBPSETTLEORGID 
...
子单据头：FBILLPAYOTHER 
	 ...
	 修改人：FModifierId 
	 创建人：FCreatorId 
担保来源：FBILLPAYABLEENTRY 
	 实体主键：FENTRYID 
	 源单类型：FSRCBILLTYPEID 
	 质押金额：FSPLEDGEAMOUNT 
	 可用金额：FPLANRECAMOUNT 
	 本次使用金额：FREALRECAMOUNT 
	 应收票据号：FRECBILLBILLNO 
	 源单内码：FSRCBILLID 
	 源单行内码：FSRCROWID 
	 应收票内码：FRECBILLBILLID 
	 源单编号：FSRCBILLNO 
关联关系表：FBILLPAYABLEENTRY_Link 
	 实体主键：FLinkId 
	 业务流程图：FBILLPAYABLEENTRY_Link_FFlowId 
	 推进路线：FBILLPAYABLEENTRY_Link_FFlowLineId 
	 转换规则：FBILLPAYABLEENTRY_Link_FRuleId 
	 源单表内码：FBILLPAYABLEENTRY_Link_FSTableId 
	 源单表：FBILLPAYABLEENTRY_Link_FSTableName 
	 源单内码：FBILLPAYABLEENTRY_Link_FSBillId 
	 源单分录内码：FBILLPAYABLEENTRY_Link_FSId 
	 原始携带量：FBILLPAYABLEENTRY_Link_FREALRECAMOUNTOld 
	 修改携带量：FBILLPAYABLEENTRY_Link_FREALRECAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_BILLPAYABLE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPE":"","FCONTACTUNITTYPE":"","FBILLNUMBER":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FDate":"1900-01-01","FDUEDATE":"1900-01-01","FPARAMOUNTFOR":0,"FPARRATE":0,"FACCEPTOR":"","FCOMMENT":"","FREVOCABLE":"false","FRECOURSE":"false","FSETTLEORGID":{"FNumber":""},"FBillNo":"","FPURCHASEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FPURCHASERGROUPID":{"FNumber":""},"FPURCHASERID":{"FNumber":""},"FPAYBANKID":{"FNumber":""},"FPAYBANKACNTID":{"FNumber":""},"FRECBANKNAME":"","FRECBANKACNTNO":"","FRECACNTNAME":"","FRECBANKADDRESS":"","FExchangeRate":0,"FPAYORGID":{"FNumber":""},"FREVOCABLENEW":"false","FRECOURSENEW":"false","FScanPoint":{"FNUMBER":""},"FISINIT":"false","FNoteStatus":"","FBankInvoice":"false","FISELECTRONICBILL":"false","FUNPAYAMOUTFOR":0,"FUNPAYAMOUT":0,"FRCBILLNUMBER":"","FStandardAmt":0,"FEquidiffBill":"false","FPAYBILLTYPE":{"FNUMBER":""},"FSUBBILLSTARTNO":0,"FSUBBILLENDNO":0,"FBILLPAYOTHER":{"FEntryId":0},"FEntity":[{"FEntryID":0}],"FBILLPAYABLEENTRY":[{"FENTRYID":0,"FSRCBILLTYPEID":"","FSRCBILLNO":"","FSPLEDGEAMOUNT":0,"FPLANRECAMOUNT":0,"FREALRECAMOUNT":0,"FRECBILLBILLNO":"","FSRCBILLID":0,"FSRCROWID":0,"FRECBILLBILLID":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_BILLPAYABLE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPE":"","FCONTACTUNITTYPE":"","FBILLNUMBER":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FDate":"1900-01-01","FDUEDATE":"1900-01-01","FPARAMOUNTFOR":0,"FPARRATE":0,"FACCEPTOR":"","FCOMMENT":"","FREVOCABLE":"false","FRECOURSE":"false","FSETTLEORGID":{"FNumber":""},"FBillNo":"","FPURCHASEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FPURCHASERGROUPID":{"FNumber":""},"FPURCHASERID":{"FNumber":""},"FPAYBANKID":{"FNumber":""},"FPAYBANKACNTID":{"FNumber":""},"FRECBANKNAME":"","FRECBANKACNTNO":"","FRECACNTNAME":"","FRECBANKADDRESS":"","FExchangeRate":0,"FPAYORGID":{"FNumber":""},"FREVOCABLENEW":"false","FRECOURSENEW":"false","FScanPoint":{"FNUMBER":""},"FISINIT":"false","FNoteStatus":"","FBankInvoice":"false","FISELECTRONICBILL":"false","FUNPAYAMOUTFOR":0,"FUNPAYAMOUT":0,"FRCBILLNUMBER":"","FStandardAmt":0,"FEquidiffBill":"false","FPAYBILLTYPE":{"FNUMBER":""},"FSUBBILLSTARTNO":0,"FSUBBILLENDNO":0,"FBILLPAYOTHER":{"FEntryId":0},"FEntity":[{"FEntryID":0}],"FBILLPAYABLEENTRY":[{"FENTRYID":0,"FSRCBILLTYPEID":"","FSRCBILLNO":"","FSPLEDGEAMOUNT":0,"FPLANRECAMOUNT":0,"FREALRECAMOUNT":0,"FRECBILLBILLNO":"","FSRCBILLID":0,"FSRCROWID":0,"FRECBILLBILLID":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_BILLPAYABLE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_BILLPAYABLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BILLPAYABLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_BILLPAYABLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_BILLPAYABLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CN_BILLPAYABLE","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BILLPAYABLE","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BILLPAYABLE","StepBack","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBILLTYPE":"","FCONTACTUNITTYPE":"","FBILLNUMBER":"","FCONTACTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FDate":"1900-01-01","FDUEDATE":"1900-01-01","FPARAMOUNTFOR":0,"FPARRATE":0,"FACCEPTOR":"","FCOMMENT":"","FREVOCABLE":"false","FRECOURSE":"false","FSETTLEORGID":{"FNumber":""},"FBillNo":"","FPURCHASEORGID":{"FNumber":""},"FDEPARTMENTID":{"FNumber":""},"FPURCHASERGROUPID":{"FNumber":""},"FPURCHASERID":{"FNumber":""},"FPAYBANKID":{"FNumber":""},"FPAYBANKACNTID":{"FNumber":""},"FRECBANKNAME":"","FRECBANKACNTNO":"","FRECACNTNAME":"","FRECBANKADDRESS":"","FExchangeRate":0,"FPAYORGID":{"FNumber":""},"FREVOCABLENEW":"false","FRECOURSENEW":"false","FScanPoint":{"FNUMBER":""},"FISINIT":"false","FNoteStatus":"","FBankInvoice":"false","FISELECTRONICBILL":"false","FUNPAYAMOUTFOR":0,"FUNPAYAMOUT":0,"FRCBILLNUMBER":"","FStandardAmt":0,"FEquidiffBill":"false","FPAYBILLTYPE":{"FNUMBER":""},"FSUBBILLSTARTNO":0,"FSUBBILLENDNO":0,"FBILLPAYOTHER":{"FEntryId":0},"FEntity":[{"FEntryID":0}],"FBILLPAYABLEENTRY":[{"FENTRYID":0,"FSRCBILLTYPEID":"","FSRCBILLNO":"","FSPLEDGEAMOUNT":0,"FPLANRECAMOUNT":0,"FREALRECAMOUNT":0,"FRECBILLBILLNO":"","FSRCBILLID":0,"FSRCROWID":0,"FRECBILLBILLID":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_BILLPAYABLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BILLPAYABLE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_BILLPAYABLE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_BILLPAYABLE"}");

# 辅助属性值 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 基础资料 > 辅助属性值
...
client.Delete("BD_AuxPtyValue","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_AuxPtyValue","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FAuxPtyValueID":0,"FMaterialId":{"FNumber":""},"FMaterialAuxPropertyId":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FEntity":[{"FEntryID":0,"FAuxPtyNumber":"","FAuxPtyName":"","FIsDefault":"false","FIsDisable":"false"}]}}");
...
单据头：FBillHead 
	 ...
	 单据编号：FBillNo 
	 物料名称：FMaterialName 
	 辅助属性：FMaterialAuxPropertyId  (必填项)
	 ...
	 禁用人：FForbidderId 
	 审核日期：FApproveDate 
	 后台预插：FIsSysPreInsert 
辅助属性值表体：FEntity 
	 实体主键：FEntryID 
	 选择：FIsSelect 
	 默认：FIsDefault 
	 禁用：FIsDisable 
	 编码：FAuxPtyNumber  (必填项)
	 辅助属性内码：FAuxPtyId 
	 名称：FAuxPtyName 
	 显示顺序：FDisplaySeq 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_AuxPtyValue","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_AuxPtyValue","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FAuxPtyValueID":0,"FMaterialId":{"FNumber":""},"FMaterialAuxPropertyId":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FEntity":[{"FEntryID":0,"FAuxPtyNumber":"","FAuxPtyName":"","FIsDefault":"false","FIsDisable":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_AuxPtyValue"}");

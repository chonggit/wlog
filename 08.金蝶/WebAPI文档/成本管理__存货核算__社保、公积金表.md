# 社保、公积金表 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 社保、公积金表
...
client.Delete("QRDO_Accumulation","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QRDO_Accumulation","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FUseOrgId":{"FNumber":""},"FDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FDeptName":"","FRankName":"","FCostCenter":"","FPeopleCount":0,"FDeptIncome":0,"FPepleIncome":0,"FTotalIncome":0,"FAccountName":"","FAccountDimension":{"FNUMBER":""},"FCostDimension":{"FNUMBER":""},"FDeptDimension":{"FNUMBER":""},"F_ora_Text":"","F_ora_YXZH":{"FNUMBER":""}}]}}");
...
单据体：FEntity 
	 ...
	 职级：FRankName 
	 人数：FPeopleCount 
	 单位月缴存额(元)：FDeptIncome 
	 个人月缴存额(元)：FPepleIncome 
	 月缴存额合计(元)：FTotalIncome 
	 科技人员后部门：FDeptName 
	 科目：FAccountName 
	 科目纬度1：FAccountDimension 
	 成本中心：FCostCenter 
	 费用项目维度2：FCostDimension 
	 部门维度3：FDeptDimension 
	 摘要：F_ora_Text 
	 银行账号：F_ora_YXZH  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QRDO_Accumulation","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FUseOrgId":{"FNumber":""},"FDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FDeptName":"","FRankName":"","FCostCenter":"","FPeopleCount":0,"FDeptIncome":0,"FPepleIncome":0,"FTotalIncome":0,"FAccountName":"","FAccountDimension":{"FNUMBER":""},"FCostDimension":{"FNUMBER":""},"FDeptDimension":{"FNUMBER":""},"F_ora_Text":"","F_ora_YXZH":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QRDO_Accumulation","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QRDO_Accumulation","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QRDO_Accumulation","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QRDO_Accumulation","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QRDO_Accumulation","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QRDO_Accumulation"}");

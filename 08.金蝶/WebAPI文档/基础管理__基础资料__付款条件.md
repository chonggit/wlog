...
client.Delete("BD_PaymentCondition","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_PaymentCondition","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_PaymentCondition","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FMutDueStd":"","FAccountTimeJudge":"","FDescription":"","FPAYMENTMETHOD":"","FISINSTALLMENT":"false","FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FISMATCHBYRATE":"false","FPayRecCondtionEntry":[{"FEntryID":0,"FAmount":0,"FRate":0,"FISPREPAID":"false","FDueCalMethodID":{"FNUMBER":""},"FDueCalMethodDesc":"","FODConfirmMethod":"","FTHISMONTHEND":0,"FODMonth":0,"FODDay":0,"FISMONTHEND":"false","FODDayToEndMonth":0,"FODFixedDayOne":0,"FODFixedDayTwo":0,"FODFixedDayThree":0,"FODFixedDayMatchWay":"","FWorkCalID":{"FNUMBER":""},"FODFIXEDDAYONEBEG":0,"FODFIXEDDAYONEEND":0,"FODFIXEDDAYTWOBEG":0,"FODFIXEDDAYTWOEND":0,"FODFIXEDDAYTHREEBEG":0,"FODFIXEDDAYTHREEEND":0,"FODFixedDayFour":0,"FODFIXEDDAYFOURBEG":0,"FODFIXEDDAYFOUREND":0,"FNEXTPERIOD1":"","FNEXTPERIOD2":"","FNEXTPERIOD3":"","FNEXTPERIOD4":"","FendDateBegin":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FISMATCHBYRATE": "false",
        "FPayRecCondtionEntry": [
            {
                "FEntryID": 0,
                "FAmount": 0,
                "FRate": 0,
                ...
                "FODFIXEDDAYTWOBEG": 0,
                "FODFIXEDDAYTWOEND": 0,
                "FODFIXEDDAYTHREEBEG": 0,
                "FODFIXEDDAYTHREEEND": 0,
                "FODFixedDayFour": 0,
                "FODFIXEDDAYFOURBEG": 0,
                "FODFIXEDDAYFOUREND": 0,
                "FNEXTPERIOD1": "",
                "FNEXTPERIOD2": "",
                "FNEXTPERIOD3": "",
                "FNEXTPERIOD4": "",
...
单据头：FBillHead 
	 ...
	 禁用日期：FForbidDate 
	 系统预设：FIsSysPreset 
	 到期日计算日期：FAccountTimeJudge  (必填项)
	 多到期日设置标准：FMutDueStd  (必填项)
	 是否分期付款：FISINSTALLMENT 
	 付款方式：FPAYMENTMETHOD  (必填项)
	 预付比例核销：FISMATCHBYRATE 
单据体：FPayRecCondtionEntry 
	 实体主键：FEntryID 
	 比例(%)：FRate 
	 到期日确定方式：FODConfirmMethod 
	 账单结算日：FTHISMONTHEND 
	 月数：FODMonth 
	 天数：FODDay 
	 月底：FISMONTHEND 
	 固定日1：FODFixedDayOne 
	 固定日2：FODFixedDayTwo 
	 固定日3：FODFixedDayThree 
	 固定日匹配方式：FODFixedDayMatchWay 
	 金额：FAmount 
	 距离月底天数：FODDayToEndMonth 
	 到期日确定方式：FDueCalMethodID 
	 到期日确定方式描述：FDueCalMethodDesc 
	 预付：FISPREPAID 
	 工作日历：FWorkCalID 
	 固定日1-起：FODFIXEDDAYONEBEG 
	 固定日1-止：FODFIXEDDAYONEEND 
	 固定日2-起：FODFIXEDDAYTWOBEG 
	 固定日2-止：FODFIXEDDAYTWOEND 
	 固定日3-起：FODFIXEDDAYTHREEBEG 
	 固定日3-止：FODFIXEDDAYTHREEEND 
	 固定日4：FODFixedDayFour 
	 固定日4-起：FODFIXEDDAYFOURBEG 
	 固定日4-止：FODFIXEDDAYFOUREND 
	 跨期(月/年)1：FNEXTPERIOD1 
	 跨期(月/年)2：FNEXTPERIOD2 
	 跨期(月/年)3：FNEXTPERIOD3 
	 跨期(月/年)4：FNEXTPERIOD4 
	 到期日起算日：FendDateBegin 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_PaymentCondition","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FMutDueStd":"","FAccountTimeJudge":"","FDescription":"","FPAYMENTMETHOD":"","FISINSTALLMENT":"false","FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FISMATCHBYRATE":"false","FPayRecCondtionEntry":[{"FEntryID":0,"FAmount":0,"FRate":0,"FISPREPAID":"false","FDueCalMethodID":{"FNUMBER":""},"FDueCalMethodDesc":"","FODConfirmMethod":"","FTHISMONTHEND":0,"FODMonth":0,"FODDay":0,"FISMONTHEND":"false","FODDayToEndMonth":0,"FODFixedDayOne":0,"FODFixedDayTwo":0,"FODFixedDayThree":0,"FODFixedDayMatchWay":"","FWorkCalID":{"FNUMBER":""},"FODFIXEDDAYONEBEG":0,"FODFIXEDDAYONEEND":0,"FODFIXEDDAYTWOBEG":0,"FODFIXEDDAYTWOEND":0,"FODFIXEDDAYTHREEBEG":0,"FODFIXEDDAYTHREEEND":0,"FODFixedDayFour":0,"FODFIXEDDAYFOURBEG":0,"FODFIXEDDAYFOUREND":0,"FNEXTPERIOD1":"","FNEXTPERIOD2":"","FNEXTPERIOD3":"","FNEXTPERIOD4":"","FendDateBegin":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_PaymentCondition","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_PaymentCondition","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_PaymentCondition","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_PaymentCondition","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_PaymentCondition","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_PaymentCondition","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_PaymentCondition","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_PaymentCondition"}");

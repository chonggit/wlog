# 车间异常处理绩效统计表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 车间异常处理绩效统计表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2273 |
...
client.GetSysReportData("SFC_AlertHandlePerfRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FProcessOrgId":[{"FNumber":""}],"FProWorkShopIDS":"","FStartTimeFrom":"1900-01-01","FStartTimeTo":"1900-01-01","FFilterTimeOutOnly":"false","FFilterPerTimeOutOnly":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FProWorkShopIDS": "",
        "FStartTimeFrom": "1900-01-01",
        "FStartTimeTo": "1900-01-01",
        "FFilterTimeOutOnly": "false",
        "FFilterPerTimeOutOnly": "false"
    }
}

五、字段说明：
	 至：：FStartTimeTo  (必填项)
	 发生时间：FStartTimeFrom  (必填项)
	 仅过滤整单超时信息：FFilterTimeOutOnly 
	 仅过滤个人超时信息：FFilterPerTimeOutOnly 
	 发生部门：FProWorkShopIDS 

# 仓库对应表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 仓库对应表
...
client.Delete("QRDO_t_StockMap","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QRDO_t_StockMap","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FUseOrgID":{"FNumber":""},"FBillNo":"","FDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"FSourceStockID":{"FNUMBER":""},"FSourceLocID":{"FSOURCELOCID__FF100003":{"FNumber":""},"FSOURCELOCID__FF100005":{"FNumber":""},"FSOURCELOCID__FF100006":{"FNumber":""},"FSOURCELOCID__FF100007":{"FNumber":""},"FSOURCELOCID__FF100008":{"FNumber":""},"FSOURCELOCID__FF100009":{"FNumber":""},"FSOURCELOCID__FF100011":{"FNumber":""},"FSOURCELOCID__FF100014":{"FNumber":""}},"FXHStockNumber":"","FXHStockName":"","FXHLocNumber":"","FTargetStockID":{"FNUMBER":""},"FTargetLocID":{"FTARGETLOCID__FF100003":{"FNumber":""},"FTARGETLOCID__FF100005":{"FNumber":""},"FTARGETLOCID__FF100006":{"FNumber":""},"FTARGETLOCID__FF100007":{"FNumber":""},"FTARGETLOCID__FF100008":{"FNumber":""},"FTARGETLOCID__FF100009":{"FNumber":""},"FTARGETLOCID__FF100011":{"FNumber":""},"FTARGETLOCID__FF100014":{"FNumber":""}},"FEntryNote":""}]}}");
        ...
        "FEntity": [
            {
                ...
                "FSourceLocID": {
                    "FSOURCELOCID__FF100003": {
                        "FNumber": ""
                    },
                    "FSOURCELOCID__FF100005": {
                        "FNumber": ""
                    },
                    "FSOURCELOCID__FF100006": {
                        "FNumber": ""
                    },
                    "FSOURCELOCID__FF100007": {
                        "FNumber": ""
                    },
                    "FSOURCELOCID__FF100008": {
                        "FNumber": ""
                    },
                    "FSOURCELOCID__FF100009": {
                        "FNumber": ""
                    },
                    "FSOURCELOCID__FF100011": {
                        "FNumber": ""
                    },
                    "FSOURCELOCID__FF100014": {
                        "FNumber": ""
                    }
                },
                "FXHStockNumber": "",
                ...
                "FTargetLocID": {
                    "FTARGETLOCID__FF100003": {
                        "FNumber": ""
                    },
                    "FTARGETLOCID__FF100005": {
                        "FNumber": ""
                    },
                    "FTARGETLOCID__FF100006": {
                        "FNumber": ""
                    },
                    "FTARGETLOCID__FF100007": {
                        "FNumber": ""
                    },
                    "FTARGETLOCID__FF100008": {
                        "FNumber": ""
                    },
                    "FTARGETLOCID__FF100009": {
                        "FNumber": ""
                    },
                    "FTARGETLOCID__FF100011": {
                        "FNumber": ""
                    },
                    "FTARGETLOCID__FF100014": {
                        "FNumber": ""
                    }
                },
                "FEntryNote": ""
...
单据体：FEntity 
	 实体主键：FEntryID 
	 备注：FEntryNote 
	 新豪仓库：FSourceStockID  (必填项)
	 新豪仓库名称：FSourceStockName 
	 新豪仓位：FSourceLocID 
	 100新豪仓位值集：FF100003
	 ...
	 300德上仓位值集：FF100014
	 输入组织仓库代码1：FTargetStockID 
	 输入组织仓库名称1：FTargetStockName 
	 输入组织仓位1：FTargetLocID 
	 100新豪仓位值集：FF100003
	 10010新豪副账套仓位值集：FF100005
	 10110香港副账套仓位值集：FF100006
	 200东莞科达仓位值集：FF100007
	 ...
	 346科裕格兰仓位值集：FF100011
	 300德上仓位值集：FF100014
	 输入组织仓库代码：FXHStockNumber 
	 输入组织仓库名称：FXHStockName 
	 输入组织仓位：FXHLocNumber 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QRDO_t_StockMap","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FUseOrgID":{"FNumber":""},"FBillNo":"","FDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"FSourceStockID":{"FNUMBER":""},"FSourceLocID":{"FSOURCELOCID__FF100003":{"FNumber":""},"FSOURCELOCID__FF100005":{"FNumber":""},"FSOURCELOCID__FF100006":{"FNumber":""},"FSOURCELOCID__FF100007":{"FNumber":""},"FSOURCELOCID__FF100008":{"FNumber":""},"FSOURCELOCID__FF100009":{"FNumber":""},"FSOURCELOCID__FF100011":{"FNumber":""},"FSOURCELOCID__FF100014":{"FNumber":""}},"FXHStockNumber":"","FXHStockName":"","FXHLocNumber":"","FTargetStockID":{"FNUMBER":""},"FTargetLocID":{"FTARGETLOCID__FF100003":{"FNumber":""},"FTARGETLOCID__FF100005":{"FNumber":""},"FTARGETLOCID__FF100006":{"FNumber":""},"FTARGETLOCID__FF100007":{"FNumber":""},"FTARGETLOCID__FF100008":{"FNumber":""},"FTARGETLOCID__FF100009":{"FNumber":""},"FTARGETLOCID__FF100011":{"FNumber":""},"FTARGETLOCID__FF100014":{"FNumber":""}},"FEntryNote":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QRDO_t_StockMap","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QRDO_t_StockMap","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QRDO_t_StockMap","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QRDO_t_StockMap","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QRDO_t_StockMap","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("QRDO_t_StockMap","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QRDO_t_StockMap"}");

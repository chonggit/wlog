# 组织变更检查规则 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 组织管理 > 组织变更检查规则
...
client.Delete("ORG_ChangeChkRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ORG_ChangeChkRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FChangeType":"","FChangeRuleEntry":[{"FEntryID":"","FSubSystemId":{"FNUMBER":""},"FObjectTypeId":{"FID":""},"FOrgKey":"","FOrgName":"","FIsSysPreset":"false","FControlStrength":"","FCheckRuleId":{"FNumber":""},"FIsLockCS":"false"}],"FChangeSelfRuleEntry":[{"FEntryID":"","FSelfTopClassId":{"FTOPCLASSID":""},"FCheckCondition":"","FSControlStrength":"","FSIsLockCS":"","FPlugIn":""}],"FPreChangeRuleEntry":[{"FEntryID":"","FPreRule":"","FPreID":""}]}}");
...
单据头：FBillHead 
	 ...
	 编号：FBillNo 
检查规则：FChangeRuleEntry 
	 实体主键：FEntryID 
	 业务对象：FObjectTypeId  (必填项)
	 检查条件：FCheckRuleId  (必填项)
	 预设：FIsSysPreset 
	 控制强度：FControlStrength  (必填项)
	 锁定控制强度：FIsLockCS 
	 子系统：FSubSystemId 
	 单据上的组织：FOrgKey 
	 业务领域：FDomainId 
	 组织名称：FOrgName 
自定义规则：FChangeSelfRuleEntry 
	 实体主键：FEntryID 
	 插件处理程序：FPlugIn 
	 业务领域：FSelfTopClassId 
	 控制强度：FSControlStrength 
	 锁定控制强度：FSIsLockCS 
	 检查条件：FCheckCondition 
前置检查规则：FPreChangeRuleEntry 
	 实体主键：FEntryID 
	 前置检查规则ID：FPreID 
	 前置检查规则：FPreRule 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ORG_ChangeChkRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FChangeType":"","FChangeRuleEntry":[{"FEntryID":"","FSubSystemId":{"FNUMBER":""},"FObjectTypeId":{"FID":""},"FOrgKey":"","FOrgName":"","FIsSysPreset":"false","FControlStrength":"","FCheckRuleId":{"FNumber":""},"FIsLockCS":"false"}],"FChangeSelfRuleEntry":[{"FEntryID":"","FSelfTopClassId":{"FTOPCLASSID":""},"FCheckCondition":"","FSControlStrength":"","FSIsLockCS":"","FPlugIn":""}],"FPreChangeRuleEntry":[{"FEntryID":"","FPreRule":"","FPreID":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ORG_ChangeChkRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ORG_ChangeChkRule","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ORG_ChangeChkRule"}");

# 会员积分规则 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 全网会员 > 会员积分规则
...
client.Delete("MMC_IntegralRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("MMC_IntegralRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("MMC_IntegralRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FMemberTypeId":{"FNUMBER":""},"FValidBeginDate":"1900-01-01","FAccountTypeId":{"FNUMBER":""},"FAwardTypeId":{"FNumber":""},"FValidEndDate":"1900-01-01","FPriority":0,"FCreateOrgId":{"FNumber":""},"FCalMode":"","FEntityIntegralCalcCond":[{"FEntryID":0,"FLeftBracket":"","FField":"","FCompare":"","FValue":"","FRightBracket":"","FLogic":""}],"FEntityIntegralCalcRule":[{"FEntryID":0,"FMemberLevelId":{"FNUMBER":""},"FAmountPercent":0,"FIntegralValue":0}],"FIntegralOrg":[{"FEntryID":0,"FOrgId":{"FNumber":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FValidEndDate": "1900-01-01",
        "FPriority": 0,
        "FCreateOrgId": {
            "FNumber": ""
        },
        "FCalMode": "",
        "FEntityIntegralCalcCond": [
            {
                "FEntryID": 0,
                "FLeftBracket": "",
                "FField": "",
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 描述：FDescription 
	 有效期至：FValidEndDate  (必填项)
	 有效期始：FValidBeginDate  (必填项)
	 积分帐户：FAccountTypeId  (必填项)
	 奖励活动：FAwardTypeId  (必填项)
	 会员种类：FMemberTypeId  (必填项)
	 优先级：FPriority 
	 创建组织：FCreateOrgId 
	 单选按钮组：FCalMode 
	 按等级和交易金额赠送：FRadio 
	 直接赠送：FRadio1 
积分奖励条件：FEntityIntegralCalcCond 
	 实体主键：FEntryID 
	 (：FLeftBracket 
	 字段：FField 
	 比较：FCompare 
	 ...
	 逻辑：FLogic 
积分计算规则：FEntityIntegralCalcRule 
	 实体主键：FEntryID 
	 会员等级：FMemberLevelId  (必填项)
	 按交易金额奖励比例(%)：FAmountPercent 
	 赠送积分：FIntegralValue 
组织范围：FIntegralOrg 
	 实体主键：FEntryID 
	 组织编码：FOrgId  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("MMC_IntegralRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FMemberTypeId":{"FNUMBER":""},"FValidBeginDate":"1900-01-01","FAccountTypeId":{"FNUMBER":""},"FAwardTypeId":{"FNumber":""},"FValidEndDate":"1900-01-01","FPriority":0,"FCreateOrgId":{"FNumber":""},"FCalMode":"","FEntityIntegralCalcCond":[{"FEntryID":0,"FLeftBracket":"","FField":"","FCompare":"","FValue":"","FRightBracket":"","FLogic":""}],"FEntityIntegralCalcRule":[{"FEntryID":0,"FMemberLevelId":{"FNUMBER":""},"FAmountPercent":0,"FIntegralValue":0}],"FIntegralOrg":[{"FEntryID":0,"FOrgId":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("MMC_IntegralRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("MMC_IntegralRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("MMC_IntegralRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("MMC_IntegralRule","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("MMC_IntegralRule","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("MMC_IntegralRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("MMC_IntegralRule","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"MMC_IntegralRule"}");

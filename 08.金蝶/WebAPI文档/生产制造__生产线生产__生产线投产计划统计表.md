# 生产线投产计划统计表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产线生产 > 生产线投产计划统计表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2625 |
...
client.GetSysReportData("REM_PrdLineProductionPlanRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgIds":[{"FNumber":""}],"FShiftSliceId":{"FNUMBER":""},"FWorkShopIds":"","FBeginMaterialId":{"FNumber":""},"FPrdLines":[{"FNumber":""}],"FEndMaterialId":{"FNumber":""},"FCountUnit":"","FStaDimensionality":""}}");

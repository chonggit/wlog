# 应收票据余额表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 应收票据余额表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3021 |
...
client.GetSysReportData("CN_ReceivableBillBalRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSettleOrgLst":"","FAffiliation":{"FName":""},"FCONTACTUNITTYPE":"","FCurrencyFrom":{"FNumber":""},"FCONTACTUNITFrom":{"FNumber":""},"FCONTACTUNITTo":{"FNumber":""},"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FShowSum":"false","FSHOWPLEDGE":"false","FSHOWISTRUST":"false"}}");
...
参数FieldKeys显示列：
	 付款单位编码：FCONTACTUNITNumber 
	 付款单位名称：FCONTACTUNITName 
	 票据类型：FBILLTYPE 
	 币别：FCURRENCYFORNAME 
	 业务描述：FNote 
	 单据编码：FBillNo 

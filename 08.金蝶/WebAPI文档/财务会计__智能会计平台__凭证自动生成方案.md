# 凭证自动生成方案 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 智能会计平台 > 凭证自动生成方案
...
client.Delete("GL_AutoBuildVoucherScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("GL_AutoBuildVoucherScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("GL_AutoBuildVoucherScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FFrequency":"","FStatus":"","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDay":0,"FHour":0,"FMinute":0,"FSecond":0,"FDescription":"","FBuildType":"","FCreatorType":"","F_Bas_SelCreatorId":{"FUSERACCOUNT":""},"FNextExeTime":"1900-01-01","FEntity":[{"FDetailID":0,"FBookId":{"FNUMBER":""},"FActionType":"","FMergeBuildVchScheme":{"FNUMBER":""},"F_Acct_SelCreatorId":{"FUSERACCOUNT":""},"FPeriodFutureComBo":"","FSubEntity":[{"FEntryId":0,"FIsSelected":"false","FSourceBillKey":{"FNUMBER":""},"FGenerateType":"","FMatchName":"","FMatchValue":"","F_Bill_SelCreatorId":{"FUSERACCOUNT":""},"FBillCreatorDesc":"","FBillCreatorValue":"","FSystemID":"","FBillFilterIn":"","FBillFilter":"","FBillFilterDesc":"","FBillFilterKeyDesc":"","FBillFilterScheme":""}]}]}}");
...
单据头：FBillHead 
	 ...
	 执行频率：FFrequency  (必填项)
	 描述：FDescription 
	 自动生成凭证选项：FBuildType  (必填项)
	 凭证制单人选项：FCreatorType  (必填项)
	 制单人：F_Bas_SelCreatorId 
	 启用状态：FStatus  (必填项)
	 创建人：FCreatorId 
	 修改人：FModifierId 
	 创建日期：FCreateDate 
...
单据体：FEntity 
	 ...
	 核算体系：FAcctSystemId 
	 核算组织：FAccountOrgId 
	 执行方式：FActionType  (必填项)
	 凭证制单人：F_Acct_SelCreatorId 
	 合并方案：FMergeBuildVchScheme 
	 未来期间数：FPeriodFutureComBo  (必填项)
子单据体：FSubEntity 
	 实体主键：FEntryId 
	 来源单据：FSourceBillKey  (必填项)
	 来源系统：FSystemIdProp 
	 总账凭证生成方式：FGenerateType  (必填项)
	 匹配字段：FMatchName 
	 匹配字段标识：FMatchValue 
	 固定制单人：F_Bill_SelCreatorId 
	 选择：FIsSelected 
	 来源系统ID：FSystemID 
	 取单据上用户：FBillCreatorDesc 
	 取单据上用户字段：FBillCreatorValue 
	 单据过滤条件：FBillFilterIn 
	 单据过滤条件标识：FBillFilter 
	 单据过滤条件：FBillFilterDesc 
	 FXML：FXML 
	 单据过滤条件多语言：FBillFilterKeyDesc 
	 单据过滤条件方案编码：FBillFilterScheme 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("GL_AutoBuildVoucherScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FFrequency":"","FStatus":"","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDay":0,"FHour":0,"FMinute":0,"FSecond":0,"FDescription":"","FBuildType":"","FCreatorType":"","F_Bas_SelCreatorId":{"FUSERACCOUNT":""},"FNextExeTime":"1900-01-01","FEntity":[{"FDetailID":0,"FBookId":{"FNUMBER":""},"FActionType":"","FMergeBuildVchScheme":{"FNUMBER":""},"F_Acct_SelCreatorId":{"FUSERACCOUNT":""},"FPeriodFutureComBo":"","FSubEntity":[{"FEntryId":0,"FIsSelected":"false","FSourceBillKey":{"FNUMBER":""},"FGenerateType":"","FMatchName":"","FMatchValue":"","F_Bill_SelCreatorId":{"FUSERACCOUNT":""},"FBillCreatorDesc":"","FBillCreatorValue":"","FSystemID":"","FBillFilterIn":"","FBillFilter":"","FBillFilterDesc":"","FBillFilterKeyDesc":"","FBillFilterScheme":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_AutoBuildVoucherScheme","Activate","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_AutoBuildVoucherScheme","NotActivate","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("GL_AutoBuildVoucherScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"GL_AutoBuildVoucherScheme"}");

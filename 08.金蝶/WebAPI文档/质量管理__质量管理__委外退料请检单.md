# 委外退料请检单 Web API 操作原始内容

> 来源页面：全部 > 质量管理 > 质量管理 > 委外退料请检单
...
client.Delete("QM_SubRtnMtrlAppQc","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QM_SubRtnMtrlAppQc","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDescription":"","FSupplyOrgId":{"FNumber":""},"FSubOrgId":{"FNumber":""},"FDate":"1900-01-01","FStockGroupId":{"FNUMBER":""},"FSupplier":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FEntity":[{"FENTRYID":0,"FMaterialId":{"FNUMBER":""},"FUnitID":{"FNumber":""},"FBaseUnitId":{"FNumber":""},"FQty":0,"FBaseQty":0,"FStockId":{"FNUMBER":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FStockStatusId":{"FNUMBER":""},"FChildSupplier":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FBomId":{"FNUMBER":""},"FMtoNo":"","FLot":{"FNumber":""},"FOperId":0,"FProcessId":{"FNUMBER":""},"FPrdDate":"1900-01-01","FExpDate":"1900-01-01","FOwnerTypeId":"","FOwnerId":{"FNumber":""},"FSrcBillType":"","FSrcBillNo":"","FSrcBillId":0,"FSrcEntryId":0,"FSrcSeq":0,"FOrderType":{"FID":""},"FOrderBillNo":"","FOrderBillSeq":0,"FSubPpbomEntryId":0,"FSNQty":0,"FSubPpbomId":0,"FSubPpbomNo":"","FSNUnitId":{"FNumber":""},"FParentOwnerTypeId":"","FParentOwnerId":{"FNumber":""},"FReturnType":"","FOrderId":0,"FOrderEntryId":0,"FParentMaterialId":{"FNUMBER":""},"FSerialSubEntity":[{"FDetailID":0,"FRtnMtrlAppFlag":"","FSerialNote":""}]}]}}");
...
明细：FEntity 
	 ...
	 货主：FOwnerId  (必填项)
	 检验选单数量：FInspectSelQty 
	 检验数量：FInspectQty 
	 良品数量：FGoodQty 
	 来料不良数量：FIncDefectQty 
	 作业不良数量：FProcDefectQty 
	 良品退料选单数量：FSelGoodRtnQty 
	 良品退料数量：FGoodRtnQty 
	 来料不良退料选单数量：FSelIncDefectRtnQty 
	 来料不良退料数量：FIncDefectRtnQty 
	 作业不良退料数量：FProcDefectRtnQty 
	 作业不良退料选单数量：FSelProcDefectRtnQty 
	 源单类型：FSrcBillType 
	 源单编号：FSrcBillNo 
	 源单内码：FSrcBillId 
	 源单分录内码：FSrcEntryId 
	 ...
	 订单编号：FOrderBillNo 
	 订单行号：FOrderBillSeq 
	 委外用料清单分录内码：FSubPpbomEntryId 
	 委外用料清单内码：FSubPpbomId 
	 序列号单位：FSNUnitId 
	 序列号单位数量：FSNQty 
	 委外用料清单编号：FSubPpbomNo 
	 基本单位：FBaseUnitId 
	 基本单位检验选单数量：FBaseInspectSelQty 
	 基本单位检验数量：FBaseInspectQty 
	 基本单位良品数量：FBaseGoodQty 
	 基本单位来料不良数量：FBaseIncDefectQty 
	 基本单位作业不良数量：FBaseProcDefectQty 
	 基本单位数量：FBaseQty 
	 基本单位良品退料选单数量：FBaseSelGoodRtnQty 
	 基本单位来料不良退料数量：FBaseIncDefectRtnQty 
	 基本单位良品退料数量：FBaseGoodRtnQty 
	 基本单位来料不良退料选单数量：FBaseSelIncDefectRtnQty 
	 基本单位作业不良退料数量：FBaseProcDefectRtnQty 
	 基本单位作业不良退料选单数量：FBaseSelProcDefectRtnQty 
	 库存状态：FStockStatusId 
	 有效期至：FExpDate 
	 生产日期：FPrdDate 
	 产品货主类型：FParentOwnerTypeId  (必填项)
	 产品货主：FParentOwnerId  (必填项)
	 退料类型-供下推委外退料使用：FReturnType 
	 订单内码：FOrderId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QM_SubRtnMtrlAppQc","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDescription":"","FSupplyOrgId":{"FNumber":""},"FSubOrgId":{"FNumber":""},"FDate":"1900-01-01","FStockGroupId":{"FNUMBER":""},"FSupplier":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FEntity":[{"FENTRYID":0,"FMaterialId":{"FNUMBER":""},"FUnitID":{"FNumber":""},"FBaseUnitId":{"FNumber":""},"FQty":0,"FBaseQty":0,"FStockId":{"FNUMBER":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FStockStatusId":{"FNUMBER":""},"FChildSupplier":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FBomId":{"FNUMBER":""},"FMtoNo":"","FLot":{"FNumber":""},"FOperId":0,"FProcessId":{"FNUMBER":""},"FPrdDate":"1900-01-01","FExpDate":"1900-01-01","FOwnerTypeId":"","FOwnerId":{"FNumber":""},"FSrcBillType":"","FSrcBillNo":"","FSrcBillId":0,"FSrcEntryId":0,"FSrcSeq":0,"FOrderType":{"FID":""},"FOrderBillNo":"","FOrderBillSeq":0,"FSubPpbomEntryId":0,"FSNQty":0,"FSubPpbomId":0,"FSubPpbomNo":"","FSNUnitId":{"FNumber":""},"FParentOwnerTypeId":"","FParentOwnerId":{"FNumber":""},"FReturnType":"","FOrderId":0,"FOrderEntryId":0,"FParentMaterialId":{"FNUMBER":""},"FSerialSubEntity":[{"FDetailID":0,"FRtnMtrlAppFlag":"","FSerialNote":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QM_SubRtnMtrlAppQc","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QM_SubRtnMtrlAppQc","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QM_SubRtnMtrlAppQc","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QM_SubRtnMtrlAppQc","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QM_SubRtnMtrlAppQc","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("QM_SubRtnMtrlAppQc","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("QM_SubRtnMtrlAppQc","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QM_SubRtnMtrlAppQc"}");

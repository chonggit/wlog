# 支付信息变更单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 支付信息变更单
...
client.Draft("CN_PAYINFOCHANGEREC","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FSourceBillType":"","FSourceBillNo":"","FPAYORGID":{"FNumber":""},"FSETTLEORGID":{"FNumber":""},"FRECTUNITTYPE":"","FRECTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FREMARK":"","FMoreReceive":"false","FSOURCEID":0,"FSOURCEBILLTYPEID":{"FNUMBER":""},"FBILLCONVERTRULEID":"","FEntity":[{"FEntryID":0,"FSOURCEENTRYID":0,"FSOURCESEQ":0,"FAmount":0,"FSETTLETYPEID":{"FNUMBER":""},"FRECTUNIT_D":{"FNumber":""},"FACCOUNTID_BEFORE":{"FNUMBER":""},"FOPPOSITEBANKACNT_BEFORE":"","FOPPOSITEACNTNAME_BEFORE":"","FOPPOSITEBANKNAME_BEFORE":"","FBANKDETAIL_BEFORE":{"FNUMBER":""},"FOPENADDRESSREC_BEFORE":"","FCNAPS_BEFORE":"","FCOUNTRY_BEFORE":"","FNProvince_BEFORE":"","FNCITY_BEFORE":"","FNDISTRICT_BEFORE":"","FDISTRICTCODE_BEFORE":"","FRECTYPE_BEFORE":"","FRUZHANGTYPE_BEFORE":"","FPAYTYPE_BEFORE":"","FCOMMENT_BEFORE":"","FACCOUNTID_AFTER":{"FNUMBER":""},"FOPPOSITEBANKACNT_AFTER":"","FOPPOSITEACNTNAME_AFTER":"","FBANKDETAIL_AFTER":{"FNUMBER":""},"FOPPOSITEBANKNAME_AFTER":"","FOPENADDRESSREC_AFTER":"","FCNAPS_AFTER":"","FCOUNTRY_AFTER":"","FNPROVINCE_AFTER":"","FNCITY_AFTER":"","FNDISTRICT_AFTER":"","FDISTRICTCODE_AFTER":"","FRECTYPE_AFTER":"","FRUZHANGTYPE_AFTER":"","FPAYTYPE_AFTER":"","FCOMMENT_AFTER":"","FCERTTYPE_BEFORE":"","FCERTTYPE_AFTER":"","FCERTNUM_BEFORE":"","FCERTNUM_AFTER":"","FUSE_BEFORE":"","FUSE_AFTER":""}]}}");
        ...
        "FEntity": [
            {
                ...
                "FOPPOSITEBANKACNT_BEFORE": "",
                "FOPPOSITEACNTNAME_BEFORE": "",
                "FOPPOSITEBANKNAME_BEFORE": "",
                "FBANKDETAIL_BEFORE": {
                    "FNUMBER": ""
                },
                "FOPENADDRESSREC_BEFORE": "",
                "FCNAPS_BEFORE": "",
                "FCOUNTRY_BEFORE": "",
                "FNProvince_BEFORE": "",
                "FNCITY_BEFORE": "",
                "FNDISTRICT_BEFORE": "",
                "FDISTRICTCODE_BEFORE": "",
                "FRECTYPE_BEFORE": "",
                "FRUZHANGTYPE_BEFORE": "",
                "FPAYTYPE_BEFORE": "",
                "FCOMMENT_BEFORE": "",
                ...
                "FOPPOSITEBANKACNT_AFTER": "",
                "FOPPOSITEACNTNAME_AFTER": "",
                "FBANKDETAIL_AFTER": {
                    "FNUMBER": ""
                },
                "FOPPOSITEBANKNAME_AFTER": "",
                "FOPENADDRESSREC_AFTER": "",
                "FCNAPS_AFTER": "",
                "FCOUNTRY_AFTER": "",
                "FNPROVINCE_AFTER": "",
                "FNCITY_AFTER": "",
...
单据头：FBillHead 
	 ...
	 变更日期：FDate  (必填项)
	 源单类型：FSourceBillType  (必填项)
	 源单编号：FSourceBillNo  (必填项)
	 付款组织：FPAYORGID  (必填项)
	 结算组织：FSETTLEORGID 
	 收款单位：FRECTUNIT  (必填项)
	 收款单位类型：FRECTUNITTYPE  (必填项)
	 支付币别：FCURRENCYID  (必填项)
	 表头-变更支付金额：FChangePayAmountFor 
	 变更描述：FREMARK  (必填项)
	 多收款人：FMoreReceive 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 ...
	 单据转换标识：FBILLCONVERTRULEID 
单据体：FEntity 
	 实体主键：FEntryID 
	 源单序号：FSOURCESEQ 
	 支付金额：FAmount 
	 我方银行账号：FACCOUNTID_BEFORE 
	 对方银行账号：FOPPOSITEBANKACNT_BEFORE 
	 对方账户名称：FOPPOSITEACNTNAME_BEFORE 
	 对方开户行：FOPPOSITEBANKNAME_BEFORE 
	 备注（转账附言）：FCOMMENT_BEFORE 
	 银行网点：FBANKDETAIL_BEFORE 
	 对方开户行地址：FOPENADDRESSREC_BEFORE 
	 联行号：FCNAPS_BEFORE 
	 国别：FCOUNTRY_BEFORE 
	 省：FNProvince_BEFORE 
	 城市：FNCITY_BEFORE 
	 地区：FNDISTRICT_BEFORE 
	 地区码：FDISTRICTCODE_BEFORE 
	 收款方类型：FRECTYPE_BEFORE 
	 入账类型：FRUZHANGTYPE_BEFORE 
	 支付类型：FPAYTYPE_BEFORE 
	 我方银行账号（变更后）：FACCOUNTID_AFTER 
	 对方银行账号（变更后）：FOPPOSITEBANKACNT_AFTER 
	 对方账户名称（变更后）：FOPPOSITEACNTNAME_AFTER 
	 银行网点（变更后）：FBANKDETAIL_AFTER 
	 对方开户行（变更后）：FOPPOSITEBANKNAME_AFTER 
	 对方开户行地址（变更后）：FOPENADDRESSREC_AFTER 
	 联行号（变更后）：FCNAPS_AFTER 
	 国别（变更后）：FCOUNTRY_AFTER 
	 省（变更后）：FNPROVINCE_AFTER 
	 城市（变更后）：FNCITY_AFTER 
	 地区（变更后）：FNDISTRICT_AFTER 
	 地区码（变更后）：FDISTRICTCODE_AFTER 
	 收款方类型（变更后）：FRECTYPE_AFTER 
	 入账类型（变更后）：FRUZHANGTYPE_AFTER 
	 支付类型（变更后）：FPAYTYPE_AFTER 
	 我方账户名称：FPAYACCOUNTNAME_BEFORE 
	 我方账户名称（变更后）：FPAYACCOUNTNAME_AFTER 
	 我方开户行：FPAYBANKID_BEFORE 
	 我方开户行（变更后）：FPAYBANKID_AFTER 
	 收款人证件类型：FCERTTYPE_BEFORE 
	 收款人证件类型（变更后）：FCERTTYPE_AFTER 
	 收款人证件号码：FCERTNUM_BEFORE 
	 收款人证件号码（变更后）：FCERTNUM_AFTER 
	 系统支付用途：FUSE_BEFORE 
	 系统支付用途（变更后）：FUSE_AFTER 
	 备注（转账附言）（变更后）：FCOMMENT_AFTER 
	 结算方式：FSETTLETYPEID 
	 源单分录内码：FSOURCEENTRYID 
	 收款单位：FRECTUNIT_D 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_PAYINFOCHANGEREC","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FSourceBillType":"","FSourceBillNo":"","FPAYORGID":{"FNumber":""},"FSETTLEORGID":{"FNumber":""},"FRECTUNITTYPE":"","FRECTUNIT":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FREMARK":"","FMoreReceive":"false","FSOURCEID":0,"FSOURCEBILLTYPEID":{"FNUMBER":""},"FBILLCONVERTRULEID":"","FEntity":[{"FEntryID":0,"FSOURCEENTRYID":0,"FSOURCESEQ":0,"FAmount":0,"FSETTLETYPEID":{"FNUMBER":""},"FRECTUNIT_D":{"FNumber":""},"FACCOUNTID_BEFORE":{"FNUMBER":""},"FOPPOSITEBANKACNT_BEFORE":"","FOPPOSITEACNTNAME_BEFORE":"","FOPPOSITEBANKNAME_BEFORE":"","FBANKDETAIL_BEFORE":{"FNUMBER":""},"FOPENADDRESSREC_BEFORE":"","FCNAPS_BEFORE":"","FCOUNTRY_BEFORE":"","FNProvince_BEFORE":"","FNCITY_BEFORE":"","FNDISTRICT_BEFORE":"","FDISTRICTCODE_BEFORE":"","FRECTYPE_BEFORE":"","FRUZHANGTYPE_BEFORE":"","FPAYTYPE_BEFORE":"","FCOMMENT_BEFORE":"","FACCOUNTID_AFTER":{"FNUMBER":""},"FOPPOSITEBANKACNT_AFTER":"","FOPPOSITEACNTNAME_AFTER":"","FBANKDETAIL_AFTER":{"FNUMBER":""},"FOPPOSITEBANKNAME_AFTER":"","FOPENADDRESSREC_AFTER":"","FCNAPS_AFTER":"","FCOUNTRY_AFTER":"","FNPROVINCE_AFTER":"","FNCITY_AFTER":"","FNDISTRICT_AFTER":"","FDISTRICTCODE_AFTER":"","FRECTYPE_AFTER":"","FRUZHANGTYPE_AFTER":"","FPAYTYPE_AFTER":"","FCOMMENT_AFTER":"","FCERTTYPE_BEFORE":"","FCERTTYPE_AFTER":"","FCERTNUM_BEFORE":"","FCERTNUM_AFTER":"","FUSE_BEFORE":"","FUSE_AFTER":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_PAYINFOCHANGEREC","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_PAYINFOCHANGEREC","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_PAYINFOCHANGEREC","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_PAYINFOCHANGEREC","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_PAYINFOCHANGEREC","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_PAYINFOCHANGEREC"}");

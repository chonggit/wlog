# 银企互联设置 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 网上银行 > 银企互联设置
...
client.Draft("WB_BankEPSetBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FSetEntity":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FServiceURL":"","FServiceIP":"","FServicePort":"","FISWSS":"false","FClientUserName":"","FClientPassword":"","FServerUserName":"","FServerPassword":"","FClientFriendlyName":"","FServerFriendlyName":"","FServiceNoteURL":"","FServiceOverPayURL":"","FSftpUserName":"","FSftpPassword":""}]}}");
...
明细：FSetEntity 
	 ...
	 业务组织名称：FKDBPBIZORGNAME 
	 银企互联地址：FServiceURL 
	 启用安全连接：FISWSS 
	 客户端账号：FClientUserName 
	 客户端密码：FClientPassword 
	 服务端账号：FServerUserName 
	 服务端密码：FServerPassword 
	 客户端证书别名：FClientFriendlyName 
	 服务端证书别名：FServerFriendlyName 
	 银企互联IP：FServiceIP  (必填项)
	 银企互联端口：FServicePort  (必填项)
	 银企互联NOTE地址：FServiceNoteURL 
	 银企互联境外支付地址：FServiceOverPayURL 
	 电子回单SFTP服务登录用户名：FSftpUserName 
	 电子回单SFTP服务登录密码：FSftpPassword 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("WB_BankEPSetBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FSetEntity":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FServiceURL":"","FServiceIP":"","FServicePort":"","FISWSS":"false","FClientUserName":"","FClientPassword":"","FServerUserName":"","FServerPassword":"","FClientFriendlyName":"","FServerFriendlyName":"","FServiceNoteURL":"","FServiceOverPayURL":"","FSftpUserName":"","FSftpPassword":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("WB_BankEPSetBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("WB_BankEPSetBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("WB_BankEPSetBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("WB_BankEPSetBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"WB_BankEPSetBill"}");

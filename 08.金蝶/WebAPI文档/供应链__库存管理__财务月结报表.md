# 财务月结报表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 财务月结报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2506 |
...
client.GetSysReportData("QRDO_MonthFinancial","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FStockOrgId1":"","FStockOrgId":"","FDeptNumber":"","FCheckNoData":"false"}}");
...
参数FieldKeys显示列：
	 ...
	 材料制造入库：FInStockTypeQty1 
	 生产领料入库：FInStockTypeQty2 
	 产品报废出库：FOutStockTypeQty1 
	 入成品仓出库：FOutStockTypeQty2 
	 领料退货出库：FOutStockTypeQty3 
	 期末结存数量：FBalance_End 
	 盘点盘盈入库：FInStockTypeQty3 
	 盘点盘亏出库：FOutStockTypeQty4 
	 产品流失出库：FOutStockTypeQty5 
	 试算平衡公式：FTrialBalanceQty 

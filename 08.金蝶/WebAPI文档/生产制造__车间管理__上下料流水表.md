# 上下料流水表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 上下料流水表
...
client.Delete("SFC_LoadUnloadDetail","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_LoadUnloadDetail","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FOrgId":{"FNumber":""},"FType":"","FProductLineId":{"FNUMBER":""},"FChipMounterLocation":"","FEquipmentId":{"FNUMBER":""},"FOldTrack":"","FNewTrack":"","FOldFeederId":{"FNUMBER":""},"FNewFeederId":{"FNUMBER":""},"FMOBillNo":"","FMOEntrySeq":0,"FProcessId":{"FNUMBER":""},"FOldMaterialId":{"FNUMBER":""},"FOldLot":{"FNumber":""},"FNewMaterialId":{"FNUMBER":""},"FNewLot":{"FNumber":""},"FQty":0,"FUnitId":{"FNumber":""},"FBaseQty":0,"FBaseUnitId":{"FNumber":""},"FOperateTime":"1900-01-01","FOperatorId":{"FSTAFFNUMBER":""},"FMOEntryId":0}}");
...
单据头：FBillHead 
	 ...
	 工单编号：FMOBillNo 
	 工单行号：FMOEntrySeq 
	 旧物料编码：FOldMaterialId 
	 旧物料名称：FOldMaterialName 
	 旧物料规格型号：FOldMaterialSpecification 
	 新物料编码：FNewMaterialId 
	 新物料名称：FNewMaterialName 
	 新物料规格型号：FNewMaterialSpecification 
	 旧物料批号：FOldLot 
	 新物料批号：FNewLot 
	 数量：FQty 
	 计量单位：FUnitId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_LoadUnloadDetail","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FOrgId":{"FNumber":""},"FType":"","FProductLineId":{"FNUMBER":""},"FChipMounterLocation":"","FEquipmentId":{"FNUMBER":""},"FOldTrack":"","FNewTrack":"","FOldFeederId":{"FNUMBER":""},"FNewFeederId":{"FNUMBER":""},"FMOBillNo":"","FMOEntrySeq":0,"FProcessId":{"FNUMBER":""},"FOldMaterialId":{"FNUMBER":""},"FOldLot":{"FNumber":""},"FNewMaterialId":{"FNUMBER":""},"FNewLot":{"FNumber":""},"FQty":0,"FUnitId":{"FNumber":""},"FBaseQty":0,"FBaseUnitId":{"FNumber":""},"FOperateTime":"1900-01-01","FOperatorId":{"FSTAFFNUMBER":""},"FMOEntryId":0}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_LoadUnloadDetail","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SFC_LoadUnloadDetail","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_LoadUnloadDetail"}");

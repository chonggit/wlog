...
client.Delete("BD_Account","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_Account","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_Account","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FACCTID":0,"FCreateOrgId":{"FNumber":""},"FCurrencyList":"","FCURRENCYS":"","FUseOrgId":{"FNumber":""},"FFullName":"","FACCTTBLID":{"FNumber":""},"FNumber":"","FHelperCode":"","FName":"","FGROUPID":{"FNumber":""},"FDescription":"","FDC":"","FCFItemID":{"FNumber":""},"FAllCurrency":"false","FCFIndirectItemId":{"FNumber":""},"FIsCash":"false","FLevel":0,"FISCASHFLOW":"false","FOCFItemID":{"FNumber":""},"FIsBank":"false","FOCFIndirectItemId":{"FNumber":""},"FIsAllocate":"false","FIsQty":"false","FUNITGROUPID":{"FNUMBER":""},"FUnitId":{"FNumber":""},"FISDETAIL":"false","FIsSysPreset":"false","FControlOrgId":{"FNUMBER":""},"FISSHOWJOURNAL":"false","FISCONTACT":"false","FAMOUNTDC":"","FUNMANUAL":"false","FContactsFlex":"","FIsInternalContacts":"false","FAcctCy":[{"FEntryID":0,"FCurrencyID":{"FNumber":""}}],"FEntity":[{"FEntryID":0,"FFlEXITEMPROPERTYID":{"FNumber":""},"FInputType":""}],"FDistEntity":[{"FENTRYID":0,"FIsAllowRedistribute":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FISSHOWJOURNAL": "false",
        "FISCONTACT": "false",
        "FAMOUNTDC": "",
        "FUNMANUAL": "false",
        "FContactsFlex": "",
        "FIsInternalContacts": "false",
        "FAcctCy": [
            {
                "FEntryID": 0,
                "FCurrencyID": {
...
科目单据头：FBillHead 
	 ...
	 全名：FFullName 
	 主表项目(减少)：FOCFItemID 
	 附表项目(减少)：FOCFIndirectItemId 
	 核算所有币别：FAllCurrency 
	 主表项目(增加)：FCFItemID 
	 附表项目(增加)：FCFIndirectItemId 
	 外币核算(作废)：FCurrencyList 
	 外币核算：FCURRENCYS 
	 启用数量金额辅助核算：FIsQty 
	 计量单位组：FUNITGROUPID 
	 默认单位：FUnitId 
	 ...
	 往来科目：FISCONTACT 
	 不允许手工录入：FUNMANUAL 
	 往来核算维度：FContactsFlex 
	 内部往来科目：FIsInternalContacts 
外币核算单据体：FAcctCy 
	 实体主键：FEntryID 
	 币别名称：FCurrencyName 
	 币别编码：FCurrencyID 
核算维度：FEntity 
	 实体主键：FEntryID 
	 维度：FFlEXITEMPROPERTYID 
	 是否启用：FAcctItemIsValid 
	 必录类型：FInputType  (必填项)
	 数据字段名称：FDataFieldName 
分配信息：FDistEntity 
	 实体主键：FENTRYID 
	 允许新增下级科目：FIsAllowAddChild 
	 禁用时间（分配）：FDISTFORBIDDATE 
	 分配组织：FDISTORGID 
	 使用组织：FDISTUSEORGID 
	 禁用组织（分配）：FDISTFORBIDORGID 
	 禁用人（分配）：FDISTFORBIDDERID 
	 禁用状态（分配）：FDISTFBDSTATUS 
	 允许再分配：FIsAllowRedistribute 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_Account","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FACCTID":0,"FCreateOrgId":{"FNumber":""},"FCurrencyList":"","FCURRENCYS":"","FUseOrgId":{"FNumber":""},"FFullName":"","FACCTTBLID":{"FNumber":""},"FNumber":"","FHelperCode":"","FName":"","FGROUPID":{"FNumber":""},"FDescription":"","FDC":"","FCFItemID":{"FNumber":""},"FAllCurrency":"false","FCFIndirectItemId":{"FNumber":""},"FIsCash":"false","FLevel":0,"FISCASHFLOW":"false","FOCFItemID":{"FNumber":""},"FIsBank":"false","FOCFIndirectItemId":{"FNumber":""},"FIsAllocate":"false","FIsQty":"false","FUNITGROUPID":{"FNUMBER":""},"FUnitId":{"FNumber":""},"FISDETAIL":"false","FIsSysPreset":"false","FControlOrgId":{"FNUMBER":""},"FISSHOWJOURNAL":"false","FISCONTACT":"false","FAMOUNTDC":"","FUNMANUAL":"false","FContactsFlex":"","FIsInternalContacts":"false","FAcctCy":[{"FEntryID":0,"FCurrencyID":{"FNumber":""}}],"FEntity":[{"FEntryID":0,"FFlEXITEMPROPERTYID":{"FNumber":""},"FInputType":""}],"FDistEntity":[{"FENTRYID":0,"FIsAllowRedistribute":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_Account","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_Account","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_Account","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_Account","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_Account","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_Account","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_Account"}");

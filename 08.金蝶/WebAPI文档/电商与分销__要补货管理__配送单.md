...
| 下推 | Push | 2329 |
| 行关闭 | EntryMRPClose | 1703 |
| 作废 | Cancel | 1696 |
| 整单关闭 | BillClose | 1699 |
| 反关闭 | UnBillClose | 1701 |
| 行反关闭 | EntryMrpUnClose | 1705 |
| 批量保存 | BatchSave | 3059 |
...
client.Delete("DRP_DistributeOfBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("DRP_DistributeOfBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FREQUESTDATE":"1900-01-01","FCallOutStorageOrgID":{"FNumber":""},"FCallInStorageOrgID":{"FNumber":""},"FDescription":"","FCurrencyID":{"FNUMBER":""},"FPriceListID":{"FNUMBER":""},"FIsIncludedTax":"false","FDistributeEntry":[{"FEntryID":0,"FMaterialID":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FQty":0,"FBaseUnitID":{"FNumber":""},"FBaseUnitQty":0,"FPrice":0,"FTaxPrice":0,"FTaxRate":0,"FAmount":0,"FTaxAmount":0,"FAllAmount":0,"FDiscountRate":0,"FDiscount":0,"FTaxNetPrice":0,"FCallInWarehouseID":{"FNUMBER":""},"FCallOutWarehouseID":{"FNUMBER":""},"FDeliveryDate":"1900-01-01","FComment":"","FSupplyModelId":{"FNUMBER":""},"FSourceBillType":"","FSourceBillNo":"","FSourceBillName":"","FJoinQty":0,"FBaseJoinQty":0,"FJoinTransferOutQty":0,"FJoinTransferOutBaseQty":0,"FEntryCloserId":{"FUserID":""},"FBFLowId":{"FName":""},"FEntryCloseDate":"1900-01-01"}],"FSumEntry":[{"FEntryID":0,"FMaterialID_sum":{"FNUMBER":""},"FAuxPropId_sum":{"FAUXPROPID_SUM__FF100001":{"FNumber":""},"FAUXPROPID_SUM__FF100002":{"FNumber":""},"FAUXPROPID_SUM__FF100003":{"FNumber":""},"FAUXPROPID_SUM__FF100005":{"FNumber":""},"FAUXPROPID_SUM__FF100010":{"FNumber":""},"FAUXPROPID_SUM__FF100007":{"FNumber":""},"FAUXPROPID_SUM__FF100008":{"FNumber":""}},"FUnitID_sum":{"FNUMBER":""},"FQty_sum":0,"FBaseUnitID_sum":{"FNumber":""},"FBaseUnitQty_sum":0,"FAmount_sum":0,"FTaxAmount_sum":0,"FAllAmount_sum":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FBillNo": "",
        "FREQUESTDATE": "1900-01-01",
        "FCallOutStorageOrgID": {
            "FNumber": ""
        },
        "FCallInStorageOrgID": {
            "FNumber": ""
        ...
        "FDistributeEntry": [
            {
                ...
                "FJoinQty": 0,
                "FBaseJoinQty": 0,
                "FJoinTransferOutQty": 0,
                "FJoinTransferOutBaseQty": 0,
                "FEntryCloserId": {
                    "FUserID": ""
                },
                "FBFLowId": {
        ...
        "FSumEntry": [
            {
                ...
                "FAuxPropId_sum": {
                    "FAUXPROPID_SUM__FF100001": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_SUM__FF100002": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_SUM__FF100003": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_SUM__FF100005": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_SUM__FF100010": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_SUM__FF100007": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_SUM__FF100008": {
                        "FNumber": ""
                    }
                },
                "FUnitID_sum": {
...
配送单基本信息：FBillHead 
	 ...
	 申请日期：FREQUESTDATE  (必填项)
	 单据类型：FBillTypeID  (必填项)
	 调入库存组织：FCallInStorageOrgID  (必填项)
	 调出库存组织：FCallOutStorageOrgID  (必填项)
	 价目表：FPriceListID 
	 结算币别：FCurrencyID  (必填项)
	 是否含税：FIsIncludedTax 
	 最后修改人：FModifierId 
	 创建日期：FCreateDate 
	 最后修改日期：FModifyDate 
...
配送单物料明细：FDistributeEntry 
	 ...
	 税额：FTaxAmount 
	 价税合计：FAllAmount 
	 调入仓库：FCallInWarehouseID  (必填项)
	 调出仓库：FCallOutWarehouseID  (必填项)
	 辅助属性：FAuxPropId 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 ...
	 源单单号：FSourceBillNo 
	 关联数量：FJoinQty 
	 业务关闭：FEntryCloseStatus 
	 业务关闭人：FEntryCloserId 
	 业务关闭日期：FEntryCloseDate 
	 源单名称：FSourceBillName 
	 关联基本数量：FBaseJoinQty 
	 已调拨出库数量：FJoinTransferOutQty 
	 已调拨出库基本数量：FJoinTransferOutBaseQty 
	 备注：FComment 
	 补货模式：FSupplyModelId 
	 业务流程：FBFLowId 
物料汇总单体：FSumEntry 
	 实体主键：FEntryID 
	 物料编码：FMaterialID_sum 
	 物料名称：FMaterialName_sum 
	 规格型号：FMaterialModel_sum 
	 辅助属性：FAuxPropId_sum 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 ...
	 单位：FUnitID_sum 
	 数量：FQty_sum 
	 基本单位：FBaseUnitID_sum 
	 基本单位数量：FBaseUnitQty_sum 
	 金额：FAmount_sum 
	 税额：FTaxAmount_sum 
	 价税合计：FAllAmount_sum 
关联关系表：FDistributeEntry_Link 
	 实体主键：FLinkId 
	 业务流程图：FDistributeEntry_Link_FFlowId 
	 推进路线：FDistributeEntry_Link_FFlowLineId 
	 转换规则：FDistributeEntry_Link_FRuleId 
	 源单表内码：FDistributeEntry_Link_FSTableId 
	 源单表：FDistributeEntry_Link_FSTableName 
	 源单内码：FDistributeEntry_Link_FSBillId 
	 源单分录内码：FDistributeEntry_Link_FSId 
	 原始携带量：FDistributeEntry_Link_FBaseUnitQtyOld 
	 修改携带量：FDistributeEntry_Link_FBaseUnitQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("DRP_DistributeOfBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FREQUESTDATE":"1900-01-01","FCallOutStorageOrgID":{"FNumber":""},"FCallInStorageOrgID":{"FNumber":""},"FDescription":"","FCurrencyID":{"FNUMBER":""},"FPriceListID":{"FNUMBER":""},"FIsIncludedTax":"false","FDistributeEntry":[{"FEntryID":0,"FMaterialID":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FQty":0,"FBaseUnitID":{"FNumber":""},"FBaseUnitQty":0,"FPrice":0,"FTaxPrice":0,"FTaxRate":0,"FAmount":0,"FTaxAmount":0,"FAllAmount":0,"FDiscountRate":0,"FDiscount":0,"FTaxNetPrice":0,"FCallInWarehouseID":{"FNUMBER":""},"FCallOutWarehouseID":{"FNUMBER":""},"FDeliveryDate":"1900-01-01","FComment":"","FSupplyModelId":{"FNUMBER":""},"FSourceBillType":"","FSourceBillNo":"","FSourceBillName":"","FJoinQty":0,"FBaseJoinQty":0,"FJoinTransferOutQty":0,"FJoinTransferOutBaseQty":0,"FEntryCloserId":{"FUserID":""},"FBFLowId":{"FName":""},"FEntryCloseDate":"1900-01-01"}],"FSumEntry":[{"FEntryID":0,"FMaterialID_sum":{"FNUMBER":""},"FAuxPropId_sum":{"FAUXPROPID_SUM__FF100001":{"FNumber":""},"FAUXPROPID_SUM__FF100002":{"FNumber":""},"FAUXPROPID_SUM__FF100003":{"FNumber":""},"FAUXPROPID_SUM__FF100005":{"FNumber":""},"FAUXPROPID_SUM__FF100010":{"FNumber":""},"FAUXPROPID_SUM__FF100007":{"FNumber":""},"FAUXPROPID_SUM__FF100008":{"FNumber":""}},"FUnitID_sum":{"FNUMBER":""},"FQty_sum":0,"FBaseUnitID_sum":{"FNumber":""},"FBaseUnitQty_sum":0,"FAmount_sum":0,"FTaxAmount_sum":0,"FAllAmount_sum":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("DRP_DistributeOfBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("DRP_DistributeOfBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("DRP_DistributeOfBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("DRP_DistributeOfBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("DRP_DistributeOfBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("DRP_DistributeOfBill","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_DistributeOfBill","EntryMRPClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_DistributeOfBill","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_DistributeOfBill","BillClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_DistributeOfBill","UnBillClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_DistributeOfBill","EntryMrpUnClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("DRP_DistributeOfBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"DRP_DistributeOfBill"}");

# 资源利用率分析表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 资源利用率分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2836 |
...
client.GetSysReportData("SFC_ResUAnalysisRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgId":{"FNumber":""},"FRadioBeforeMonth":"","FRadioCurrMonth":"","FRadioSeason":"","FRadioYear":"","FBeginCountDate":"1900-01-01","FWorkShopIDS":"","FRSRCCategory":"","FBeginResourceId":{"FNumber":""},"FEndResourceId":{"FNUMBER":""},"FCountDateGroup":"","FEndCountDate":"1900-01-01"}}");

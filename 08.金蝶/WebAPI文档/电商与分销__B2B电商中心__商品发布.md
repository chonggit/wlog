...
client.Delete("CP_GoodsPublishBase","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CP_GoodsPublishBase","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CP_GoodsPublishBase","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPublishOrgId":{"FNumber":""},"FMaterialId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FGoodsTypeId":{"FNumber":""},"FCurrencyId":{"FNumber":""},"FStdPrice":0,"FCustId":{"FNumber":""},"FShowName":"","FEffectiveStatus":"false","FDetailDesc":"","FQty":0,"FEndDate":"1900-01-01","FBaseUnitId":{"FNumber":""},"FDate":"1900-01-01","FCreatorId":{"FUserID":""},"FOrderOrgId":{"FNumber":""},"FOrderStock":[{"FNumber":""}],"FVitiator":{"FUserID":""},"FTransportOrgId":{"FNumber":""},"FOrdering":0,"FImgName":"","FGoodsList":[{"FEntryID":0,"FIsDefaultShow":"false"}]}}");
...
单据头：FBillHead 
	 ...
	 规格型号：FUOM 
	 客户名称：FCustomerName 
	 发布状态：FDocumentStatus 
	 数量：FQty 
	 订货组织：FOrderOrgId  (必填项)
	 标志（后台）：FFlag 
	 辅助属性：FAuxPropId 
	 描述：FF100001
	 公差：FF100002
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 物料MasterId：FMatMasterId 
	 商品类别：FGoodsTypeId  (必填项)
	 审核日期：FApproveDate 
	 审核人：FApproverId 
	 发货仓库：FOrderStock 
	 客户MasterId：FCustMasterId 
	 失效人：FVitiator 
	 物料FId（订货组织）：FMatId_OrderOrg 
	 客户FId（订货组织）：FCustId_OrderOrg 
	 编码：FNumber 
	 展示名称：FShowName 
	 详细描述：FDetailDesc 
	 生效：FEffectiveStatus 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CP_GoodsPublishBase","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPublishOrgId":{"FNumber":""},"FMaterialId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FGoodsTypeId":{"FNumber":""},"FCurrencyId":{"FNumber":""},"FStdPrice":0,"FCustId":{"FNumber":""},"FShowName":"","FEffectiveStatus":"false","FDetailDesc":"","FQty":0,"FEndDate":"1900-01-01","FBaseUnitId":{"FNumber":""},"FDate":"1900-01-01","FCreatorId":{"FUserID":""},"FOrderOrgId":{"FNumber":""},"FOrderStock":[{"FNumber":""}],"FVitiator":{"FUserID":""},"FTransportOrgId":{"FNumber":""},"FOrdering":0,"FImgName":"","FGoodsList":[{"FEntryID":0,"FIsDefaultShow":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CP_GoodsPublishBase","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CP_GoodsPublishBase","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CP_GoodsPublishBase","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CP_GoodsPublishBase","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CP_GoodsPublishBase","GetPrice","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FPublishOrgId":{"FNumber":""},"FMaterialId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FGoodsTypeId":{"FNumber":""},"FCurrencyId":{"FNumber":""},"FStdPrice":0,"FCustId":{"FNumber":""},"FShowName":"","FEffectiveStatus":"false","FDetailDesc":"","FQty":0,"FEndDate":"1900-01-01","FBaseUnitId":{"FNumber":""},"FDate":"1900-01-01","FCreatorId":{"FUserID":""},"FOrderOrgId":{"FNumber":""},"FOrderStock":[{"FNumber":""}],"FVitiator":{"FUserID":""},"FTransportOrgId":{"FNumber":""},"FOrdering":0,"FImgName":"","FGoodsList":[{"FEntryID":0,"FIsDefaultShow":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CP_GoodsPublishBase","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CP_GoodsPublishBase"}");

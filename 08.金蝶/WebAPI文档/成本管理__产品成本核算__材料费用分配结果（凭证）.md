# 材料费用分配结果（凭证） Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 材料费用分配结果（凭证）
...
client.Delete("V_CB_MATALLOCREVINSEND","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("V_CB_MATALLOCREVINSEND","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FBillNo":"","FDate":"1900-01-01","FCURRENCYID":{"FNUMBER":""},"FSENDCOSTCENTERID":{"FNUMBER":""},"FSENDDEPARTMENGID":{"FNUMBER":""},"FSENDORGID":{"FNUMBER":""},"FSENDAMOUNT":0,"FMATERIALID":{"FNUMBER":""},"FRECTOTALAMOUNT":0,"FYEAR":0,"FPERIOD":0,"FSENDQTY":0,"FBASEUNITID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FRECCOSTCENTERID":{"FNUMBER":""},"FRECDEPARTMENGID":{"FNUMBER":""},"FRECORGID":{"FNUMBER":""},"FRECEXPENSEITEMID":{"FNUMBER":""},"FRECAMOUNT":0,"FPRODUCTID":{"FNUMBER":""},"FCOSTITEMID":{"FNUMBER":""},"FBILLTYPEID":{"FNUMBER":""},"FOUTSRCTYPE":""}]}}");
...
单据头：FBillHead 
	 ...
	 业务日期：FDate 
	 币别：FCURRENCYID 
	 发送方成本中心：FSENDCOSTCENTERID 
	 发送方部门：FSENDDEPARTMENGID 
	 费用来源组织：FSENDORGID 
	 发送金额：FSENDAMOUNT 
	 物料：FMATERIALID 
	 接收金额：FRECTOTALAMOUNT 
	 年：FYEAR 
	 期：FPERIOD 
	 发送数量：FSENDQTY 
	 基本单位：FBASEUNITID 
单据体：FEntity 
	 实体主键：FEntryID 
	 接收金额：FRECAMOUNT 
	 接收方成本中心：FRECCOSTCENTERID 
	 接收方部门：FRECDEPARTMENGID 
	 费用承担组织：FRECORGID 
	 费用项目：FRECEXPENSEITEMID 
	 费用承担产品：FPRODUCTID 
	 成本项目：FCOSTITEMID 
	 单据类型：FBILLTYPEID 
	 委外业务：FOUTSRCTYPE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("V_CB_MATALLOCREVINSEND","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FBillNo":"","FDate":"1900-01-01","FCURRENCYID":{"FNUMBER":""},"FSENDCOSTCENTERID":{"FNUMBER":""},"FSENDDEPARTMENGID":{"FNUMBER":""},"FSENDORGID":{"FNUMBER":""},"FSENDAMOUNT":0,"FMATERIALID":{"FNUMBER":""},"FRECTOTALAMOUNT":0,"FYEAR":0,"FPERIOD":0,"FSENDQTY":0,"FBASEUNITID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FRECCOSTCENTERID":{"FNUMBER":""},"FRECDEPARTMENGID":{"FNUMBER":""},"FRECORGID":{"FNUMBER":""},"FRECEXPENSEITEMID":{"FNUMBER":""},"FRECAMOUNT":0,"FPRODUCTID":{"FNUMBER":""},"FCOSTITEMID":{"FNUMBER":""},"FBILLTYPEID":{"FNUMBER":""},"FOUTSRCTYPE":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("V_CB_MATALLOCREVINSEND","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("V_CB_MATALLOCREVINSEND","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("V_CB_MATALLOCREVINSEND","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("V_CB_MATALLOCREVINSEND","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("V_CB_MATALLOCREVINSEND","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"V_CB_MATALLOCREVINSEND"}");

# 供应商评分表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 供应商评分表
...
client.Delete("PUR_SupplierAsseementTb","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_SupplierAsseementTb","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FPurOrg":{"FNumber":""},"FAssessmentPlan":{"FNUMBER":""},"FSupplier":{"FNUMBER":""},"FSumScores":0,"FGradeGroup":{"FNUMBER":""},"FAssessmentGrade":{"FNUMBER":""},"FSuggestions":"","FFeedback":"","FAssmentDateFrom":"1900-01-01","FAssmentDateTo":"1900-01-01","FAssistant":{"FNumber":""},"FConfirmerId":{"FUserID":""},"FConfirmDate":"1900-01-01","FTreeEntity":[{"FEntryID":0,"FAssessmentIndex":{"FNUMBER":""},"FScoreStandard":"","FScore":0,"FSysScore":0,"FScoreOne":"","FScoreFive":"","FScoreSix":"","FScoreSeven":"","FScoreEight":"","FScoreNine":"","FScoreTen":"","FScoreEleven":"","FScoreTwelve":"","FScoreThirteen":"","FScoreFourteen":"","FScoreFifteen":"","FScoreSixteen":"","FScoreSeventeen":"","FScoreEighteen":"","FScoreNineteen":"","FAverageScore":0,"FFinalScore":0,"FWeight":0,"FWeightScore":0,"FKey":"","FIndexParentId":"","FRowType":0}],"FScorerEntity":[{"FEntryID":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FSuggestions": "",
        "FFeedback": "",
        "FAssmentDateFrom": "1900-01-01",
        "FAssmentDateTo": "1900-01-01",
        "FAssistant": {
            "FNumber": ""
        },
        "FConfirmerId": {
...
基本信息：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 等级分组：FGradeGroup  (必填项)
	 最终得分默认等于平均分：FIsAveToFScore 
	 创建日期：FCreateDate 
	 综合得分：FSumScores 
	 评估等级：FAssessmentGrade 
	 综合评估意见：FSuggestions 
	 供应商反馈：FFeedback 
	 评估期间从：FAssmentDateFrom 
	 评估期间至：FAssmentDateTo 
	 供应商等级：FAssistant 
	 确认人：FConfirmerId 
	 确认日期：FConfirmDate 
	 确认状态：FConfirmStatus 
...
评分明细：FTreeEntity 
	 ...
	 评分人十一：FScoreEleven 
	 评分人十二：FScoreTwelve 
	 评分人十三：FScoreThirteen 
	 评分人十四：FScoreFourteen 
	 评分人十五：FScoreFifteen 
	 评分人十六：FScoreSixteen 
	 评分人十七：FScoreSeventeen 
	 评分人十八：FScoreEighteen 
	 评分人十九：FScoreNineteen 
评分人：FScorerEntity 
	 实体主键：FEntryID 
	 部门：FDepartment 
	 评分人：FEmployee 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PUR_SupplierAsseementTb","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FPurOrg":{"FNumber":""},"FAssessmentPlan":{"FNUMBER":""},"FSupplier":{"FNUMBER":""},"FSumScores":0,"FGradeGroup":{"FNUMBER":""},"FAssessmentGrade":{"FNUMBER":""},"FSuggestions":"","FFeedback":"","FAssmentDateFrom":"1900-01-01","FAssmentDateTo":"1900-01-01","FAssistant":{"FNumber":""},"FConfirmerId":{"FUserID":""},"FConfirmDate":"1900-01-01","FTreeEntity":[{"FEntryID":0,"FAssessmentIndex":{"FNUMBER":""},"FScoreStandard":"","FScore":0,"FSysScore":0,"FScoreOne":"","FScoreFive":"","FScoreSix":"","FScoreSeven":"","FScoreEight":"","FScoreNine":"","FScoreTen":"","FScoreEleven":"","FScoreTwelve":"","FScoreThirteen":"","FScoreFourteen":"","FScoreFifteen":"","FScoreSixteen":"","FScoreSeventeen":"","FScoreEighteen":"","FScoreNineteen":"","FAverageScore":0,"FFinalScore":0,"FWeight":0,"FWeightScore":0,"FKey":"","FIndexParentId":"","FRowType":0}],"FScorerEntity":[{"FEntryID":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_SupplierAsseementTb","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_SupplierAsseementTb","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_SupplierAsseementTb","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_SupplierAsseementTb","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_SupplierAsseementTb","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("PUR_SupplierAsseementTb","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PUR_SupplierAsseementTb","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_SupplierAsseementTb"}");

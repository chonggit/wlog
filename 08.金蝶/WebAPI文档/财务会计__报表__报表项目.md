...
client.Delete("KDS_RptItem","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("KDS_RptItem","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("KDS_RptItem","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FItemId":0,"FNumber":"","FLevelCode":"","FName":"","FRptShowName":"","FItemTypeID":{"FNumber":""},"FParentId":{"FNumber":""},"FCustomPty":"","FIsSysPreset":"false","FItemDC":"","FCreateOrgId":{"FNumber":""},"FIsText":"false","FIsSumItem":"false","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FDataResource":"","FAcctTableId":{"FNumber":""},"FAcctId":"","FForbidderID":{"FUserID":""},"FUseOrgId":{"FNumber":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FCashFlowID":{"FNumber":""},"FForbidDate":"1900-01-01","FRptItemID":{"FNumber":""},"FAcctFormula":"","FAcctFormulaTxt":""}}");
...
单据头：FBillHead 
	 ...
	 合计项：FIsSumItem 
	 父级项目：FParentId 
	 原上级项目内码(虚拟字段)：FOldParentId 
	 数据来源(虚字段)：FDataFrom 
	 层级码：FLevelCode 
	 表达式描述：FAcctFormulaTxt 
	 自定义属性：FCustomProperty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("KDS_RptItem","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("KDS_RptItem","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"KDS_RptItem"}");

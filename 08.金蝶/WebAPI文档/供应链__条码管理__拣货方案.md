...
client.Delete("UN_PickingPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UN_PickingPlan","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_PickingPlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FScanConfig":"","FSourceBill":{"FID":""},"FTargetBill":{"FID":""},"FStartDate":"1900-01-01","FScanConfigId":"","FWaveRule":"","FLotPickRule":"","FExpPeriodPickRule":"","FAssignMode":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FTaskFilter":"","FIsLastBoxGuide":"false","FCreateFailCtrl":"","FLastBoxMatchOpt":"","FLastBoxMatchLevel":"","FInventoryShortCtrl":"","FTaskStautsCtrl":"","FMatchEntryMode":"","FIsReview":"false","FIsReviewPwd":"false","FReviewPwd":"","FReviewType":"","FReviewPutBackStock":{"FNUMBER":""},"FSTOCKLOCID":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FCreateBillNode":"","FBackScanConfig":"","FBackScanConfigId":"","FSchemaId":"","FPickPlot":"","FSuitePickTaking":"false","FUnScanQtyFrom":"","FNonSuiteMode":"","FChangBarcodeBind":"false","FCreateBillCtrl":"","FManualAllocation":"false","FISCompleteSetControl":"","FNoHandWorkDrawCanDel":"false","FPickDetailsValueMethod":"","FBarUnscanMode":"","FLocationOrgEntry":[{"FEntryID":0,"FOrgId":{"FNumber":""},"FRemark":""}],"FInventoryDimensionEntity":[{"FEntryID":0,"FFieldItem":{"FNUMBER":""},"FFilter":"false","FReturn":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FSchemaId": "",
        "FPickPlot": "",
        "FSuitePickTaking": "false",
        "FUnScanQtyFrom": "",
        "FNonSuiteMode": "",
        "FChangBarcodeBind": "false",
        "FCreateBillCtrl": "",
        "FManualAllocation": "false",
        "FISCompleteSetControl": "",
        "FNoHandWorkDrawCanDel": "false",
        "FPickDetailsValueMethod": "",
        "FBarUnscanMode": "",
        "FLocationOrgEntry": [
            {
                "FEntryID": 0,
...
单据头：FBillHead 
	 ...
	 波次规则：FWaveRule 
	 批号拣货规则：FLotPickRule 
	 保质期拣货规则：FExpPeriodPickRule 
	 分配方式：FAssignMode 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 手工领取-任务过滤维度：FTaskFilter 
	 尾箱指引：FIsLastBoxGuide 
	 尾箱匹配维度：FLastBoxMatchOpt 
	 尾箱匹配层级：FLastBoxMatchLevel 
	 库存不足时控制：FInventoryShortCtrl 
	 任务状态处理：FTaskStautsCtrl 
	 扫描匹配分录模式：FMatchEntryMode 
	 审核生成拣货单失败时控制：FCreateFailCtrl 
	 启用复核：FIsReview 
	 启用复核确认码管控：FIsReviewPwd 
	 复核确认码：FReviewPwd 
	 复核操作方式：FReviewType 
	 复核放回仓库：FReviewPutBackStock 
	 复核放回仓位：FSTOCKLOCID 
	 100新豪仓位值集：FF100003
	 ...
	 300德上仓位值集：FF100014
	 生成单据节点：FCreateBillNode 
	 调拨放回扫描配置：FBackScanConfig 
	 调拨放回扫描配置ID：FBackScanConfigId 
	 关联方案ID：FSchemaId 
	 拣货策略：FPickPlot 
	 套件拣货：FSuitePickTaking 
	 非套件物料拣货方式：FNonSuiteMode 
	 支持变更条码绑定分录：FChangBarcodeBind 
	 生成单据控制：FCreateBillCtrl 
	 手工分配已扫分录：FManualAllocation 
	 齐套控制：FISCompleteSetControl 
	 需携带未拣数量：FUnScanQtyFrom 
	 非手工领取的任务可以取消：FNoHandWorkDrawCanDel 
	 拣货单明细取值方式：FPickDetailsValueMethod 
	 扫描删除明细条码的方式：FBarUnscanMode 
适用库存组织：FLocationOrgEntry 
	 实体主键：FEntryID 
	 组织编码：FOrgId 
	 组织名称：FOrgName 
	 备注：FRemark 
匹配库存维度设置：FInventoryDimensionEntity 
	 实体主键：FEntryID 
	 过滤：FFilter 
	 返回：FReturn 
	 库存字段：FFieldItem 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_PickingPlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FScanConfig":"","FSourceBill":{"FID":""},"FTargetBill":{"FID":""},"FStartDate":"1900-01-01","FScanConfigId":"","FWaveRule":"","FLotPickRule":"","FExpPeriodPickRule":"","FAssignMode":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FTaskFilter":"","FIsLastBoxGuide":"false","FCreateFailCtrl":"","FLastBoxMatchOpt":"","FLastBoxMatchLevel":"","FInventoryShortCtrl":"","FTaskStautsCtrl":"","FMatchEntryMode":"","FIsReview":"false","FIsReviewPwd":"false","FReviewPwd":"","FReviewType":"","FReviewPutBackStock":{"FNUMBER":""},"FSTOCKLOCID":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FCreateBillNode":"","FBackScanConfig":"","FBackScanConfigId":"","FSchemaId":"","FPickPlot":"","FSuitePickTaking":"false","FUnScanQtyFrom":"","FNonSuiteMode":"","FChangBarcodeBind":"false","FCreateBillCtrl":"","FManualAllocation":"false","FISCompleteSetControl":"","FNoHandWorkDrawCanDel":"false","FPickDetailsValueMethod":"","FBarUnscanMode":"","FLocationOrgEntry":[{"FEntryID":0,"FOrgId":{"FNumber":""},"FRemark":""}],"FInventoryDimensionEntity":[{"FEntryID":0,"FFieldItem":{"FNUMBER":""},"FFilter":"false","FReturn":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("UN_PickingPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("UN_PickingPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("UN_PickingPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_PickingPlan","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_PickingPlan","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("UN_PickingPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_PickingPlan"}");

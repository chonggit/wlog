# 资产借用单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 资产借用单
...
client.Delete("FA_BORROW","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_BORROW","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBorrowDate":"1900-01-01","FOwnerOrgID":{"FNumber":""},"FBorrowOrgID":{"FNumber":""},"FBorrowDeptID":{"FNumber":""},"FBorrowerID":{},"FBorrowEntity":[{"FEntryID":0,"FAlterID":{"FNumber":""},"FUnitID":{"FNumber":""},"FQuantity":0,"FBorrowReason":"","FPlanReturnDate":"1900-01-01","FDetailSubEntity":[{"FDetailID":0,"FAlloID":{"FID":""},"FOldPositionId":{"FNUMBER":""},"FNewPositionId":{"FNUMBER":""}}]}]}}");
...
单据头：FBillHead 
	 ...
	 借用日期：FBorrowDate  (必填项)
	 借用人：FBorrowerID 
	 借用部门：FBorrowDeptID 
	 货主组织：FOwnerOrgID  (必填项)
	 借用组织：FBorrowOrgID  (必填项)
资产：FBorrowEntity 
	 实体主键：FEntryID 
	 卡片编码：FAlterID  (必填项)
	 资产名称：FAssetName 
	 借用原因：FBorrowReason 
	 预计归还日期：FPlanReturnDate 
	 是否归还：FIsReturn 
	 归还日期：FReturnDate 
	 数量：FQuantity 
	 是否收回：FIsReceive 
	 ...
	 资产编码属性：FAssetNumber 
	 计量单位：FUnitID 
使用及实物信息：FDetailSubEntity 
	 实体主键：FDetailID 
	 使用分配视图内码：FAlloID 
	 原使用部门：FUserDeptId 
	 原使用人：FUserId 
	 资产编码：FAssetNo 
	 现存放位置：FNewPositionId  (必填项)
	 原资产位置：FOldPositionId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_BORROW","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBorrowDate":"1900-01-01","FOwnerOrgID":{"FNumber":""},"FBorrowOrgID":{"FNumber":""},"FBorrowDeptID":{"FNumber":""},"FBorrowerID":{},"FBorrowEntity":[{"FEntryID":0,"FAlterID":{"FNumber":""},"FUnitID":{"FNumber":""},"FQuantity":0,"FBorrowReason":"","FPlanReturnDate":"1900-01-01","FDetailSubEntity":[{"FDetailID":0,"FAlloID":{"FID":""},"FOldPositionId":{"FNUMBER":""},"FNewPositionId":{"FNUMBER":""}}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_BORROW","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_BORROW","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_BORROW","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_BORROW","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("FA_BORROW","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_BORROW"}");

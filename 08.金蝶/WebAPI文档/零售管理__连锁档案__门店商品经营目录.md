# 门店商品经营目录 Web API 操作原始内容

> 来源页面：全部 > 零售管理 > 连锁档案 > 门店商品经营目录
...
client.Delete("CMK_BranchItemCatalog","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CMK_BranchItemCatalog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBizOrgId":{"FNumber":""},"FBranchID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FOrgId":{"FNumber":""},"FBranch":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FBarCode":"","FStockId":{"FNumber":""},"FUnitID":{"FNumber":""},"FSalePrice":0,"FVIPPrice":0,"FProPrice":0,"FPlanPrice":0,"FReqUnitID":{"FNumber":""},"FTARE":0,"FMasterId":0,"FSaleStatus":"","FRequestStatus":"","FStockBizStatus":"","FSafeStock":0,"FMinStock":0,"FMaxStock":0,"FTransferStatus":"","FPosShowName":"","FCardPriceEntity":[{"FDetailID":0,"FCardLevelId":{"FNUMBER":""},"FCardPrice":0}]}]}}");
...
商品信息：FEntity 
	 ...
	 默认税率：FTAXRATEID 
	 税分类：FTAXTYPE 
	 库存业务状态：FStockBizStatus 
	 要货状态：FRequestStatus 
	 门店调拨状态：FTransferStatus 
	 默认要货单位：FReqUnitID  (必填项)
	 首选仓库：FStockId 
	 皮重(克)：FTARE 
	 POS显示名称：FPosShowName 
	 单位订金：FPlanPrice 
卡级别价格：FCardPriceEntity 
	 实体主键：FDetailID 
	 卡级别：FCardLevelId 
	 会员价：FCardPrice 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CMK_BranchItemCatalog","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBizOrgId":{"FNumber":""},"FBranchID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FOrgId":{"FNumber":""},"FBranch":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FBarCode":"","FStockId":{"FNumber":""},"FUnitID":{"FNumber":""},"FSalePrice":0,"FVIPPrice":0,"FProPrice":0,"FPlanPrice":0,"FReqUnitID":{"FNumber":""},"FTARE":0,"FMasterId":0,"FSaleStatus":"","FRequestStatus":"","FStockBizStatus":"","FSafeStock":0,"FMinStock":0,"FMaxStock":0,"FTransferStatus":"","FPosShowName":"","FCardPriceEntity":[{"FDetailID":0,"FCardLevelId":{"FNUMBER":""},"FCardPrice":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CMK_BranchItemCatalog","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CMK_BranchItemCatalog","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CMK_BranchItemCatalog","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CMK_BranchItemCatalog","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CMK_BranchItemCatalog","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CMK_BranchItemCatalog","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CMK_BranchItemCatalog","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CMK_BranchItemCatalog"}");

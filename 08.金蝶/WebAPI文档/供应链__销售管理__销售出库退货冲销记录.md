# 销售出库退货冲销记录 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 销售出库退货冲销记录

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3000 |
...
client.GetSysReportData("SAL_WriteOffReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FWriteOffDateFrom":"1900-01-01","FSaleOrgList":"","FSettleOrgList":"","FCustFrom":{"FNUMBER":""},"FMATERIALCODEFROM":{"FNUMBER":""},"FCustTo":{"FNUMBER":""},"FMATERIALCODETO":{"FNUMBER":""},"FWriteOffDateTo":"1900-01-01","FMoneyType":{"FNumber":""}}}");
...
参数FieldKeys显示列：
	 ...
	 单据日期：FBillDate 
	 客户名称：FCustomer 
	 结算币别：FSettleCurrency 
	 物料编码：FMaterialId 
	 物料名称：FMaterialName 
	 本次冲销数量：FWriteOffQty 
	 计价单位：FUnitID 
	 本次冲销金额：FWriteOffAmount 
	 销售组织：FSaleOrgId 
	 结算组织：FSettleOrgId 
	 销售部门：FSaleDeptId 
	 销售组：FSaleGroupId 

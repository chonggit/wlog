# 金税连接设置 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 金税连接设置
...
client.Delete("IV_GTSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IV_GTSetting","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FText":"","FBillNo":"","FEXAMPLEURL":"","FEXAMPLEURLFORRECEIVE":"","FPiaozoneClientId":"","FBWAMOUNTDIFFRANGE":0,"FHXAMOUNTDIFFRANGE":0,"FUKeyAMOUNTDIFFRANGE":0,"FQDAMOUNTDIFFRANGE":0,"FQDTAXAMOUNTDIFFRANGE":0,"FUKeyTAXAMOUNTDIFFRANGE":0,"FBWTAXAMOUNTDIFFRANGE":0,"FHXTAXAMOUNTDIFFRANGE":0,"FKPQSRULE":"false","FRoundNumber":0,"FEntity":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FDEVICENUMBER":"","FGTDISKNUMBER":"","FDISKNAME":"","FISMAINDISK":"false","FIsQdElectronicIV":"false","FISDEPOSIT":"false","FISNOTAXDISK":"false","FTAXSERVICEPROVIDER":"","FCOMPANYNAME":"","FSHOWINVOICEVOLUME":"false","FTAXNUMBER":"","FMAILINFO":"","FBANKINFO":"","FREGISTERADDRESS":{"FNumber":""},"FLINELIMIT":0,"FICLIMIT":0,"FOCLIMIT":0,"FELECTRICICLIMIT":0,"FELECTRICOCLIMIT":0,"FGTURL":"","FRECEIVEURL":"","FPIAOZONECLIENTID_E":"","FPIAOZONECLIENTSECRET_E":"","FPIAOZONEENCRYPTKEY":"","FTNAME":"","FCACODE":"","FTID":"","FTAXPLATFORMPASS":""}],"FEntityConvert":[{"FEntryID":0,"FORGID":[{"FNumber":""}],"FSALESICCRID":{},"FSALESOCCRID":{},"FSALEEXVATINCRID":{},"FSALEEXINVCRID":{},"FPURCHASECRID":{},"FPURCHASEICRID":{},"FREMARK":"","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FBillNo": "",
        "FEXAMPLEURL": "",
        "FEXAMPLEURLFORRECEIVE": "",
        "FPiaozoneClientId": "",
        "FBWAMOUNTDIFFRANGE": 0,
        "FHXAMOUNTDIFFRANGE": 0,
        "FUKeyAMOUNTDIFFRANGE": 0,
        "FQDAMOUNTDIFFRANGE": 0,
        "FQDTAXAMOUNTDIFFRANGE": 0,
        "FUKeyTAXAMOUNTDIFFRANGE": 0,
        "FBWTAXAMOUNTDIFFRANGE": 0,
        "FHXTAXAMOUNTDIFFRANGE": 0,
        "FKPQSRULE": "false",
        "FRoundNumber": 0,
        "FEntity": [
            {
                ...
                "FDISKNAME": "",
                "FISMAINDISK": "false",
                "FIsQdElectronicIV": "false",
                "FISDEPOSIT": "false",
                "FISNOTAXDISK": "false",
                "FTAXSERVICEPROVIDER": "",
                "FCOMPANYNAME": "",
                "FSHOWINVOICEVOLUME": "false",
                "FTAXNUMBER": "",
                "FMAILINFO": "",
                "FBANKINFO": "",
                "FREGISTERADDRESS": {
...
单据头：FBillHead 
	 ...
	 开票地址示例：：FEXAMPLEURL 
	 收票地址示例：：FEXAMPLEURLFORRECEIVE 
	 (已移到表体)票无忧ClientId：FPiaozoneClientId 
	 文本：FText 
	 百望盘校验范围：：FBWAMOUNTDIFFRANGE 
	 航信盘校验范围：：FHXAMOUNTDIFFRANGE 
	 税务ukey盘校验范围:：FUKeyAMOUNTDIFFRANGE 
	 全电发票校验范围:：FQDAMOUNTDIFFRANGE 
	 全电发票校验范围:：FQDTAXAMOUNTDIFFRANGE 
	 税务ukey盘校验范围:：FUKeyTAXAMOUNTDIFFRANGE 
	 百望盘校验范围:：FBWTAXAMOUNTDIFFRANGE 
	 航信盘校验范围:：FHXTAXAMOUNTDIFFRANGE 
	 校验公式的计算结果，保留至小数点后：FKPQSRULE 
	 保留几位小数：FRoundNumber 
	 对接发票云安全算法类型：FInvoiceSecurityType 
连接设置：FEntity 
	 实体主键：FEntryID 
	 业务组织：FSETTLEORGID  (必填项)
	 业务组织名称：FSETTLEORGNAME 
	 开票地址：FGTURL 
	 企业名称：FCOMPANYNAME 
	 纳税人识别号：FTAXNUMBER 
	 企业地址电话：FMAILINFO 
	 ...
	 金税盘名称：FDISKNAME 
	 收票地址：FRECEIVEURL 
	 税盘登记地址：FREGISTERADDRESS 
	 税务平台密码：FTAXPLATFORMPASS 
	 税盘设备编号：FDEVICENUMBER 
	 发票云ClientId：FPIAOZONECLIENTID_E 
	 发票云ClientSecret：FPIAOZONECLIENTSECRET_E 
	 发票云加密密钥：FPIAOZONEENCRYPTKEY 
	 税控设备类型：FTAXSERVICEPROVIDER 
	 开票限行：FLINELIMIT 
	 无盘收票：FISNOTAXDISK 
	 电子普票开票限额：FELECTRICOCLIMIT 
	 电子专票开票限额：FELECTRICICLIMIT 
	 是否托管电票：FISDEPOSIT 
	 显示发票卷：FSHOWINVOICEVOLUME 
	 启动全电发票：FIsQdElectronicIV 
转换规则：FEntityConvert 
	 实体主键：FEntryID 
	 适用组织：FORGID  (必填项)
	 转换规则&销售增值税专用发票：FSALESICCRID 
	 转换规则&销售普通发票：FSALESOCCRID 
	 转换规则&销项费用普通发票：FSALEEXINVCRID 
	 转换规则&销项费用增值税专用发票：FSALEEXVATINCRID 
	 转换规则&采购普通发票：FPURCHASECRID 
	 描述：FREMARK 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 转换规则&采购增值税发票：FPURCHASEICRID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IV_GTSetting","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FText":"","FBillNo":"","FEXAMPLEURL":"","FEXAMPLEURLFORRECEIVE":"","FPiaozoneClientId":"","FBWAMOUNTDIFFRANGE":0,"FHXAMOUNTDIFFRANGE":0,"FUKeyAMOUNTDIFFRANGE":0,"FQDAMOUNTDIFFRANGE":0,"FQDTAXAMOUNTDIFFRANGE":0,"FUKeyTAXAMOUNTDIFFRANGE":0,"FBWTAXAMOUNTDIFFRANGE":0,"FHXTAXAMOUNTDIFFRANGE":0,"FKPQSRULE":"false","FRoundNumber":0,"FEntity":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FDEVICENUMBER":"","FGTDISKNUMBER":"","FDISKNAME":"","FISMAINDISK":"false","FIsQdElectronicIV":"false","FISDEPOSIT":"false","FISNOTAXDISK":"false","FTAXSERVICEPROVIDER":"","FCOMPANYNAME":"","FSHOWINVOICEVOLUME":"false","FTAXNUMBER":"","FMAILINFO":"","FBANKINFO":"","FREGISTERADDRESS":{"FNumber":""},"FLINELIMIT":0,"FICLIMIT":0,"FOCLIMIT":0,"FELECTRICICLIMIT":0,"FELECTRICOCLIMIT":0,"FGTURL":"","FRECEIVEURL":"","FPIAOZONECLIENTID_E":"","FPIAOZONECLIENTSECRET_E":"","FPIAOZONEENCRYPTKEY":"","FTNAME":"","FCACODE":"","FTID":"","FTAXPLATFORMPASS":""}],"FEntityConvert":[{"FEntryID":0,"FORGID":[{"FNumber":""}],"FSALESICCRID":{},"FSALESOCCRID":{},"FSALEEXVATINCRID":{},"FSALEEXINVCRID":{},"FPURCHASECRID":{},"FPURCHASEICRID":{},"FREMARK":"","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IV_GTSetting","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("IV_GTSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("IV_GTSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("IV_GTSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("IV_GTSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("IV_GTSetting","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IV_GTSetting"}");

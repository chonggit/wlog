# 预算调整表 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 预算调整表
...
client.Submit("BM_ReportAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_ReportAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_ReportAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ReportAdjust","StatusClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ReportAdjust","StatusEnable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("BM_ReportAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_ReportAdjust","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FSampleID":{"FBILLNO":""},"FName":"","FOrgID":{"FNUMBER":""},"FAdjustReason":"","FOrgTypeID":"","FCycleID":"","FDOCUMENTSTATUS":"","FCurrencyID":{"FNumber":""},"FCreateStyle":"","FAmountUnitID":{"FNumber":""},"FSchemeID":{"FNUMBER":""},"FBWBCurrencyID":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FFORBIDDERId":{"FUserID":""},"FAuditDate":"1900-01-01","FAdjustType":"","FForbidDate":"1900-01-01","FForbidStatus":"","FRateTypeId":{"FNumber":""},"FStyleType":"","FIsSample":"false","FIsJsonReport":"false","FOrgClass":"","FYear":"","FPeriod":"","FRangeDate":"","FEntryOrgId":{},"FUserOrgID":{"FNumber":""},"FEXCUTESTATUS":"","FRPTSchemeName":"","FBillTypeID":{"FNUMBER":""},"FDeptOrgID":0,"FISCURRENCYBWB":"false","FDIMENSIONTYPEID":{"FNUMBER":""},"FPrimaryDimensionValue":"","FDIMENSIONID":0,"FASSISTANTID":"","FDimensionValueName":"","FSOURCESAMPLEID":"","FLastLocaleId":0,"FAdjustDept":{"FNUMBER":""},"FEntity":[{"FSHEETID":"","FSheetName":"","FSheetType":0,"FIndex":0,"FSampleSheetId":"","FRPTSchemeId":0}]}}");
...
单据头：FBillHead 
	 ...
	 执行状态：FEXCUTESTATUS  (必填项)
	 包含预算样式方案：FRPTSchemeName 
	 报表编号：FBillNo 
	 报表类型：FBillTypeID  (必填项)
	 预算组织：FEntryOrgId  (必填项)
	 部门组织Id：FDeptOrgID 
	 综合本位币：FISCURRENCYBWB 
	 ...
	 FSOURCESAMPLEID：FSOURCESAMPLEID 
	 是否H5报表：FIsJsonReport 
	 JSON报表样式：FJSONStyle 
	 上次打开语言：FLastLocaleId 
	 调整类型：FAdjustType  (必填项)
	 版本号：FAdjustVersion 
	 最新版本：FIsLatestVersion 
	 调整事由：FAdjustReason  (必填项)
	 预算报表编号：FBaseProperty 
	 调整部门：FAdjustDept 
单据体：FEntity 
	 实体主键：FSHEETID 
	 表页名称：FSheetName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ReportAdjust","StatusForbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ReportAdjust","Execute","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ReportAdjust","UnExecute","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ReportAdjust","UnClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BM_ReportAdjust","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_ReportAdjust","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_ReportAdjust"}");

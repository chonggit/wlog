# 业务单据对账方案 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 智能会计平台 > 业务单据对账方案
...
client.Save("GL_CUSTOMCHECKSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FAcctTableID":{"FNUMBER":""},"FAccountBookId":[{"FNumber":""}],"FIsSysPreset":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FAuditDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FNumber":"","FShowBalanceAmount":"false","FBALCONTROL":"false","FBALCONTROLFOR":"false","FEntityDataChanged":"false","FEXCLUDEBALANCEPROFIT":"false","FBookMulLangText":"","FEntity":[{"FENTRYID":0,"FAccountName":"","FDC":"","FGLFLEXINCLUDENULL":"false","FGLFLEXFILTER":"","FGLFLEXFILTERMUL":"","FGLFLEXFILTERSQL":"","FGLFLEXFILTERMODEL":"","FSubEntity":[{"FDETAILID":0,"FSrcBillId":{"FID":""},"FBizDataIncDecItem":"","FBillFilter":"","FBILLFILTERMULLANG":"","FRefBillFieldDesc":"","FACCTORGFIELD":"","FDATEFIELD":"","FACCTORGFIELDDESC":"","FDATEFIELDDESC":"","FCURRENCYFIELD":"","FAMOUNTFORFIELD":"","FCURRENCYFIELDDESC":"","FAMOUNTFIELD":"","FAMOUNTFORFIELDDESC":"","FAMOUNTFIELDDESC":"","FBillFilterString":"","FBILLFILTERNO":"","FRefBillField":""}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FNumber": "",
        "FShowBalanceAmount": "false",
        "FBALCONTROL": "false",
        "FBALCONTROLFOR": "false",
        "FEntityDataChanged": "false",
        "FEXCLUDEBALANCEPROFIT": "false",
        "FBookMulLangText": "",
        "FEntity": [
            {
                "FENTRYID": 0,
...
单据头：FBillHead 
	 ...
	 方案名称：FName  (必填项)
	 方案编码：FNumber 
	 显示余额：FShowBalanceAmount 
	 本位币金额与总账期末对账平衡：FBALCONTROL 
	 原币金额与总账期末对账平衡：FBALCONTROLFOR 
	 单据体数据被改变标志：FEntityDataChanged 
	 不包含结转损益凭证：FEXCLUDEBALANCEPROFIT 
	 适用账簿：FBookMulLangText 
科目及核算维度：FEntity 
	 实体主键：FENTRYID 
	 科目名称：FAccountName 
	 核算维度：FFLEXITEMID 
	 余额方向：FDC  (必填项)
	 科目编码：FAccountID 
	 包含空值：FGLFLEXINCLUDENULL 
	 核算维度过滤：FGLFLEXFILTER 
	 核算维度过滤多语言：FGLFLEXFILTERMUL 
	 核算维度过滤sql：FGLFLEXFILTERSQL 
	 核算维度过滤方案：FGLFLEXFILTERMODEL 
单据取值设置：FSubEntity 
	 实体主键：FDETAILID 
	 业务数据增减项：FBizDataIncDecItem  (必填项)
	 单据取值条件设置：FBillFilter 
	 核算维度对应单据字段：FRefBillFieldDesc 
	 来源单据：FSrcBillId  (必填项)
	 取值条件对应的XML：FSubEntryXML 
	 取值条件对应的过滤条件：FBillFilterString 
	 核算组织：FACCTORGFIELD  (必填项)
	 日期：FDATEFIELD  (必填项)
	 币别：FCURRENCYFIELD  (必填项)
	 取值条件对应方案的编码：FBILLFILTERNO 
	 单据取值条件设置：FBILLFILTERMULLANG 
	 原币金额：FAMOUNTFORFIELD  (必填项)
	 本位币金额：FAMOUNTFIELD  (必填项)
	 原币金额描述：FAMOUNTFORFIELDDESC  (必填项)
	 本位币金额描述：FAMOUNTFIELDDESC  (必填项)
	 核算维度对应单据字段：FRefBillField 
	 核算组织描述：FACCTORGFIELDDESC  (必填项)
	 日期描述：FDATEFIELDDESC  (必填项)
	 币别描述：FCURRENCYFIELDDESC  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_CUSTOMCHECKSCHEME","ForBid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_CUSTOMCHECKSCHEME","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("GL_CUSTOMCHECKSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FAcctTableID":{"FNUMBER":""},"FAccountBookId":[{"FNumber":""}],"FIsSysPreset":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FAuditDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FNumber":"","FShowBalanceAmount":"false","FBALCONTROL":"false","FBALCONTROLFOR":"false","FEntityDataChanged":"false","FEXCLUDEBALANCEPROFIT":"false","FBookMulLangText":"","FEntity":[{"FENTRYID":0,"FAccountName":"","FDC":"","FGLFLEXINCLUDENULL":"false","FGLFLEXFILTER":"","FGLFLEXFILTERMUL":"","FGLFLEXFILTERSQL":"","FGLFLEXFILTERMODEL":"","FSubEntity":[{"FDETAILID":0,"FSrcBillId":{"FID":""},"FBizDataIncDecItem":"","FBillFilter":"","FBILLFILTERMULLANG":"","FRefBillFieldDesc":"","FACCTORGFIELD":"","FDATEFIELD":"","FACCTORGFIELDDESC":"","FDATEFIELDDESC":"","FCURRENCYFIELD":"","FAMOUNTFORFIELD":"","FCURRENCYFIELDDESC":"","FAMOUNTFIELD":"","FAMOUNTFORFIELDDESC":"","FAMOUNTFIELDDESC":"","FBillFilterString":"","FBILLFILTERNO":"","FRefBillField":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("GL_CUSTOMCHECKSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("GL_CUSTOMCHECKSCHEME","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("GL_CUSTOMCHECKSCHEME","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"GL_CUSTOMCHECKSCHEME"}");

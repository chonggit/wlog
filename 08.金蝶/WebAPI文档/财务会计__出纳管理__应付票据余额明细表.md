# 应付票据余额明细表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 应付票据余额明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3179 |
...
client.GetSysReportData("CN_PayBillBalRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPayOrgLst":[{"FNumber":""}],"FAffiliation":{"FNUMBER":""},"FCONTACTUNITTYPE":"","FCONTACTUNITFrom":{"FNumber":""},"FCurrency":{"FNUMBER":""},"FCONTACTUNITTo":{"FNumber":""},"FDate":"1900-01-01","FENDDATE":"1900-01-01","FBILLNOFROM":"","FBILLNOTO":"","FSETTLESTATE":"","FUseFDATE":"false"}}");
...
五、字段说明：
	 付款组织：FPayOrgLst  (必填项)
	 隶属方案：FAffiliation 
	 收款单位：FCONTACTUNITFrom 
	 收款单位类型：FCONTACTUNITTYPE 
	 币别：FCurrency 
	 至：FCONTACTUNITTo 
	 业务日期：FDate 
	 至：FENDDATE 
...
参数FieldKeys显示列：
	 ...
	 票面金额：FPARAMOUNTFOR 
	 关联付款金额：FRELATEDPAYMENT 
	 结算状态：FSETTLESTATUS 
	 票据类型：FBILLTYPE 
	 付款期限（天）：FPAYMENTPERIOD 
	 期初余额：FBalAmt 
	 本期增加：FAddAmount 
	 到期付款票面金额：FPAYMENTPERIODAMOUT 
	 退票票面金额：FRETURNBILLAMOUNT 

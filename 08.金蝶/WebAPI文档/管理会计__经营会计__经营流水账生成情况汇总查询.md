# 经营流水账生成情况汇总查询 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 经营流水账生成情况汇总查询
...
client.GetSysReportData("AM_VOUCHERBUILDQUERY","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAccountBookH":{"FNUMBER":""},"FProfitCenterH":{"FNUMBER":""},"FYEARPERIODH":"","FAMBORGIDSYSTEMH":{"FNUMBER":""},"FUNCREATEVCHBILL":"false","FAMEBAUNITH":[{"FNumber":""}],"FFilterTypeCombo":"","FImportPlan":[{"FNumber":""}],"FEntity":[{"FSELECTROWH":"false","FSOURCEBILLH":{"FNUMBER":""}}]}}");

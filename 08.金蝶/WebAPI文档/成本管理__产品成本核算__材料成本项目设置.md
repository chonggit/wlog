# 材料成本项目设置 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 材料成本项目设置
...
client.Delete("CB_MaterialCostItemSet","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_MaterialCostItemSet","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_MaterialCostItemSet","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FMaterialCostItemID":0,"FNumber":"","FAPPLYORGID":{"FNUMBER":""},"FMATERIALTYPE":"","FEntity":[{"FEntryID":0,"FMATERIALID":{"FNUMBER":""},"FCOSTITEMID":{"FNUMBER":""}}],"FGroupEntity":[{"FEntryID":0,"FCATEGORY":{"FNUMBER":""},"FMATERIALGROUP":{"FNUMBER":""},"FGROCOSTITEMID":{"FNUMBER":""}}]}}");
...
材料成本项目明细：FEntity 
	 实体主键：FEntryID 
	 物料编码：FMATERIALID 
	 存货类别：FMaterialCostType 
	 物料属性：FMaterialProperty 
	 成本项目：FCOSTITEMID 
	 物料名称：FMATERIALNAME 
材料成本按类型设置：FGroupEntity 
	 实体主键：FEntryID 
	 存货类别：FCATEGORY 
	 成本项目：FGROCOSTITEMID 
	 物料分组：FMATERIALGROUP 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CB_MaterialCostItemSet","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CB_MaterialCostItemSet","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_MaterialCostItemSet"}");

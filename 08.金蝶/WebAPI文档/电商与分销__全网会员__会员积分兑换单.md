# 会员积分兑换单 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 全网会员 > 会员积分兑换单
...
client.Delete("MMC_IntegralExchange","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("MMC_IntegralExchange","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FMemberId":{"FNUMBER":""},"FCardId":{"FNUMBER":""},"FAccountTypeId":{"FNUMBER":""},"FExchangeOrgId":{"FNumber":""},"FExchangeDate":"1900-01-01","FDescription":"","FEcgRuleId":{"FNUMBER":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FSourceOrder":"","FCreatorId":{"FUserID":""},"FCurrentIntegral":0,"FCostIntegral":0,"FIntegralExchangeEntry":[{"FEntryID":0,"FGoodsId":{"FNUMBER":""},"FUnitID":{"FNumber":""},"FNum":0,"FPercost":0,"FAllCost":0}]}}");
...
单据头：FBillHead 
	 ...
	 卡号：FCardId 
	 兑换账户：FAccountTypeId 
	 兑换组织：FExchangeOrgId  (必填项)
	 兑换时间：FExchangeDate  (必填项)
	 备注：FDescription 
	 积分兑换规则：FEcgRuleId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 ...
	 原始交易单：FSourceOrder 
	 创建人：FCreatorId 
	 当前积分：FCurrentIntegral 
	 本次消耗积分：FCostIntegral 
商品兑换明细：FIntegralExchangeEntry 
	 实体主键：FEntryID 
	 商品编码：FGoodsId 
	 商品名称：FGoodsName 
	 规则型号：FModel 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("MMC_IntegralExchange","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FMemberId":{"FNUMBER":""},"FCardId":{"FNUMBER":""},"FAccountTypeId":{"FNUMBER":""},"FExchangeOrgId":{"FNumber":""},"FExchangeDate":"1900-01-01","FDescription":"","FEcgRuleId":{"FNUMBER":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FSourceOrder":"","FCreatorId":{"FUserID":""},"FCurrentIntegral":0,"FCostIntegral":0,"FIntegralExchangeEntry":[{"FEntryID":0,"FGoodsId":{"FNUMBER":""},"FUnitID":{"FNumber":""},"FNum":0,"FPercost":0,"FAllCost":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("MMC_IntegralExchange","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("MMC_IntegralExchange","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("MMC_IntegralExchange","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("MMC_IntegralExchange","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("MMC_IntegralExchange","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("MMC_IntegralExchange","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"MMC_IntegralExchange"}");

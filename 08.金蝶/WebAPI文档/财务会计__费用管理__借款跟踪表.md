# 借款跟踪表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 费用管理 > 借款跟踪表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3146 |
...
client.GetSysReportData("ER_TraceRequest","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAffiliation":{"FNUMBER":""},"FCurrency":{"FNUMBER":""},"FCONTACTUNITTYPE":"","FCONTACTUNITTo":{"FNumber":""},"FCONTACTUNITFrom":{"FNumber":""},"FEXPIDFrom":{"FNUMBER":""},"FEXPIDTo":{"FNUMBER":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FEXPENSEORGID":"","FBorrowSource":"","FIsBorrowRadio":"","FIsPayRadio":""}}");
...
五、字段说明：
	 ...
	 单选按钮组：FBorrowSource 
	 借款单（含历史借款）：FIsBorrowRadio 
	 报销类付款单（含历史借款、退款）：FIsPayRadio 
...
参数FieldKeys显示列：
	 ...
	 申请日期：FDate 
	 费用项目：FEXPID 
	 借款（已付款）金额：FHadBorrowAmount 
	 尾差核销（付款单）：FOffsetAmount 
	 已报销金额：FReimburseAmount 
	 已退款金额：FRefundAmount 
	 借款余额：FTurnOverAmount 
	 已转移金额：FTransOutAmount 

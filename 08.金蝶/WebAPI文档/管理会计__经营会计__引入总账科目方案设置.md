# 引入总账科目方案设置 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 引入总账科目方案设置
...
client.Delete("AM_VCHFROMVCHPLAN","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_VCHFROMVCHPLAN","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FREMARK":"","FACCTBOOK":{"FNUMBER":""},"FGLBOOK":{"FNUMBER":""},"FVOUCHERTYPE":"","FCREATORID":{"FUserID":""},"FAPPROVERID":{"FUserID":""},"FBILLFILTER":"","FBYHEADERFILTER":"false","FHCUSTOMALLOSTDID":{"FNUMBER":""},"FALLSTDSTATE":"false","FBILLFILTERDESC":"","FFILTERBILLNO":"","FBILLFILTERIN":0,"FCREATEORG":{"FNumber":""},"FFROMVCHTYPE":"","FINCLUDEUNAUDIT":"false","FGLTOVCHCRTCOLL":"false","FBIlLLENTITY":[{"FEntryID":0,"FENTRYSTATUS":"false","FGLACCOUNTID":{"FNUMBER":""},"FDC":"","FVOUCHERBILLTYPE":{"FNUMBER":""},"FCACCOUNTID":{"FNUMBER":""},"FDACCOUNTID":{"FNUMBER":""},"FWEIGHTFROM":"","FCUSTOMALLOSTDID":{"FNUMBER":""},"FACCTITEMID":{"FNUMBER":""},"FPLUGIN":"","FACCTFILTERIN":0,"FACCTFILTERBILLNO":"","FAllOPLUGIN":"","FEXPENSEID":{"FNUMBER":""},"FEXPATIONIN":"","FEXPATION":"","FEXPATIONDESC":"","FDEFAULTAMOEBAID":{"FNUMBER":""},"FCNDEFAULTAMOEBAID":{"FNUMBER":""},"FAMOUNTFILEIN":"","FAMOUNTFILE":"","FAMOUNTFILEDESC":""}]}}");
...
单据头：FBillHead 
	 ...
	 审核日期：FAPPROVEDATE 
	 审核人：FAPPROVERID 
	 按表头过滤条件过滤：FBYHEADERFILTER 
	 过滤条件：FBILLFILTER 
	 经营账簿本位币：FACCBOOKCURRCY 
	 权重标准：FHCUSTOMALLOSTDID 
	 按表头权重标准统一分配：FALLSTDSTATE 
	 过滤条件多语言：FBILLFILTERDESC 
	 过滤条件单据编号：FFILTERBILLNO 
	 过滤条件单据内码：FBILLFILTERIN 
	 创建组织：FCREATEORG 
	 收支类型：FVOUCHERTYPE  (必填项)
	 来源类型：FFROMVCHTYPE  (必填项)
	 备注：FREMARK 
	 来源账簿：FMULGLBOOKS 
	 包含未审核数据：FINCLUDEUNAUDIT 
	 同时生成费用归集单和费用分配结果单：FGLTOVCHCRTCOLL 
单据体：FBIlLLENTITY 
	 实体主键：FEntryID 
	 总账科目：FGLACCOUNTID 
	 借贷方向：FDC  (必填项)
	 转入经营科目：FCACCOUNTID  (必填项)
	 转出经营科目或账户：FDACCOUNTID  (必填项)
	 权重标准：FCUSTOMALLOSTDID 
	 是否有效：FENTRYSTATUS 
	 过滤条件：FACCTFILTER 
	 过滤条件多语言：FACCTFILTERDESC 
	 核算维度：FACCTITEMID 
	 权重来源：FWEIGHTFROM  (必填项)
	 过滤条件单据编号：FACCTFILTERBILLNO 
	 过滤条件单据内码：FACCTFILTERIN 
	 归集插件：FPLUGIN 
	 分配插件：FAllOPLUGIN 
	 费用项目：FEXPENSEID 
	 备注设置：FEXPATIONIN 
	 备注设置标识：FEXPATION 
	 备注设置标识多语言：FEXPATIONDESC 
	 缺省经营单元：FDEFAULTAMOEBAID 
	 缺省内部交易方：FCNDEFAULTAMOEBAID 
	 金额配置：FAMOUNTFILEIN 
	 金额标识：FAMOUNTFILE 
	 金额多语言设置：FAMOUNTFILEDESC 
	 交易类型：FVOUCHERBILLTYPE  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_VCHFROMVCHPLAN","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FREMARK":"","FACCTBOOK":{"FNUMBER":""},"FGLBOOK":{"FNUMBER":""},"FVOUCHERTYPE":"","FCREATORID":{"FUserID":""},"FAPPROVERID":{"FUserID":""},"FBILLFILTER":"","FBYHEADERFILTER":"false","FHCUSTOMALLOSTDID":{"FNUMBER":""},"FALLSTDSTATE":"false","FBILLFILTERDESC":"","FFILTERBILLNO":"","FBILLFILTERIN":0,"FCREATEORG":{"FNumber":""},"FFROMVCHTYPE":"","FINCLUDEUNAUDIT":"false","FGLTOVCHCRTCOLL":"false","FBIlLLENTITY":[{"FEntryID":0,"FENTRYSTATUS":"false","FGLACCOUNTID":{"FNUMBER":""},"FDC":"","FVOUCHERBILLTYPE":{"FNUMBER":""},"FCACCOUNTID":{"FNUMBER":""},"FDACCOUNTID":{"FNUMBER":""},"FWEIGHTFROM":"","FCUSTOMALLOSTDID":{"FNUMBER":""},"FACCTITEMID":{"FNUMBER":""},"FPLUGIN":"","FACCTFILTERIN":0,"FACCTFILTERBILLNO":"","FAllOPLUGIN":"","FEXPENSEID":{"FNUMBER":""},"FEXPATIONIN":"","FEXPATION":"","FEXPATIONDESC":"","FDEFAULTAMOEBAID":{"FNUMBER":""},"FCNDEFAULTAMOEBAID":{"FNUMBER":""},"FAMOUNTFILEIN":"","FAMOUNTFILE":"","FAMOUNTFILEDESC":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_VCHFROMVCHPLAN","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_VCHFROMVCHPLAN","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_VCHFROMVCHPLAN","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AM_VCHFROMVCHPLAN","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_VCHFROMVCHPLAN","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AM_VCHFROMVCHPLAN"}");

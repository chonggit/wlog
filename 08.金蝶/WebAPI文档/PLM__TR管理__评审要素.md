...
client.Delete("PLM_STD_NEW_TR_REVIEWELEMENTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PLM_STD_NEW_TR_REVIEWELEMENTS","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FCreateOrgId":{"FNumber":""},"FTRMAJORCLASSEID":{"FNUMBER":""},"FTRSUBCALSSEID":{"FNUMBER":""},"FEnglishElements":{"FNUMBER":""},"FRedLineCode":"","FPrdPkgDeliverables":"","FDutyRoleId":{"FNUMBER":""},"FIsNeed":"false","FBaseLine":"","FElementScene":"","FLCL":"","FRedLineDemandFlag":"","FRemark":"","FUCL":"","FIRB":"","FChkType":"","FBIZType":"","FManual":"","FImportance":"","FAcceptStd":"","FQualityReqmt":"","FOperationGuide":"","FAcceptActivity":""}}");
...
单据头：FBillHead 
	 ...
	 创建日期：FCreateDate 
	 修改日期：FModifyDate 
	 要求大类：FTRMAJORCLASSEID 
	 要求小类：FTRSUBCALSSEID 
	 英文要素：FEnglishElements 
	 承接红线编码：FRedLineCode 
	 产品包交付件：FPrdPkgDeliverables 
	 责任角色：FDutyRoleId 
	 是否必须：FIsNeed 
	 Baseline：FBaseLine 
	 要素场景：FElementScene 
	 LCL：FLCL 
	 红线要求标识：FRedLineDemandFlag 
	 Remark：FRemark 
	 UCL：FUCL 
	 IRB：FIRB 
	 产品线：FPRDLine 
	 ...
	 重要性：FImportance 
	 验收角色：FAcceptRoleId 
	 参与验收角色：FParticipateRoleId 
	 验收标准：FAcceptStd 
	 质量要求：FQualityReqmt 
	 操作指南：FOperationGuide 
	 验收活动及方法：FAcceptActivity 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLM_STD_NEW_TR_REVIEWELEMENTS","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PLM_STD_NEW_TR_REVIEWELEMENTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PLM_STD_NEW_TR_REVIEWELEMENTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PLM_STD_NEW_TR_REVIEWELEMENTS","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_STD_NEW_TR_REVIEWELEMENTS"}");

# 供应商协同即时库存查询 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 供应商协同平台 > 供应商协同即时库存查询
...
client.Save("SCP_STKInventory","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FProjectNo":"","FMtoNo":"","FOwnerTypeId":"","FExpiryDays":0,"FSecAVBQty":0,"FBaseAVBQty":0,"FAVBQty":0,"FBomId":{"FNumber":""},"FExpiryDate":"1900-01-01","FSecQty":0,"FStockStatusId":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FBaseLockQty":0,"FProduceDate":"1900-01-01","FBaseQty":0,"FSecLockQty":0,"FLockQty":0,"FLot":{"FNumber":""},"FStockUnitId":{"FNumber":""},"FSecUnitId":{"FNumber":""},"FBaseUnitId":{"FNumber":""},"FStockOrgId":{"FNumber":""},"FKeeperTypeId":"","FQty":0,"FKeeperId":{"FNumber":""},"FOwnerId":{"FNumber":""},"FStockId":{"FNumber":""},"FMaterialId":{"FNumber":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}}}}");
...
即时库存：FBillHead 
	 ...
	 库存辅单位：FSecUnitId 
	 库存主单位：FStockUnitId 
	 库存单位换算分子：FStoreurNum 
	 库存单位换算分母：FStoreurNom 
	 批号：FLot 
	 批号生产日期：FLotProduceDate 
	 保质期：FKFPeriod 
	 项目编号：FProjectNo 
	 预留量(主单位)：FLockQty 
	 预留量(辅单位)：FSecLockQty 
	 ...
	 库存状态：FStockStatusId 
	 库存量(库存辅单位)：FSecQty 
	 批号有效期至：FLotExpiryDate 
	 有效期至：FExpiryDate 
	 BOM版本：FBomId 
	 保质期单位：FKFPeriodUnit 
	 库存单位舍入类型：FUnitRoundType 
	 物料分组：FBaseProperty 
	 可用量(主单位)：FAVBQty 
	 可用量(基本单位)：FBaseAVBQty 
	 可用量(库存辅单位)：FSecAVBQty 
	 到期天数：FExpiryDays 
	 最后更新日期：FUpdateTime 
	 物料分组：FMaterialGroup 
	 仓库分组：FStockGroup 
	 批次归属供应商：F_ora_BaseProperty 
	 入库日期：F_ora_BaseProperty1 
	 材质：F_ora_BaseProperty_qtr 
	 材质型号：F_ora_BaseProperty_83g 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SCP_STKInventory","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SCP_STKInventory"}");

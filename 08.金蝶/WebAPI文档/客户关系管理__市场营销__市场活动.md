...
client.Delete("CRM_MAR_MarketActivity","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRM_MAR_MarketActivity","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FActivityType":{"FNumber":""},"FEndTime":"1900-01-01","FStartTime":"1900-01-01","FActivityTitle":"","FActivityGoal":"","FBudget":0,"FForcastRevenue":0,"FAutoStart":"false","FAutoEnd":"false","FPotentialCustCount":0,"FPotentialOppCount":0,"FPotentialClueCount":0,"FTransferdCustCount":0,"FForcastDealAmount":0,"FActDealAmount":0,"FClueRate":0,"FContent":"","FSaleOrgId":{"FNumber":""},"FSALEDEPTID":{"FNUMBER":""},"FBEmpID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FContact":{"FNUMBER":""}}],"FCRMAllocation":[{"FCooperationType":"","FEmployee":{"FSTAFFNUMBER":""},"FDept":{"FNUMBER":""},"FRead":"false","FModify":"false","FDelete":"false","FAllocation":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FAutoStart": "false",
        "FAutoEnd": "false",
        "FPotentialCustCount": 0,
        "FPotentialOppCount": 0,
        "FPotentialClueCount": 0,
        "FTransferdCustCount": 0,
        "FForcastDealAmount": 0,
        "FActDealAmount": 0,
        "FClueRate": 0,
        "FContent": "",
        "FSaleOrgId": {
...
单据头：FBillHead 
	 ...
	 创建人：FCreatorId 
	 修改日期：FModifyDate 
	 客户细分：FSegmentationID 
	 潜在客户数：FPotentialCustCount 
	 潜在商机数：FPotentialOppCount 
	 潜在线索数：FPotentialClueCount 
	 线索转客户数：FTransferdCustCount 
	 预计成交金额：FForcastDealAmount 
	 实际成交金额：FActDealAmount 
	 线索转客户比例：FClueRate 
	 活动内容：FContent  (必填项)
	 活动名称：FName  (必填项)
	 活动类型：FActivityType 
	 计划结束日期：FEndTime  (必填项)
	 计划开始日期：FStartTime  (必填项)
	 预算费用：FBudget 
	 审核后立即执行：FAutoStart 
	 预计收入：FForcastRevenue 
	 到期自动结束：FAutoEnd 
	 活动目标：FActivityGoal  (必填项)
	 活动主题：FActivityTitle  (必填项)
	 营销组织：FSaleOrgId 
	 营销部门：FSALEDEPTID 
	 营销人员：FBEmpID 
目标客户联系人：FEntity 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRM_MAR_MarketActivity","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FActivityType":{"FNumber":""},"FEndTime":"1900-01-01","FStartTime":"1900-01-01","FActivityTitle":"","FActivityGoal":"","FBudget":0,"FForcastRevenue":0,"FAutoStart":"false","FAutoEnd":"false","FPotentialCustCount":0,"FPotentialOppCount":0,"FPotentialClueCount":0,"FTransferdCustCount":0,"FForcastDealAmount":0,"FActDealAmount":0,"FClueRate":0,"FContent":"","FSaleOrgId":{"FNumber":""},"FSALEDEPTID":{"FNUMBER":""},"FBEmpID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FContact":{"FNUMBER":""}}],"FCRMAllocation":[{"FCooperationType":"","FEmployee":{"FSTAFFNUMBER":""},"FDept":{"FNUMBER":""},"FRead":"false","FModify":"false","FDelete":"false","FAllocation":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRM_MAR_MarketActivity","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CRM_MAR_MarketActivity","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CRM_MAR_MarketActivity","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CRM_MAR_MarketActivity","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CRM_MAR_MarketActivity","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CRM_MAR_MarketActivity","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRM_MAR_MarketActivity"}");

# 自定义分摊规则 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 自定义分摊规则
...
client.Delete("AM_EXPALLOCATIONSTANDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_EXPALLOCATIONSTANDAR","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_EXPALLOCATIONSTANDAR","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FAMBOOKID":{"FNUMBER":""},"FCOMPOSITENAME":"","FCOMPOSITEFORMULAIN":"","FFORBIDDATE":"1900-01-01","FAUDITORID":{"FUserID":""},"FAUDITDATE":"1900-01-01","FFORBIDDERID":{"FUserID":""},"FGETWEIGHTSCLASS":"","FISSYSPRESET":"false","FAllocationType":"","FDataFromType":"","FCOMPOSITEFORMULA":"","FFLEXITEMID":{"FNUMBER":""},"FSRCFLEXITEMID":{"FNUMBER":""},"FFLEXFILTER":"","FFLEXFILTERIN":0,"FFLEXFILTERDESC":"","FFLEXFILTERNO":"","FAbsValue":"false"}}");
...
单据头：FBillHead 
	 ...
	 描述：FDescription 
	 经营账簿：FAMBOOKID 
	 公式描述：FCOMPOSITENAME  (必填项)
	 分摊公式：FCOMPOSITEFORMULAIN  (必填项)
	 禁用日期：FFORBIDDATE 
	 审核人：FAUDITORID 
	 审核日期：FAUDITDATE 
	 禁用用户：FFORBIDDERID 
	 配置实现类：FGETWEIGHTSCLASS 
	 系统预置：FISSYSPRESET 
	 分摊规则：FAllocationType  (必填项)
	 取数类型：FDataFromType 
	 交易类型：FTransactionType 
	 分摊公式存储：FCOMPOSITEFORMULA 
	 分摊核算维度：FFLEXITEMID 
	 费用来源核算维度：FSRCFLEXITEMID 
	 分摊核算维度范围：FFLEXFILTER 
	 分摊核算维度范围内码：FFLEXFILTERIN 
	 分摊核算维度范围多语言：FFLEXFILTERDESC 
	 分摊核算维度编码：FFLEXFILTERNO 
	 分摊权重取值为负数转为正数参与分摊：FAbsValue 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_EXPALLOCATIONSTANDAR","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FAMBOOKID":{"FNUMBER":""},"FCOMPOSITENAME":"","FCOMPOSITEFORMULAIN":"","FFORBIDDATE":"1900-01-01","FAUDITORID":{"FUserID":""},"FAUDITDATE":"1900-01-01","FFORBIDDERID":{"FUserID":""},"FGETWEIGHTSCLASS":"","FISSYSPRESET":"false","FAllocationType":"","FDataFromType":"","FCOMPOSITEFORMULA":"","FFLEXITEMID":{"FNUMBER":""},"FSRCFLEXITEMID":{"FNUMBER":""},"FFLEXFILTER":"","FFLEXFILTERIN":0,"FFLEXFILTERDESC":"","FFLEXFILTERNO":"","FAbsValue":"false"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_EXPALLOCATIONSTANDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_EXPALLOCATIONSTANDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AM_EXPALLOCATIONSTANDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_EXPALLOCATIONSTANDAR","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_EXPALLOCATIONSTANDAR","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_EXPALLOCATIONSTANDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AM_EXPALLOCATIONSTANDAR","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AM_EXPALLOCATIONSTANDAR"}");

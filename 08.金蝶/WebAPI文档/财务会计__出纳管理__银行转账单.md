# 银行转账单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 银行转账单
...
client.Delete("CN_BANKTRANSBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_BANKTRANSBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FDATE":"1900-01-01","FCOMMENT":"","FScanPoint":{"FNUMBER":""},"FPAYORGID":{"FNumber":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FTOBANKID":{"FNumber":""},"FTOBANKACNTID":{"FNumber":""},"FFROMBANKID":{"FNumber":""},"FFROMBANKACNTID":{"FNumber":""},"FINCURRENCYID":{"FNumber":""},"FAmount":0,"FTOTALAMOUNT":0,"FOUTCURRENCYID":{"FNumber":""},"FINSETTLENO":"","FSETTLENO":"","FEXPLANATION":"","FFEE":0,"FRECEIVEFEE":0,"FINEXCHANGERATE":0,"FOUTEXCHANGERATE":0,"FRECEIVEFEELOC":0,"FPOSTDATE":"1900-01-01","FRuZhangType":"","FSignature":""}]}}");
...
银行转账单明细：FEntity 
	 实体主键：FEntryID 
	 转出银行：FFROMBANKID  (必填项)
	 转出账号：FFROMBANKACNTID  (必填项)
	 转出账户名称：FKDBPFROMBANKACNTNAME 
	 转入银行：FTOBANKID  (必填项)
	 转入账号：FTOBANKACNTID  (必填项)
	 转入账户名称：FKDBPTOBANKACNTNAME 
	 转入币别：FINCURRENCYID  (必填项)
	 转入金额：FAmount 
	 付款方手续费：FFEE 
	 转出金额：FTOTALAMOUNT 
	 转出结算号：FSETTLENO 
	 摘要：FEXPLANATION  (必填项)
	 转出币别：FOUTCURRENCYID  (必填项)
	 转入勾对：FINBLEND 
	 转出勾对：FOUTBLEND 
	 ...
	 银行处理状态：FBankStatus 
	 转入汇率：FINEXCHANGERATE 
	 转出汇率：FOUTEXCHANGERATE 
	 转入金额本位币：FAMOUNTLOC 
	 付款方手续费本位币：FFEELOC 
	 转出金额本位币：FTOTALAMOUNTLOC 
	 登账日期：FPOSTDATE  (必填项)
	 是否登账：FISPOST 
	 转入结算号：FINSETTLENO 
	 流水号/对账码：FCHECKCODE 
...
关联关系表：FEntity_Link 
	 ...
	 原始携带量：FEntity_Link_FTOTALAMOUNTOld 
	 修改携带量：FEntity_Link_FTOTALAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_BANKTRANSBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FDATE":"1900-01-01","FCOMMENT":"","FScanPoint":{"FNUMBER":""},"FPAYORGID":{"FNumber":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FTOBANKID":{"FNumber":""},"FTOBANKACNTID":{"FNumber":""},"FFROMBANKID":{"FNumber":""},"FFROMBANKACNTID":{"FNumber":""},"FINCURRENCYID":{"FNumber":""},"FAmount":0,"FTOTALAMOUNT":0,"FOUTCURRENCYID":{"FNumber":""},"FINSETTLENO":"","FSETTLENO":"","FEXPLANATION":"","FFEE":0,"FRECEIVEFEE":0,"FINEXCHANGERATE":0,"FOUTEXCHANGERATE":0,"FRECEIVEFEELOC":0,"FPOSTDATE":"1900-01-01","FRuZhangType":"","FSignature":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_BANKTRANSBILL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_BANKTRANSBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_BANKTRANSBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_BANKTRANSBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_BANKTRANSBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CN_BANKTRANSBILL","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BANKTRANSBILL","Cancle","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BANKTRANSBILL","Synchronism","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FDATE":"1900-01-01","FCOMMENT":"","FScanPoint":{"FNUMBER":""},"FPAYORGID":{"FNumber":""},"FMAINBOOKID":{"FNUMBER":""},"FEXCHANGETYPE":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FTOBANKID":{"FNumber":""},"FTOBANKACNTID":{"FNumber":""},"FFROMBANKID":{"FNumber":""},"FFROMBANKACNTID":{"FNumber":""},"FINCURRENCYID":{"FNumber":""},"FAmount":0,"FTOTALAMOUNT":0,"FOUTCURRENCYID":{"FNumber":""},"FINSETTLENO":"","FSETTLENO":"","FEXPLANATION":"","FFEE":0,"FRECEIVEFEE":0,"FINEXCHANGERATE":0,"FOUTEXCHANGERATE":0,"FRECEIVEFEELOC":0,"FPOSTDATE":"1900-01-01","FRuZhangType":"","FSignature":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_BANKTRANSBILL","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_BANKTRANSBILL"}");

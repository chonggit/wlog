...
client.Delete("BAS_MSGTEMPLATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BAS_MSGTEMPLATE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BAS_MSGTEMPLATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FType":"","FObjectId":{"FID":""},"FSubSystem":"","FIsSysPreset":"false","FKeyWord":"","FSubHeadWarnNewsEntity":{"FEntryId":"","FWarnNewsType":"","FWarnNewsTitle":"","FWarnNewContent":"","FWarnNewEntityKey":""},"FSubHeadOperateNewsEntity":{"FEntryId":"","FOperateNewsType":"","FOperateNewsTitle":"","FOperateNewContent":"","FOperateNewsLinkUrl":"","FOperateShowFormLinkUrl":"","FOperateBannerContent":"","FOperateBannerLinkUrl":"","FOperateFuncContent":"","FOperateFuncLinkUrl":"","FOperateNewEntityKey":""},"FSubHeadBusNoticeEntity":{"FEntryId":"","FBusNoticeType":"","FBusNoticeTitle":"","FBusNoticeContent":"","FBusNoticeEntityKey":""},"FSubHeadPublicNewsEntity":{"FEntryId":"","FPublicNewsTitle":"","FPublicNewsContent":"","FPublicNewsLinkUrl":""},"FSubHeadMsgEntity":{"FEntryId":"","FMsgContent":""},"FSubHeadMailEntity":{"FEntryId":"","FMailTitle":"","FMailContent":"","FMailType":"","FMailEntityKey":""},"FSubHeadLightAppEntity":{"FEntryId":"","FLightAppStyle":"","FLightAppTitle":"","FLightAppContent":"","FLightAppLinkUrl":"","FLightAppEntityKey":""},"FMailEntryEntity":[{"FEntryId":"","FFieldId":{"FNUMBER":""},"FMailSumType":"","FMailColumnWidth":""}],"FLightAppEntryEntity":[{"FEntryId":"","FLightAppFieldId":{"FNUMBER":""},"FLightAppSumType":"","FLightAppColumnWidth":""}],"FWarnNewEntryEntity":[{"FEntryId":"","FWarnNewFieldId":{"FNUMBER":""},"FWarnNewSumType":"","FWarnNewColumnWidth":""}],"FBusNoticeEntryEntity":[{"FEntryId":"","FBusNoticeFieldId":{"FNUMBER":""},"FBusNoticeSumType":"","FBusNoticeColumnWidth":""}],"FOperateEntryEntity":[{"FEntryId":"","FOperateFieldId":{"FNUMBER":""},"FOperateSumType":"","FOperateColumnWidth":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FSubHeadOperateNewsEntity": {
            "FEntryId": "",
            "FOperateNewsType": "",
            "FOperateNewsTitle": "",
            "FOperateNewContent": "",
            "FOperateNewsLinkUrl": "",
            "FOperateShowFormLinkUrl": "",
            "FOperateBannerContent": "",
            "FOperateBannerLinkUrl": "",
            "FOperateFuncContent": "",
            "FOperateFuncLinkUrl": "",
            "FOperateNewEntityKey": ""
        },
        "FSubHeadBusNoticeEntity": {
            "FEntryId": "",
            "FBusNoticeType": "",
            "FBusNoticeTitle": "",
            "FBusNoticeContent": "",
...
单据头：FBillHead 
	 ...
	 系统预设：FIsSysPreset 
	 关键字：FKeyWord 
预警消息中心子单据头：FSubHeadWarnNewsEntity 
	 实体主键：FEntryId 
	 预警消息样式：FWarnNewsType 
	 内容：FWarnNewContent 
	 标题：FWarnNewsTitle 
	 业务对象实体key(预警)：FWarnNewEntityKey 
运营消息中心子单据头：FSubHeadOperateNewsEntity 
	 实体主键：FEntryId 
	 运营方式：FOperateNewsType 
	 标题：FOperateNewsTitle 
	 内容：FOperateNewContent 
	 链接地址：FOperateNewsLinkUrl 
	 链接地址：FOperateShowFormLinkUrl 
	 内容：FOperateBannerContent 
	 链接地址：FOperateBannerLinkUrl 
	 图片(数据库)：FOperateShowFormImage 
	 内容：FOperateFuncContent 
	 链接地址：FOperateFuncLinkUrl 
	 业务对象实体key(运营)：FOperateNewEntityKey 
业务通知消息中心子单据头：FSubHeadBusNoticeEntity 
	 实体主键：FEntryId 
	 标题：FBusNoticeTitle 
	 内容：FBusNoticeContent 
	 通知消息样式：FBusNoticeType 
	 业务对象实体key(业务)：FBusNoticeEntityKey 
公告消息中心子单据头：FSubHeadPublicNewsEntity 
	 实体主键：FEntryId 
	 公告内容：FPublicNewsContent 
	 公告标题：FPublicNewsTitle 
	 链接地址：FPublicNewsLinkUrl 
短信子单据头：FSubHeadMsgEntity 
	 实体主键：FEntryId 
	 第三方消息内容：FMsgContent 
邮件子单据头：FSubHeadMailEntity 
	 实体主键：FEntryId 
	 邮件标题：FMailTitle 
	 邮件内容：FMailContent 
	 邮件样式：FMailType 
	 业务对象实体key(邮件)：FMailEntityKey 
轻应用消息子单据头：FSubHeadLightAppEntity 
	 实体主键：FEntryId 
	 通知消息样式：FLightAppStyle 
	 标题：FLightAppTitle 
	 内容：FLightAppContent 
	 链接地址：FLightAppLinkUrl 
	 业务对象实体key(轻应用)：FLightAppEntityKey 
单据体：FMailEntryEntity 
	 实体主键：FEntryId 
	 列宽：FMailColumnWidth 
	 汇总方式：FMailSumType 
	 字段名：FFieldId 
单据体：FLightAppEntryEntity 
	 实体主键：FEntryId 
	 字段名：FLightAppFieldId 
	 汇总方式：FLightAppSumType 
	 列宽：FLightAppColumnWidth 
单据体：FWarnNewEntryEntity 
	 实体主键：FEntryId 
	 字段名：FWarnNewFieldId 
	 汇总方式：FWarnNewSumType 
	 列宽：FWarnNewColumnWidth 
单据体：FBusNoticeEntryEntity 
	 实体主键：FEntryId 
	 字段名：FBusNoticeFieldId 
	 汇总方式：FBusNoticeSumType 
	 列宽：FBusNoticeColumnWidth 
单据体：FOperateEntryEntity 
	 实体主键：FEntryId 
	 字段名：FOperateFieldId 
	 汇总方式：FOperateSumType 
	 列宽：FOperateColumnWidth 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BAS_MSGTEMPLATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FType":"","FObjectId":{"FID":""},"FSubSystem":"","FIsSysPreset":"false","FKeyWord":"","FSubHeadWarnNewsEntity":{"FEntryId":"","FWarnNewsType":"","FWarnNewsTitle":"","FWarnNewContent":"","FWarnNewEntityKey":""},"FSubHeadOperateNewsEntity":{"FEntryId":"","FOperateNewsType":"","FOperateNewsTitle":"","FOperateNewContent":"","FOperateNewsLinkUrl":"","FOperateShowFormLinkUrl":"","FOperateBannerContent":"","FOperateBannerLinkUrl":"","FOperateFuncContent":"","FOperateFuncLinkUrl":"","FOperateNewEntityKey":""},"FSubHeadBusNoticeEntity":{"FEntryId":"","FBusNoticeType":"","FBusNoticeTitle":"","FBusNoticeContent":"","FBusNoticeEntityKey":""},"FSubHeadPublicNewsEntity":{"FEntryId":"","FPublicNewsTitle":"","FPublicNewsContent":"","FPublicNewsLinkUrl":""},"FSubHeadMsgEntity":{"FEntryId":"","FMsgContent":""},"FSubHeadMailEntity":{"FEntryId":"","FMailTitle":"","FMailContent":"","FMailType":"","FMailEntityKey":""},"FSubHeadLightAppEntity":{"FEntryId":"","FLightAppStyle":"","FLightAppTitle":"","FLightAppContent":"","FLightAppLinkUrl":"","FLightAppEntityKey":""},"FMailEntryEntity":[{"FEntryId":"","FFieldId":{"FNUMBER":""},"FMailSumType":"","FMailColumnWidth":""}],"FLightAppEntryEntity":[{"FEntryId":"","FLightAppFieldId":{"FNUMBER":""},"FLightAppSumType":"","FLightAppColumnWidth":""}],"FWarnNewEntryEntity":[{"FEntryId":"","FWarnNewFieldId":{"FNUMBER":""},"FWarnNewSumType":"","FWarnNewColumnWidth":""}],"FBusNoticeEntryEntity":[{"FEntryId":"","FBusNoticeFieldId":{"FNUMBER":""},"FBusNoticeSumType":"","FBusNoticeColumnWidth":""}],"FOperateEntryEntity":[{"FEntryId":"","FOperateFieldId":{"FNUMBER":""},"FOperateSumType":"","FOperateColumnWidth":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BAS_MSGTEMPLATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BAS_MSGTEMPLATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BAS_MSGTEMPLATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_MSGTEMPLATE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_MSGTEMPLATE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BAS_MSGTEMPLATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BAS_MSGTEMPLATE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BAS_MSGTEMPLATE"}");

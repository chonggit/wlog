# 经营账户余额表 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 经营账户余额表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2774 |
...
client.GetSysReportData("AM_AMBBalance","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAccountBookH":{"FNUMBER":""},"FSTARTPERIODH":"","FENDPERIODH":"","FAMEBAUNITH":[{"FNumber":""}],"FAccountH":[{"FNumber":""}],"FProfitCenterH":[{"FNumber":""}],"FINCLUDECOLLACTION":"false","FORGSTRUCTUREID":{"FNUMBER":""}}}");

# 字段自动携带设置 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 字段自动携带设置
...
client.Delete("FA_CUSTFIELDCARRYSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_CUSTFIELDCARRYSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNAME":"","FRemarks":"","FSOURCESUBSYSID":"","FSOURCEBILL":"","FTARGETSUBSYSID":"","FTARGETBILL":"","FOPERATE":"","FOPERATEBILL":"","FCARRYSCHEMEENTRY":[{"FEntryID":0,"FSOURCEOBJ":"","FTARGETOBJ":"","FSOURCEFIELD":"","FTARGEFIELD":"","FCONDITIONTYPE":"","FSFTINFO":"","FTFTINFO":"","FCARRYSCHEMESUBENTRY":[{"FDetailID":0,"FSCFIELD":"","FTCFIELD":"","FSCFTINFO":"","FTCFTINFO":""}]}]}}");
...
单据头：FBillHead 
	 ...
	 方案名称：FNAME  (必填项)
	 描述：FRemarks 
	 源单子系统：FSOURCESUBSYSID  (必填项)
	 源单：FSOURCEBILL  (必填项)
	 目标单子系统：FTARGETSUBSYSID  (必填项)
	 目标单：FTARGETBILL  (必填项)
	 触发操作：FOPERATE  (必填项)
	 触发单据：FOPERATEBILL  (必填项)
单据体：FCARRYSCHEMEENTRY 
	 实体主键：FEntryID 
	 源单对象：FSOURCEOBJ  (必填项)
	 目标对象：FTARGETOBJ  (必填项)
	 源单字段：FSOURCEFIELD  (必填项)
	 目标字段：FTARGEFIELD  (必填项)
	 匹配方式：FCONDITIONTYPE  (必填项)
	 源单字段表关联信息：FSFTINFO 
	 目标单字段表关联信息：FTFTINFO 
子单据体：FCARRYSCHEMESUBENTRY 
	 实体主键：FDetailID 
	 源单字段：FSCFIELD 
	 目标单字段：FTCFIELD 
	 源单字段表关联信息：FSCFTINFO 
	 目标单字段表关联信息：FTCFTINFO 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_CUSTFIELDCARRYSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNAME":"","FRemarks":"","FSOURCESUBSYSID":"","FSOURCEBILL":"","FTARGETSUBSYSID":"","FTARGETBILL":"","FOPERATE":"","FOPERATEBILL":"","FCARRYSCHEMEENTRY":[{"FEntryID":0,"FSOURCEOBJ":"","FTARGETOBJ":"","FSOURCEFIELD":"","FTARGEFIELD":"","FCONDITIONTYPE":"","FSFTINFO":"","FTFTINFO":"","FCARRYSCHEMESUBENTRY":[{"FDetailID":0,"FSCFIELD":"","FTCFIELD":"","FSCFTINFO":"","FTCFTINFO":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_CUSTFIELDCARRYSCHEME","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_CUSTFIELDCARRYSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_CUSTFIELDCARRYSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_CUSTFIELDCARRYSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("FA_CUSTFIELDCARRYSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("FA_CUSTFIELDCARRYSCHEME","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("FA_CUSTFIELDCARRYSCHEME","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_CUSTFIELDCARRYSCHEME","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_CUSTFIELDCARRYSCHEME"}");

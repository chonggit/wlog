# 设备点值业务归档 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 设备点值业务归档
...
client.Delete("SFC_MeterGatherHistoryQuery","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SFC_MeterGatherHistoryQuery","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPrdOrgId":{"FNumber":""},"FMoNo":"","FPrdTrackNo":"","FSerialNo":"","FDescription":"","FMaterialId":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FProductLine":{"FNUMBER":""},"FEquipmentId":{"FNUMBER":""},"FOptPlanNo":"","FSeqNumber":"","FOperNumber":0,"FOperDescription":"","FProcessId":{"FNUMBER":""},"FGatherNo":"","FGatherTime":"1900-01-01","FGatherValue":"","FMeterUnitName":"","FProcessType":"","FProjName":"","FProComplete":"false","FProCompleteReason":"","FSourceMeterGatherId":0,"FSourceCreateDate":"1900-01-01","FDITaskHistoryDataId":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FProComplete": "false",
                "FProCompleteReason": "",
                "FSourceMeterGatherId": 0,
                "FSourceCreateDate": "1900-01-01",
                "FDITaskHistoryDataId": 0
            }
        ]
    }
}
...
单据体：FEntity 
	 ...
	 处理类型：FProcessType 
	 工程名称：FProjName 
	 处理完成原因：FProCompleteReason 
	 原始仪表值ID：FSourceMeterGatherId 
	 工序号：FOperNumber 
	 工序说明：FOperDescription 
	 处理完成标记：FProComplete 
	 原始创建时间：FSourceCreateDate 
	 任务历史表ID：FDITaskHistoryDataId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SFC_MeterGatherHistoryQuery","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPrdOrgId":{"FNumber":""},"FMoNo":"","FPrdTrackNo":"","FSerialNo":"","FDescription":"","FMaterialId":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FProductLine":{"FNUMBER":""},"FEquipmentId":{"FNUMBER":""},"FOptPlanNo":"","FSeqNumber":"","FOperNumber":0,"FOperDescription":"","FProcessId":{"FNUMBER":""},"FGatherNo":"","FGatherTime":"1900-01-01","FGatherValue":"","FMeterUnitName":"","FProcessType":"","FProjName":"","FProComplete":"false","FProCompleteReason":"","FSourceMeterGatherId":0,"FSourceCreateDate":"1900-01-01","FDITaskHistoryDataId":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SFC_MeterGatherHistoryQuery","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SFC_MeterGatherHistoryQuery","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SFC_MeterGatherHistoryQuery","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SFC_MeterGatherHistoryQuery","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SFC_MeterGatherHistoryQuery","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("SFC_MeterGatherHistoryQuery","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_MeterGatherHistoryQuery","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SFC_MeterGatherHistoryQuery","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SFC_MeterGatherHistoryQuery"}");

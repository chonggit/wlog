...
client.Delete("AM_ReportStyle","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_ReportStyle","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_ReportStyle","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FDescription":"","FName":"","FAMBOOKID":{"FNUMBER":""},"FCOLUMNTYPE":"","FROWTYPE":"","FCTName":"","FColumnEntity":[{"FEntryID":0,"FColumnID":"","FPARENTCOLUMNID":"","FCOLUMNLAYER":0,"FCOLUMNSIGN":"","FCOLUMNPROPERTY":"","FCOLUMNNAME":"","FColumnDemSource":{"FNUMBER":""},"FCOLUMNFORMULA":"","FCOLUMNFORMULADESC":"","FCOLUMNFORMULAIN":"","FREPORTSTYLETEXT":"","FREPORTSTYLETEXTDESC":"","FREPORTSTYLETEXTIN":"","FISCOLUMNHIDDEN":"false","FCOLUMNSEQUENCE":0}],"FRowEntity":[{"FEntryID":0,"FROWID":"","FPARENTROWID":"","FROWLAYER":0,"FROWSIGN":"","FROWPROPERTY":"","FROWNAME":"","FRowDemSource":{"FNUMBER":""},"FROWFORMULA":"","FROWFORMULADESC":"","FROWFORMULAIN":"","FISROWHIDDEN":"false","FRREPORTSTYLETEXT":"","FROWSEQUENCE":0,"FRREPORTSTYLETEXTIN":"","FRREPORTSTYLETEXTDESC":"","FSPECIFIEDCOLUMN":""}]}}");
        ...
        "FColumnEntity": [
            {
                ...
                "FCOLUMNFORMULAIN": "",
                "FREPORTSTYLETEXT": "",
                "FREPORTSTYLETEXTDESC": "",
                "FREPORTSTYLETEXTIN": "",
                "FISCOLUMNHIDDEN": "false",
                "FCOLUMNSEQUENCE": 0
            }
        ],
        "FRowEntity": [
...
单据头：FBillHead 
	 ...
	 行设置：FROWTYPE  (必填项)
	 云模板名称：FCTName 
列设置单据体：FColumnEntity 
	 实体主键：FEntryID 
	 ID：FColumnID 
	 父级内码：FPARENTCOLUMNID 
	 列名称：FCOLUMNNAME  (必填项)
	 维度来源：FColumnDemSource 
	 列属性：FCOLUMNPROPERTY  (必填项)
	 取数公式：FCOLUMNFORMULADESC 
	 隐藏列：FISCOLUMNHIDDEN 
	 取数公式：FCOLUMNFORMULAIN 
	 取数公式：FCOLUMNFORMULA 
	 列标识：FCOLUMNSIGN 
	 列层级：FCOLUMNLAYER 
	 序列：FCOLUMNSEQUENCE 
	 样式设置：FREPORTSTYLETEXT 
	 样式设置多语言：FREPORTSTYLETEXTDESC 
	 样式设置公式：FREPORTSTYLETEXTIN 
行设置单据体：FRowEntity 
	 实体主键：FEntryID 
	 ID：FROWID 
	 父级内码：FPARENTROWID 
	 行属性：FROWPROPERTY  (必填项)
	 行名称：FROWNAME  (必填项)
	 维度来源：FRowDemSource 
	 取数公式：FROWFORMULADESC 
	 隐藏行：FISROWHIDDEN 
	 取数公式：FROWFORMULAIN 
	 取数公式：FROWFORMULA 
	 行标识：FROWSIGN 
	 行层级：FROWLAYER 
	 序列：FROWSEQUENCE 
	 样式设置：FRREPORTSTYLETEXT 
	 样式设置公式：FRREPORTSTYLETEXTIN 
	 样式设置多语言：FRREPORTSTYLETEXTDESC 
	 优先列取数：FSPECIFIEDCOLUMN 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_ReportStyle","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FDescription":"","FName":"","FAMBOOKID":{"FNUMBER":""},"FCOLUMNTYPE":"","FROWTYPE":"","FCTName":"","FColumnEntity":[{"FEntryID":0,"FColumnID":"","FPARENTCOLUMNID":"","FCOLUMNLAYER":0,"FCOLUMNSIGN":"","FCOLUMNPROPERTY":"","FCOLUMNNAME":"","FColumnDemSource":{"FNUMBER":""},"FCOLUMNFORMULA":"","FCOLUMNFORMULADESC":"","FCOLUMNFORMULAIN":"","FREPORTSTYLETEXT":"","FREPORTSTYLETEXTDESC":"","FREPORTSTYLETEXTIN":"","FISCOLUMNHIDDEN":"false","FCOLUMNSEQUENCE":0}],"FRowEntity":[{"FEntryID":0,"FROWID":"","FPARENTROWID":"","FROWLAYER":0,"FROWSIGN":"","FROWPROPERTY":"","FROWNAME":"","FRowDemSource":{"FNUMBER":""},"FROWFORMULA":"","FROWFORMULADESC":"","FROWFORMULAIN":"","FISROWHIDDEN":"false","FRREPORTSTYLETEXT":"","FROWSEQUENCE":0,"FRREPORTSTYLETEXTIN":"","FRREPORTSTYLETEXTDESC":"","FSPECIFIEDCOLUMN":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_ReportStyle","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_ReportStyle","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AM_ReportStyle","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_ReportStyle","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_ReportStyle","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_ReportStyle","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AM_ReportStyle"}");

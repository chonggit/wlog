# BBC自动审单规则 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > B2B电商中心 > BBC自动审单规则
...
client.Save("CP_BBCAutoAuditRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FRuleName":"","FBillName":"","FBeginTime":"1900-01-01","FEndTime":"1900-01-01","FIsSecondDay":"false","FIsPreset":"false","FIsAutoAudit":"false","FAutoBackDays":0,"FAutoAuditDays":0,"FAuditCycleType":"","FBackCycleType":"","FCustEntity":[{"FEntryID":0,"FOrgId":{"FNumber":""},"FCustId":{"FNUMBER":""},"FIsEnable":"false"}],"FMGEntity":[{"FEntryID":0,"FMaterialGroupId":{"FNumber":""},"FMaterialId":{"FNUMBER":""},"FMatMasterId":0}],"FMGDetailEntity":[{"FEntryID":0,"FDetailMaterialGroupId":{"FNumber":""}}]}}");
...
单据头：FBillHead 
	 ...
	 名称：FRuleName 
	 单据：FBillName 
	 开始审单时间：FBeginTime  (必填项)
	 结束审单时间：FEndTime  (必填项)
	 第2天：FIsSecondDay 
	 系统预设：FIsPreset 
	 单据类型：FBillType 
	 信用余额状态为不检查支持自动审批：FIsAutoAudit 
	 自动打回超过周期未审核的订单：：FAutoBackDays 
	 自动审核周期内提交的订单：：FAutoAuditDays 
	 审核周期类型：FAuditCycleType 
	 自动打回周期类型：FBackCycleType 
不参与自动审单的客户：FCustEntity 
	 实体主键：FEntryID 
	 组织编码：FOrgId 
	 客户编码：FCustId 
	 组织名称：FOrgName 
	 客户名称：FCustName 
	 启用：FIsEnable 
不参与自动审单物料范围：FMGEntity 
	 实体主键：FEntryID 
	 物料分组：FMaterialGroupId 
	 物料编码：FMaterialId 
	 物料名称：FMaterialName 
	 物料内码：FMatMasterId 
不参与自动审单物料分组明细：FMGDetailEntity 
	 实体主键：FEntryID 
	 物料分组：FDetailMaterialGroupId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CP_BBCAutoAuditRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CP_BBCAutoAuditRule","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CP_BBCAutoAuditRule"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("CP_BBCAutoAuditRule","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("CP_BBCAutoAuditRule","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("CP_BBCAutoAuditRule","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

# 经营单元结算折扣表 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 经营单元结算折扣表
...
client.Delete("AM_SettleDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_SettleDiscount","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_SettleDiscount","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FCurrencyId":{"FNumber":""},"FEffectiveDate":"1900-01-01","FExpiryDate":"1900-01-01","FDescription":"","FName":"","FForbidDate":"1900-01-01","FORGIDSYSTEID":{"FNUMBER":""},"FSELLER":{"FNUMBER":""},"FDiscountObject":"","FSETTLEDISCOUNTENTRY":[{"FEntryID":0,"FMATERIALID":{"FNUMBER":""},"FMaterialGroupId":{"FNUMBER":""},"FDiscountType":"","FUNITID":{"FNumber":""},"FCALCULATEMETHOD":"","FDiscountRate":0,"FCalculateFormula":"","FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FEntryForbiderId":{"FUserID":""},"FDiscountDescrip":""}],"FEntityBuyEr":[{"FPKID":0,"FBUYER2":{"FNUMBER":""}}]}}");
...
基本信息：FBillHead 
	 ...
	 失效人：FForbiderId 
	 禁用日期：FForbidDate 
	 经营组织架构：FORGIDSYSTEID  (必填项)
	 折扣对象：FDiscountObject  (必填项)
折扣明细：FSETTLEDISCOUNTENTRY 
	 实体主键：FEntryID 
	 物料：FMATERIALID 
	 物料名称：FMaterialName 
	 规格型号：FMaterialModel 
	 ...
	 行失效状态：FEntryForbidStatus 
	 业务失效人：FEntryForbiderId 
	 业务失效日期：FEntryForbidDate 
	 折扣类型：FDiscountType  (必填项)
	 计算方式：FCALCULATEMETHOD  (必填项)
	 折扣率(%)：FDiscountRate 
	 折后价计算公式：FCalculateFormula  (必填项)
	 折扣描述：FDiscountDescrip 
	 物料分组编码：FMaterialGroupId 
	 物料分组名称：FMaterialGroupName 
买方经营单元：FEntityBuyEr 
	 实体主键：FPKID 
	 经营单元：FBUYER2 
	 经营单元名称：FBaseProperty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_SettleDiscount","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FCurrencyId":{"FNumber":""},"FEffectiveDate":"1900-01-01","FExpiryDate":"1900-01-01","FDescription":"","FName":"","FForbidDate":"1900-01-01","FORGIDSYSTEID":{"FNUMBER":""},"FSELLER":{"FNUMBER":""},"FDiscountObject":"","FSETTLEDISCOUNTENTRY":[{"FEntryID":0,"FMATERIALID":{"FNUMBER":""},"FMaterialGroupId":{"FNUMBER":""},"FDiscountType":"","FUNITID":{"FNumber":""},"FCALCULATEMETHOD":"","FDiscountRate":0,"FCalculateFormula":"","FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FEntryForbiderId":{"FUserID":""},"FDiscountDescrip":""}],"FEntityBuyEr":[{"FPKID":0,"FBUYER2":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_SettleDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_SettleDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AM_SettleDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_SettleDiscount","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_SettleDiscount","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_SettleDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_SettleDiscount","Effective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_SettleDiscount","UnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AM_SettleDiscount"}");

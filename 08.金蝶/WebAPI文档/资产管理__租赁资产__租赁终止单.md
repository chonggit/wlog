# 租赁终止单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 租赁资产 > 租赁终止单
...
client.Delete("FA_LEASETERMINATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_LEASETERMINATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAssetOrgID":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FBUSDATE":"1900-01-01","FREMARKS":"","FLOCALCURRID":{"FNUMBER":""},"FDISPOSALNO":"","FDISPOSALID":0,"FLEASEIN":[{"FEntryID":0,"FISCREATELEASEIN":"false","FLEASEINNO":{"FNumber":""},"FCARDNO":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FLEASELIABILITYBAL":0,"FNOTFINANCIALCHARGESBAL":0,"FLEASELIABILITYBB":0,"FNOTFINANCIALCHARGESBB":0}]}}");
        ...
        "FLEASEIN": [
            {
                ...
                "FLEASELIABILITYBAL": 0,
                "FNOTFINANCIALCHARGESBAL": 0,
                "FLEASELIABILITYBB": 0,
                "FNOTFINANCIALCHARGESBB": 0
            }
        ]
    }
}
...
明细：FLEASEIN 
	 ...
	 租赁结束日期：FENDDATE 
	 卡片编码：FCARDNO 
	 租赁负债（余额）：FLEASELIABILITYBAL 
	 未确认融资费（余额）：FNOTFINANCIALCHARGESBAL 
	 租赁负债（余额）（本位币）：FLEASELIABILITYBB 
	 未确认融资费用（余额）（本位币）：FNOTFINANCIALCHARGESBB 
	 币别：FCURRENCYID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_LEASETERMINATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAssetOrgID":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FBUSDATE":"1900-01-01","FREMARKS":"","FLOCALCURRID":{"FNUMBER":""},"FDISPOSALNO":"","FDISPOSALID":0,"FLEASEIN":[{"FEntryID":0,"FISCREATELEASEIN":"false","FLEASEINNO":{"FNumber":""},"FCARDNO":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FLEASELIABILITYBAL":0,"FNOTFINANCIALCHARGESBAL":0,"FLEASELIABILITYBB":0,"FNOTFINANCIALCHARGESBB":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_LEASETERMINATE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_LEASETERMINATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_LEASETERMINATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_LEASETERMINATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_LEASETERMINATE","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_LEASETERMINATE"}");

# 任务质量明细表 Web API 操作原始内容

> 来源页面：全部 > 共享服务中心 > 任务共享中心 > 任务质量明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2459 |
...
client.GetSysReportData("ASC_QualityDetailRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FShareCenter":[{"FNumber":""}],"FProcTemplate":[{"FNumber":""}],"FReceiver":[{"FUserAccount":""}],"FResult":"","FBeginDate":"1900-01-01","FEndDate":"1900-01-01"}}");

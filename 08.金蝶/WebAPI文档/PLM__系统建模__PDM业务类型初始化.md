# PDM业务类型初始化 Web API 操作原始内容

> 来源页面：全部 > PLM > 系统建模 > PDM业务类型初始化
...
client.Save("PLM_CFG_CATEGORYIMPORT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCode":"","FName":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FTypeID":{"FName":""},"FParentID":{"FCode":""},"FRuleId":{"FName":""},"FLifecycleTemplate":{"FCode":""},"FDefaultAttFolder":{"FCODE":""},"FMajorStruct":{"FName":""},"FSeparate":"","FMinorStruct":{"FName":""},"FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FCBInstance":"false","FIsJoinThinkTank":"false","FCBMulInstance":"false","FIsEnableForm":"false","FIsRelationType":"false","FPermissionObjectName":"","FPermissionObjectId":"","FEnableLink":"false","FSelfMadeProcessEnabled":"false","FIntegrityEntity":[{"FEntryID":0,"FBaseIntegrity":{"FCode":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FCBInstance": "false",
        "FIsJoinThinkTank": "false",
        "FCBMulInstance": "false",
        "FIsEnableForm": "false",
        "FIsRelationType": "false",
        "FPermissionObjectName": "",
        "FPermissionObjectId": "",
        "FEnableLink": "false",
        "FSelfMadeProcessEnabled": "false",
        "FIntegrityEntity": [
            {
                "FEntryID": 0,
                "FBaseIntegrity": {
...
PDM业务类型：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 图标：FImageIcon 
	 允许在当层业务类型下创建具体的实例：FCBInstance 
	 允许在该业务类型下创建多个实例：FCBMulInstance 
	 允许通过物料申请单来创建物料：FIsEnableForm 
	 定义为关系对象：FIsRelationType 
	 权限对象名称：FPermissionObjectName 
	 权限对象ID：FPermissionObjectId 
	 名称：FName  (必填项)
	 默认附件文件夹：FDefaultAttFolder 
	 纳入研发智库：FIsJoinThinkTank 
	 启用连接符：FEnableLink 
	 允许非自制件创建工艺路线：FSelfMadeProcessEnabled 
完整性：FIntegrityEntity 
	 实体主键：FEntryID 
	 完整性规则编码：FBaseIntegrity 
	 完整性规则名称：FBaseIntegrityName 
	 检查方式：FBaseCheckType 
	 物料生产方式：FBaseProductionMode 
	 对应转换状态：FBaseStatusName 
	 对应状态字段：FBaseMulField 
	 操作：FBaseOperationName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("PLM_CFG_CATEGORYIMPORT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLM_CFG_CATEGORYIMPORT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_CFG_CATEGORYIMPORT"}");

# 核算单据成本对比分析表 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 核算单据成本对比分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3419 |
...
client.GetSysReportData("HS_HSBillCostAnalysis","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTGSYSTEMID":{"FNUMBER":""},"FACCTGORGID":{"FNAME":""},"FACCTPOLICYID":{"FNumber":""},"FYear":"","FPeriod":"","FCompACCTGSYSTEMID":{"FNUMBER":""},"FMulCOMPACCTGORGID":[{"FNumber":""}],"FMulCompACCTPOLICYID":[{"FNumber":""}],"FSrcBillTypeId":[{"FNumber":""}],"FBILLNO":"","FENDBILLNO":"","FCompAcctPolicyName":"","FCompACCTGORGNAME":""}}");
...
五、字段说明：
	 ...
	 核算体系名称：FCompACCTGSYSTEMNAME 
	 核算体系编码：FCompACCTGSYSTEMID  (必填项)
	 核算组织编码：FMulCOMPACCTGORGID  (必填项)
	 会计政策编码：FMulCompACCTPOLICYID  (必填项)
	 会计政策名称：FCompAcctPolicyName 
	 核算组织名称：FCompACCTGORGNAME 

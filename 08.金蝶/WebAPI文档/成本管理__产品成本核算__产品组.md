...
client.Delete("CB_PROACNTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_PROACNTGROUP","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_PROACNTGROUP","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FPRODUCTGROUPID":0,"FNumber":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FGROUPBY":"","FName":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FISENABLECPHSSET":"false","FISENABLEAUXPROPERTY":"false","FAUXPROPERTY":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FPRODUCTID":{"FNumber":""},"FINSTOCKTYPE":"","FAUXPROPERTYID":{"FAUXPROPERTYID__FF100001":{"FNumber":""},"FAUXPROPERTYID__FF100002":{"FNumber":""},"FAUXPROPERTYID__FF100003":{"FNumber":""},"FAUXPROPERTYID__FF100005":{"FNumber":""},"FAUXPROPERTYID__FF100010":{"FNumber":""},"FAUXPROPERTYID__FF100007":{"FNumber":""},"FAUXPROPERTYID__FF100008":{"FNumber":""}},"FASSAUXPROPERTYID":{"FNumber":""},"FPRODUCTTYPE":"","FALLOCATETYPE":"","FALLOCATEWEIGHT":0,"FASSAUXBASE":"","FASSAUXTEXT":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FISENABLECPHSSET": "false",
        "FISENABLEAUXPROPERTY": "false",
        "FAUXPROPERTY": {
            "FNUMBER": ""
        },
        "FEntity": [
            {
                ...
                "FINSTOCKTYPE": "",
                "FAUXPROPERTYID": {
                    "FAUXPROPERTYID__FF100001": {
                        "FNumber": ""
                    },
                    "FAUXPROPERTYID__FF100002": {
                        "FNumber": ""
                    },
                    "FAUXPROPERTYID__FF100003": {
                        "FNumber": ""
                    },
                    "FAUXPROPERTYID__FF100005": {
                        "FNumber": ""
                    },
                    "FAUXPROPERTYID__FF100010": {
                        "FNumber": ""
                    },
                    "FAUXPROPERTYID__FF100007": {
                        "FNumber": ""
                    },
                    "FAUXPROPERTYID__FF100008": {
                        "FNumber": ""
                    }
                },
                "FASSAUXPROPERTYID": {
...
单据头：FBillHead 
	 ...
	 分组依据：FGROUPBY  (必填项)
	 综合设置：FISENABLECPHSSET 
	 启用辅助属性：FISENABLEAUXPROPERTY 
	 等级品辅助属性：FAUXPROPERTY 
产品信息：FEntity 
	 实体主键：FEntryID 
	 产品编码：FPRODUCTID 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 指定辅助属性(辅助资料)：FASSAUXPROPERTYID 
	 指定辅助属性(基础资料)：FASSAUXBASE 
	 指定辅助属性(文本)：FASSAUXTEXT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CB_PROACNTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CB_PROACNTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CB_PROACNTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CB_PROACNTGROUP","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CB_PROACNTGROUP","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_PROACNTGROUP"}");

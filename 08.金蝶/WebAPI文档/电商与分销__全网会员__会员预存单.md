# 会员预存单 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 全网会员 > 会员预存单
...
client.Delete("MMC_PreDeposit_Bill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("MMC_PreDeposit_Bill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDocumentStatus":"","FMemberCardId":{"FNumber":""},"FOrderSource":"","FMember":{"FNumber":""},"FPredepositDatetime":"1900-01-01","FComment":"","FPreDepositRule":{"FNUMBER":""},"FPreDepositAccount":{"FNUMBER":""},"FPreDepositAccountScore":{"FNUMBER":""},"FPreDepositAmount":0,"FRemain":0,"FGiftAccountRemain":0,"FAwardCash":0,"FAwardScore":0,"FOrg":{"FNumber":""}}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FPredepositDatetime": "1900-01-01",
        "FComment": "",
        "FPreDepositRule": {
            "FNUMBER": ""
        },
        ...
        "FPreDepositAccountScore": {
            "FNUMBER": ""
        },
        "FPreDepositAmount": 0,
        "FRemain": 0,
        "FGiftAccountRemain": 0,
        "FAwardCash": 0,
        "FAwardScore": 0,
        "FOrg": {
            "FNumber": ""
...
单据头：FBillHead 
	 ...
	 单据编号：FBillNo 
	 卡号：FMemberCardId 
	 原始交易编码单：FOrderSource 
	 会员：FMember  (必填项)
	 预存时间：FPredepositDatetime  (必填项)
	 备注：FComment 
	 预存款规则：FPreDepositRule 
	 预存现金账户：FPreDepositAccount  (必填项)
	 数据状态：FDocumentStatus  (必填项)
	 金额：FPreDepositAmount 
	 金额：FRemain 
	 金额：FGiftAccountRemain 
	 预存积分账户：FPreDepositAccountScore  (必填项)
	 本次赠送金额：FAwardCash 
	 小数：FAwardScore 
	 预存款组织：FOrg 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("MMC_PreDeposit_Bill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDocumentStatus":"","FMemberCardId":{"FNumber":""},"FOrderSource":"","FMember":{"FNumber":""},"FPredepositDatetime":"1900-01-01","FComment":"","FPreDepositRule":{"FNUMBER":""},"FPreDepositAccount":{"FNUMBER":""},"FPreDepositAccountScore":{"FNUMBER":""},"FPreDepositAmount":0,"FRemain":0,"FGiftAccountRemain":0,"FAwardCash":0,"FAwardScore":0,"FOrg":{"FNumber":""}}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("MMC_PreDeposit_Bill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("MMC_PreDeposit_Bill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("MMC_PreDeposit_Bill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("MMC_PreDeposit_Bill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("MMC_PreDeposit_Bill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("MMC_PreDeposit_Bill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"MMC_PreDeposit_Bill"}");

# 内部应付清理单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应付款管理 > 内部应付清理单
...
client.View("AP_InnerPayClear","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AP_InnerPayClear"}");

# 智能审单规则 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > B2C电商中心 > 智能审单规则
...
client.Save("ECC_AutoAuditOrders","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillName":"","FExecuteTimeSpan":0,"FAuditOrderRange":0,"FStartTime":"1900-01-01","FEndTime":"1900-01-01","FExcuteTime":"1900-01-01","FExcuteQty":"","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FConditions":"","FConditionSql":"","FRemarks":"","FLastExcuteStatus":"","FApproverID":{"FUserID":""},"FApproverDate":"1900-01-01","FForbidID":{"FUserID":""},"FForbidDate":"1900-01-01"}}");
...
单据头：FBillHead 
	 ...
	 执行次数：FExcuteQty  (必填项)
	 下次执行时间：FExcuteTime 
	 执行时间间隔(分钟)：FExecuteTimeSpan 
	 条件脚本：FConditionSql 
	 描述：FRemarks 
	 编号：FBillNo  (必填项)
	 审单范围(分钟以内)：FAuditOrderRange 
	 审核人：FApproverID 
	 禁用用户：FForbidID 
	 审核日期：FApproverDate 
	 修改日期：FModifyDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("ECC_AutoAuditOrders","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ECC_AutoAuditOrders","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ECC_AutoAuditOrders","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ECC_AutoAuditOrders","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ECC_AutoAuditOrders","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ECC_AutoAuditOrders","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ECC_AutoAuditOrders","Disable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ECC_AutoAuditOrders","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillName":"","FExecuteTimeSpan":0,"FAuditOrderRange":0,"FStartTime":"1900-01-01","FEndTime":"1900-01-01","FExcuteTime":"1900-01-01","FExcuteQty":"","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FConditions":"","FConditionSql":"","FRemarks":"","FLastExcuteStatus":"","FApproverID":{"FUserID":""},"FApproverDate":"1900-01-01","FForbidID":{"FUserID":""},"FForbidDate":"1900-01-01"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ECC_AutoAuditOrders"}");

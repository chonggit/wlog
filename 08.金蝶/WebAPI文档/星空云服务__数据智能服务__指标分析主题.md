# 指标分析主题 Web API 操作原始内容

> 来源页面：全部 > 星空云服务 > 数据智能服务 > 指标分析主题
...
client.Delete("BDIP_TargetSubject","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BDIP_TargetSubject","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FRemarks":"","FTitle":"","FSYS":"false","FIsExecute":"false","FEntity":[{"FEntryID":0,"FArea":"","FSubArea":[{"FDetailID":0,"FTgtEntryID":{"FNUMBER":""},"FLocationRow":0,"FLocationCol":0,"FRealCardID":0,"FBaseCardNumber":"","FCardTitle":"","FDimensionSelect":"","FSuffix":""}]}],"FEntity2":[{"FEntryID":0,"FFilterCondition":"","FDimensionsType":"","FApplyOnCard":"","FSubEntity":[{"FDetailID":0,"FApplyCardID":0,"FApplyDimetion":"","FSourceTableName":""}]}]}}");
...
单据体：FEntity2 
	 实体主键：FEntryID 
	 作用到卡片：FApplyOnCard 
	 过滤条件名称：FFilterCondition 
	 维度类型：FDimensionsType  (必填项)
子单据体：FSubEntity 
	 实体主键：FDetailID 
	 维度：FApplyDimetion 
	 宽表名：FSourceTableName 
	 卡片ID：FApplyCardID 
卡片设置：FSubArea 
	 实体主键：FDetailID 
	 卡片名称：FCardTitle  (必填项)
	 位置&行：FLocationRow 
	 位置&列：FLocationCol 
	 卡片ID(发布时隐藏)：FRealCardID 
	 卡片选择(发布时隐藏)：FBaseCardNumber 
	 指标：FTgtEntryID  (必填项)
	 所属分析模型：FTgtID 
	 样式设置：FDimensionSelect 
	 指标后缀：FSuffix 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BDIP_TargetSubject","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FRemarks":"","FTitle":"","FSYS":"false","FIsExecute":"false","FEntity":[{"FEntryID":0,"FArea":"","FSubArea":[{"FDetailID":0,"FTgtEntryID":{"FNUMBER":""},"FLocationRow":0,"FLocationCol":0,"FRealCardID":0,"FBaseCardNumber":"","FCardTitle":"","FDimensionSelect":"","FSuffix":""}]}],"FEntity2":[{"FEntryID":0,"FFilterCondition":"","FDimensionsType":"","FApplyOnCard":"","FSubEntity":[{"FDetailID":0,"FApplyCardID":0,"FApplyDimetion":"","FSourceTableName":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BDIP_TargetSubject","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BDIP_TargetSubject","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BDIP_TargetSubject","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BDIP_TargetSubject","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BDIP_TargetSubject","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BDIP_TargetSubject"}");

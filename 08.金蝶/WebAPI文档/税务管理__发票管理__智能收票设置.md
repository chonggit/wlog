# 智能收票设置 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 智能收票设置
...
client.Delete("IV_AutoReceiveInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IV_AutoReceiveInvoice","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IV_AutoReceiveInvoice","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FExecutionInterval":0,"FDescription":"","FMainOrgId":{"FNumber":""},"FNextTime":"1900-01-01","FExecutionTime":"1900-01-01","FExecutor":{"FName":""},"FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FENABLEASYNCDOWNLOADIV":"false","FEntity":[{"FEntryID":0,"FOrgId":{"FNUMBER":""},"FTaxNumber":"","FRange":"","FRemark":"","FInvoiceType":"","FConfirmStatus":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FNumber": "",
        "FName": "",
        "FExecutionInterval": 0,
        "FDescription": "",
        "FMainOrgId": {
            "FNumber": ""
        },
        "FNextTime": "1900-01-01",
        "FExecutionTime": "1900-01-01",
        "FExecutor": {
            "FName": ""
        },
        "FModifierId": {
...
单据头：FBillHead 
	 ...
	 方案名称：FName  (必填项)
	 方案编码：FNumber 
	 执行间隔（小时）：FExecutionInterval 
	 摘要：FDescription 
	 创建组织：FMainOrgId  (必填项)
	 下次执行时间：FNextTime 
	 执行时间：FExecutionTime  (必填项)
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 ...
	 审核人：FAuditorID 
	 执行人：FExecutor  (必填项)
	 (已弃用)云通行证用户名：FCloudPassUser 
	 (已弃用)云通行证密码：FCloudPassword 
	 定时收票启用全量发票数据异步下载方式：FENABLEASYNCDOWNLOADIV 
单据体：FEntity 
	 实体主键：FEntryID 
	 业务组织：FOrgId  (必填项)
	 纳税识别号：FTaxNumber  (必填项)
	 收票范围：FRange  (必填项)
	 备注：FRemark 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IV_AutoReceiveInvoice","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FExecutionInterval":0,"FDescription":"","FMainOrgId":{"FNumber":""},"FNextTime":"1900-01-01","FExecutionTime":"1900-01-01","FExecutor":{"FName":""},"FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FENABLEASYNCDOWNLOADIV":"false","FEntity":[{"FEntryID":0,"FOrgId":{"FNUMBER":""},"FTaxNumber":"","FRange":"","FRemark":"","FInvoiceType":"","FConfirmStatus":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("IV_AutoReceiveInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("IV_AutoReceiveInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("IV_AutoReceiveInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IV_AutoReceiveInvoice","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("IV_AutoReceiveInvoice","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("IV_AutoReceiveInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("IV_AutoReceiveInvoice","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IV_AutoReceiveInvoice"}");

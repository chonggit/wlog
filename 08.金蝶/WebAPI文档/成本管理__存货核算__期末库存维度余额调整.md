# 期末库存维度余额调整 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 期末库存维度余额调整

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 4423 |
...
参数FieldKeys显示列：
	 ...
	 库存维度期末单价：FPrice 
	 库存维度期末金额：FAmount 
	 核算维度期末单价：FACCTGDIMEPrice 
	 核算维度期末金额：FACCTGDIMEAmount 
	 金额差异：FDIFFAMOUNT 
	 调整金额：FADJAMOUNT 

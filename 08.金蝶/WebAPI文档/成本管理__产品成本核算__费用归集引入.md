# 费用归集引入 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 费用归集引入
...
client.Delete("ora_ExpenseCollectionImport","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ora_ExpenseCollectionImport","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_XCKF_Org":{"FNumber":""},"F_XCKF_Period":"1900-01-01","F_ora_CreatorId_apv":{"FUserID":""},"F_ora_CreateDate_tzk":"1900-01-01","F_ora_ModifierId_ca9":{"FUserID":""},"F_ora_ModifyDate_uky":"1900-01-01","FApproveDate":"1900-01-01","FApproverId":{"FUserID":""},"FEntity":[{"FEntryID":0,"F_XCKF_Sub_Subject":{"FNUMBER":""},"F_XCKF_Sub_Department":{"FNUMBER":""},"F_XCKF_Sub_FeeProject":{"FNUMBER":""},"F_XCKF_Sub_DebtorHappenAmt":0}],"F_XCKF_ExpCollImtDetail":[{"FEntryID":0,"F_XCKF_Dtl_CostCenter":{"FNUMBER":""},"F_XCKF_Dtl_FeeProject":{"FNUMBER":""},"F_XCKF_Dtl_Date":"1900-01-01","F_XCKF_Dtl_Amount":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_ora_CreateDate_tzk": "1900-01-01",
        "F_ora_ModifierId_ca9": {
            "FUserID": ""
        },
        "F_ora_ModifyDate_uky": "1900-01-01",
        ...
        "FEntity": [
            {
                ...
                "F_XCKF_Sub_Department": {
                    "FNUMBER": ""
                },
                "F_XCKF_Sub_FeeProject": {
                    "FNUMBER": ""
                },
                "F_XCKF_Sub_DebtorHappenAmt": 0
            }
        ],
        "F_XCKF_ExpCollImtDetail": [
            {
                "FEntryID": 0,
                "F_XCKF_Dtl_CostCenter": {
                    "FNUMBER": ""
                },
                "F_XCKF_Dtl_FeeProject": {
                    "FNUMBER": ""
                },
                "F_XCKF_Dtl_Date": "1900-01-01",
                "F_XCKF_Dtl_Amount": 0
            }
        ]
    }
...
单据头：FBillHead 
	 ...
	 组织：F_XCKF_Org 
	 期间：F_XCKF_Period 
	 创建人：F_ora_CreatorId_apv 
	 创建日期：F_ora_CreateDate_tzk 
	 修改人：F_ora_ModifierId_ca9 
	 修改日期：F_ora_ModifyDate_uky 
	 审核日期：FApproveDate 
	 审核人：FApproverId 
科目余额表明细：FEntity 
	 实体主键：FEntryID 
	 科目编码：F_XCKF_Sub_Subject 
	 部门（核算维度）：F_XCKF_Sub_Department 
	 费用项目：F_XCKF_Sub_FeeProject 
	 借方发生额：F_XCKF_Sub_DebtorHappenAmt 
费用归集明细：F_XCKF_ExpCollImtDetail 
	 实体主键：FEntryID 
	 成本中心：F_XCKF_Dtl_CostCenter 
	 费用项目：F_XCKF_Dtl_FeeProject 
	 日期：F_XCKF_Dtl_Date 
	 金额：F_XCKF_Dtl_Amount 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ora_ExpenseCollectionImport","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_XCKF_Org":{"FNumber":""},"F_XCKF_Period":"1900-01-01","F_ora_CreatorId_apv":{"FUserID":""},"F_ora_CreateDate_tzk":"1900-01-01","F_ora_ModifierId_ca9":{"FUserID":""},"F_ora_ModifyDate_uky":"1900-01-01","FApproveDate":"1900-01-01","FApproverId":{"FUserID":""},"FEntity":[{"FEntryID":0,"F_XCKF_Sub_Subject":{"FNUMBER":""},"F_XCKF_Sub_Department":{"FNUMBER":""},"F_XCKF_Sub_FeeProject":{"FNUMBER":""},"F_XCKF_Sub_DebtorHappenAmt":0}],"F_XCKF_ExpCollImtDetail":[{"FEntryID":0,"F_XCKF_Dtl_CostCenter":{"FNUMBER":""},"F_XCKF_Dtl_FeeProject":{"FNUMBER":""},"F_XCKF_Dtl_Date":"1900-01-01","F_XCKF_Dtl_Amount":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ora_ExpenseCollectionImport","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ora_ExpenseCollectionImport","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ora_ExpenseCollectionImport","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ora_ExpenseCollectionImport","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ora_ExpenseCollectionImport","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("ora_ExpenseCollectionImport","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ora_ExpenseCollectionImport","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ora_ExpenseCollectionImport"}");

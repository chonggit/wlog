...
client.Delete("SVM_ComparePrice","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SVM_ComparePrice","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FBusinessType":"","FCompareDate":"1900-01-01","FPurchaseOrgId":{"FNumber":""},"FPurchaseDeptId":{"FNUMBER":""},"FPurchaserGroupId":{"FNUMBER":""},"FPurchaserId":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FBillNote":"","FComMode":"","FCompareEntry":[{"FEntryID":0,"FInquiryBillNo":"","FInquiryDate":"1900-01-01","FCurrencyId":{"FNUMBER":""},"FIsIncludedTax":"false","FMaterialId":{"FNUMBER":""},"FBaseQty":0,"FBaseUnitID":{"FNumber":""},"FREFERCURRID":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FREFERPRICE":0,"FUnitID":{"FNumber":""},"FQty":0,"FComfirmQty":0,"FComfirmPrice":0,"FComfirmTaxPrice":0,"FComfirmSupplier":{"FNUMBER":""},"FComfirmBaseQty":0,"FQuoteEntry":[{"FDetailID":0,"FQuoteBillNo":"","FQuoteDate":"1900-01-01","FQuoteSupplier":{"FNUMBER":""},"FQuotePhone":"","FQuoteUnitID":{"FNumber":""},"FQuoteQty":0,"FAccessRate":0,"FQuotePrice":0,"FQuoteTaxPrice":0,"FQuoteAmount":0,"FQuoteAllAmount":0,"FQuoteResult":"","FQuoteComfirmQty":0,"FTaxRate":0,"FQuoteComfirmPrice":0,"FQuoteComfirmTaxPrice":0,"FQuoteComfirmNote":"","FQuoteCurrencyId":{"FNUMBER":""},"FQuoteBaseQty":0,"FQuoteBaseUnitId":{"FNumber":""},"FQuoteComfirmBaseQty":0,"FCompareFeedback":""}]}],"FQuoteSum":[{"FEntryID":0,"FSumQuoteNO":"","FSumSupplier":{"FNUMBER":""},"FSumBillAmount":0,"FSumBillAllAmount":0,"FSumComRst":"","FSumCurr":{"FNUMBER":""},"FSumQuoteId":0}]}}");
                ...
                "FQuoteEntry": [
                    {
                        ...
                        "FQuoteComfirmQty": 0,
                        "FTaxRate": 0,
                        "FQuoteComfirmPrice": 0,
                        "FQuoteComfirmTaxPrice": 0,
                        "FQuoteComfirmNote": "",
                        "FQuoteCurrencyId": {
                            "FNUMBER": ""
                        },
...
基本信息：FBillHead 
	 ...
	 备注：FBillNote 
	 比价模式：FComMode 
	 允许比价时采纳多个供应商：FAccessMutilSup 
	 预置空用户：FPreUserId 
询价信息：FCompareEntry 
	 实体主键：FEntryID 
	 询价单号：FInquiryBillNo  (必填项)
	 询价日期：FInquiryDate  (必填项)
	 ...
	 确认数量：FComfirmQty 
	 确认单价：FComfirmPrice 
	 确认含税单价：FComfirmTaxPrice 
	 确认供应商：FComfirmSupplier 
	 币别：FCurrencyId  (必填项)
	 含税：FIsIncludedTax 
	 辅助属性：FAuxPropId 
	 描述：FF100001
...
报价信息：FQuoteEntry 
	 ...
	 单价：FQuotePrice 
	 含税单价：FQuoteTaxPrice 
	 询报价结果：FQuoteResult  (必填项)
	 报价确认数量：FQuoteComfirmQty 
	 报价确认单价：FQuoteComfirmPrice 
	 报价确认含税单价：FQuoteComfirmTaxPrice 
	 报价确认意见：FQuoteComfirmNote 
	 报价单位：FQuoteUnitID 
	 报价币别：FQuoteCurrencyId 
	 报价数量(基本单位)：FQuoteBaseQty 
	 报价基本单位：FQuoteBaseUnitId 
	 报价确认数量(基本单位)：FQuoteComfirmBaseQty 
	 报价单分录内码：FQuoteBillEntryId 
	 税率%：FTaxRate 
	 联系人：FQuoteContacter 
	 比价反馈：FCompareFeedback 
	 电话：FQuotePhone 
	 金额：FQuoteAmount 
	 含税金额：FQuoteAllAmount 
	 货源比例(%)：FAccessRate 
总金额比价：FQuoteSum 
	 实体主键：FEntryID 
	 报价单号：FSumQuoteNO 
	 ...
	 报价单id：FSumQuoteId 
	 总金额：FSumBillAmount 
	 总价税合计：FSumBillAllAmount 
	 比价结果建议：FSumComRst 
关联关系表：FCompareEntry_Link 
	 实体主键：FLinkId 
	 业务流程图：FCompareEntry_Link_FFlowId 
	 推进路线：FCompareEntry_Link_FFlowLineId 
	 转换规则：FCompareEntry_Link_FRuleId 
	 源单表内码：FCompareEntry_Link_FSTableId 
	 源单表：FCompareEntry_Link_FSTableName 
	 源单内码：FCompareEntry_Link_FSBillId 
	 源单分录内码：FCompareEntry_Link_FSId 
	 原始携带量：FCompareEntry_Link_FBaseQtyOld 
	 修改携带量：FCompareEntry_Link_FBaseQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SVM_ComparePrice","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FBusinessType":"","FCompareDate":"1900-01-01","FPurchaseOrgId":{"FNumber":""},"FPurchaseDeptId":{"FNUMBER":""},"FPurchaserGroupId":{"FNUMBER":""},"FPurchaserId":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FBillNote":"","FComMode":"","FCompareEntry":[{"FEntryID":0,"FInquiryBillNo":"","FInquiryDate":"1900-01-01","FCurrencyId":{"FNUMBER":""},"FIsIncludedTax":"false","FMaterialId":{"FNUMBER":""},"FBaseQty":0,"FBaseUnitID":{"FNumber":""},"FREFERCURRID":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FREFERPRICE":0,"FUnitID":{"FNumber":""},"FQty":0,"FComfirmQty":0,"FComfirmPrice":0,"FComfirmTaxPrice":0,"FComfirmSupplier":{"FNUMBER":""},"FComfirmBaseQty":0,"FQuoteEntry":[{"FDetailID":0,"FQuoteBillNo":"","FQuoteDate":"1900-01-01","FQuoteSupplier":{"FNUMBER":""},"FQuotePhone":"","FQuoteUnitID":{"FNumber":""},"FQuoteQty":0,"FAccessRate":0,"FQuotePrice":0,"FQuoteTaxPrice":0,"FQuoteAmount":0,"FQuoteAllAmount":0,"FQuoteResult":"","FQuoteComfirmQty":0,"FTaxRate":0,"FQuoteComfirmPrice":0,"FQuoteComfirmTaxPrice":0,"FQuoteComfirmNote":"","FQuoteCurrencyId":{"FNUMBER":""},"FQuoteBaseQty":0,"FQuoteBaseUnitId":{"FNumber":""},"FQuoteComfirmBaseQty":0,"FCompareFeedback":""}]}],"FQuoteSum":[{"FEntryID":0,"FSumQuoteNO":"","FSumSupplier":{"FNUMBER":""},"FSumBillAmount":0,"FSumBillAllAmount":0,"FSumComRst":"","FSumCurr":{"FNUMBER":""},"FSumQuoteId":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SVM_ComparePrice","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SVM_ComparePrice","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SVM_ComparePrice","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SVM_ComparePrice","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SVM_ComparePrice","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SVM_ComparePrice","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SVM_ComparePrice"}");

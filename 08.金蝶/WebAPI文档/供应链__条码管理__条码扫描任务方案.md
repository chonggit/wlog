# 条码扫描任务方案 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 条码扫描任务方案
...
client.Save("UN_SCANTASKSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FTaskExecObject":"","FTaskItem":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FBillStatus":"","FAutoAllotType":"","FAutoAllot":"false","FFixedAllot":"false","FEntity":[{"FEntryID":0,"FScanConfig":"","FSOURCEEBILL":{"FID":""},"FTARGETBILL":{"FID":""},"FCHECK":"false","FTaskExecObjectEntry":"","FTaskItemEntry":{"FNumber":""},"FAutoAllotEntry":"false","FAutoAllotTypeEntry":"","FFixedAllotEntry":"false","FSCANCONFIGID":""}]}}");
        ...
        "FEntity": [
            {
                ...
                "FCHECK": "false",
                "FTaskExecObjectEntry": "",
                "FTaskItemEntry": {
                    "FNumber": ""
                },
                "FAutoAllotEntry": "false",
                "FAutoAllotTypeEntry": "",
                "FFixedAllotEntry": "false",
                "FSCANCONFIGID": ""
            }
        ]
    }
...
单据头：FBillHead 
	 ...
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 启用状态：FBillStatus  (必填项)
	 自动分配方式：FAutoAllotType 
	 自动分配：FAutoAllot 
	 固定分配：FFixedAllot 
单据体：FEntity 
	 实体主键：FEntryID 
	 ...
	 目标单：FTARGETBILL 
	 校验模式：FCHECK 
	 任务执行对象：FTaskExecObjectEntry 
	 任务执行者：FTaskItemEntry 
	 自动分配：FAutoAllotEntry 
	 自动分配方式：FAutoAllotTypeEntry 
	 固定分配：FFixedAllotEntry 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("UN_SCANTASKSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_SCANTASKSCHEME","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_SCANTASKSCHEME","Disable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_SCANTASKSCHEME"}");

# 周期盘点计划 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 周期盘点计划
...
| 关闭 | StatusConvertClose | 1706 |
| 反关闭 | StatusConvertUnClose | 1708 |
| 批量保存 | BatchSave | 3057 |
...
client.Delete("STK_CycleCountPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("STK_CycleCountPlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FName":"","FStockOrgId":{"FNumber":""},"FIsAutoPlan":"false","FPeriodUnit":"","FPeriod":0,"FNextCycleDate":"1900-01-01","FAutoAudit":"false","FABCGroupId":{"FNumber":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCountOverTol":"false","FZeroStockInCount":"false","FAllowProcAddMaterial":"false","FLapseDate":"1900-01-01","FNote":"","FAutoPlanLocaleId":0,"FCheckQtyDefault":"","FNotIncludeForbidMat":"false","FSZeroStockInCount":"false","FBZeroStockInCount":"false","FExcludeInTransInv":"false","FStockRange":"","FCycleCountStock":[{"FEntryID":0,"FStockId":{"FNumber":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FStockNote":""}],"FCycleCountABC":[{"FEntryID":0,"FGroupNo":"","FGroupName":"","FTimesPYear":0,"FPercent":0,"FControlTol":"false","FGainTol":0,"FLossTol":0,"FGropuNote":"","FGroupEntryId":""}],"FCycleCountMat":[{"FEntryID":0,"FGroupNumber":"","FMatGroupName":"","FMaterialId":{"FNumber":""},"FMatControlTol":"false","FMatGainTol":0,"FMatLossTol":0,"FMatNote":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FAllowProcAddMaterial": "false",
        "FLapseDate": "1900-01-01",
        "FNote": "",
        "FAutoPlanLocaleId": 0,
        "FCheckQtyDefault": "",
        "FNotIncludeForbidMat": "false",
        "FSZeroStockInCount": "false",
        "FBZeroStockInCount": "false",
        "FExcludeInTransInv": "false",
        "FStockRange": "",
        "FCycleCountStock": [
            {
                "FEntryID": 0,
...
基本信息：FBillHead 
	 ...
	 起始序号：FStartSeq 
	 上次计划日期：FLastCycleDate 
	 下次计划日期：FNextCycleDate  (必填项)
	 失效日期：FLapseDate  (必填项)
	 周期盘点作业允许增加物料：FAllowProcAddMaterial 
	 基本单位和库存辅单位库存量同时为零，参与盘点：FZeroStockInCount 
	 盘点误差超出容差范围自动纳入下次盘点：FCountOverTol 
	 备注：FNote 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 最后修改人：FModifierId 
	 ...
	 关闭日期：FCloseDate 
	 关闭状态：FCloseStatus 
	 ABC分配组编码：FABCGroupId 
	 ABC分配组名称：FABCGroupName 
	 盘点计划名称：FName 
	 周期单位：FPeriodUnit  (必填项)
	 间隔周期：FPeriod 
	 最近盘点日期：FLastCountDate 
	 指定仓库范围：FAppoint 
	 仓库范围：FStockRange 
	 全部仓库：FAll 
	 自动计划执行人：FOperator 
	 启用自动计划：FIsAutoPlan 
	 自动计划区域码：FAutoPlanLocaleId 
	 实盘数默认值：FCheckQtyDefault  (必填项)
	 生成物料周期盘点表时自动审核并生成物料盘点作业：FAutoAudit 
	 禁用物料不参与盘点：FNotIncludeForbidMat 
	 基本单位库存量不为零，库存辅单位库存量为零，参与盘点：FSZeroStockInCount 
	 基本单位库存量为零，库存辅单位库存量不为零，参与盘点：FBZeroStockInCount 
	 序列号默认为盘亏状态：FGenLossSN 
	 在途物料不参与盘点：FExcludeInTransInv 
仓库范围：FCycleCountStock 
	 实体主键：FEntryID 
	 仓库：FStockId 
	 仓位：FStockLocId 
	 100新豪仓位值集：FF100003
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("STK_CycleCountPlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FName":"","FStockOrgId":{"FNumber":""},"FIsAutoPlan":"false","FPeriodUnit":"","FPeriod":0,"FNextCycleDate":"1900-01-01","FAutoAudit":"false","FABCGroupId":{"FNumber":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCountOverTol":"false","FZeroStockInCount":"false","FAllowProcAddMaterial":"false","FLapseDate":"1900-01-01","FNote":"","FAutoPlanLocaleId":0,"FCheckQtyDefault":"","FNotIncludeForbidMat":"false","FSZeroStockInCount":"false","FBZeroStockInCount":"false","FExcludeInTransInv":"false","FStockRange":"","FCycleCountStock":[{"FEntryID":0,"FStockId":{"FNumber":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FStockNote":""}],"FCycleCountABC":[{"FEntryID":0,"FGroupNo":"","FGroupName":"","FTimesPYear":0,"FPercent":0,"FControlTol":"false","FGainTol":0,"FLossTol":0,"FGropuNote":"","FGroupEntryId":""}],"FCycleCountMat":[{"FEntryID":0,"FGroupNumber":"","FMatGroupName":"","FMaterialId":{"FNumber":""},"FMatControlTol":"false","FMatGainTol":0,"FMatLossTol":0,"FMatNote":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("STK_CycleCountPlan","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("STK_CycleCountPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("STK_CycleCountPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("STK_CycleCountPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("STK_CycleCountPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_CycleCountPlan","StatusConvertClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("STK_CycleCountPlan","StatusConvertUnClose","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("STK_CycleCountPlan","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"STK_CycleCountPlan"}");

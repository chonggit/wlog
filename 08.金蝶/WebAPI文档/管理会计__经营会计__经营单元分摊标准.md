# 经营单元分摊标准 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 经营单元分摊标准
...
client.Delete("AM_CSTALLOCTESTDBASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_CSTALLOCTESTDBASE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_CSTALLOCTESTDBASE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FCREATORID":{"FUserID":""},"FAPPROVERID":{"FUserID":""},"FACCOUNTBOOKID":{"FNUMBER":""},"FORGID":{"FNumber":""},"FEXPENSEALLOCRITERIATYPE":"","FEXPENSEALLOCRITERIA":{"FNUMBER":""},"FSHARETARGET":"","FISPROFITCAMOEBAID":"false","FISAMOEBAID":"false","F_AM_Entity":[{"FEntryID":0,"FAMOEABID":{"FNUMBER":""},"FPROFITCENTERID":{"FNUMBER":""},"FBEAROBJECTTYPE":{"FNUMBER":""},"FBEAROBJECTIN":"","FBEAROBJECTID":0,"FBEAROBJECTDESC":"","FWEIGHT":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FEXPENSEALLOCRITERIATYPE": "",
        "FEXPENSEALLOCRITERIA": {
            "FNUMBER": ""
        },
        "FSHARETARGET": "",
        "FISPROFITCAMOEBAID": "false",
        "FISAMOEBAID": "false",
        "F_AM_Entity": [
            {
                "FEntryID": 0,
...
单据头：FBillHead 
	 ...
	 修改日期：FMODIFYDATE 
	 创建组织：FORGID  (必填项)
	 分摊规则：FEXPENSEALLOCRITERIATYPE  (必填项)
	 自定义分摊规则：FEXPENSEALLOCRITERIA 
	 接收方类型：FSHARETARGET  (必填项)
	 接收方取分摊方利润中心的下级经营单元：FISPROFITCAMOEBAID 
	 接收方取分摊方的经营单元或下级经营单元：FISAMOEBAID 
单据体：F_AM_Entity 
	 实体主键：FEntryID 
	 经营单元编码：FAMOEABID 
	 经营单元名称：FAMNAME 
	 权重值：FWEIGHT 
	 承担对象类型：FBEAROBJECTTYPE 
	 承担对象：FBEAROBJECTIN 
	 承担对象内码：FBEAROBJECTID 
	 承担对象多语言：FBEAROBJECTDESC 
	 利润中心编码：FPROFITCENTERID 
	 利润中心名称：FBaseProperty 
	 经营组织架构：FORGIDSYSTEID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_CSTALLOCTESTDBASE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FCREATORID":{"FUserID":""},"FAPPROVERID":{"FUserID":""},"FACCOUNTBOOKID":{"FNUMBER":""},"FORGID":{"FNumber":""},"FEXPENSEALLOCRITERIATYPE":"","FEXPENSEALLOCRITERIA":{"FNUMBER":""},"FSHARETARGET":"","FISPROFITCAMOEBAID":"false","FISAMOEBAID":"false","F_AM_Entity":[{"FEntryID":0,"FAMOEABID":{"FNUMBER":""},"FPROFITCENTERID":{"FNUMBER":""},"FBEAROBJECTTYPE":{"FNUMBER":""},"FBEAROBJECTIN":"","FBEAROBJECTID":0,"FBEAROBJECTDESC":"","FWEIGHT":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_CSTALLOCTESTDBASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_CSTALLOCTESTDBASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AM_CSTALLOCTESTDBASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_CSTALLOCTESTDBASE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AM_CSTALLOCTESTDBASE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_CSTALLOCTESTDBASE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AM_CSTALLOCTESTDBASE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AM_CSTALLOCTESTDBASE"}");

...
client.Delete("IOS_ScheduleSettle","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IOS_ScheduleSettle","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IOS_ScheduleSettle","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FACCTSysId":{"FNUMBER":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FIsSettleAll":"false","FIsCreateReceive_M":"false","FIsCreatePay_M":"false","FIsCreateReceive_FA":"false","FIsCreatePay_FA":"false","FIsCreateReceive_EXP":"false","FIsCreatePay_EXP":"false","FIOSBizFormId":"","FIOSBizType":"","FIsAutoAuditPay":"false","FIsAutoAuditArAp":"false","FIsAutoPush":"false","FIsAutoAuditRecive":"false","FIsAutoCreate":"false","FIsGroupByBizType":"false","FIOSPriceMatchPoint":"","FIsCreateZeroPrice":"false","FIsGroupByBizBillNo":"false","FExecuteTime":"1900-01-01","FPlanBeginDate":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteIntervalUnit":"","FExecuteInterval":0,"FTaskRemarks":"","FSettleByMonth":"false","FAutoNextTime":"false","FDataType":"","FOneToOneOrg":"false","FBillFilterSchemeId":{"FNUMBER":""},"FIsCreateByNum":"false","FCreateNum":0,"FIsAutoAuditAp":"false","FIsAutoPushAP":"false","FSettleEntity":[{"FENTRYID":0,"FSettleOrgId":{"FNumber":""},"FAcctID":{"FNumber":""}}],"FPriceSetEntity":[{"FENTRYID":0,"FTransferBizTypeID":{"FNUMBER":""},"FPriceSetID":{"FNUMBER":""}}],"FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FEndDate": "1900-01-01",
        "FIsSettleAll": "false",
        "FIsCreateReceive_M": "false",
        "FIsCreatePay_M": "false",
        "FIsCreateReceive_FA": "false",
        "FIsCreatePay_FA": "false",
        "FIsCreateReceive_EXP": "false",
        "FIsCreatePay_EXP": "false",
        "FIOSBizFormId": "",
        "FIOSBizType": "",
        "FIsAutoAuditPay": "false",
        "FIsAutoAuditArAp": "false",
        "FIsAutoPush": "false",
        "FIsAutoAuditRecive": "false",
        "FIsAutoCreate": "false",
        "FIsGroupByBizType": "false",
        "FIOSPriceMatchPoint": "",
        "FIsCreateZeroPrice": "false",
        "FIsGroupByBizBillNo": "false",
        ...
        "FIsCreateByNum": "false",
        "FCreateNum": 0,
        "FIsAutoAuditAp": "false",
        "FIsAutoPushAP": "false",
        "FSettleEntity": [
            {
                "FENTRYID": 0,
...
单据头：FBillHead 
	 ...
	 核算体系：FACCTSysId  (必填项)
	 计划名称：FScheduledId 
	 执行时间点：FPDExecuteTime 
	 计划开始时间：FPDBeginDate 
	 计划结束时间：FPDEndDate 
	 执行间隔单位：FPDExecuteIntervalUnit 
	 执行间隔时间：FPDExecuteInterval 
	 任务状态：FPDTaskStatus 
	 任务描述：FPDTaskRemarks 
	 最近一次执行情况：FPDExecutResult 
	 核算组织：FACCTOrgId 
	 结算所有下级业务组织：FIsSettleAll 
	 起始日期：FStartDate  (必填项)
	 截止日期：FEndDate  (必填项)
	 结算价目表匹配时点：FIOSPriceMatchPoint  (必填项)
	 按跨组织业务单据编号分单：FIsGroupByBizBillNo 
	 按跨组织结算类型分单：FIsGroupByBizType 
	 结算业务对方组织自动生成结算清单：FIsAutoCreate 
	 有结算价格的应收结算清单自动审核：FIsAutoAuditRecive 
	 结算清单审核后自动生成应收单：FIsAutoPush 
	 审核结算应收清单联动审核应付结算清单：FIsAutoAuditPay 
	 生成应收单为已审核状态：FIsAutoAuditArAp 
	 创建应收结算清单_物料：FIsCreateReceive_M 
	 创建应付结算清单_物料：FIsCreatePay_M 
	 创建应收结算清单_资产：FIsCreateReceive_FA 
	 创建应付结算清单_资产：FIsCreatePay_FA 
	 创建应收结算清单_费用：FIsCreateReceive_EXP 
	 创建应付结算清单_费用：FIsCreatePay_EXP 
	 单据类型：FIOSBizFormId  (必填项)
	 跨组织业务类型：FIOSBizType  (必填项)
	 任务描述：FTaskRemarks 
	 ...
	 按自然月结算：FSettleByMonth 
	 自动滚动月份结算：FAutoNextTime 
	 数据类型（单据改造前后）：FDataType 
	 结算价小于等于0生成结算清单：FIsCreateZeroPrice 
	 接收方组织：FMRecOrgId 
	 按供货方接收方核算组织一对一生成：FOneToOneOrg 
	 供货方组织：FMSupplyOrgId 
	 单据选择方案：FBillFilterSchemeId 
	 生成结算清单分录行数：FIsCreateByNum 
	 行数：FCreateNum 
	 生成应付单为已审核状态：FIsAutoAuditAp 
	 结算清单审核后自动生成应付单：FIsAutoPushAP 
下级业务组织单据体：FSettleEntity 
	 实体主键：FENTRYID 
	 业务组织编码：FSettleOrgId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IOS_ScheduleSettle","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FACCTSysId":{"FNUMBER":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FIsSettleAll":"false","FIsCreateReceive_M":"false","FIsCreatePay_M":"false","FIsCreateReceive_FA":"false","FIsCreatePay_FA":"false","FIsCreateReceive_EXP":"false","FIsCreatePay_EXP":"false","FIOSBizFormId":"","FIOSBizType":"","FIsAutoAuditPay":"false","FIsAutoAuditArAp":"false","FIsAutoPush":"false","FIsAutoAuditRecive":"false","FIsAutoCreate":"false","FIsGroupByBizType":"false","FIOSPriceMatchPoint":"","FIsCreateZeroPrice":"false","FIsGroupByBizBillNo":"false","FExecuteTime":"1900-01-01","FPlanBeginDate":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteIntervalUnit":"","FExecuteInterval":0,"FTaskRemarks":"","FSettleByMonth":"false","FAutoNextTime":"false","FDataType":"","FOneToOneOrg":"false","FBillFilterSchemeId":{"FNUMBER":""},"FIsCreateByNum":"false","FCreateNum":0,"FIsAutoAuditAp":"false","FIsAutoPushAP":"false","FSettleEntity":[{"FENTRYID":0,"FSettleOrgId":{"FNumber":""},"FAcctID":{"FNumber":""}}],"FPriceSetEntity":[{"FENTRYID":0,"FTransferBizTypeID":{"FNUMBER":""},"FPriceSetID":{"FNUMBER":""}}],"FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("IOS_ScheduleSettle","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("IOS_ScheduleSettle","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("IOS_ScheduleSettle","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IOS_ScheduleSettle"}");

# 折旧调整单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 折旧调整单
...
client.Delete("FA_ADJUST","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_ADJUST","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAcctPolicyID":{"FNumber":""},"FCurrencyID":{"FNumber":""},"FOWNERORGID":{"FNumber":""},"FTransDate":"1900-01-01","Fyear":0,"FPeriod":0,"FISAFFECTNEXTPERIOD":"false","FCompareValue":"","FCompareItem":"","FCompareMethod":"","FA_DEPRADJUSTENTRY":[{"FENTRYID":0,"FAssetTypeID":{"FNumber":""},"FAlterID":{"FNumber":""},"FDepr":0,"FShouldDepr":0,"FDeprMethod":"","FPeriodWorkLoad":0,"FDeprRemain":0,"FWorkLoadUnitID":{"FNumber":""},"FOrgVal":0,"FResidualvalue":0,"FLifePeriods":0,"FAccumDepr":0,"FAccumDevalue":0,"FDeprPeriods":0,"FPeriodcount":0,"FDeprRate":0,"FFORMULACONTENT":"","FRemainYear":0,"FMQuantity":0,"FLifeYear":0,"FAssetCurStatus":"","FDisposeDepr":0,"FPredictWorkLoad":0,"FDeprWorkLoad":0,"F_ora_KH":"","FA_DEPRADJUSTDETAIL":[{"FDETAILID":0,"FAssetNO":"","FUseDeptID":{"FNumber":""},"FUserID":{},"FAllocRatio":0,"FAllocValue":0,"FCostItemID":{"FNumber":""},"FQuantity":0}]}]}}");
...
单据头：FBillHead 
	 ...
	 业务日期：FTransDate 
	 货主组织：FOWNERORGID 
	 手工调整折旧仅影响本期：FISAFFECTNEXTPERIOD 
	 比较值：FCompareValue 
	 比较项：FCompareItem 
	 下拉列表：FCompareMethod 
折旧汇总：FA_DEPRADJUSTENTRY 
	 实体主键：FENTRYID 
	 资产类别：FAssetTypeID 
	 卡片编码：FAlterID 
	 卡片名称：FAssetName 
	 ...
	 未计提折旧：FDeprRemain 
	 资产原值：FOrgVal 
	 预计净残值：FResidualvalue 
	 预计使用期间数：FLifePeriods 
	 累计折旧：FAccumDepr 
	 减值准备：FAccumDevalue 
	 已折旧期间数：FDeprPeriods 
	 年度会计期间数：FPeriodcount 
	 折旧率：FDeprRate 
	 折旧计算公式：FFORMULACONTENT 
	 卡片数量：FMQuantity 
	 剩余使用年限：FRemainYear 
	 预计使用年限：FLifeYear 
	 卡片当前状态：FAssetCurStatus 
	 处置单计提折旧额：FDisposeDepr 
	 工作量单位：FWorkLoadUnitID 
	 预计工作总量：FPredictWorkLoad 
	 已折旧工作量：FDeprWorkLoad 
	 折旧方法：FDeprMethod 
	 本期折旧工作量：FPeriodWorkLoad 
	 资产状态：F_ora_BaseProperty_83g 
	 客户：F_ora_KH 
折旧分配：FA_DEPRADJUSTDETAIL 
	 实体主键：FDETAILID 
	 使用部门：FUseDeptID 
	 使用人：FUserID 
	 分配比例%：FAllocRatio 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_ADJUST","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_ADJUST","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_ADJUST","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_ADJUST","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_ADJUST"}");

# 移动采购显示设置 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 移动采购显示设置
...
client.Delete("SCM_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SCM_MobExtendFieldConfig","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SCM_MobExtendFieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillType":{"FID":""},"FEntryMarkID":"","FMobileConfigEntity":[{"FENTRYID":0,"FFieldKey":"","FFieldName":"","FIsExpand":"false","FIsHeadField":"false","FFieldTypeName":"","FLocal":""}],"FMobileConfigEntityV2":[{"FEntryID":0,"FFieldKeyV2":"","FFieldNameV2":"","FIsHeadFieldV2":"false","FFieldTypeV2":0,"FFieldTypeNameV2":"","FVisibleViewV2":"false","FVisibleEditV2":"false","FVisibleListV2":"false","FVisibleExpandV2":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FMobileConfigEntityV2": [
            {
                "FEntryID": 0,
                "FFieldKeyV2": "",
                "FFieldNameV2": "",
                "FIsHeadFieldV2": "false",
                "FFieldTypeV2": 0,
                "FFieldTypeNameV2": "",
                "FVisibleViewV2": "false",
                "FVisibleEditV2": "false",
                "FVisibleListV2": "false",
                "FVisibleExpandV2": "false"
            }
        ]
    }
}
...
单据体：FMobileConfigEntity 
	 ...
	 字段位置：FLocal 
	 折叠展示：FIsExpand 
单据体V2：FMobileConfigEntityV2 
	 实体主键：FEntryID 
	 字段标识：FFieldKeyV2 
	 字段名称：FFieldNameV2 
	 单据头字段：FIsHeadFieldV2 
	 字段类型：FFieldTypeV2 
	 字段类型：FFieldTypeNameV2 
	 查看可见：FVisibleViewV2 
	 新增修改可见：FVisibleEditV2 
	 列表可见：FVisibleListV2 
	 折叠可见：FVisibleExpandV2 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SCM_MobExtendFieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillType":{"FID":""},"FEntryMarkID":"","FMobileConfigEntity":[{"FENTRYID":0,"FFieldKey":"","FFieldName":"","FIsExpand":"false","FIsHeadField":"false","FFieldTypeName":"","FLocal":""}],"FMobileConfigEntityV2":[{"FEntryID":0,"FFieldKeyV2":"","FFieldNameV2":"","FIsHeadFieldV2":"false","FFieldTypeV2":0,"FFieldTypeNameV2":"","FVisibleViewV2":"false","FVisibleEditV2":"false","FVisibleListV2":"false","FVisibleExpandV2":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SCM_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SCM_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SCM_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SCM_MobExtendFieldConfig","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SCM_MobExtendFieldConfig","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SCM_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SCM_MobExtendFieldConfig","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SCM_MobExtendFieldConfig"}");

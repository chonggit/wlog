# 定时模拟报价 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 定时模拟报价
...
client.Delete("SAL_SCHEDULESIMULATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SAL_SCHEDULESIMULATE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SAL_SCHEDULESIMULATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FPlanBeginDate":"1900-01-01","FExecuteTime":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteInterval":0,"FExecuteIntervalUnit":"","FScheduledId":{"FNAME":""},"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FGETTAXPRICE":"false","FConsiderCPRate":"false","FOrgId":{"FNUMBER":""},"FExpandWGMaterial":"false","FCusId":{"FNUMBER":""},"FOnlyIssueMaterial":"false","FConsiderLossRate":"false","FCurrId":{"FNUMBER":""},"FCalcSkipFee":"false","FSkipSelfMadeOnlyVolCalc":"false","FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}],"FMaterialPriceSet":[{"FENTRYID":0,"FMaterialPriceType":"","FMaterialPriceSource":"","FMaterialPriority":0,"FGetPriceSet":"","FPriceOrgId":{"FNumber":""}}],"FSubcontractSet":[{"FENTRYID":0,"FSubcontractPriceType":"","FSubcontractPriceSrc":"","FSubcontractPriority":0,"FSubGetPriceSet":"","FSubPriceOrgId":{"FNumber":""}}],"FSelfMadePriceSet":[{"FENTRYID":0,"FSelfMadePriceType":"","FSelfMadePriceSrc":"","FSelfMadePrior":0,"FSelfGetPriceSet":""}],"FCustomPriceSet":[{"FENTRYID":0,"FCustomPriceType":"","FCostOfName":"","FCost":0,"FPrepaidQty":0,"FCustCostUpRate":0,"FCostItemId":{"FNUMBER":""}}],"FMaterialEntity":[{"FENTRYID":0,"FMapId":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FSupplyOrgId":{"FNumber":""},"FBomId":{"FNumber":""},"FUnitID":{"FNumber":""},"FQty":0,"FTaxRate":0,"FCostFloatingRate":0,"FBaseUnitID":{"FNumber":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FExpandWGMaterial": "false",
        "FCusId": {
            "FNUMBER": ""
        },
        "FOnlyIssueMaterial": "false",
        ...
        "FLogEntity": [
            {
                "FEntryID": 0,
                "FEXECSTARTDATE": "1900-01-01",
                "FEXECENDDATE": "1900-01-01",
                "FMESSAGE": ""
            }
        ],
        "FMaterialPriceSet": [
        ...
        "FSubcontractSet": [
            {
                "FENTRYID": 0,
                "FSubcontractPriceType": "",
                "FSubcontractPriceSrc": "",
                "FSubcontractPriority": 0,
                "FSubGetPriceSet": "",
                "FSubPriceOrgId": {
                    "FNumber": ""
                }
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 描述：FDescription 
	 计划开始时间：FPlanBeginDate  (必填项)
	 执行时间点：FExecuteTime  (必填项)
	 计划结束时间：FPlanEndDate  (必填项)
	 执行间隔：FExecuteInterval 
	 执行间隔单位：FExecuteIntervalUnit  (必填项)
	 计划名称：FScheduledId 
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 任务状态：FScheduleStatus 
	 最后一次执行情况：FBaseProperty 
	 获取含税价：FGETTAXPRICE 
	 考虑成品率：FConsiderCPRate 
	 报价组织：FOrgId  (必填项)
	 外购件物料展开至末级：FExpandWGMaterial 
	 购货客户：FCusId 
	 BOM展开时只携带需要发料的子项物料：FOnlyIssueMaterial 
	 报价数量计算BOM损耗：FConsiderLossRate 
	 报价币别：FCurrId  (必填项)
	 计算跳层物料的标准费率：FCalcSkipFee 
	 跳层自制件只按BOM卷算：FSkipSelfMadeOnlyVolCalc 
执行日志单据体：FLogEntity 
	 实体主键：FEntryID 
	 开始执行时间：FEXECSTARTDATE 
	 执行情况：FMESSAGE 
	 完成执行时间：FEXECENDDATE 
外购材料单价设置：FMaterialPriceSet 
	 实体主键：FENTRYID 
	 外购价格类型：FMaterialPriceType 
	 外购材料单价来源：FMaterialPriceSource 
	 外购材料取价优先次序：FMaterialPriority 
	 指定取价组织：FMPriceOrgId 
	 取价选项：FGetPriceSet 
	 指定采购价目表：FMPriceListId 
	 指定结算价目表：FMIOSPriceListId 
	 指定组织(作废)：FPriceOrgId 
委外加工单价设置：FSubcontractSet 
	 实体主键：FENTRYID 
	 委外价格类型：FSubcontractPriceType 
	 委外加工单价来源：FSubcontractPriceSrc 
	 委外加工取价优先次序：FSubcontractPriority 
	 指定取价组织：FMSubPriceOrgId 
	 取价选项：FSubGetPriceSet 
	 指定价目表：FMSubPriceListId 
	 指定组织(作废)：FSubPriceOrgId 
	 指定结算价目表：FMSubIOSPriceListId 
自制件单价设置：FSelfMadePriceSet 
	 实体主键：FENTRYID 
	 自制件价格类型：FSelfMadePriceType 
	 自制件单价来源：FSelfMadePriceSrc 
	 自制件取价优先次序：FSelfMadePrior 
	 指定取价组织：FMSelfPriceOrgId 
	 取价选项：FSelfGetPriceSet 
	 指定采购价目表：FMSelfPurPriceListId 
	 指定结算价目表：FMSelfPriceListId 
自定义维度设置：FCustomPriceSet 
	 实体主键：FENTRYID 
	 自定义价格类型：FCustomPriceType 
	 费用：FCost 
	 待摊数量：FPrepaidQty 
	 自定义待摊费用成本上浮比率(%)：FCustCostUpRate 
	 费用项目(基础资料)：FCostItemId 
	 费用名称：FCostOfName 
报价物料：FMaterialEntity 
	 实体主键：FENTRYID 
	 客户物料编码：FMapId 
	 客户物料名称：FMapName 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 BOM来源组织：FSupplyOrgId  (必填项)
	 BOM：FBomId  (必填项)
	 计量单位：FUnitID 
	 数量：FQty 
	 税率(%)：FTaxRate 
	 成本上浮率(%)：FCostFloatingRate 
	 基本计量单位：FBaseUnitID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SAL_SCHEDULESIMULATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FPlanBeginDate":"1900-01-01","FExecuteTime":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteInterval":0,"FExecuteIntervalUnit":"","FScheduledId":{"FNAME":""},"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FGETTAXPRICE":"false","FConsiderCPRate":"false","FOrgId":{"FNUMBER":""},"FExpandWGMaterial":"false","FCusId":{"FNUMBER":""},"FOnlyIssueMaterial":"false","FConsiderLossRate":"false","FCurrId":{"FNUMBER":""},"FCalcSkipFee":"false","FSkipSelfMadeOnlyVolCalc":"false","FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}],"FMaterialPriceSet":[{"FENTRYID":0,"FMaterialPriceType":"","FMaterialPriceSource":"","FMaterialPriority":0,"FGetPriceSet":"","FPriceOrgId":{"FNumber":""}}],"FSubcontractSet":[{"FENTRYID":0,"FSubcontractPriceType":"","FSubcontractPriceSrc":"","FSubcontractPriority":0,"FSubGetPriceSet":"","FSubPriceOrgId":{"FNumber":""}}],"FSelfMadePriceSet":[{"FENTRYID":0,"FSelfMadePriceType":"","FSelfMadePriceSrc":"","FSelfMadePrior":0,"FSelfGetPriceSet":""}],"FCustomPriceSet":[{"FENTRYID":0,"FCustomPriceType":"","FCostOfName":"","FCost":0,"FPrepaidQty":0,"FCustCostUpRate":0,"FCostItemId":{"FNUMBER":""}}],"FMaterialEntity":[{"FENTRYID":0,"FMapId":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FSupplyOrgId":{"FNumber":""},"FBomId":{"FNumber":""},"FUnitID":{"FNumber":""},"FQty":0,"FTaxRate":0,"FCostFloatingRate":0,"FBaseUnitID":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SAL_SCHEDULESIMULATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SAL_SCHEDULESIMULATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SAL_SCHEDULESIMULATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SAL_SCHEDULESIMULATE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SAL_SCHEDULESIMULATE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SAL_SCHEDULESIMULATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SAL_SCHEDULESIMULATE"}");

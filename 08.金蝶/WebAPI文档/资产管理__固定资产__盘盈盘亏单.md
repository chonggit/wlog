# 盘盈盘亏单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 盘盈盘亏单
...
client.Draft("FA_CountingSheet","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FIsProfit":"false","FAcctPolicyCombo":"","FAcctPolicyBd":{"FNumber":""},"FPositionFullName":"false","FInventUser":"false","FInventUseDept":"false","FInventPosition":"false","FCountRptId":0,"FAssetOrgId":{"FNumber":""},"FInventSchemeId":{"FBILLNO":""},"FCountRptNo":"","FEntity":[{"FEntryID":0,"FOwnerOrgId":{"FNumber":""},"FAssetTypeId":{"FNumber":""},"FCardNumber":"","FAssetName":"","FAssetNumber":"","FAssetUnitId":{"FNumber":""},"FBookQty":0,"FBookPositionId":{"FNumber":""},"FBookUseDeptId":{"FNumber":""},"FBookUserId":{},"FActualQty":0,"FActPositionId":{"FNumber":""},"FActUseDeptId":{"FNumber":""},"FActUserId":{},"FQty":0,"FCurrencyId":{"FNumber":""},"FProfitValue":0,"FLostOriginalValue":0,"FLostNetValue":0,"FHasCreatedCard":"false","FHasDisposaled":"false","FAcctPolicyId":{"FNumber":""},"FAlterId":{"FNumber":""},"FBFLowId":{"FName":""},"FSourceBillId":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FProfitValue": 0,
                "FLostOriginalValue": 0,
                "FLostNetValue": 0,
                "FHasCreatedCard": "false",
                "FHasDisposaled": "false",
                "FAcctPolicyId": {
                    "FNumber": ""
                },
                "FAlterId": {
...
单据头：FBillHead 
	 ...
	 资产盘点表：FCountRptNo 
	 是否盘盈：FIsProfit 
	 会计政策：FAcctPolicyCombo 
	 会计政策(基础资料)：FAcctPolicyBd 
	 币别：FCurrencyProperty 
...
单据体：FEntity 
	 ...
	 账存使用人：FBookUserId 
	 实际资产位置：FActPositionId 
	 实际使用部门：FActUseDeptId 
	 实际使用人：FActUserId 
	 业务流程：FBFLowId 
	 数量：FQty 
	 估值--金额：FProfitValue 
	 金额--原值：FLostOriginalValue 
	 金额--净值：FLostNetValue 
	 账存数量：FBookQty 
	 资产实际数量：FActualQty 
	 货主组织：FOwnerOrgId 
	 源单分录内码：FSourceBillId 
关联关系表：FEntity_Link 
	 实体主键：FLinkId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_CountingSheet","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FIsProfit":"false","FAcctPolicyCombo":"","FAcctPolicyBd":{"FNumber":""},"FPositionFullName":"false","FInventUser":"false","FInventUseDept":"false","FInventPosition":"false","FCountRptId":0,"FAssetOrgId":{"FNumber":""},"FInventSchemeId":{"FBILLNO":""},"FCountRptNo":"","FEntity":[{"FEntryID":0,"FOwnerOrgId":{"FNumber":""},"FAssetTypeId":{"FNumber":""},"FCardNumber":"","FAssetName":"","FAssetNumber":"","FAssetUnitId":{"FNumber":""},"FBookQty":0,"FBookPositionId":{"FNumber":""},"FBookUseDeptId":{"FNumber":""},"FBookUserId":{},"FActualQty":0,"FActPositionId":{"FNumber":""},"FActUseDeptId":{"FNumber":""},"FActUserId":{},"FQty":0,"FCurrencyId":{"FNumber":""},"FProfitValue":0,"FLostOriginalValue":0,"FLostNetValue":0,"FHasCreatedCard":"false","FHasDisposaled":"false","FAcctPolicyId":{"FNumber":""},"FAlterId":{"FNumber":""},"FBFLowId":{"FName":""},"FSourceBillId":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_CountingSheet","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_CountingSheet","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_CountingSheet","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_CountingSheet","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_CountingSheet","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("FA_CountingSheet","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_CountingSheet"}");

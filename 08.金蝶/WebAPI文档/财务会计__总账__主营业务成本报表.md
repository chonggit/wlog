# 主营业务成本报表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 总账 > 主营业务成本报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 1713 |
...
client.GetSysReportData("k24f77692f1304d71ab3cf57e7a1d14f1","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSTARTYEAR":""}}");

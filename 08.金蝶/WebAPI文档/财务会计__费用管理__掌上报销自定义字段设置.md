# 掌上报销自定义字段设置 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 费用管理 > 掌上报销自定义字段设置
...
client.Delete("ER_MBReimbExtFieldCfg","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ER_MBReimbExtFieldCfg","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ER_MBReimbExtFieldCfg","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPEID":{"FID":""},"FMobileConfigEntity":[{"FENTRYID":0,"FFIELDKEY":"","FFIELDNAME":"","FISSHOWFORFOLD":"false","FIsSysDefault":"false","FISSHOWONWHENEDIT":"false","FISSHOWWHENVIEW":"false"}],"FMobileConfigV3Entity":[{"FENTRYID":0,"FV3FieldKey":"","FV3FieldName":"","FFieldVisible":"","FV3IsShowOnWhenEdit":"false","FV3IsShowWhenView":"false","FSrcBillEntity":"","FV3IsShowForFold":"false"}]}}");
        ...
        "FMobileConfigEntity": [
            {
                ...
                "FFIELDKEY": "",
                "FFIELDNAME": "",
                "FISSHOWFORFOLD": "false",
                "FIsSysDefault": "false",
                "FISSHOWONWHENEDIT": "false",
                "FISSHOWWHENVIEW": "false"
            }
        ],
        "FMobileConfigV3Entity": [
            {
                "FENTRYID": 0,
                "FV3FieldKey": "",
                "FV3FieldName": "",
                "FFieldVisible": "",
                "FV3IsShowOnWhenEdit": "false",
                "FV3IsShowWhenView": "false",
                "FSrcBillEntity": "",
                "FV3IsShowForFold": "false"
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 描述：FDescription 
	 单据：FBILLTYPEID  (必填项)
字段配置V2：FMobileConfigEntity 
	 实体主键：FENTRYID 
	 字段标识：FFIELDKEY 
	 新增修改可见：FISSHOWONWHENEDIT 
	 查看可见：FISSHOWWHENVIEW 
	 字段名称：FFIELDNAME 
	 折叠时显示：FISSHOWFORFOLD 
	 系统预置：FIsSysDefault 
字段配置V3：FMobileConfigV3Entity 
	 实体主键：FENTRYID 
	 字段标识：FV3FieldKey  (必填项)
	 字段名称：FV3FieldName 
	 来源单据体：FSrcBillEntity 
	 字段可见性：FFieldVisible 
	 新增修改可见：FV3IsShowOnWhenEdit 
	 查看可见：FV3IsShowWhenView 
	 折叠时可见：FV3IsShowForFold 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ER_MBReimbExtFieldCfg","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBILLTYPEID":{"FID":""},"FMobileConfigEntity":[{"FENTRYID":0,"FFIELDKEY":"","FFIELDNAME":"","FISSHOWFORFOLD":"false","FIsSysDefault":"false","FISSHOWONWHENEDIT":"false","FISSHOWWHENVIEW":"false"}],"FMobileConfigV3Entity":[{"FENTRYID":0,"FV3FieldKey":"","FV3FieldName":"","FFieldVisible":"","FV3IsShowOnWhenEdit":"false","FV3IsShowWhenView":"false","FSrcBillEntity":"","FV3IsShowForFold":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ER_MBReimbExtFieldCfg","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ER_MBReimbExtFieldCfg","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ER_MBReimbExtFieldCfg","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ER_MBReimbExtFieldCfg","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ER_MBReimbExtFieldCfg","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ER_MBReimbExtFieldCfg","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ER_MBReimbExtFieldCfg","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ER_MBReimbExtFieldCfg"}");

...
client.Delete("PLM_STD_NEW_TR_REVIEWBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PLM_STD_NEW_TR_REVIEWBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPRDID":{"FCODE":""},"FPRDDESC":"","FChkListLanguage":"","FName":"","FDescription":"","FBillNo":"","FReviewType":"","FRemainingProblems":"","FSignSuggestion":"","FTRID":"","FPRJTYPE":"","FISCMEAttack":"","FCMEID":{"FUSERACCOUNT":""},"FSEUserId":{"FUSERACCOUNT":""},"FCntSignUserID":{"FUSERACCOUNT":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FRecordTime":"1900-01-01","FEntity":[{"FEntryID":0,"FAcceptActivityId":{"FNUMBER":""}}],"FRvwSelfChkEntry":[{"FEntryID":0,"FSelfChkRoleId":{"FNUMBER":""},"FSCIsGroup":"false","FTRZJGUID":"","FSCType":""}],"FRvwCntSgnEntry":[{"FEntryID":0,"FCounterSignRoleId":{"FNUMBER":""},"FCSIsGroup":"false","FDataSource":"","FFROMTRZJGUID":"","FCSType":""}],"FAttchEntry":[{"FEntryID":0,"FAttIcon":"","FAttachObject":{"FCODE":""},"FAttchEntryBillerId":{"FUSERACCOUNT":""}}],"FRvwQltGoalStuEntry":[{"FEntryID":0,"FTRQltGoal":{"FNUMBER":""},"FBaseLine":"","FGoal":"","FActually":"","FGoalDesc":""}],"FRvwRiskAdvnceEntry":[{"FEntryID":0,"FRiskType":"","FRiskDesc":"","FOccurrence":"","FInfluence":"","FRiskLevel":"","FRiskInflDesc":"","FMeasure":"","FPlanTime":"1900-01-01","FResponPerson":{"FUSERACCOUNT":""},"FRiskDiscovererArbtrt":{"FUSERACCOUNT":""},"FRiskCloseReasonArbtrt":"","FIsRiskCLose":"false","FRiskEntryBillerId":{"FUSERACCOUNT":""}}],"FRvwRiskAdvncViewEntry":[{"FEntryID":0,"FRiskTypeView":"","FRiskDescView":"","FOccurrenceView":"","FInfluenceView":"","FRiskLevelView":"","FRiskInflDescView":"","FMeasureView":"","FPlanTimeView":"1900-01-01","FResponPersonView":{"FUSERACCOUNT":""},"FRiskDiscovererView":{"FSTAFFNUMBER":""},"FRiskCloseReasonView":""}],"FRvwCntSgnViewEntry":[{"FEntryID":0,"FROLEID":{"FNUMBER":""},"FCntAcceptActivityId":{"FNUMBER":""},"FRvwConclusion":"","FRvwConclusionDesc":"","FCntSgnEntryBillerId":{"FUSERACCOUNT":""},"FSignCreateDate":"1900-01-01"}],"FCMEEntry":[{"FEntryID":0,"FCMEAttackId":{"FCODE":""},"FFutrueLife":{"FVALUE":""}}],"FReportUsersEntry":[{"FEntryID":0,"FCheckBox":"false","FType":"","FRoleType":{"FNUMBER":""},"FRUIsGroup":"false","FUser":{"FUSERACCOUNT":""},"FOpnion":"","FTRBGHQRADD":""}]}}");
        ...
        "FRvwRiskAdvnceEntry": [
            {
                ...
                "FRiskInflDesc": "",
                "FMeasure": "",
                "FPlanTime": "1900-01-01",
                "FResponPerson": {
                    "FUSERACCOUNT": ""
                },
                "FRiskDiscovererArbtrt": {
                    "FUSERACCOUNT": ""
                },
                "FRiskCloseReasonArbtrt": "",
                "FIsRiskCLose": "false",
                "FRiskEntryBillerId": {
                    "FUSERACCOUNT": ""
                }
        ...
        "FRvwCntSgnViewEntry": [
            {
                ...
                "FCntAcceptActivityId": {
                    "FNUMBER": ""
                },
                "FRvwConclusion": "",
                "FRvwConclusionDesc": "",
                "FCntSgnEntryBillerId": {
                    "FUSERACCOUNT": ""
                },
                "FSignCreateDate": "1900-01-01"
            }
        ],
        "FCMEEntry": [
            {
...
单据头：FBillHead 
	 ...
	 名称：FName  (必填项)
	 摘要：FDescription 
	 评审类型：FReviewType  (必填项)
	 CheckList语言：FChkListLanguage  (必填项)
	 上次TR遗留问题改进情况说明：FRemainingProblems 
	 签发意见：FSignSuggestion 
	 技术评审点：FTRID  (必填项)
	 项目类型：FPRJTYPE  (必填项)
	 附属子项：FISCMEAttack 
	 CME：FCMEID 
	 SE：FSEUserId  (必填项)
	 签发人：FCntSignUserID  (必填项)
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 签发日期：FRecordTime 
后续活动：FEntity 
	 实体主键：FEntryID 
	 后续活动：FAcceptActivityId 
TR自检人：FRvwSelfChkEntry 
	 实体主键：FEntryID 
	 专家角色：FSelfChkRoleId  (必填项)
	 参与者：FSelfChkPersonId 
	 TR自检GUID隐藏：FTRZJGUID 
	 类型隐藏：FSCType 
	 是否群组：FSCIsGroup 
TR会签人：FRvwCntSgnEntry 
	 实体主键：FEntryID 
	 专家角色：FCounterSignRoleId  (必填项)
	 参与者：FCounterSignPersonId 
	 数据来源标识（隐藏）：FDataSource 
	 来于TR自检GUID隐藏 不保存：FFROMTRZJGUID 
	 类型隐藏：FCSType 
	 是否群组：FCSIsGroup 
附件：FAttchEntry 
	 实体主键：FEntryID 
	 ...
	 编码：FAttachObject 
	 名称：FAttachName 
	 创建人：FAttchEntryBillerId 
	 更新时间：FAttachModifyDate 
	 更新人：FAttachModifier 
质量目标完成情况：FRvwQltGoalStuEntry 
	 实体主键：FEntryID 
	 基线：FBaseLine 
	 目标：FGoal 
	 实际：FActually 
...
填写风险分析建议：FRvwRiskAdvnceEntry 
	 ...
	 影响程度：FInfluence 
	 风险等级：FRiskLevel  (必填项)
	 风险影响描述：FRiskInflDesc 
	 对应措施：FMeasure 
	 计划解决时间：FPlanTime 
	 责任人：FResponPerson 
	 关闭原因：FRiskCloseReasonArbtrt 
	 关闭：FIsRiskCLose 
	 风险发现人：FRiskDiscovererArbtrt 
	 创建人：FRiskEntryBillerId 
查看风险信息：FRvwRiskAdvncViewEntry 
	 实体主键：FEntryID 
	 风险类型：FRiskTypeView 
	 风险描述：FRiskDescView 
	 发生概率：FOccurrenceView 
	 影响程度：FInfluenceView 
	 风险等级：FRiskLevelView 
	 风险影响描述：FRiskInflDescView 
	 对应措施：FMeasureView 
	 计划解决时间：FPlanTimeView 
	 责任人：FResponPersonView 
	 风险发现人：FRiskDiscovererView 
	 关闭原因：FRiskCloseReasonView 
会签意见：FRvwCntSgnViewEntry 
	 实体主键：FEntryID 
	 后续活动：FCntAcceptActivityId  (必填项)
	 评审结论：FRvwConclusion  (必填项)
	 结论陈述：FRvwConclusionDesc  (必填项)
	 创建人：FCntSgnEntryBillerId 
	 创建日期：FSignCreateDate 
	 角色：FROLEID 
CME添加附属子项：FCMEEntry 
	 实体主键：FEntryID 
	 编码：FCMEAttackId 
	 名称：FCMEAttackName 
	 版本：FCMEAttackVer 
	 生命周期阶段：FCMEAttackStage 
	 所有者：FCMEAttackOwner 
	 备注：FCMEAttackRemark 
	 规格：FCMEAttackSpecification 
	 型号：FCMEAttackModel 
	 转到的生命周期：FFutrueLife 
	 版次：FCMEAttackBuildVer 
TR报告会签人：FReportUsersEntry 
	 实体主键：FEntryID 
	 指派会签任务：FCheckBox 
	 类型：FType 
	 会签角色：FRoleType 
	 带入已填写的意见：FOpnion 
	 会签人：FUser 
	 TR报告会签人添加记录标识（隐藏）不保存：FTRBGHQRADD 
	 是否群组：FRUIsGroup 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLM_STD_NEW_TR_REVIEWBILL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PLM_STD_NEW_TR_REVIEWBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PLM_STD_NEW_TR_REVIEWBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PLM_STD_NEW_TR_REVIEWBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_STD_NEW_TR_REVIEWBILL"}");

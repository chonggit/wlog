...
client.Delete("BAS_BusinessVoucher","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BAS_BusinessVoucher","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BAS_BusinessVoucher","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FVoucherID":0,"FAccountBookID":{"FNumber":""},"FSystemID":{"FNumber":""},"FDate":"1900-01-01","FYEAR":0,"FPERIOD":0,"FSourceBillNo":"","FVOUCHERGROUPID":{"FNumber":""},"FIsError":"false","FBASECURRENCYID":{"FNumber":""},"FIsUpdate":"false","FBillNo":"","FSourceBillID":0,"FSourceBillKey":{"FNumber":""},"FDEBITTOTAL":0,"FCREDITTOTAL":0,"FDocumentStatus":"","FIsIniVoucher":"false","FExStatus":"false","FVchSort":"","FCreateDate":"1900-01-01","FBusDate":"1900-01-01","FEntity":[{"FEntryID":0,"FEXPLANATION":"","FACCOUNTID":{"FNumber":""},"FDetailID":{"FDETAILID__FFLEX9":{"FNumber":""},"FDETAILID__FFLEX10":{"FNumber":""},"FDETAILID__FFLEX11":{"FNumber":""},"FDETAILID__FFLEX12":{"FNumber":""},"FDETAILID__FFLEX13":{"FNumber":""},"FDETAILID__FF100002":{"FNumber":""},"FDETAILID__FFLEX4":{"FNumber":""},"FDETAILID__FF100003":{"FNumber":""},"FDETAILID__FFLEX5":{"FNumber":""},"FDETAILID__FF100004":{"FNumber":""},"FDETAILID__FFLEX6":{"FNumber":""},"FDETAILID__FF100005":{"FNumber":""},"FDETAILID__FFLEX7":{"FNumber":""},"FDETAILID__FF100006":{"FNumber":""},"FDETAILID__FFLEX8":{"FNumber":""},"FDETAILID__FF100007":{"FNumber":""},"FDETAILID__FF100008":{"FNumber":""},"FDETAILID__FF100009":{"FNumber":""}},"FCURRENCYID":{"FNumber":""},"FEXCHANGERATETYPE":{"FNumber":""},"FEXCHANGERATE":0,"FUnitId":{"FNUMBER":""},"FPrice":0,"FQty":0,"FAMOUNTFOR":0,"FDEBIT":0,"FCREDIT":0,"FSETTLETYPEID":{"FNumber":""},"FSettleNo":"","FAutomatic":"","FBUSNO":"","FVchTemplateInfo":""}]}}");
...
单据头：FBillHead 
	 ...
	 总账凭证：FBuildGlVoucher 
	 总账凭证id：FGLVoucherID 
	 对应总账凭证号：FVoucherGroupNo 
	 本位币(辅助)：FBASECURRENCYID 
	 是否有手工修改：FIsUpdate 
	 是否有错误：FIsError 
	 期初业务凭证：FIsIniVoucher 
	 异常凭证：FExStatus 
	 附件数：FAttachMents 
	 凭证排序来源取值：FVchSort 
	 作废状态：FInvalid 
...
凭证分录：FEntity 
	 ...
	 财务类别：FF100009
	 币别：FCURRENCYID 
	 汇率类型：FEXCHANGERATETYPE 
	 汇率：FEXCHANGERATE 
	 原币金额：FAMOUNTFOR 
	 借方金额：FDEBIT 
	 贷方金额：FCREDIT 
	 科目维度属性：FAccountFlexItemId 
	 结算方式：FSETTLETYPEID 
	 是否自动生成：FAutomatic 
	 结算号：FSettleNo 
	 科目全名：FAccoutFullName 
	 单位：FUnitId 
	 单价：FPrice 
	 数量：FQty 
	 业务编号：FBUSNO 
	 凭证模板信息：FVchTemplateInfo 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BAS_BusinessVoucher"}");

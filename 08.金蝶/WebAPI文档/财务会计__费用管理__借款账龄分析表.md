# 借款账龄分析表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 费用管理 > 借款账龄分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3352 |
...
client.GetSysReportData("ER_AgingAnalysis","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAffiliation":{"FNUMBER":""},"FCONTACTUNITTYPE":"","FCONTACTUNITFrom":{"FNumber":""},"FCONTACTUNITTo":{"FNumber":""},"FCurrency":{"FNUMBER":""},"FEXPIDFrom":{"FNUMBER":""},"FEXPIDTO":{"FNUMBER":""},"FAgingDate":"1900-01-01","FByBill":"false","FAnalysisType":"","FByRefundDate":"","FIsFromFilter":"false","FByActualDate":"","FEXPENSEORGID":"","FEntAgingGrpSetting":[{"FSection":"","FDays":0}]}}");
...
五、字段说明：
	 ...
	 费用项目：FEXPIDFrom 
	 至：FEXPIDTO 
	 账龄计算日期：FAgingDate  (必填项)
	 按单据显示：FByBill 
	 来自过滤条件：FIsFromFilter 
	 费用承担组织：FEXPENSEORGID  (必填项)
	 单选按钮组：FAnalysisType 
	 按预计还款日计算天数：FByRefundDate 
	 按实际付款日计算天数：FByActualDate 
	 账龄分组设置：FSection 
	 天数：FDays 

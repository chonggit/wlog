# 资产领用单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 人人资产管理 > 资产领用单
...
client.Delete("FA_PICKINGAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_PICKINGAPPLY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FOwnerOrgID":{"FNumber":""},"FPickingDate":"1900-01-01","FReason":"","FPickingEntry":[{"FEntryID":0,"FAssetNumber":{"FASSETNO":""},"FAssetID":{"FNumber":""},"FUnitID":{"FNumber":""},"FQty":0,"FPickingDeptId":{"FNumber":""},"FPickingEmpId":{"FStaffNumber":""},"FPREPOSITIONID":{"FNUMBER":""},"FPOSITIONID":{"FNUMBER":""},"FAfterAlterId":0,"FPREKEEPERID":{"FSTAFFNUMBER":""},"FPickingFor":""}],"FPickingApply":[{"FApplyEntryID":0,"FAssetCategory":{"FNUMBER":""},"FApplyAssetName":"","FApplyQty":0,"FApplyDeptId":{"FNUMBER":""},"FApplyEmpId":{"FSTAFFNUMBER":""},"FRemark":""}]}}");
...
单据头：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 领用日期：FPickingDate  (必填项)
	 单据类型：FBillTypeID  (必填项)
	 我的组织：FOwnerOrgID  (必填项)
	 申请事由：FReason 
领用资产：FPickingEntry 
	 实体主键：FEntryID 
	 卡片编码：FAssetID  (必填项)
	 ...
	 领用用途：FPickingFor 
	 资产类别：FAssetGroup 
	 领用部门：FPickingDeptId  (必填项)
	 领用人：FPickingEmpId 
	 资产名称：FAssetName 
	 领用数量：FQty 
	 计量单位：FUnitID 
	 资产编码：FAssetNumber  (必填项)
	 领用前资产位置：FPREPOSITIONID 
	 领用后资产位置：FPOSITIONID 
	 原保管人：FPREKEEPERID 
	 变更后ID：FAfterAlterId 
申请资产：FPickingApply 
	 实体主键：FApplyEntryID 
	 实物类别：FAssetCategory  (必填项)
	 数量：FApplyQty 
	 申请部门：FApplyDeptId  (必填项)
	 申请人：FApplyEmpId  (必填项)
	 备注：FRemark 
	 申请资产名称：FApplyAssetName  (必填项)
关联关系表：FPickingEntry_Link 
	 实体主键：FLinkId 
	 业务流程图：FPickingEntry_Link_FFlowId 
	 推进路线：FPickingEntry_Link_FFlowLineId 
	 转换规则：FPickingEntry_Link_FRuleId 
	 源单表内码：FPickingEntry_Link_FSTableId 
	 源单表：FPickingEntry_Link_FSTableName 
	 源单内码：FPickingEntry_Link_FSBillId 
	 源单分录内码：FPickingEntry_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_PICKINGAPPLY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FOwnerOrgID":{"FNumber":""},"FPickingDate":"1900-01-01","FReason":"","FPickingEntry":[{"FEntryID":0,"FAssetNumber":{"FASSETNO":""},"FAssetID":{"FNumber":""},"FUnitID":{"FNumber":""},"FQty":0,"FPickingDeptId":{"FNumber":""},"FPickingEmpId":{"FStaffNumber":""},"FPREPOSITIONID":{"FNUMBER":""},"FPOSITIONID":{"FNUMBER":""},"FAfterAlterId":0,"FPREKEEPERID":{"FSTAFFNUMBER":""},"FPickingFor":""}],"FPickingApply":[{"FApplyEntryID":0,"FAssetCategory":{"FNUMBER":""},"FApplyAssetName":"","FApplyQty":0,"FApplyDeptId":{"FNUMBER":""},"FApplyEmpId":{"FSTAFFNUMBER":""},"FRemark":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_PICKINGAPPLY","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_PICKINGAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_PICKINGAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("FA_PICKINGAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("FA_PICKINGAPPLY","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("FA_PICKINGAPPLY","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_PICKINGAPPLY","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_PICKINGAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("FA_PICKINGAPPLY","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_PICKINGAPPLY"}");

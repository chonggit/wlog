...
client.Delete("CRE_CustArchives","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRE_CustArchives","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgId":{"FNumber":""},"FObjectType":"","FDate":"1900-01-01","FNote":"","FCtrlScope":"","FDeptId":{"FNUMBER":""},"FIsCheckDate":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FEntity":[{"FEntryID":0,"FObjectId":{"FNumber":""},"FCurrencyId":{"FNumber":""},"FCreditStatus":"","FCreditGrade":{"FNumber":""},"FCheckRuleId":{"FNumber":""},"FCreditAmount":0,"FCreditRate":0,"FLimitAmount":0,"FOverDays":0,"FOverAmount":0,"FOverARRate":0,"FEffectiveDate":"1900-01-01","FCheckPeriod":0,"FPressBatchCount":"","FCreDetailEntity":[{"FDetailID":0,"FSubCreditAmount":0,"FSubCreditRate":0,"FSubLimitAmount":0,"FSubOverDays":0,"FSubOverAmount":0,"FSubOverARRate":0,"FSubEffectiveDate":"1900-01-01","FSubCheckPeriod":0,"FSubInvalidDate":"1900-01-01"}],"FExpEntity":[{"FDetailID":0,"FExpCustId":{"FNUMBER":""},"FExpCustMasterId":{"FNUMBER":""}}]}]}}");
...
授信内容：FCreDetailEntity 
	 实体主键：FDetailID 
	 有效期_信用额度：FSubCreditAmount 
	 有效期_信用比例%：FSubCreditRate 
	 有效期_单笔限额：FSubLimitAmount 
	 有效期_逾期天数：FSubOverDays 
	 有效期_逾期额度：FSubOverAmount 
	 有效期_逾期比例%：FSubOverARRate 
	 有效期_生效日期：FSubEffectiveDate 
	 有效期_复查周期(天)：FSubCheckPeriod 
	 有效期_失效日期：FSubInvalidDate 
例外单据体：FExpEntity 
	 实体主键：FDetailID 
	 例外客户：FExpCustId 
	 例外客户MASTERID：FExpCustMasterId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRE_CustArchives","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FOrgId":{"FNumber":""},"FObjectType":"","FDate":"1900-01-01","FNote":"","FCtrlScope":"","FDeptId":{"FNUMBER":""},"FIsCheckDate":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FEntity":[{"FEntryID":0,"FObjectId":{"FNumber":""},"FCurrencyId":{"FNumber":""},"FCreditStatus":"","FCreditGrade":{"FNumber":""},"FCheckRuleId":{"FNumber":""},"FCreditAmount":0,"FCreditRate":0,"FLimitAmount":0,"FOverDays":0,"FOverAmount":0,"FOverARRate":0,"FEffectiveDate":"1900-01-01","FCheckPeriod":0,"FPressBatchCount":"","FCreDetailEntity":[{"FDetailID":0,"FSubCreditAmount":0,"FSubCreditRate":0,"FSubLimitAmount":0,"FSubOverDays":0,"FSubOverAmount":0,"FSubOverARRate":0,"FSubEffectiveDate":"1900-01-01","FSubCheckPeriod":0,"FSubInvalidDate":"1900-01-01"}],"FExpEntity":[{"FDetailID":0,"FExpCustId":{"FNUMBER":""},"FExpCustMasterId":{"FNUMBER":""}}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRE_CustArchives","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CRE_CustArchives","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CRE_CustArchives","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CRE_CustArchives","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CRE_CustArchives","RowAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CRE_CustArchives","RowReject","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CRE_CustArchives","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CRE_CustArchives","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CRE_CustArchives","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRE_CustArchives"}");

# 原材料条码追溯报表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 原材料条码追溯报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 1943 |
...
client.GetSysReportData("RawMatBarCodeTrackRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FDateStart":"1900-01-01","FDateEnd":"1900-01-01","FBarcode":"","FPrdPickMtrlBillNo":""}}");

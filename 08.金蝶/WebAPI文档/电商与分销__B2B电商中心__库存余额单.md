# 库存余额单 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > B2B电商中心 > 库存余额单
...
| 提交 | StatusConvert | 1697 |
| 撤销 | CancelSubmitStatusConvert | 1711 |
| 批量保存 | BatchSave | 3055 |
...
client.Delete("CP_StockBalances","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CP_StockBalances","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FIsCPCreate":"false","FAPPROVEDATE":"1900-01-01","FApproverId":{"FUserID":""},"FIsCPUser":"false","FSubmitDate":"1900-01-01","FSubmiter":{"FUserID":""},"FModifyDate":"1900-01-01","FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateOrg":{"FNumber":""},"FRemarks":"","FStockEndDate":"1900-01-01","FReportCust":{"FNUMBER":""},"FREPORTDATE":"1900-01-01","FOrderOrgId":{"FNumber":""},"FCurrencyId":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FCUSTMATERIALID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FSTOCKQTY":0,"FBASEUNITID":{"FNumber":""},"FBaseQty":0,"FPrice":0,"FAmount":0,"FGoodsPublishId":{"FNUMBER":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FRemarks": "",
        "FStockEndDate": "1900-01-01",
        "FReportCust": {
            "FNUMBER": ""
        },
        "FREPORTDATE": "1900-01-01",
        "FOrderOrgId": {
            "FNumber": ""
        },
        "FCurrencyId": {
...
单据头：FBillHead 
	 ...
	 上报日期：FREPORTDATE 
	 上报客户：FReportCust  (必填项)
	 库存截止日期：FStockEndDate 
	 备注：FRemarks 
	 创建组织：FCreateOrg 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
...
单据体：FEntity 
	 ...
	 库存余额：FSTOCKQTY 
	 基本单位数量：FBaseQty 
	 客户产品编码：FCUSTMATERIALID 
	 客户产品名称：FCUSTMATERIALNAME 
	 价格：FPrice 
	 金额：FAmount 
	 商品：FGoodsPublishId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CP_StockBalances","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FIsCPCreate":"false","FAPPROVEDATE":"1900-01-01","FApproverId":{"FUserID":""},"FIsCPUser":"false","FSubmitDate":"1900-01-01","FSubmiter":{"FUserID":""},"FModifyDate":"1900-01-01","FModifierId":{"FUserID":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateOrg":{"FNumber":""},"FRemarks":"","FStockEndDate":"1900-01-01","FReportCust":{"FNUMBER":""},"FREPORTDATE":"1900-01-01","FOrderOrgId":{"FNumber":""},"FCurrencyId":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FCUSTMATERIALID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FSTOCKQTY":0,"FBASEUNITID":{"FNumber":""},"FBaseQty":0,"FPrice":0,"FAmount":0,"FGoodsPublishId":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CP_StockBalances","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CP_StockBalances","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CP_StockBalances","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CP_StockBalances","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CP_StockBalances","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.StatusConvert("CP_StockBalances","StatusConvert","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CP_StockBalances","CancelSubmitStatusConvert","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CP_StockBalances","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CP_StockBalances"}");

# 资产领用结存表 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 资产领用结存表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2333 |
...
client.GetSysReportData("FA_AssetPickBalanceList","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FBeginPeriod":"","FOwnerOrgID":"","FYear":"","FAcctPolicyID":"","FAcctOrgID":"","FEndPeriod":""}}");

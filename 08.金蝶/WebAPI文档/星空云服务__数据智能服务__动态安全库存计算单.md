# 动态安全库存计算单 Web API 操作原始内容

> 来源页面：全部 > 星空云服务 > 数据智能服务 > 动态安全库存计算单
...
client.Delete("DI_SafeStockCalc","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("DI_SafeStockCalc","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FUseOrgId":{"FNumber":""},"FCalculatePlan":"","FMaterialScopeType":"","FCalculateDimension":"","FCalcPeriod":"","FStatisticalPeriod":0,"FPeriod":"","FPeriodScope":"","FBillSource":"","FSourceBillNo":"","FCalcStatus":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FDefaultCalculateModel":"","FDefaultServiceLevel":0,"FCalcDate":"1900-01-01","FCalculatePlanId":0,"FSourceBillId":0,"FLeadTime":"","FCalcEntryEntity":[{"FEntryID":0,"FMaterialId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FStockId":{"FNUMBER":""},"FBOMId":{"FNUMBER":""},"FNMTONo":"","FBaseUnitID":{"FNumber":""},"FCurSafeStockCost":0,"FAvgPurchaseLead":0,"FAvgPrdLead":0,"FMatFixLead":0,"FAdoptLead":0,"FUpdateLeadTime":"1900-01-01","FAvgDailyConsume":0,"FCalcModel":"","FExpectServiceLevel":0,"FRecommendSafeStock":0,"FAdoptSafeStock":0,"FDssAvailableDays":0,"FAdoptSSCost":0,"FUpdateSafeStockTime":"1900-01-01","FInventoryQty":0,"FVarCoe":0,"FSalServiceLevel":0,"FPrdServiceLevel":0,"FInvAvailableDays":0,"FRefMtrlCost":0,"FIndex1":"","FIndex2":"","FIndex3":"","FIndex4":"","FIndex5":"","FIndex6":"","FIndex7":"","FIndex8":"","FIndex9":"","FIndex10":"","FIndex11":"","FIndex12":"","FIndex13":"","FIndex14":"","FIndex15":"","FSalServiceLevelStr":"","FPrdServiceLevelStr":""}],"FCalculationRecord":[{"FEntryID":0,"FSubBillNo":"","FDssDate":"1900-01-01","FSubStatus":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDefaultCalculateModel": "",
        "FDefaultServiceLevel": 0,
        ...
        "FCalcEntryEntity": [
            {
                ...
                "FMatFixLead": 0,
                "FAdoptLead": 0,
                "FUpdateLeadTime": "1900-01-01",
                "FAvgDailyConsume": 0,
                "FCalcModel": "",
                "FExpectServiceLevel": 0,
                "FRecommendSafeStock": 0,
                "FAdoptSafeStock": 0,
                "FDssAvailableDays": 0,
                "FAdoptSSCost": 0,
                "FUpdateSafeStockTime": "1900-01-01",
                "FInventoryQty": 0,
                "FVarCoe": 0,
                "FSalServiceLevel": 0,
                "FPrdServiceLevel": 0,
...
动态安全库存计算单：FBillHead 
	 ...
	 单据编号：FBillNo 
	 使用组织：FUseOrgId  (必填项)
	 计算方案：FCalculatePlan  (必填项)
	 物料范围类型：FMaterialScopeType 
	 单据状态：FBillStatus 
	 计算维度：FCalculateDimension 
	 计算周期单位：FCalcPeriod 
	 统计周期数：FStatisticalPeriod 
	 统计周期：FPeriod 
	 统计周期范围：FPeriodScope 
	 单据来源：FBillSource 
	 来源单号：FSourceBillNo 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 默认计算模型：FDefaultCalculateModel 
	 默认服务水平：FDefaultServiceLevel 
	 计算时间：FCalcDate 
	 计算方案Id：FCalculatePlanId 
	 单据来源Id：FSourceBillId 
	 提前期：FLeadTime 
物料明细：FCalcEntryEntity 
	 实体主键：FEntryID 
	 物料编码：FMaterialId 
	 BOM版本：FBOMId 
	 辅助属性：FAuxPropId 
	 ...
	 计划跟踪号：FNMTONo 
	 仓库：FStockId 
	 当前安全库存成本（元）：FCurSafeStockCost 
	 计算模型：FCalcModel  (必填项)
	 期望服务水平（%）：FExpectServiceLevel 
	 日均消耗：FAvgDailyConsume 
	 采购平均提前期（天）：FAvgPurchaseLead 
	 生产平均提前期（天）：FAvgPrdLead 
	 采纳固定提前期（天）：FAdoptLead 
	 安全库存可用天数：FDssAvailableDays 
	 采纳安全库存成本（元）：FAdoptSSCost 
	 物料名称：FMaterialName 
	 规格型号：FMaterialModel 
	 物料属性：FErpClsId 
	 物料分组：FMaterialGroup 
	 系统当前安全库存：FMatSafeStock 
	 物料固定提前期：FMatFixLead 
	 最小库存：FMinStock 
	 再订货点：FReOrderGood 
	 ...
	 存货类别：FCategoryID 
	 固定提前期：FFixLeadTime 
	 固定提前期单位：FFixLeadTimeType 
	 变动提前期：FVarLeadTime 
	 变动提前期单位：FVarLeadTimeType 
	 检验提前期：FCheckLeadTime 
	 检验提前期单位：FCheckLeadTimeType 
	 累计提前期：FAccuLeadTime 
	 当前库存：FInventoryQty 
	 变动系数：FVarCoe 
	 实际服务水平（销售）弃用：FSalServiceLevel 
	 实际服务水平（生产）弃用：FPrdServiceLevel 
	 库存预计可用天数：FInvAvailableDays 
	 建议安全库存：FRecommendSafeStock 
	 采纳安全库存：FAdoptSafeStock 
	 基本单位：FBaseUnitID 
	 更新安全库存时间：FUpdateSafeStockTime 
	 更新提前期时间：FUpdateLeadTime 
	 指标1：FIndex1 
	 指标2：FIndex2 
	 指标3：FIndex3 
	 指标4：FIndex4 
	 ...
	 指标15：FIndex15 
	 参考物料成本：FRefMtrlCost 
	 实际服务水平（销售）：FSalServiceLevelStr 
	 实际服务水平（生产）：FPrdServiceLevelStr 
计算记录：FCalculationRecord 
	 实体主键：FEntryID 
	 单据编号：FSubBillNo 
	 单据状态：FSubStatus 
	 计算日期：FDssDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("DI_SafeStockCalc","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("DI_SafeStockCalc","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FUseOrgId":{"FNumber":""},"FCalculatePlan":"","FMaterialScopeType":"","FCalculateDimension":"","FCalcPeriod":"","FStatisticalPeriod":0,"FPeriod":"","FPeriodScope":"","FBillSource":"","FSourceBillNo":"","FCalcStatus":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FDefaultCalculateModel":"","FDefaultServiceLevel":0,"FCalcDate":"1900-01-01","FCalculatePlanId":0,"FSourceBillId":0,"FLeadTime":"","FCalcEntryEntity":[{"FEntryID":0,"FMaterialId":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FStockId":{"FNUMBER":""},"FBOMId":{"FNUMBER":""},"FNMTONo":"","FBaseUnitID":{"FNumber":""},"FCurSafeStockCost":0,"FAvgPurchaseLead":0,"FAvgPrdLead":0,"FMatFixLead":0,"FAdoptLead":0,"FUpdateLeadTime":"1900-01-01","FAvgDailyConsume":0,"FCalcModel":"","FExpectServiceLevel":0,"FRecommendSafeStock":0,"FAdoptSafeStock":0,"FDssAvailableDays":0,"FAdoptSSCost":0,"FUpdateSafeStockTime":"1900-01-01","FInventoryQty":0,"FVarCoe":0,"FSalServiceLevel":0,"FPrdServiceLevel":0,"FInvAvailableDays":0,"FRefMtrlCost":0,"FIndex1":"","FIndex2":"","FIndex3":"","FIndex4":"","FIndex5":"","FIndex6":"","FIndex7":"","FIndex8":"","FIndex9":"","FIndex10":"","FIndex11":"","FIndex12":"","FIndex13":"","FIndex14":"","FIndex15":"","FSalServiceLevelStr":"","FPrdServiceLevelStr":""}],"FCalculationRecord":[{"FEntryID":0,"FSubBillNo":"","FDssDate":"1900-01-01","FSubStatus":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("DI_SafeStockCalc","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("DI_SafeStockCalc","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("DI_SafeStockCalc","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("DI_SafeStockCalc","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("DI_SafeStockCalc","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"DI_SafeStockCalc"}");

# 第三方系统登录授权 Web API 操作原始内容

> 来源页面：全部 > 基础管理 > 安全管理 > 第三方系统登录授权
...
client.Delete("SEC_SimplePassport","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SEC_SimplePassport","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAppId":"","FAppName":"","FAppSecret":"","FForbidStatus":"","FValidityTime":0,"FUserName":{"FName":""},"FEnableWhite":"false","FWhiteList":"","FCiphertext":"","FRequireWhiteList":"","FLINKTYPE":"","FPERMITCOUNT":0,"FEnableAllUser":"false","FISLOGINATHEN":"false","FEntity":[{"FEntryID":0,"FUserId":{"FUSERACCOUNT":""}}]}}");
...
单据头：FBillHead 
	 ...
	 测试用户：FUserName 
	 是否启用白名单：FEnableWhite 
	 白名单列表：FWhiteList 
	 加密数据：FCiphertext 
	 启用状态：FRequireWhiteList  (必填项)
	 链接有效性：FLINKTYPE  (必填项)
	 允许登录次数：FPERMITCOUNT 
	 允许全部用户登录：FEnableAllUser 
	 是否二次登录认证：FISLOGINATHEN 
单据体：FEntity 
	 实体主键：FEntryID 
	 用户：FUserId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SEC_SimplePassport","Disable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SEC_SimplePassport","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SEC_SimplePassport","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SEC_SimplePassport"}");

# 生产订单工时对比分析表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 生产订单工时对比分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2820 |
...
client.GetSysReportData("SFC_MoTimeContrastRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgId":[{"FNumber":""}],"FBeginMONumber":"","FEndMONumber":"","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FPrdLineId":[{"FNumber":""}],"FTimeUnit":"","FMoStatus":""}}");

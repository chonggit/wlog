...
| 失效 | StatusConvert | 1692 |
| 取消失效 | StatusConvertUnEffective | 1705 |
| 业务失效 | EntryUnEffective | 1697 |
| 取消业务失效 | EntryEffective | 1695 |
| 审核 | Audit | 1876 |
| 提交 | Submit | 1605 |
| 反审核 | UnAudit | 1763 |
| 批量保存 | BatchSave | 3050 |
...
client.Delete("PUR_CATALOG","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_CATALOG","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPurchaseOrgId":{"FNumber":""},"FBillNo":"","FName":"","FRecentStatisticsDate":"1900-01-01","FDate":"1900-01-01","FPUR_CATALOGENTRY":[{"FENTRYID":0,"FSUPPLYTYPE":"","FMaterialId":{"FNumber":""},"FUnitID":{"FNumber":""},"FAxupropID":{"FAXUPROPID__FF100001":{"FNumber":""},"FAXUPROPID__FF100002":{"FNumber":""},"FAXUPROPID__FF100003":{"FNumber":""},"FAXUPROPID__FF100005":{"FNumber":""},"FAXUPROPID__FF100010":{"FNumber":""},"FAXUPROPID__FF100007":{"FNumber":""},"FAXUPROPID__FF100008":{"FNumber":""}},"FEtySupplierId":{"FNumber":""},"FSupplyStatus":"","FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FQuotaRatio":0,"FQuotaOrder":0,"FPrimarySupPro":"false","FSupMatId":"","FSupMatName":"","FAllOrderQty":0,"FAllOrderAmount":0,"FAllOrderNum":0,"FRecentOrderDate":"1900-01-01","FRecentOrderNo":"","FBaseUnitID":{"FNumber":""},"FMaxBaseOrderQty":0,"FMinBaseOrderQty":0,"FAllBaseOrderQty":0,"FFirstOrderDate":"1900-01-01","FMinpackagingQty":0,"FPayCondition":{"FNUMBER":""},"FSettleTypeId":{"FNUMBER":""},"FMinbasePackagingQty":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FBillNo": "",
        "FName": "",
        "FRecentStatisticsDate": "1900-01-01",
        "FDate": "1900-01-01",
        "FPUR_CATALOGENTRY": [
            {
                "FENTRYID": 0,
                ...
                "FAxupropID": {
                    "FAXUPROPID__FF100001": {
                        "FNumber": ""
                    },
                    "FAXUPROPID__FF100002": {
                        "FNumber": ""
                    },
                    "FAXUPROPID__FF100003": {
                        "FNumber": ""
                    },
                    "FAXUPROPID__FF100005": {
                        "FNumber": ""
                    },
                    "FAXUPROPID__FF100010": {
                        "FNumber": ""
                    },
                    "FAXUPROPID__FF100007": {
                        "FNumber": ""
                    },
                    "FAXUPROPID__FF100008": {
                        "FNumber": ""
                    }
                },
                "FEtySupplierId": {
                ...
                "FQuotaRatio": 0,
                "FQuotaOrder": 0,
                "FPrimarySupPro": "false",
                "FSupMatId": "",
                "FSupMatName": "",
                "FAllOrderQty": 0,
                "FAllOrderAmount": 0,
                "FAllOrderNum": 0,
                "FRecentOrderDate": "1900-01-01",
                "FRecentOrderNo": "",
                "FBaseUnitID": {
                    "FNumber": ""
                },
...
基本信息：FBillHead 
	 ...
	 名称：FName  (必填项)
	 使用组织：FUseOrgId 
	 最近统计日期：FRecentStatisticsDate 
	 审核日期：FApproveDate 
	 审核人：FApproverId 
	 创建组织：FCORGID 
货源信息：FPUR_CATALOGENTRY 
	 实体主键：FENTRYID 
	 ...
	 来源单据编号：FSrcBillNo 
	 业务失效：FEntryForbidStatus 
	 业务失效人：FEntryForbiderId 
	 业务失效日期：FEntryForbidDate 
	 订货次数：FOrderNum 
	 试用批量：FTrybatchNum 
	 最小订货数量：FMinOrderQty 
	 最大订货数量：FMaxOrderQty 
	 原产地：FPlaceOriginId 
	 证书生效日期：FCertEffectiveDate 
	 证书失效日期：FCertExpiryDate 
	 制造商：FManuFacturerId 
	 辅助属性：FAxupropID 
	 描述：FF100001
	 公差：FF100002
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 供应商对应物料名称：FSupMatName 
	 危险品标识号：FDangGoodsId 
	 危险等级：FRiskRating 
	 危险品标签：FDangGoodsLabel 
	 原产地证书号：FCertOriginal 
	 固定供应商：FPrimarySupPro 
	 物料类别：FMaterialType 
	 供应商：FEtySupplierId  (必填项)
	 配额比例%：FQuotaRatio 
	 配额顺序：FQuotaOrder 
	 累计订货量：FAllOrderQty 
	 累计订货金额：FAllOrderAmount 
	 累计订货次数：FAllOrderNum 
	 最近订货日期：FRecentOrderDate 
	 最近订单编号：FRecentOrderNo 
	 供应类别：FSUPPLYTYPE 
	 供货状态：FSupplyStatus 
	 基本单位：FBaseUnitID 
	 最大订货数量（基本单位）：FMaxBaseOrderQty 
	 订货单位：FUnitID 
	 最小订货数量(基本单位)：FMinBaseOrderQty 
	 累计订货量（基本单位）：FAllBaseOrderQty 
	 首次订货日期：FFirstOrderDate 
	 最小包装数量：FMinpackagingQty 
	 付款条件：FPayCondition 
	 结算方式：FSettleTypeId 
	 最小包装数量(基本单位)：FMinbasePackagingQty 
关联关系表：FPUR_CATALOGENTRY_Link 
	 实体主键：FLinkId 
	 业务流程图：FPUR_CATALOGENTRY_Link_FFlowId 
	 推进路线：FPUR_CATALOGENTRY_Link_FFlowLineId 
	 转换规则：FPUR_CATALOGENTRY_Link_FRuleId 
	 源单表内码：FPUR_CATALOGENTRY_Link_FSTableId 
	 源单表：FPUR_CATALOGENTRY_Link_FSTableName 
	 源单内码：FPUR_CATALOGENTRY_Link_FSBillId 
	 源单分录内码：FPUR_CATALOGENTRY_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PUR_CATALOG","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FPurchaseOrgId":{"FNumber":""},"FBillNo":"","FName":"","FRecentStatisticsDate":"1900-01-01","FDate":"1900-01-01","FPUR_CATALOGENTRY":[{"FENTRYID":0,"FSUPPLYTYPE":"","FMaterialId":{"FNumber":""},"FUnitID":{"FNumber":""},"FAxupropID":{"FAXUPROPID__FF100001":{"FNumber":""},"FAXUPROPID__FF100002":{"FNumber":""},"FAXUPROPID__FF100003":{"FNumber":""},"FAXUPROPID__FF100005":{"FNumber":""},"FAXUPROPID__FF100010":{"FNumber":""},"FAXUPROPID__FF100007":{"FNumber":""},"FAXUPROPID__FF100008":{"FNumber":""}},"FEtySupplierId":{"FNumber":""},"FSupplyStatus":"","FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FQuotaRatio":0,"FQuotaOrder":0,"FPrimarySupPro":"false","FSupMatId":"","FSupMatName":"","FAllOrderQty":0,"FAllOrderAmount":0,"FAllOrderNum":0,"FRecentOrderDate":"1900-01-01","FRecentOrderNo":"","FBaseUnitID":{"FNumber":""},"FMaxBaseOrderQty":0,"FMinBaseOrderQty":0,"FAllBaseOrderQty":0,"FFirstOrderDate":"1900-01-01","FMinpackagingQty":0,"FPayCondition":{"FNUMBER":""},"FSettleTypeId":{"FNUMBER":""},"FMinbasePackagingQty":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_CATALOG","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_CATALOG","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.StatusConvert("PUR_CATALOG","StatusConvert","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_CATALOG","StatusConvertUnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_CATALOG","EntryUnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_CATALOG","EntryEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_CATALOG","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_CATALOG","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_CATALOG","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PUR_CATALOG","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_CATALOG"}");

# 智慧轻门店配置 Web API 操作原始内容

> 来源页面：全部 > 零售管理 > 连锁档案 > 智慧轻门店配置
...
client.Delete("CMK_LS_MiniApp","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CMK_LS_MiniApp","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreateOrgId":{"FNUMBER":""},"FAppName":"","FInterval":0,"FRemarks":"","FIsGivePoint":"false","FAllowInput":"false","FUseShopCard":"false","FIsCommentPoint":"false","FSignPoint":0,"FCommentPoint":0,"FMateriaSortType":"","FShowType":"","FIsUseForAll":"false","FTmplType":"","FLogoUrl":"","FTicketPolicy":"","FGroupPolicy":"","FBarginPolicy":"","FCOLORTYPE":"","FIsEnableEvaluate":"false","FIsShieldBad":"false","FUseLive":"false","FExpressUseCoupon":"false","FIsEnableNoStock":"false","FFreePrice":0,"FIsUseService":"false","FIsUseDecorate":"false","FTencentMapKey":"","FSFExpressDevId":"","FSFExpressSecret":"","FRechargePolicy":"","FRegisterPolicy":"","FFaceValue4":0,"FFaceValue6":0,"FFaceValue5":0,"FFaceValue3":0,"FFaceValue2":0,"FFaceValue1":0,"FRegisterTitle":"","FExpressDays":0,"FTCExpressDays":0,"FPayChannel":"","FAllowCancelVip":"false","FScanHide":"false","FMarketHide":"false","FCartHide":"false","FPayOutTime":0,"FOrderSubmitAndPay":"false","FProductShowType":"","FEntity":[{"FEntryID":0,"FPicture":"","FPictureUrl":""}],"FBranchEntity":[{"FEntryID":0,"FUseOrgId":{"FNUMBER":""},"FUseBranchId":{"FNUMBER":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FBarginPolicy": "",
        "FCOLORTYPE": "",
        "FIsEnableEvaluate": "false",
        "FIsShieldBad": "false",
        "FUseLive": "false",
        "FExpressUseCoupon": "false",
        "FIsEnableNoStock": "false",
        "FFreePrice": 0,
        "FIsUseService": "false",
        "FIsUseDecorate": "false",
        "FTencentMapKey": "",
        "FSFExpressDevId": "",
        "FSFExpressSecret": "",
        "FRechargePolicy": "",
        ...
        "FTCExpressDays": 0,
        "FPayChannel": "",
        "FAllowCancelVip": "false",
        "FScanHide": "false",
        "FMarketHide": "false",
        "FCartHide": "false",
        "FPayOutTime": 0,
        "FOrderSubmitAndPay": "false",
        "FProductShowType": "",
        "FEntity": [
            {
                "FEntryID": 0,
...
单据头：FBillHead 
	 ...
	 图片(文件服务器)：FLogoImg 
	 LOGO图详细地址：FLogoUrl 
	 礼券转赠规则：FTicketPolicy 
	 色卡类型：FCOLORTYPE 
	 黄色渐变色：FRadio2 
	 紫色：FRadio21 
	 蓝色：FRadio22 
	 启用评价：FIsEnableEvaluate 
	 三星以下评价48小时后屏蔽：FIsShieldBad 
	 是否开通直播：FUseLive 
	 无库存不允许提交订单：FIsEnableNoStock 
	 订单满：FFreePrice 
	 是否启用客服：FIsUseService 
	 拼团规则：FGroupPolicy 
	 砍价规则：FBarginPolicy 
	 腾讯地理位置KEY：FTencentMapKey  (必填项)
	 允许使用优惠券抵扣运费：FExpressUseCoupon 
	 顺丰同城开发者ID：FSFExpressDevId 
	 顺丰同城开发秘钥：FSFExpressSecret 
	 充值说明：FRechargePolicy 
	 面值1：FFaceValue1 
	 面值2：FFaceValue2 
	 面值3：FFaceValue3 
	 面值4：FFaceValue4 
	 ...
	 面值6：FFaceValue6 
	 允许手输金额：FAllowInput 
	 启用按门店领取会员卡：FUseShopCard 
	 是否启用自定义首页：FIsUseDecorate 
	 订单评价赠送：FCommentPoint 
	 启用评价积分：FIsCommentPoint 
	 协议内容：FRegisterPolicy 
	 隐私协议标题：FRegisterTitle 
	 快递超时确认：FExpressDays 
	 同城超时确认：FTCExpressDays 
	 支付通道：FPayChannel  (必填项)
	 允许在线注销会员：FAllowCancelVip 
	 扫一扫：FScanHide 
	 商城：FMarketHide 
	 购物车：FCartHide 
	 订单超时：FPayOutTime 
	 订单提交时发起支付：FOrderSubmitAndPay 
	 商城呈现方式：FProductShowType  (必填项)
轮播图：FEntity 
	 实体主键：FEntryID 
	 上传图片：FPicture  (必填项)
	 图片地址：FPictureUrl 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CMK_LS_MiniApp","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreateOrgId":{"FNUMBER":""},"FAppName":"","FInterval":0,"FRemarks":"","FIsGivePoint":"false","FAllowInput":"false","FUseShopCard":"false","FIsCommentPoint":"false","FSignPoint":0,"FCommentPoint":0,"FMateriaSortType":"","FShowType":"","FIsUseForAll":"false","FTmplType":"","FLogoUrl":"","FTicketPolicy":"","FGroupPolicy":"","FBarginPolicy":"","FCOLORTYPE":"","FIsEnableEvaluate":"false","FIsShieldBad":"false","FUseLive":"false","FExpressUseCoupon":"false","FIsEnableNoStock":"false","FFreePrice":0,"FIsUseService":"false","FIsUseDecorate":"false","FTencentMapKey":"","FSFExpressDevId":"","FSFExpressSecret":"","FRechargePolicy":"","FRegisterPolicy":"","FFaceValue4":0,"FFaceValue6":0,"FFaceValue5":0,"FFaceValue3":0,"FFaceValue2":0,"FFaceValue1":0,"FRegisterTitle":"","FExpressDays":0,"FTCExpressDays":0,"FPayChannel":"","FAllowCancelVip":"false","FScanHide":"false","FMarketHide":"false","FCartHide":"false","FPayOutTime":0,"FOrderSubmitAndPay":"false","FProductShowType":"","FEntity":[{"FEntryID":0,"FPicture":"","FPictureUrl":""}],"FBranchEntity":[{"FEntryID":0,"FUseOrgId":{"FNUMBER":""},"FUseBranchId":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CMK_LS_MiniApp","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CMK_LS_MiniApp","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CMK_LS_MiniApp","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CMK_LS_MiniApp","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CMK_LS_MiniApp","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CMK_LS_MiniApp","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CMK_LS_MiniApp"}");

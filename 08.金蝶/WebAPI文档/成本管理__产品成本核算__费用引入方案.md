# 费用引入方案 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 费用引入方案
...
client.Delete("CB_EXPENSEIMPSOLUTION","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_EXPENSEIMPSOLUTION","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_EXPENSEIMPSOLUTION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FIMPSLUID":0,"FNumber":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FIMPORTTYPE":"","FACCOUNTBOOKID":{"FNumber":""},"FEntity":[{"FEntryID":0,"FISIMPORT":"false","FDATAFROMTYPE":"","FACCOUNTID":[{"FNumber":""}],"FEXPENSEITEMINID":[{"FNumber":""}],"FACCOUNTDC":"","FCCBIZTYPE":"","FCOSTCENTERID":[{"FNumber":""}],"FEXPENSEITEMID":{"FNumber":""},"FSUMEXPENSEID":{"FNUMBER":""},"FISDOCUMENTSTATUS":"false","FDEPARTID":{"FNUMBER":""},"FISSALOUTSTOCKAMOUNT":"false","FISEXPSUPPLIER":"false"}]}}");
        ...
        "FEntity": [
            {
                ...
                "FISDOCUMENTSTATUS": "false",
                "FDEPARTID": {
                    "FNUMBER": ""
                },
                "FISSALOUTSTOCKAMOUNT": "false",
                "FISEXPSUPPLIER": "false"
            }
        ]
    }
}
...
费用项目设置：FEntity 
	 实体主键：FEntryID 
	 是否引入：FISIMPORT 
	 费用项目为空时指定：FEXPENSEITEMID  (必填项)
	 取数来源：FDATAFROMTYPE 
	 总账科目：FACCOUNTID 
	 成本中心属性：FCCBIZTYPE  (必填项)
	 成本中心：FCOSTCENTERID  (必填项)
	 科目方向：FACCOUNTDC 
	 引入费用项目范围：FEXPENSEITEMINID 
	 合并后费用项目：FSUMEXPENSEID 
	 仅引入已审核凭证：FISDOCUMENTSTATUS 
	 按上次销售出库金额分配：FISSALOUTSTOCKAMOUNT 
	 部门为空时指定：FDEPARTID 
	 引入供应商：FISEXPSUPPLIER 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_EXPENSEIMPSOLUTION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FIMPSLUID":0,"FNumber":"","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FIMPORTTYPE":"","FACCOUNTBOOKID":{"FNumber":""},"FEntity":[{"FEntryID":0,"FISIMPORT":"false","FDATAFROMTYPE":"","FACCOUNTID":[{"FNumber":""}],"FEXPENSEITEMINID":[{"FNumber":""}],"FACCOUNTDC":"","FCCBIZTYPE":"","FCOSTCENTERID":[{"FNumber":""}],"FEXPENSEITEMID":{"FNumber":""},"FSUMEXPENSEID":{"FNUMBER":""},"FISDOCUMENTSTATUS":"false","FDEPARTID":{"FNUMBER":""},"FISSALOUTSTOCKAMOUNT":"false","FISEXPSUPPLIER":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CB_EXPENSEIMPSOLUTION","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CB_EXPENSEIMPSOLUTION","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CB_EXPENSEIMPSOLUTION","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CB_EXPENSEIMPSOLUTION","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CB_EXPENSEIMPSOLUTION","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_EXPENSEIMPSOLUTION","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_EXPENSEIMPSOLUTION"}");

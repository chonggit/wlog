# 经营单元变更单 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 经营单元变更单
...
client.Delete("AM_AMBOBJIDSCHASNGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AM_AMBOBJIDSCHASNGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FAMBOOKID":{"FNUMBER":""},"FACCTSYSTEMID":{"FNUMBER":""},"FACCTPOLICYID":{"FNUMBER":""},"FORGIDSYSTEMID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FCREATEORGID":{"FNumber":""},"FREMARKS":"","FEntity":[{"FENTRYID":0,"FAMOEBAID":{"FNUMBER":""},"FAMBOBJECTTYPE":{"FNUMBER":""},"FAMOEBAOBJOLDNAME":"","FAMOEBAOBJNEWNAME":"","FAMOEBAOBJNEWVALUE":"","FAMBORGID":{"FNUMBER":""},"FNEWOBJECTIDS":"","FAMOEBAOBJECTID":"","FOLDOBJECTIDS":"","FAMOEBAOBJCHANGBEFORE":[{"FDetailID":0,"FAMBOBJECT":"","FAMBCNOBJNUMBER":"","FAMBCNOBJNAMEIN":"","FAMBCNOBJNAME":"","FUSEORGID":{"FNUMBER":""}}],"FAMOEBAOBJCHANGAFTER":[{"FDetailID":0,"FAMBOBJECTNEW":"","FAMBCNOBJNUMBERNEW":"","FAMBCNOBJNAMEINNEW":"","FAMBCNOBJNAMENEW":"","FUSEORGIDNEW":{"FNUMBER":""},"FBASEDATETYPE":{"FNUMBER":""}}]}]}}");
...
单据体：FEntity 
	 实体主键：FENTRYID 
	 经营单元：FAMOEBAID  (必填项)
	 经营对象类型：FAMBOBJECTTYPE 
	 经营对象(变更前)：FAMOEBAOBJOLDNAME 
	 经营对象(变更后)：FAMOEBAOBJNEWNAME 
	 经营对象名称(变更后)：FAMOEBAOBJNEWVALUE 
	 核算组织：FAMBORGID 
	 对象内码：FNEWOBJECTIDS 
	 经营单元历史对象值：FAMOEBAOBJECTID 
	 经营单元历史对象内码拼接：FOLDOBJECTIDS 
	 经营对象组织(变更后)：FAMOEBAOBJORGS 
	 经营单元编码：FBaseProperty 
	 经营对象类型：FBaseProperty1 
	 经营对象名称：FBaseProperty2 
变更前子单据体：FAMOEBAOBJCHANGBEFORE 
	 实体主键：FDetailID 
	 经营对象：FAMBOBJECT 
	 经营对象编码：FAMBCNOBJNUMBER 
	 经营对象名称：FAMBCNOBJNAMEIN 
	 经营对象名称(多语言)：FAMBCNOBJNAME 
	 使用组织(已弃用)：FUSEORGID 
	 使用组织：FUSEORGIDMUL 
变更后子单据体：FAMOEBAOBJCHANGAFTER 
	 实体主键：FDetailID 
	 经营对象：FAMBOBJECTNEW 
	 经营对象编码：FAMBCNOBJNUMBERNEW 
	 经营对象名称：FAMBCNOBJNAMEINNEW 
	 经营对象名称（多语言）：FAMBCNOBJNAMENEW 
	 使用组织(已弃用)：FUSEORGIDNEW 
	 基础资料类型：FBASEDATETYPE 
	 使用组织：FUSEORGIDNEWMUL 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AM_AMBOBJIDSCHASNGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FAMBOOKID":{"FNUMBER":""},"FACCTSYSTEMID":{"FNUMBER":""},"FACCTPOLICYID":{"FNUMBER":""},"FORGIDSYSTEMID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FCREATEORGID":{"FNumber":""},"FREMARKS":"","FEntity":[{"FENTRYID":0,"FAMOEBAID":{"FNUMBER":""},"FAMBOBJECTTYPE":{"FNUMBER":""},"FAMOEBAOBJOLDNAME":"","FAMOEBAOBJNEWNAME":"","FAMOEBAOBJNEWVALUE":"","FAMBORGID":{"FNUMBER":""},"FNEWOBJECTIDS":"","FAMOEBAOBJECTID":"","FOLDOBJECTIDS":"","FAMOEBAOBJCHANGBEFORE":[{"FDetailID":0,"FAMBOBJECT":"","FAMBCNOBJNUMBER":"","FAMBCNOBJNAMEIN":"","FAMBCNOBJNAME":"","FUSEORGID":{"FNUMBER":""}}],"FAMOEBAOBJCHANGAFTER":[{"FDetailID":0,"FAMBOBJECTNEW":"","FAMBCNOBJNUMBERNEW":"","FAMBCNOBJNAMEINNEW":"","FAMBCNOBJNAMENEW":"","FUSEORGIDNEW":{"FNUMBER":""},"FBASEDATETYPE":{"FNUMBER":""}}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AM_AMBOBJIDSCHASNGE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AM_AMBOBJIDSCHASNGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AM_AMBOBJIDSCHASNGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AM_AMBOBJIDSCHASNGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AM_AMBOBJIDSCHASNGE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AM_AMBOBJIDSCHASNGE"}");

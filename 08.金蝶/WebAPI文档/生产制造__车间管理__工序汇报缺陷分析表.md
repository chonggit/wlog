# 工序汇报缺陷分析表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 工序汇报缺陷分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3098 |
...
client.GetSysReportData("SFC_RptDefAnalyRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FRadioBeforeMonth":"","FProcessOrgIds":[{"FNumber":""}],"FRadioCurrMonth":"","FProWorkShopIDS":"","FRadioSeason":"","FRadioYear":"","FBeginCountDate":"1900-01-01","FBeginMaterialId":{"FNumber":""},"FEndMaterialId":{"FNumber":""},"FCountDateGroup":"","FProcessId":[{"FNumber":""}],"FEndCountDate":"1900-01-01","FAnalyseDim":"","FDefectType":[{"FNumber":""}],"FOnlyDefect":"false"}}");
...
五、字段说明：
	 ...
	 至：：FEndMaterialId 
	 作业：FProcessId 
	 分析维度：FAnalyseDim  (必填项)
	 缺陷类型：FDefectType 
	 加工组织：FProcessOrgIds  (必填项)
	 仅显示缺陷数据：FOnlyDefect 

# 资产报修单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 资产报修单
...
client.Save("UN_AssetsWarrantyBillKey","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FReportNum":0,"FAddress":"","FRemark":"","FReportDate":"1900-01-01","FReportUser":{"FUSERACCOUNT":""},"FCargoOwnerOrg":{"FNumber":""},"FReportType":{"FNUMBER":""},"FReportStatus":{"FNUMBER":""},"FReportPosition":{"FNUMBER":""},"FUseDepart":{"FNUMBER":""},"FUser":{"FSTAFFNUMBER":""},"FBarCode":"","FCardCoding":"","FReportCode":"","FReportUnit":{"FNumber":""},"FReportModel":"","FReportName":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverID":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"FimgName":"","FPic":""}]}}");
...
基本信息：FBillHead 
	 ...
	 报修地点：FAddress  (必填项)
	 备注：FRemark 
	 报修日期：FReportDate  (必填项)
	 报修人：FReportUser  (必填项)
	 货主组织：FCargoOwnerOrg 
	 资产类别：FReportType 
	 资产状态：FReportStatus 
	 资产位置：FReportPosition 
	 使用部门：FUseDepart 
	 使用人：FUser 
	 资产条码：FBarCode  (必填项)
	 卡片编码：FCardCoding  (必填项)
	 资产编码：FReportCode  (必填项)
	 计量单位：FReportUnit  (必填项)
	 规格型号：FReportModel 
	 资产名称：FReportName  (必填项)
	 审核人：FApproverID 
	 审核日期：FApproveDate 
	 创建人：FCreatorId 
	 修改日期：FModifyDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_AssetsWarrantyBillKey","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FReportNum":0,"FAddress":"","FRemark":"","FReportDate":"1900-01-01","FReportUser":{"FUSERACCOUNT":""},"FCargoOwnerOrg":{"FNumber":""},"FReportType":{"FNUMBER":""},"FReportStatus":{"FNUMBER":""},"FReportPosition":{"FNUMBER":""},"FUseDepart":{"FNUMBER":""},"FUser":{"FSTAFFNUMBER":""},"FBarCode":"","FCardCoding":"","FReportCode":"","FReportUnit":{"FNumber":""},"FReportModel":"","FReportName":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverID":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"FimgName":"","FPic":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("UN_AssetsWarrantyBillKey","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("UN_AssetsWarrantyBillKey","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("UN_AssetsWarrantyBillKey","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("UN_AssetsWarrantyBillKey","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("UN_AssetsWarrantyBillKey","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_AssetsWarrantyBillKey"}");

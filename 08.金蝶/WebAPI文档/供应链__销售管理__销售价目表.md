# 销售价目表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 销售价目表
...
| 失效 | Effective | 1695 |
| 取消失效 | UnEffective | 1697 |
| 业务失效 | SubUnEffective | 1700 |
| 取消业务失效 | SubEffective | 1698 |
| 下推 | Push | 2325 |
| 整单审核提交 | AllSubmit | 1695 |
| 整单审核 | AllAudit | 1694 |
| 整单反审核 | AllUnAudit | 1696 |
| 行提交 | RowSubmti | 1695 |
| 行审核 | RowAudit | 1694 |
...
client.Delete("BD_SAL_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_SAL_PriceList","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_SAL_PriceList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FCurrencyId":{"FNumber":""},"FDescription":"","FPriceObject":"","FEffectiveDate":"1900-01-01","FExpiryDate":"1900-01-01","FIsIncludedTax":"false","FLimitCustomer":"","FLimitSalesMan":"","FPriceType":{"FNumber":""},"FIsNotCheckPrice":"false","FEntity":[{"FENTRYID":0,"FMapId":{"FNUMBER":""},"FMaterialId":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FBomId":{"FNUMBER":""},"FLot":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FPriceBase":0,"FToQty":0,"FPrice":0,"FDownPrice":0,"FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FDefBaseDataO":{"FNUMBER":""},"FDefBaseDataT":{"FNUMBER":""},"FDefAssistantO":{"FNumber":""},"FDefAssistantT":{"FNumber":""},"FDefTextO":"","FDefTextT":"","FDefaultPriceO":0,"FDefaultPriceT":0}],"FEntity1":[{"FENTRYID":0,"FSalerId":{"FNumber":""},"FDeptId":{"FNumber":""},"FSaleGroupId":{"FNumber":""}}],"FEntity2":[{"FENTRYID":0,"FCustID":{"FNumber":""},"FCustTypeID":{"FNumber":""},"FCustGroup":{"FNumber":""},"FIsDefList":"false"}]}}");
        ...
        "FEntity": [
            {
                ...
                "FPrice": 0,
                "FDownPrice": 0,
                "FEntryEffectiveDate": "1900-01-01",
                "FEntryExpiryDate": "1900-01-01",
                "FDefBaseDataO": {
                    "FNUMBER": ""
                },
                "FDefBaseDataT": {
...
基本信息：FBillHead 
	 ...
	 编号：FNumber 
	 备注：FDescription 
	 销售组织：FCreateOrgId  (必填项)
	 使用组织：FUseOrgId 
	 创建人：FCreatorId 
	 最后修改人：FModifierId 
	 创建日期：FCreateDate 
	 最后修改日期：FModifyDate 
	 运费条款：FCarriageClause 
	 收款条款：FChargeClause 
	 含税：FIsIncludedTax 
	 币别：FCurrencyId  (必填项)
	 生效日：FEffectiveDate 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 失效人：FEntryForbiderId 
	 失效日期：FEntryForbidDate 
	 价目对象：FPriceObject  (必填项)
	 限定客户：FLimitCustomer 
	 限定销售员：FLimitSalesMan 
	 整单状态：FAuditStatus 
	 价格类型：FPriceType 
	 不参与严控价目表定价检查：FIsNotCheckPrice 
价格明细：FEntity 
	 实体主键：FENTRYID 
	 物料携带计价单位（废弃）：FPriceUnitId 
	 价格系数：FPriceBase 
	 至：FToQty 
	 价格：FPrice  (必填项)
	 最低限价：FDownPrice 
	 生效日期：FEntryEffectiveDate 
	 失效日期：FEntryExpiryDate 
	 失效：FEntryForbidStatus 
	 业务失效人：FForbiderId 
	 业务失效日期：FForbidDate 
	 辅助属性：FAuxPropId 
	 描述：FF100001
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 存货类别（废弃）：FMaterialTypeId 
	 物料编码：FMaterialId 
	 物料名称：FMaterialName 
	 规格型号：FMaterialModel 
	 行审核状态：FRowAuditStatus 
	 计价单位：FUnitID  (必填项)
	 从（无用字段）：FFromQty 
	 BOM版本：FBomId 
	 批号：FLot 
	 自定义基础资料1：FDefBaseDataO 
	 自定义基础资料2：FDefBaseDataT 
	 自定义辅助资料1：FDefAssistantO 
	 自定义辅助资料2：FDefAssistantT 
	 自定义文本1：FDefTextO 
	 自定义文本2：FDefTextT 
	 自定义价格1：FDefaultPriceO 
	 自定义价格2：FDefaultPriceT 
	 物料分组编码：FMaterialGroupId 
	 物料分组名称：FMATERIALGROUPNAME 
	 客户物料编码：FMapId 
	 客户物料名称：FMapName 
	 自定义多选基础资料：FDefMulBaseData 
	 自定义多选辅助资料：FDefMulAssistant 
适用销售员：FEntity1 
	 实体主键：FENTRYID 
	 销售员编码：FSalerId 
	 销售组编码：FSaleGroupId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_SAL_PriceList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FCurrencyId":{"FNumber":""},"FDescription":"","FPriceObject":"","FEffectiveDate":"1900-01-01","FExpiryDate":"1900-01-01","FIsIncludedTax":"false","FLimitCustomer":"","FLimitSalesMan":"","FPriceType":{"FNumber":""},"FIsNotCheckPrice":"false","FEntity":[{"FENTRYID":0,"FMapId":{"FNUMBER":""},"FMaterialId":{"FNumber":""},"FMaterialGroupId":{"FNUMBER":""},"FBomId":{"FNUMBER":""},"FLot":{"FNumber":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FUnitID":{"FNumber":""},"FPriceBase":0,"FToQty":0,"FPrice":0,"FDownPrice":0,"FEntryEffectiveDate":"1900-01-01","FEntryExpiryDate":"1900-01-01","FDefBaseDataO":{"FNUMBER":""},"FDefBaseDataT":{"FNUMBER":""},"FDefAssistantO":{"FNumber":""},"FDefAssistantT":{"FNumber":""},"FDefTextO":"","FDefTextT":"","FDefaultPriceO":0,"FDefaultPriceT":0}],"FEntity1":[{"FENTRYID":0,"FSalerId":{"FNumber":""},"FDeptId":{"FNumber":""},"FSaleGroupId":{"FNumber":""}}],"FEntity2":[{"FENTRYID":0,"FCustID":{"FNumber":""},"FCustTypeID":{"FNumber":""},"FCustGroup":{"FNumber":""},"FIsDefList":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_SAL_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_SAL_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_SAL_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_SAL_PriceList","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","Effective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","UnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","SubUnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","SubEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("BD_SAL_PriceList","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","AllSubmit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","AllAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","AllUnAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","RowSubmti","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","RowAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_SAL_PriceList","RowUnAudit","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_SAL_PriceList","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_SAL_PriceList"}");

# 红字专票信息表 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 红字专票信息表
...
client.Delete("IV_RedInvInfoTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("IV_RedInvInfoTable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FPURNAME":"","FPURTAXNUMBER":"","FSALENAME":"","FSALETAXNUMBER":"","FINCLUDETAX":"false","FIVCODE":"","FIVNUMBER":"","FSUMAMOUNT":0,"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FSUMTAXAMOUNT":0,"FSUMALLAMOUNT":0,"FOPENDATE":"1900-01-01","FInfoTableNumber":"","FRequestNumber":"","FStatusCode":"","FStatusDesc":"","FISELECTRONICIV":"false","FAPPLICANTTYPE":"","FDEDUCTIONSTATUS":"","FIVDATE":"1900-01-01","FRUSHREDREASON":"","FEntity":[{"FEntryID":0,"FITEMNAME":"","FUNIT":"","FSPECIFICATIONS":"","FQTY":0,"FPRICE":0,"FAMOUNT":0,"FTAXRATE":0,"FTAXAMOUNT":0,"FTAXCODE":"","FTAXPOLICY":"","FASSOCIATEDLINENUMBER":0,"FVERSION":""}]}}");
...
单据头：FBillHead 
	 ...
	 源单编号：FSOURCEBILLNO 
	 源单内码：FSOURCEBILLID 
	 电子发票：FISELECTRONICIV 
	 申请类型：FAPPLICANTTYPE 
	 抵扣状态：FDEDUCTIONSTATUS 
	 原蓝票填开日期：FIVDATE 
	 冲红原因：FRUSHREDREASON 
单据体：FEntity 
	 实体主键：FEntryID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("IV_RedInvInfoTable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FPURNAME":"","FPURTAXNUMBER":"","FSALENAME":"","FSALETAXNUMBER":"","FINCLUDETAX":"false","FIVCODE":"","FIVNUMBER":"","FSUMAMOUNT":0,"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FSUMTAXAMOUNT":0,"FSUMALLAMOUNT":0,"FOPENDATE":"1900-01-01","FInfoTableNumber":"","FRequestNumber":"","FStatusCode":"","FStatusDesc":"","FISELECTRONICIV":"false","FAPPLICANTTYPE":"","FDEDUCTIONSTATUS":"","FIVDATE":"1900-01-01","FRUSHREDREASON":"","FEntity":[{"FEntryID":0,"FITEMNAME":"","FUNIT":"","FSPECIFICATIONS":"","FQTY":0,"FPRICE":0,"FAMOUNT":0,"FTAXRATE":0,"FTAXAMOUNT":0,"FTAXCODE":"","FTAXPOLICY":"","FASSOCIATEDLINENUMBER":0,"FVERSION":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("IV_RedInvInfoTable","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("IV_RedInvInfoTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("IV_RedInvInfoTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("IV_RedInvInfoTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("IV_RedInvInfoTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("IV_RedInvInfoTable","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"IV_RedInvInfoTable"}");

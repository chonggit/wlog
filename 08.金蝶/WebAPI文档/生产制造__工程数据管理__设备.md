...
client.Delete("ENG_Equipment","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ENG_Equipment","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ENG_Equipment","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FCurrentStatus":"","FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FProjName":"","FImgStorageType":"","FDeviceId":"","FProjId":"","FIsAutoAdd":"false","FIsDeviceNetWorking":"false","FIsCalOEE":"false","FIsMonitoring":"false","FUseDeptId":{"FNUMBER":""},"FEqumCategory":{"FNUMBER":""},"FIsAutoGather":"false","FMonitorDisOrder":"","FIsLinkageStart":"false","FEntity":[{"FEntryID":0,"FGatherNo":"","FMeterName":"","FMeterDescription":"","FMeterUnitName":"","FProcessType":"","FIsAutoPush":"false","FIsAlert":"false","FAlertTypeId":{"FNUMBER":""},"FSourceType":"","FUpperLimitValue":0,"FAutoDeleteDay":0,"FAutoDeleteItem":0,"FChangeTime":"1900-01-01","FTagId":"","FIsMonitor":"false","FIsAutoPushMessage":"false","FIsBizFiling":"false","FIsUploadCloud":"false","FNumDisplayPreci":0,"FSubEntity":[{"FDetailID":0,"FLowerLimit":0,"FUpperLimit":0}]}],"FEntityLink":[{"FEntryID":0,"FCloudStatus":"","FSCADAStatusCode":""}],"FEntity1":[{"FEntryID":0,"FFaultCode":"","FProductEvent":{"FNUMBER":""},"FNote":""}]}}");
        ...
        "FEntity": [
            {
                ...
                "FAutoDeleteDay": 0,
                "FAutoDeleteItem": 0,
                "FChangeTime": "1900-01-01",
                "FTagId": "",
                "FIsMonitor": "false",
                "FIsAutoPushMessage": "false",
                "FIsBizFiling": "false",
                "FIsUploadCloud": "false",
                "FNumDisplayPreci": 0,
                "FSubEntity": [
                    {
                        "FDetailID": 0,
...
单据头：FBillHead 
	 ...
	 当前状态：FCurrentStatus  (必填项)
	 工程编码：FProjName 
	 图片(数据库)：FImage 
	 图片存储类型：FImgStorageType 
	 图片(文件服务)：FIsImgFileServer 
	 图片(数据库)：FIsImgDataBase 
	 图片(文件服务)：FImageFileServer 
	 设备ID(SCADA)：FDeviceId 
	 工程ID(SCADA)：FProjId 
	 自动新增设备：FIsAutoAdd 
	 启用设备联网：FIsDeviceNetWorking 
	 使用部门：FUseDeptId 
	 设备类别：FEqumCategory 
	 计算OEE：FIsCalOEE 
	 看板显示：FIsMonitoring 
	 联网采集数据：FIsAutoGather 
	 监控显示顺序：FMonitorDisOrder 
	 仅设备联动开工：FIsLinkageStart 
单据体：FEntity 
	 实体主键：FEntryID 
	 采集号：FGatherNo  (必填项)
	 仪表名称：FMeterName  (必填项)
	 仪表显示单位：FMeterUnitName 
	 仪表描述：FMeterDescription 
	 处理类型：FProcessType  (必填项)
	 来源：FSourceType 
	 变更时间：FChangeTime 
	 自动报警：FIsAlert 
	 仪表ID(SCADA)：FTagId 
	 设备事件类型：FAlertTypeId 
	 自动推送：FIsAutoPush 
	 上限值：FUpperLimitValue 
	 自动删除(天)：FAutoDeleteDay 
	 自动删除(条)：FAutoDeleteItem 
	 监控显示：FIsMonitor 
	 消息推送：FIsAutoPushMessage 
	 业务归档：FIsBizFiling 
	 上传云端：FIsUploadCloud 
	 数字精度：FNumDisplayPreci 
子单据体：FSubEntity 
	 实体主键：FDetailID 
	 监测上限：FUpperLimit 
	 监测下限：FLowerLimit 
单据体：FEntityLink 
	 实体主键：FEntryID 
	 设备状态：FCloudStatus  (必填项)
	 SCADA状态代码：FSCADAStatusCode 
单据体：FEntity1 
	 实体主键：FEntryID 
	 故障代码：FFaultCode 
	 生产事件：FProductEvent 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ENG_Equipment","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FCurrentStatus":"","FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FProjName":"","FImgStorageType":"","FDeviceId":"","FProjId":"","FIsAutoAdd":"false","FIsDeviceNetWorking":"false","FIsCalOEE":"false","FIsMonitoring":"false","FUseDeptId":{"FNUMBER":""},"FEqumCategory":{"FNUMBER":""},"FIsAutoGather":"false","FMonitorDisOrder":"","FIsLinkageStart":"false","FEntity":[{"FEntryID":0,"FGatherNo":"","FMeterName":"","FMeterDescription":"","FMeterUnitName":"","FProcessType":"","FIsAutoPush":"false","FIsAlert":"false","FAlertTypeId":{"FNUMBER":""},"FSourceType":"","FUpperLimitValue":0,"FAutoDeleteDay":0,"FAutoDeleteItem":0,"FChangeTime":"1900-01-01","FTagId":"","FIsMonitor":"false","FIsAutoPushMessage":"false","FIsBizFiling":"false","FIsUploadCloud":"false","FNumDisplayPreci":0,"FSubEntity":[{"FDetailID":0,"FLowerLimit":0,"FUpperLimit":0}]}],"FEntityLink":[{"FEntryID":0,"FCloudStatus":"","FSCADAStatusCode":""}],"FEntity1":[{"FEntryID":0,"FFaultCode":"","FProductEvent":{"FNUMBER":""},"FNote":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ENG_Equipment","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ENG_Equipment","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ENG_Equipment","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_Equipment","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_Equipment","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ENG_Equipment","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Allocate("ENG_Equipment","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAllocate("ENG_Equipment","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ENG_Equipment"}");

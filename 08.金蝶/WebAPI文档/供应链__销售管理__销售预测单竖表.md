# 销售预测单竖表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 销售预测单竖表
...
client.Delete("xhfz_SaleYCtable","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("xhfz_SaleYCtable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_xhfz_Date":"1900-01-01","F_xhfz_CustID":{"FNUMBER":""},"FBillStatus":"","FCreateDate":"1900-01-01","F_xhfz_UserOrgId":{"FNumber":""},"F_xhfz_Area":"","F_xhfz_OrderNo":"","FCreatorId":{"FUserID":""},"F_xhfz_Entity":[{"FEntryID":0,"F_xhfz_MaterialID":{"FNUMBER":""},"F_xhfz_tu":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"F_xhfz_OrderID":"","F_xhfz_CustXXQty":0,"F_xhfz_PCPeriod":0,"F_xhfz_Unit":{"FNUMBER":""},"F_xhfz_YQCHDate":"1900-01-01","F_xhfz_LJQty":0,"F_xhfz_OpenQty":0,"F_xhfz_Note":"","F_xhfz_SourceBillNo":""}]}}");
...
单据头：FBillHead 
	 ...
	 单据编号：FBillNo 
	 日期：F_xhfz_Date 
	 客户代码：F_xhfz_CustID  (必填项)
	 客户名称：F_xhfz_CustName 
	 单据状态：FBillStatus  (必填项)
	 创建日期：FCreateDate 
	 使用组织：F_xhfz_UserOrgId 
	 地区：F_xhfz_Area 
	 订单号：F_xhfz_OrderNo 
	 创建人：FCreatorId 
预测单明细：F_xhfz_Entity 
	 实体主键：FEntryID 
	 零件编码：F_xhfz_MaterialID  (必填项)
	 零件名称：F_xhfz_MaterialName 
	 客户PO号：F_xhfz_OrderID 
	 要求出货日期：F_xhfz_YQCHDate 
	 本月Open订单数量：F_xhfz_OpenQty 
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 来源单号：F_xhfz_SourceBillNo 
	 备注：F_xhfz_Note 
	 允许采购指数：F_xhfz_CustXXQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("xhfz_SaleYCtable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_xhfz_Date":"1900-01-01","F_xhfz_CustID":{"FNUMBER":""},"FBillStatus":"","FCreateDate":"1900-01-01","F_xhfz_UserOrgId":{"FNumber":""},"F_xhfz_Area":"","F_xhfz_OrderNo":"","FCreatorId":{"FUserID":""},"F_xhfz_Entity":[{"FEntryID":0,"F_xhfz_MaterialID":{"FNUMBER":""},"F_xhfz_tu":{"FNUMBER":""},"FAuxPropId":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"F_xhfz_OrderID":"","F_xhfz_CustXXQty":0,"F_xhfz_PCPeriod":0,"F_xhfz_Unit":{"FNUMBER":""},"F_xhfz_YQCHDate":"1900-01-01","F_xhfz_LJQty":0,"F_xhfz_OpenQty":0,"F_xhfz_Note":"","F_xhfz_SourceBillNo":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("xhfz_SaleYCtable","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("xhfz_SaleYCtable","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("xhfz_SaleYCtable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("xhfz_SaleYCtable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("xhfz_SaleYCtable","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"xhfz_SaleYCtable"}");

# 移动单据列表显示设置 Web API 操作原始内容

> 来源页面：全部 > 移动应用 > 小K > 移动单据列表显示设置
...
client.Delete("AI_ExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AI_ExtendFieldConfig","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AI_ExtendFieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FMainEntry":"","FEnableAttachment":"false","FPublishList":"false","FPublishNew":"false","FSourceBill":{"FID":""},"FApproverId":{"FUserID":""},"FForbiderId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidDate":"1900-01-01","FSubSystem":{"FName":""},"FSourceType":"","FHeadFieldEntry":[{"FEntryID":0,"FHeadFieldName":"","FHeadFieldType":"","FHeadFieldHighLight":"false","FHeadFieldFixedVisible":"false","FHeadFieldKey":""}],"FEntryFieldEntry":[{"FEntryID":0,"FEntryFieldName":"","FEntryFieldType":"","FEntryFieldHighLight":"false","FDetailPreviewShow":"false","FDetailPreviewKeyWord":"false","FEntryFieldKey":""}],"FBillOperationEntry":[{"FEntryID":0,"FOperationName":"","FOperationType":"","FOperationCode":"","FOperationId":"","FOperationOption":""}],"FListFieldEntry":[{"FEntryID":0,"FListFieldName":"","FListFieldType":"","FListFieldHighLight":"false","FIsListKeyWord":"false","FListFieldKey":""}],"FDetailOperationEntry":[{"FEntryID":0,"FDetailOperationName":"","FDetailOperationType":"","FDetailOperationCode":"","FDetailOperationId":"","FDetailOperationOption":""}]}}");
        ...
        "FHeadFieldEntry": [
            {
                ...
                "FHeadFieldName": "",
                "FHeadFieldType": "",
                "FHeadFieldHighLight": "false",
                "FHeadFieldFixedVisible": "false",
                "FHeadFieldKey": ""
            }
        ],
        "FEntryFieldEntry": [
            {
                ...
                "FEntryFieldName": "",
                "FEntryFieldType": "",
                "FEntryFieldHighLight": "false",
                "FDetailPreviewShow": "false",
                "FDetailPreviewKeyWord": "false",
                "FEntryFieldKey": ""
            }
        ],
        "FBillOperationEntry": [
        ...
        "FListFieldEntry": [
            {
                ...
                "FListFieldName": "",
                "FListFieldType": "",
                "FListFieldHighLight": "false",
                "FIsListKeyWord": "false",
                "FListFieldKey": ""
            }
        ],
        "FDetailOperationEntry": [
            {
                "FEntryID": 0,
                "FDetailOperationName": "",
                "FDetailOperationType": "",
                "FDetailOperationCode": "",
                "FDetailOperationId": "",
                "FDetailOperationOption": ""
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 子系统：FSubSystem 
	 来源类型：FSourceType 
单据头字段：FHeadFieldEntry 
	 实体主键：FEntryID 
	 字段名称：FHeadFieldName 
	 字段类型：FHeadFieldType 
	 字段高亮显示：FHeadFieldHighLight 
	 字段固定可见：FHeadFieldFixedVisible 
	 字段Key：FHeadFieldKey 
单据体字段：FEntryFieldEntry 
	 实体主键：FEntryID 
	 字段名称：FEntryFieldName 
	 字段类型：FEntryFieldType 
	 字段高亮显示：FEntryFieldHighLight 
	 明细预览显示：FDetailPreviewShow 
	 明细预览关键字段：FDetailPreviewKeyWord 
	 字段Key：FEntryFieldKey 
单据操作：FBillOperationEntry 
	 实体主键：FEntryID 
	 操作代码：FOperationCode 
	 操作Id：FOperationId 
	 操作类型：FOperationType 
	 操作名称：FOperationName 
	 操作参数：FOperationOption 
列表显示字段：FListFieldEntry 
	 实体主键：FEntryID 
	 字段名称：FListFieldName 
	 字段类型：FListFieldType 
	 字段高亮显示：FListFieldHighLight 
	 列表关键字段：FIsListKeyWord 
	 字段Key：FListFieldKey 
单据详情操作：FDetailOperationEntry 
	 实体主键：FEntryID 
	 操作代码：FDetailOperationCode 
	 操作ID：FDetailOperationId 
	 操作类型：FDetailOperationType 
	 操作名称：FDetailOperationName 
	 操作参数：FDetailOperationOption 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AI_ExtendFieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FMainEntry":"","FEnableAttachment":"false","FPublishList":"false","FPublishNew":"false","FSourceBill":{"FID":""},"FApproverId":{"FUserID":""},"FForbiderId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidDate":"1900-01-01","FSubSystem":{"FName":""},"FSourceType":"","FHeadFieldEntry":[{"FEntryID":0,"FHeadFieldName":"","FHeadFieldType":"","FHeadFieldHighLight":"false","FHeadFieldFixedVisible":"false","FHeadFieldKey":""}],"FEntryFieldEntry":[{"FEntryID":0,"FEntryFieldName":"","FEntryFieldType":"","FEntryFieldHighLight":"false","FDetailPreviewShow":"false","FDetailPreviewKeyWord":"false","FEntryFieldKey":""}],"FBillOperationEntry":[{"FEntryID":0,"FOperationName":"","FOperationType":"","FOperationCode":"","FOperationId":"","FOperationOption":""}],"FListFieldEntry":[{"FEntryID":0,"FListFieldName":"","FListFieldType":"","FListFieldHighLight":"false","FIsListKeyWord":"false","FListFieldKey":""}],"FDetailOperationEntry":[{"FEntryID":0,"FDetailOperationName":"","FDetailOperationType":"","FDetailOperationCode":"","FDetailOperationId":"","FDetailOperationOption":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AI_ExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AI_ExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AI_ExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AI_ExtendFieldConfig","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AI_ExtendFieldConfig","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("AI_ExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AI_ExtendFieldConfig","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AI_ExtendFieldConfig"}");

# 出库成本维护 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 出库成本维护

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3402 |
...
client.GetSysReportData("HS_OutStockEstimateReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FYear":"","FPeriod":"","FBillTypeId":[{"FNumber":""}],"FMATERIALID":{"FNumber":""},"FENDMATERIALID":{"FNumber":""},"FBILLNO":"","FCURRENCYID":{"FNumber":""},"FENDBILLNO":"","FAmount":0,"FEndAmount":0,"FBILLFORMID":""}}");

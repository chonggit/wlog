# 会员第三方消息规则设置 Web API 操作原始内容

> 来源页面：全部 > 零售管理 > 连锁档案 > 会员第三方消息规则设置
...
client.Delete("CMK_VIP_SmsTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CMK_VIP_SmsTemplate","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CMK_VIP_SmsTemplate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FParamKey19":"","FParamKey20":"","FParamKey22":"","FParamKey23":"","FParamKey24":"","FParamKey25":"","FParamKey26":"","FParamKey29":"","FParamKey28":"","FParamKey18":"","FParamKey30":"","FParamKey31":"","FParamKey32":"","FParamKey33":"","FParamKey27":"","FParamKey17":"","FParamKey13":"","FParamKey15":"","FParamKey01":"","FParamKey02":"","FParamKey03":"","FParamKey04":"","FParamKey05":"","FParamKey06":"","FParamKey07":"","FParamKey08":"","FParamKey09":"","FParamKey10":"","FParamKey11":"","FParamKey21":"","FParamKey12":"","FParamKey14":"","FParamKey16":"","FPricePrecision":0,"FPointPrecision":0,"FEntity":[{"FEntryID":0,"FType":"","FContent":"","FSendSms":"false","FSendWeChat":"false"}]}}");
...
单据头：FBillHead 
	 ...
	 积分消费：FParamKey32 
	 获得积分：FParamKey33 
	 金额保留位数：FPricePrecision 
	 积分保留位数：FPointPrecision 
单据体：FEntity 
	 实体主键：FEntryID 
	 模板类型：FType  (必填项)
	 模板内容：FContent  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CMK_VIP_SmsTemplate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FDescription":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FParamKey19":"","FParamKey20":"","FParamKey22":"","FParamKey23":"","FParamKey24":"","FParamKey25":"","FParamKey26":"","FParamKey29":"","FParamKey28":"","FParamKey18":"","FParamKey30":"","FParamKey31":"","FParamKey32":"","FParamKey33":"","FParamKey27":"","FParamKey17":"","FParamKey13":"","FParamKey15":"","FParamKey01":"","FParamKey02":"","FParamKey03":"","FParamKey04":"","FParamKey05":"","FParamKey06":"","FParamKey07":"","FParamKey08":"","FParamKey09":"","FParamKey10":"","FParamKey11":"","FParamKey21":"","FParamKey12":"","FParamKey14":"","FParamKey16":"","FPricePrecision":0,"FPointPrecision":0,"FEntity":[{"FEntryID":0,"FType":"","FContent":"","FSendSms":"false","FSendWeChat":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CMK_VIP_SmsTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CMK_VIP_SmsTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CMK_VIP_SmsTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CMK_VIP_SmsTemplate","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CMK_VIP_SmsTemplate","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CMK_VIP_SmsTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CMK_VIP_SmsTemplate","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CMK_VIP_SmsTemplate"}");

...
client.Delete("BM_SCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_SCHEME","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_SCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FIsPlanVersion":"false","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FAuditorId":{"FUserID":""},"FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FAuditDate":"1900-01-01","FCalendarId":{"FNUMBER":""},"FRATETYPEID":{"FNUMBER":""},"FStartYear":"","FSTARTDATE":"1900-01-01","FENDDATE":"1900-01-01","FIsStartActual":"false","FActualStartDate":"1900-01-01","FEndYear":"","FOrgSchemeId":{"FNUMBER":""},"FEntity":[{"FENTRYID":0,"FCheck":"false","FSAMPLEID":{"FNumber":""},"FENTRYEDITOR":"","FDistributeID":"","FSubEntity":[{"FDistributeId":0,"FOrgCheck":"false","FOrgNumber":"","FOrgName":"","FORGTYPE":"","FReportBeginDate":"1900-01-01","FDetailId":"","FNewSampleId":"","FSourceSampleId":"","FOrgId":"","FDeptOrgId":"","FForbidenState":"","FEntryOrgId":"","FActualNewSampleId":"","FActualSourceSampleId":"","FIsActualSample":"","FActualForbidenState":""}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FENDDATE": "1900-01-01",
        "FIsStartActual": "false",
        "FActualStartDate": "1900-01-01",
        "FEndYear": "",
        "FOrgSchemeId": {
            "FNUMBER": ""
        },
                ...
                "FSubEntity": [
                    {
                        ...
                        "FEntryOrgId": "",
                        "FActualNewSampleId": "",
                        "FActualSourceSampleId": "",
                        "FIsActualSample": "",
                        "FActualForbidenState": ""
                    }
                ]
            }
        ]
...
单据头：FBillHead 
	 ...
	 禁用日期：FForbidDate 
	 审核日期：FAuditDate 
	 预算日历：FCalendarId  (必填项)
	 默认汇率类型：FRATETYPEID  (必填项)
	 开始年度：FStartYear  (必填项)
	 开始日期：FSTARTDATE 
	 结束日期：FENDDATE 
	 启用前实际执行数仅来源于实际数报表：FIsStartActual 
	 启用日期：FActualStartDate 
	 结束年度：FEndYear  (必填项)
	 是否未来版本：FIsPlanVersion 
	 预算组织架构：FOrgSchemeId 
方案明细：FEntity 
	 实体主键：FENTRYID 
	 模板编码：FSAMPLEID 
	 ...
	 预算周期：FENTRYCYCLE 
	 预算编制主体：FENTRYEDITOR 
	 关联分发ID：FDistributeID 
	 选取：FCheck 
子单据体：FSubEntity 
	 实体主键：FDistributeId 
	 预算组织编码：FOrgNumber 
	 预算组织名称：FOrgName 
	 报表起始日期：FReportBeginDate 
	 分发ID：FDetailId 
	 分发预算复制模板ID：FNewSampleId 
	 预算组织类型：FORGTYPE 
	 分发源预算模板ID：FSourceSampleId 
	 组织ID：FOrgId 
	 选取：FOrgCheck 
	 部门组织ID：FDeptOrgId 
	 预算模板禁用状态：FForbidenState 
	 预算组织ID：FEntryOrgId 
	 实际数复制模板ID：FActualNewSampleId 
	 源实际数模板ID：FActualSourceSampleId 
	 实际数模板禁用状态：FActualForbidenState 
	 分发为实际数模板：FIsActualSample 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_SCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FIsPlanVersion":"false","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FAuditorId":{"FUserID":""},"FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FAuditDate":"1900-01-01","FCalendarId":{"FNUMBER":""},"FRATETYPEID":{"FNUMBER":""},"FStartYear":"","FSTARTDATE":"1900-01-01","FENDDATE":"1900-01-01","FIsStartActual":"false","FActualStartDate":"1900-01-01","FEndYear":"","FOrgSchemeId":{"FNUMBER":""},"FEntity":[{"FENTRYID":0,"FCheck":"false","FSAMPLEID":{"FNumber":""},"FENTRYEDITOR":"","FDistributeID":"","FSubEntity":[{"FDistributeId":0,"FOrgCheck":"false","FOrgNumber":"","FOrgName":"","FORGTYPE":"","FReportBeginDate":"1900-01-01","FDetailId":"","FNewSampleId":"","FSourceSampleId":"","FOrgId":"","FDeptOrgId":"","FForbidenState":"","FEntryOrgId":"","FActualNewSampleId":"","FActualSourceSampleId":"","FIsActualSample":"","FActualForbidenState":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BM_SCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_SCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_SCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_SCHEME","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_SCHEME","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BM_SCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_SCHEME","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_SCHEME"}");

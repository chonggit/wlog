# 借款转移单 Web API 操作原始内容

> 来源页面：全部 > 员工服务 > 人人报销 > 借款转移单
...
client.Delete("ER_LoanTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ER_LoanTransfer","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCurrencyID":{"FNUMBER":""},"FOrgID":{"FNumber":""},"FCausa":"","FTransOutUserId":{"FSTAFFNUMBER":""},"FTransInUserId":{"FSTAFFNUMBER":""},"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAPPROVERID":{"FUserID":""},"FAPPROVEDATE":"1900-01-01","FCancellerId":{"FUserID":""},"FCancelDate":"1900-01-01","FTRANSAMTSUM":0,"FDate":"1900-01-01","FLocCurrencyID":{"FNUMBER":""},"FExchangeTypeID":{"FNUMBER":""},"FExchangeRate":0,"FLocTransAmtSum":0,"FTransInDept":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FSourceBillNo":"","FReqSeq":0,"FSourceBillType":{"FNUMBER":""},"FExpenseItemID":{"FNUMBER":""},"FTransOutAmount":0,"FExpenseDeptEntryID":{"FNUMBER":""},"FRemarks":"","FReqEntryId":0,"FReqfid":0,"FtargetFid":0,"FtargetBillno":"","FtargetEntryId":0}]}}");
...
单据头：FBillHead 
	 ...
	 转移日期：FDate 
	 转出组织：FOrgID  (必填项)
	 转出人：FTransOutUserId  (必填项)
	 转入人：FTransInUserId  (必填项)
	 币别：FCurrencyID  (必填项)
	 转移金额汇总：FTRANSAMTSUM 
	 事由：FCausa  (必填项)
...
借款转移：FEntity 
	 ...
	 转移单据id：FtargetFid 
	 转入申请单：FtargetBillno 
	 申请单类型：FSourceBillType 
	 费用项目：FExpenseItemID 
	 转入单据分录：FtargetEntryId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ER_LoanTransfer","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCurrencyID":{"FNUMBER":""},"FOrgID":{"FNumber":""},"FCausa":"","FTransOutUserId":{"FSTAFFNUMBER":""},"FTransInUserId":{"FSTAFFNUMBER":""},"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FAPPROVERID":{"FUserID":""},"FAPPROVEDATE":"1900-01-01","FCancellerId":{"FUserID":""},"FCancelDate":"1900-01-01","FTRANSAMTSUM":0,"FDate":"1900-01-01","FLocCurrencyID":{"FNUMBER":""},"FExchangeTypeID":{"FNUMBER":""},"FExchangeRate":0,"FLocTransAmtSum":0,"FTransInDept":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FSourceBillNo":"","FReqSeq":0,"FSourceBillType":{"FNUMBER":""},"FExpenseItemID":{"FNUMBER":""},"FTransOutAmount":0,"FExpenseDeptEntryID":{"FNUMBER":""},"FRemarks":"","FReqEntryId":0,"FReqfid":0,"FtargetFid":0,"FtargetBillno":"","FtargetEntryId":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ER_LoanTransfer","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ER_LoanTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ER_LoanTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ER_LoanTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ER_LoanTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ER_LoanTransfer","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ER_LoanTransfer","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ER_LoanTransfer"}");

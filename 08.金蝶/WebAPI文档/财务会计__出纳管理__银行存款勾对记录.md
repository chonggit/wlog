# 银行存款勾对记录 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 银行存款勾对记录
...
client.View("CN_BLENDDATA","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_BLENDDATA","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDate":"1900-01-01","FBANKID":{"FNAME":""},"FBANKACNTID":{"FNumber":""},"FCURRENCYID":{"FNAME":""},"FCREATORID":{"FUserID":""},"FMAXBILLDATE":"1900-01-01","FEntity":[{"FEntryID":0,"FSRCBILLTYPEID":{"FNAME":""},"FSRCBILLNO":"","FSRCSEQ":0,"FSRCDATE":"1900-01-01","FSRCDEBITAMOUNT":0,"FSRCCREDITAMOUNT":0,"FSRCBILLFORM":"","FBLENDKEY":"","FSRCENTRYID":0,"FREMARKS":"","FOppBankAcntNo":"","FOppBankAcntName":""}]}}");
...
单据头：FBillHead 
	 ...
	 创建人：FCREATORID 
	 最大业务日期：FMAXBILLDATE 
	 来源智能对账：FIsIntelligentBlend 
	 智能对账报告：FIntelligentBlendNo 
单据体：FEntity 
	 实体主键：FEntryID 
	 单据编号：FSRCBILLNO 
	 单据行号：FSRCSEQ 
	 交易日期：FSRCDATE 
	 借方金额：FSRCDEBITAMOUNT 
	 贷方金额：FSRCCREDITAMOUNT 
	 勾对单据标识：FSRCBILLFORM 
	 单据类型：FSRCBILLTYPEID 
	 勾对字段标识：FBLENDKEY 
	 勾对单据分录内码：FSRCENTRYID 
	 摘要：FREMARKS 
	 对方银行账号：FOppBankAcntNo 
	 对方银行账号名称：FOppBankAcntName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_BLENDDATA","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_BLENDDATA"}");

# 会计核算体系 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 总账 > 会计核算体系
...
client.Delete("Org_AccountSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("Org_AccountSystem","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("Org_AccountSystem","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FACCTSYSTEMID":0,"FNumber":"","FVersionsNO":"","FName":"","FDescription":"","FISDefault":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FNewVersionsId":0,"FIsOriginal":"false","FVersionsSeq":0,"FIsCorporate":"false","FAccountSystemEntry":[{"FEntryID":0,"FMAINORGID":{"FNumber":""},"FAcctCldId":{"FNumber":""},"FACOUNTTYPE":"","FAPPACCTPOLICY":[{"FNumber":""}],"FDefAcctPolicy":{"FNumber":""},"FAcctDescription":"","FAcctPolicyLst":"","FSubEntity":[{"FDetailID":0,"FSUBORGID":{"FNumber":""},"FINVESTRATE":0,"FSUBDESCRIPTION":""}]}]}}");
...
单据头：FBillHead 
	 ...
	 默认核算体系：FISDefault 
	 版本号：FVersionsNO 
	 新版核算体系ID：FNewVersionsId 
	 历史版本：FIsOriginal 
	 版本序号：FVersionsSeq 
	 法人核算体系：FIsCorporate 
核算组织：FAccountSystemEntry 
	 实体主键：FEntryID 
	 核算组织：FMAINORGID  (必填项)
	 类型：FACOUNTTYPE  (必填项)
	 描述：FAcctDescription 
	 会计日历：FAcctCldId 
	 适用会计政策：FAPPACCTPOLICY  (必填项)
	 默认会计政策：FDefAcctPolicy  (必填项)
	 适用会计政策：FAcctPolicyLst 
下级组织：FSubEntity 
	 实体主键：FDetailID 
	 下级组织：FSUBORGID  (必填项)
	 投资比例：FINVESTRATE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("Org_AccountSystem","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FACCTSYSTEMID":0,"FNumber":"","FVersionsNO":"","FName":"","FDescription":"","FISDefault":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FNewVersionsId":0,"FIsOriginal":"false","FVersionsSeq":0,"FIsCorporate":"false","FAccountSystemEntry":[{"FEntryID":0,"FMAINORGID":{"FNumber":""},"FAcctCldId":{"FNumber":""},"FACOUNTTYPE":"","FAPPACCTPOLICY":[{"FNumber":""}],"FDefAcctPolicy":{"FNumber":""},"FAcctDescription":"","FAcctPolicyLst":"","FSubEntity":[{"FDetailID":0,"FSUBORGID":{"FNumber":""},"FINVESTRATE":0,"FSUBDESCRIPTION":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("Org_AccountSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("Org_AccountSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("Org_AccountSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("Org_AccountSystem","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("Org_AccountSystem","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("Org_AccountSystem","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("Org_AccountSystem","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"Org_AccountSystem"}");

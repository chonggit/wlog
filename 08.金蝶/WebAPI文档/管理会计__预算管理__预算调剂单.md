# 预算调剂单 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 预算调剂单
...
client.Save("BM_BudgetRegulate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FSchemeId":{"FNumber":""},"FAdjustDate":"1900-01-01","FPeriodEndDate":"1900-01-01","FPrimaryDimension":{"FNUMBER":""},"FBWBCurrencyID":{"FNUMBER":""},"FCurrency":{"FNUMBER":""},"FModifierId":{"FUserID":""},"FPeriod":"","FCYCLEID":"","FYear":"","FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FCreatorId":{"FUserID":""},"FFORBIDDERId":{"FUserID":""},"FCreateDate":"1900-01-01","FAuditDate":"1900-01-01","FForbidDate":"1900-01-01","FREPORTID":{"FBILLNO":""},"FREPORT":"","FSampleID":{"FNUMBER":""},"FRateTypeId":{"FNUMBER":""},"FAmountUnit":{"FNUMBER":""},"FBudgetOrgEntryID":{"FNUMBER":""},"FPrimaryDimensionId":"","FRptSchemeId":{"FNUMBER":""},"FItemDataTypeId":{"FNUMBER":""},"FBUSINESSTYPEID":{"FNUMBER":""},"FBILLTYPE":"","FBUDGETMULTI":"false","FAmountNotZero":"false","FRegulateAmount":0,"FRegulateAmountBWB":0,"FIsRegulate":"","FSheetId":"","FRegulateCause":"","FAdjustDept":{"FNUMBER":""},"FBudgetRegulateEntity":[{"FEntryID":0,"FREPORTID1":{"FBILLNO":""},"FBUDGETORGENTRYID1":{"FNUMBER":""},"FYEAR1":"","FPERIOD1":"","FDimensionList":"","FStartAmount":0,"FApplyAmount":0,"FCheckAmount":0,"FFinalAmount":0,"FDimensionListId":0,"FSheetID1":"","FGroupID":"","FREPORT1":"","FPrimaryDimension1":"","FSchemeId1":{"FNUMBER":""},"FPrimaryDimensionId1":"","FIsMultiOrg":0,"FIsMultiPeriod":0,"FDimensionListNo":"","FDimentionValueEntity":[{"FSubDetailID":0,"FDimensionId":{"FNUMBER":""},"FNameList":"","FIDList":"","FDimensionPosition":"","FDimension":""}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FBILLTYPE": "",
        "FBUDGETMULTI": "false",
        "FAmountNotZero": "false",
        "FRegulateAmount": 0,
        "FRegulateAmountBWB": 0,
        "FIsRegulate": "",
        "FSheetId": "",
        "FRegulateCause": "",
        "FAdjustDept": {
        ...
        "FBudgetRegulateEntity": [
            {
                ...
                "FPrimaryDimensionId1": "",
                "FIsMultiOrg": 0,
                "FIsMultiPeriod": 0,
                "FDimensionListNo": "",
                "FDimentionValueEntity": [
                    {
                        "FSubDetailID": 0,
                        "FDimensionId": {
                            "FNUMBER": ""
...
单据头：FBillHead 
	 ...
	 预算年度：FYear  (必填项)
	 预算期间：FPeriod  (必填项)
	 调整日期：FAdjustDate  (必填项)
	 预算报表内码：FREPORT 
	 汇率类型：FRateTypeId  (必填项)
	 金额单位：FAmountUnit  (必填项)
	 预算组织：FBudgetOrgEntryID  (必填项)
	 组织类型：FOrgTypeID 
	 主维度值：FPrimaryDimensionId 
	 禁用日期：FForbidDate 
	 预算模板：FSampleID 
	 禁用状态：FForbidStatus 
	 修改日期：FModifyDate 
	 ...
	 创建日期：FCreateDate 
	 禁用人：FFORBIDDERId 
	 预算业务类型：FBUSINESSTYPEID  (必填项)
	 样式方案：FRptSchemeId  (必填项)
	 项目数据类型：FItemDataTypeId  (必填项)
	 单据类型：FBILLTYPE  (必填项)
	 跨期调剂：FBUDGETMULTI 
	 调剂总金额：FRegulateAmount 
	 调剂总金额(本位币)：FRegulateAmountBWB 
	 是否调剂单：FIsRegulate 
	 表页ID：FSheetId 
	 周期结束日期：FPeriodEndDate 
	 特殊调整：FAmountNotZero 
	 调剂事由：FRegulateCause  (必填项)
	 调整部门：FAdjustDept 
预算维度组合：FDimentionValueEntity 
	 实体主键：FSubDetailID 
	 维度：FDimensionId 
	 维度值：FNameList 
	 维度值：FIDList 
	 ...
	 维度FormID：FDimension 
单据体：FBudgetRegulateEntity 
	 实体主键：FEntryID 
	 预算维度组合：FDimensionList 
	 调整前：FStartAmount 
	 申请调整额：FApplyAmount 
	 核定调整额：FCheckAmount 
	 调整后：FFinalAmount 
	 预算维度组合内码：FDimensionListId 
	 表页ID：FSheetID1 
	 维度组合ID：FGroupID 
	 预算报表：FREPORTID1  (必填项)
	 预算组织：FBUDGETORGENTRYID1  (必填项)
	 预算年度：FYEAR1  (必填项)
	 预算期间：FPERIOD1  (必填项)
	 预算报表内码：FREPORT1 
	 主维度：FPrimaryDimension1 
	 主维度值：FPrimaryDimensionId1 
	 预算方案：FSchemeId1  (必填项)
	 多组织：FIsMultiOrg 
	 多期间：FIsMultiPeriod 
	 预算维度组合编码：FDimensionListNo 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_BudgetRegulate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FSchemeId":{"FNumber":""},"FAdjustDate":"1900-01-01","FPeriodEndDate":"1900-01-01","FPrimaryDimension":{"FNUMBER":""},"FBWBCurrencyID":{"FNUMBER":""},"FCurrency":{"FNUMBER":""},"FModifierId":{"FUserID":""},"FPeriod":"","FCYCLEID":"","FYear":"","FModifyDate":"1900-01-01","FAuditorID":{"FUserID":""},"FCreatorId":{"FUserID":""},"FFORBIDDERId":{"FUserID":""},"FCreateDate":"1900-01-01","FAuditDate":"1900-01-01","FForbidDate":"1900-01-01","FREPORTID":{"FBILLNO":""},"FREPORT":"","FSampleID":{"FNUMBER":""},"FRateTypeId":{"FNUMBER":""},"FAmountUnit":{"FNUMBER":""},"FBudgetOrgEntryID":{"FNUMBER":""},"FPrimaryDimensionId":"","FRptSchemeId":{"FNUMBER":""},"FItemDataTypeId":{"FNUMBER":""},"FBUSINESSTYPEID":{"FNUMBER":""},"FBILLTYPE":"","FBUDGETMULTI":"false","FAmountNotZero":"false","FRegulateAmount":0,"FRegulateAmountBWB":0,"FIsRegulate":"","FSheetId":"","FRegulateCause":"","FAdjustDept":{"FNUMBER":""},"FBudgetRegulateEntity":[{"FEntryID":0,"FREPORTID1":{"FBILLNO":""},"FBUDGETORGENTRYID1":{"FNUMBER":""},"FYEAR1":"","FPERIOD1":"","FDimensionList":"","FStartAmount":0,"FApplyAmount":0,"FCheckAmount":0,"FFinalAmount":0,"FDimensionListId":0,"FSheetID1":"","FGroupID":"","FREPORT1":"","FPrimaryDimension1":"","FSchemeId1":{"FNUMBER":""},"FPrimaryDimensionId1":"","FIsMultiOrg":0,"FIsMultiPeriod":0,"FDimensionListNo":"","FDimentionValueEntity":[{"FSubDetailID":0,"FDimensionId":{"FNUMBER":""},"FNameList":"","FIDList":"","FDimensionPosition":"","FDimension":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BM_BudgetRegulate","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BM_BudgetRegulate","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_BudgetRegulate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_BudgetRegulate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BudgetRegulate","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BudgetRegulate","Unforbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("BM_BudgetRegulate","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_BudgetRegulate","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_BudgetRegulate","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_BudgetRegulate"}");

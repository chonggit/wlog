...
client.Delete("ENG_Process","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ENG_Process","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ENG_Process","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FTIMEUNIT":"","FWorkCenterID":{"FNumber":""},"FDataAcOrder":"","FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FPLMProcessId":"","FProcessSrc":"","FFeatureFlag":"","FAutoGenPackaging":"false","FIsForceChangeBoxPrint":"false","FIsMaterial":"false","FIsLot":"false","FIsPlanTrcNo":"false","FIsWarePosition":"false","FIsBom":"false","FIsMoEntry":"false","FIsCustomer":"false","FIsAuxprop":"false","FEntity":[{"FEntryID":0,"FResourceID":{"FNumber":""}}],"FDefectEntity":[{"FEntryID":0,"FDefectTypeId":{"FNUMBER":""}}],"FCostResourceEntity":[{"FEntryID":0,"FCostResource":{"FNUMBER":""},"FUseRate":0,"FResourceReqNum":0,"FUseRateRecent":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FProcessSrc": "",
        "FFeatureFlag": "",
        "FAutoGenPackaging": "false",
        "FIsForceChangeBoxPrint": "false",
        "FIsMaterial": "false",
        "FIsLot": "false",
        "FIsPlanTrcNo": "false",
        "FIsWarePosition": "false",
        "FIsBom": "false",
        "FIsMoEntry": "false",
        "FIsCustomer": "false",
        "FIsAuxprop": "false",
...
单据头：FBillHead 
	 ...
	 数据来源：FProcessSrc 
	 PLM内码：FPLMProcessId 
	 数据采集顺序：FDataAcOrder  (必填项)
	 特征标识：FFeatureFlag  (必填项)
	 自动生成条码拆装箱单：FAutoGenPackaging 
	 强制换箱打印箱号标签：FIsForceChangeBoxPrint 
	 产品：FIsMaterial 
	 批号：FIsLot 
	 计划跟踪号：FIsPlanTrcNo 
	 仓库仓位：FIsWarePosition 
	 BOM版本：FIsBom 
	 生产订单分录：FIsMoEntry 
	 客户：FIsCustomer 
	 辅助属性：FIsAuxprop 
...
缺陷类型：FDefectEntity 
	 实体主键：FEntryID 
	 缺陷类型编码：FDefectTypeId  (必填项)
	 缺陷类型名称：FDefectTypeName 
	 缺陷类型分组：FDefectTypeGroup 
成本资源：FCostResourceEntity 
	 实体主键：FEntryID 
	 资源：FCostResource  (必填项)
	 使用比例%：FUseRate 
	 资源需求数量：FResourceReqNum 
	 数量单位：FQtyUnit 
	 最近一次使用比例：FUseRateRecent 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ENG_Process","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FTIMEUNIT":"","FWorkCenterID":{"FNumber":""},"FDataAcOrder":"","FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FPLMProcessId":"","FProcessSrc":"","FFeatureFlag":"","FAutoGenPackaging":"false","FIsForceChangeBoxPrint":"false","FIsMaterial":"false","FIsLot":"false","FIsPlanTrcNo":"false","FIsWarePosition":"false","FIsBom":"false","FIsMoEntry":"false","FIsCustomer":"false","FIsAuxprop":"false","FEntity":[{"FEntryID":0,"FResourceID":{"FNumber":""}}],"FDefectEntity":[{"FEntryID":0,"FDefectTypeId":{"FNUMBER":""}}],"FCostResourceEntity":[{"FEntryID":0,"FCostResource":{"FNUMBER":""},"FUseRate":0,"FResourceReqNum":0,"FUseRateRecent":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ENG_Process","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ENG_Process","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ENG_Process","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_Process","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_Process","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ENG_Process","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Allocate("ENG_Process","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAllocate("ENG_Process","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ENG_Process","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ENG_Process"}");

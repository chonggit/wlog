# 自动对账方案 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 智能会计平台 > 自动对账方案
...
client.Delete("GL_AutoCheckAccountScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("GL_AutoCheckAccountScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("GL_AutoCheckAccountScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FFrequency":"","FDay":0,"FHour":0,"FMinute":0,"FSecond":0,"FIsContainNotPostVoucher":"false","FIsContainAdjustVoucher":"false","FNextExecTime":"1900-01-01","FEntity":[{"FDETAILID":0,"FBookId":{"FNUMBER":""},"FCHECKTYPE":"","FScheme":"","FCUSTOMCHECKSCHEME":{"FNUMBER":""},"FCurrencyID":[{"FNumber":""}],"FPeriod":"","FExecCheckAccount":"false","FExecCheckItem":"false","FLastExecDate":"1900-01-01","FNextExecDate":"1900-01-01","FStartStockBillDate":"1900-01-01","FEmailAddress":"","FSchemeId":0,"FSubEntity":[{"FEntryID":0,"FCheckBox":"false","FCHECKITEM":{"FID":0,"FCHECKITEMNAME":"","FCHECKITEMDESC":"","FUSEDFORCHECKITEMTEXT":""}}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FMinute": 0,
        "FSecond": 0,
        "FIsContainNotPostVoucher": "false",
        "FIsContainAdjustVoucher": "false",
        "FNextExecTime": "1900-01-01",
        "FEntity": [
            {
                "FDETAILID": 0,
                "FBookId": {
                ...
                "FPeriod": "",
                "FExecCheckAccount": "false",
                "FExecCheckItem": "false",
                "FLastExecDate": "1900-01-01",
                "FNextExecDate": "1900-01-01",
                "FStartStockBillDate": "1900-01-01",
                "FEmailAddress": "",
                "FSchemeId": 0,
                "FSubEntity": [
                    {
...
基本：FBillHead 
	 ...
	 时：FHour 
	 天：FDay 
	 包含未过账凭证：FIsContainNotPostVoucher 
	 包含调整期凭证：FIsContainAdjustVoucher 
	 下次执行时间：FNextExecTime 
	 启用状态：FStatus 
对账设置：FEntity 
	 实体主键：FDETAILID 
	 账簿：FBookId  (必填项)
	 币别：FCurrencyID  (必填项)
	 启用对账：FExecCheckAccount 
	 启用检查项：FExecCheckItem 
	 上次执行时间：FLastExecDate 
	 下次执行时间：FNextExecDate 
	 邮箱地址：FEmailAddress 
	 业务报表对账方案：FScheme 
	 入库开始日期：FStartStockBillDate 
	 对账方案id：FSchemeId 
	 会计期间：FPeriod  (必填项)
	 对账类型：FCHECKTYPE  (必填项)
	 业务单据对账方案：FCUSTOMCHECKSCHEME 
业务检查：FSubEntity 
	 实体主键：FEntryID 
	 选择：FCheckBox 
	 对账检查项：FCHECKITEM 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("GL_AutoCheckAccountScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FFrequency":"","FDay":0,"FHour":0,"FMinute":0,"FSecond":0,"FIsContainNotPostVoucher":"false","FIsContainAdjustVoucher":"false","FNextExecTime":"1900-01-01","FEntity":[{"FDETAILID":0,"FBookId":{"FNUMBER":""},"FCHECKTYPE":"","FScheme":"","FCUSTOMCHECKSCHEME":{"FNUMBER":""},"FCurrencyID":[{"FNumber":""}],"FPeriod":"","FExecCheckAccount":"false","FExecCheckItem":"false","FLastExecDate":"1900-01-01","FNextExecDate":"1900-01-01","FStartStockBillDate":"1900-01-01","FEmailAddress":"","FSchemeId":0,"FSubEntity":[{"FEntryID":0,"FCheckBox":"false","FCHECKITEM":{"FID":0,"FCHECKITEMNAME":"","FCHECKITEMDESC":"","FUSEDFORCHECKITEMTEXT":""}}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_AutoCheckAccountScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_AutoCheckAccountScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("GL_AutoCheckAccountScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_AutoCheckAccountScheme","Active","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_AutoCheckAccountScheme","NotActive","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"GL_AutoCheckAccountScheme"}");

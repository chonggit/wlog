# 出纳期末对账 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 出纳期末对账

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3630 |
...
client.GetSysReportData("CN_FinalReconReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSTARTYEAR":"","FSTARTPERIOD":"","FENDYEAR":"","FENDPERIOD":"","FAcctBookId":[{"FNumber":""}],"FCurrencyIds":[{"FNumber":""}],"FFundType":"","FBanks":[{"FNumber":""}],"FBankAccts":[{"FNumber":""}],"FCashAccts":[{"FNumber":""}],"FIncludeVoucher":"false","FIsGroup":"false","FIsAll":"false","FOrgIds":"","FInAdjustVoucher":"false","FPeriodOrDate":"","FPeriodRadio":"","FDateRadio":"","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FIsZeroUnShow":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FIncludeVoucher": "false",
        "FIsGroup": "false",
        "FIsAll": "false",
        "FOrgIds": "",
        "FInAdjustVoucher": "false",
        "FPeriodOrDate": "",
        "FPeriodRadio": "",
        "FDateRadio": "",
...
五、字段说明：
	 ...
	 参数组织：FOrgIds 
	 出纳数据按单汇总：FIsGroup 
	 包含调整期凭证：FInAdjustVoucher 
	 单选按钮组：FPeriodOrDate 
	 按期间查询：FPeriodRadio 
	 按业务日期查询：FDateRadio 
	 开始日期：FStartDate 
	 结束日期：FEndDate 
	 余额及发生额为0的不显示：FIsZeroUnShow 

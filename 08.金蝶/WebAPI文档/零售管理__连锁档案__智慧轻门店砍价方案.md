# 智慧轻门店砍价方案 Web API 操作原始内容

> 来源页面：全部 > 零售管理 > 连锁档案 > 智慧轻门店砍价方案
...
client.Delete("CMK_LS_AppBargain","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CMK_LS_AppBargain","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNAME":"","FBillNo":"","FCreateOrgId":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FCheckId":{"FUserID":""},"FCheckDate":"1900-01-01","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FGroupStatus":"","FValidTime":0,"FIsForAll":"false","FBargainMode":"","FCalculateMode":"","FMinBarginNum":0,"FGroupImgUrl":"","FReferNum":0,"FMaxFQNum":0,"FMaxCRNum":0,"FEntity":[{"FEntryID":0,"FMaterialId":{"FNumber":""},"FBarCode":"","FUnit":{"FNumber":""},"FSalePrice":0,"FVipPrice":0,"FMinPrice":0}],"FBranchEntity":[{"FEntryID":0,"FUseOrgId":{"FNUMBER":""},"FUseBranchId":{"FNUMBER":""}}]}}");
...
单据头：FBillHead 
	 ...
	 活动状态：FGroupStatus 
	 适用所有门店：FIsForAll 
	 达成条件：FBargainMode  (必填项)
	 最低砍价人数：FMinBarginNum 
	 上传首页图：FGroupImageFileServer 
	 活动图片地址：FGroupImgUrl 
	 砍价有效时间(小时)：FValidTime 
	 计算规则：FCalculateMode  (必填项)
	 参考计算人数：FReferNum 
	 会员允许发起次数：FMaxFQNum 
	 会员允许参与次数：FMaxCRNum 
砍价商品：FEntity 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CMK_LS_AppBargain","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNAME":"","FBillNo":"","FCreateOrgId":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FCheckId":{"FUserID":""},"FCheckDate":"1900-01-01","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FGroupStatus":"","FValidTime":0,"FIsForAll":"false","FBargainMode":"","FCalculateMode":"","FMinBarginNum":0,"FGroupImgUrl":"","FReferNum":0,"FMaxFQNum":0,"FMaxCRNum":0,"FEntity":[{"FEntryID":0,"FMaterialId":{"FNumber":""},"FBarCode":"","FUnit":{"FNumber":""},"FSalePrice":0,"FVipPrice":0,"FMinPrice":0}],"FBranchEntity":[{"FEntryID":0,"FUseOrgId":{"FNUMBER":""},"FUseBranchId":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CMK_LS_AppBargain","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CMK_LS_AppBargain","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CMK_LS_AppBargain","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CMK_LS_AppBargain","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CMK_LS_AppBargain","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CMK_LS_AppBargain","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CMK_LS_AppBargain"}");

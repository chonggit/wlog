# 集成平台设置 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 费用管理 > 集成平台设置
...
client.Delete("BD_CQCONFIG","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_CQCONFIG","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
单据头：FBillHead 
	 ...
	 语言字串：FLANGUAGE  (必填项)
	 第三方AppId：FAPPID  (必填项)
	 第三方App密码：FAPPSECURET 
	 租户ID：FTENANTID  (必填项)
	 数据中心ID：FACCOUNTID  (必填项)
	 访问IP地址：FIPADDRESS  (必填项)
	 是否系统预置：FIsSyspReset 
	 用户类型：FUSERTYPE 
单据体：FEntity 
	 实体主键：FENTRYID 
	 单据唯一标识：FFORMID  (必填项)
	 操作：FOPERATEKEY  (必填项)
	 方案编码：FSCHEMENUMBER  (必填项)
	 是否系统预置：FIsSyspReset_lst 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_CQCONFIG","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FUSER":"","FLANGUAGE":"","FAPPID":"","FAPPSECURET":"","FTENANTID":"","FACCOUNTID":"","FIPADDRESS":"","FUSERTYPE":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FDescription":"","FEntity":[{"FENTRYID":0,"FFORMID":"","FOPERATEKEY":"","FSCHEMENUMBER":"","FIsSyspReset_lst":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_CQCONFIG","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_CQCONFIG","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_CQCONFIG"}");

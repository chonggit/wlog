# 应收风险统计数据 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 应收风险统计数据
...
client.Save("SAL_OrderRecRisk","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FDate":"1900-01-01","FCreateDate":"1900-01-01","FEntryOverRecievaAmt":[{"FEntryID":0,"FCustomer1":{"FNUMBER":""},"FSettleOrg1":{"FNUMBER":""},"FCurrency1":{"FNUMBER":""},"FLocalCurrId1":{"FNUMBER":""},"FOverAmt":0,"FLoccOverAmt":0}],"FEntryRecAmount":[{"FEntryID":0,"FCustomer2":{"FNUMBER":""},"FSettleOrg2":{"FNUMBER":""},"FCurrency2":{"FNUMBER":""},"FLocalCurrId2":{"FNUMBER":""},"FRecAmount":0}],"FEntryRecRate":[{"FEntryID":0,"FCustomer3":{"FNUMBER":""},"FSettleOrg3":{"FNUMBER":""},"FCurrency3":{"FNUMBER":""},"FLocalCurrId3":{"FNUMBER":""},"FRecRate":0,"FRecALLAmount":0,"FMatchAmount":0}],"FEntryOverDueDate":[{"FEntryID":0,"FCustomer4":{"FNUMBER":""},"FSettleOrg4":{"FNUMBER":""},"FCurrency4":{"FNUMBER":""},"FLocalCurrId4":{"FNUMBER":""},"FOverDueDate":0,"FAvgOverDueDate":0}],"FEntryOverDueCount":[{"FEntryID":0,"FCustomer5":{"FNUMBER":""},"FSettleOrg5":{"FNUMBER":""},"FCurrency5":{"FNUMBER":""},"FLocalCurrId5":{"FNUMBER":""},"FOverDueCount":0,"FReceivableCount":0,"FOverDueRate":0}],"FEntryOrderCount":[{"FEntryID":0,"FCustomer6":{"FNUMBER":""},"FSettleOrg6":{"FNUMBER":""},"FCurrency6":{"FNUMBER":""},"FLocalCurrId6":{"FNUMBER":""},"FOrderCount":0,"FAllAmount":0,"FPrice":0}],"FEntryReceivableCount":[{"FEntryID":0,"FCustomer17":{"FNUMBER":""},"FSettleOrg17":{"FNUMBER":""},"FCurrency17":{"FNUMBER":""},"FLocalCurrId17":{"FNUMBER":""},"FReceivableCount17":0}],"FEntryRecAvgRate":[{"FEntryID":0,"FSettleOrg8":{"FNUMBER":""},"FCurrency8":{"FNUMBER":""},"FLocalCurrId8":{"FNUMBER":""},"FRecAvgRate":0,"FAvgRecAllAmount":0,"FAvgMatchAmount":0}],"FEntryBadDebtLoss":[{"FEntryID":0,"FCustomer9":{"FNUMBER":""},"FSettleOrg9":{"FNUMBER":""},"FCurrency9":{"FNUMBER":""},"FLocalCurrId9":{"FNUMBER":""},"FBadDebtAmount":0,"FBadDebtCount":0}],"FEntryLongTimeRate":[{"FEntryID":0,"FCustomer7":{"FNUMBER":""},"FSettleOrg7":{"FNUMBER":""},"FCurrency7":{"FNUMBER":""},"FLocalCurrId7":{"FNUMBER":""},"FLongTimeRate":0}]}}");
...
逾期应收款：FEntryOverRecievaAmt 
	 ...
	 本位币：FLocalCurrId1 
	 逾期应收款：FOverAmt 
	 逾期应收款（本位币）：FLoccOverAmt 
应收余额：FEntryRecAmount 
	 实体主键：FEntryID 
	 客户：FCustomer2 
	 结算组织：FSettleOrg2 
	 结算币别：FCurrency2 
...
回款及时率：FEntryRecRate 
	 ...
	 本位币：FLocalCurrId3 
	 回款及时率：FRecRate 
	 累计应收收款：FRecALLAmount 
	 及时回款金额：FMatchAmount 
逾期天数：FEntryOverDueDate 
	 实体主键：FEntryID 
	 客户：FCustomer4 
	 结算组织：FSettleOrg4 
	 结算币别：FCurrency4 
	 本位币：FLocalCurrId4 
	 最大逾期天数：FOverDueDate 
	 平均逾期天数：FAvgOverDueDate 
历史逾期率：FEntryOverDueCount 
	 实体主键：FEntryID 
	 客户：FCustomer5 
	 结算组织：FSettleOrg5 
	 结算币别：FCurrency5 
	 本位币：FLocalCurrId5 
	 逾期次数：FOverDueCount 
	 应收次数：FReceivableCount 
	 历史逾期率：FOverDueRate 
交易次数：FEntryOrderCount 
	 实体主键：FEntryID 
	 客户：FCustomer6 
	 结算组织：FSettleOrg6 
	 结算币别：FCurrency6 
	 ...
	 价税合计：FAllAmount 
	 客单价：FPrice 
应收次数（废弃）：FEntryReceivableCount 
	 实体主键：FEntryID 
	 客户：FCustomer17 
	 结算组织：FSettleOrg17 
	 结算币别：FCurrency17 
	 本位币：FLocalCurrId17 
	 应收次数：FReceivableCount17 
平均回款及时率：FEntryRecAvgRate 
	 实体主键：FEntryID 
	 结算组织：FSettleOrg8 
	 结算币别：FCurrency8 
	 本位币：FLocalCurrId8 
	 平均回款及时率：FRecAvgRate 
	 及时回款金额(计算平均回款率)：FAvgMatchAmount 
	 累计应收收款(计算平均回款率)：FAvgRecAllAmount 
坏账情况：FEntryBadDebtLoss 
	 实体主键：FEntryID 
	 客户：FCustomer9 
	 结算组织：FSettleOrg9 
	 结算币别：FCurrency9 
	 ...
	 坏账金额：FBadDebtAmount 
	 坏账笔数：FBadDebtCount 
长账龄比例（一年）：FEntryLongTimeRate 
	 实体主键：FEntryID 
	 客户：FCustomer7 
	 结算组织：FSettleOrg7 
	 结算币别：FCurrency7 
	 本位币：FLocalCurrId7 
	 长账龄比例（一年）：FLongTimeRate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SAL_OrderRecRisk","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SAL_OrderRecRisk"}");

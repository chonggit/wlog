# PLM物料审核流程单据_多组织 Web API 操作原始内容

> 来源页面：全部 > PLM > 研发物料管理 > PLM物料审核流程单据_多组织
...
client.Delete("ESS_PREPAYMENT","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ESS_PREPAYMENT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FModifierId":{"FUserID":""},"FApproveId":{"FUserID":""},"FApproveDate":"1900-01-01","FCustomerId":{"FNUMBER":""},"FSaleOrgId":{"FNumber":""},"FPayeeOrg":{"FNumber":""},"FAccountOrg":{"FNumber":""},"FCurrencyId":{"FNUMBER":""},"FOrderTypeID":{"FNUMBER":""},"FRemark":"","FFilePath":"","FChannelId":{"FNUMBER":""},"FCreatorId":{"FUSERNAME":""},"FBalanceChannel":{"FNUMBER":""},"FPayChannel":{"FNUMBER":""},"FAccountName":"","FBankCode":"","FOpenBankName":"","FBalanceCustomer":{"FNUMBER":""},"FRecBankAcntId":{"FNUMBER":""},"FActualPayDate":"1900-01-01","FOrderBillNo":"","FCALLBACKERID":{"FUserID":""},"FCallbackDate":"1900-01-01","FCallbackReason":"","FEntity":[{"FEntryID":0,"FPayTypeId":{"FNumber":""},"FAmount":0,"FSrcFlag":"","FSrcId":0,"FJoinReceiveAmount":0}]}}");
...
单据头：FBillHead 
	 ...
	 审核人：FApproveId 
	 审核日期：FApproveDate 
	 提报客户：FCustomerId  (必填项)
	 销售组织：FSaleOrgId  (必填项)
	 币别：FCurrencyId 
	 单据类型：FOrderTypeID  (必填项)
	 备注：FRemark 
	 附件地址：FFilePath 
	 付款人：FChannelStaffId 
	 提报渠道（渠道）：FChannelId 
	 ...
	 付款账户：FBankCode 
	 付款开户行：FOpenBankName 
	 结算客户：FBalanceCustomer 
	 收款银行账户：FRecBankAcntId 
	 收款银行账号：FRecBankAcntCode 
	 打款日期：FActualPayDate 
	 收款组织：FPayeeOrg  (必填项)
	 结算组织：FAccountOrg  (必填项)
	 订货单编号：FOrderBillNo 
	 打回人：FCALLBACKERID 
	 打回时间：FCallbackDate 
...
单据体：FEntity 
	 实体主键：FEntryID 
	 付款业务类型：FPayTypeId  (必填项)
	 金额：FAmount 
	 来源单据标识：FSrcFlag 
	 来源单据ID：FSrcId 
	 是否生成收款单：FReceivable 
	 已关联收款金额：FJoinReceiveAmount 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ESS_PREPAYMENT","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FModifierId":{"FUserID":""},"FApproveId":{"FUserID":""},"FApproveDate":"1900-01-01","FCustomerId":{"FNUMBER":""},"FSaleOrgId":{"FNumber":""},"FPayeeOrg":{"FNumber":""},"FAccountOrg":{"FNumber":""},"FCurrencyId":{"FNUMBER":""},"FOrderTypeID":{"FNUMBER":""},"FRemark":"","FFilePath":"","FChannelId":{"FNUMBER":""},"FCreatorId":{"FUSERNAME":""},"FBalanceChannel":{"FNUMBER":""},"FPayChannel":{"FNUMBER":""},"FAccountName":"","FBankCode":"","FOpenBankName":"","FBalanceCustomer":{"FNUMBER":""},"FRecBankAcntId":{"FNUMBER":""},"FActualPayDate":"1900-01-01","FOrderBillNo":"","FCALLBACKERID":{"FUserID":""},"FCallbackDate":"1900-01-01","FCallbackReason":"","FEntity":[{"FEntryID":0,"FPayTypeId":{"FNumber":""},"FAmount":0,"FSrcFlag":"","FSrcId":0,"FJoinReceiveAmount":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ESS_PREPAYMENT","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ESS_PREPAYMENT","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ESS_PREPAYMENT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ESS_PREPAYMENT","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ESS_PREPAYMENT","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("ESS_PREPAYMENT","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ESS_PREPAYMENT","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ESS_PREPAYMENT"}");

# 资金头寸表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 资金头寸表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 4213 |
...
client.GetSysReportData("CN_FundPositionReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSETTLEORGID":[{"FNumber":""}],"FOrgId":[{"FNumber":""}],"FCurrencyIds":"","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FNotAudit":"false","FInNOut":"false","FMyCurrency":"false","FCurrencySubTotal":"false","FAffiliation":{"FNUMBER":""},"FSettleOrgBox":"false","FPAYORGIDBOX":"false","FMyCurrencySum":"false","FMyPayOrg":"false","FGroupCash":"false","FOrgOrAccount":"","FOrgRadio":"","FAccountRadio":"","FAllCashAccount":"false","FAllBankAccount":"false","FCashAcctId":[{"FNumber":""}],"FBankAccountID":[{"FNumber":""}],"FIsShowCancelBankAcnt":"false","FINCLUDEEMPTY":"false"}}");
...
五、字段说明：
	 ...
	 按组织查询：FOrgRadio 
	 单选按钮组：FOrgOrAccount 
	 所有现金账号：FAllCashAccount 
	 所有银行账号：FAllBankAccount 
	 现金账号：FCashAcctId 
	 银行账号：FBankAccountID 
	 显示已注销银行账号：FIsShowCancelBankAcnt 
	 显示无业务的银行账号：FINCLUDEEMPTY 

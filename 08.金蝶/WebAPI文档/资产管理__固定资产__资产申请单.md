# 资产申请单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 资产申请单
...
client.Delete("FA_REQUISITION","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_REQUISITION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FReqDate":"1900-01-01","FApplicationOrgId":{"FNumber":""},"FApplicationDeptId":{"FNumber":""},"FApplicant":{"FStaffNumber":""},"FPostId":{"FNumber":""},"FPlanUseDate":"1900-01-01","FDescription":"","FRequisitionEntry":[{"FEntryID":0,"FAssetName":{"FNumber":""},"FErpClsID":"","FAssetExplan":"","FUnitId":{"FNumber":""},"FApplicationQTY":0,"FApprovelQTY":0,"FArrivalDate":"1900-01-01","FFuncDescription":"","FApplicationReason":"","FReplaceAssetNo":"","FReplaceName":"","FRemark":""}]}}");
...
单据头：FBillHead 
	 ...
	 申请日期：FReqDate  (必填项)
	 需求组织：FApplicationOrgId  (必填项)
	 需求部门：FApplicationDeptId 
	 需求人：FApplicant 
	 岗位：FPostId 
	 拟使用日期：FPlanUseDate  (必填项)
	 备注：FDescription 
资产：FRequisitionEntry 
	 实体主键：FEntryID 
	 单位：FUnitId  (必填项)
	 申请数量：FApplicationQTY 
	 批准数量：FApprovelQTY 
	 到货日期：FArrivalDate 
	 资产功能描述：FFuncDescription 
	 申请原因：FApplicationReason 
	 备注：FRemark 
	 替换卡片编码：FReplaceAssetNo 
	 替换资产名称：FReplaceName 
	 关联采购数量：FQty 
	 资产名称：FAssetName  (必填项)
	 资产编码：FAssetNo 
	 资产说明：FAssetExplan  (必填项)
	 业务流程：FBFLowId 
	 物料属性：FErpClsID 
	 已领用数量：FRecievedQty 
关联关系表：FRequisitionEntry_Link 
	 实体主键：FLinkId 
	 业务流程图：FRequisitionEntry_Link_FFlowId 
	 推进路线：FRequisitionEntry_Link_FFlowLineId 
	 转换规则：FRequisitionEntry_Link_FRuleId 
	 源单表内码：FRequisitionEntry_Link_FSTableId 
	 源单表：FRequisitionEntry_Link_FSTableName 
	 源单内码：FRequisitionEntry_Link_FSBillId 
	 源单分录内码：FRequisitionEntry_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_REQUISITION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FReqDate":"1900-01-01","FApplicationOrgId":{"FNumber":""},"FApplicationDeptId":{"FNumber":""},"FApplicant":{"FStaffNumber":""},"FPostId":{"FNumber":""},"FPlanUseDate":"1900-01-01","FDescription":"","FRequisitionEntry":[{"FEntryID":0,"FAssetName":{"FNumber":""},"FErpClsID":"","FAssetExplan":"","FUnitId":{"FNumber":""},"FApplicationQTY":0,"FApprovelQTY":0,"FArrivalDate":"1900-01-01","FFuncDescription":"","FApplicationReason":"","FReplaceAssetNo":"","FReplaceName":"","FRemark":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_REQUISITION","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_REQUISITION","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_REQUISITION","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_REQUISITION","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_REQUISITION","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("FA_REQUISITION","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_REQUISITION"}");

# 进项发票明细表 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 进项发票明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3344 |
...
client.GetSysReportData("IV_JXIVDetailReport","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAffiliation":{"FNAME":""},"FContactUnitType":"","FContactUnitFrom":{"FNumber":""},"FEndDate":"1900-01-01","FContactUnitTo":{"FNumber":""},"FSettleOrgIdList":"","FStartDate":"1900-01-01","FIncludeUnAudit":"false","FByBill":"false","FCurrencyIdList":[{"FNumber":""}]}}");

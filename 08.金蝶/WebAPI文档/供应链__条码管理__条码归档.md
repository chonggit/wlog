...
client.Delete("UN_BarCodeArchive","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_BarCodeArchive","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FArchiveDate":"1900-01-01","FArchiver":{"FUserID":""},"FBarCodeMainFile":"false","FSCANRecord":"false","FBarCodePrint":"false","FPackaging":"false","FMainDateStart":"1900-01-01","FScanDateStart":"1900-01-01","FPrintDateStart":"1900-01-01","FPackDateStart":"1900-01-01","FMainDateEnd":"1900-01-01","FScanDateEnd":"1900-01-01","FPrintDateEnd":"1900-01-01","FPackDateEnd":"1900-01-01","FEntity":[{"FEntryID":0,"FBarCodeRule":{"FNUMBER":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FArchiveDate": "1900-01-01",
        "FArchiver": {
            "FUserID": ""
        },
        "FBarCodeMainFile": "false",
        "FSCANRecord": "false",
        "FBarCodePrint": "false",
        "FPackaging": "false",
        "FMainDateStart": "1900-01-01",
        "FScanDateStart": "1900-01-01",
        "FPrintDateStart": "1900-01-01",
        "FPackDateStart": "1900-01-01",
        "FMainDateEnd": "1900-01-01",
        "FScanDateEnd": "1900-01-01",
        "FPrintDateEnd": "1900-01-01",
        "FPackDateEnd": "1900-01-01",
        "FEntity": [
            {
                "FEntryID": 0,
                "FBarCodeRule": {
...
单据头：FBillHead 
	 ...
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 归档日期：FArchiveDate  (必填项)
	 归档人：FArchiver 
	 条码主档：FBarCodeMainFile 
	 条码扫描记录：FSCANRecord 
	 条码打印日志：FBarCodePrint 
	 条码拆装箱：FPackaging 
	 创建日期从：FMainDateStart 
	 至：FMainDateEnd 
	 业务日期从：FScanDateStart 
	 至：FScanDateEnd 
	 创建日期从：FPrintDateStart 
	 至：FPrintDateEnd 
	 创建日期从：FPackDateStart 
	 至：FPackDateEnd 
	 归档状态：FArchiveStatus 
单据体：FEntity 
	 实体主键：FEntryID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_BarCodeArchive","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FArchiveDate":"1900-01-01","FArchiver":{"FUserID":""},"FBarCodeMainFile":"false","FSCANRecord":"false","FBarCodePrint":"false","FPackaging":"false","FMainDateStart":"1900-01-01","FScanDateStart":"1900-01-01","FPrintDateStart":"1900-01-01","FPackDateStart":"1900-01-01","FMainDateEnd":"1900-01-01","FScanDateEnd":"1900-01-01","FPrintDateEnd":"1900-01-01","FPackDateEnd":"1900-01-01","FEntity":[{"FEntryID":0,"FBarCodeRule":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UN_BarCodeArchive","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("UN_BarCodeArchive","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("UN_BarCodeArchive","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("UN_BarCodeArchive","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("UN_BarCodeArchive","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_BarCodeArchive"}");

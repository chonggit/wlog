# 销售航信开票 Web API 操作原始内容

> 来源页面：全部 > 税务管理 > 发票管理 > 销售航信开票
...
client.View("ora_SellInvoice","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("ora_SellInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ora_SellInvoice","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"F_InvoiceNo":"","F_InvoiceCode":"","F_InvoiceDate":"1900-01-01","F_Customer":{"FNUMBER":""},"F_CusTaxpayerID":"","F_CusBilladdresss":"","F_CusTel":"","F_CusAccBanNo":"","F_CusAccBan":"","F_Supplier":{"FNUMBER":""},"F_SupTaxpayerID":"","F_SupBilladdresss":"","F_SupTel":"","F_SupAccBanNo":"","F_SupAccBan":"","F_Creater":"","F_CreatDate":"1900-01-01","F_Updater":"","F_UpdateDate":"1900-01-01","F_Checker":"","F_CheckDate":"1900-01-01","F_Payee":"","F_Reviewer":"","F_Drawer":"","F_Remark":"","F_Currency":{"FNUMBER":""},"F_DutyNo":"","F_BillAmount":0,"F_ReceivedAmount":0,"F_NoReceivedAmount":0,"F_IsLumpSumAmountCheckBox":"false","FDOCUMENTSTATUS":"","F_BGtyppe":{"FNumber":""},"F_ora_SaleBillEntity":[{"FEntryID":0,"F_ItemCode":{"FNUMBER":""},"F_Qty":0,"F_InvText":"","F_Price":0,"F_Amount":0,"F_TaxRate":{"FNUMBER":""},"F_TaxAmount":0,"F_AllAmount":0,"F_SaleOrderNo":"","F_TaxType":"","F_ora_Decimal":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_SupAccBan": "",
        "F_Creater": "",
        "F_CreatDate": "1900-01-01",
        "F_Updater": "",
        "F_UpdateDate": "1900-01-01",
        "F_Checker": "",
        "F_CheckDate": "1900-01-01",
        "F_Payee": "",
        "F_Reviewer": "",
        "F_Drawer": "",
        "F_Remark": "",
        ...
        "F_BillAmount": 0,
        "F_ReceivedAmount": 0,
        "F_NoReceivedAmount": 0,
        "F_IsLumpSumAmountCheckBox": "false",
        "FDOCUMENTSTATUS": "",
        "F_BGtyppe": {
            "FNumber": ""
        },
        "F_ora_SaleBillEntity": [
            {
                "FEntryID": 0,
                "F_ItemCode": {
                    "FNUMBER": ""
...
单据头：FBillHead 
	 ...
	 发票日期：F_InvoiceDate 
	 客户：F_Customer 
	 客户纳税人识别号：F_CusTaxpayerID 
	 客户开票地址：F_CusBilladdresss 
	 客户电话：F_CusTel 
	 客户开户行：F_CusAccBanNo 
	 客户开户行账号：F_CusAccBan 
	 销售方名称：F_Supplier 
	 销售方纳税人识别号：F_SupTaxpayerID 
	 销售方地址：F_SupBilladdresss 
	 销售方电话：F_SupTel 
	 销售方开户行：F_SupAccBanNo 
	 销售方开户行账号：F_SupAccBan 
	 创建人：F_Creater 
	 创建日期：F_CreatDate 
	 修改人：F_Updater 
	 修改日期：F_UpdateDate 
	 ...
	 税号：F_DutyNo 
	 发票总金额：F_BillAmount 
	 已收款金额：F_ReceivedAmount 
	 未收款金额：F_NoReceivedAmount 
	 是否全额收款：F_IsLumpSumAmountCheckBox 
	 单据状态：FDOCUMENTSTATUS  (必填项)
	 报关方式：F_BGtyppe 
明细信息：F_ora_SaleBillEntity 
	 实体主键：FEntryID 
	 物料编码：F_ItemCode 
	 物料名称：F_ItemName 
	 规格型号：F_ItemStd 
	 单位：F_Unit 
	 数量：F_Qty 
	 货物或应税劳务、服务名称：F_InvText 
	 不含税单价：F_Price 
	 不含税金额：F_Amount 
	 税率：F_TaxRate 
	 税额：F_TaxAmount 
	 价税合计：F_AllAmount 
	 金蝶源单单号：F_SaleOrderNo 
	 税分类：F_TaxType 
	 金蝶源单行号：F_ora_Decimal 
	 产品一级大类：F_CPYJDL 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ora_SellInvoice","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"F_InvoiceNo":"","F_InvoiceCode":"","F_InvoiceDate":"1900-01-01","F_Customer":{"FNUMBER":""},"F_CusTaxpayerID":"","F_CusBilladdresss":"","F_CusTel":"","F_CusAccBanNo":"","F_CusAccBan":"","F_Supplier":{"FNUMBER":""},"F_SupTaxpayerID":"","F_SupBilladdresss":"","F_SupTel":"","F_SupAccBanNo":"","F_SupAccBan":"","F_Creater":"","F_CreatDate":"1900-01-01","F_Updater":"","F_UpdateDate":"1900-01-01","F_Checker":"","F_CheckDate":"1900-01-01","F_Payee":"","F_Reviewer":"","F_Drawer":"","F_Remark":"","F_Currency":{"FNUMBER":""},"F_DutyNo":"","F_BillAmount":0,"F_ReceivedAmount":0,"F_NoReceivedAmount":0,"F_IsLumpSumAmountCheckBox":"false","FDOCUMENTSTATUS":"","F_BGtyppe":{"FNumber":""},"F_ora_SaleBillEntity":[{"FEntryID":0,"F_ItemCode":{"FNUMBER":""},"F_Qty":0,"F_InvText":"","F_Price":0,"F_Amount":0,"F_TaxRate":{"FNUMBER":""},"F_TaxAmount":0,"F_AllAmount":0,"F_SaleOrderNo":"","F_TaxType":"","F_ora_Decimal":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ora_SellInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ora_SellInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ora_SellInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ora_SellInvoice","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ora_SellInvoice"}");

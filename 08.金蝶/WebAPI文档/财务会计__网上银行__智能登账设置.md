# 智能登账设置 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 网上银行 > 智能登账设置
...
client.Delete("WB_ReceiveFromBankPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("WB_ReceiveFromBankPlan","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("WB_ReceiveFromBankPlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FCURRENCYID":{"FNUMBER":""},"FUseOrgId":{"FNumber":""},"FDescription":"","FDATASOUR":"","FDRAFTBILL":"false","FBillEntity":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FBillTypeId":{"FNUMBER":""},"FEntryBillState":"","FENTRYSETTLETYPEID":{"FNUMBER":""},"FBANKACCOUNTID":{"FNUMBER":""},"FISAutoConfirm":"false","FCONTACTUNITTYPE":"","FCONTACTUNIT":"","FFIXEDUNIT":{"FNumber":""},"FBUSINESSTYPE":"","FENTRYISCONACTCREATEBILL":"false","FPURPOSEID":{"FNumber":""},"FISREFUND":"false","FLastDate":"1900-01-01","FENTRYEXECREATORID":{"FName":""}}]}}");
        ...
        "FBillEntity": [
            {
                ...
                "FBUSINESSTYPE": "",
                "FENTRYISCONACTCREATEBILL": "false",
                "FPURPOSEID": {
                    "FNumber": ""
                },
                "FISREFUND": "false",
...
单据头：FBillHead 
	 ...
	 结算方式：FSETTLETYPEID 
	 执行人：FEXECREATORID 
	 往来单位为空不生成暂存单据：FISCONACTCREATEBILL 
	 数据来源：FDATASOUR  (必填项)
	 生成单据失败时暂存单据：FDRAFTBILL 
单据体：FBillEntity 
	 实体主键：FEntryID 
	 银行账号：FBANKACCOUNTID  (必填项)
	 ...
	 结算组织：FSETTLEORGID 
	 条件设置：FBillFilter 
	 条件设置过滤：FBillFilterIn 
	 条件设置过滤编码：FBillFilterNumber 
	 FXML：FXML 
	 单据类型：FBillTypeId  (必填项)
	 是否按自动匹配规则：FISAutoConfirm 
	 固定往来单位：FFIXEDUNIT 
	 退款流水：FISREFUND 
	 执行人：FENTRYEXECREATORID  (必填项)
	 单据状态：FEntryBillState  (必填项)
	 往来单位为空不生成单据：FENTRYISCONACTCREATEBILL 
	 结算方式：FENTRYSETTLETYPEID  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("WB_ReceiveFromBankPlan","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FCURRENCYID":{"FNUMBER":""},"FUseOrgId":{"FNumber":""},"FDescription":"","FDATASOUR":"","FDRAFTBILL":"false","FBillEntity":[{"FEntryID":0,"FSETTLEORGID":{"FNumber":""},"FBillTypeId":{"FNUMBER":""},"FEntryBillState":"","FENTRYSETTLETYPEID":{"FNUMBER":""},"FBANKACCOUNTID":{"FNUMBER":""},"FISAutoConfirm":"false","FCONTACTUNITTYPE":"","FCONTACTUNIT":"","FFIXEDUNIT":{"FNumber":""},"FBUSINESSTYPE":"","FENTRYISCONACTCREATEBILL":"false","FPURPOSEID":{"FNumber":""},"FISREFUND":"false","FLastDate":"1900-01-01","FENTRYEXECREATORID":{"FName":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("WB_ReceiveFromBankPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("WB_ReceiveFromBankPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("WB_ReceiveFromBankPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("WB_ReceiveFromBankPlan","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("WB_ReceiveFromBankPlan","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("WB_ReceiveFromBankPlan","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("WB_ReceiveFromBankPlan","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"WB_ReceiveFromBankPlan"}");

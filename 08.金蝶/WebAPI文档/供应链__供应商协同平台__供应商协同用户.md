# 供应商协同用户 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 供应商协同平台 > 供应商协同用户
...
client.Save("SCP_SupUser","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FUserID":0,"FDomainUser":"","FUserAccount":"","FEmail":"","FName":"","FMBACCONT":"","FType":"","FDynamicPassword":{"FSERIALNUMBER":""},"FLinkObject":{"FNumber":""},"FPRIMARYGROUP":{"FNumber":""},"FPhone":"","FDescription":"","FSocialId":"","FEnableUserId":{"FUserID":""},"FDisableUserId":{"FUserID":""},"FEnableTime":"1900-01-01","FDisableTime":"1900-01-01","FAppGroup":"","FKdPassportId":"","FSex":"","FSignetPath":"","FFaceUid":"","FIsLockTerminal":"false","FIsRegister":"false","FBINDTIME":"1900-01-01","FSupplierData":{"FEntryId":0,"FSupplierId":{"FNUMBER":""}},"FOrgInfo":[{"FEntityID":0,"FOrgOrgId":{"FNumber":""},"FRoleInfo":[{"FDetailID":0,"FRoleId":{"FNumber":""}}]}]}}");
...
用户：FBillHead 
	 ...
	 人脸采集：FFaceImg 
	 人脸采集UID：FFaceUid 
	 锁定终端：FIsLockTerminal 
	 是否激活：FIsRegister 
	 绑定时间：FBINDTIME 
	 金蝶·云账号：FCLOUDACCOUNT 
	 金蝶·云账号凭证：FIDENTITY 
组织范围：FOrgInfo 
	 实体主键：FEntityID 
	 组织编码：FOrgOrgId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SCP_SupUser","Disable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SCP_SupUser","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SCP_SupUser","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SCP_SupUser","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SCP_SupUser"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("SCP_SupUser","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("SCP_SupUser","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("SCP_SupUser","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

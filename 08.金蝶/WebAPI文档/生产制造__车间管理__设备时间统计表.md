# 设备时间统计表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 设备时间统计表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2826 |
...
client.GetSysReportData("SFC_EquipmentMonthlyAnalyRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FOrgIds":[{"FNumber":""}],"FEquipmentIds":[{"FNumber":""}],"FCombo_Year":"","FCombo_Month":"","FDateTypeGroup":"","FNaturalDay":"","FCalendarDay":"","FCountDateGroup":"","FRadioBeforeMonth":"","FRadioCurrMonth":"","FRadioSeason":"","FRadioYear":"","FBeginCountDate":"1900-01-01","FEndCountDate":"1900-01-01"}}");

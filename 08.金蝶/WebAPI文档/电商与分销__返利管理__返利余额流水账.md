# 返利余额流水账 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 返利管理 > 返利余额流水账

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 不参与报表统计 | RptExcept | 3307 |
| 参与报表统计 | NotRptExcept | 3310 |
| 批量保存 | BatchSave | 3067 |
| 单据查询 | ExecuteBillQuery | 1876 |
| 单据查询(json) | BillQuery | 1861 |
| 元数据查询 | QueryBusinessInfo | 863 |
...
client.ExcuteOperation("RPM_ViewAccountBalanceDetail","RptExcept","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FCustomerID":{"FNUMBER":""},"FAccountBalanceID":0,"FFinOrgId":{"FNumber":""},"FCurrencyID":{"FNUMBER":""},"FAccountID":{"FNUMBER":""},"FSrcType":"","FSrcFormID":"","FBillID":0,"FAmount":0,"FUpdateTime":"1900-01-01","FOperationID":{"FUserID":""},"FBalanceAmount":0,"FBillNo":"","FOperationLot":0,"FBillRemark":"","FOrderCustomerId":{"FNUMBER":""},"FIsRptExcept":"false","FIsGroupRebate":"false","FGroupCustomerId":{"FNUMBER":""},"FOptFormId":"","FOperateCode":""}}");
...
基本信息：FBillHead 
	 ...
	 操作人：FOperationID 
	 更新日期：FUpdateTime 
	 结余账户余额：FBalanceAmount 
	 金额：FAmount 
	 单据编号：FBillNo 
	 更新批次：FOperationLot 
	 单据ID：FBillID 
	 账户余额ID：FAccountBalanceID 
	 单据备注：FBillRemark 
	 返利客户：FOrderCustomerId 
	 返利客户编码：FOrderCustomerNum 
	 结算客户编码：FCustomerNumber 
	 不参与报表统计：FIsRptExcept 
	 集团返利：FIsGroupRebate 
	 集团客户：FGroupCustomerId 
	 集团客户编码：FGroupCustomerNumber 
	 更新操作单据标识：FOptFormId 
	 单据操作代码：FOperateCode 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("RPM_ViewAccountBalanceDetail","NotRptExcept","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FCustomerID":{"FNUMBER":""},"FAccountBalanceID":0,"FFinOrgId":{"FNumber":""},"FCurrencyID":{"FNUMBER":""},"FAccountID":{"FNUMBER":""},"FSrcType":"","FSrcFormID":"","FBillID":0,"FAmount":0,"FUpdateTime":"1900-01-01","FOperationID":{"FUserID":""},"FBalanceAmount":0,"FBillNo":"","FOperationLot":0,"FBillRemark":"","FOrderCustomerId":{"FNUMBER":""},"FIsRptExcept":"false","FIsGroupRebate":"false","FGroupCustomerId":{"FNUMBER":""},"FOptFormId":"","FOperateCode":""}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("RPM_ViewAccountBalanceDetail","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RPM_ViewAccountBalanceDetail"}");

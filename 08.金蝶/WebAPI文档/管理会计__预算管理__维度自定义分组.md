# 维度自定义分组 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 维度自定义分组
...
client.Delete("BM_DIMCUSTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_DIMCUSTGROUP","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_DIMCUSTGROUP","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRemark":"","FCustomizeGroup":{"FNUMBER":""},"FDetailDimGroup":{"FNUMBER":""},"FDimFilter":"false","FDimFilterViewName":"","FDimCustomizeGroupEntity":[{"FEntryID":0,"FCustDetailNumber":"","FCustDetailMasterId":"","FCustDetailName":"","FDimCustomizeGroupSubEntity":[{"FDetailID":0,"FDimDetailNumber":"","FDimDetailName":"","FDimDetailOwnerOrgName":"","FDimDetailId":""}],"FDimFilterSubEntity":[{"FDetailID":0,"FDimFilterSql":"","FDimFilterName":"","FDimFilterSqlDesc":""}]}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDimFilter": "false",
        "FDimFilterViewName": "",
        "FDimCustomizeGroupEntity": [
            {
                "FEntryID": 0,
                "FCustDetailNumber": "",
                "FCustDetailMasterId": "",
                "FCustDetailName": "",
                "FDimCustomizeGroupSubEntity": [
                    {
                        "FDetailID": 0,
                        "FDimDetailNumber": "",
                        "FDimDetailName": "",
                        "FDimDetailOwnerOrgName": "",
                        "FDimDetailId": ""
                    }
                ],
                "FDimFilterSubEntity": [
...
单据头：FBillHead 
	 ...
	 编码：FNumber 
	 描述：FRemark 
	 自定义分组：FCustomizeGroup 
	 对应明细预算维度：FDetailDimGroup 
	 过滤：FDimFilter 
	 维度过滤名称：FDimFilterViewName 
自定义分组：FDimCustomizeGroupEntity 
	 实体主键：FEntryID 
	 编码：FCustDetailNumber 
	 名称：FCustDetailName 
	 内码ID：FCustDetailMasterId 
对应维度子单据体：FDimCustomizeGroupSubEntity 
	 实体主键：FDetailID 
	 编码：FDimDetailNumber 
	 名称：FDimDetailName 
	 所属组织：FDimDetailOwnerOrgName 
	 内码Id：FDimDetailId 
子单据体：FDimFilterSubEntity 
	 实体主键：FDetailID 
	 维度过滤SQL：FDimFilterSql 
	 维度过滤名称：FDimFilterName 
	 维度过滤条件多语言：FDimFilterSqlDesc 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_DIMCUSTGROUP","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRemark":"","FCustomizeGroup":{"FNUMBER":""},"FDetailDimGroup":{"FNUMBER":""},"FDimFilter":"false","FDimFilterViewName":"","FDimCustomizeGroupEntity":[{"FEntryID":0,"FCustDetailNumber":"","FCustDetailMasterId":"","FCustDetailName":"","FDimCustomizeGroupSubEntity":[{"FDetailID":0,"FDimDetailNumber":"","FDimDetailName":"","FDimDetailOwnerOrgName":"","FDimDetailId":""}],"FDimFilterSubEntity":[{"FDetailID":0,"FDimFilterSql":"","FDimFilterName":"","FDimFilterSqlDesc":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BM_DIMCUSTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_DIMCUSTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_DIMCUSTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_DIMCUSTGROUP","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_DIMCUSTGROUP","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BM_DIMCUSTGROUP","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_DIMCUSTGROUP","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_DIMCUSTGROUP"}");

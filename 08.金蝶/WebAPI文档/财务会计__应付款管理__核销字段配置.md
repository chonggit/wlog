# 核销字段配置 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应付款管理 > 核销字段配置
...
client.Delete("AP_FieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("AP_FieldConfig","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("AP_FieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FFieldName":"","FJoinField":"","FShowName":"","FShowSeqInner":0,"FISSHOWSPECIALInner":"false","FInnerNAME":"","FIsShowSpecial":"false","FWidth":0,"FShowSeq":0,"FIsDefaultShow":"false","FFieldType":"","FIsSystemDefault":"false","FMatchType":"","FName":"","FLenght":0,"FIsMustSelect":"","FISSHOWWRITEOFF":"false","FWRITEOFFNAME":"","FWRITEOFFSEQ":0,"FCreateType":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FShowName": "",
        "FShowSeqInner": 0,
        "FISSHOWSPECIALInner": "false",
        "FInnerNAME": "",
        "FIsShowSpecial": "false",
        "FWidth": 0,
        "FShowSeq": 0,
        "FIsDefaultShow": "false",
        "FFieldType": "",
        "FIsSystemDefault": "false",
        "FMatchType": "",
        "FName": "",
        "FLenght": 0,
        "FIsMustSelect": "",
        "FISSHOWWRITEOFF": "false",
        "FWRITEOFFNAME": "",
        "FWRITEOFFSEQ": 0,
        "FCreateType": "",
...
单据头：FBillHead 
	 ...
	 核销类型：FMatchType  (必填项)
	 字段名：FFieldName 
	 是否系统默认：FIsSystemDefault 
	 字段类型：FFieldType 
	 显示在核销方案匹配项目中：FIsDefaultShow 
	 长度：FLenght 
	 关联字段：FJoinField 
	 显示在特殊核销页面的宽度：FWidth 
	 显示在特殊核销页面的字段：FShowName 
	 显示序号：FShowSeq 
	 显示在手工核销界面上：FIsShowSpecial 
	 内部清理名称：FInnerNAME 
	 显示在内部清理界面上：FISSHOWSPECIALInner 
	 内部清理序号：FShowSeqInner 
	 选择方式：FIsMustSelect  (必填项)
	 显示在转销界面上：FISSHOWWRITEOFF 
	 转销名称：FWRITEOFFNAME 
	 转销序号：FWRITEOFFSEQ 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("AP_FieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FFieldName":"","FJoinField":"","FShowName":"","FShowSeqInner":0,"FISSHOWSPECIALInner":"false","FInnerNAME":"","FIsShowSpecial":"false","FWidth":0,"FShowSeq":0,"FIsDefaultShow":"false","FFieldType":"","FIsSystemDefault":"false","FMatchType":"","FName":"","FLenght":0,"FIsMustSelect":"","FISSHOWWRITEOFF":"false","FWRITEOFFNAME":"","FWRITEOFFSEQ":0,"FCreateType":"","FCreateDate":"1900-01-01","FModifyDate":"1900-01-01"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("AP_FieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("AP_FieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("AP_FieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AP_FieldConfig","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("AP_FieldConfig","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("AP_FieldConfig","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"AP_FieldConfig"}");

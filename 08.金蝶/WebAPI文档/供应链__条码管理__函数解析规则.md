# 函数解析规则 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 函数解析规则
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1471 |
| 分组信息查询 | QueryGroupInfo | 1184 |
| 分组删除 | GroupDelete | 1084 |
...
client.Delete("UNW_FunctionParseRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UNW_FunctionParseRule","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UNW_FunctionParseRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FMaterialAllocationRule":"","FDataSplitChar":"","FAuditorId":{"FUserID":""},"FAuditDate":"1900-01-01","FMaterialGroup":{"FNumber":""},"FIsDefault":"false","FQrcodeParseRuleEntity":[{"FEntryID":0,"FQrcodeRuleField":{"FNUMBER":""},"FArrayIndex":0,"FQrcodePrefixLength":0,"FInterceptLength":0,"FQrcodeSuffixLength":0,"FQrcodeProcessFunction":""}],"FFieldParseRuleEntity":[{"FEntryID":0,"FFieldField":{"FNUMBER":""},"FFieldPrefixLength":0,"FFieldInterceptLength":0,"FFieldSuffixLength":0,"FFieldProcessFunction":"","FIsAnalyseTogether":"false","FGroupNo":0}]}}");
        ...
        "FQrcodeParseRuleEntity": [
            {
                ...
                "FArrayIndex": 0,
                "FQrcodePrefixLength": 0,
                "FInterceptLength": 0,
                "FQrcodeSuffixLength": 0,
                "FQrcodeProcessFunction": ""
            }
        ],
        "FFieldParseRuleEntity": [
            {
                ...
                "FFieldPrefixLength": 0,
                "FFieldInterceptLength": 0,
                "FFieldSuffixLength": 0,
                "FFieldProcessFunction": "",
                "FIsAnalyseTogether": "false",
                "FGroupNo": 0
            }
        ]
    }
...
单据头：FBillHead 
	 ...
	 修改日期：FModifyDate 
	 描述：FDescription 
	 物料分配规则：FMaterialAllocationRule  (必填项)
	 数据分隔符：FDataSplitChar 
	 审核人：FAuditorId 
	 审核日期：FAuditDate 
	 物料分组：FMaterialGroup 
	 默认规则：FIsDefault 
	 物料品牌：FMaterialBrandId 
二维码解析规则：FQrcodeParseRuleEntity 
	 实体主键：FEntryID 
	 字段：FQrcodeRuleField  (必填项)
	 前缀长度：FQrcodePrefixLength 
	 截取长度：FInterceptLength 
	 后缀长度：FQrcodeSuffixLength 
	 处理函数：FQrcodeProcessFunction 
	 数组：FArrayIndex 
栏位解析规则：FFieldParseRuleEntity 
	 实体主键：FEntryID 
	 字段：FFieldField  (必填项)
	 前缀长度：FFieldPrefixLength 
	 截取长度：FFieldInterceptLength 
	 后缀长度：FFieldSuffixLength 
	 处理函数：FFieldProcessFunction 
	 同时解析：FIsAnalyseTogether 
	 分组号：FGroupNo 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UNW_FunctionParseRule","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FMaterialAllocationRule":"","FDataSplitChar":"","FAuditorId":{"FUserID":""},"FAuditDate":"1900-01-01","FMaterialGroup":{"FNumber":""},"FIsDefault":"false","FQrcodeParseRuleEntity":[{"FEntryID":0,"FQrcodeRuleField":{"FNUMBER":""},"FArrayIndex":0,"FQrcodePrefixLength":0,"FInterceptLength":0,"FQrcodeSuffixLength":0,"FQrcodeProcessFunction":""}],"FFieldParseRuleEntity":[{"FEntryID":0,"FFieldField":{"FNUMBER":""},"FFieldPrefixLength":0,"FFieldInterceptLength":0,"FFieldSuffixLength":0,"FFieldProcessFunction":"","FIsAnalyseTogether":"false","FGroupNo":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("UNW_FunctionParseRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("UNW_FunctionParseRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("UNW_FunctionParseRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UNW_FunctionParseRule","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UNW_FunctionParseRule","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("UNW_FunctionParseRule","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UNW_FunctionParseRule"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("UNW_FunctionParseRule","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("UNW_FunctionParseRule","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("UNW_FunctionParseRule","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

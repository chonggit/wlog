# 工作流角色 Web API 操作原始内容

> 来源页面：全部 > 流程中心 > 工作流 > 工作流角色
...
client.Delete("WF_WFRole","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("WF_WFRole","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("WF_WFRole","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FType":"","FIsFiilterByDept":"false","FIsFiilterByOrg":"false","FOrg":{"FNumber":""},"FEmpEntity":[{"FEntryID":0,"F_Emp_Emp":{"FSTAFFNUMBER":""},"F_Emp_Org":{"FNumber":""},"F_Emp_Dept":{"FNUMBER":""},"F_Emp_IncludeSubs":"false"}],"FPostEntity":[{"FEntryID":0,"F_Post_Post":{"FNumber":""},"F_Post_Org":{"FNumber":""},"F_Post_Dept":{"FNUMBER":""},"F_Post_IncludeSubs":"false"}],"FDeptEntity":[{"FEntryID":0,"F_Dept_Dept":{"FNUMBER":""},"F_Dept_IncludeSubs":"false","F_Dept_Org":{"FNumber":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDescription": "",
        "FType": "",
        "FIsFiilterByDept": "false",
        "FIsFiilterByOrg": "false",
        "FOrg": {
            "FNumber": ""
        },
        "FEmpEntity": [
...
单据头：FBillHead 
	 ...
	 描述：FDescription 
	 角色类型：FType  (必填项)
	 按单据部门过滤：FIsFiilterByDept 
	 按单据组织过滤：FIsFiilterByOrg 
	 所属组织：FOrg 
员工明细：FEmpEntity 
	 实体主键：FEntryID 
	 审批部门：F_Emp_Dept 
	 包含下级：F_Emp_IncludeSubs 
	 员工编码：F_Emp_Emp 
	 员工名称：F_Emp_Name 
	 审批组织：F_Emp_Org 
	 员工.所属组织：F_Emp_Emp_UseOrg 
	 审批部门.所属组织：F_Emp_Dept_UseOrg 
岗位明细：FPostEntity 
	 实体主键：FEntryID 
	 审批部门：F_Post_Dept 
	 包含下级：F_Post_IncludeSubs 
	 岗位编码：F_Post_Post 
	 岗位名称：F_Post_Name 
	 审批组织：F_Post_Org 
	 岗位.所属组织：F_Post_Post_UseOrg 
	 审批部门.所属组织：F_Post_Dept_UseOrg 
部门明细：FDeptEntity 
	 实体主键：FEntryID 
	 审批部门：F_Dept_Dept 
	 包含下级：F_Dept_IncludeSubs 
	 部门编码：F_Dept_Number 
	 部门全称：F_Dept_FullName 
	 审批组织：F_Dept_Org 
	 审批部门.所属组织：F_Dept_Dept_UseOrg 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("WF_WFRole","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FType":"","FIsFiilterByDept":"false","FIsFiilterByOrg":"false","FOrg":{"FNumber":""},"FEmpEntity":[{"FEntryID":0,"F_Emp_Emp":{"FSTAFFNUMBER":""},"F_Emp_Org":{"FNumber":""},"F_Emp_Dept":{"FNUMBER":""},"F_Emp_IncludeSubs":"false"}],"FPostEntity":[{"FEntryID":0,"F_Post_Post":{"FNumber":""},"F_Post_Org":{"FNumber":""},"F_Post_Dept":{"FNUMBER":""},"F_Post_IncludeSubs":"false"}],"FDeptEntity":[{"FEntryID":0,"F_Dept_Dept":{"FNUMBER":""},"F_Dept_IncludeSubs":"false","F_Dept_Org":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("WF_WFRole","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("WF_WFRole","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("WF_WFRole","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("WF_WFRole","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("WF_WFRole","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("WF_WFRole","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("WF_WFRole","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"WF_WFRole"}");

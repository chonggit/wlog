# 自动发货方案设置 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 自动发货方案设置
...
client.Delete("SAL_AutoDEScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SAL_AutoDEScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SAL_AutoDEScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FFilterString":"","FFilterSetting":"","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FModifyDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FDeliveryMode":"","FByCustStock":"false","FNeedMidCheckBill":"false","FCombineCreate":"false","FPlugIn":"","FCreateDeliveryStatus":"","FIncludeLowReserve":"false","FCheckExpectQty":"false","FFilterItems":[{"FEntryID":0,"FFilterField":"","FCompareType":"","FLeftBracket":"","FLogic":"","FRightBracket":"","FValue":"","FFilterKey":""}],"FPriorEntity":[{"FEntryID":0,"FPriorSetKey":{"FName":""},"FPriorOrient":""}],"FStockSetEntity":[{"FEntryID":0,"FStockSetFieldKey":{"FName":""},"FStockSetOrient":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDeliveryMode": "",
        "FByCustStock": "false",
        "FNeedMidCheckBill": "false",
        "FCombineCreate": "false",
        "FPlugIn": "",
        "FCreateDeliveryStatus": "",
        "FIncludeLowReserve": "false",
        "FCheckExpectQty": "false",
        "FFilterItems": [
            {
                "FEntryID": 0,
                "FFilterField": "",
...
单据头：FBillHead 
	 ...
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 发货选项：FDeliveryMode  (必填项)
	 按客户对应仓库表匹配发货组织及仓库：FByCustStock 
	 是否需要中间发货确认单：FNeedMidCheckBill 
	 按单据转换的分组策略合并生成发货通知单：FCombineCreate 
	 自定义插件：FPlugIn 
	 生成发货通知单状态：FCreateDeliveryStatus  (必填项)
	 计算可发数量统计弱预留数量：FIncludeLowReserve 
	 检查可发量：FCheckExpectQty 
过滤项目：FFilterItems 
	 实体主键：FEntryID 
	 过滤字段：FFilterField 
	 ...
	 比较值：FValue 
	 过滤字段Key：FFilterKey 
发货优先级单据体：FPriorEntity 
	 实体主键：FEntryID 
	 优先依据：FPriorSetKey 
	 排序规则：FPriorOrient 
发货匹配单据体：FStockSetEntity 
	 实体主键：FEntryID 
	 匹配依据：FStockSetFieldKey 
	 排序规则：FStockSetOrient 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SAL_AutoDEScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FFilterString":"","FFilterSetting":"","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FModifyDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FDeliveryMode":"","FByCustStock":"false","FNeedMidCheckBill":"false","FCombineCreate":"false","FPlugIn":"","FCreateDeliveryStatus":"","FIncludeLowReserve":"false","FCheckExpectQty":"false","FFilterItems":[{"FEntryID":0,"FFilterField":"","FCompareType":"","FLeftBracket":"","FLogic":"","FRightBracket":"","FValue":"","FFilterKey":""}],"FPriorEntity":[{"FEntryID":0,"FPriorSetKey":{"FName":""},"FPriorOrient":""}],"FStockSetEntity":[{"FEntryID":0,"FStockSetFieldKey":{"FName":""},"FStockSetOrient":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SAL_AutoDEScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SAL_AutoDEScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SAL_AutoDEScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SAL_AutoDEScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("SAL_AutoDEScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SAL_AutoDEScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("SAL_AutoDEScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SAL_AutoDEScheme"}");

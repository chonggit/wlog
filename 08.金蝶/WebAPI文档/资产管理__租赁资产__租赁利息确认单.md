# 租赁利息确认单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 租赁资产 > 租赁利息确认单
...
client.Delete("FA_LEASEINTERESTCONFIRM","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_LEASEINTERESTCONFIRM","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAssetOrgID":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FBUSDATE":"1900-01-01","FINTERESTCONFIRMMODE":"","FLEASEINID":{"FNUMBER":""},"FLOCALCURRID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FEXCHANGETYPEID":{"FNUMBER":""},"FEXCHANGERATE":0,"FISDAYRULE":"false","FA_LEASEINTERESTENTRY":[{"FEntryID":0,"FPAYDATE":0,"FPRINCIPAL":0,"FDISCOUNTRATE":0,"FNOTFINANCIALCHARGES":0,"FPAYINTEREST":0,"FCONFIRMINTEREST":0,"FPRINCIPALSTD":0,"FPAYINTERESTD":0,"FCONFIRMINTERESTSTD":0,"FSTARTDATE":"1900-01-01","FENDDATE":"1900-01-01","FDAYS":0,"FTOTALDAYS":0,"FREMARK":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FEXCHANGERATE": 0,
        "FISDAYRULE": "false",
        "FA_LEASEINTERESTENTRY": [
            {
                "FEntryID": 0,
                "FPAYDATE": 0,
                "FPRINCIPAL": 0,
                "FDISCOUNTRATE": 0,
                "FNOTFINANCIALCHARGES": 0,
                "FPAYINTEREST": 0,
                "FCONFIRMINTEREST": 0,
                "FPRINCIPALSTD": 0,
                "FPAYINTERESTD": 0,
                "FCONFIRMINTERESTSTD": 0,
...
单据头：FBillHead 
	 ...
	 按天计算利息（判断利息确认方式）：FISDAYRULE 
明细：FA_LEASEINTERESTENTRY 
	 实体主键：FEntryID 
	 付款期：FPAYDATE 
	 期初本金：FPRINCIPAL 
	 实际折现率：FDISCOUNTRATE 
	 期初未确认融资费：FNOTFINANCIALCHARGES 
	 本付款期利息：FPAYINTEREST 
	 本期确认利息：FCONFIRMINTEREST 
	 期初本金（本位币）：FPRINCIPALSTD 
	 本付款期利息（本位币）：FPAYINTERESTD 
	 本期确认利息（本位币）：FCONFIRMINTERESTSTD 
	 开始日期：FSTARTDATE 
	 结束日期：FENDDATE 
	 天数：FDAYS 
	 本付款期总天数：FTOTALDAYS 
	 备注：FREMARK 
关联关系表：FA_LEASEINTERESTENTRY_Link 
	 实体主键：FLinkId 
	 业务流程图：FA_LEASEINTERESTENTRY_Link_FFlowId 
	 推进路线：FA_LEASEINTERESTENTRY_Link_FFlowLineId 
	 转换规则：FA_LEASEINTERESTENTRY_Link_FRuleId 
	 源单表内码：FA_LEASEINTERESTENTRY_Link_FSTableId 
	 源单表：FA_LEASEINTERESTENTRY_Link_FSTableName 
	 源单内码：FA_LEASEINTERESTENTRY_Link_FSBillId 
	 源单分录内码：FA_LEASEINTERESTENTRY_Link_FSId 
	 原始携带量：FA_LEASEINTERESTENTRY_Link_FCONFIRMINTERESTOld 
	 修改携带量：FA_LEASEINTERESTENTRY_Link_FCONFIRMINTEREST 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_LEASEINTERESTCONFIRM","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FAssetOrgID":{"FNumber":""},"FOwnerOrgID":{"FNumber":""},"FBUSDATE":"1900-01-01","FINTERESTCONFIRMMODE":"","FLEASEINID":{"FNUMBER":""},"FLOCALCURRID":{"FNUMBER":""},"FCURRENCYID":{"FNUMBER":""},"FEXCHANGETYPEID":{"FNUMBER":""},"FEXCHANGERATE":0,"FISDAYRULE":"false","FA_LEASEINTERESTENTRY":[{"FEntryID":0,"FPAYDATE":0,"FPRINCIPAL":0,"FDISCOUNTRATE":0,"FNOTFINANCIALCHARGES":0,"FPAYINTEREST":0,"FCONFIRMINTEREST":0,"FPRINCIPALSTD":0,"FPAYINTERESTD":0,"FCONFIRMINTERESTSTD":0,"FSTARTDATE":"1900-01-01","FENDDATE":"1900-01-01","FDAYS":0,"FTOTALDAYS":0,"FREMARK":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_LEASEINTERESTCONFIRM","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_LEASEINTERESTCONFIRM","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_LEASEINTERESTCONFIRM","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_LEASEINTERESTCONFIRM","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_LEASEINTERESTCONFIRM"}");

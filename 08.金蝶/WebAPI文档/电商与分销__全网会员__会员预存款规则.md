# 会员预存款规则 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 全网会员 > 会员预存款规则
...
client.Delete("MMC_MEMBER_PREDEPOSIT_RULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("MMC_MEMBER_PREDEPOSIT_RULE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("MMC_MEMBER_PREDEPOSIT_RULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FDocumentStatus":"","FForbidStatus":"","FName":"","FMemberType":{"FNUMBER":""},"FStartDate":"1900-01-01","FendDate":"1900-01-01","FPreDepositAccount":{"FNUMBER":""},"FCashGiving":"false","FScoreGiving":"false","FCashGivingType":"","FScoreGivingType":"","FInMainAccount":"","FInMainAccountScore":"","FLevel":0,"FDescription":"","FOrg":{"FNumber":""},"FPreDepositDetail":[{"FENTRYID":0,"FDepositGlt":0,"FDepositLt":0,"FCashGivingEntry":0,"FScoreGivingEntry":0}],"FOrgScope":[{"FENTRYID":0,"ForgEntry":{"FNUMBER":""}}]}}");
...
单据头：FBillHead 
	 ...
	 名称：FName  (必填项)
	 编码：FNumber  (必填项)
	 会员种类：FMemberType  (必填项)
	 有效期始：FStartDate  (必填项)
	 有效期至：FendDate  (必填项)
	 预存款账户：FPreDepositAccount  (必填项)
	 赠送金额：FCashGiving 
	 赠送积分：FScoreGiving 
	 下拉列表：FCashGivingType  (必填项)
	 下拉列表：FScoreGivingType  (必填项)
	 下拉列表：FInMainAccount  (必填项)
	 优先级：FLevel 
	 说明：FDescription 
	 下拉列表：FInMainAccountScore  (必填项)
	 创建组织：FOrg  (必填项)
单据体：FPreDepositDetail 
	 实体主键：FENTRYID 
	 存款金额>=：FDepositGlt 
	 存款金额<：FDepositLt 
	 赠送金额(固定/比例)：FCashGivingEntry 
	 赠送积分(固定/比例)：FScoreGivingEntry 
单据体：FOrgScope 
	 实体主键：FENTRYID 
	 组织编码：ForgEntry  (必填项)
	 组织名称：FOrgName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("MMC_MEMBER_PREDEPOSIT_RULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FDocumentStatus":"","FForbidStatus":"","FName":"","FMemberType":{"FNUMBER":""},"FStartDate":"1900-01-01","FendDate":"1900-01-01","FPreDepositAccount":{"FNUMBER":""},"FCashGiving":"false","FScoreGiving":"false","FCashGivingType":"","FScoreGivingType":"","FInMainAccount":"","FInMainAccountScore":"","FLevel":0,"FDescription":"","FOrg":{"FNumber":""},"FPreDepositDetail":[{"FENTRYID":0,"FDepositGlt":0,"FDepositLt":0,"FCashGivingEntry":0,"FScoreGivingEntry":0}],"FOrgScope":[{"FENTRYID":0,"ForgEntry":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("MMC_MEMBER_PREDEPOSIT_RULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("MMC_MEMBER_PREDEPOSIT_RULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("MMC_MEMBER_PREDEPOSIT_RULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("MMC_MEMBER_PREDEPOSIT_RULE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("MMC_MEMBER_PREDEPOSIT_RULE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("MMC_MEMBER_PREDEPOSIT_RULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("MMC_MEMBER_PREDEPOSIT_RULE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"MMC_MEMBER_PREDEPOSIT_RULE"}");

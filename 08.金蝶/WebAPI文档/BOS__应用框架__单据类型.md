...
client.Delete("BOS_BillType","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BOS_BillType","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BOS_BillType","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FBILLTYPEID":"","FBillFormID":{"FNumber":""},"FNumber":"","FName":"","FBillCodeRuleID":{"FNAME":""},"FDescription":"","FIsDefault":"false","FLayoutSolution":{"FID":""},"FControlPrintCount":"false","FMaxPrintCount":0,"FPrintAfterAudit":"false","FDefPrintTemplate":"","FDefWnReportTemplate":"","FFieldControl":[{"FEntryID":"","FSEQ":0,"FMustInput":"false","FFieldKey":"","FEnabled":"false","FEDITENABLED":"false","FDefaultValue":"","FFormId":"","FDefaultValueId":"","FDefaultFuncName":"","FFieldElementType":0,"FSysMustInput":"false"}],"FWFSetting":[{"FEntryId":"","FBFVersionId":{"FNAME":""},"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FIsDefaultBF":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FControlPrintCount": "false",
        "FMaxPrintCount": 0,
        "FPrintAfterAudit": "false",
        "FDefPrintTemplate": "",
        "FDefWnReportTemplate": "",
        "FFieldControl": [
            {
...
单据类型：FBillHead 
	 ...
	 描述：FDescription 
	 默认单据类型：FIsDefault 
	 编码规则：FBillCodeRuleID 
	 最大打印次数：FMaxPrintCount 
	 审核后才允许打印：FPrintAfterAudit 
	 控制打印次数：FControlPrintCount 
	 单据：FBillFormID  (必填项)
	 修改日期：FModifyDate 
	 修改人：FModifierId 
	 创建日期：FCreateDate 
	 ...
	 禁用日期：FForbidDate 
	 系统预设：FIsSysPreSet 
	 默认套打模板：FDefPrintTemplate 
	 单据布局方案：FLayoutSolution 
	 默认报表模版：FDefWnReportTemplate 
	 H5布局方案：FH5View 
字段控制：FFieldControl 
	 实体主键：FEntryID 
	 序号：FSEQ  (必填项)
	 ...
	 字段标识：FFieldKey  (必填项)
	 字段名称：FFieldName 
	 默认值类型：FDefaultValueType 
	 默认值函数参数：FDefaultFuncParam 
	 默认函数ID：FDefaultFuncID 
	 字段元素类型：FFieldElementType 
	 系统预设必录：FSysMustInput 
	 函数名称：FDefaultFuncName 
	 新增时不可维护：FEnabled 
	 修改时不可维护：FEDITENABLED 
	 F8单据ID：FFormId 
	 默认值的ID：FDefaultValueId 
业务流设置：FWFSetting 
	 实体主键：FEntryId 
	 名称：FBFVersionId 
	 描述：FWFMemo 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BOS_BillType","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FBILLTYPEID":"","FBillFormID":{"FNumber":""},"FNumber":"","FName":"","FBillCodeRuleID":{"FNAME":""},"FDescription":"","FIsDefault":"false","FLayoutSolution":{"FID":""},"FControlPrintCount":"false","FMaxPrintCount":0,"FPrintAfterAudit":"false","FDefPrintTemplate":"","FDefWnReportTemplate":"","FFieldControl":[{"FEntryID":"","FSEQ":0,"FMustInput":"false","FFieldKey":"","FEnabled":"false","FEDITENABLED":"false","FDefaultValue":"","FFormId":"","FDefaultValueId":"","FDefaultFuncName":"","FFieldElementType":0,"FSysMustInput":"false"}],"FWFSetting":[{"FEntryId":"","FBFVersionId":{"FNAME":""},"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FIsDefaultBF":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BOS_BillType","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BOS_BillType","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BOS_BillType","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BOS_BillType","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BOS_BillType","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BOS_BillType","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BOS_BillType","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BOS_BillType"}");

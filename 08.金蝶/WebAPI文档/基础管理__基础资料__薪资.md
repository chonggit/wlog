...
client.Save("BAS_CMPSchemeData","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FName":"","FForbidUserId":{"FUserID":""},"FForbidDate":"1900-01-01","FCreateOrgId":{"FNumber":""},"FUSEORGID":{"FNumber":""},"FFinanceDate":"1900-01-01","FCurrencyId":{"FNUMBER":""},"FCurrency":"","FPeriod":"1900-01-01","FPeriodYearMonth":"","FSHRMapEntity":{"FMAPID":0,"FSHRPeriod":"","FShrId":"","FSHRNumber":"","FSHRName":"","FSHRStatus":""},"FEntity":[{"FEntryID":0,"FEntryOrgId":{"FNumber":""},"FDeptId":{"FNUMBER":""},"FPositonId":{"FNUMBER":""},"FEMPINFOId":{"FSTAFFNUMBER":""},"FCMPItemId":{"FNUMBER":""},"FSumValue":0,"FEntryOrg":"","FDept":"","FPositon":"","FEmpinfo":"","FCMPItem":""}]}}");
...
单据体：FEntity 
	 ...
	 部门使用组织：FDeptUseOrg 
	 岗位：FPositonId 
	 岗位使用组织：FPositonUseOrg 
	 员工：FEMPINFOId 
	 薪资项：FCMPItemId 
	 部门新编码：FDeptNumber 
	 岗位新编码：FPositonNumber 
	 员工新编码：FEmpinfoNumber 
	 薪资项新编码：FCMPItemNumber 
	 组织：FEntryOrgId 
	 组织编码：FEntryOrg 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_CMPSchemeData","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_CMPSchemeData","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("BAS_CMPSchemeData","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BAS_CMPSchemeData","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BAS_CMPSchemeData","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BAS_CMPSchemeData"}");

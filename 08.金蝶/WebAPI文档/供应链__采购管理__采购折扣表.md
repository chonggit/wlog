# 采购折扣表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 采购折扣表
...
| 行禁用 | SubUnEffective | 1698 |
| 取消行禁用 | SubEffective | 1696 |
| 暂存 | Draft | 8002 |
| 反禁用 | Effective | 1693 |
| 批量保存 | BatchSave | 3053 |
...
client.Delete("BD_PurDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_PurDiscount","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_PurDiscount","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FDISCOUNTOBJECT":"","FCurrencyID":{"FNumber":""},"FPriceType":"","FSupplierID":{"FNumber":""},"FDefDiscountListId":"false","FDISCOUNTREASON":{"FNumber":""},"FDescription":"","FDISCOUNTLISTENTRY":[{"FEntryID":0,"FMATERIALID":{"FNumber":""},"FMATERIALTYPEID":{"FNumber":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FDISCOUNTITEM":{"FNumber":""},"FDISCOUNTTYPE":"","FDISCOUNTACCORDING":"","FUNITID":{"FNumber":""},"FFROMQTY":0,"FTOQTY":0,"FCOMPUTEMODE":"","FDISCOUNTRATE":0,"FDISCOUNT":0,"FPriceDiscount":0,"FAPPORTIONMODE":"","FDISCOUNTDIRECTION":"","FBegDate":"1900-01-01","FEntryModifierId":{"FUserID":""},"FEndDate":"1900-01-01","FEntryModifyDate":"1900-01-01","FSRCBILLNO":"","FNOTE":""}]}}");
...
基本信息：FBillHead 
	 ...
	 价目表：FPRICELISTID 
	 币别：FCurrencyID  (必填项)
	 生效日期(2.0废除)：FEffectiveDate 
	 失效日期(2.0废除)：FExpiryDate 
	 禁用日期：FForbidDate 
	 审核日期：FApproveDate 
	 禁用人：FForbiderId 
	 审核人：FApproverId 
	 ...
	 价格类型：FPriceType  (必填项)
	 折扣原因：FDISCOUNTREASON 
	 默认折扣表：FDefDiscountListId 
明细信息：FDISCOUNTLISTENTRY 
	 实体主键：FEntryID 
	 物料编码：FMATERIALID 
	 物料名称：FMeterialName 
	 规格型号：FMeterialModel 
	 ...
	 折扣率(%)：FDISCOUNTRATE 
	 分摊方式：FAPPORTIONMODE  (必填项)
	 折扣方向：FDISCOUNTDIRECTION  (必填项)
	 生效日期：FBegDate  (必填项)
	 失效日期：FEndDate  (必填项)
	 来源单据号：FSRCBILLNO 
	 备注：FNOTE 
	 ...
	 业务失效人：FDISABLERID 
	 业务失效日期：FDISABLEDATE 
	 修改人：FEntryModifierId 
	 修改日期：FEntryModifyDate 
	 ...
	 计价单位：FUNITID 
	 单价折扣：FPriceDiscount 
关联关系表：FDISCOUNTLISTENTRY_Link 
	 实体主键：FLinkId 
	 业务流程图：FDISCOUNTLISTENTRY_Link_FFlowId 
	 推进路线：FDISCOUNTLISTENTRY_Link_FFlowLineId 
	 转换规则：FDISCOUNTLISTENTRY_Link_FRuleId 
	 源单表内码：FDISCOUNTLISTENTRY_Link_FSTableId 
	 源单表：FDISCOUNTLISTENTRY_Link_FSTableName 
	 源单内码：FDISCOUNTLISTENTRY_Link_FSBillId 
	 源单分录内码：FDISCOUNTLISTENTRY_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_PurDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_PurDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_PurDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_PurDiscount","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_PurDiscount","SubUnEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_PurDiscount","SubEffective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_PurDiscount","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FName":"","FDISCOUNTOBJECT":"","FCurrencyID":{"FNumber":""},"FPriceType":"","FSupplierID":{"FNumber":""},"FDefDiscountListId":"false","FDISCOUNTREASON":{"FNumber":""},"FDescription":"","FDISCOUNTLISTENTRY":[{"FEntryID":0,"FMATERIALID":{"FNumber":""},"FMATERIALTYPEID":{"FNumber":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FDISCOUNTITEM":{"FNumber":""},"FDISCOUNTTYPE":"","FDISCOUNTACCORDING":"","FUNITID":{"FNumber":""},"FFROMQTY":0,"FTOQTY":0,"FCOMPUTEMODE":"","FDISCOUNTRATE":0,"FDISCOUNT":0,"FPriceDiscount":0,"FAPPORTIONMODE":"","FDISCOUNTDIRECTION":"","FBegDate":"1900-01-01","FEntryModifierId":{"FUserID":""},"FEndDate":"1900-01-01","FEntryModifyDate":"1900-01-01","FSRCBILLNO":"","FNOTE":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_PurDiscount","Effective","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_PurDiscount","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_PurDiscount"}");

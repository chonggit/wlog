...
client.Delete("BD_STOCK","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_STOCK","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_STOCK","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FStockId":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FStockProperty":"","FThirdStockType":"","FSupplierId":{"FNumber":""},"FCustomerId":{"FNumber":""},"FAddress":"","FTHIRDSTOCKNO":"","FPrincipal":{},"FTel":"","FGYStockNumber":"","FDescription":"","FGroup":{"FNumber":""},"FStockStatusType":"","FDefStockStatusId":{"FNumber":""},"FDefReceiveStatusId":{"FNumber":""},"FAllowMinusQty":"false","FAllowLock":"false","FIsGYStock":"false","FNotExpQty":"false","FIsOpenLocation":"false","FAllowMRPPlan":"false","FAvailableAlert":"false","FAvailablePicking":"false","FSortingPriority":0,"FLocListFormatter":"","F_xhfz_IsSale":"false","FDeptId":{"FNUMBER":""},"F_WHtype":"","F_If_the_bonded":"","FIsZYStock":"false","F_Warehouse_category":"","F_RESP_WTHTS":0,"F_RESP_Cus":{"FNumber":""},"F_ora_Base_qtr":{"FNUMBER":""},"F_ora_FYXM":{"FNUMBER":""},"F_ora_CheckBox_qtr":"false","F_Custom_Mon":"","F_XCKF_Bonded":{"FNumber":""},"F_XCKF_TempStorageStock":{"FNUMBER":""},"F_XCKF_GroupType":"","FStockFlexItem":[{"FEntryID":0,"FFlexId":{"FNumber":""},"FIsMustInput":"false","FStockFlexDetail":[{"FDetailID":0,"FFlexEntryId":{"FNumber":""},"FIsRepeat":"","FIsConfirm":"false"}]}]}}");
...
基本信息：FBillHead 
	 ...
	 管易仓：FIsGYStock 
	 管易仓编码：FGYStockNumber 
	 管易同步状态：FGYSynStatus 
	 不参与可发量统计：FNotExpQty 
	 仓位维度数据列表显示格式：FLocListFormatter  (必填项)
	 部门：FDeptId 
	 直运仓：FIsZYStock 
	 是否销售仓库：F_xhfz_IsSale 
	 材质类别（创城开发报表专用）：F_WHtype 
	 是否保税仓库（废）：F_If_the_bonded 
	 仓库类别：F_Warehouse_category 
	 未提货商品预警天数：F_RESP_WTHTS 
	 客户(未提货预警)：F_RESP_Cus 
	 存货科目：F_ora_Base_qtr 
	 费用项目：F_ora_FYXM 
	 线边仓：F_ora_CheckBox_qtr 
	 是否保税仓库：F_Custom_Mon 
	 保税非保税：F_XCKF_Bonded 
	 暂存仓库：F_XCKF_TempStorageStock 
	 组别：F_XCKF_GroupType 
仓位值集：FStockFlexItem 
	 实体主键：FEntryID 
	 仓位值集编码：FFlexId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_STOCK","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FStockId":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FStockProperty":"","FThirdStockType":"","FSupplierId":{"FNumber":""},"FCustomerId":{"FNumber":""},"FAddress":"","FTHIRDSTOCKNO":"","FPrincipal":{},"FTel":"","FGYStockNumber":"","FDescription":"","FGroup":{"FNumber":""},"FStockStatusType":"","FDefStockStatusId":{"FNumber":""},"FDefReceiveStatusId":{"FNumber":""},"FAllowMinusQty":"false","FAllowLock":"false","FIsGYStock":"false","FNotExpQty":"false","FIsOpenLocation":"false","FAllowMRPPlan":"false","FAvailableAlert":"false","FAvailablePicking":"false","FSortingPriority":0,"FLocListFormatter":"","F_xhfz_IsSale":"false","FDeptId":{"FNUMBER":""},"F_WHtype":"","F_If_the_bonded":"","FIsZYStock":"false","F_Warehouse_category":"","F_RESP_WTHTS":0,"F_RESP_Cus":{"FNumber":""},"F_ora_Base_qtr":{"FNUMBER":""},"F_ora_FYXM":{"FNUMBER":""},"F_ora_CheckBox_qtr":"false","F_Custom_Mon":"","F_XCKF_Bonded":{"FNumber":""},"F_XCKF_TempStorageStock":{"FNUMBER":""},"F_XCKF_GroupType":"","FStockFlexItem":[{"FEntryID":0,"FFlexId":{"FNumber":""},"FIsMustInput":"false","FStockFlexDetail":[{"FDetailID":0,"FFlexEntryId":{"FNumber":""},"FIsRepeat":"","FIsConfirm":"false"}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_STOCK","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_STOCK","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_STOCK","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_STOCK","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_STOCK","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_STOCK","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_STOCK"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("BD_STOCK","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("BD_STOCK","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("BD_STOCK","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

# 多账簿核算维度明细表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 总账 > 多账簿核算维度明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2949 |
...
client.GetSysReportData("GL_RPT_MultFlexAccountDetail","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSchemeID":{"FNumber":""},"FCURRENCY":"","FSTARTYEAR":"","FSTARTPERIOD":"","FENDYEAR":"","FENDPERIOD":"","FSTARTBALANCE":{"FNumber":""},"FSHOWDETAIL":"false","FEXCLUDEADJUSTVCH":"false","FFORBIDBALANCE":"false","FNOTPOSTVOUCHER":"false","FLEVEL":"","FSHOWFULLNAME":"false","FLEVELID":""}}");

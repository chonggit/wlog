# 预测冲销方案 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 计划管理 > 预测冲销方案
...
client.Delete("REQ_WRITEOFFSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("REQ_WRITEOFFSCHEME","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("REQ_WRITEOFFSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FSchemeDescription":"","FIsATOScheme":"false","FWriteOffParamEntity":{"FEntryId":0,"FIsCloseCalc":"false","FDefaultDays":0,"FWriteOffPolicy":"","FFDayF":0,"FBDayB":0,"FFDayFB":0,"FBDayBF":0,"FBDayFB":0,"FFDayBF":0,"FIsCalcUnApprove":"false","FUnshippedQtyOnly":"false","FIsCloseRoCalc":"false","FATOWithShippedQty":"false","FDelayDays":0},"FWriteOffRelationEntity":[{"FEntryID":0,"FForecastSrcOrgId":{"FNumber":""},"FOrderSrcOrgId":{"FNumber":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FWriteOffParamEntity": {
            ...
            "FBDayFB": 0,
            "FFDayBF": 0,
            "FIsCalcUnApprove": "false",
            "FUnshippedQtyOnly": "false",
            "FIsCloseRoCalc": "false",
            "FATOWithShippedQty": "false",
            "FDelayDays": 0
        },
        "FWriteOffRelationEntity": [
            {
                "FEntryID": 0,
                "FForecastSrcOrgId": {
                    "FNumber": ""
...
单据头：FBillHead 
	 ...
	 禁用日期：FForbidDate 
	 审核日期：FApproveDate 
	 方案描述：FSchemeDescription 
	 向前冲销：FForward 
	 向后冲销：FBackWard 
	 先向前再向后冲销：FForwardFirst 
	 先向后再向前冲销：FBackwardFirst 
	 按周冲销（订单只冲销同一周的预测）：FWeek 
	 按月冲销（订单只冲销同一月的预测）：FMonth 
	 ATO冲销方案：FIsATOScheme 
冲销关系定义：FWriteOffRelationEntity 
	 实体主键：FEntryID 
	 预测单来源组织：FForecastSrcOrgId  (必填项)
	 冲销单据来源组织：FOrderSrcOrgId  (必填项)
冲销参数：FWriteOffParamEntity 
	 实体主键：FEntryId 
	 手工冲销默认周期（天）：FDefaultDays 
	 向前天数：FFDayF 
	 向后天数：FBDayB 
	 向前天数：FFDayFB 
	 向前天数：FFDayBF 
	 向后天数：FBDayFB 
	 向后天数：FBDayBF 
	 未审核订单参与冲销：FIsCalcUnApprove 
	 冲销策略：FWriteOffPolicy 
	 关闭的销售订单参与冲销：FIsCloseCalc 
	 指定日期之前的销售订单参与冲销时只冲销未出货数量：FUnshippedQtyOnly 
	 预测单单据类型：FForecastBillType 
	 冲销单据单据类型：FSrcBillType 
	 关闭的组织间需求单参与冲销：FIsCloseRoCalc 
	 ATO冲销考虑发料数量：FATOWithShippedQty 
	 考虑拖期单据：FDelayDays 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("REQ_WRITEOFFSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FDescription":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FSchemeDescription":"","FIsATOScheme":"false","FWriteOffParamEntity":{"FEntryId":0,"FIsCloseCalc":"false","FDefaultDays":0,"FWriteOffPolicy":"","FFDayF":0,"FBDayB":0,"FFDayFB":0,"FBDayBF":0,"FBDayFB":0,"FFDayBF":0,"FIsCalcUnApprove":"false","FUnshippedQtyOnly":"false","FIsCloseRoCalc":"false","FATOWithShippedQty":"false","FDelayDays":0},"FWriteOffRelationEntity":[{"FEntryID":0,"FForecastSrcOrgId":{"FNumber":""},"FOrderSrcOrgId":{"FNumber":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("REQ_WRITEOFFSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("REQ_WRITEOFFSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("REQ_WRITEOFFSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("REQ_WRITEOFFSCHEME","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("REQ_WRITEOFFSCHEME","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("REQ_WRITEOFFSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("REQ_WRITEOFFSCHEME","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"REQ_WRITEOFFSCHEME"}");

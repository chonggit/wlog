# 定时创建消耗汇总 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 定时创建消耗汇总
...
client.Delete("PUR_SCHEDULEVMICONSUME","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_SCHEDULEVMICONSUME","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_SCHEDULEVMICONSUME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FPlanBeginDate":"1900-01-01","FExecuteTime":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteInterval":0,"FExecuteIntervalUnit":"","FPurOrgId":{"FNumber":""},"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FAutoNextTime":"false","FByMonth":"false","FByWeek":"false","FByAfterDay":"false","FDiffDay":0,"FScheduledId":{"FNAME":""},"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FClearingPoint":"","FSEPSETTLE":"false","FPriceSource":"","FSettleOrgId":{"FNumber":""},"FConsumptionOrgIdList":"","FSupplierList":[{"FNumber":""}],"FBeginProOrderId":"","FEndProOrderId":"","FBeginWWOrderId":"","FEndWWOrderId":"","FBeginProId":{"FNUMBER":""},"FEndProId":{"FNUMBER":""},"FByLastCloseDate":"false","FIsCreateZeroPrice":"false","FDiffBeforeDay":0,"FByBeforeDay":"false","FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}]}}");
...
单据头：FBillHead 
	 ...
	 消耗日期：FBeginDate  (必填项)
	 至：FEndDate  (必填项)
	 指定日期自动滚动计算：FAutoNextTime 
	 按当前自然月计算：FByMonth 
	 按当前自然周计算：FByWeek 
	 按当前日期后多少天计算：FByAfterDay 
	 指定天数：FDiffDay 
	 计划名称：FScheduledId 
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 ...
	 结算时点：FClearingPoint  (必填项)
	 集中结算：FSEPSETTLE 
	 价格来源：FPriceSource  (必填项)
	 结算组织：FSettleOrgId 
	 消耗组织：FConsumptionOrgIdList  (必填项)
	 供应商：FSupplierList  (必填项)
	 生产订单编码：FBeginProOrderId 
	 生产订单至：FEndProOrderId 
	 委外订单编码：FBeginWWOrderId 
	 委外订单至：FEndWWOrderId 
	 产品编码：FBeginProId 
	 产品编码至：FEndProId 
	 按最近财务关账日期至当前日期：FByLastCloseDate 
	 单价为空生成消耗汇总表：FIsCreateZeroPrice 
	 指定天数：FDiffBeforeDay 
	 按当前日期前多少天计算：FByBeforeDay 
单据体：FLogEntity 
	 实体主键：FEntryID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PUR_SCHEDULEVMICONSUME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FPlanBeginDate":"1900-01-01","FExecuteTime":"1900-01-01","FPlanEndDate":"1900-01-01","FExecuteInterval":0,"FExecuteIntervalUnit":"","FPurOrgId":{"FNumber":""},"FBeginDate":"1900-01-01","FEndDate":"1900-01-01","FAutoNextTime":"false","FByMonth":"false","FByWeek":"false","FByAfterDay":"false","FDiffDay":0,"FScheduledId":{"FNAME":""},"FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FClearingPoint":"","FSEPSETTLE":"false","FPriceSource":"","FSettleOrgId":{"FNumber":""},"FConsumptionOrgIdList":"","FSupplierList":[{"FNumber":""}],"FBeginProOrderId":"","FEndProOrderId":"","FBeginWWOrderId":"","FEndWWOrderId":"","FBeginProId":{"FNUMBER":""},"FEndProId":{"FNUMBER":""},"FByLastCloseDate":"false","FIsCreateZeroPrice":"false","FDiffBeforeDay":0,"FByBeforeDay":"false","FLogEntity":[{"FEntryID":0,"FEXECSTARTDATE":"1900-01-01","FEXECENDDATE":"1900-01-01","FMESSAGE":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_SCHEDULEVMICONSUME","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_SCHEDULEVMICONSUME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_SCHEDULEVMICONSUME","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_SCHEDULEVMICONSUME","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_SCHEDULEVMICONSUME","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_SCHEDULEVMICONSUME","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PUR_SCHEDULEVMICONSUME","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_SCHEDULEVMICONSUME"}");

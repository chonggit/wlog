# 银行账户变更单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 银行账户变更单
...
client.Delete("CN_ALTERAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_ALTERAPPLY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FAlterOrgId":{"FNumber":""},"FBANKACNTID":{"FNUMBER":""},"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FName":"","FAlterReason":"","FAlterReason_Tag":"","FBANKID":{"FNumber":""},"FINNERACCOUNTID":{"FNUMBER":""},"FOpenAddressRec":"","FCNAPS":"","FACNTAREACODE":"","FACNTAREANAME":"","FDescription":"","FNewBankId":{"FNUMBER":""},"FNewBankName":"","FNewAcctProperty":"","FNEWINNERACCOUNTID":{"FNUMBER":""},"FNewBankAddress":"","FNewCanps":"","FNEWACNTAREACODE":"","FNEWACNTAREANAME":"","FNewDescription":"","FAccountProperty":"","FNewName":""}}");
...
单据头：FBillHead 
	 ...
	 变更事由：FAlterReason 
	 原账户名称：FName 
	 银行账号：FBANKACNTID  (必填项)
	 创建组织：FCreateOrgId 
	 使用组织：FUseOrgId 
	 新开户银行名称：FNewBankId 
	 新账户收支属性：FNewAcctProperty  (必填项)
	 原开户银行：FBANKID 
	 原银行地址：FOpenAddressRec 
	 新银行地址：FNewBankAddress 
	 原开户银行联行号：FCNAPS 
	 新开户银行联行号：FNewCanps 
	 银行：FBankType 
	 原省（作废）：FProvince 
	 ...
	 原地区（作废）：FDistrict 
	 新地区（作废）：FNewDistrict 
	 原账户地区码：FACNTAREACODE 
	 新账户地区码：FNEWACNTAREACODE 
	 原账户地区名：FACNTAREANAME 
	 新账户地区名：FNEWACNTAREANAME 
	 原备注：FDescription 
	 新备注：FNewDescription 
	 新对应内部账号：FNEWINNERACCOUNTID 
	 原对应内部账号：FINNERACCOUNTID 
	 新省（作废）：FNewProvince 
	 变更组织：FAlterOrgId  (必填项)
	 新开户银行：FNewBankName 
	 原账户收支属性：FAccountProperty 
	 原省：FNProvince 
	 原地区：FNDistrict 
	 原城市：FNCity 
	 原国别：FCountry 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_ALTERAPPLY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FAlterOrgId":{"FNumber":""},"FBANKACNTID":{"FNUMBER":""},"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FName":"","FAlterReason":"","FAlterReason_Tag":"","FBANKID":{"FNumber":""},"FINNERACCOUNTID":{"FNUMBER":""},"FOpenAddressRec":"","FCNAPS":"","FACNTAREACODE":"","FACNTAREANAME":"","FDescription":"","FNewBankId":{"FNUMBER":""},"FNewBankName":"","FNewAcctProperty":"","FNEWINNERACCOUNTID":{"FNUMBER":""},"FNewBankAddress":"","FNewCanps":"","FNEWACNTAREACODE":"","FNEWACNTAREANAME":"","FNewDescription":"","FAccountProperty":"","FNewName":""}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_ALTERAPPLY","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_ALTERAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_ALTERAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_ALTERAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_ALTERAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_ALTERAPPLY","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_ALTERAPPLY","UnCancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_ALTERAPPLY","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_ALTERAPPLY"}");

# 资产调出单 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 资产调出单
...
client.Delete("FA_DELIVERY","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("FA_DELIVERY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FExpAssetOrgId":{"FNumber":""},"FExpOwnerOrgId":{"FNumber":""},"FImpAssetOrgId":{"FNumber":""},"FImpOwnerOrgId":{"FNumber":""},"FExpDate":"1900-01-01","FTransReason":"","FEntityAsset":[{"FEntryID":0,"FAssetSeq":"","FAlterId":{"FNumber":""},"FUnitID":{"FNumber":""},"FAssetQty":0,"FExpQty":0,"FSubEntityFin":[{"FDetailID":0,"FFinSeq":"","FFinId":{"FFINANCEID":""},"FAcctPolicyId":{"FNumber":""},"FRCurrencyId":{"FNumber":""},"FImpOrgVal":0,"FImpAccumDepr":0,"FExpNetBookvalue":0,"FExpPResidualvalue":0,"FExpAccumDevalue":0}],"FSubEntityDevice":[{"FDetailID":0,"FDeviceSeq":""}],"FSubEntityDetail":[{"FDetailID":0,"FMatterSeq":""}]}]}}");
...
单据头：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 调出货主组织：FExpOwnerOrgId  (必填项)
	 调入资产组织：FImpAssetOrgId  (必填项)
	 调入货主组织：FImpOwnerOrgId  (必填项)
	 调出资产组织：FExpAssetOrgId  (必填项)
	 调拨币种：FTransCurrencyId 
	 调拨费用：FAllAmount 
	 调出日期：FExpDate  (必填项)
	 调拨原因：FTransReason 
	 调入确认：FImpCheck 
...
财务信息：FSubEntityFin 
	 ...
	 序号：FFinSeq 
	 币别：FRCurrencyId 
	 调出净值：FExpNetBookvalue 
	 调出残值：FExpPResidualvalue 
	 调出减值准备：FExpAccumDevalue 
	 调出原值：FImpOrgVal 
	 调出累计折旧：FImpAccumDepr 
附属设备：FSubEntityDevice 
	 实体主键：FDetailID 
	 附属设备：FDeviceId 
	 设备编码：FBPNumber 
	 设备名称：FBPName 
	 规格型号：FBPSpecification 
	 计量单位：FBPUnitId 
	 数量：FBPQuantity 
	 金额：FBPValue 
	 开始使用日期：FBPBeginUseDate 
	 结束使用日期：FBPEndUseDate 
	 使用情况：FBPUseState 
	 变化原因：FBPAlterReason 
	 资产位置：FBPPositionId 
	 备注：FBPRemark 
	 资产编码：FDeviceAssetNo 
	 序号：FDeviceSeq 
实物信息：FSubEntityDetail 
	 实体主键：FDetailID 
	 实物信息：FMatterId 
	 条形码：FBDBarcode 
	 规格型号：FBDSpecification 
	 资产位置：FBDPositionId 
	 数量：FBDQuantity 
	 产地：FBDLocality 
	 供应商：FBDSupplierId 
	 ...
	 资产编码：FAssetNo 
	 序号：FMatterSeq 
关联关系表：FEntityAsset_Link 
	 实体主键：FLinkId 
	 业务流程图：FEntityAsset_Link_FFlowId 
	 推进路线：FEntityAsset_Link_FFlowLineId 
	 转换规则：FEntityAsset_Link_FRuleId 
	 源单表内码：FEntityAsset_Link_FSTableId 
	 源单表：FEntityAsset_Link_FSTableName 
	 源单内码：FEntityAsset_Link_FSBillId 
	 源单分录内码：FEntityAsset_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("FA_DELIVERY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FExpAssetOrgId":{"FNumber":""},"FExpOwnerOrgId":{"FNumber":""},"FImpAssetOrgId":{"FNumber":""},"FImpOwnerOrgId":{"FNumber":""},"FExpDate":"1900-01-01","FTransReason":"","FEntityAsset":[{"FEntryID":0,"FAssetSeq":"","FAlterId":{"FNumber":""},"FUnitID":{"FNumber":""},"FAssetQty":0,"FExpQty":0,"FSubEntityFin":[{"FDetailID":0,"FFinSeq":"","FFinId":{"FFINANCEID":""},"FAcctPolicyId":{"FNumber":""},"FRCurrencyId":{"FNumber":""},"FImpOrgVal":0,"FImpAccumDepr":0,"FExpNetBookvalue":0,"FExpPResidualvalue":0,"FExpAccumDevalue":0}],"FSubEntityDevice":[{"FDetailID":0,"FDeviceSeq":""}],"FSubEntityDetail":[{"FDetailID":0,"FMatterSeq":""}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("FA_DELIVERY","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("FA_DELIVERY","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("FA_DELIVERY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("FA_DELIVERY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("FA_DELIVERY","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("FA_DELIVERY","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"FA_DELIVERY"}");

# 期初在产品成本调整 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 期初在产品成本调整
...
client.Save("CB_INITPRODUCECOSTADJ","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FShowPeriod":"","FYEAR":0,"FPERIOD":0,"FCREATEFROMSYS":"false","FTreeEntity":[{"FEntryID":0,"FPARENTID":"","FROWID":"","FROWTYPE":0,"FPROORDERTYPE":"","FPROORDERID":{"FNUMBER":""},"FPROORDERNO":"","FPROORDERSEQ":0,"FCOSTCENTERID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FSUPPLIERID":{"FNUMBER":""},"FUNITID":{"FNumber":""},"FInitQty":0,"FINITINPROQTY":0,"FAfterAdjQty":0,"FCOSTITEMID":{"FNUMBER":""},"FEXPENSEITEMID":{"FNUMBER":""},"FInitAmount":0,"FINITINPROAMOUNT":0,"FAfterAdjAmount":0,"FFORMID":"","FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FPROBOMID":{"FNumber":""},"FPROLOT":{"FNUMBER":""},"FBUSINESSORGID":{"FNumber":""},"FMainPID":0,"FMainSubEntryID":0,"FEXPTYPE":"","FMtoNo":"","FMaterialEntity":[{"FDetailID":0,"FEXPENSESITEMID":{"FNUMBER":""},"FMatInitQty":0,"FMatAfterAdjQty":0,"FMatInitAmount":0,"FMATERDETAILENTRYID":0,"FMatAfterAdjAmount":0,"FMatEntryID":0,"FCostExpEntity":[{"FSubDetailID":0,"FDetailInitAmount":0,"FDetailAfterAdjAmount":0,"FMatSubEntryID":0}]}]}]}}");
                ...
                "FMaterialEntity": [
                    {
                        ...
                        "FMatAfterAdjQty": 0,
                        "FMatInitAmount": 0,
                        "FMATERDETAILENTRYID": 0,
                        "FMatAfterAdjAmount": 0,
                        "FMatEntryID": 0,
                        "FCostExpEntity": [
                            {
                                "FSubDetailID": 0,
                                "FDetailInitAmount": 0,
                                "FDetailAfterAdjAmount": 0,
                                "FMatSubEntryID": 0
                            }
                        ]
                    }
...
父项产品：FTreeEntity 
	 ...
	 规格型号：FPRODUCTMODEL 
	 费用项目：FEXPENSEITEMID 
	 期初调整金额：FINITINPROAMOUNT 
	 累计完工金额：FSUMFINISHAMOUNT 
	 累计投产金额：FSUMINPUTAMOUNT 
	 累计完工数量：FSUMFINISHQTY 
	 累计投产数量：FSUMINPUTQTY 
	 基本单位：FUNITID 
	 累计合格品数量：FSUMQUALQTY 
	 累计合格品金额：FSUMQUALAMOUNT 
	 累计不良品数量：FSUMBADQTY 
	 累计不良品金额：FSUMBADAMOUNT 
	 累计废品数量：FSUMREJECTQTY 
	 累计废品金额：FSUMREJECTAMOUNT 
	 生产组织：FBUSINESSORGID 
	 父级内码：FPARENTID 
	 行内码：FROWID 
	 行类型：FROWTYPE 
	 ...
	 期初金额：FInitAmount 
	 调整后数量：FAfterAdjQty 
	 调整后金额：FAfterAdjAmount 
	 产品维度内码：FMainPID 
	 父项费用明细分录内码：FMainSubEntryID 
	 费用类型：FEXPTYPE 
	 供应商编码：FSUPPLIERID 
	 供应商名称：FSUPPLIERNAME 
子项物料：FMaterialEntity 
	 实体主键：FDetailID 
	 物料编码：FMATERIALID 
	 物料名称：FMATERIALNAME 
	 基本单位：FDETAILUNITID 
	 期初调整数量：FINITINPROMATQTY 
	 累计完工数量：FSUMFINISHMATQTY 
	 累计投入数量：FSUMINPUTMATQTY 
	 期初调整金额：FINITINPROMATAMOUNT 
	 累计完工金额：FSUMFINISHMATAMOUNT 
	 累计投入金额：FSUMINPUTMATAMOUNT 
	 批号：FLOTID 
	 规格型号：FMaterialModel 
	 BOM版本：FBOMID 
	 仓库：FSTOCKID 
	 ...
	 300德上仓位值集：FF100014
	 用料清单分录内码：FMATERDETAILENTRYID 
	 子项基本单位：FDETAILUNITIDPROPERTY 
	 期初数量：FMatInitQty 
	 期初金额：FMatInitAmount 
	 调整后数量：FMatAfterAdjQty 
	 调整后金额：FMatAfterAdjAmount 
	 材料明细分录内码：FMatEntryID 
	 费用项目编码：FEXPENSESITEMID 
	 费用项目名称：FEXPENSESITEMNAME 
	 期初数量是否可调整：FISAUTOADJQTY 
子项费用项目：FCostExpEntity 
	 实体主键：FSubDetailID 
	 费用项目名称：FDETAILEXPITEMNAME 
	 费用项目编码：FDETAILEXPITEMID 
	 期初调整数量：FINITINPROEXPQTY 
	 期初调整金额：FINITINPROEXPAMOUNT 
	 累计完工数量：FSUMFINISHEXPQTY 
	 累计完工金额：FSUMFINISHEXPAMOUNT 
	 累计投入数量：FSUMINPUTEXPQTY 
	 累计投入金额：FSUMINPUTEXPAMOUNT 
	 期初金额：FDetailInitAmount 
	 调整后金额：FDetailAfterAdjAmount 
	 材料费用明细分录内码：FMatSubEntryID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_INITPRODUCECOSTADJ","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("CB_INITPRODUCECOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CB_INITPRODUCECOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CB_INITPRODUCECOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CB_INITPRODUCECOSTADJ","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_INITPRODUCECOSTADJ"}");

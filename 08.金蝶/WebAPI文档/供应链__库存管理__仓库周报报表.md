# 仓库周报报表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 仓库周报报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3466 |
...
client.GetSysReportData("k542c4b009e2b4bcf8e3b8fee1e58750c","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FStockOrgId":{"FNUMBER":""},"FBeginMaterial":{"FNumber":""},"F_xhfz_Stock":[{"FNumber":""}],"F_xhfz_BeginDate":"1900-01-01","F_xhfz_EndDate":"1900-01-01","FLotFrom":{"FNumber":""},"FStockOrgIds":[{"FNumber":""}],"FInSrcBillTypeId1":[{"FNumber":""}],"FOutSrcBillTypeId1":[{"FNumber":""}],"FInSrcBillTypeId":[{"FNumber":""}],"FOutSrcBillTypeId":[{"FNumber":""}]}}");
...
五、字段说明：
	 ...
	 入库类别1：FInSrcBillTypeId1 
	 出库单据1：FOutSrcBillTypeId1 
	 入库类别：FInSrcBillTypeId  (必填项)
	 出库类别：FOutSrcBillTypeId  (必填项)

# PLM审核流程单据 Web API 操作原始内容

> 来源页面：全部 > PLM > 系统建模 > PLM审核流程单据
...
client.Delete("PLM_WF_AUDITBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PLM_WF_AUDITBILL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FMark":"","FBillNoName":"","FCreatorId":{"FUserID":""},"FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FFlowType":{"FLaunchdes":""},"FProject":{"FCODE":""},"FAttachmentEntity":[{"FEntryID":0,"FAttIcon":"","FAttachmentsCode":{"FCode":""},"FUploadId":{"FUserID":""},"FUploadDate":"1900-01-01"}],"FObjectEntity":[{"FEntryID":0,"FROWID":"","FPARENTROWID":"","FIsCheck":"false","FIcon":"","FROWEXPANDTYPE":"","FBaseCode":{"FCode":""},"FFLOWNUMBER":""}],"FTaskEntity":[{"FEntryID":0,"Ftask":{"FCODE":""}}]}}");
...
单据头：FBillHead 
	 ...
	 单据名称：FBillNoName  (必填项)
	 创建人：FCreatorId 
	 修改日期：FModifyDate 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 流程类型：FFlowType 
	 PLM项目经理：FProjectLeader 
	 流程备注：FMark 
	 PLM任务负责人：FTASKLEADER 
	 PLM项目：FProject 
附件：FAttachmentEntity 
	 实体主键：FEntryID 
	 编码：FAttachmentsCode 
	 名称：FAttachmentsName 
	 图标：FAttIcon 
...
树形单据体：FObjectEntity 
	 ...
	 文件夹：FBaseFloder 
	 业务类型：FBaseCategory 
	 修改日期：FBaseModifyDate 
	 生命周期阶段：FLifeCircleStage 
	 检出人：FCheckOutor 
	 检出标记：FIsCheckOut 
	 图标：FIcon 
	 复选框：FIsCheck 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLM_WF_AUDITBILL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PLM_WF_AUDITBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PLM_WF_AUDITBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PLM_WF_AUDITBILL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_WF_AUDITBILL"}");

# 供应商对账单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 采购管理 > 供应商对账单

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2370 |
...
client.GetSysReportData("kcc25e29f5e7f42399e222ab5e7a50c39","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"F_XCKF_Supplier":[{"FName":""}],"F_XCKF_SupplierOrg":{"FNUMBER":""},"F_XCKF_BeginDate":"1900-01-01","F_XCKF_EndDate":"1900-01-01","F_XCKF_BillNo":"","F_XCKF_Type":"","F_XCKF_InStockStatus":""}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_XCKF_BeginDate": "1900-01-01",
        "F_XCKF_EndDate": "1900-01-01",
        "F_XCKF_BillNo": "",
        "F_XCKF_Type": "",
        "F_XCKF_InStockStatus": ""
    }
}

五、字段说明：
	 供应商：F_XCKF_Supplier 
	 组织：F_XCKF_SupplierOrg  (必填项)
	 开始日期：F_XCKF_BeginDate  (必填项)
	 结束日期：F_XCKF_EndDate  (必填项)
	 单据编号：F_XCKF_BillNo 
	 对账类型：F_XCKF_Type 
	 入库单状态：F_XCKF_InStockStatus 

# 费用移转单 Web API 操作原始内容

> 来源页面：全部 > 员工服务 > 人人报销 > 费用移转单
...
client.Delete("ER_ExpenseTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ER_ExpenseTransfer","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FOrgId":{"FNumber":""},"FDeptID":{"FNUMBER":""},"FStaffID":{"FSTAFFNUMBER":""},"FCurrencyID":{"FNUMBER":""},"FExpenseItemID":{"FNUMBER":""},"FProductID":{"FNUMBER":""},"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FExchangeTypeID":{"FNUMBER":""},"FExchangeRate":0,"FOrgAmountSum":0,"FLocAmountSum":0,"FLocCurrencyID":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FCancelStatus":"","FReason":"","FScanPoint":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FEntryBillNo":"","FToOrgID":{"FNumber":""},"FToDeptID":{"FNUMBER":""},"FToStaffID":{"FSTAFFNUMBER":""},"FToExpenseItemID":{"FNUMBER":""},"FToProductID":{"FNUMBER":""},"FTOCONTACTUNITTYPE":"","FTOCONTACTUNIT":{"FNumber":""},"FToOrgAmount":0,"FToLocalCurrID":{"FNUMBER":""},"FToLocalAmount":0,"FRemark":"","FToExchangeTypeID":{"FNUMBER":""},"FToExchangeRate":0,"FFromLocalAmount":0}],"FSrcEntity":[{"FEntryID":0,"FSourceBillType":"","FSourceBillNo":"","FSourceEntryID":0,"FSrcAmount":0}]}}");
...
单据头：FBillHead 
	 ...
	 转移日期：FDate  (必填项)
	 转移金额：FOrgAmountSum 
	 转移金额(本位币)：FLocAmountSum 
	 本位币：FLocCurrencyID  (必填项)
	 跨组织业务类型：FIOSBizTypeId 
	 已下推报销金额：FRELATEAMOUNT 
	 转移事由：FReason 
	 已报销金额：FReimbAmount 
...
转入信息：FEntity 
	 ...
	 转入部门：FToDeptID  (必填项)
	 分录编码：FEntryBillNo 
	 转入经手人：FToStaffID  (必填项)
	 转入费用项目：FToExpenseItemID  (必填项)
	 转入承担产品：FToProductID 
	 转入往来单位类型：FTOCONTACTUNITTYPE  (必填项)
	 转入往来单位：FTOCONTACTUNIT  (必填项)
	 转入金额：FToOrgAmount 
	 本位币：FToLocalCurrID 
	 本位币金额：FToLocalAmount 
	 转入汇率类型：FToExchangeTypeID 
	 转入汇率：FToExchangeRate 
	 转出本位币金额：FFromLocalAmount 
	 备注：FRemark 
源单信息：FSrcEntity 
	 实体主键：FEntryID 
	 源单类型：FSourceBillType 
	 源单编号：FSourceBillNo 
	 源单分录ID：FSourceEntryID 
	 费用项目：FSrcExpItemId 
	 可转移金额：FSrcAmount 
	 实际转移金额：FRealAmount 
关联关系表：FSrcEntity_Link 
	 实体主键：FLinkId 
	 业务流程图：FSrcEntity_Link_FFlowId 
	 推进路线：FSrcEntity_Link_FFlowLineId 
	 转换规则：FSrcEntity_Link_FRuleId 
	 源单表内码：FSrcEntity_Link_FSTableId 
	 源单表：FSrcEntity_Link_FSTableName 
	 源单内码：FSrcEntity_Link_FSBillId 
	 源单分录内码：FSrcEntity_Link_FSId 
	 原始携带量：FSrcEntity_Link_FRealAmountOld 
	 修改携带量：FSrcEntity_Link_FRealAmount 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ER_ExpenseTransfer","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FOrgId":{"FNumber":""},"FDeptID":{"FNUMBER":""},"FStaffID":{"FSTAFFNUMBER":""},"FCurrencyID":{"FNUMBER":""},"FExpenseItemID":{"FNUMBER":""},"FProductID":{"FNUMBER":""},"FCONTACTUNITTYPE":"","FCONTACTUNIT":{"FNumber":""},"FExchangeTypeID":{"FNUMBER":""},"FExchangeRate":0,"FOrgAmountSum":0,"FLocAmountSum":0,"FLocCurrencyID":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FCancelStatus":"","FReason":"","FScanPoint":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FEntryBillNo":"","FToOrgID":{"FNumber":""},"FToDeptID":{"FNUMBER":""},"FToStaffID":{"FSTAFFNUMBER":""},"FToExpenseItemID":{"FNUMBER":""},"FToProductID":{"FNUMBER":""},"FTOCONTACTUNITTYPE":"","FTOCONTACTUNIT":{"FNumber":""},"FToOrgAmount":0,"FToLocalCurrID":{"FNUMBER":""},"FToLocalAmount":0,"FRemark":"","FToExchangeTypeID":{"FNUMBER":""},"FToExchangeRate":0,"FFromLocalAmount":0}],"FSrcEntity":[{"FEntryID":0,"FSourceBillType":"","FSourceBillNo":"","FSourceEntryID":0,"FSrcAmount":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ER_ExpenseTransfer","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ER_ExpenseTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ER_ExpenseTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ER_ExpenseTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ER_ExpenseTransfer","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("ER_ExpenseTransfer","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ER_ExpenseTransfer","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ER_ExpenseTransfer"}");

...
client.Delete("CN_CHEQUEMANAGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_CHEQUEMANAGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCLAIMDATE":"1900-01-01","FCLAIMUSE":"","FUSELIMIT":0,"FEXPECTEDREIMBURSEMENTDATE":"1900-01-01","FISSURANCEDATE":"1900-01-01","FRECEIVEAMOUNT":0,"FRECEIVEUSE":"","FTRANSFERACCOUNTDATE":"1900-01-01","FREIMBURSEMENTDATE":"1900-01-01","FREMAKE":"","FCLAIMDEPARTMENT":"","FCLAIMER":"","FCLAIMORGANIZATION":"","FPAYERFULLNAME":"","FRECEIVENAME":"","FRECEIVEBANKACCOUNT":"","FRECEIVEOPENINGBANK":"","FSUBJECT":"","FOTHERSIDESUBJECT":"","FREIMBURSEMENTNAME":"","FBILLID":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCHECKER":{"FUserID":""},"FINSURER":{"FUserID":""},"FCHEQUENO":"","FCHEQUENumber":0,"FCURRENCYID":{"FNUMBER":""},"FCHECKDATE":"1900-01-01","FUseOrgId":{"FNumber":""}}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        "FID": 0,
        "FBillNo": "",
        "FCLAIMDATE": "1900-01-01",
        "FCLAIMUSE": "",
        "FUSELIMIT": 0,
        "FEXPECTEDREIMBURSEMENTDATE": "1900-01-01",
        "FISSURANCEDATE": "1900-01-01",
        "FRECEIVEAMOUNT": 0,
        "FRECEIVEUSE": "",
        "FTRANSFERACCOUNTDATE": "1900-01-01",
        "FREIMBURSEMENTDATE": "1900-01-01",
        "FREMAKE": "",
        "FCLAIMDEPARTMENT": "",
        "FCLAIMER": "",
        "FCLAIMORGANIZATION": "",
...
单据头：FBillHead 
	 ...
	 领用用途：FCLAIMUSE 
	 使用限额：FUSELIMIT 
	 预计报销日期：FEXPECTEDREIMBURSEMENTDATE 
	 签发日期：FISSURANCEDATE  (必填项)
	 金额：FRECEIVEAMOUNT 
	 用途：FRECEIVEUSE 
	 转账日期：FTRANSFERACCOUNTDATE 
	 报销日期：FREIMBURSEMENTDATE 
	 备注：FREMAKE 
	 领用部门：FCLAIMDEPARTMENT  (必填项)
	 领用人：FCLAIMER  (必填项)
	 对方单位：FCLAIMORGANIZATION 
	 付款人全称：FPAYERFULLNAME 
	 收款人名称：FRECEIVENAME  (必填项)
	 收款人开户行：FRECEIVEOPENINGBANK 
	 科目：FSUBJECT 
	 对方科目：FOTHERSIDESUBJECT 
	 报销人：FREIMBURSEMENTNAME 
	 收款人银行账号：FRECEIVEBANKACCOUNT 
	 使用金额（大写）：FUSEAMOUNTUPER 
	 大写金额：FRECEIVEAMOUNTUPPER 
	 支票卷：FBILLID 
	 银行名称：FBANKNAME 
	 银行账号：FBANKACCOUNTNO 
	 购置日期：FPURCHASEDATE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_CHEQUEMANAGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FCLAIMDATE":"1900-01-01","FCLAIMUSE":"","FUSELIMIT":0,"FEXPECTEDREIMBURSEMENTDATE":"1900-01-01","FISSURANCEDATE":"1900-01-01","FRECEIVEAMOUNT":0,"FRECEIVEUSE":"","FTRANSFERACCOUNTDATE":"1900-01-01","FREIMBURSEMENTDATE":"1900-01-01","FREMAKE":"","FCLAIMDEPARTMENT":"","FCLAIMER":"","FCLAIMORGANIZATION":"","FPAYERFULLNAME":"","FRECEIVENAME":"","FRECEIVEBANKACCOUNT":"","FRECEIVEOPENINGBANK":"","FSUBJECT":"","FOTHERSIDESUBJECT":"","FREIMBURSEMENTNAME":"","FBILLID":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCHECKER":{"FUserID":""},"FINSURER":{"FUserID":""},"FCHEQUENO":"","FCHEQUENumber":0,"FCURRENCYID":{"FNUMBER":""},"FCHECKDATE":"1900-01-01","FUseOrgId":{"FNumber":""}}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_CHEQUEMANAGE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_CHEQUEMANAGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_CHEQUEMANAGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_CHEQUEMANAGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_CHEQUEMANAGE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_CHEQUEMANAGE","Insure","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_CHEQUEMANAGE","Abandon","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_CHEQUEMANAGE"}");

# 信用评分表 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 信用管理 > 信用评分表
...
client.Delete("CRE_ScoringTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRE_ScoringTable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FCreditOrg":{"FNumber":""},"FCreditModel":{"FNumber":""},"FCustomer":{"FNumber":""},"FSumScore":0,"FGradeScheme":{"FNumber":""},"FGrade":{"FNumber":""},"FSuggestion":"","FIsUpdateRule":"false","FISUPCUSTGPPARCH":"false","FTreeEntity":[{"FEntryID":0,"FCreditIndex":{"FNumber":""},"FScoreStandard":"","FScore":0,"FSysScore":0,"FScoreOne":"","FAverageScore":0,"FFinalScore":0,"FWeight":0,"FWeightScore":0,"FKey":"","FIndexParentId":"","FRowType":0}],"FScorerEntity":[{"FEntryID":0}]}}");
...
基本信息：FBillHead 
	 ...
	 评估日期：FDate  (必填项)
	 评估组织：FCreditOrg  (必填项)
	 评估模型：FCreditModel  (必填项)
	 客户：FCustomer  (必填项)
	 综合得分：FSumScore 
	 综合评估意见：FSuggestion 
	 更新信用档案检查规则：FIsUpdateRule 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
	 修改日期：FModifyDate 
	 ...
	 审核日期：FApproveDate 
	 评估等级：FGrade 
	 等级方案：FGradeScheme  (必填项)
	 最终得分默认等于平均分分：FIsAveToFScore 
	 更新集团客户信用档案：FISUPCUSTGPPARCH 
评分明细：FTreeEntity 
	 实体主键：FEntryID 
	 评估指标编码：FCreditIndex  (必填项)
	 评估指标名称：FIndexName 
	 指标描述：FIndexDesc 
	 评分标准：FScoreStandard 
	 指标分值：FScore 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRE_ScoringTable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FCreditOrg":{"FNumber":""},"FCreditModel":{"FNumber":""},"FCustomer":{"FNumber":""},"FSumScore":0,"FGradeScheme":{"FNumber":""},"FGrade":{"FNumber":""},"FSuggestion":"","FIsUpdateRule":"false","FISUPCUSTGPPARCH":"false","FTreeEntity":[{"FEntryID":0,"FCreditIndex":{"FNumber":""},"FScoreStandard":"","FScore":0,"FSysScore":0,"FScoreOne":"","FAverageScore":0,"FFinalScore":0,"FWeight":0,"FWeightScore":0,"FKey":"","FIndexParentId":"","FRowType":0}],"FScorerEntity":[{"FEntryID":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRE_ScoringTable","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CRE_ScoringTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CRE_ScoringTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CRE_ScoringTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CRE_ScoringTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CRE_ScoringTable","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CRE_ScoringTable","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRE_ScoringTable"}");

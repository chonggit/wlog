# 存货核算汇总报告 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 存货核算汇总报告

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2908 |
...
client.GetSysReportData("HS_HSSummary","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FYear":"","FPeriod":"","FMATERIALID":{"FNumber":""},"FENDMATERIALID":{"FNumber":""},"FACCTGRANGEID":{"FNumber":""},"FCURRENCYID":{"FNumber":""},"FOnlyWrong":"false"}}");

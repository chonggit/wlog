# 寄货物快递单 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 库存管理 > 寄货物快递单
...
client.Delete("ora_MailGoodsBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ora_MailGoodsBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDepartmentID":{"FNUMBER":""},"FPostcode":"","FMailDate":"1900-01-01","FMailArriveDate":"1900-01-01","FConsigneeAccountNum":"","FFreightEnglishName":"","FfreightAmount":0,"FPostNumber":"","FExpressType":{"FNumber":""},"FFreightPayType":{"FNumber":""},"FAssignExpCompany":{"FNumber":""},"FMailCauseOption":{"FNumber":""},"FMailCause":{"FNumber":""},"FLastExpCompany":{"FNumber":""},"FHCurrencyID":{"FNUMBER":""},"FIsAssignExpCompany":"false","FModifyDate":"1900-01-01","FModifierId":{"FUserID":""},"F_ora_OrgId1":{"FNumber":""},"FDeliveryDeptID":{"FNumber":""},"FDocumentStatus":"","FSaleID":{"FNUMBER":""},"FPhoneNumber":"","FapplyDate":"1900-01-01","FDetailedReasons":"","FFreightCName":"","FCustomersID":{"FNUMBER":""},"FNowTradeClauseL":{"FNumber":""},"FQtySum":0,"FWeightSum":0,"FfreightRealPriceSum":0,"FBoxQtySUm":0,"FRecipientsPhone":"","FInvoiceNumber":"","FCustContactID":"","FCustcontActionID":"","FOldTradeClause":{"FNumber":""},"FCustcontActionIDL":"","F_RESP_YSDDRQ":"1900-01-01","F_ora_OrgId":{"FNumber":""},"F_TMS_BillNO":"","FEntity":[{"FEntryID":0,"FMaterialID":{"FNUMBER":""},"FPrice":0,"FQty":0,"FBoxQty":0,"FWeight":0,"FCurrencyID":{"FNUMBER":""},"FfreightRealPrice":0}],"F_ora_Entity":[{"FEntryID":0,"FExpCompany":"","FAmount":0,"FRemarks":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FPostcode": "",
        "FMailDate": "1900-01-01",
        "FMailArriveDate": "1900-01-01",
        "FConsigneeAccountNum": "",
        "FFreightEnglishName": "",
        "FfreightAmount": 0,
        "FPostNumber": "",
        "FExpressType": {
...
单据头：FBillHead 
	 实体主键：FID 
	 单据编号：FBillNo 
	 TU负责部门：FDepartmentID 
	 邮编：FPostcode 
	 寄件日期：FMailDate 
	 要求到达日期：FMailArriveDate 
	 到付账号：FConsigneeAccountNum 
	 货物英文名：FFreightEnglishName 
	 运费金额：FfreightAmount 
	 快递单号：FPostNumber 
	 快递种类：FExpressType 
	 运费付款方式：FFreightPayType 
	 指定快递公司：FAssignExpCompany 
	 寄件原因选项：FMailCauseOption 
	 寄件是否正常：FMailCause 
	 最终承运公司：FLastExpCompany 
	 币别：FHCurrencyID 
	 是否客户指定快递公司：FIsAssignExpCompany 
	 创建日期：FCreateDate 
	 审核人：FApproverID 
	 审核日期：FApproveDate 
	 修改日期：FModifyDate 
	 ...
	 申请部门：F_SaleDept 
	 申请日期：FapplyDate 
	 详细原因/备注：FDetailedReasons 
	 货物中文名：FFreightCName 
	 收件公司名：FCustomersID 
	 现贸易条款：FNowTradeClauseL 
	 总个数：FQtySum 
	 总重量：FWeightSum 
	 总价值：FfreightRealPriceSum 
	 总箱数：FBoxQtySUm 
	 收件人电话：FRecipientsPhone 
	 发票号：FInvoiceNumber 
	 收件人：FCustContactID 
	 收件人地址（废弃）：FCustcontActionID 
	 原贸易条款：FOldTradeClause 
	 收件人地址：FCustcontActionIDL 
	 运输到达日期：F_RESP_YSDDRQ 
	 销售组织：F_ora_OrgId 
	 TMS单号：F_TMS_BillNO 
单据体：FEntity 
	 实体主键：FEntryID 
	 零件名称：FMaterialID  (必填项)
	 单价：FPrice 
	 个数：FQty 
	 重量：FWeight 
	 币种：FCurrencyID 
	 货物真实价格：FfreightRealPrice 
	 箱数：FBoxQty 
	 海关编码：FCustomsNumber 
单据体：F_ora_Entity 
	 实体主键：FEntryID 
...
关联关系表：FEntity_Link 
	 ...
	 原始携带量：FEntity_Link_FQtyOld 
	 修改携带量：FEntity_Link_FQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ora_MailGoodsBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDepartmentID":{"FNUMBER":""},"FPostcode":"","FMailDate":"1900-01-01","FMailArriveDate":"1900-01-01","FConsigneeAccountNum":"","FFreightEnglishName":"","FfreightAmount":0,"FPostNumber":"","FExpressType":{"FNumber":""},"FFreightPayType":{"FNumber":""},"FAssignExpCompany":{"FNumber":""},"FMailCauseOption":{"FNumber":""},"FMailCause":{"FNumber":""},"FLastExpCompany":{"FNumber":""},"FHCurrencyID":{"FNUMBER":""},"FIsAssignExpCompany":"false","FModifyDate":"1900-01-01","FModifierId":{"FUserID":""},"F_ora_OrgId1":{"FNumber":""},"FDeliveryDeptID":{"FNumber":""},"FDocumentStatus":"","FSaleID":{"FNUMBER":""},"FPhoneNumber":"","FapplyDate":"1900-01-01","FDetailedReasons":"","FFreightCName":"","FCustomersID":{"FNUMBER":""},"FNowTradeClauseL":{"FNumber":""},"FQtySum":0,"FWeightSum":0,"FfreightRealPriceSum":0,"FBoxQtySUm":0,"FRecipientsPhone":"","FInvoiceNumber":"","FCustContactID":"","FCustcontActionID":"","FOldTradeClause":{"FNumber":""},"FCustcontActionIDL":"","F_RESP_YSDDRQ":"1900-01-01","F_ora_OrgId":{"FNumber":""},"F_TMS_BillNO":"","FEntity":[{"FEntryID":0,"FMaterialID":{"FNUMBER":""},"FPrice":0,"FQty":0,"FBoxQty":0,"FWeight":0,"FCurrencyID":{"FNUMBER":""},"FfreightRealPrice":0}],"F_ora_Entity":[{"FEntryID":0,"FExpCompany":"","FAmount":0,"FRemarks":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ora_MailGoodsBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ora_MailGoodsBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ora_MailGoodsBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ora_MailGoodsBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ora_MailGoodsBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ora_MailGoodsBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ora_MailGoodsBill"}");

# 新豪总账应收逾期账龄 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 总账 > 新豪总账应收逾期账龄

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2290 |
...
client.GetSysReportData("QGWK_GL_AR_AgingAnalysis","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"F_QGWK_Customer":{"FNUMBER":""},"FSettleOrgLst":"","F_QGWK_Date":"1900-01-01","F_QGWK_OrgId":{"FNumber":""},"F_QGWK_AgingGrpSetting":[{"F_QGWK_Section":"","F_QGWK_Days":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FSettleOrgLst": "",
        "F_QGWK_Date": "1900-01-01",
        "F_QGWK_OrgId": {
            "FNumber": ""
        },
        "F_QGWK_AgingGrpSetting": [
            {
                "F_QGWK_Section": "",
                "F_QGWK_Days": 0
            }
...
五、字段说明：
	 客户：F_QGWK_Customer 
	 多选下拉列表：FSettleOrgLst 
	 日期：F_QGWK_Date  (必填项)
	 组织：F_QGWK_OrgId 
	 账龄分组设置：F_QGWK_Section 
	 天数：F_QGWK_Days 

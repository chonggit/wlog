# 德上BOM变更记录 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 工程数据管理 > 德上BOM变更记录
...
client.Delete("k0653473bb28e471dbef5d6caaaafcc89","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("k0653473bb28e471dbef5d6caaaafcc89","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreateOrgId":{"FNumber":""},"FDepartID":{"FNUMBER":""},"FApplyID":{"FStaffNumber":""},"FDate":"1900-01-01","FNote":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FHeadBOMNumber":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FBOMNumber":"","FBOMName":"","FRowSeq":0,"FMtrlDepartName":"","FBOMEntryID":0,"FMaterialID":{"FNUMBER":""},"FUnitID":{"FNUMBER":""},"FAuxPropID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FMaterialID_Change":{"FNUMBER":""},"FAuxPropID_Change":{"FAUXPROPID_CHANGE__FF100001":{"FNumber":""},"FAUXPROPID_CHANGE__FF100002":{"FNumber":""},"FAUXPROPID_CHANGE__FF100003":{"FNumber":""},"FAUXPROPID_CHANGE__FF100005":{"FNumber":""},"FAUXPROPID_CHANGE__FF100010":{"FNumber":""},"FAUXPROPID_CHANGE__FF100007":{"FNumber":""},"FAUXPROPID_CHANGE__FF100008":{"FNumber":""}},"FUnitID_Change":{"FNUMBER":""},"FMtrlModel":"","FMtrlModel_Change":"","FMtrlLenght":"","FMtrlLenght_Change":"","FMaterialIDChild":{"FNUMBER":""},"FUnitIDChild":{"FNUMBER":""},"FMaterialIDChild_Change":{"FNUMBER":""},"FUnitIDChild_Change":{"FNUMBER":""},"FNumerator":0,"Fnumerator_Change":0,"FDenominator":0,"Fdenominator_Change":0,"Fweight":0,"Fweight_Change":0,"FStockOrgID":{"FNumber":""},"FStockID":{"FNUMBER":""},"FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FIssueType":""}]}}");
        ...
        "FEntity": [
            {
                ...
                "FAuxPropID_Change": {
                    "FAUXPROPID_CHANGE__FF100001": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_CHANGE__FF100002": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_CHANGE__FF100003": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_CHANGE__FF100005": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_CHANGE__FF100010": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_CHANGE__FF100007": {
                        "FNumber": ""
                    },
                    "FAUXPROPID_CHANGE__FF100008": {
                        "FNumber": ""
                    }
                },
                "FUnitID_Change": {
...
单据头：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 BOM版本：FHeadBOMNumber 
	 BOM简称：FHeadBOMName 
	 父项物料编码：FHeadMaterialNumber 
	 附件数：F_DJQty 
单据体：FEntity 
	 实体主键：FEntryID 
	 机型：FMtrlModel 
	 料长：FMtrlLenght 
	 BOM简称：FBOMName  (必填项)
	 领料部门：FMtrlDepartName 
	 父项物料单位：FUnitID  (必填项)
	 父项物料编码：FMaterialID  (必填项)
	 BOM版本：FBOMNumber  (必填项)
	 父项物料名称：FMaterialName 
	 辅助属性：FAuxPropID 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 ...
	 发料方式：FIssueType  (必填项)
	 父项物料名称(变更后）：FMaterialName_Change 
	 辅助属性(变更后）：FAuxPropID_Change 
	 描述：FF100001
	 公差：FF100002
	 品牌：FF100003
	 TU归属：FF100005
	 ...
	 版本号：FF100007
	 指定对象：FF100008
	 机型(变更后）：FMtrlModel_Change 
	 料长(变更后）：FMtrlLenght_Change 
	 子项物料编码(变更后）：FMaterialIDChild_Change  (必填项)
	 子项物料名称(变更后）：FMaterialNameChild_Change 
	 子项物料单位(变更后）：FUnitIDChild_Change  (必填项)
	 用量分子(变更后）：Fnumerator_Change 
	 用量分母(变更后）：Fdenominator_Change 
	 单净重(变更后）：Fweight_Change 
	 父项物料编码(变更后）：FMaterialID_Change  (必填项)
	 父项物料单位(变更后）：FUnitID_Change 
	 发料组织：FStockOrgID 
	 BOM行号：FRowSeq 
	 BOM行内码：FBOMEntryID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("k0653473bb28e471dbef5d6caaaafcc89","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreateOrgId":{"FNumber":""},"FDepartID":{"FNUMBER":""},"FApplyID":{"FStaffNumber":""},"FDate":"1900-01-01","FNote":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FHeadBOMNumber":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FBOMNumber":"","FBOMName":"","FRowSeq":0,"FMtrlDepartName":"","FBOMEntryID":0,"FMaterialID":{"FNUMBER":""},"FUnitID":{"FNUMBER":""},"FAuxPropID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FMaterialID_Change":{"FNUMBER":""},"FAuxPropID_Change":{"FAUXPROPID_CHANGE__FF100001":{"FNumber":""},"FAUXPROPID_CHANGE__FF100002":{"FNumber":""},"FAUXPROPID_CHANGE__FF100003":{"FNumber":""},"FAUXPROPID_CHANGE__FF100005":{"FNumber":""},"FAUXPROPID_CHANGE__FF100010":{"FNumber":""},"FAUXPROPID_CHANGE__FF100007":{"FNumber":""},"FAUXPROPID_CHANGE__FF100008":{"FNumber":""}},"FUnitID_Change":{"FNUMBER":""},"FMtrlModel":"","FMtrlModel_Change":"","FMtrlLenght":"","FMtrlLenght_Change":"","FMaterialIDChild":{"FNUMBER":""},"FUnitIDChild":{"FNUMBER":""},"FMaterialIDChild_Change":{"FNUMBER":""},"FUnitIDChild_Change":{"FNUMBER":""},"FNumerator":0,"Fnumerator_Change":0,"FDenominator":0,"Fdenominator_Change":0,"Fweight":0,"Fweight_Change":0,"FStockOrgID":{"FNumber":""},"FStockID":{"FNUMBER":""},"FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FIssueType":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("k0653473bb28e471dbef5d6caaaafcc89","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("k0653473bb28e471dbef5d6caaaafcc89","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("k0653473bb28e471dbef5d6caaaafcc89","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("k0653473bb28e471dbef5d6caaaafcc89","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("k0653473bb28e471dbef5d6caaaafcc89","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("k0653473bb28e471dbef5d6caaaafcc89","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"k0653473bb28e471dbef5d6caaaafcc89"}");

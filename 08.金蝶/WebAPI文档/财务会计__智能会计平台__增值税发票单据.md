# 增值税发票单据 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 智能会计平台 > 增值税发票单据
...
client.Delete("GL_AddedTaxBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("GL_AddedTaxBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillCode":"","FBillNumber":"","FBillDate":"1900-01-01","FTemplateId":{"FNUMBER":""},"FBizDate":"1900-01-01","FBillType":"","FPageNumber":"","FBuyerType":"","FBuyer":{"FNumber":""},"FSalesType":"","FSales":{"FNumber":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FRemark":"","FSumAmount":0,"FSumTax":0,"FAllAmount":0,"FCurrencyId":{"FNUMBER":""},"FAcctOrgId":{"FNUMBER":""},"FOCRRESULTID":0,"FEntity":[{"FEntryID":0,"FTaxItem":{"FNUMBER":""},"FModels":"","FUnit":{"FNumber":""},"FQuantity":0,"FPrice":0,"FAmount":0,"FTaxRate":0,"FTaxAmount":0,"FSubtotal":0}]}}");
...
单据头：FBillHead 
	 ...
	 核算组织：FAcctOrgId 
	 税额合计：FSumTax 
	 扫描结果ID(用于联查)：FOCRRESULTID 
单据体：FEntity 
	 实体主键：FEntryID 
	 货物应税劳务或服务：FTaxItem  (必填项)
	 规格型号：FModels 
	 税率（%）：FTaxRate 
	 单价：FPrice 
	 金额：FAmount 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("GL_AddedTaxBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillCode":"","FBillNumber":"","FBillDate":"1900-01-01","FTemplateId":{"FNUMBER":""},"FBizDate":"1900-01-01","FBillType":"","FPageNumber":"","FBuyerType":"","FBuyer":{"FNumber":""},"FSalesType":"","FSales":{"FNumber":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FRemark":"","FSumAmount":0,"FSumTax":0,"FAllAmount":0,"FCurrencyId":{"FNUMBER":""},"FAcctOrgId":{"FNUMBER":""},"FOCRRESULTID":0,"FEntity":[{"FEntryID":0,"FTaxItem":{"FNUMBER":""},"FModels":"","FUnit":{"FNumber":""},"FQuantity":0,"FPrice":0,"FAmount":0,"FTaxRate":0,"FTaxAmount":0,"FSubtotal":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("GL_AddedTaxBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("GL_AddedTaxBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("GL_AddedTaxBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("GL_AddedTaxBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("GL_AddedTaxBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"GL_AddedTaxBill"}");

# MRP运算结果汇总表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 计划管理 > MRP运算结果汇总表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3709 |
...
client.GetSysReportData("PLN_MRPCalSummaryRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FShowNoDemandMtrl":"false","FOnlyDisplaySummaryRow":"false","FExpandSubordinateMtrl":"false","FSummarizeType":"","FMaterialBegin":{"FNumber":""},"FMtrlCategory":"","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FMaterialEnd":{"FNumber":""},"FMrpBillNo":"","FComputeId":"","FMulOrgId":[{"FNumber":""}],"FPlanStrategy":"","FShowAllCalMtrl":"false","FMtoNoBegin":"","FMtoNoEnd":"","FPlannerID":[{"FNumber":""}],"FPurchaserId":[{"FNumber":""}]}}");
...
五、字段说明：
	 ...
	 至：：FMaterialEnd 
	 物料编码：FMaterialBegin 
	 汇总方式：FSummarizeType  (必填项)
	 展开下级物料：FExpandSubordinateMtrl 
	 只显示汇总行：FOnlyDisplaySummaryRow 

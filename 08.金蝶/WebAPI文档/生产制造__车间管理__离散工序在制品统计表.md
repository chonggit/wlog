# 离散工序在制品统计表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 离散工序在制品统计表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3468 |
...
client.GetSysReportData("SFC_DiscreteOptWIPRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgId":[{"FNumber":""}],"FProcessOrgId":[{"FNumber":""}],"FWorkShopIDS":"","FProWorkShopIDS":"","FMONumber":"","FOperPlanningNumber":"","FWorkCenterId":[{"FNumber":""}],"FProcessId":[{"FNumber":""}],"FIsShowZero":"false","FMaterialId":[{"FNumber":""}]}}");

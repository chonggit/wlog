...
client.Save("BAS_WarnObject","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FMsgPluginid":"","FName":"","FDataSourceid":{"FID":""},"FSubSysid":{"FNumber":""},"FModelTypeId":"","FSupplierName":"","FIsSysPreset":"false","FIsExpand":"false","FConditionForm":{"FID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FAppPluginid":"","FMsgPlugin":"","FControlPlugin":"","FAppPlugin":"","FControlPluginid":"","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""}}}");
...
单据头：FBillHead 
	 实体主键：FID 
	 监控消息解析插件ID：FMsgPluginid 
	 业务领域：FTopClassId 
	 监控对象名称：FName  (必填项)
	 数据来源：FDataSourceid  (必填项)
	 子系统：FSubSysid  (必填项)
	 来源类型：FModelTypeId 
	 开发商：FSupplierName 
	 是否系统预置：FIsSysPreset 
	 是否扩展：FIsExpand 
	 监控条件窗体：FConditionForm  (必填项)
	 创建日期：FCreateDate 
	 修改日期：FModifyDate 
	 监控方案解析插件ID：FAppPluginid 
	 监控对象编码：FNumber  (必填项)
	 监控消息解析插件：FMsgPlugin 
	 监控方案编辑插件：FControlPlugin 
	 监控方案解析插件：FAppPlugin 
	 监控方案编辑插件ID：FControlPluginid 
	 创建人：FCreatorId 
	 修改人：FModifierId 
	 审核人：FAuditorID 
	 审核日期：FAuditDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BAS_WarnObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BAS_WarnObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BAS_WarnObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BAS_WarnObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_WarnObject","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BAS_WarnObject","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("BAS_WarnObject","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BAS_WarnObject","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FMsgPluginid":"","FName":"","FDataSourceid":{"FID":""},"FSubSysid":{"FNumber":""},"FModelTypeId":"","FSupplierName":"","FIsSysPreset":"false","FIsExpand":"false","FConditionForm":{"FID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FAppPluginid":"","FMsgPlugin":"","FControlPlugin":"","FAppPlugin":"","FControlPluginid":"","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""}}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BAS_WarnObject"}");

...
client.Delete("CR_ScopeType","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CR_ScopeType","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CR_ScopeType","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FConsolidationMode":"","FIsSysPreset":"false","FAcctSysId":{"FNumber":""},"FAcctPolicyId":{"FNumber":""},"FEffectiveDate":"1900-01-01","FVersionGroupId":0,"FVersion":0,"FHaveScope":"false","FByEmail":"false","FBySms":"false","FRemindDayCount":0,"FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FPromptDayCount":0,"FDescription":"","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FIsLastedVersion":"false","FChangeReason":"","FScopeEntity":[{"FHisID":0,"FScopeID":{"FNUMBER":""},"FParentScopeID":{"FNUMBER":""},"FCompany":[{"FDetailID":0,"FCompanyId":{"FNumber":""},"FIsCtrCompany":"false"}]}]}}");
...
单据头：FBillHead 
	 ...
	 会计日历：FAcctCalendarId 
	 主币别：FBaseCurrencyId 
	 权益核算：FConsolidationMode  (必填项)
	 生效日期：FEffectiveDate  (必填项)
	 上报提醒天数：FRemindDayCount 
	 预期催报天数：FPromptDayCount 
	 短信：FBySms 
	 邮件：FByEmail 
	 系统预设：FIsSysPreset 
	 核算体系：FAcctSysId  (必填项)
	 ...
	 版本号：FVersion 
	 启用状态：FActiveStatus 
	 版本隔离ID：FVersionGroupId 
	 是否最新版本：FIsLastedVersion 
	 更变原因：FChangeReason 
合并范围：FScopeEntity 
	 实体主键：FHisID 
	 合并范围编码：FScopeNumber 
	 合并范围名称：FScopeName 
	 合并范围：FScopeID 
	 父合并范围：FParentScopeID 
	 父合并范围编码：FParentScopeNumber 
公司：FCompany 
	 实体主键：FDetailID 
	 公司编码：FCompanyId 
	 公司名称：FCompanyName 
	 是否控股公司：FIsCtrCompany 
	 合并方案ID：FCompanyScopeTypeID 
	 合并范围ID：FCompanyScopeID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CR_ScopeType","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CR_ScopeType","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CR_ScopeType","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ScopeType","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ScopeType","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CR_ScopeType","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ScopeType","Active","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ScopeType","Inactive","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ScopeType","CheckInvest","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FNumber":"","FName":"","FConsolidationMode":"","FIsSysPreset":"false","FAcctSysId":{"FNumber":""},"FAcctPolicyId":{"FNumber":""},"FEffectiveDate":"1900-01-01","FVersionGroupId":0,"FVersion":0,"FHaveScope":"false","FByEmail":"false","FBySms":"false","FRemindDayCount":0,"FModifyDate":"1900-01-01","FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FModifierId":{"FUserID":""},"FPromptDayCount":0,"FDescription":"","FForbidderID":{"FUserID":""},"FForbidDate":"1900-01-01","FIsLastedVersion":"false","FChangeReason":"","FScopeEntity":[{"FHisID":0,"FScopeID":{"FNUMBER":""},"FParentScopeID":{"FNUMBER":""},"FCompany":[{"FDetailID":0,"FCompanyId":{"FNumber":""},"FIsCtrCompany":"false"}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CR_ScopeType"}");

# 月末在制分配标准值维护 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 月末在制分配标准值维护
...
client.Delete("CB_WipBom","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_WipBom","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FAcctSystemId":{"FNUMBER":""},"FAcctOrgId":{"FNumber":""},"FAcctPolicyId":{"FNUMBER":""},"FYear":0,"FPeriod":0,"FProductId":{"FNUMBER":""},"FOrderNo":"","FOrderSeq":0,"FBusinessType":"","FBusinessStatus":"","FOutSrcType":"","FCostCenterId":{"FNUMBER":""},"FProductUnitId":{"FNumber":""},"FPInitQty":0,"FPInputQty":0,"FPAdjustQty":0,"FPCompleteQty":0,"FPEndQty":0,"FCalRuleId":{"FNUMBER":""},"FCalDatetime":"1900-01-01","FBaseOrderQty":0,"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FLOTID":{"FNumber":""},"FMTONO":"","FBOMID":{"FNumber":""},"FBILLTYPEID":{"FNUMBER":""},"FFORMID":"","FBaseQty":0,"FENTITY":[{"FEntryID":0,"FENTRYCOSTCENTERID":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FMaterialUnitID":{"FNumber":""},"FEndQty":0,"FPickedQty":0,"FFeedQty":0,"FRetQty":0,"FPrcDefectReturnQty":0,"FIncDefectReturnQty":0,"FGoodReturnQty":0,"FENTRYCALRULEID":{"FNUMBER":""}}],"FBomEntity":[{"FSubEntryID":0,"FREPLACEGROUP2":0,"FPPBOMMATERIALID":{"FNUMBER":""},"FMATERIALTYPE":"","FUSERATE":0,"FPPBOMBASESTDQTY":0,"FINITBASEQTY":0,"FPPBOMBASEMUSTQTY":0,"FPPBOMENDQTY":0,"FCurrConsumeQty":0,"FCurrPickQty":0,"FCurrRepickedQty":0,"FCurrScrapQty":0,"FCurrGoodReturnQty":0,"FCurrIncDefectReturnQty":0,"FCurrPrcDefectReturnQty":0,"FCurrCloseScrapQty":0,"FBASECONSUMEQTY":0,"FPPBOMBASEPICKQTY":0,"FBASEREPICKEDQTY":0,"FBASESCRAPQTY":0,"FPPBOMBASEGOODRTQTY":0,"FPPBOMBASEINCDEFRTQTY":0,"FPPBOMBASEPRCDEFRTQTY":0,"FBASECLOSESCRAPQTY":0}]}}");
        ...
        "FENTITY": [
            {
                ...
                "FFeedQty": 0,
                "FRetQty": 0,
                "FPrcDefectReturnQty": 0,
                "FIncDefectReturnQty": 0,
                "FGoodReturnQty": 0,
                "FENTRYCALRULEID": {
                    "FNUMBER": ""
                }
        ...
        "FBomEntity": [
            {
                ...
                "FCurrRepickedQty": 0,
                "FCurrScrapQty": 0,
                "FCurrGoodReturnQty": 0,
                "FCurrIncDefectReturnQty": 0,
                "FCurrPrcDefectReturnQty": 0,
                "FCurrCloseScrapQty": 0,
                "FBASECONSUMEQTY": 0,
                "FPPBOMBASEPICKQTY": 0,
                "FBASEREPICKEDQTY": 0,
                "FBASESCRAPQTY": 0,
                "FPPBOMBASEGOODRTQTY": 0,
                "FPPBOMBASEINCDEFRTQTY": 0,
                "FPPBOMBASEPRCDEFRTQTY": 0,
                "FBASECLOSESCRAPQTY": 0
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 产品编码：FProductId 
	 产品名称：FProductName 
	 产品规格：FProductSpecification 
	 工单编号：FOrderNo 
	 工单行号：FOrderSeq 
	 业务类型：FBusinessType  (必填项)
	 业务状态：FBusinessStatus  (必填项)
	 委外业务：FOutSrcType  (必填项)
	 成本中心：FCostCenterId 
	 产品基本单位：FProductUnitId 
	 期初在产数量：FPInitQty 
	 本期投入数量：FPInputQty 
	 期初调整数量：FPAdjustQty 
	 本期完工数量：FPCompleteQty 
	 期末在产数量：FPEndQty 
	 计算规则：FCalRuleId 
	 计算时间：FCalDatetime 
	 工单分录内码：FOrderEntryId 
	 工单下达数量：FBaseOrderQty 
	 是否期初：FISINITTYPE 
	 辅助属性：FAUXPROPID 
	 描述：FF100001
	 公差：FF100002
...
单据体：FENTITY 
	 ...
	 本期完工数量：FCompleteQty 
	 期末在产数量：FEndQty 
	 物料基本单位：FMaterialUnitID 
	 使用比例(%)：FMaterialUseRate 
	 外键内码：FPKID 
	 应发数量：FBaseMustQty 
	 累计已领数量：FBasePickedQty 
	 累计补料数量：FBaseFeedQty 
	 累计退料数量（合计）：FBaseRetQty 
	 项次：FReplaceGroup 
	 基本单位分子：FBaseNumerator 
	 基本单位分母：FBaseDenominator 
	 累计作业不良退料数量：FBasePrcDefectReturnQty 
	 累计来料不良退料数量：FBaseIncDefectReturnQty 
	 累计良品退料数量：FBaseGoodReturnQty 
	 标准用量：FStdQty 
	 本期已领数量：FPickedQty 
	 本期补料数量：FFeedQty 
	 本期退料数量（合计）：FRetQty 
	 本期作业不良退料数量：FPrcDefectReturnQty 
	 本期来料不良退料数量：FIncDefectReturnQty 
	 本期良品退料数量：FGoodReturnQty 
	 成本中心编码：FENTRYCOSTCENTERID 
	 成本中心：FCOSTCENTERNAME 
	 计算规则：FENTRYCALRULEID 
	 数据来源：FDATATYPE 
	 本期合格入库数量（工序）：FQUALIFIEDQTY 
	 本期不良入库数量（工序）：FDYSINQTY 
	 本期废品入库数量（工序）：FFAILQTY 
来源用料清单单据体：FBomEntity 
	 实体主键：FSubEntryID 
	 项次：FREPLACEGROUP2 
	 子项物料编码：FPPBOMMATERIALID 
	 子项物料名称：FPPBOMMATERIALNAME 
	 规格型号：FSpecification 
	 子项类型：FMATERIALTYPE 
	 使用比例(%)：FUSERATE 
	 标准用量：FPPBOMBASESTDQTY 
	 应发数量：FPPBOMBASEMUSTQTY 
	 在制材料数量：FPPBOMENDQTY 
	 累计结案报失数量：FBASECLOSESCRAPQTY 
	 累计已消耗数量：FBASECONSUMEQTY 
	 累计良品退料数量：FPPBOMBASEGOODRTQTY 
	 累计来料不良退料数量：FPPBOMBASEINCDEFRTQTY 
	 累计领料数量：FPPBOMBASEPICKQTY 
	 累计作业不良退料数量：FPPBOMBASEPRCDEFRTQTY 
	 累计补领数量：FBASEREPICKEDQTY 
	 累计报废数量：FBASESCRAPQTY 
	 期初数量：FINITBASEQTY 
	 本期结案报失数量：FCurrCloseScrapQty 
	 本期已消耗数量：FCurrConsumeQty 
	 本期良品退料数量：FCurrGoodReturnQty 
	 本期来料不良退料数量：FCurrIncDefectReturnQty 
	 本期领料数量：FCurrPickQty 
	 本期作业不良退料数量：FCurrPrcDefectReturnQty 
	 本期补领数量：FCurrRepickedQty 
	 本期报废数量：FCurrScrapQty 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_WipBom","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FAcctSystemId":{"FNUMBER":""},"FAcctOrgId":{"FNumber":""},"FAcctPolicyId":{"FNUMBER":""},"FYear":0,"FPeriod":0,"FProductId":{"FNUMBER":""},"FOrderNo":"","FOrderSeq":0,"FBusinessType":"","FBusinessStatus":"","FOutSrcType":"","FCostCenterId":{"FNUMBER":""},"FProductUnitId":{"FNumber":""},"FPInitQty":0,"FPInputQty":0,"FPAdjustQty":0,"FPCompleteQty":0,"FPEndQty":0,"FCalRuleId":{"FNUMBER":""},"FCalDatetime":"1900-01-01","FBaseOrderQty":0,"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FLOTID":{"FNumber":""},"FMTONO":"","FBOMID":{"FNumber":""},"FBILLTYPEID":{"FNUMBER":""},"FFORMID":"","FBaseQty":0,"FENTITY":[{"FEntryID":0,"FENTRYCOSTCENTERID":{"FNUMBER":""},"FMaterialId":{"FNUMBER":""},"FMaterialUnitID":{"FNumber":""},"FEndQty":0,"FPickedQty":0,"FFeedQty":0,"FRetQty":0,"FPrcDefectReturnQty":0,"FIncDefectReturnQty":0,"FGoodReturnQty":0,"FENTRYCALRULEID":{"FNUMBER":""}}],"FBomEntity":[{"FSubEntryID":0,"FREPLACEGROUP2":0,"FPPBOMMATERIALID":{"FNUMBER":""},"FMATERIALTYPE":"","FUSERATE":0,"FPPBOMBASESTDQTY":0,"FINITBASEQTY":0,"FPPBOMBASEMUSTQTY":0,"FPPBOMENDQTY":0,"FCurrConsumeQty":0,"FCurrPickQty":0,"FCurrRepickedQty":0,"FCurrScrapQty":0,"FCurrGoodReturnQty":0,"FCurrIncDefectReturnQty":0,"FCurrPrcDefectReturnQty":0,"FCurrCloseScrapQty":0,"FBASECONSUMEQTY":0,"FPPBOMBASEPICKQTY":0,"FBASEREPICKEDQTY":0,"FBASESCRAPQTY":0,"FPPBOMBASEGOODRTQTY":0,"FPPBOMBASEINCDEFRTQTY":0,"FPPBOMBASEPRCDEFRTQTY":0,"FBASECLOSESCRAPQTY":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_WipBom","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CB_WipBom","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CB_WipBom","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CB_WipBom","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CB_WipBom","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_WipBom","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_WipBom"}");

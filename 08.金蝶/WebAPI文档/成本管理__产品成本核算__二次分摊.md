...
client.Delete("ora_SecondaryAllocate","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ora_SecondaryAllocate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_XCKF_Org":{"FNumber":""},"F_ora_ModifierId_ca9_83g":{"FUserID":""},"F_ora_ModifyDate_uky_re5":"1900-01-01","F_ora_CreateDate_tzk_apv":"1900-01-01","F_XCKF_Period":"1900-01-01","F_ora_CreatorId_apv_ca9":{"FUserID":""},"F_ora__PTDD_UserId_qtr_uky":{"FUserID":""},"F_ora__PTDD_Date_83g_dvn":"1900-01-01","FEntity":[{"FEntryID":0,"F_XCKF_Subject":{"FNUMBER":""},"F_XCKF_Department":{"FNUMBER":""},"F_XCKF_FeeProject":{"FNUMBER":""},"F_XCKF_DebtorAmount":0}],"F_XCKF_SecondaryAllWeight":[{"FEntryID":0,"F_XCKF_WT_CostObject":{"FNUMBER":""},"F_XCKF_WT_WorkHourTotal":0,"F_XCKF_WT_Proportion":0,"F_XCKF_WT_Depart":{"FNUMBER":""},"F_XCKF_WT_FeeProject":{"FNUMBER":""},"F_XCKF_WT_WeightAmount":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "F_ora_ModifierId_ca9_83g": {
            "FUserID": ""
        },
        "F_ora_ModifyDate_uky_re5": "1900-01-01",
        "F_ora_CreateDate_tzk_apv": "1900-01-01",
        "F_XCKF_Period": "1900-01-01",
        "F_ora_CreatorId_apv_ca9": {
            "FUserID": ""
        },
        "F_ora__PTDD_UserId_qtr_uky": {
            "FUserID": ""
        },
        "F_ora__PTDD_Date_83g_dvn": "1900-01-01",
        "FEntity": [
            {
                "FEntryID": 0,
                "F_XCKF_Subject": {
                ...
                "F_XCKF_DebtorAmount": 0
            }
        ],
        "F_XCKF_SecondaryAllWeight": [
            {
                "FEntryID": 0,
                "F_XCKF_WT_CostObject": {
                    "FNUMBER": ""
                },
                "F_XCKF_WT_WorkHourTotal": 0,
                "F_XCKF_WT_Proportion": 0,
                "F_XCKF_WT_Depart": {
                    "FNUMBER": ""
                },
                "F_XCKF_WT_FeeProject": {
                    "FNUMBER": ""
                },
                "F_XCKF_WT_WeightAmount": 0
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 组织：F_XCKF_Org 
	 修改人：F_ora_ModifierId_ca9_83g 
	 修改日期：F_ora_ModifyDate_uky_re5 
	 创建日期：F_ora_CreateDate_tzk_apv 
	 期间：F_XCKF_Period 
	 创建人：F_ora_CreatorId_apv_ca9 
	 审核人：F_ora__PTDD_UserId_qtr_uky 
	 审核日期：F_ora__PTDD_Date_83g_dvn 
科目余额表明细：FEntity 
	 实体主键：FEntryID 
	 科目编码：F_XCKF_Subject 
	 部门（核算维度）：F_XCKF_Department 
	 费用项目：F_XCKF_FeeProject 
	 借方发生额：F_XCKF_DebtorAmount 
分摊权重：F_XCKF_SecondaryAllWeight 
	 实体主键：FEntryID 
	 费用分配标准（工序）：F_XCKF_WT_CostObject 
	 汇总工时：F_XCKF_WT_WorkHourTotal 
	 占比%：F_XCKF_WT_Proportion 
	 部门：F_XCKF_WT_Depart 
	 费用项目：F_XCKF_WT_FeeProject 
	 分摊金额：F_XCKF_WT_WeightAmount 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ora_SecondaryAllocate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","F_XCKF_Org":{"FNumber":""},"F_ora_ModifierId_ca9_83g":{"FUserID":""},"F_ora_ModifyDate_uky_re5":"1900-01-01","F_ora_CreateDate_tzk_apv":"1900-01-01","F_XCKF_Period":"1900-01-01","F_ora_CreatorId_apv_ca9":{"FUserID":""},"F_ora__PTDD_UserId_qtr_uky":{"FUserID":""},"F_ora__PTDD_Date_83g_dvn":"1900-01-01","FEntity":[{"FEntryID":0,"F_XCKF_Subject":{"FNUMBER":""},"F_XCKF_Department":{"FNUMBER":""},"F_XCKF_FeeProject":{"FNUMBER":""},"F_XCKF_DebtorAmount":0}],"F_XCKF_SecondaryAllWeight":[{"FEntryID":0,"F_XCKF_WT_CostObject":{"FNUMBER":""},"F_XCKF_WT_WorkHourTotal":0,"F_XCKF_WT_Proportion":0,"F_XCKF_WT_Depart":{"FNUMBER":""},"F_XCKF_WT_FeeProject":{"FNUMBER":""},"F_XCKF_WT_WeightAmount":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ora_SecondaryAllocate","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ora_SecondaryAllocate","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ora_SecondaryAllocate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ora_SecondaryAllocate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ora_SecondaryAllocate","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ora_SecondaryAllocate","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ora_SecondaryAllocate"}");

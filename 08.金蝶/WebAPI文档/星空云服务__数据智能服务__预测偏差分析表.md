# 预测偏差分析表 Web API 操作原始内容

> 来源页面：全部 > 星空云服务 > 数据智能服务 > 预测偏差分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3050 |
...
client.GetSysReportData("BDIP_SalePreAndActualRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FSaleOrgList":"","FBaseDate":"1900-01-01","FMATERIALCODEFROM":{"FNUMBER":""},"FMATERIALCODETO":{"FNUMBER":""},"F_MATERIALGROUP":[{"FNumber":""}],"FBillStatus":"","FPredictionModels":"","FBaseDateTo":"1900-01-01","FPreValueType":"","FCustGroup":[{"FNumber":""}],"FAlgorithmId":"","FAnalsisPeriod":"","FUnit":""}}");

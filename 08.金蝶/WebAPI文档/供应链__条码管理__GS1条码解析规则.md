# GS1条码解析规则 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > GS1条码解析规则
...
client.Delete("UN_BARANALYZINGRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UN_BARANALYZINGRULE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_BARANALYZINGRULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRemark":"","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverID":{"FUserID":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"FBarcodePropertyId":{"FNUMBER":""},"FStandardApplicatKey":"","FFormat":{"FNUMBER":""},"FIstepcept":"false","FINTERCEPTSTART":0,"FInterceptEnd":0,"FReplaceApplicatingKey":"","FReplaceIsIntercept":"false","FReplaceInterceptStart":0,"FReplaceInterceptEnd":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FINTERCEPTSTART": 0,
                "FInterceptEnd": 0,
                "FReplaceApplicatingKey": "",
                "FReplaceIsIntercept": "false",
                "FReplaceInterceptStart": 0,
                "FReplaceInterceptEnd": 0
            }
        ]
    }
}
...
单据体：FEntity 
	 实体主键：FEntryID 
	 条码属性：FBarcodePropertyId  (必填项)
	 属性名称：FBarcodePropertyName 
	 属性类型：FBarcodePropertyType 
	 标准应用标识符(AI)：FStandardApplicatKey 
	 是否截取：FIstepcept 
	 截取起始位：FINTERCEPTSTART 
	 截取终止位：FInterceptEnd 
	 替代-应用标识符(AI)：FReplaceApplicatingKey 
	 替代-是否截取：FReplaceIsIntercept 
	 替代-截取起始位：FReplaceInterceptStart 
	 替代-截取终止位：FReplaceInterceptEnd 
	 格式：FFormat 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_BARANALYZINGRULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FRemark":"","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverID":{"FUserID":""},"FCreateDate":"1900-01-01","FCreatorId":{"FUserID":""},"FApproveDate":"1900-01-01","FEntity":[{"FEntryID":0,"FBarcodePropertyId":{"FNUMBER":""},"FStandardApplicatKey":"","FFormat":{"FNUMBER":""},"FIstepcept":"false","FINTERCEPTSTART":0,"FInterceptEnd":0,"FReplaceApplicatingKey":"","FReplaceIsIntercept":"false","FReplaceInterceptStart":0,"FReplaceInterceptEnd":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("UN_BARANALYZINGRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("UN_BARANALYZINGRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("UN_BARANALYZINGRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_BARANALYZINGRULE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_BARANALYZINGRULE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("UN_BARANALYZINGRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("UN_BARANALYZINGRULE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_BARANALYZINGRULE"}");

# 经营账户收支明细表 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 经营会计 > 经营账户收支明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3155 |
...
client.GetSysReportData("AM_AMBTransact","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FAccountBookH":{"FNUMBER":""},"FSTARTPERIODH":"","FENDPERIODH":"","FSTARTDATEH":"1900-01-01","FENDDATEH":"1900-01-01","FNotAudit":"false","FAMEBAUNITH":[{"FNumber":""}],"FCURRENCYIDH":[{"FNumber":""}],"FSum":"false","FProfitCenterH":{"FNUMBER":""},"FAccountH":{"FNUMBER":""},"FINCLUDECOLLACTION":"false","FORGSTRUCTUREID":{"FNUMBER":""}}}");
...
五、字段说明：
	 ...
	 经营期间：FSTARTPERIODH  (必填项)
	 至：FENDPERIODH 
	 业务日期：FSTARTDATEH  (必填项)
	 至：FENDDATEH 
	 包含未审核经营流水账：FNotAudit 
	 经营单元：FAMEBAUNITH 
	 币别：FCURRENCYIDH 
	 显示合计：FSum 

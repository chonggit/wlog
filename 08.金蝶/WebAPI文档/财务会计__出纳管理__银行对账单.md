# 银行对账单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 银行对账单
...
client.Delete("CN_BANKACNTSTATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_BANKACNTSTATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBANKID":{"FNumber":""},"FBANKACNTID":{"FNumber":""},"FCurrencyId":{"FNumber":""},"FBEGINDATE":"1900-01-01","FENDDATE":"1900-01-01","FFIRSTBALAMOUNT":0,"FEntity":[{"FEntryID":0,"FTRANSDATE":"1900-01-01","FDEBITAMOUNT":0,"FCREDITAMOUNT":0,"FEXPLANATION":"","FSETTLETYPEID":{"FNumber":""},"FSETTLENO":"","FCHECKCODE":"","FOPPOSITEBANKNAME":"","FOPPOSITEBANKACNTNO":"","FOPPOSITECCOUNTNAME":"","FACCOUNTINGSERIALNO":""}]}}");
...
单据头：FBillHead 
	 ...
	 结束日期：FENDDATE  (必填项)
	 银行账户名称：FBANKACNNAME 
	 借方合计金额：FALLDEBITAMOUNT 
	 贷方合计金额：FALLCREDITAMOUNT 
	 借方笔数：FDEBITCOUNT 
	 贷方笔数：FCREDITCOUNT 
	 创建组织：FCreateOrgId 
	 单据类型：FBillTypeID 
	 首笔余额：FFIRSTBALAMOUNT 
	 末笔余额：FLASTBALAMOUNT 
单据体：FEntity 
	 实体主键：FEntryID 
	 业务日期：FTRANSDATE  (必填项)
	 摘要：FEXPLANATION 
	 借方/付款金额：FDEBITAMOUNT 
	 贷方/收款金额：FCREDITAMOUNT 
	 余额：FBALANCEAMOUNT 
	 结算方式：FSETTLETYPEID 
	 结算号：FSETTLENO 
	 勾对：FBLEND 
	 对方开户行：FOPPOSITEBANKNAME 
	 对方银行账号：FOPPOSITEBANKACNTNO 
	 对方账户名称：FOPPOSITECCOUNTNAME 
	 对账码：FCHECKCODE 
	 是否生成银行流水：FISExportRECEIVEBILL 
	 会计流水号：FACCOUNTINGSERIALNO 
关联关系表：FBillHead_Link 
	 ...
	 原始携带量：FBillHead_Link_FLASTBALAMOUNTOld 
	 修改携带量：FBillHead_Link_FLASTBALAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_BANKACNTSTATE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBANKID":{"FNumber":""},"FBANKACNTID":{"FNumber":""},"FCurrencyId":{"FNumber":""},"FBEGINDATE":"1900-01-01","FENDDATE":"1900-01-01","FFIRSTBALAMOUNT":0,"FEntity":[{"FEntryID":0,"FTRANSDATE":"1900-01-01","FDEBITAMOUNT":0,"FCREDITAMOUNT":0,"FEXPLANATION":"","FSETTLETYPEID":{"FNumber":""},"FSETTLENO":"","FCHECKCODE":"","FOPPOSITEBANKNAME":"","FOPPOSITEBANKACNTNO":"","FOPPOSITECCOUNTNAME":"","FACCOUNTINGSERIALNO":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_BANKACNTSTATE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_BANKACNTSTATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_BANKACNTSTATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_BANKACNTSTATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_BANKACNTSTATE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_BANKACNTSTATE","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_BANKACNTSTATE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_BANKACNTSTATE"}");

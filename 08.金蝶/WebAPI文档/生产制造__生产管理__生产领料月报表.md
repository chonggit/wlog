# 生产领料月报表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产管理 > 生产领料月报表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3440 |
...
client.GetSysReportData("PRD_PickMtrlMonthRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgId":"","FPickMtrlMonth":"1900-01-01","FWorkShopId":[{"FNumber":""}],"FProdNumId":[{"FNumber":""}],"FMaterialGroupId":[{"FNumber":""}],"FSumBasis":"","FMaterialId":[{"FNumber":""}],"FRangeDateChk":"false","FApprEndDate":"1900-01-01","FMonDateChk":"false","FApprBeginDate":"1900-01-01","FMoBillTypeId":[{"FNumber":""}],"FAccSource":"","FDocStatus":""}}");

...
client.Delete("BD_TAXRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_TAXRULE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_TAXRULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FTaxRuleID":0,"FNumber":"","FName":"","FDescription":"","FTaxSystemID":{"FNumber":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FMnemonic":"","FDEFAULTISTAXMIX":"","FDEFAULTTAXMIXID":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FResultFromType":"","FEntityCondition":[{"FConditionID":0,"FDeterminants":{"FNumber":""},"FLimitedType":"","FDeterminantsName":{"FNumber":""},"FOperators":"","FValueRange":"","FLogic":"","FVALUERANGEKEY":"","FMARKSELECTED":""}],"FEntityTaxMix":[{"FEntryID":0,"FTaxMixID1":{"FNumber":""},"FISTAXMIX":"","FTaxMixID":{"FNumber":""}}],"FValueRangeEntity":[{"FValueRangeEntityId":0,"FValueRangeItem":"","FValueRangeItemKey":""}]}}");
...
单据头：FBillHead 
	 ...
	 系统预置：FIsSysPreset 
	 助记码：FMnemonic 
	 税率/税组合类型：FDEFAULTISTAXMIX 
	 缺省税率/税组合：FDEFAULTTAXMIXID 
	 结果来源：FResultFromType 
	 税率/税组合：FRadio 
	 物料的税率：FRadio1 
	 供应商的税率：FRadio3 
	 客户的税率：FRadio4 
	 费用项目的税率：FRadio5 
决定性因素和条件：FEntityCondition 
	 实体主键：FConditionID 
	 运算符：FOperators 
	 逻辑：FLogic 
	 值/范围：FValueRange 
	 分类限定词：FLimitedType 
	 决定性因素分类：FDeterminants 
	 决定性因素名称：FDeterminantsName 
	 值/范围内码：FVALUERANGEKEY 
	 选择决定性因素分类：FMARKSELECTED 
税组合：FEntityTaxMix 
	 实体主键：FEntryID 
	 废弃代码：FTaxMixID1 
	 基础资料属性：FBaseProperty 
	 代码：FTaxMixID  (必填项)
	 税率/税组合：FISTAXMIX  (必填项)
条件值范围：FValueRangeEntity 
	 实体主键：FValueRangeEntityId 
	 值/范围：FValueRangeItem 
	 值内码：FValueRangeItemKey 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_TAXRULE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FTaxRuleID":0,"FNumber":"","FName":"","FDescription":"","FTaxSystemID":{"FNumber":""},"FStartDate":"1900-01-01","FEndDate":"1900-01-01","FMnemonic":"","FDEFAULTISTAXMIX":"","FDEFAULTTAXMIXID":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FResultFromType":"","FEntityCondition":[{"FConditionID":0,"FDeterminants":{"FNumber":""},"FLimitedType":"","FDeterminantsName":{"FNumber":""},"FOperators":"","FValueRange":"","FLogic":"","FVALUERANGEKEY":"","FMARKSELECTED":""}],"FEntityTaxMix":[{"FEntryID":0,"FTaxMixID1":{"FNumber":""},"FISTAXMIX":"","FTaxMixID":{"FNumber":""}}],"FValueRangeEntity":[{"FValueRangeEntityId":0,"FValueRangeItem":"","FValueRangeItemKey":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_TAXRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_TAXRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_TAXRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_TAXRULE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_TAXRULE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_TAXRULE","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_TAXRULE","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_TAXRULE"}");

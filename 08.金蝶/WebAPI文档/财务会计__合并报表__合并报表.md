...
client.Delete("CR_ConsolidatedRpt","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CR_ConsolidatedRpt","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CR_ConsolidatedRpt","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FRptID":"","FNumber":"","FVersion":"","FCycleID":"","FCurrUnitID":{"FNumber":""},"FIsAutoCreate":"false","FPolicyId":{"FNumber":""},"FCreateStyle":"","FRptStyleType":"","FRECALTIME":"1900-01-01","FIsAdjustBackUp":"false","FRptExtension":{"FExtensionId":"","FScopeId":{"FNUMBER":""},"FScopeTypeId":{"FNUMBER":""},"FCompanyId":{"FNumber":""}},"FEntity":[{"FSheetID":"","FSheetName":"","FSheetType":0,"FIndex":0,"FSheetBookID":{"FNumber":""},"FSheetYear":0,"FSheetPeriod":0,"FSheetDay":"1900-01-01","FSheetCycleID":"","FSheetCurrID":{"FNumber":""},"FSheetCurrUnit":{"FNumber":""},"FSheetSampleID":""}],"FRptReportInfo":[{"FReportInfoId":"","FReportScopeTypeId":{"FNUMBER":""},"FReportScopeId":{"FNUMBER":""},"FReportorId":{"FUserID":""},"FReportDate":"1900-01-01","FReportStatus":"","FReceiverId":{"FUserID":""},"FReveiceDate":"1900-01-01"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FCreateStyle": "",
        "FRptStyleType": "",
        "FRECALTIME": "1900-01-01",
        "FIsAdjustBackUp": "false",
        "FRptExtension": {
            "FExtensionId": "",
            "FScopeId": {
                "FNUMBER": ""
...
单据头：FBillHead 
	 ...
	 禁用人：FForbidderID 
	 所属组织：FOrgId 
	 保存时检查审核：FVerifyStatus 
	 期：FPeriod 
	 报表日期：FDay 
	 币别：FCurrencyID 
	 年：FYear 
	 报表检查日期：FVerifyDate 
	 报表检查结果：FVerifyResult 
	 金额单位：FCurrUnitID 
	 是否自动生成：FIsAutoCreate 
	 会计政策：FPolicyId 
	 创建方式：FCreateStyle 
	 样式类型：FRptStyleType 
	 报表Style内容：FRptStyle 
...
单据体：FEntity 
	 ...
	 期间：FSheetPeriod 
	 报表日期：FSheetDay 
	 表页报表周期：FSheetCycleID 
	 币别：FSheetCurrID 
	 金额单位：FSheetCurrUnit 
	 表页模版ID：FSheetSampleID 
	 默认取数账簿：FSheetBookID 
	 报表模板表页ID：FSheetSampleSheetId 
合并报表属性：FRptExtension 
	 实体主键：FExtensionId 
	 合并范围：FScopeId 
	 合并方案：FScopeTypeId 
	 公司：FCompanyId 
上报信息：FRptReportInfo 
	 实体主键：FReportInfoId 
	 上报方案：FReportScopeTypeId 
	 上报范围：FReportScopeId 
	 上报人：FReportorId 
	 上报时间：FReportDate 
	 上报状态：FReportStatus  (必填项)
	 接收人：FReceiverId 
	 接收时间：FReveiceDate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CR_ConsolidatedRpt","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FRptID":"","FNumber":"","FVersion":"","FCycleID":"","FCurrUnitID":{"FNumber":""},"FIsAutoCreate":"false","FPolicyId":{"FNumber":""},"FCreateStyle":"","FRptStyleType":"","FRECALTIME":"1900-01-01","FIsAdjustBackUp":"false","FRptExtension":{"FExtensionId":"","FScopeId":{"FNUMBER":""},"FScopeTypeId":{"FNUMBER":""},"FCompanyId":{"FNumber":""}},"FEntity":[{"FSheetID":"","FSheetName":"","FSheetType":0,"FIndex":0,"FSheetBookID":{"FNumber":""},"FSheetYear":0,"FSheetPeriod":0,"FSheetDay":"1900-01-01","FSheetCycleID":"","FSheetCurrID":{"FNumber":""},"FSheetCurrUnit":{"FNumber":""},"FSheetSampleID":""}],"FRptReportInfo":[{"FReportInfoId":"","FReportScopeTypeId":{"FNUMBER":""},"FReportScopeId":{"FNUMBER":""},"FReportorId":{"FUserID":""},"FReportDate":"1900-01-01","FReportStatus":"","FReceiverId":{"FUserID":""},"FReveiceDate":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CR_ConsolidatedRpt","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CR_ConsolidatedRpt","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CR_ConsolidatedRpt","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ConsolidatedRpt","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ConsolidatedRpt","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ConsolidatedRpt","RptReport","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FRptID":"","FNumber":"","FVersion":"","FCycleID":"","FCurrUnitID":{"FNumber":""},"FIsAutoCreate":"false","FPolicyId":{"FNumber":""},"FCreateStyle":"","FRptStyleType":"","FRECALTIME":"1900-01-01","FIsAdjustBackUp":"false","FRptExtension":{"FExtensionId":"","FScopeId":{"FNUMBER":""},"FScopeTypeId":{"FNUMBER":""},"FCompanyId":{"FNumber":""}},"FEntity":[{"FSheetID":"","FSheetName":"","FSheetType":0,"FIndex":0,"FSheetBookID":{"FNumber":""},"FSheetYear":0,"FSheetPeriod":0,"FSheetDay":"1900-01-01","FSheetCycleID":"","FSheetCurrID":{"FNumber":""},"FSheetCurrUnit":{"FNumber":""},"FSheetSampleID":""}],"FRptReportInfo":[{"FReportInfoId":"","FReportScopeTypeId":{"FNUMBER":""},"FReportScopeId":{"FNUMBER":""},"FReportorId":{"FUserID":""},"FReportDate":"1900-01-01","FReportStatus":"","FReceiverId":{"FUserID":""},"FReveiceDate":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ConsolidatedRpt","RptCancleReport","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FRptID":"","FNumber":"","FVersion":"","FCycleID":"","FCurrUnitID":{"FNumber":""},"FIsAutoCreate":"false","FPolicyId":{"FNumber":""},"FCreateStyle":"","FRptStyleType":"","FRECALTIME":"1900-01-01","FIsAdjustBackUp":"false","FRptExtension":{"FExtensionId":"","FScopeId":{"FNUMBER":""},"FScopeTypeId":{"FNUMBER":""},"FCompanyId":{"FNumber":""}},"FEntity":[{"FSheetID":"","FSheetName":"","FSheetType":0,"FIndex":0,"FSheetBookID":{"FNumber":""},"FSheetYear":0,"FSheetPeriod":0,"FSheetDay":"1900-01-01","FSheetCycleID":"","FSheetCurrID":{"FNumber":""},"FSheetCurrUnit":{"FNumber":""},"FSheetSampleID":""}],"FRptReportInfo":[{"FReportInfoId":"","FReportScopeTypeId":{"FNUMBER":""},"FReportScopeId":{"FNUMBER":""},"FReportorId":{"FUserID":""},"FReportDate":"1900-01-01","FReportStatus":"","FReceiverId":{"FUserID":""},"FReveiceDate":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CR_ConsolidatedRpt","Unreceive","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FRptID":"","FNumber":"","FVersion":"","FCycleID":"","FCurrUnitID":{"FNumber":""},"FIsAutoCreate":"false","FPolicyId":{"FNumber":""},"FCreateStyle":"","FRptStyleType":"","FRECALTIME":"1900-01-01","FIsAdjustBackUp":"false","FRptExtension":{"FExtensionId":"","FScopeId":{"FNUMBER":""},"FScopeTypeId":{"FNUMBER":""},"FCompanyId":{"FNumber":""}},"FEntity":[{"FSheetID":"","FSheetName":"","FSheetType":0,"FIndex":0,"FSheetBookID":{"FNumber":""},"FSheetYear":0,"FSheetPeriod":0,"FSheetDay":"1900-01-01","FSheetCycleID":"","FSheetCurrID":{"FNumber":""},"FSheetCurrUnit":{"FNumber":""},"FSheetSampleID":""}],"FRptReportInfo":[{"FReportInfoId":"","FReportScopeTypeId":{"FNUMBER":""},"FReportScopeId":{"FNUMBER":""},"FReportorId":{"FUserID":""},"FReportDate":"1900-01-01","FReportStatus":"","FReceiverId":{"FUserID":""},"FReveiceDate":"1900-01-01"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CR_ConsolidatedRpt","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CR_ConsolidatedRpt","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CR_ConsolidatedRpt"}");

# 人员任务工时统计表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 人员任务工时统计表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2795 |
...
client.GetSysReportData("SFC_UserTaskWorkTime","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FEmpId":[{"FStaffNumber":""}],"FBeginMONumber":"","FEndMONumber":"","FProcessOrgId":[{"FNumber":""}],"FProWorkShopIDS":"","FStartDatetime":"1900-01-01","FFinishDateTime":"1900-01-01"}}");

# 标准成本版本 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 标准成本分析 > 标准成本版本
...
client.Delete("CA_STDCOSTVERSION","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CA_STDCOSTVERSION","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CA_STDCOSTVERSION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FVERSIONID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FModifyDate":"1900-01-01","FDescription":"","FISDEFAULT":"false","FCHKSTDHOUR":"false","FCHKLOSTRATE":"false","FCHKPRODRATE":"false","FFACTORS":"","FCHKRATEBYPRD":"false","FCHKRATEBYCC":"false","FISSIMPLIFYBOM":"false","FConsiderEffeDate":"false","FISSKIP":"false","FSupplyEntrust":"false","FCreateDate":"1900-01-01","FCHKFIXSCRAP":"false","FNOSUPERPOSITIONPROCESS":"false","FSUPPLYISSUEMATERIAL":"false"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FCHKRATEBYPRD": "false",
        "FCHKRATEBYCC": "false",
        "FISSIMPLIFYBOM": "false",
        "FConsiderEffeDate": "false",
        "FISSKIP": "false",
        "FSupplyEntrust": "false",
        "FCreateDate": "1900-01-01",
        "FCHKFIXSCRAP": "false",
        "FNOSUPERPOSITIONPROCESS": "false",
        "FSUPPLYISSUEMATERIAL": "false"
    }
}
...
单据头：FBillHead 
	 ...
	 成品率：FCHKPRODRATE 
	 影响因素：FFACTORS 
	 标准费率按产品维护：FCHKRATEBYPRD 
	 标准费率按成本中心维护：FCHKRATEBYCC 
	 是否使用简化BOM：FISSIMPLIFYBOM 
	 考虑子项物料的生效日期：FConsiderEffeDate 
	 展示跳层件：FISSKIP 
	 考虑供料方式：FSupplyEntrust 
	 固定损耗：FCHKFIXSCRAP 
	 通用或报价BOM仅卷算标准工费：FNOSUPERPOSITIONPROCESS 
	 考虑发料方式：FSUPPLYISSUEMATERIAL 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CA_STDCOSTVERSION","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FVERSIONID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FModifyDate":"1900-01-01","FDescription":"","FISDEFAULT":"false","FCHKSTDHOUR":"false","FCHKLOSTRATE":"false","FCHKPRODRATE":"false","FFACTORS":"","FCHKRATEBYPRD":"false","FCHKRATEBYCC":"false","FISSIMPLIFYBOM":"false","FConsiderEffeDate":"false","FISSKIP":"false","FSupplyEntrust":"false","FCreateDate":"1900-01-01","FCHKFIXSCRAP":"false","FNOSUPERPOSITIONPROCESS":"false","FSUPPLYISSUEMATERIAL":"false"}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CA_STDCOSTVERSION","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CA_STDCOSTVERSION","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CA_STDCOSTVERSION","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CA_STDCOSTVERSION","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CA_STDCOSTVERSION","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CA_STDCOSTVERSION","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CA_STDCOSTVERSION"}");

...
client.Delete("BM_BUDGETCALENDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_BUDGETCALENDAR","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_BUDGETCALENDAR","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FAuditorId":{"FUserID":""},"FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FAuditDate":"1900-01-01","FBudgetCalendarType":"","FACId":{"FNUMBER":""},"FCycleSelectType":"","FYear":"false","FHALFOFYEAR":"false","FMONTH":"false","FSEASON":"false","FTENDAYS":"false","FDAYS":"false","FWEEKS":"false","FIsShowDay":"false","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FSTARTYEAR":"","FBudgetPeriodEntity":[{"FEntryID":0,"FRowID":"","FRowParentId":"","FRowType":"","FPeriodNumber":"","FPeriodName":"","FPeriodShortName":"","FPeriodType":"","FPeriodStartDate":"1900-01-01","FPeriodEndDate":"1900-01-01","FPeriodYear":0,"FPeriod":0}]}}");
...
单据头：FBillHead 
	 ...
	 禁用日期：FForbidDate 
	 审核日期：FAuditDate 
	 日历类型：FBudgetCalendarType  (必填项)
	 会计日历：FACId 
	 周起点：FCycleSelectType 
	 年：FYear 
	 半年：FHALFOFYEAR 
	 月：FMONTH 
	 季：FSEASON 
	 ...
	 结束日期：FEndDate 
	 起始年度：FSTARTYEAR  (必填项)
	 显示期间的开始结束日期：FIsShowDay 
预算期间：FBudgetPeriodEntity 
	 实体主键：FEntryID 
	 节点：FRowID 
	 父节点：FRowParentId 
	 节点类型：FRowType 
	 编码：FPeriodNumber 
	 名称：FPeriodName 
	 起始日期：FPeriodStartDate 
	 结束日期：FPeriodEndDate 
	 周期类型：FPeriodType 
	 年度：FPeriodYear 
	 期间：FPeriod 
	 短名称：FPeriodShortName 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_BUDGETCALENDAR","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FAuditorId":{"FUserID":""},"FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FAuditDate":"1900-01-01","FBudgetCalendarType":"","FACId":{"FNUMBER":""},"FCycleSelectType":"","FYear":"false","FHALFOFYEAR":"false","FMONTH":"false","FSEASON":"false","FTENDAYS":"false","FDAYS":"false","FWEEKS":"false","FIsShowDay":"false","FStartDate":"1900-01-01","FEndDate":"1900-01-01","FSTARTYEAR":"","FBudgetPeriodEntity":[{"FEntryID":0,"FRowID":"","FRowParentId":"","FRowType":"","FPeriodNumber":"","FPeriodName":"","FPeriodShortName":"","FPeriodType":"","FPeriodStartDate":"1900-01-01","FPeriodEndDate":"1900-01-01","FPeriodYear":0,"FPeriod":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BM_BUDGETCALENDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_BUDGETCALENDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_BUDGETCALENDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BUDGETCALENDAR","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_BUDGETCALENDAR","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BM_BUDGETCALENDAR","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BM_BUDGETCALENDAR","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_BUDGETCALENDAR"}");

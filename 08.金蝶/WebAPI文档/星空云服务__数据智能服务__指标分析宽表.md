# 指标分析宽表 Web API 操作原始内容

> 来源页面：全部 > 星空云服务 > 数据智能服务 > 指标分析宽表
...
client.Delete("PUR_WidthTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PUR_WidthTable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FWdomain":{"FOBJECTID":""},"FDescription":"","FCTableName":"","FWTABLE_1":"","FWTABLE_2":"","FOVERTIMECTL":"","FOpenAddData":"false","FMainTable":"","FParmaryKey":"","FSpikeDate":0,"FMainSplitDate":"","FAllUpRemarks":"","FOpenAllUpdata":"false","FLastExecData":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproveDate":"1900-01-01","FApproverId":{"FUserID":""},"FForbiderId":{"FUserID":""},"FForbidDate":"1900-01-01","FTableSQL":"","FSYS":"false","FVALIDITY":"","FIsExecute":"false","FWidthSourceEntry":[{"FEntryID":0,"FSourceType":"","FSourceWidthKey":{"FID":""},"FSourceName":"","FSOURSHOWNAME":"","FFilterString":"","FFilterStringKey":"","FSourceEntry":"","FSourceEntryKey":"","FTableName":"","FTableNameAs":"","FOwnerWhereString":"","FSOURCESQL":"","FWidthSourceSubEntry":[{"FDetailID":0,"FSourceScript":""}]}],"FUnionEntry":[{"FEntryID":0,"FWidthtableId":"","FWidthtablename":"","FWidthtablekey":""}],"FRelationEntry":[{"FEntryID":0,"FRelationS1":"","FRelationSKey1":"","FReSourceField1":"","FReSourceFieldKey1":"","FReLinkField1":"","FRelation":"","FRelationS2":"","FRelationSKey2":"","FReSourceField2":"","FReSourceFieldKey2":"","FLinkTable1":"","FLinkTable2":"","FReLinkField2":""}],"FWidthFieldEntry":[{"FEntryID":0,"FTableId":"","FFieldType":"","FFieldSource":"","FFieldSourcekey":"","FSourceField":"","FSourceFieldKey":"","FSourceFieldColumn":"","FSQLExpression":"","FFieldNameAs":"","FFieldTable":"","FFieldShow":"","FDataIsRepeat":"false"}],"FINFOLOGENTITY":[{"FEntryID":0,"FInfoNotes":"","FLogCreateDate":"1900-01-01"}],"FCreatIndexEntity":[{"FEntryID":0,"FWidthIndexField":"","FWidthIndexName":""}],"FWidthTableEntry":[{"FEntryID":0,"FTableScript":""}]}}");
...
单据头：FBillHead 
	 ...
	 表后缀：FWTABLE_2  (必填项)
	 是否预置：FSYS 
	 最后更新时间：FLastExecData 
	 有效性：FVALIDITY 
	 手动执行超时控制(秒)：FOVERTIMECTL 
	 启用增量计划：FOpenAddData 
	 增量主表：FMainTable 
	 主表主键：FParmaryKey 
	 时间戳字段：FMainSplitDate 
	 增量区间(天)：FSpikeDate 
	 全量更新备注：FAllUpRemarks 
	 启用全量更新：FOpenAllUpdata 
	 按执行计划执行：FIsExecute 
宽表数据源单据体 ：FWidthSourceEntry 
	 实体主键：FEntryID 
	 ...
	 表重命名：FTableNameAs 
	 过滤方案：FFilterString 
	 自定义过滤：FOwnerWhereString 
	 过滤方案key：FFilterStringKey 
	 数据源显示名称：FSOURSHOWNAME 
	 数据源SQL：FSOURCESQL  (必填项)
UNION：FUnionEntry 
	 实体主键：FEntryID 
	 宽表编码：FWidthtableId 
	 宽表名称：FWidthtablename 
	 宽表标识：FWidthtablekey 
关系：FRelationEntry 
	 实体主键：FEntryID 
	 数据源1：FRelationS1 
	 数据源1key：FRelationSKey1 
	 数据源关联字段1：FReSourceField1 
	 数据源关联字段key1：FReSourceFieldKey1 
	 数据源2：FRelationS2 
	 数据源2key：FRelationSKey2 
	 数据源关联字段2：FReSourceField2 
	 数据源关联字段key2：FReSourceFieldKey2 
	 表1：FLinkTable1 
	 物理表列名1：FReLinkField1 
	 表2：FLinkTable2 
	 物理表列名2：FReLinkField2 
	 连接关系：FRelation 
宽表字段：FWidthFieldEntry 
	 实体主键：FEntryID 
	 字段所属标识：FTableId 
	 字段类型：FFieldType 
	 数据源：FFieldSource 
	 数据源key：FFieldSourcekey 
	 [数据源]来源字段：FSourceField 
	 [数据源]列名key：FSourceFieldKey 
	 [数据源]列名：FSourceFieldColumn 
	 SQL表达式：FSQLExpression 
	 物理表列名：FFieldNameAs  (必填项)
	 字段所属表：FFieldTable 
	 唯一校验：FDataIsRepeat 
	 宽表字段名：FFieldShow  (必填项)
执行日志：FINFOLOGENTITY 
	 实体主键：FEntryID 
	 执行状态：FInfoStatus 
	 执行情况：FInfoNotes 
	 创建日期：FLogCreateDate 
索引维护：FCreatIndexEntity 
	 实体主键：FEntryID 
	 索引名称：FWidthIndexName 
	 索引字段：FWidthIndexField 
数据源子单据体：FWidthSourceSubEntry 
	 实体主键：FDetailID 
	 数据源脚本：FSourceScript 
宽表脚本单据体：FWidthTableEntry 
	 实体主键：FEntryID 
	 宽表脚本：FTableScript 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PUR_WidthTable","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FWdomain":{"FOBJECTID":""},"FDescription":"","FCTableName":"","FWTABLE_1":"","FWTABLE_2":"","FOVERTIMECTL":"","FOpenAddData":"false","FMainTable":"","FParmaryKey":"","FSpikeDate":0,"FMainSplitDate":"","FAllUpRemarks":"","FOpenAllUpdata":"false","FLastExecData":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproveDate":"1900-01-01","FApproverId":{"FUserID":""},"FForbiderId":{"FUserID":""},"FForbidDate":"1900-01-01","FTableSQL":"","FSYS":"false","FVALIDITY":"","FIsExecute":"false","FWidthSourceEntry":[{"FEntryID":0,"FSourceType":"","FSourceWidthKey":{"FID":""},"FSourceName":"","FSOURSHOWNAME":"","FFilterString":"","FFilterStringKey":"","FSourceEntry":"","FSourceEntryKey":"","FTableName":"","FTableNameAs":"","FOwnerWhereString":"","FSOURCESQL":"","FWidthSourceSubEntry":[{"FDetailID":0,"FSourceScript":""}]}],"FUnionEntry":[{"FEntryID":0,"FWidthtableId":"","FWidthtablename":"","FWidthtablekey":""}],"FRelationEntry":[{"FEntryID":0,"FRelationS1":"","FRelationSKey1":"","FReSourceField1":"","FReSourceFieldKey1":"","FReLinkField1":"","FRelation":"","FRelationS2":"","FRelationSKey2":"","FReSourceField2":"","FReSourceFieldKey2":"","FLinkTable1":"","FLinkTable2":"","FReLinkField2":""}],"FWidthFieldEntry":[{"FEntryID":0,"FTableId":"","FFieldType":"","FFieldSource":"","FFieldSourcekey":"","FSourceField":"","FSourceFieldKey":"","FSourceFieldColumn":"","FSQLExpression":"","FFieldNameAs":"","FFieldTable":"","FFieldShow":"","FDataIsRepeat":"false"}],"FINFOLOGENTITY":[{"FEntryID":0,"FInfoNotes":"","FLogCreateDate":"1900-01-01"}],"FCreatIndexEntity":[{"FEntryID":0,"FWidthIndexField":"","FWidthIndexName":""}],"FWidthTableEntry":[{"FEntryID":0,"FTableScript":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PUR_WidthTable","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PUR_WidthTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PUR_WidthTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PUR_WidthTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PUR_WidthTable","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.StatusConvert("PUR_WidthTable","StatusConvert","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PUR_WidthTable","NODisable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PUR_WidthTable"}");

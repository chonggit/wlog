# 条码自动归档方案 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 条码自动归档方案
...
client.View("UN_BarCodeArchiveScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_BarCodeArchiveScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FIsArchiveForbidBarcode":"false","FIsArchiveOutStock":"false","FArchiveMode":"","FOutStockDays":"","FCreateDays":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01"}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        "FID": 0,
        "FIsArchiveForbidBarcode": "false",
        "FIsArchiveOutStock": "false",
        "FArchiveMode": "",
        "FOutStockDays": "",
        "FCreateDays": "",
        "FCreatorId": {
...
单据头：FBillHead 
	 实体主键：FID 
	 归档已禁用的条码：FIsArchiveForbidBarcode 
	 归档已出库的条码：FIsArchiveOutStock 
	 归档方式：FArchiveMode 
	 按出库日期归档：FOutStockDate 
	 出库天数：FOutStockDays 
	 按创建日期归档：FBarcodeCreateDate 
	 创建天数：FCreateDays 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 修改人：FModifierId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("UN_BarCodeArchiveScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("UN_BarCodeArchiveScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_BarCodeArchiveScheme"}");

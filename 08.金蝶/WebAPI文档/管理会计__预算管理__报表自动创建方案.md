# 报表自动创建方案 Web API 操作原始内容

> 来源页面：全部 > 管理会计 > 预算管理 > 报表自动创建方案
...
client.Delete("BM_ActualRptScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BM_ActualRptScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BM_ActualRptScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FIsFromReport":"false","FIsFromBill":"false","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FEXCUTEPERIODTYPE":"","FIsReCalAuditReport":"false","FIsReCreateReport":"false","FIntervalMinute":"false","FIsCreateLastRpt":"false","FIsCreateMulRpt":"false","FIsReCalReport":"false","FExcPeriod":"","FFORBIDDERId":{"FUserID":""},"FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FForbidDate":"1900-01-01","FSchemeId":{"FNUMBER":""},"FGroup":{"FNumber":""},"FEXCUTETIME":"1900-01-01","FRPTStartDate":"1900-01-01","FRPTEndDate":"1900-01-01","FIsCreateCurRpt":"false","FRPTToNow":"false","FDeadLine":"1900-01-01","FAutoSubmitRPT":"false","FBeginDateTime":"1900-01-01","FIntervalValue":0,"FActualRPTSchemeEntry":[{"FEntryID":0,"FRptSample":{},"FRptOrgUnitId":{"FNUMBER":""},"FRPTCurrencyID":{"FNUMBER":""},"FDIMENSIONTYPEID":{"FNUMBER":""},"FPrimaryDimensionValue":"","FDIMENSIONID":0,"FASSISTANTID":"","FDimensionValueName":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDescription": "",
        "FEXCUTEPERIODTYPE": "",
        "FIsReCalAuditReport": "false",
        "FIsReCreateReport": "false",
        "FIntervalMinute": "false",
        "FIsCreateLastRpt": "false",
        "FIsCreateMulRpt": "false",
        "FIsReCalReport": "false",
        "FExcPeriod": "",
        "FFORBIDDERId": {
            "FUserID": ""
        },
        ...
        "FIsCreateCurRpt": "false",
        "FRPTToNow": "false",
        "FDeadLine": "1900-01-01",
        "FAutoSubmitRPT": "false",
        "FBeginDateTime": "1900-01-01",
        "FIntervalValue": 0,
        "FActualRPTSchemeEntry": [
            {
                "FEntryID": 0,
                "FRptSample": {},
                "FRptOrgUnitId": {
...
单据头：FBillHead 
	 ...
	 预算方案：FSchemeId  (必填项)
	 分组：FGroup 
	 实际数来源于实际数报表：FIsFromReport 
	 实际数来源于单据：FIsFromBill 
	 禁用人：FFORBIDDERId 
	 审核人：FAuditorID 
	 创建多期报表，时间范围：：FIsCreateMulRpt 
	 根据执行时间，创建上期报表：FIsCreateLastRpt 
	 报表已存在，重算现有报表：FIsReCalReport 
	 报表刷新期间：FExcPeriod  (必填项)
	 天：FEXCUTETIME 
	 报表已存在，覆盖现有报表：FIsReCreateReport 
	 执行周期：FEXCUTEPERIODTYPE  (必填项)
	 从：FRPTStartDate 
	 至：FRPTEndDate 
	 根据执行时间,，创建当期报表：FIsCreateCurRpt 
	 至现在：FRPTToNow 
	 截止时间：FDeadLine 
	 报表自动提交审核：FAutoSubmitRPT 
	 执行任务内码：FRefreshTaskID 
	 重算已审核报表：FIsReCalAuditReport 
	 执行间隔单位(分)：FIntervalMinute 
	 开始时间：FBeginDateTime 
	 每隔：FIntervalValue 
实际数报表：FActualRPTSchemeEntry 
	 实体主键：FEntryID 
	 实际数报表模板：FRptSample  (必填项)
	 预算组织类型：FRptOrgType 
	 币别：FRPTCurrencyID  (必填项)
	 周期类型：FRptPeriodType 
	 预算组织：FRptOrgUnitId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BM_ActualRptScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FIsFromReport":"false","FIsFromBill":"false","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FEXCUTEPERIODTYPE":"","FIsReCalAuditReport":"false","FIsReCreateReport":"false","FIntervalMinute":"false","FIsCreateLastRpt":"false","FIsCreateMulRpt":"false","FIsReCalReport":"false","FExcPeriod":"","FFORBIDDERId":{"FUserID":""},"FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FForbidDate":"1900-01-01","FSchemeId":{"FNUMBER":""},"FGroup":{"FNumber":""},"FEXCUTETIME":"1900-01-01","FRPTStartDate":"1900-01-01","FRPTEndDate":"1900-01-01","FIsCreateCurRpt":"false","FRPTToNow":"false","FDeadLine":"1900-01-01","FAutoSubmitRPT":"false","FBeginDateTime":"1900-01-01","FIntervalValue":0,"FActualRPTSchemeEntry":[{"FEntryID":0,"FRptSample":{},"FRptOrgUnitId":{"FNUMBER":""},"FRPTCurrencyID":{"FNUMBER":""},"FDIMENSIONTYPEID":{"FNUMBER":""},"FPrimaryDimensionValue":"","FDIMENSIONID":0,"FASSISTANTID":"","FDimensionValueName":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BM_ActualRptScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BM_ActualRptScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BM_ActualRptScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ActualRptScheme","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ActualRptScheme","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BM_ActualRptScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BM_ActualRptScheme","EnableEngine","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FNumber":"","FIsFromReport":"false","FIsFromBill":"false","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FEXCUTEPERIODTYPE":"","FIsReCalAuditReport":"false","FIsReCreateReport":"false","FIntervalMinute":"false","FIsCreateLastRpt":"false","FIsCreateMulRpt":"false","FIsReCalReport":"false","FExcPeriod":"","FFORBIDDERId":{"FUserID":""},"FAuditorID":{"FUserID":""},"FAuditDate":"1900-01-01","FForbidDate":"1900-01-01","FSchemeId":{"FNUMBER":""},"FGroup":{"FNumber":""},"FEXCUTETIME":"1900-01-01","FRPTStartDate":"1900-01-01","FRPTEndDate":"1900-01-01","FIsCreateCurRpt":"false","FRPTToNow":"false","FDeadLine":"1900-01-01","FAutoSubmitRPT":"false","FBeginDateTime":"1900-01-01","FIntervalValue":0,"FActualRPTSchemeEntry":[{"FEntryID":0,"FRptSample":{},"FRptOrgUnitId":{"FNUMBER":""},"FRPTCurrencyID":{"FNUMBER":""},"FDIMENSIONTYPEID":{"FNUMBER":""},"FPrimaryDimensionValue":"","FDIMENSIONID":0,"FASSISTANTID":"","FDimensionValueName":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BM_ActualRptScheme"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("BM_ActualRptScheme","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("BM_ActualRptScheme","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("BM_ActualRptScheme","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

# 工作日历设置 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 工程数据管理 > 工作日历设置
...
client.View("ENG_WorkCalCustom","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ENG_WorkCalCustom"}");

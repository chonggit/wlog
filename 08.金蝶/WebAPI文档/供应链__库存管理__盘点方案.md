...
client.Delete("STK_StockCountScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("STK_StockCountScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FName":"","FStockOrgId":{"FNumber":""},"FDocumentStatus":"","FNote":"","FCloseStatus":"","FCountType":"","FMoveBegDate":"1900-01-01","FBackUpDATE":"1900-01-01","FAllowAddMaterial":"false","FNotIncludeForbidMat":"false","FIgnoreBillCheck":"false","FZeroStockInCount":"false","FBZeroStockInCount":"false","FSZeroStockInCount":"false","FCheckQtyDefault":"","FOWnerTypeID":"","FOwnerId":{"FNumber":""},"FStockId":{"FNumber":""},"FMaterialId":{"FNumber":""},"FKeeperTypeId":"","FKeeperId":{"FNumber":""},"FStockIdTo":{"FNumber":""},"FMaterialIdTo":{"FNumber":""},"FMoveEndDate":"1900-01-01","FExcludeInTransInv":"false","FIncludeBlkGrpMat":"false","FBackUpType":"","FIncludeSubMatGroup":"false","FFilterItems":[{"FEntryID":0,"FFilterField":"","FCompareType":"","FLeftBracket":"","FLogic":"","FRightBracket":"","FValue":"","FFilterKey":""}],"FAssignBillEntity":[{"FEntryId":0,"FSepBillItemId":"","FSepBillItemEx":"","FDescription":""}],"FEntitySort":[{"FEntryID":0,"FSortItemId":"","FSortDirect":"","FSrcFieldNameSt":"","FTableNameSt":"","FTableRelationSt":""}],"FEntityMoveBill":[{"FEntryID":0,"FMBizFormID":{"FID":""},"FMBizBillTypeID":{"FNUMBER":""}}],"FEntityMatRange":[{"FEntryID":0,"FRgMaterialId":{"FNUMBER":""}}],"FEntityMatGroupRange":[{"FEntryID":0,"FRgMaterialGroupId":{"FNumber":""},"FRgSMaterialGroupId":""}],"FEntityMoveStock":[{"FEntryID":0,"FMvStockId":{"FNUMBER":""}}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FCloseStatus": "",
        "FCountType": "",
        "FMoveBegDate": "1900-01-01",
        "FBackUpDATE": "1900-01-01",
        "FAllowAddMaterial": "false",
        "FNotIncludeForbidMat": "false",
        "FIgnoreBillCheck": "false",
        ...
        "FMoveEndDate": "1900-01-01",
        "FExcludeInTransInv": "false",
        "FIncludeBlkGrpMat": "false",
        "FBackUpType": "",
        "FIncludeSubMatGroup": "false",
        "FFilterItems": [
            {
                "FEntryID": 0,
                "FFilterField": "",
...
基本信息：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 关闭状态：FCloseStatus  (必填项)
	 过滤条件结果：FFilterString 
	 过滤表格设置：FFilterSetting 
	 备注：FNote 
	 货主类型：FOWnerTypeID 
	 货主：FOwnerId 
	 保管者类型：FKeeperTypeId 
	 ...
	 忽略库存单据审核状态检查：FIgnoreBillCheck 
	 基本单位库存量为零，库存辅单位库存量不为零，参与盘点：FBZeroStockInCount 
	 基本单位库存量不为零，库存辅单位库存量为零，参与盘点：FSZeroStockInCount 
	 动盘开始日期：FMoveBegDate 
	 盘点类型：FCountType  (必填项)
	 动盘结束日期：FMoveEndDate 
	 包含下级物料分组：FIncludeSubMatGroup 
	 生成盘盈或盘亏单：FUpdateStock 
	 序列号默认为盘亏状态：FGenLossSN 
	 在途物料不参与盘点：FExcludeInTransInv 
	 包含物料分组为空的物料：FIncludeBlkGrpMat 
过滤项目：FFilterItems 
	 实体主键：FEntryID 
	 过滤字段：FFilterField 
	 比较类型：FCompareType  (必填项)
	 左括弧：FLeftBracket 
	 连接逻辑符：FLogic 
	 右括弧：FRightBracket 
	 比较值：FValue 
	 过滤字段Key：FFilterKey 
分单规则：FAssignBillEntity 
	 实体主键：FEntryId 
	 分单依据：FSepBillItemId 
	 分单依据扩展信息：FSepBillItemEx 
	 备注：FDescription 
	 源表字段名：FSrcFieldName 
	 表名：FTableName 
	 表关联信息：FTableRelation 
排序规则：FEntitySort 
	 实体主键：FEntryID 
	 排序字段：FSortItemId  (必填项)
	 排序方式：FSortDirect  (必填项)
	 来源字段：FSrcFieldNameSt 
	 表名：FTableNameSt 
	 表关联信息：FTableRelationSt 
动盘单据范围：FEntityMoveBill 
	 实体主键：FEntryID 
	 单据名称：FMBizFormID  (必填项)
	 单据类型：FMBizBillTypeID 
物料范围_物料：FEntityMatRange 
	 实体主键：FEntryID 
	 物料编码：FRgMaterialId 
	 物料名称：FRgMaterialName 
	 规格型号：FRgMaterialModel 
物料范围_物料分组：FEntityMatGroupRange 
	 实体主键：FEntryID 
	 物料分组：FRgMaterialGroupName 
	 物料分组编码：FRgMaterialGroupId 
	 物料分组内码(文本)：FRgSMaterialGroupId 
动盘仓库范围：FEntityMoveStock 
	 实体主键：FEntryID 
	 仓库编码：FMvStockId  (必填项)
	 仓库名称：FMvStockname 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("STK_StockCountScheme","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeID":{"FNUMBER":""},"FBillNo":"","FName":"","FStockOrgId":{"FNumber":""},"FDocumentStatus":"","FNote":"","FCloseStatus":"","FCountType":"","FMoveBegDate":"1900-01-01","FBackUpDATE":"1900-01-01","FAllowAddMaterial":"false","FNotIncludeForbidMat":"false","FIgnoreBillCheck":"false","FZeroStockInCount":"false","FBZeroStockInCount":"false","FSZeroStockInCount":"false","FCheckQtyDefault":"","FOWnerTypeID":"","FOwnerId":{"FNumber":""},"FStockId":{"FNumber":""},"FMaterialId":{"FNumber":""},"FKeeperTypeId":"","FKeeperId":{"FNumber":""},"FStockIdTo":{"FNumber":""},"FMaterialIdTo":{"FNumber":""},"FMoveEndDate":"1900-01-01","FExcludeInTransInv":"false","FIncludeBlkGrpMat":"false","FBackUpType":"","FIncludeSubMatGroup":"false","FFilterItems":[{"FEntryID":0,"FFilterField":"","FCompareType":"","FLeftBracket":"","FLogic":"","FRightBracket":"","FValue":"","FFilterKey":""}],"FAssignBillEntity":[{"FEntryId":0,"FSepBillItemId":"","FSepBillItemEx":"","FDescription":""}],"FEntitySort":[{"FEntryID":0,"FSortItemId":"","FSortDirect":"","FSrcFieldNameSt":"","FTableNameSt":"","FTableRelationSt":""}],"FEntityMoveBill":[{"FEntryID":0,"FMBizFormID":{"FID":""},"FMBizBillTypeID":{"FNUMBER":""}}],"FEntityMatRange":[{"FEntryID":0,"FRgMaterialId":{"FNUMBER":""}}],"FEntityMatGroupRange":[{"FEntryID":0,"FRgMaterialGroupId":{"FNumber":""},"FRgSMaterialGroupId":""}],"FEntityMoveStock":[{"FEntryID":0,"FMvStockId":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("STK_StockCountScheme","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("STK_StockCountScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("STK_StockCountScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("STK_StockCountScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("STK_StockCountScheme","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("STK_StockCountScheme","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"STK_StockCountScheme"}");

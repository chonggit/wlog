...
client.Delete("ECC_Shop","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ECC_Shop","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ECC_Shop","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FDescription":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FSaleOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FShopType":"","FShopName":"","FShopCustomerCode":"","FLogisticsFilterByStockOrg":"false","FLogisticsFilterByNetShop":"false","FLogisticsFilterByAreaScope":"false","FLogisticsFilterByMatScope":"false","FLogisticsFilterByFare":"false","FToken":"","FEnterAddress":"","FStartDate":"1900-01-01","FSettlementCurrency":{"FNUMBER":""},"FCustomerId":{"FNUMBER":""},"FSettlementOrgId":{"FNumber":""},"FIsOneSMSNotice":"false","FDownloadByGY":"false","FIsSMSNotice":"false","FEnableDown":"false","FIsTBYZShop":"false","FServiceMaterialID":{"FNUMBER":""},"FServiceMaterial":{"FNUMBER":""},"FNick":"","FTBYZJoinNetShopId":{"FNUMBER":""},"FLSBranch":{"FNumber":""},"FGYShopType":"","FGYModifyDate":"1900-01-01","FShopStock":[{"FEntryID":0,"FLevel":0,"FIsEnable":"false","FStockOrgId":{"FNumber":""},"FStockId":{"FNumber":""},"FEnableInvSync":"false","FTransType":"","FSyncPercent":0,"FSenderName":"","FCompanyName":"","FSenderAddress":"","FTelephone":"","FZipCode":"","FIsSupportCarry":"false","FCarryAddress":{"FNUMBER":""},"FSendAddress":{"FNUMBER":""},"FReturnAddress":{"FNUMBER":""}}],"FEntityMD":[{"FEntryID":0,"FMDChannel":{"FNUMBER":""},"FEnableSyn":"false","FSynRate":0}],"FEntityWB":[{"FEntryID":0,"FWBChannel":{"FNUMBER":""},"FWBKeepInvQty":0}],"FEntityGYS":[{"FEntryID":0,"FGYSKeepInvQty":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FShopName": "",
        "FShopCustomerCode": "",
        "FLogisticsFilterByStockOrg": "false",
        "FLogisticsFilterByNetShop": "false",
        "FLogisticsFilterByAreaScope": "false",
        "FLogisticsFilterByMatScope": "false",
        "FLogisticsFilterByFare": "false",
        "FToken": "",
        "FEnterAddress": "",
...
单据头：FBillHead 
	 ...
	 接入网址：FEnterAddress 
	 开通时间：FStartDate 
	 对应客户：FCustomerId  (必填项)
	 结算币别：FSettlementCurrency  (必填项)
	 对应结算组织：FSettlementOrgId  (必填项)
	 启用下载：FEnableDown 
	 默认菜鸟接入网店：FIsTBYZShop 
	 京东快递店铺商家编码：FShopCustomerCode 
	 对应运费物料：FServiceMaterialID  (必填项)
	 按库存组织匹配物流公司：FLogisticsFilterByStockOrg 
	 按网店匹配物流公司：FLogisticsFilterByNetShop 
	 按配送区域范围匹配物流公司：FLogisticsFilterByAreaScope 
	 按配送物料范围匹配物流公司：FLogisticsFilterByMatScope 
	 按最小运费匹配物流公司：FLogisticsFilterByFare 
	 收付款组织：FBillOrgID 
	 昵称：FNick 
	 菜鸟面单接入网店：FTBYZJoinNetShopId 
	 对应服务物料：FServiceMaterial 
	 门店信息：FLSBranch 
	 管易对接网店：FDownloadByGY 
	 管易网店类型：FGYShopType 
	 管易网店修改日期：FGYModifyDate 
	 生成出库单短信通知收货人：FIsSMSNotice 
	 拆分发货仅发一次短信通知：FIsOneSMSNotice 
配送网络：FShopStock 
	 实体主键：FEntryID 
	 库存组织：FStockOrgId 
	 仓库：FStockId 
	 启用库存同步：FEnableInvSync 
	 同步比例：FSyncPercent 
	 发件人信息&名称：FSenderName 
	 发件人信息&单位名称：FCompanyName 
	 发件人信息&寄件地址：FSenderAddress 
	 发件人信息&联系电话：FTelephone 
	 发件人信息&邮政编码：FZipCode 
	 支持自提：FIsSupportCarry 
	 自提地址：FCarryAddress 
	 发货地址：FSendAddress 
	 退货地址：FReturnAddress 
	 启用：FIsEnable 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ECC_Shop","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FDescription":"","FName":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FSaleOrgId":{"FNumber":""},"FCreateOrgId":{"FNumber":""},"FShopType":"","FShopName":"","FShopCustomerCode":"","FLogisticsFilterByStockOrg":"false","FLogisticsFilterByNetShop":"false","FLogisticsFilterByAreaScope":"false","FLogisticsFilterByMatScope":"false","FLogisticsFilterByFare":"false","FToken":"","FEnterAddress":"","FStartDate":"1900-01-01","FSettlementCurrency":{"FNUMBER":""},"FCustomerId":{"FNUMBER":""},"FSettlementOrgId":{"FNumber":""},"FIsOneSMSNotice":"false","FDownloadByGY":"false","FIsSMSNotice":"false","FEnableDown":"false","FIsTBYZShop":"false","FServiceMaterialID":{"FNUMBER":""},"FServiceMaterial":{"FNUMBER":""},"FNick":"","FTBYZJoinNetShopId":{"FNUMBER":""},"FLSBranch":{"FNumber":""},"FGYShopType":"","FGYModifyDate":"1900-01-01","FShopStock":[{"FEntryID":0,"FLevel":0,"FIsEnable":"false","FStockOrgId":{"FNumber":""},"FStockId":{"FNumber":""},"FEnableInvSync":"false","FTransType":"","FSyncPercent":0,"FSenderName":"","FCompanyName":"","FSenderAddress":"","FTelephone":"","FZipCode":"","FIsSupportCarry":"false","FCarryAddress":{"FNUMBER":""},"FSendAddress":{"FNUMBER":""},"FReturnAddress":{"FNUMBER":""}}],"FEntityMD":[{"FEntryID":0,"FMDChannel":{"FNUMBER":""},"FEnableSyn":"false","FSynRate":0}],"FEntityWB":[{"FEntryID":0,"FWBChannel":{"FNUMBER":""},"FWBKeepInvQty":0}],"FEntityGYS":[{"FEntryID":0,"FGYSKeepInvQty":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ECC_Shop","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ECC_Shop","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ECC_Shop","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ECC_Shop","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ECC_Shop","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ECC_Shop","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ECC_Shop"}");

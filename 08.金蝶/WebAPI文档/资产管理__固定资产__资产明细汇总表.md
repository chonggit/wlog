# 资产明细汇总表 Web API 操作原始内容

> 来源页面：全部 > 资产管理 > 固定资产 > 资产明细汇总表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 1652 |
...
client.GetSysReportData("890d9854-c490-45b6-9a16-650c376c3523","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{}}");

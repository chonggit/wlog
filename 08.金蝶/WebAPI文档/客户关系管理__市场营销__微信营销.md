...
client.Delete("CRM_WeixinMarketing","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRM_WeixinMarketing","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FMarketType":{"FNumber":""},"FEndTime":"1900-01-01","FStartTime":"1900-01-01","FAutoStart":"false","FAutoEnd":"false","FMarketChannel":{"FNumber":""},"FMarketRegion":"","FPotentialClueCount":0,"FPotentialOppCount":0,"FTransferdCustCount":0,"FReadCount":0,"FPotentialCustCount":0,"FTransmitCount":0,"FEmpAttentionCount":0,"FNEmpAttentionCount":0,"FForcastDealAmount":0,"FActDealAmount":0,"FClueRate":0,"FMaterial":{"FNUMBER":""},"FIsPermanent":"false","FPromotionDate":"1900-01-01","FIsIntention":"false","FSaleOrgId":{"FNumber":""},"FSALEDEPTID":{"FNUMBER":""},"FBEmpID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FContact":{"FNUMBER":""}}],"FCRMAllocation":[{"FCooperationType":"","FEmployee":{"FSTAFFNUMBER":""},"FDept":{"FNUMBER":""},"FRead":"false","FModify":"false","FDelete":"false","FAllocation":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FTransmitCount": 0,
        "FEmpAttentionCount": 0,
        "FNEmpAttentionCount": 0,
...
单据头：FBillHead 
	 ...
	 阅读数：FReadCount 
	 转发数：FTransmitCount 
	 关注数(职员)：FEmpAttentionCount 
	 关注数(非职员)：FNEmpAttentionCount 
	 潜在客户数：FPotentialCustCount 
	 潜在商机数：FPotentialOppCount 
	 潜在线索数：FPotentialClueCount 
	 转交易客户数：FTransferdCustCount 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRM_WeixinMarketing","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FName":"","FMarketType":{"FNumber":""},"FEndTime":"1900-01-01","FStartTime":"1900-01-01","FAutoStart":"false","FAutoEnd":"false","FMarketChannel":{"FNumber":""},"FMarketRegion":"","FPotentialClueCount":0,"FPotentialOppCount":0,"FTransferdCustCount":0,"FReadCount":0,"FPotentialCustCount":0,"FTransmitCount":0,"FEmpAttentionCount":0,"FNEmpAttentionCount":0,"FForcastDealAmount":0,"FActDealAmount":0,"FClueRate":0,"FMaterial":{"FNUMBER":""},"FIsPermanent":"false","FPromotionDate":"1900-01-01","FIsIntention":"false","FSaleOrgId":{"FNumber":""},"FSALEDEPTID":{"FNUMBER":""},"FBEmpID":{"FNUMBER":""},"FEntity":[{"FEntryID":0,"FContact":{"FNUMBER":""}}],"FCRMAllocation":[{"FCooperationType":"","FEmployee":{"FSTAFFNUMBER":""},"FDept":{"FNUMBER":""},"FRead":"false","FModify":"false","FDelete":"false","FAllocation":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRM_WeixinMarketing","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CRM_WeixinMarketing","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CRM_WeixinMarketing","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CRM_WeixinMarketing","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CRM_WeixinMarketing","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CRM_WeixinMarketing","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRM_WeixinMarketing"}");

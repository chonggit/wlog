# 自定义费用分配标准值维护 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 自定义费用分配标准值维护
...
client.View("CB_ALLOCSTANDARDDATA","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_ALLOCSTANDARDDATA","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FBillNo":"","FYEAR":0,"FPERIOD":0,"FEntity":[{"FEntryID":0,"FSTANDARDID":{"FNumber":""},"FCOSTCENTERID":{"FNumber":""},"FWORKACTIVEID":{"FNumber":""},"FQTY":0,"FPROORDERTYPE":"","FPROORDERENTRYID":0,"FPROORDERNO":"","FPROORDERSEQ":0,"FPROORDERSTATUS":"","FPRODUCTID":{"FNumber":""},"FFORMID":"","F_XCKF_SrcBillId":"","F_XCKF_SrcEntryId":""}]}}");
...
单据体：FEntity 
	 ...
	 工单行号：FPROORDERSEQ 
	 生产车间：FWORKSHOPID 
	 工单分录内码：FPROORDERENTRYID 
	 分配标准：FSTANDARDID  (必填项)
	 ...
	 计量单位：FUNITID 
	 数量：FQTY 
	 适用范围：FallocDataScope 
	 单据类型：FBILLTYPEID 
	 业务状态：FPROORDERSTATUS 
	 单据来源标识：FFORMID 
	 源单内码：F_XCKF_SrcBillId 
	 源单分录内码：F_XCKF_SrcEntryId 
关联关系表：FEntity_Link 
	 实体主键：FLinkId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("CB_ALLOCSTANDARDDATA","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_ALLOCSTANDARDDATA","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FBillNo":"","FYEAR":0,"FPERIOD":0,"FEntity":[{"FEntryID":0,"FSTANDARDID":{"FNumber":""},"FCOSTCENTERID":{"FNumber":""},"FWORKACTIVEID":{"FNumber":""},"FQTY":0,"FPROORDERTYPE":"","FPROORDERENTRYID":0,"FPROORDERNO":"","FPROORDERSEQ":0,"FPROORDERSTATUS":"","FPRODUCTID":{"FNumber":""},"FFORMID":"","F_XCKF_SrcBillId":"","F_XCKF_SrcEntryId":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_ALLOCSTANDARDDATA","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_ALLOCSTANDARDDATA"}");

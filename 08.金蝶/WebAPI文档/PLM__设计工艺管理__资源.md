...
client.Delete("PLM_ENG_RESOURCE","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLM_ENG_RESOURCE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PLM_ENG_RESOURCE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FNumber":"","FUseOrgId":{"FNumber":""},"FName":"","FRSRCCategory":"","FQty":0,"FUnitID":{"FNumber":""},"FEffectDate":"1900-01-01","FExpireDate":"1900-01-01","FIsShareRsc":"false","FDescription":"","FIsCalcCapacity":"false","FCapaUnitType":"","FCapacityUnitID":{"FNumber":""},"FEfficiency":0,"FIsSetWorCal":"false","FIsOneselfRsrc":"false","FIsLimitedCap":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FProcessId":{"FNUMBER":""},"FCapaExceptionEntity":[{"FEntryID":0,"FBgDate":"1900-01-01","FEndDate":"1900-01-01","FRsrcQty":0,"FExcptEfficient":0,"FExcptRemark":""}],"FResourceDetailEntry":[{"FEntryID":0,"FResourceTypeId":"","FResId":{"FNumber":""},"FResName":"","FIsForbidden":"false","FGroupId":0,"FPrdSeq":0,"FIsAgentReport":"false"}],"FEntityRelatedObject":[{"FEntryID":0,"FBaseObjId":{"FCODE":""},"FIcon":"","FBaseLifeCircleStage":""}],"FToolEntity":[{"FEntryID":0,"FToolCode":{"FCODE":""}}]}}");
        ...
        "FResourceDetailEntry": [
            {
                ...
                "FGroupId": 0,
                "FPrdSeq": 0,
                "FIsAgentReport": "false"
            }
        ],
        "FEntityRelatedObject": [
            {
                "FEntryID": 0,
                "FBaseObjId": {
                    "FCODE": ""
...
单据头：FBillHead 
	 ...
	 资源数量：FQty 
	 工作中心共享：FIsShareRsc 
	 资源类别：FRSRCCategory  (必填项)
	 数量单位：FUnitID  (必填项)
	 生效日期：FEffectDate  (必填项)
	 失效日期：FExpireDate  (必填项)
	 计算能力：FIsCalcCapacity 
	 能力单位：FCapacityUnitID 
	 利用率%：FEfficiency 
	 按有限产能排产：FIsLimitedCap 
	 独占资源：FIsOneselfRsrc 
	 已设置工作日历：FIsSetWorCal 
	 能力单位类别：FCapaUnitType 
	 作业：FProcessId 
能力例外：FCapaExceptionEntity 
	 实体主键：FEntryID 
	 起始日期：FBgDate 
	 结束日期：FEndDate 
	 效率：FExcptEfficient 
	 备注：FExcptRemark 
	 资源数量：FRsrcQty 
资源明细：FResourceDetailEntry 
	 实体主键：FEntryID 
	 编码：FResId  (必填项)
	 资源类别：FResourceTypeId  (必填项)
	 名称：FResName 
	 禁用：FIsForbidden 
	 名称：FResourceName 
	 组别：FGroupId 
	 生产顺序：FPrdSeq 
	 代理报工：FIsAgentReport 
相关资源单据体：FEntityRelatedObject 
	 实体主键：FEntryID 
	 相关资料：FBaseObjId 
	 图标：FIcon 
	 资料编码：FBaseCode 
	 业务类型：FBaseCategoryID 
	 生命周期阶段：FBaseLifeCircleStage 
	 创建人：FBaseCreatorId 
	 版本号：FBaseVerNO 
	 版次：FBaseBuildVer 
	 文件夹：FBaseFolderID 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PLM_ENG_RESOURCE","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PLM_ENG_RESOURCE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PLM_ENG_RESOURCE","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PLM_ENG_RESOURCE","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("PLM_ENG_RESOURCE","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_ENG_RESOURCE"}");

# 物料分销特性 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 要补货管理 > 物料分销特性
...
| 切换组织 | SwitchOrg | 1031 |
| 分组保存 | GroupSave | 1467 |
| 分组信息查询 | QueryGroupInfo | 1180 |
| 分组删除 | GroupDelete | 1080 |
...
client.Delete("DRP_MatExtendList","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("DRP_MatExtendList","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("DRP_MatExtendList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FMATERIALID":0,"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FNumber":"","FName":"","FSpecification":"","FDescription":"","FMaterialGroup":{"FNumber":""},"SubHeadEntity":{"FEntryId":0,"FBaseUnitId":{"FNumber":""}},"SubHeadEntity1":{"FEntryId":0,"FStoreUnitID":{"FNumber":""}},"SubHeadEntity2":{"FEntryId":0,"FSaleUnitId":{"FNumber":""}},"SubHeadEntity6":{"FEntryId":0,"FSafeStock":0,"FMaxStock":0,"FReOrderGood":0,"FMaxQty":0,"FMinQty":0,"FReOrderQty":0,"FAvgDayOrderQty":0,"FReOrderIntervalTime":0,"FReOrderLeadDays":0,"FReOrderModeId":{"FNAME":""},"FReOrderPlanId":{"FNUMBER":""},"FBaseAvgDayOrderQty":0,"FBaseMinQty":0,"FBaseMaxQty":0,"FBaseMaxStock":0,"FBaseReOrderQty":0,"FBaseSafeStock":0,"FBaseReOrderGood":0}}}");
...
分销：SubHeadEntity6 
	 ...
	 最小批量：FMinQty 
	 要补货批量：FReOrderQty 
	 日平均销量：FAvgDayOrderQty 
	 运输提前期：FReOrderLeadDays 
	 要补货周期：FReOrderIntervalTime 
	 补货模式：FReOrderModeId 
	 要补货方案：FReOrderPlanId 
	 基本单位日平均销量：FBaseAvgDayOrderQty 
	 基本单位要补货批量：FBaseReOrderQty 
	 基本单位最小批量：FBaseMinQty 
	 基本单位最大批量：FBaseMaxQty 
	 基本单位安全库存：FBaseSafeStock 
	 基本单位再补货点：FBaseReOrderGood 
	 基本单位最大库存：FBaseMaxStock 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("DRP_MatExtendList","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FMATERIALID":0,"FCreateOrgId":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FNumber":"","FName":"","FSpecification":"","FDescription":"","FMaterialGroup":{"FNumber":""},"SubHeadEntity":{"FEntryId":0,"FBaseUnitId":{"FNumber":""}},"SubHeadEntity1":{"FEntryId":0,"FStoreUnitID":{"FNumber":""}},"SubHeadEntity2":{"FEntryId":0,"FSaleUnitId":{"FNumber":""}},"SubHeadEntity6":{"FEntryId":0,"FSafeStock":0,"FMaxStock":0,"FReOrderGood":0,"FMaxQty":0,"FMinQty":0,"FReOrderQty":0,"FAvgDayOrderQty":0,"FReOrderIntervalTime":0,"FReOrderLeadDays":0,"FReOrderModeId":{"FNAME":""},"FReOrderPlanId":{"FNUMBER":""},"FBaseAvgDayOrderQty":0,"FBaseMinQty":0,"FBaseMaxQty":0,"FBaseMaxStock":0,"FBaseReOrderQty":0,"FBaseSafeStock":0,"FBaseReOrderGood":0}}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("DRP_MatExtendList","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("DRP_MatExtendList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("DRP_MatExtendList","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_MatExtendList","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("DRP_MatExtendList","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("DRP_MatExtendList","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Allocate("DRP_MatExtendList","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAllocate("DRP_MatExtendList","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("DRP_MatExtendList","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"DRP_MatExtendList"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupSave("DRP_MatExtendList","{"GroupFieldKey":"","GroupPkId":0,"FParentId":0,"FNumber":"","FName":"","FDescription":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryGroupInfo("DRP_MatExtendList","{"FormId":"","GroupFieldKey":"","GroupPkIds":"","Ids":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.GroupDelete("DRP_MatExtendList","{"FormId":"","GroupFieldKey":"","GroupPkIds":""}");

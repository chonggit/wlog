# 条码盘点设置 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 条码管理 > 条码盘点设置
...
client.Delete("UN_StockTakeSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("UN_StockTakeSetting","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("UN_StockTakeSetting","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FNumber":"","FName":"","FOrgId":{"FNumber":""},"FCodeAnalyzeGetValCtrl":"","FGainScanCtrl":"","FCodeRepeatScanCtrl":"","FSerialNoSource":"","FUpdateBarMainQty":"","FPackageCodeRepeatScanCtrl":"","FFieldEntity":[{"FEntryID":"","FFieldKey":"","FFieldTitle":"","FIsMatch":"false","FIsEdit":"false","FIndex1":0,"FPackCodeGetValRule":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FCodeAnalyzeGetValCtrl": "",
        "FGainScanCtrl": "",
        "FCodeRepeatScanCtrl": "",
        "FSerialNoSource": "",
        "FUpdateBarMainQty": "",
        "FPackageCodeRepeatScanCtrl": "",
        "FFieldEntity": [
            {
                "FEntryID": "",
                "FFieldKey": "",
...
单据头：FBillHead 
	 ...
	 编码：FNumber 
	 组织：FOrgId  (必填项)
	 条码解析取值控制：FCodeAnalyzeGetValCtrl 
	 新增物料分录控制：FGainScanCtrl 
	 条码重复扫描控制：FCodeRepeatScanCtrl 
	 序列号来源：FSerialNoSource 
	 更新条码主档数量控制：FUpdateBarMainQty 
	 包装条码重复扫描控制：FPackageCodeRepeatScanCtrl 
单据体：FFieldEntity 
	 实体主键：FEntryID 
	 字段标识：FFieldKey 
	 字段名称：FFieldTitle 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("UN_StockTakeSetting","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":"","FNumber":"","FName":"","FOrgId":{"FNumber":""},"FCodeAnalyzeGetValCtrl":"","FGainScanCtrl":"","FCodeRepeatScanCtrl":"","FSerialNoSource":"","FUpdateBarMainQty":"","FPackageCodeRepeatScanCtrl":"","FFieldEntity":[{"FEntryID":"","FFieldKey":"","FFieldTitle":"","FIsMatch":"false","FIsEdit":"false","FIndex1":0,"FPackCodeGetValRule":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("UN_StockTakeSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("UN_StockTakeSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("UN_StockTakeSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_StockTakeSetting","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("UN_StockTakeSetting","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("UN_StockTakeSetting","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"UN_StockTakeSetting"}");

# 现金流量表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 总账 > 现金流量表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2806 |
...
client.GetSysReportData("GL_Rpt_CashFlow","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FACCTBOOKID":{"FNumber":""},"FCURRENCYID":"","FSumLevel":"","FByPeriod":"","FByDate":"","FSTARTYEAR":"","FSTARTPERIOD":"","FENDYEAR":"","FENDPERIOD":"","FSTARTDATE":"1900-01-01","FENDDATE":"1900-01-01","FIncNotPost":"false","FShowRateDetail":"false","FCBFORBIDITEM":"false","FFindType":""}}");

# 人员工时分析表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 人员工时分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2873 |
...
client.GetSysReportData("SFC_ManHourSwotRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FRadioBeforeMonth":"","FRadioCurrMonth":"","FRadioSeason":"","FRadioYear":"","FBeginCountDate":"1900-01-01","FEndCountDate":"1900-01-01","FCountDateGroup":"","FStaff":[{"FStaffNumber":""}],"FPrdShop":[{"FNumber":""}],"FPrdOrgId":[{"FNumber":""}]}}");
...
参数FieldKeys显示列：
	 ...
	 操作工：FStaffName 
	 产品工时：FProductHour 
	 非产品工时：FUnProductHour 
	 出勤工时：FAttendanceHour 
	 加班工时：FOverTime 
	 异常工时：FAbnormalHour 
	 生产投入效率：FPrdInEfficiency 
	 制造效率：FManuEfficiency 
	 异常占比：FAnomalyRatio 

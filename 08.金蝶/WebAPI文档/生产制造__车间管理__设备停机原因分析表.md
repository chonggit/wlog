# 设备停机原因分析表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 车间管理 > 设备停机原因分析表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2606 |
...
client.GetSysReportData("SFC_ExcepCloseDownAnaly","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FCountDateGroup":"","FRadioBeforeMonth":"","FRadioCurrMonth":"","FRadioSeason":"","FRadioYear":"","FBeginCountDate":"1900-01-01","FEndCountDate":"1900-01-01","FProcessOrgId":[{"FNumber":""}],"FEquipmentId":[{"FNumber":""}]}}");
...
参数FieldKeys显示列：
	 ...
	 设备编码：FEquipmentNumber 
	 设备名称：FEquipmentName 
	 日期：FDate 
	 停机时长（分）：FCloseDownTime 

# 工序交收表 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 工序交收表
...
client.Delete("QRDO_ProcessDelivery","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QRDO_ProcessDelivery","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FUseOrgID":{"FNumber":""},"FProDeyID":"","FEntity":[{"FEntryID":0,"FProcessId":"","FDocDate":"1900-01-01","FDocNo":"","FDispatchQtyDate":"1900-01-01","FDispatchQty":0,"FCompletedQtyDate":"1900-01-01","FCompletedQty":0,"FcWhCode":"","FcWhName":"","FcInvCode":{"FNUMBER":""},"FProductionStd":"","FMainTU":"","FProductionTu":"","FMaterialsBatch":"","FMaterials":"","FBatchQty":0,"FVer":"","FFtStatus":"","FFurnaceNo":"","FMaterialCode":{"FNUMBER":""},"FOutNo":"","FPackingMethod":"","FMaterialSource":"","FIsModelFT":"","FRemarks":"","FProiRow":"","FCustomName":"","FNetWeight":0,"FStdPackingQuantity":0,"FStdPackingBoxBagsQty":0,"FNotificationMaterials":"","FProcessEntryID":"","FExpenseItem":"","FJobSequence":"","FProcessName":"","FProdDept":"","FMachineNo":"","FProcessDate":"1900-01-01","FShift":"","FStaffInCharge":"","FBadQty":0,"FLoseQty":0,"FScrappedQty":0,"FDelivery":0,"FPEQty":0,"FRemark":"","FQCQty":0,"FQCJudgment":"","FIsCompletionMonitored":"","FProcessingConditions":"","FLeadDays":0,"FProcessingParameters":"","FHotFurnaceNo":"","FCycleTime":"","FTotalCycleTime":0}]}}");
        ...
        "FEntity": [
            {
                ...
                "FDocDate": "1900-01-01",
                "FDocNo": "",
                "FDispatchQtyDate": "1900-01-01",
                "FDispatchQty": 0,
                "FCompletedQtyDate": "1900-01-01",
                "FCompletedQty": 0,
                "FcWhCode": "",
                "FcWhName": "",
                "FcInvCode": {
                ...
                "FCustomName": "",
                "FNetWeight": 0,
                "FStdPackingQuantity": 0,
                "FStdPackingBoxBagsQty": 0,
                "FNotificationMaterials": "",
                "FProcessEntryID": "",
                "FExpenseItem": "",
                "FJobSequence": "",
                "FProcessName": "",
                ...
                "FQCQty": 0,
                "FQCJudgment": "",
                "FIsCompletionMonitored": "",
                "FProcessingConditions": "",
                "FLeadDays": 0,
...
单据头：FBillHead 
	 ...
	 审核日期：FApproveDate 
	 使用组织：FUseOrgID  (必填项)
	 工序交收唯一码：FProDeyID  (必填项)
单据体：FEntity 
	 实体主键：FEntryID 
	 表头主键：FProcessId 
	 随工单日期：FDocDate 
	 随工单号：FDocNo 
	 激活日期：FDispatchQtyDate 
	 激活数量：FDispatchQty 
	 完工日期：FCompletedQtyDate 
	 完工数量：FCompletedQty 
	 仓库编码：FcWhCode 
	 仓库名称：FcWhName 
	 零件编码：FcInvCode  (必填项)
	 ...
	 生产订单号：FOutNo 
	 包装方式：FPackingMethod 
	 材料来源：FMaterialSource 
	 是否样板：FIsModelFT 
	 备注：FRemarks 
	 生产订单行号：FProiRow 
	 所属客户：FCustomName 
	 净重：FNetWeight 
	 标准包装数量(1箱多少PCS)：FStdPackingQuantity 
	 标准包装箱数(一卡板多少箱)：FStdPackingBoxBagsQty 
	 申报材质：FNotificationMaterials 
	 表体ID：FProcessEntryID 
	 费用项目：FExpenseItem 
	 工序号：FJobSequence 
	 工艺名称：FProcessName 
	 生产部门：FProdDept 
	 ...
	 QC检测数量：FQCQty 
	 QC判定：FQCJudgment 
	 是否参与交收：FIsCompletionMonitored 
	 加工条件：FProcessingConditions 
	 热处理提前期：FLeadDays 
	 加工参数：FProcessingParameters 
	 热处理炉号：FHotFurnaceNo 
	 机时：FCycleTime 
	 总工时：FTotalCycleTime 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QRDO_ProcessDelivery","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDate":"1900-01-01","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FUseOrgID":{"FNumber":""},"FProDeyID":"","FEntity":[{"FEntryID":0,"FProcessId":"","FDocDate":"1900-01-01","FDocNo":"","FDispatchQtyDate":"1900-01-01","FDispatchQty":0,"FCompletedQtyDate":"1900-01-01","FCompletedQty":0,"FcWhCode":"","FcWhName":"","FcInvCode":{"FNUMBER":""},"FProductionStd":"","FMainTU":"","FProductionTu":"","FMaterialsBatch":"","FMaterials":"","FBatchQty":0,"FVer":"","FFtStatus":"","FFurnaceNo":"","FMaterialCode":{"FNUMBER":""},"FOutNo":"","FPackingMethod":"","FMaterialSource":"","FIsModelFT":"","FRemarks":"","FProiRow":"","FCustomName":"","FNetWeight":0,"FStdPackingQuantity":0,"FStdPackingBoxBagsQty":0,"FNotificationMaterials":"","FProcessEntryID":"","FExpenseItem":"","FJobSequence":"","FProcessName":"","FProdDept":"","FMachineNo":"","FProcessDate":"1900-01-01","FShift":"","FStaffInCharge":"","FBadQty":0,"FLoseQty":0,"FScrappedQty":0,"FDelivery":0,"FPEQty":0,"FRemark":"","FQCQty":0,"FQCJudgment":"","FIsCompletionMonitored":"","FProcessingConditions":"","FLeadDays":0,"FProcessingParameters":"","FHotFurnaceNo":"","FCycleTime":"","FTotalCycleTime":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QRDO_ProcessDelivery","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QRDO_ProcessDelivery","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QRDO_ProcessDelivery","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QRDO_ProcessDelivery","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QRDO_ProcessDelivery","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("QRDO_ProcessDelivery","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QRDO_ProcessDelivery"}");

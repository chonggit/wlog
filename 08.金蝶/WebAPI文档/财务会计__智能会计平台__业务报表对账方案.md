# 业务报表对账方案 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 智能会计平台 > 业务报表对账方案
...
client.Save("GL_CHECKSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FAcctTableID":{"FNUMBER":""},"FAccountBookId":[{"FName":""}],"FACCOUNTBOOK":"","FIsSysPreset":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FAuditDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FBALCONTROL":"false","FEntity":[{"FEntryID":0,"FCheckItemID":"","FDC":"","FACCOUNTID":"","FFLEXPROPERTYID":{"FNUMBER":""},"FFLEXITEMID":"","FGLFLEXFILTER":"","FGLFLEXINCLUDENULL":"false","FSOURCEBILLNAME":"","FBillFilter":"","FCONTACTTYPE":"","FSOURCEFIELD":"","FACCOUNTS":"","FFLEXITEMINFO":"","FSOURCEBILL":"","FBillFilterMulLang":"","FSOURCEFIELDMULLANG":"","FFilterSql":"","FSchemeModel":"","FGLFLEXFILTERMUL":"","FGLFLEXFILTERSQL":"","FGLFLEXFILTERMODEL":""}]}}");
...
单据头：FBillHead 
	 ...
	 方案编码：FNumber 
	 适用账簿：FACCOUNTBOOK 
	 必须与总账期末对账平衡：FBALCONTROL 
对账方案设置：FEntity 
	 实体主键：FEntryID 
	 报表过滤：FBillFilter 
	 余额方向：FDC  (必填项)
	 对账项目：FCheckItemID  (必填项)
	 核算维度值：FFLEXITEMID 
	 报表过滤条件SQL：FFilterSql 
	 报表过滤方案：FSchemeModel 
	 核算维度对应报表字段：FSOURCEFIELD 
	 科目编码：FACCOUNTS 
	 往来单位类型：FCONTACTTYPE 
	 科目：FACCOUNTID  (必填项)
	 核算维度对应报表字段值：FFLEXITEMINFO 
	 核算维度：FFLEXPROPERTYID 
	 业务报表：FSOURCEBILL  (必填项)
	 报表过滤多语言：FBillFilterMulLang 
	 核算维度对应报表字段多语言：FSOURCEFIELDMULLANG 
	 业务报表：FSOURCEBILLNAME  (必填项)
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_CHECKSCHEME","ForBid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("GL_CHECKSCHEME","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("GL_CHECKSCHEME","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FNumber":"","FName":"","FAcctTableID":{"FNUMBER":""},"FAccountBookId":[{"FName":""}],"FACCOUNTBOOK":"","FIsSysPreset":"false","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FAuditDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FBALCONTROL":"false","FEntity":[{"FEntryID":0,"FCheckItemID":"","FDC":"","FACCOUNTID":"","FFLEXPROPERTYID":{"FNUMBER":""},"FFLEXITEMID":"","FGLFLEXFILTER":"","FGLFLEXINCLUDENULL":"false","FSOURCEBILLNAME":"","FBillFilter":"","FCONTACTTYPE":"","FSOURCEFIELD":"","FACCOUNTS":"","FFLEXITEMINFO":"","FSOURCEBILL":"","FBillFilterMulLang":"","FSOURCEFIELDMULLANG":"","FFilterSql":"","FSchemeModel":"","FGLFLEXFILTERMUL":"","FGLFLEXFILTERSQL":"","FGLFLEXFILTERMODEL":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("GL_CHECKSCHEME","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("GL_CHECKSCHEME","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("GL_CHECKSCHEME","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"GL_CHECKSCHEME"}");

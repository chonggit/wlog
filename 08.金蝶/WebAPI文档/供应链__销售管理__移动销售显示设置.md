# 移动销售显示设置 Web API 操作原始内容

> 来源页面：全部 > 供应链 > 销售管理 > 移动销售显示设置
...
client.Delete("BD_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("BD_MobExtendFieldConfig","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("BD_MobExtendFieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillType":{"FID":""},"FEntryMarkID":"","FMobileConfigEntity":[{"FENTRYID":0,"FFieldKey":"","FFieldName":"","FIsHeadField":"false","FFieldTypeName":"","FLocal":"","FNote":""}],"FMobileConfigEntityV5":[{"FEntryID":0,"FFieldKeyV5":"","FFieldNameV5":"","FIsHeadFieldV5":"false","FFieldTypeV5":0,"FFieldTypeNameV5":"","FVisibleViewV5":"false","FVisibleEditV5":"false","FVisibleListV5":"false","FVisibleExpandV5":"false"}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FMobileConfigEntityV5": [
            {
                "FEntryID": 0,
                "FFieldKeyV5": "",
                "FFieldNameV5": "",
                "FIsHeadFieldV5": "false",
                "FFieldTypeV5": 0,
                "FFieldTypeNameV5": "",
                "FVisibleViewV5": "false",
                "FVisibleEditV5": "false",
                "FVisibleListV5": "false",
                "FVisibleExpandV5": "false"
            }
        ]
    }
}
...
单据头：FBillHead 
	 ...
	 业务领域：FTopClass 
	 单据体：FEntryMarkID 
移动销售自定义字段单据体：FMobileConfigEntity 
	 实体主键：FENTRYID 
	 单据头字段：FIsHeadField 
	 字段名称：FFieldName 
	 字段标识：FFieldKey 
	 ...
	 字段位置：FLocal 
	 备注：FNote 
移动销售V5自定义字段单据体：FMobileConfigEntityV5 
	 实体主键：FEntryID 
	 字段标识：FFieldKeyV5 
	 字段名称：FFieldNameV5 
	 单据头字段：FIsHeadFieldV5 
	 字段类型：FFieldTypeNameV5 
	 新增修改可见：FVisibleEditV5 
	 查看可见：FVisibleViewV5 
	 列表可见：FVisibleListV5 
	 折叠可见：FVisibleExpandV5 
	 字段类型：FFieldTypeV5 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("BD_MobExtendFieldConfig","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillType":{"FID":""},"FEntryMarkID":"","FMobileConfigEntity":[{"FENTRYID":0,"FFieldKey":"","FFieldName":"","FIsHeadField":"false","FFieldTypeName":"","FLocal":"","FNote":""}],"FMobileConfigEntityV5":[{"FEntryID":0,"FFieldKeyV5":"","FFieldNameV5":"","FIsHeadFieldV5":"false","FFieldTypeV5":0,"FFieldTypeNameV5":"","FVisibleViewV5":"false","FVisibleEditV5":"false","FVisibleListV5":"false","FVisibleExpandV5":"false"}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("BD_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("BD_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("BD_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_MobExtendFieldConfig","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("BD_MobExtendFieldConfig","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("BD_MobExtendFieldConfig","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("BD_MobExtendFieldConfig","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"BD_MobExtendFieldConfig"}");

# 生产线工位日产量表 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产线生产 > 生产线工位日产量表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 3022 |
...
client.GetSysReportData("REM_PrdLineLocDailyOutputRpt","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgIds":[{"FNumber":""}],"FRadioBeforeWeek":"","FRadioCurrWeek":"","FRadioBeforeMonth":"","FRadioCurrMonth":"","FBeginCountDate":"1900-01-01","FEndCountDate":"1900-01-01","FCountDateGroup":"","FWorkShopIds":"","FLocation":"","FBeginMaterialId":{"FNumber":""},"FPrdLines":[{"FNumber":""}],"FEndMaterialId":{"FNumber":""}}}");

# 借款利息单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 资金管理 > 借款利息单
...
client.Delete("SC_BorrowInterest","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("SC_BorrowInterest","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBankID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FBillNo":"","FDocumentStatus":"","FAssureOrgId":"","FRateShow":"","FFundsOrgID":{"FNumber":""},"FDate":"1900-01-01","FCURRENCYID":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FInterestExtent":"","FStopDays":0,"FInterestDays":0,"FFreeAmout":0,"FTOTALFACTOR":0,"FMAINBOOKID":{"FNUMBER":""},"FCREDITBILLNO":"","FEXCHANGETYPE":{"FNUMBER":""},"FEXCHANGERATE":0,"FBORROWAMOUNT":0,"FPAYTOTALAMOUNTFOR":0,"FPAYTOTALAMOUNT":0,"FREALPAYAMOUNT":0,"FREMARKS":"","FBORROWINTERESTENTRY":[{"FEntryID":0,"FINTERESTTYPE":"","FBEGINDATE":"1900-01-01","FENDDATE":"1900-01-01","FDAYS":0,"FFACTOR":0,"FYEARRATE":0,"FPAYAMOUNTFOR":0,"FPAYAMOUNT":0,"FREALPAYAMOUNT_E":0}]}}");
...
单据头：FBillHead 
	 ...
	 银行账号：FBankActID  (必填项)
	 本位币：FMAINBOOKID  (必填项)
	 信贷单编号：FCREDITBILLNO  (必填项)
	 计息区间：FInterestExtent 
	 计息天数：FInterestDays 
	 断息天数：FStopDays 
	 利率表示：FRateShow  (必填项)
	 ...
	 免息额：FFreeAmout 
	 积数：FTOTALFACTOR 
	 应付利息：FPAYTOTALAMOUNTFOR 
	 应付利息本位币：FPAYTOTALAMOUNT 
	 实际支付利息：FREALPAYAMOUNT 
	 单据类型：FBillTypeID  (必填项)
	 摘要：FREMARKS 
明细：FBORROWINTERESTENTRY 
	 实体主键：FEntryID 
	 利息类型：FINTERESTTYPE  (必填项)
	 开始日期：FBEGINDATE  (必填项)
	 结束日期：FENDDATE  (必填项)
	 积数：FFACTOR 
	 年利率(%)：FYEARRATE 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("SC_BorrowInterest","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBankID":{"FNUMBER":""},"FBankActID":{"FNUMBER":""},"FBillNo":"","FDocumentStatus":"","FAssureOrgId":"","FRateShow":"","FFundsOrgID":{"FNumber":""},"FDate":"1900-01-01","FCURRENCYID":{"FNUMBER":""},"FBillTypeID":{"FNUMBER":""},"FInterestExtent":"","FStopDays":0,"FInterestDays":0,"FFreeAmout":0,"FTOTALFACTOR":0,"FMAINBOOKID":{"FNUMBER":""},"FCREDITBILLNO":"","FEXCHANGETYPE":{"FNUMBER":""},"FEXCHANGERATE":0,"FBORROWAMOUNT":0,"FPAYTOTALAMOUNTFOR":0,"FPAYTOTALAMOUNT":0,"FREALPAYAMOUNT":0,"FREMARKS":"","FBORROWINTERESTENTRY":[{"FEntryID":0,"FINTERESTTYPE":"","FBEGINDATE":"1900-01-01","FENDDATE":"1900-01-01","FDAYS":0,"FFACTOR":0,"FYEARRATE":0,"FPAYAMOUNTFOR":0,"FPAYAMOUNT":0,"FREALPAYAMOUNT_E":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("SC_BorrowInterest","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("SC_BorrowInterest","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("SC_BorrowInterest","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("SC_BorrowInterest","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("SC_BorrowInterest","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("SC_BorrowInterest","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"SC_BorrowInterest"}");

# 应收逾期明细表 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 应收款管理 > 应收逾期明细表

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2534 |
...
client.GetSysReportData("RESP_YSYQMXB","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"F_RESP_Date":"1900-01-01","F_RESP_SKTJ":{"FNUMBER":""},"F_RESP_JSB":{"FNUMBER":""},"F_RESP_YSDH":"","F_RESP_CHBM":{"FNUMBER":""},"F_RESP_PZDL":[{"FNumber":""}],"F_RESP_ZZ":[{"FNumber":""}],"F_RESP_KHLB":[{"FNumber":""}]}}");

# 生产闭环报表-财务部 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产管理 > 生产闭环报表-财务部

## 操作列表

| 操作 | 标识 | 文本长度 |
| --- | --- | ---: |
| 查询报表数据 | GetSysReportData | 2812 |
...
client.GetSysReportData("QRDO_SCBHBBFinance","{"FieldKeys":"","SchemeId":"","StartRow":0,"Limit":2000,"IsVerifyBaseDataField":"true","FilterString":[],"Model":{"FPrdOrgId":"","FCloseType":""}}");

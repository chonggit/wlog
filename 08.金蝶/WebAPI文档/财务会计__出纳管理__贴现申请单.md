# 贴现申请单 Web API 操作原始内容

> 来源页面：全部 > 财务会计 > 出纳管理 > 贴现申请单
...
client.Delete("CN_DISCOUNTAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CN_DISCOUNTAPPLY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDiscountOrgId":{"FNumber":""},"FDate":"1900-01-01","FBookingDate":"1900-01-01","FCurrencyId":{"FNUMBER":""},"FDISCOUNTRATE":0,"FDiscountType":"","FClearWay":"","FRemark":"","FIsElectronicbill":"false","FTransferFlag":"false","FDiscountorBank":{"FNUMBER":""},"FDiscountorBankNo":"","FDiscountorCnaps":"","FAccountidName":"","FPayInterest":"false","FInterestPercentage":0,"FRedemptionSDate":"1900-01-01","FRedemptionEDate":"1900-01-01","FDiscountEntryBank":{"FNUMBER":""},"FDiscountEntryBankNo":{"FNUMBER":""},"FDiscountEntryBankCnaps":"","FDiscountAccountidName":"","FAddDate":0,"FDisRedRate":0,"FOpenAddressRec":"","FCancelStatus":"","FRateType":"","FProvince":"","FCity":"","FTicketClearType":"","FTicketSettleType":"","FDISCOUNTOPTBANKNO":{"FNUMBER":""},"FDISCOUNTAPPLYENTRY":[{"FEntryID":0,"FBillNumber":"","FBillType":"","FPARAmountFor":0,"FRealRecAmount":0,"FDisInterestAmount":0,"FIssueDate":"1900-01-01","FDueDate":"1900-01-01","FDrawer":"","FAcceptor":"","FComment":"","FNoteStatus":"","FSubmitUser":{"FUserID":""},"FSubmitBankTime":"1900-01-01","FNoteId":0,"FSettleOrgId":{"FNumber":""},"FContactUnitType":"","FContactUnit":{"FNumber":""},"FIsSplitTicket":"false","FTicketNo":"","FStartNo":0,"FEndNo":0,"FTicketFrom":"","FNewNoteStatus":"","FCirStatus":"","FSrcAmount":0,"FSrcStartNo":0,"FSrcEndNo":0}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FAccountidName": "",
        "FPayInterest": "false",
        "FInterestPercentage": 0,
        "FRedemptionSDate": "1900-01-01",
        "FRedemptionEDate": "1900-01-01",
        "FDiscountEntryBank": {
            "FNUMBER": ""
        },
        "FDiscountEntryBankNo": {
            "FNUMBER": ""
        },
        "FDiscountEntryBankCnaps": "",
        "FDiscountAccountidName": "",
        "FAddDate": 0,
        "FDisRedRate": 0,
        "FOpenAddressRec": "",
        "FCancelStatus": "",
...
单据头：FBillHead 
	 ...
	 贴现组织：FDiscountOrgId  (必填项)
	 业务日期：FDate  (必填项)
	 预约日期：FBookingDate  (必填项)
	 币别：FCurrencyId  (必填项)
	 贴现率%：FDISCOUNTRATE 
	 贴现种类：FDiscountType  (必填项)
	 清算方式：FClearWay  (必填项)
	 备注：FRemark 
	 是否电子票据：FIsElectronicbill 
	 能否转让：FTransferFlag 
	 贴入人银行：FDiscountorBank  (必填项)
	 贴入人银行账号：FDiscountorBankNo  (必填项)
	 贴入人银行行号：FDiscountorCnaps  (必填项)
	 贴入人账号名称：FAccountidName  (必填项)
	 买方付息：FPayInterest 
	 买方付息百分比%：FInterestPercentage 
	 赎回开放日：FRedemptionSDate 
	 赎回截止日：FRedemptionEDate 
	 贴现入账银行：FDiscountEntryBank  (必填项)
	 贴现入账银行账号：FDiscountEntryBankNo  (必填项)
	 贴现入账银行行号：FDiscountEntryBankCnaps  (必填项)
	 贴现入账账号名称：FDiscountAccountidName  (必填项)
	 协商加天数(贴息调整天数)：FAddDate 
	 赎回利率%：FDisRedRate 
	 修改日期：FModifyDate 
	 创建人：FCreatorId 
	 创建日期：FCreateDate 
	 ...
	 省：FProvince 
	 城市：FCity 
	 票交所清算类型：FTicketClearType 
	 票交所结算方式：FTicketSettleType 
	 贴现操作银行账号（跨行）：FDISCOUNTOPTBANKNO 
贴现申请单明细：FDISCOUNTAPPLYENTRY 
	 实体主键：FEntryID 
	 票据类型：FBillType 
	 票面金额：FPARAmountFor 
	 贴现实收金额：FRealRecAmount 
	 ...
	 开始序号（源）：FSrcStartNo 
	 终止序号（源）：FSrcEndNo 
关联关系表：FDISCOUNTAPPLYENTRY_Link 
	 实体主键：FLinkId 
	 业务流程图：FDISCOUNTAPPLYENTRY_Link_FFlowId 
	 推进路线：FDISCOUNTAPPLYENTRY_Link_FFlowLineId 
	 转换规则：FDISCOUNTAPPLYENTRY_Link_FRuleId 
	 源单表内码：FDISCOUNTAPPLYENTRY_Link_FSTableId 
	 源单表：FDISCOUNTAPPLYENTRY_Link_FSTableName 
	 源单内码：FDISCOUNTAPPLYENTRY_Link_FSBillId 
	 源单分录内码：FDISCOUNTAPPLYENTRY_Link_FSId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CN_DISCOUNTAPPLY","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FDiscountOrgId":{"FNumber":""},"FDate":"1900-01-01","FBookingDate":"1900-01-01","FCurrencyId":{"FNUMBER":""},"FDISCOUNTRATE":0,"FDiscountType":"","FClearWay":"","FRemark":"","FIsElectronicbill":"false","FTransferFlag":"false","FDiscountorBank":{"FNUMBER":""},"FDiscountorBankNo":"","FDiscountorCnaps":"","FAccountidName":"","FPayInterest":"false","FInterestPercentage":0,"FRedemptionSDate":"1900-01-01","FRedemptionEDate":"1900-01-01","FDiscountEntryBank":{"FNUMBER":""},"FDiscountEntryBankNo":{"FNUMBER":""},"FDiscountEntryBankCnaps":"","FDiscountAccountidName":"","FAddDate":0,"FDisRedRate":0,"FOpenAddressRec":"","FCancelStatus":"","FRateType":"","FProvince":"","FCity":"","FTicketClearType":"","FTicketSettleType":"","FDISCOUNTOPTBANKNO":{"FNUMBER":""},"FDISCOUNTAPPLYENTRY":[{"FEntryID":0,"FBillNumber":"","FBillType":"","FPARAmountFor":0,"FRealRecAmount":0,"FDisInterestAmount":0,"FIssueDate":"1900-01-01","FDueDate":"1900-01-01","FDrawer":"","FAcceptor":"","FComment":"","FNoteStatus":"","FSubmitUser":{"FUserID":""},"FSubmitBankTime":"1900-01-01","FNoteId":0,"FSettleOrgId":{"FNumber":""},"FContactUnitType":"","FContactUnit":{"FNumber":""},"FIsSplitTicket":"false","FTicketNo":"","FStartNo":0,"FEndNo":0,"FTicketFrom":"","FNewNoteStatus":"","FCirStatus":"","FSrcAmount":0,"FSrcStartNo":0,"FSrcEndNo":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CN_DISCOUNTAPPLY","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CN_DISCOUNTAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CN_DISCOUNTAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CN_DISCOUNTAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CN_DISCOUNTAPPLY","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_DISCOUNTAPPLY","Synchronism","{"Parameters":"","Numbers":[],"Ids":"","Model":{"FID":0,"FBillNo":"","FDiscountOrgId":{"FNumber":""},"FDate":"1900-01-01","FBookingDate":"1900-01-01","FCurrencyId":{"FNUMBER":""},"FDISCOUNTRATE":0,"FDiscountType":"","FClearWay":"","FRemark":"","FIsElectronicbill":"false","FTransferFlag":"false","FDiscountorBank":{"FNUMBER":""},"FDiscountorBankNo":"","FDiscountorCnaps":"","FAccountidName":"","FPayInterest":"false","FInterestPercentage":0,"FRedemptionSDate":"1900-01-01","FRedemptionEDate":"1900-01-01","FDiscountEntryBank":{"FNUMBER":""},"FDiscountEntryBankNo":{"FNUMBER":""},"FDiscountEntryBankCnaps":"","FDiscountAccountidName":"","FAddDate":0,"FDisRedRate":0,"FOpenAddressRec":"","FCancelStatus":"","FRateType":"","FProvince":"","FCity":"","FTicketClearType":"","FTicketSettleType":"","FDISCOUNTOPTBANKNO":{"FNUMBER":""},"FDISCOUNTAPPLYENTRY":[{"FEntryID":0,"FBillNumber":"","FBillType":"","FPARAmountFor":0,"FRealRecAmount":0,"FDisInterestAmount":0,"FIssueDate":"1900-01-01","FDueDate":"1900-01-01","FDrawer":"","FAcceptor":"","FComment":"","FNoteStatus":"","FSubmitUser":{"FUserID":""},"FSubmitBankTime":"1900-01-01","FNoteId":0,"FSettleOrgId":{"FNumber":""},"FContactUnitType":"","FContactUnit":{"FNumber":""},"FIsSplitTicket":"false","FTicketNo":"","FStartNo":0,"FEndNo":0,"FTicketFrom":"","FNewNoteStatus":"","FCirStatus":"","FSrcAmount":0,"FSrcStartNo":0,"FSrcEndNo":0}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CN_DISCOUNTAPPLY","Cancel","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CN_DISCOUNTAPPLY","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CN_DISCOUNTAPPLY"}");

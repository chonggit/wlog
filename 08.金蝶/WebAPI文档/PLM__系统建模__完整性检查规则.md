# 完整性检查规则 Web API 操作原始内容

> 来源页面：全部 > PLM > 系统建模 > 完整性检查规则
...
client.Save("PLM_CFG_COMPLETENESS_CHECK","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCode":"","FStatusValue":"","FOperationName":"","FName":"","FCheckType":"","FStageBase":{"FVALUE":""},"FProductionMode":"","FCheckStatusField":{"FKEY":""},"FEntity":[{"FEntryID":0,"FRuleCategory":{"FCODE":""},"FFileContains":"","FRuleBase":{"FNAME":""},"FRuleStage":{"FVALUE":""}}]}}");
...
单据头：FBillHead 
	 ...
	 检查方式：FCheckType  (必填项)
	 对应操作ID：FStatusValue 
	 对应转换状态：FStageBase  (必填项)
	 物料生产方式：FProductionMode  (必填项)
	 对应状态字段：FCheckStatusField  (必填项)
	 名称：FName  (必填项)
	 生成操作：FOperationName 
单据体：FEntity 
	 实体主键：FEntryID 
	 相关对象业务类型：FRuleCategory 
	 状态：FRuleStage 
	 字段规则：FRuleBase 
	 物理文件名包含字段：FFileContains 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("PLM_CFG_COMPLETENESS_CHECK","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_CFG_COMPLETENESS_CHECK"}");

...
client.Delete("ENG_LabelTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("ENG_LabelTemplate","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("ENG_LabelTemplate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FTempGroup":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FNumber":"","FName":"","FApplyScope":"","FApplyBill":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FDescription":"","FIsFlexiblePL":"false","FFilterSetting":"","FFilterString":"","FIsVerticalPrint":"false","FPrintCount":0,"FTemplateType":"","FNoteTemplate":"","FPrinterConnect":"","FEntityType":"","FEntity":[{"FEntryID":0,"FParaName":"","FIsMaunalInput":"","FFieldName":"","FFieldOrm":"","FBarCodeConvRule":""}],"FEntityMaterialType":[{"FEntryID":0,"FMaterialType":{"FNUMBER":""}}],"FEntityMaterial":[{"FEntryID":0,"FMaterialId":{"FNUMBER":""}}],"FEntryCustomPlugs":[{"FEntryID":0,"FClassName":"","FClassDesc":""}],"FEntityPrint":[{"FEntryID":0,"FDepartmentArea":{"FNumber":""},"FPrinter":{"FNUMBER":""}}]}}");
...
单据头：FBillHead 
	 ...
	 纵向打印：FIsVerticalPrint 
	 模板方式：FTemplateType  (必填项)
	 套打模板：FNoteTemplate 
	 打印份数：FPrintCount 
	 打印机连接方式：FPrinterConnect  (必填项)
	 单据体类型：FEntityType  (必填项)
模板变量：FEntity 
	 实体主键：FEntryID 
	 变量名：FParaName  (必填项)
	 字段名：FFieldName  (必填项)
	 字段ORM层级：FFieldOrm 
	 条码转换规则：FBarCodeConvRule 
	 类型：FIsMaunalInput  (必填项)
物料分类：FEntityMaterialType 
	 实体主键：FEntryID 
	 物料分类：FMaterialType 
	 分类名称：FMaterialTypeName 
物料：FEntityMaterial 
	 实体主键：FEntryID 
	 物料编码：FMaterialId 
	 物料名称：FMaterialName 
	 规格型号：FMaterialSpecification 
自定义插件：FEntryCustomPlugs 
	 实体主键：FEntryID 
	 插件实现类：FClassName  (必填项)
	 插件描述：FClassDesc 
打印机资源：FEntityPrint 
	 实体主键：FEntryID 
	 车间工作区：FDepartmentArea 
	 打印机：FPrinter 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("ENG_LabelTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("ENG_LabelTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("ENG_LabelTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_LabelTemplate","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("ENG_LabelTemplate","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("ENG_LabelTemplate","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Allocate("ENG_LabelTemplate","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAllocate("ENG_LabelTemplate","{"PkIds":0,"TOrgIds":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("ENG_LabelTemplate","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCreateOrgId":{"FNumber":""},"FTempGroup":{"FNumber":""},"FUseOrgId":{"FNumber":""},"FNumber":"","FName":"","FApplyScope":"","FApplyBill":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidderId":{"FUserID":""},"FForbidDate":"1900-01-01","FDescription":"","FIsFlexiblePL":"false","FFilterSetting":"","FFilterString":"","FIsVerticalPrint":"false","FPrintCount":0,"FTemplateType":"","FNoteTemplate":"","FPrinterConnect":"","FEntityType":"","FEntity":[{"FEntryID":0,"FParaName":"","FIsMaunalInput":"","FFieldName":"","FFieldOrm":"","FBarCodeConvRule":""}],"FEntityMaterialType":[{"FEntryID":0,"FMaterialType":{"FNUMBER":""}}],"FEntityMaterial":[{"FEntryID":0,"FMaterialId":{"FNUMBER":""}}],"FEntryCustomPlugs":[{"FEntryID":0,"FClassName":"","FClassDesc":""}],"FEntityPrint":[{"FEntryID":0,"FDepartmentArea":{"FNumber":""},"FPrinter":{"FNUMBER":""}}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("ENG_LabelTemplate","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"ENG_LabelTemplate"}");

# 返利结算单 Web API 操作原始内容

> 来源页面：全部 > 电商与分销 > 返利管理 > 返利结算单
...
client.Save("RPM_RPStatements","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillDate":"1900-01-01","FFinanceOrgId":{"FNumber":""},"FSettleCurrId":{"FNUMBER":""},"FDeptId":{"FNUMBER":""},"FAppUserId":{"FNUMBER":""},"FReturnType":"","FRemark":"","FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FBaseSettleCurrID":{"FNUMBER":""},"FRateTypeID":{"FNUMBER":""},"FExchangeRate":0,"FBillSource":"","FAccountID":{"FNUMBER":""},"FIsExceptRpt":"false","FCloserId":{"FUserID":""},"FCloseDate":"1900-01-01","FSaleOrgId":{"FNumber":""},"FEntity":[{"FEntryID":0,"FRPObjectTypeID":"","FRPObjectID":{"FNumber":""},"FCustomerID":{"FNUMBER":""},"FOrderCustomerId":{"FNUMBER":""},"FIsGroupRebate":"false","FRPLocalAmount":0,"FRPAmount":0,"FRPPolicyID":{"FNUMBER":""},"FGroupNumber":0,"FRPCycleID":{"FNUMBER":""},"FAssistPropertyID":{"FASSISTPROPERTYID__FF100001":{"FNumber":""},"FASSISTPROPERTYID__FF100002":{"FNumber":""},"FASSISTPROPERTYID__FF100003":{"FNumber":""},"FASSISTPROPERTYID__FF100005":{"FNumber":""},"FASSISTPROPERTYID__FF100010":{"FNumber":""},"FASSISTPROPERTYID__FF100007":{"FNumber":""},"FASSISTPROPERTYID__FF100008":{"FNumber":""}},"FExpenseItemID":{"FNUMBER":""},"FMaterialID":{"FNUMBER":""},"FBaseUnitID":{"FNumber":""},"FRPBaseQty":0,"FUnitID":{"FNumber":""},"FRPQty":0,"FConQty":0,"FNote":"","FBaseConQty":0,"FTotalQty":0,"FLocalConAmount":0,"FBaseTotalQty":0,"FConAmount":0,"FLocalTotalRPAmount":0,"FTotalRPAmount":0}],"FOtherEntity":[{"FEntryID":0,"FOtherObjectTypeID":"","FOtherObjectID":{"FNumber":""},"FOtherCustomerID":{"FNUMBER":""},"FOtherOrderCustomerID":{"FNUMBER":""},"FOtherPolicyID":{"FNUMBER":""},"FOtherCycleID":{"FNUMBER":""},"FOtherGroupNumber":0,"FOtherIsGroupRebate":"false"}]}}");
...
基本信息：FBillHead 
	 ...
	 审核人：FApproverId 
	 审核日期：FApproveDate 
	 币别：FSettleCurrId  (必填项)
	 返利组织：FFinanceOrgId  (必填项)
	 部门：FDeptId 
	 业务员：FAppUserId 
	 返还形式：FReturnType  (必填项)
	 结算本位币：FBaseSettleCurrID 
	 汇率类型：FRateTypeID 
	 汇率：FExchangeRate 
	 单据来源：FBillSource 
	 返利账户：FAccountID 
	 已结算到返利账户：FIsSettlement 
	 不参与余额报表统计：FIsExceptRpt 
	 关闭状态：FCloseStatus 
	 关闭人：FCloserId 
	 关闭日期：FCloseDate 
	 结算组织：FSaleOrgId 
单据体：FEntity 
	 ...
	 基本关联数量：FBaseConQty 
	 累计赠送数量：FTotalQty 
	 累计赠送基本数量：FBaseTotalQty 
	 关联金额：FConAmount 
	 累计返利金额：FTotalRPAmount 
	 费用项目名称：FExpenseItemName 
	 返利对象类型：FRPObjectTypeID  (必填项)
	 返利对象：FRPObjectID  (必填项)
	 关联本位币金额：FLocalConAmount 
	 累计返利本位币金额：FLocalTotalRPAmount 
	 组号：FGroupNumber 
	 结算客户：FOrderCustomerId  (必填项)
	 结算客户编码：FOrderCustomerNumber 
	 返利对象编码：FRPObjectNumber 
	 集团客户返利：FIsGroupRebate 
	 分录关闭状态：FEntryCloseStatus 
	 返利政策编码：FRPPolicyNumber 
其他信息：FOtherEntity 
	 实体主键：FEntryID 
	 返利对象类型：FOtherObjectTypeID 
	 返利对象：FOtherObjectID 
	 返利客户：FOtherCustomerID 
	 返利周期：FOtherCycleID 
	 返利政策：FOtherPolicyID 
	 组号：FOtherGroupNumber 
	 结算客户：FOtherOrderCustomerID 
	 是否集团返利：FOtherIsGroupRebate 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("RPM_RPStatements","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("RPM_RPStatements","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("RPM_RPStatements","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"RPM_RPStatements"}");

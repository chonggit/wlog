...
client.Delete("QRDO_Salary","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("QRDO_Salary","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FUseOrgId":{"FNumber":""},"FDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FDeptName":"","FRankName":"","FCostCenter":"","FPeopleCount":0,"FTotalIncome":0,"F_ora_Amount_qtr":0,"F_ora_Amount_83g":0,"FSocialAmount":0,"Faccumulation":0,"FBoardExpense":0,"FHotelExpense":0,"FMedicalExpense":0,"FTaxDeduction":0,"FOtherDeduction":0,"FAllDeduction":0,"FNetReceipt":0,"FAccountName":"","FAccountDimension":{"FNUMBER":""},"FCostDimension":{"FNUMBER":""},"F_ora_Base_qtr":{"FNUMBER":""},"FDeptDimension":{"FNUMBER":""},"F_ora_Text":""}]}}");
...
单据体：FEntity 
	 ...
	 医药费：FMedicalExpense 
	 扣税：FTaxDeduction 
	 其他扣除：FOtherDeduction 
	 共扣除：FAllDeduction 
	 实收：FNetReceipt 
	 摘要：F_ora_Text 
	 工资：F_ora_Amount_qtr 
	 加班费：F_ora_Amount_83g 
	 费用项目-加班费：F_ora_Base_qtr 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("QRDO_Salary","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillTypeID":{"FNUMBER":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FUseOrgId":{"FNumber":""},"FDate":"1900-01-01","FApproverId":{"FUserID":""},"FApproveDate":"1900-01-01","FModifierId":{"FUserID":""},"FModifyDate":"1900-01-01","FEntity":[{"FEntryID":0,"FDeptName":"","FRankName":"","FCostCenter":"","FPeopleCount":0,"FTotalIncome":0,"F_ora_Amount_qtr":0,"F_ora_Amount_83g":0,"FSocialAmount":0,"Faccumulation":0,"FBoardExpense":0,"FHotelExpense":0,"FMedicalExpense":0,"FTaxDeduction":0,"FOtherDeduction":0,"FAllDeduction":0,"FNetReceipt":0,"FAccountName":"","FAccountDimension":{"FNUMBER":""},"FCostDimension":{"FNUMBER":""},"F_ora_Base_qtr":{"FNUMBER":""},"FDeptDimension":{"FNUMBER":""},"F_ora_Text":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("QRDO_Salary","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("QRDO_Salary","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("QRDO_Salary","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("QRDO_Salary","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("QRDO_Salary","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("QRDO_Salary","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"QRDO_Salary"}");

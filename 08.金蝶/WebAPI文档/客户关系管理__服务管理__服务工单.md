...
client.Delete("CRM_RepairOrder","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CRM_RepairOrder","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCURRENCYID":{"FNumber":""},"FBillNo":"","FSROrgId":{"FNumber":""},"FSignDate":"1900-01-01","FPurchaseCustID":{"FNUMBER":""},"FSinger":{"FUserID":""},"FCloseUser":{"FUserID":""},"FCloseDate":"1900-01-01","FBomID":{"FNUMBER":""},"FExchangeRate":0,"FHandleDeptID":{"FNUMBER":""},"FAssignDept":{"FNUMBER":""},"FDate":"1900-01-01","FReqFinishDate":"1900-01-01","FMustFinishDate":"1900-01-01","FAssignDesc":"","FHandler":{"FSTAFFNUMBER":""},"FAssignerID":{"FSTAFFNUMBER":""},"FProductFileID":{"FNUMBER":""},"FDescription":"","FMaterialID":{"FNUMBER":""},"FCustomerID":{"FNUMBER":""},"FContactId":{"FNUMBER":""},"FAddress":"","FSourceBillType":"","FSourceBillNo":"","FRequestType":{"FNumber":""},"FHandleRecord":[{"FEntryID":0,"FStartDatetime":"1900-01-01","FEndDatetime":"1900-01-01","FDeptID":{"FNUMBER":""},"FHandlerID":{"FSTAFFNUMBER":""},"FOtherHandlerID":[{"FStaffNumber":""}],"FReason":"","FSolution":"","FResult":"","FRemark":""}],"FRepairAccessory":[{"FEntryID":0,"FACCESSORYID":{"FNUMBER":""},"FAMOUNT":0,"FAPPLYTYPE":"","FAPPLYID":{"FSTAFFNUMBER":""},"FAPPLYDPTID":{"FNUMBER":""},"FLINKAMOUNT":0}],"FCRMAllocation":[{"FEntryID":0,"FCooperationType":"","FEmployee":{"FSTAFFNUMBER":""},"FDept":{"FNUMBER":""},"FRead":"false","FModify":"false","FDelete":"false","FAllocation":"false","FCRMCLOSE":"false","FCRMUNCLOSE":"false","FCRMReAssign":"false","FHandle":"false","FAllocUser":{"FUSERACCOUNT":""},"FAllocTime":"1900-01-01"}],"FRepairIncome":[{"FEntryID":0,"FINCOMEITEMID":{"FNumber":""},"FINCOMEAMOUNT":0,"FINCOMEMARK":""}],"FRepairExpense":[{"FEntryID":0,"FEXPENSEITEMID":{"FNumber":""},"FEXPENSEAMOUNT":0,"FEXPENSEMARK":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDate": "1900-01-01",
        "FReqFinishDate": "1900-01-01",
        "FMustFinishDate": "1900-01-01",
        "FAssignDesc": "",
        "FHandler": {
            "FSTAFFNUMBER": ""
        },
        ...
        "FHandleRecord": [
            {
                "FEntryID": 0,
                "FStartDatetime": "1900-01-01",
                "FEndDatetime": "1900-01-01",
                "FDeptID": {
                    "FNUMBER": ""
                },
                "FHandlerID": {
...
单据头：FBillHead 
	 实体主键：FID 
	 工单号：FBillNo 
	 处理状态：FDocumentStatus 
	 反馈时间：FDate 
	 要求完成时间：FMustFinishDate 
	 问题描述：FDescription 
	 客服组织：FSROrgId 
	 服务组织：FSVOrgId 
	 创建日期：FCreateDate 
	 ...
	 座机：FTel 
	 服务地址：FAddress 
	 派工说明：FAssignDesc  (必填项)
	 处理负责人：FHandler  (必填项)
	 负责部门：FHandleDeptID 
	 购买客户：FPurchaseCustID 
	 ...
	 关闭人：FCloseUser 
	 产品批号：FLot 
	 客户要求完成：FReqFinishDate 
	 反馈类型：FRequestType  (必填项)
	 BOM版本：FBomID 
	 汇率类型：FEXCHANGETYPE 
	 汇率：FExchangeRate 
	 币别：FCURRENCYID  (必填项)
...
处理记录：FHandleRecord 
	 实体主键：FEntryID 
	 处理时间从：FStartDatetime 
	 至：FEndDatetime 
	 处理部门：FDeptID 
	 处理人：FHandlerID 
	 其他处理人：FOtherHandlerID 
	 问题原因：FReason 
	 处理方案：FSolution 
	 处理结果：FResult 
	 备注说明：FRemark 
配件服务清单：FRepairAccessory 
	 实体主键：FEntryID 
	 代码：FACCESSORYID  (必填项)
	 名称：FAccessoryName 
	 规格型号：FSpecification 
...
收入单据体：FRepairIncome 
	 实体主键：FEntryID 
	 费用项目编码：FINCOMEITEMID 
	 费用项目名称：FINCOMEITEMNAME 
	 金额：FINCOMEAMOUNT 
	 金额本位币：FINCOMEAMOUNT_LC 
	 备注：FINCOMEMARK 
	 关联应收金额(本位币)：FARJOINAMOUNT 
费用单据体：FRepairExpense 
	 实体主键：FEntryID 
	 费用项目编码：FEXPENSEITEMID 
	 费用项目名称：FEXPENSEITEMNAME 
	 金额：FEXPENSEAMOUNT 
	 金额本位币：FEXPENSEAMOUNT_LC 
	 备注：FEXPENSEMARK 
	 关联费用申请金额(本位币)：FERJOINAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CRM_RepairOrder","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FCURRENCYID":{"FNumber":""},"FBillNo":"","FSROrgId":{"FNumber":""},"FSignDate":"1900-01-01","FPurchaseCustID":{"FNUMBER":""},"FSinger":{"FUserID":""},"FCloseUser":{"FUserID":""},"FCloseDate":"1900-01-01","FBomID":{"FNUMBER":""},"FExchangeRate":0,"FHandleDeptID":{"FNUMBER":""},"FAssignDept":{"FNUMBER":""},"FDate":"1900-01-01","FReqFinishDate":"1900-01-01","FMustFinishDate":"1900-01-01","FAssignDesc":"","FHandler":{"FSTAFFNUMBER":""},"FAssignerID":{"FSTAFFNUMBER":""},"FProductFileID":{"FNUMBER":""},"FDescription":"","FMaterialID":{"FNUMBER":""},"FCustomerID":{"FNUMBER":""},"FContactId":{"FNUMBER":""},"FAddress":"","FSourceBillType":"","FSourceBillNo":"","FRequestType":{"FNumber":""},"FHandleRecord":[{"FEntryID":0,"FStartDatetime":"1900-01-01","FEndDatetime":"1900-01-01","FDeptID":{"FNUMBER":""},"FHandlerID":{"FSTAFFNUMBER":""},"FOtherHandlerID":[{"FStaffNumber":""}],"FReason":"","FSolution":"","FResult":"","FRemark":""}],"FRepairAccessory":[{"FEntryID":0,"FACCESSORYID":{"FNUMBER":""},"FAMOUNT":0,"FAPPLYTYPE":"","FAPPLYID":{"FSTAFFNUMBER":""},"FAPPLYDPTID":{"FNUMBER":""},"FLINKAMOUNT":0}],"FCRMAllocation":[{"FEntryID":0,"FCooperationType":"","FEmployee":{"FSTAFFNUMBER":""},"FDept":{"FNUMBER":""},"FRead":"false","FModify":"false","FDelete":"false","FAllocation":"false","FCRMCLOSE":"false","FCRMUNCLOSE":"false","FCRMReAssign":"false","FHandle":"false","FAllocUser":{"FUSERACCOUNT":""},"FAllocTime":"1900-01-01"}],"FRepairIncome":[{"FEntryID":0,"FINCOMEITEMID":{"FNumber":""},"FINCOMEAMOUNT":0,"FINCOMEMARK":""}],"FRepairExpense":[{"FEntryID":0,"FEXPENSEITEMID":{"FNumber":""},"FEXPENSEAMOUNT":0,"FEXPENSEMARK":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CRM_RepairOrder","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CRM_RepairOrder","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CRM_RepairOrder","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CRM_RepairOrder","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CRM_RepairOrder","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("CRM_RepairOrder","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CRM_RepairOrder","Closed","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("CRM_RepairOrder","UnClosed","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CRM_RepairOrder"}");

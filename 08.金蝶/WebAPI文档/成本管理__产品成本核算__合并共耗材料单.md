# 合并共耗材料单 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 合并共耗材料单
...
client.Delete("CB_CostMatMergeBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("CB_CostMatMergeBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBILLDATE":"1900-01-01","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FYEAR":0,"FPERIOD":0,"FShowPeriod":"","FCOSTCENTERID":{"FNUMBER":""},"FMATERIALID":{"FNUMBER":""},"FMASTERID":0,"FPRODUCTGROUPID":{"FNUMBER":""},"FPRODUCTNO":"","FQTY":0,"FAMOUNT":0,"FDATATYPE":"","FBILLTYPEID":{"FNUMBER":""},"FCostMatMergeEntry":[{"FEntryID":0,"FCOSTITEMID":{"FNUMBER":""},"FEXPENSESITEMID":{"FNUMBER":""},"FEXPAMOUNT":0}],"FCostMatBillMerge":[{"FBIllEntryID":0,"FSRCBILLTYPEID":{"FNUMBER":""},"FSRCBILLNO":"","FSRCBILLSEQ":0,"FSRCBILLDATE":"1900-01-01","FSRCBILLID":0,"FSRCBILLENTRYID":0,"FSRCQTY":0,"FSRCAMOUNT":0,"FCostMatExpMerge":[{"FDetailID":0,"FSRCCOSTITEMID":{"FNUMBER":""},"FSRCEXPENSESITEMID":{"FNUMBER":""},"FSRCEXPAMOUNT":0}]}]}}");
...
基本信息：FBillHead 
	 ...
	 物料编码：FMATERIALID 
	 物料名称：FMATERIALNAME 
	 产品组编码：FPRODUCTGROUPID 
	 产品组名称：FPRODUCTGROUPNAME 
	 数量：FQTY 
	 金额：FAMOUNT 
	 物料内码：FMASTERID 
	 生产编号：FPRODUCTNO 
	 ...
	 创建日期：FCreateDate 
	 审核日期：FAPPROVEDATE 
	 基本单位：FBASICUNITFIELD 
	 规格型号：FSPECIFICATION 
	 币别：FCURRENCYID 
	 数据来源：FDATATYPE 
	 单据类型：FBILLTYPEID  (必填项)
费用明细：FCostMatMergeEntry 
	 实体主键：FEntryID 
	 费用项目编码：FEXPENSESITEMID 
	 费用项目名称：FEXPENSESITEMNAME 
	 金额：FEXPAMOUNT 
	 成本项目编码：FCOSTITEMID 
	 成本项目名称：FCOSTITEMNAME 
子项单据：FCostMatBillMerge 
	 实体主键：FBIllEntryID 
	 源单编号：FSRCBILLNO 
	 源单行号：FSRCBILLSEQ 
	 源单日期：FSRCBILLDATE 
	 源单内码：FSRCBILLID 
	 源单行内码：FSRCBILLENTRYID 
	 数量：FSRCQTY 
	 金额：FSRCAMOUNT 
	 源单类型：FSRCBILLTYPEID 
子项单据费用明细：FCostMatExpMerge 
	 实体主键：FDetailID 
	 费用项目编码：FSRCEXPENSESITEMID 
	 费用项目名称：FSRCEXPENSESITEMNAME 
	 金额：FSRCEXPAMOUNT 
	 成本项目编码：FSRCCOSTITEMID 
	 成本项目名称：FSRCCOSTITEMNAME 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("CB_CostMatMergeBill","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBILLDATE":"1900-01-01","FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FYEAR":0,"FPERIOD":0,"FShowPeriod":"","FCOSTCENTERID":{"FNUMBER":""},"FMATERIALID":{"FNUMBER":""},"FMASTERID":0,"FPRODUCTGROUPID":{"FNUMBER":""},"FPRODUCTNO":"","FQTY":0,"FAMOUNT":0,"FDATATYPE":"","FBILLTYPEID":{"FNUMBER":""},"FCostMatMergeEntry":[{"FEntryID":0,"FCOSTITEMID":{"FNUMBER":""},"FEXPENSESITEMID":{"FNUMBER":""},"FEXPAMOUNT":0}],"FCostMatBillMerge":[{"FBIllEntryID":0,"FSRCBILLTYPEID":{"FNUMBER":""},"FSRCBILLNO":"","FSRCBILLSEQ":0,"FSRCBILLDATE":"1900-01-01","FSRCBILLID":0,"FSRCBILLENTRYID":0,"FSRCQTY":0,"FSRCAMOUNT":0,"FCostMatExpMerge":[{"FDetailID":0,"FSRCCOSTITEMID":{"FNUMBER":""},"FSRCEXPENSESITEMID":{"FNUMBER":""},"FSRCEXPAMOUNT":0}]}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_CostMatMergeBill","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("CB_CostMatMergeBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("CB_CostMatMergeBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("CB_CostMatMergeBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("CB_CostMatMergeBill","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_CostMatMergeBill","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_CostMatMergeBill"}");

# Live卡片 Web API 操作原始内容

> 来源页面：全部 > 移动应用 > 星空Live > Live卡片
...
client.Delete("LIVE_ReportCard","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("LIVE_ReportCard","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("LIVE_ReportCard","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeId":{"FNUMBER":""},"FName":"","FNumber":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FApproverId":{"FUserID":""},"FForbiderId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidDate":"1900-01-01","FDateType":"","FCustomStartDate":"1900-01-01","FCustomEndDate":"1900-01-01","FIsSysPreset":"false","FSumField":"","FDrillType":"","FDefaultSortType":"","FPreDisplayRulesWhenDrill":"","FDisplayUnit":"","FNotShowLastZero":"false","FPreDisplayRulesWhenCard":"","FShowPrePeriodWhenCard":"false","FSeparator":"","FOnlyShowSummary":"false","FCanShowBillList":"false","FDrillSummaryType":"","FShowRatioWhenDrill":"false","FShowPrePeriodWhenDrill":"false","FFixNumber":0,"FRankSeqIcon":"","FDrillSummaryNumber":0,"FCalcGroup":"","FSumType":{"FNumber":""},"FSumFieldKey":"","FDisplayExpression":"","FMobPlatform":"false","FPcPlatform":"false","FDrillStackField":"","FAllowShareSwitchDate":"false","FCardSourceEntry":[{"FEntryID":0,"FSourceType":"","FSourceKey":{"FID":""},"FSourceName":"","FSourceEntry":"","FSourceEntryKey":"","FFilterString":"","FFilterStringKey":"","FExtendFilterString":"","FDateField":"","FDateFieldKey":"","FFocusShowField":"","FFocusShowFieldKey":"","FBillListSourceSubEntry":[{"FDetailID":0,"FListShowField":"","FListShowFieldKey":"","FListIsHeadField":"false","FEntrySumType":{"FNumber":""},"FEntrySortType":""}]}],"FDrillFieldEntry":[{"FEntryID":0,"FDrillField":"","FIsDefaultDrillField":"false","FSourceField1":"","FSourceField1Key":"","FSourceField2":"","FSourceField2Key":"","FSourceField3":"","FSourceField3Key":"","FSourceField4":"","FSourceField4Key":"","FSourceField5":"","FSourceField5Key":"","FSourceFieldDateDrillType":""}],"FCardsAliasEntity":[{"FEntryID":0,"FAliasName":""}],"FIndicatorEntry":[{"FEntryID":0,"FIndicatorType":"","FIndicator":"","FIndicatorShowName":"","FIndicatorGroup":{"FNumber":""},"FIndicatorEmphasize":"false","FCornerMark":{"FNumber":""},"FIndicatorField":""}]}}");
...
四、JSON格式数据：
{
    ...
    "Model": {
        ...
        "FDateType": "",
        "FCustomStartDate": "1900-01-01",
        "FCustomEndDate": "1900-01-01",
        "FIsSysPreset": "false",
        "FSumField": "",
        "FDrillType": "",
        "FDefaultSortType": "",
        "FPreDisplayRulesWhenDrill": "",
        "FDisplayUnit": "",
        "FNotShowLastZero": "false",
        "FPreDisplayRulesWhenCard": "",
        "FShowPrePeriodWhenCard": "false",
        "FSeparator": "",
        "FOnlyShowSummary": "false",
        "FCanShowBillList": "false",
        "FDrillSummaryType": "",
        "FShowRatioWhenDrill": "false",
        "FShowPrePeriodWhenDrill": "false",
        "FFixNumber": 0,
        "FRankSeqIcon": "",
        "FDrillSummaryNumber": 0,
        "FCalcGroup": "",
        "FSumType": {
            "FNumber": ""
        },
        ...
        "FCardSourceEntry": [
            {
                ...
                "FFocusShowField": "",
                "FFocusShowFieldKey": "",
                "FBillListSourceSubEntry": [
                    {
                        "FDetailID": 0,
                        "FListShowField": "",
                        "FListShowFieldKey": "",
                        "FListIsHeadField": "false",
                        "FEntrySumType": {
                            "FNumber": ""
                        },
                        "FEntrySortType": ""
...
基本信息：FBillHead 
	 ...
	 汇总：FIsSumType 
	 表达式编辑：FIsExpression 
	 下查钻取方式：FDrillType  (必填项)
	 默认排序方式：FDefaultSortType  (必填项)
	 显示单位：FDisplayUnit 
	 不显示尾零：FNotShowLastZero 
	 卡片比较上期显示规则：FPreDisplayRulesWhenCard 
	 仅显示钻取摘要：FOnlyShowSummary 
	 汇总字段：FSumField 
	 末级联查单据列表：FCanShowBillList 
	 钻取摘要：FDrillSummaryType  (必填项)
	 审核日期：FApproveDate 
	 预置卡片：FIsSysPreset 
	 审核人：FApproverId 
	 禁用日期：FForbidDate 
	 禁用人：FForbiderId 
	 钻取时支持显示图表：FShowRatioWhenDrill 
	 钻取时支持显示比较上期：FShowPrePeriodWhenDrill 
	 钻取比较上期显示规则：FPreDisplayRulesWhenDrill  (必填项)
	 分隔符：FSeparator  (必填项)
	 卡片支持显示比较上期：FShowPrePeriodWhenCard 
	 排名序号图标：FRankSeqIcon  (必填项)
	 小数位数：FFixNumber 
	 钻取摘要显示数量：FDrillSummaryNumber 
	 计算方式：FCalcGroup 
	 汇总方式：FSumType 
	 汇总字段Key：FSumFieldKey 
	 表达式：FDisplayExpression 
	 开始日期：FCustomStartDate 
	 结束日期：FCustomEndDate 
	 默认日期范围：FDateType  (必填项)
	 多选下拉列表：FValidDateScope 
	 卡片类型：FBillTypeId  (必填项)
	 移动端：FMobPlatform 
	 PC端：FPcPlatform 
	 堆积维度：FDrillStackField 
	 分享时允许切换日期范围：FAllowShareSwitchDate 
	 下钻时多图表：FDrillTypeWhenShow 
卡片数据源单据体：FCardSourceEntry 
	 实体主键：FEntryID 
	 数据源名称：FSourceName  (必填项)
	 过滤方案：FFilterString 
	 日期字段：FDateField 
	 数据源类型：FSourceType  (必填项)
	 数据源：FSourceKey  (必填项)
	 过滤方案Key：FFilterStringKey 
	 日期字段Key：FDateFieldKey 
	 单据体：FSourceEntry 
	 单据体Key：FSourceEntryKey 
	 强调显示字段：FFocusShowField  (必填项)
	 强调显示字段Key：FFocusShowFieldKey  (必填项)
	 自定义过滤条件：FExtendFilterString 
钻取字段单据体：FDrillFieldEntry 
	 实体主键：FEntryID 
	 默认钻取字段：FIsDefaultDrillField 
	 [数据源1]对应字段：FSourceField1 
	 [数据源2]对应字段：FSourceField2 
	 [数据源3]对应字段：FSourceField3 
	 [数据源4]对应字段：FSourceField4 
	 [数据源5]对应字段：FSourceField5 
	 [数据源1]对应字段Key：FSourceField1Key 
	 [数据源2]对应字段Key：FSourceField2Key 
	 [数据源3]对应字段Key：FSourceField3Key 
	 [数据源4]对应字段Key：FSourceField4Key 
	 [数据源5]对应字段Key：FSourceField5Key 
	 钻取字段名称：FDrillField 
	 日期维度：FSourceFieldDateDrillType 
单据列表数据源子单据体：FBillListSourceSubEntry 
	 实体主键：FDetailID 
	 列表显示字段：FListShowField 
	 列表显示字段Key：FListShowFieldKey 
	 单据体字段汇总方式：FEntrySumType 
	 单据头字段：FListIsHeadField 
	 排序：FEntrySortType 
卡片别名列表：FCardsAliasEntity 
	 实体主键：FEntryID 
	 别名名称：FAliasName 
指标单据体：FIndicatorEntry 
	 实体主键：FEntryID 
	 指标类型：FIndicatorType  (必填项)
	 指标：FIndicator 
	 指标显示名称：FIndicatorShowName 
	 强调显示：FIndicatorEmphasize 
	 指标字段：FIndicatorField 
	 指标分组：FIndicatorGroup 
	 角标设置：FCornerMark 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("LIVE_ReportCard","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillTypeId":{"FNUMBER":""},"FName":"","FNumber":"","FModifierId":{"FUserID":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FModifyDate":"1900-01-01","FDescription":"","FApproverId":{"FUserID":""},"FForbiderId":{"FUserID":""},"FApproveDate":"1900-01-01","FForbidDate":"1900-01-01","FDateType":"","FCustomStartDate":"1900-01-01","FCustomEndDate":"1900-01-01","FIsSysPreset":"false","FSumField":"","FDrillType":"","FDefaultSortType":"","FPreDisplayRulesWhenDrill":"","FDisplayUnit":"","FNotShowLastZero":"false","FPreDisplayRulesWhenCard":"","FShowPrePeriodWhenCard":"false","FSeparator":"","FOnlyShowSummary":"false","FCanShowBillList":"false","FDrillSummaryType":"","FShowRatioWhenDrill":"false","FShowPrePeriodWhenDrill":"false","FFixNumber":0,"FRankSeqIcon":"","FDrillSummaryNumber":0,"FCalcGroup":"","FSumType":{"FNumber":""},"FSumFieldKey":"","FDisplayExpression":"","FMobPlatform":"false","FPcPlatform":"false","FDrillStackField":"","FAllowShareSwitchDate":"false","FCardSourceEntry":[{"FEntryID":0,"FSourceType":"","FSourceKey":{"FID":""},"FSourceName":"","FSourceEntry":"","FSourceEntryKey":"","FFilterString":"","FFilterStringKey":"","FExtendFilterString":"","FDateField":"","FDateFieldKey":"","FFocusShowField":"","FFocusShowFieldKey":"","FBillListSourceSubEntry":[{"FDetailID":0,"FListShowField":"","FListShowFieldKey":"","FListIsHeadField":"false","FEntrySumType":{"FNumber":""},"FEntrySortType":""}]}],"FDrillFieldEntry":[{"FEntryID":0,"FDrillField":"","FIsDefaultDrillField":"false","FSourceField1":"","FSourceField1Key":"","FSourceField2":"","FSourceField2Key":"","FSourceField3":"","FSourceField3Key":"","FSourceField4":"","FSourceField4Key":"","FSourceField5":"","FSourceField5Key":"","FSourceFieldDateDrillType":""}],"FCardsAliasEntity":[{"FEntryID":0,"FAliasName":""}],"FIndicatorEntry":[{"FEntryID":0,"FIndicatorType":"","FIndicator":"","FIndicatorShowName":"","FIndicatorGroup":{"FNumber":""},"FIndicatorEmphasize":"false","FCornerMark":{"FNumber":""},"FIndicatorField":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("LIVE_ReportCard","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("LIVE_ReportCard","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("LIVE_ReportCard","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("LIVE_ReportCard","Forbid","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.ExcuteOperation("LIVE_ReportCard","Enable","{"CreateOrgId":0,"Numbers":[],"Ids":"","PkEntryIds":[],"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("LIVE_ReportCard","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("LIVE_ReportCard","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"LIVE_ReportCard"}");

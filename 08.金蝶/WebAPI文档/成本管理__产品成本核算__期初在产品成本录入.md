# 期初在产品成本录入 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 产品成本核算 > 期初在产品成本录入
...
client.Save("CB_INITPRODUCECOST","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FACCTGSYSTEMID":{"FNumber":""},"FACCTGORGID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FCURRENCYID":{"FNUMBER":""},"FTreeEntity":[{"FEntryID":0,"FROWID":"","FPROORDERTYPE":"","FPROORDERID":{"FNUMBER":""},"FPROORDERNO":"","FPROORDERSEQ":0,"FCOSTCENTERID":{"FNUMBER":""},"FPRODUCTID":{"FNUMBER":""},"FUNITID":{"FNumber":""},"FINITINPROQTY":0,"FINITINPROAMOUNT":0,"FPROBOMID":{"FNumber":""},"FAUXPROPID":{"FAUXPROPID__FF100001":{"FNumber":""},"FAUXPROPID__FF100002":{"FNumber":""},"FAUXPROPID__FF100003":{"FNumber":""},"FAUXPROPID__FF100005":{"FNumber":""},"FAUXPROPID__FF100010":{"FNumber":""},"FAUXPROPID__FF100007":{"FNumber":""},"FAUXPROPID__FF100008":{"FNumber":""}},"FFORMID":"","FBUSINESSORGID":{"FNumber":""},"FPROLOT":{"FNUMBER":""},"FMtoNo":"","FMaterialEntity":[{"FDetailID":0,"FMATERDETAILENTRYID":0,"FCostExpEntity":[{"FSubDetailID":0}]}]}]}}");
...
子项物料：FMaterialEntity 
	 ...
	 物料名称：FMATERIALNAME 
	 基本单位：FDETAILUNITID 
	 期初在产数量：FINITINPROMATQTY 
	 累计完工数量：FSUMFINISHMATQTY 
	 累计投入数量：FSUMINPUTMATQTY 
	 期初在产金额：FINITINPROMATAMOUNT 
...
子项费用项目：FCostExpEntity 
	 ...
	 期初在产数量：FINITINPROEXPQTY 
	 期初在产金额：FINITINPROEXPAMOUNT 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("CB_INITPRODUCECOST","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Delete("CB_INITPRODUCECOST","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("CB_INITPRODUCECOST","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"CB_INITPRODUCECOST"}");

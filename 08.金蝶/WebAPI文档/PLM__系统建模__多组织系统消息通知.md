# 多组织系统消息通知 Web API 操作原始内容

> 来源页面：全部 > PLM > 系统建模 > 多组织系统消息通知
...
client.Save("PLM_MOG_SYS_MESSAGE","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FContent":"","FShowSuggestion":"","FRelationObject":{"FCODE":""},"FShowReaded":"false","FShowAggree":"false","FPublishOrgId":{"FNumber":""},"FCreatorId":{"FUserID":""},"FCreateDate":"1900-01-01","FItems":[{"FENTRYID":0,"FSelected":"false","FItemObject":{"FCODE":""},"FItemSuggestion":"","FConfirm":"false"}],"FUsers":[{"FENTRYID":0,"FUserId":{"FUserID":""},"FSuggestion":"","FAggree":"false","FReaded":"false","FMarkDate":"1900-01-01"}]}}");
...
单据头：FBillHead 
	 ...
	 消息内容：FContent 
	 意见：FShowSuggestion 
	 关联编码：FRelationObject 
	 标记阅读：FShowReaded 
	 同意：FShowAggree 
	 发布组织：FPublishOrgId 
	 发布人：FCreatorId 
	 关联名称：FRelationObjectName 
	 发布日期：FCreateDate 
单据体：FItems 
	 实体主键：FENTRYID 
	 相关项：FItemObject 
	 相关项名称：FItemObjectName 
	 确认：FConfirm 
	 选择：FSelected 
	 意见：FItemSuggestion 
相关人员：FUsers 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PLM_MOG_SYS_MESSAGE","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PLM_MOG_SYS_MESSAGE"}");

# 退料残值率设置 Web API 操作原始内容

> 来源页面：全部 > 成本管理 > 存货核算 > 退料残值率设置
...
client.View("HS_RetreatResidualvalue","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("HS_RetreatResidualvalue","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FDIMENSIONID":0,"FACCTSYSTEMID":{"FNumber":""},"FACCTPOLICYID":{"FNumber":""},"FSALVAGESETTYPE":"","FFINORGID":{"FNumber":""},"FResidualvalueSet":[{"FEntryID":0,"FBillFromId":{"FNumber":""},"FSTOCKSTATUSID":{"FNumber":""},"FResidualvalueRate":0,"FResidualvalueSetEntry":[{"FDetailID":0,"FMaterialGroup":{"FNUMBER":""},"FMaterialId":{"FNumber":""},"FSubResidualvalueRate":0,"FMasterId":0}]}]}}");
        ...
        "FResidualvalueSet": [
            {
                ...
                "FResidualvalueRate": 0,
                "FResidualvalueSetEntry": [
                    {
                        "FDetailID": 0,
                        "FMaterialGroup": {
                            "FNUMBER": ""
...
单据头：FBillHead 
	 ...
	 核算体系编码：FACCTSYSTEMID  (必填项)
	 残值率设置模式：FSALVAGESETTYPE  (必填项)
	 核算组织编码：FFINORGID  (必填项)
	 核算组织名称：FFinOrgName 
残值设置：FResidualvalueSet 
	 实体主键：FEntryID 
	 适用单据：FBillFromId  (必填项)
	 库存状态：FSTOCKSTATUSID 
	 综合残值率(%)：FResidualvalueRate 
残值设置明细表：FResidualvalueSetEntry 
	 实体主键：FDetailID 
	 物料编码：FMaterialId 
	 物料名称：FMaterialName 
	 明细残值率(%)：FSubResidualvalueRate 
	 物料FMasterId：FMasterId 
	 物料分组：FMaterialGroup 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"HS_RetreatResidualvalue"}");

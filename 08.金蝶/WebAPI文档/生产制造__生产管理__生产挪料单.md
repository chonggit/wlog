# 生产挪料单 Web API 操作原始内容

> 来源页面：全部 > 生产制造 > 生产管理 > 生产挪料单
...
client.Delete("PRD_MOVEMTRL","{"CreateOrgId":0,"Numbers":[],"Ids":"","NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Draft("PRD_MOVEMTRL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillType":{"FNUMBER":""},"FDate":"1900-01-01","FPrdOrgId":{"FNumber":""},"FWORKSHOPID":{"FNumber":""},"FBUSINESSTYPE":"","FMOVEOUTTYPE":"","FMOVEINTYPE":"","FDocumentStatus":"","FDescription":"","FMOVESETQTY":0,"FStockId":{"FNUMBER":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FEntity":[{"FEntryID":0,"FROWTYPE":"","FMOBILLNO":"","FMOENTRYSEQ":0,"FMATERIALID":{"FNUMBER":""},"FMATERIALCHILDID":{"FNumber":""},"FUnitID":{"FNumber":""},"FMUSTQTY":0,"FPICKEDQTY":0,"FRETURNQTY":0,"FWIPQTY":0,"FCANMOVEQTY":0,"FMOVEQTY":0,"FMOID":0,"FMOENTRYID":0,"FPPBOMBILLNO":"","FPPBOMID":0,"FPPBOMENTRYID":0,"FPPBOMENTRYSEQ":0,"FPICKBILLNO":"","FPICKMTRLID":0,"FRETURNBILLNO":"","FRETURNMTRLID":0,"FBASEUNITID":{"FNumber":""},"FBASEMUSTQTY":0,"FBASEPICKEDQTY":0,"FBASEWIPQTY":0,"FBASECANMOVEQTY":0,"FBASEMOVEQTY":0,"FRETURNENTRYSEQ":"","FPARENTROWID":"","FPICKENTRYSEQ":"","FROWID":"","FOverControlMode":"","FSourceBillType":"","FSourceBillNo":""}]}}");
...
单据头：FBillHead 
	 ...
	 生产车间：FWORKSHOPID 
	 挪料套数：FMOVESETQTY 
	 转出类型：FMOVEOUTTYPE  (必填项)
	 转入类型：FMOVEINTYPE  (必填项)
	 中转仓库：FStockId  (必填项)
	 中转仓位：FStockLocId 
	 100新豪仓位值集：FF100003
...
子项明细：FEntity 
	 ...
	 产品名称：FMaterialName 
	 产品规格：FSpecification 
	 子项编码：FMATERIALCHILDID 
	 子项名称：FMaterialName2 
	 子项规格：FSpecificationChild 
	 子项单位：FUnitID 
	 应发数量：FMUSTQTY 
	 已领数量：FPICKEDQTY 
	 退料数量：FRETURNQTY 
	 ...
	 生产订单内码：FMOID 
	 生产订单分录内码：FMOENTRYID 
	 生产用料清单编号：FPPBOMBILLNO 
	 生产用料清单内码：FPPBOMID 
	 生产用料清单分录内码：FPPBOMENTRYID 
	 生产用料清单分录行号：FPPBOMENTRYSEQ 
	 生产领料单编号：FPICKBILLNO 
	 生产领料单内码：FPICKMTRLID 
	 生产退料单编号：FRETURNBILLNO 
	 生产退料单内码：FRETURNMTRLID 
	 基本单位：FBASEUNITID 
	 基本单位应发数量：FBASEMUSTQTY 
	 基本单位已领数量：FBASEPICKEDQTY 
	 基本单位在制材料数量：FBASEWIPQTY 
	 基本单位可挪料数量：FBASECANMOVEQTY 
	 基本单位挪料数量：FBASEMOVEQTY 
	 父极行主键：FPARENTROWID 
	 行标识：FROWID 
	 源单类型：FSourceBillType 
	 源单编号：FSourceBillNo 
	 生产退料单行号：FRETURNENTRYSEQ 
	 生产领料单行号：FPICKENTRYSEQ 
	 转入超发控制：FOverControlMode 
关联关系表：FEntity_Link 
	 实体主键：FLinkId 
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Save("PRD_MOVEMTRL","{"NeedUpDateFields":[],"NeedReturnFields":[],"IsDeleteEntry":"true","SubSystemId":"","IsVerifyBaseDataField":"false","IsEntryBatchFill":"true","ValidateFlag":"true","NumberSearch":"true","IsAutoAdjustField":"true","InterationFlags":"","IgnoreInterationFlag":"","IsControlPrecision":"false","ValidateRepeatJson":"true","Model":{"FID":0,"FBillNo":"","FBillType":{"FNUMBER":""},"FDate":"1900-01-01","FPrdOrgId":{"FNumber":""},"FWORKSHOPID":{"FNumber":""},"FBUSINESSTYPE":"","FMOVEOUTTYPE":"","FMOVEINTYPE":"","FDocumentStatus":"","FDescription":"","FMOVESETQTY":0,"FStockId":{"FNUMBER":""},"FStockLocId":{"FSTOCKLOCID__FF100003":{"FNumber":""},"FSTOCKLOCID__FF100005":{"FNumber":""},"FSTOCKLOCID__FF100006":{"FNumber":""},"FSTOCKLOCID__FF100007":{"FNumber":""},"FSTOCKLOCID__FF100008":{"FNumber":""},"FSTOCKLOCID__FF100009":{"FNumber":""},"FSTOCKLOCID__FF100011":{"FNumber":""},"FSTOCKLOCID__FF100014":{"FNumber":""}},"FEntity":[{"FEntryID":0,"FROWTYPE":"","FMOBILLNO":"","FMOENTRYSEQ":0,"FMATERIALID":{"FNUMBER":""},"FMATERIALCHILDID":{"FNumber":""},"FUnitID":{"FNumber":""},"FMUSTQTY":0,"FPICKEDQTY":0,"FRETURNQTY":0,"FWIPQTY":0,"FCANMOVEQTY":0,"FMOVEQTY":0,"FMOID":0,"FMOENTRYID":0,"FPPBOMBILLNO":"","FPPBOMID":0,"FPPBOMENTRYID":0,"FPPBOMENTRYSEQ":0,"FPICKBILLNO":"","FPICKMTRLID":0,"FRETURNBILLNO":"","FRETURNMTRLID":0,"FBASEUNITID":{"FNumber":""},"FBASEMUSTQTY":0,"FBASEPICKEDQTY":0,"FBASEWIPQTY":0,"FBASECANMOVEQTY":0,"FBASEMOVEQTY":0,"FRETURNENTRYSEQ":"","FPARENTROWID":"","FPICKENTRYSEQ":"","FROWID":"","FOverControlMode":"","FSourceBillType":"","FSourceBillNo":""}]}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.View("PRD_MOVEMTRL","{"CreateOrgId":0,"Number":"","Id":"","IsSortBySeq":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Submit("PRD_MOVEMTRL","{"CreateOrgId":0,"Numbers":[],"Ids":"","SelectedPostId":0,"UseOrgId":0,"NetworkCtrl":"","IgnoreInterationFlag":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Audit("PRD_MOVEMTRL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true","IgnoreInterationFlag":"","UseBatControlTimes":"false"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.UnAudit("PRD_MOVEMTRL","{"CreateOrgId":0,"Numbers":[],"Ids":"","InterationFlags":"","IgnoreInterationFlag":"","UseOrgId":0,"NetworkCtrl":"","IsVerifyProcInst":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.CancelAssign("PRD_MOVEMTRL","{"CreateOrgId":0,"Numbers":[],"Ids":"","UseOrgId":0,"NetworkCtrl":""}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.Push("PRD_MOVEMTRL","{"Ids":"","Numbers":[],"EntryIds":"","RuleId":"","TargetBillTypeId":"","TargetOrgId":0,"TargetFormId":"","IsEnableDefaultRule":"false","IsDraftWhenSaveFail":"false","CustomParams":{}}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.BatchSave("PRD_MOVEMTRL","{"NumberSearch":"true","ValidateFlag":"true","IsDeleteEntry":"true","IsEntryBatchFill":"true","NeedUpDateFields":[],"NeedReturnFields":[],"SubSystemId":"","InterationFlags":"","Model":[],"BatchCount":0,"IsVerifyBaseDataField":"false","IsAutoAdjustField":"true","IgnoreInterationFlag":"false","IsControlPrecision":"false","ValidateRepeatJson":"true"}");
...
// 初始化登录认证，appID、appSec可在"第三方系统登录授权"中获取
client.InitClient("6871005268bf9d", "appID", "appSec", "userName", 2052, "100", "http://xherp.ipecn.com.cn/k3cloud/");
client.QueryBusinessInfo("{"FormId":"PRD_MOVEMTRL"}");
